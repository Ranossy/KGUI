...
function Apply(dwCharacterID, dwSkillSrcID)
	print(122123213)
	local zhuwang = GetNpc(dwSkillSrcID)
	...
	local scene = zhuwang.GetScene()
	
	local xiaozhu = scene.CreateNpc(1934, zhuwang.nX, zhuwang.nY, zhuwang.nZ, 0, 10000)
	
	xiaozhu.ModifyThreat(player.dwID, 1)
end
