---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/太原/武啸威--旗子.lua
-- 更新时间:	2014/10/13 23:15:03
-- 更新用户:	renjei1
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		npc.PlaySfx(553, 23113, 102910, 1129664)
		scene.CreateNpc(37810,23113, 102910, 1129664, 226,480,"huixueqi")
	end
