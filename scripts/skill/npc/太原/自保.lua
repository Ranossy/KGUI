---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/太原/自保.lua
-- 更新时间:	2014/11/14 11:20:23
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.dwTemplateID == 38158 then--and not npcboss.GetBuff(8624,1) 
		npcboss.AddBuff(0,99,8624,1)
	end
end
