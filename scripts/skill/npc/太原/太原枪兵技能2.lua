---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/太原/太原枪兵技能2.lua
-- 更新时间:	2014/8/26 9:31:53
-- 更新用户:	renjei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 23989 * 0, nDamageRand = 23989 * 0, nCostMana = 0}, --level 1
