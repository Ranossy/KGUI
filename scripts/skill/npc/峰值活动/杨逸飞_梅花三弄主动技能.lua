---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/杨逸飞_梅花三弄主动技能.lua
-- 更新时间:	2016/11/19 21:03:14
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 20000 * 0.95, nDamageRand = 20000 * 0.1, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"Map/ACT_峰值201611/skill/安禄山技能掉落_幽冥之怒.lua",
		--0
	--);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
		"skill/npc/峰值活动/杨逸飞_梅花三弄主动技能.lua",
		0
	);
	--skill.AddAttribute(
	--ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
	--ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
	--"Map/逼婚GWW/skill/剑心的包裹.lua",
	--0
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--	skill.BindBuff(1, 9679, 1);		-- 设置1号位Buff
	-----------------技能施放技能需求-------------------------------------------
...
--	skill.SetCheckCoolDown(1, 444);	--只检查不走的CD
	...
	--这里一定要改盾消失时的蓝的参数
	--skill.nCostManaBasePercent = 1500;	-- 技能消耗的内力
