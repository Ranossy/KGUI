---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/白陶的分身-幻心节.lua
-- 更新时间:	2015/9/10 19:49:58
-- 更新用户:	xutong3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
--	skill.BindBuff(1, 9686, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if( not player.GetBuff(9686, 1) or player.GetBuff(9686, 1).nLeftActiveCount <= 1) and not player.GetBuff(4964, 2) and not player.GetBuff(8686, 6) then
		player.AddBuff(player.dwID, player.nLevel, 9686, 1, 10)
	end
end
