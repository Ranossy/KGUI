---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/好饺子.lua
-- 更新时间:	2014/12/22 17:03:57
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{ nCostMana = 280, nTherapy = 50000, nTherapyRand = 0, }, --level 1
	{ nCostMana = 350, nTherapy = 50000, nTherapyRand = 0, }, --level 2
	{ nCostMana = 420, nTherapy = 50000, nTherapyRand = 0, }, --level 3
	{ nCostMana = 490, nTherapy = 50000, nTherapyRand = 0, }, --level 4
	{ nCostMana = 560, nTherapy = 50000, nTherapyRand = 0, }, --level 5
	{ nCostMana = 560, nTherapy = 50000, nTherapyRand = 0, }, --level 6
	{ nCostMana = 280, nTherapy = 50000, nTherapyRand = 0, }, --level 1
	{ nCostMana = 350, nTherapy = 50000, nTherapyRand = 0, }, --level 2
	{ nCostMana = 420, nTherapy = 50000, nTherapyRand = 0, }, --level 3
	{ nCostMana = 490, nTherapy = 50000, nTherapyRand = 0, }, --level 4
