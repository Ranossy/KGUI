---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/变身BOSS.lua
-- 更新时间:	2014/12/11 10:50:10
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
Include("scripts/Include/Skill.lh")
Include("scripts/Include/Player.lh")
Include("scripts/Map/ACT_苍雪龙城峰值/include/data.lua")
...
function OnRemove(dwCharacterID, dwBuffID, nBuffLevel, nLeftFrame)
	DoDelBeBossBuff(dwCharacterID);
	InternDieAward(dwCharacterID);
end
