---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/杨逸飞_羽.lua
-- 更新时间:	2015/9/7 17:12:57
-- 更新用户:	xutong3
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 500000, nDamageRand = 20000, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.nCostManaBasePercent = 914 * 0.1;	-- 技能消耗的内力
	--elseif dwSkillLevel <= 12 then
	--skill.nCostManaBasePercent = 914 * 0.2;	-- 技能消耗的内力
	--elseif dwSkillLevel <= 18 then
	--skill.nCostManaBasePercent = 914 * 0.4;	-- 技能消耗的内力
	--elseif dwSkillLevel <= 24 then
	--skill.nCostManaBasePercent = 914 * 0.7;	-- 技能消耗的内力
	--else
	--skill.nCostManaBasePercent = 914;	-- 技能消耗的内力
	--end
