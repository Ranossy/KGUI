---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/峰值活动/沈剑心弱群攻.lua
-- 更新时间:	2014/12/5 10:57:39
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	local n = Random(1, 6)
	if n == 1 then 
		player.Talk(GetEditorString(7, 1072))
	end
	if n == 2 then 
		player.Talk(GetEditorString(7, 1073))
	end
	if n == 3 then 
		player.Talk(GetEditorString(5, 488))
	end
	return nPreResult;
end
