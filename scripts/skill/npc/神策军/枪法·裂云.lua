...
tSkillData =
{
   {nCostMana = 36, nAPAdd = 4, nDamageRand = 1, nMinRadius = 0, nMaxRadius = 5, nAngleRange = 128, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},
	 ...
	 {nCostMana = 97, nAPAdd = 7, nDamageRand = 1, nMinRadius = 0, nMaxRadius = 5, nAngleRange = 128, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},
   ...
   {nCostMana = 243, nAPAdd = 60, nDamageRand = 12, nMinRadius = 0, nMaxRadius = 5, nAngleRange = 128, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},
