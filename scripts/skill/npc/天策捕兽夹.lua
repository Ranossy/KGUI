...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 1924 then
		npc.SetDisappearFrames(1, 0)
		return
	end 
	if npc.dwTemplateID ~= 1922 then
		return
	end
	if npc.GetBuff(990, 1) then
 	npc.DelGroupBuff(990, 1)
	end
	if not npc.GetBuff(2948, 1) then
		npc.AddBuff(0, 99, 2948, 1)
	end
end
