---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/地脉勘测-战斗技能/冰冻母技能.lua
-- 更新时间:	2015/7/1 17:43:17
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if IsPlayer(dwCharacterID) then
		charater = GetPlayer(dwCharacterID)
	else
		charater = GetNpc(dwCharacterID)
	end

	if not charater then
		return 
	end
	local scene = charater.GetScene()
	if not scene then
		return
	end
	scene.CreateNpc(43581, charater.nX, charater.nY, charater.nZ, 0, -1, "bingjie1" .. charater.dwID)
	--scene.CreateNpc(43581, target.nX + Random(300, 800), target.nY, target.nZ, 0, -1, "bingjie2" .. target.dwID)
	--scene.CreateNpc(43581, target.nX - Random(300, 800), target.nY, target.nZ, 0, -1, "bingjie3" .. target.dwID)
	--scene.CreateNpc(43581, target.nX, target.nY + Random(300, 800), target.nZ, 0, -1, "bingjie4" .. target.dwID)
	--scene.CreateNpc(43581, target.nX, target.nY - Random(300, 800), target.nZ, 0, -1, "bingjie5" .. target.dwID)
	--scene.CreateNpc(43581, target.nX + Random(800, 1000), target.nY + Random(800, 1000), target.nZ, 0, -1, "bingjie6" .. target.dwID)
	--scene.CreateNpc(43581, target.nX + Random(800, 1000), target.nY - Random(800, 1000), target.nZ, 0, -1, "bingjie7" .. target.dwID)
	--scene.CreateNpc(43581, target.nX - Random(800, 1000), target.nY + Random(800, 1000), target.nZ, 0, -1, "bingjie8" .. target.dwID)
	--scene.CreateNpc(43581, target.nX - Random(800, 1000), target.nY - Random(800, 1000), target.nZ, 0, -1, "bingjie9" .. target.dwID)
end
