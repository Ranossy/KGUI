---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/地脉勘测-战斗技能/冰冻定身.lua
-- 更新时间:	2015/6/15 16:51:00
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4133, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.AddBuff(0, 99, 4133, 1, 5) -- 添加冰冻定身buff
	end
end
