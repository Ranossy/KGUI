---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/地脉勘测-战斗技能/定身.lua
-- 更新时间:	2015/6/15 16:03:33
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 200, nDamageRand = 10, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	target.AddBuff(dwCharacterID, 99, 9056, 1, 5)
end
