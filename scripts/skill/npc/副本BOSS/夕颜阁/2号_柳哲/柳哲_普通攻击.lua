---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/2号_柳哲/柳哲_普通攻击.lua
-- 更新时间:	2016/9/12 9:39:47
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 11800, nDamageRand = 590, nCostMana = 0}, --level 2
	{nDamageBase = 18600, nDamageRand = 930, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/2号_柳哲/柳哲_普通攻击.lua", --属性值1
		0															--属性值2
	);
