---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/2号_柳哲/柳哲_斩枫重刀.lua
-- 更新时间:	2016/9/22 16:26:51
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 50, nDamageRand = 3, nCostMana = 0}, --level 1
	{nDamageBase = 66000, nDamageRand = 3300, nCostMana = 0}, --level 2
	{nDamageBase = 99000, nDamageRand = 4950, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/2号_柳哲/柳哲_斩枫重刀.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	local pet = GetNpc(dwCharacterID)
	if  player then
		player.PlaySfx(1304, player.nX, player.nY, player.nZ)
		player.PlaySfx(1501, player.nX, player.nY, player.nZ + 500)
	end
	if  pet then
		pet.PlaySfx(1304, pet.nX, pet.nY, pet.nZ + 500)
		pet.PlaySfx(1501, pet.nX, pet.nY, pet.nZ + 500)
	end
end
