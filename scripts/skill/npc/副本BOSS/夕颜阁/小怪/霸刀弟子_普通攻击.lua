---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/小怪/霸刀弟子_普通攻击.lua
-- 更新时间:	2016/10/5 20:42:14
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 2800, nDamageRand = 140, nCostMana = 0}, --level 2
	{nDamageBase = 4000, nDamageRand = 200, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/小怪/霸刀弟子_普通攻击.lua", --属性值1
		0															--属性值2
	);
