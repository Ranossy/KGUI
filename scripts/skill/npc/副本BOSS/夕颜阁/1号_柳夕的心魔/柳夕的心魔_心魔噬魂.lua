---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/1号_柳夕的心魔/柳夕的心魔_心魔噬魂.lua
-- 更新时间:	2016/8/4 9:46:41
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10, nDamageRand = 2, nCostMana = 0}, --level 1
	{nDamageBase = 6250, nDamageRand = 312, nCostMana = 0}, --level 2
	{nDamageBase = 7800, nDamageRand = 390, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/1号_柳夕的心魔/柳夕的心魔_心魔噬魂.lua", --属性值1
		0															--属性值2
	);
