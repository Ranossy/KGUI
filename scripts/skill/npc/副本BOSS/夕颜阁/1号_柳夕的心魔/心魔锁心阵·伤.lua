---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/1号_柳夕的心魔/心魔锁心阵·伤.lua
-- 更新时间:	2016/9/22 11:56:21
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 6, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 9, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 12, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 550, nDamageRand = 14, nCostMana = 0}, --level 5
	{nDamageBase = 1100, nDamageRand = 28, nCostMana = 0}, --level 6
	{nDamageBase = 1650, nDamageRand = 42, nCostMana = 0}, --level 7
	{nDamageBase = 2200, nDamageRand = 56, nCostMana = 0}, --level 8
	{nDamageBase = 650, nDamageRand = 16, nCostMana = 0}, --level 9
	{nDamageBase = 1300, nDamageRand = 32, nCostMana = 0}, --level 10
	{nDamageBase = 1950, nDamageRand = 48, nCostMana = 0}, --level 11
	{nDamageBase = 2600, nDamageRand = 64, nCostMana = 0}, --level 12
};
...
function GetSkillLevelData(skill)
	...
	--	"skill/npc/副本BOSS/夕颜阁/1号_柳夕的心魔/心魔锁心阵·伤.lua", --属性值1
	--	0															--属性值2
	--	);
	...
	skill.nRectWidth = 44 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	--skill.nAngleRange = 256;					-- 攻击范围的扇形角度范围
	skill.nAreaRadius = 44 * LENGTH_BASE;		-- 技能作用半径
