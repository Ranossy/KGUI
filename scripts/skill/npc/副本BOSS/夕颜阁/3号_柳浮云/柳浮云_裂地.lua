---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_裂地.lua
-- 更新时间:	2016/10/10 16:00:40
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 5300, nDamageRand = 132, nCostMana = 0}, --level 2
	{nDamageBase = 7800, nDamageRand = 195, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_裂地.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nRectWidth = 45 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
