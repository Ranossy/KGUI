---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_吞宇.lua
-- 更新时间:	2016/10/10 16:01:43
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 10400, nDamageRand = 260, nCostMana = 0}, --level 2
	{nDamageBase = 16500, nDamageRand = 412, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_吞宇.lua", --属性值1
		0															--属性值2
	);
