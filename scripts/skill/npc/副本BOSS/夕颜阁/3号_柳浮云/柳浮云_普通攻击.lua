---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_普通攻击.lua
-- 更新时间:	2016/9/12 9:39:29
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 15, nDamageRand = 2, nCostMana = 0}, --level 1
	{nDamageBase = 12800, nDamageRand = 640, nCostMana = 0}, --level 2
	{nDamageBase = 21700, nDamageRand = 1085, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_普通攻击.lua", --属性值1
		0															--属性值2
	);
