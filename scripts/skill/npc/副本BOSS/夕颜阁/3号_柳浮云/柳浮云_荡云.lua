---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_荡云.lua
-- 更新时间:	2016/9/24 15:11:28
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 61100, nDamageRand = 3055, nCostMana = 0}, --level 2
	{nDamageBase = 96100, nDamageRand = 4805, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/夕颜阁/3号_柳浮云/柳浮云_荡云.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if  player then
		player.PlaySfx(1505, player.nX, player.nY, player.nZ)
	end
end
