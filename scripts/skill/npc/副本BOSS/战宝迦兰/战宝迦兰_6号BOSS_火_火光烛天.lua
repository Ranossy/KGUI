...
-- 武功套路  :  无
-- 技能名称  :  火光烛天
-- 技能效果  :  16尺范围内所有玩家受到4000点阳性内功伤害，必中
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 1760    *0.8, nDamageRand = 1760   *0.4, nCostMana = 0},		--level 30
};
...
--   		);
	...
	skill.nMaxRadius		= 14 * LENGTH_BASE;		-- 技能施放的最大距离 
