------------------------------------------------
-- 文件名    :  战宝迦兰_2号BOSS_朱癸_蛇蛊·葵之甲(回血).lua
-- 创建人    :  李凯	
-- 创建时间  :  2009-7-11
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
-- 武功套路  :  无
-- 技能名称  :  蛇蛊·葵之甲(回血)
-- 技能效果  :  为自己添加阴性BUFF，BUFF存在期间每次受到攻击回复20000生命，可以被驱散，BUFF无持续时间限制，最多可以生效10次。
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 45000  *0.8, nDamageRand = 45000  *0.4, nCostMana = 0},		--level 2
...
--   		);
	...
	----------------- BUFF相关 -------------------------------------------------
  -- skill.BindBuff(1,1218,1);		-- 设置1号位Buff
