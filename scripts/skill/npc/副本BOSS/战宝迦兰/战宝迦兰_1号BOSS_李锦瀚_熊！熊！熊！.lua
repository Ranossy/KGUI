...
-- 武功套路  :  无
-- 技能名称  :  熊！熊！熊！
-- 技能效果  : 	吟唱2秒，可以被打断。成功施放则从指定点召唤2头精英战熊加入战斗
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
    	...
    	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/战宝迦兰/战宝迦兰_1号BOSS_李锦瀚_熊！熊！熊！.lua",				-- 属性值1
   		0														-- 属性值2
   		);
  -- 	skill.AddAttribute(
  ...
  --skill.BindBuff(1,1331,1);		-- 设置1号位Buff 作用于自身的HOT
    ...
    ----------------- 打断相关 -------------------------------------------------
    --skill.nBrokenRate         = 1024 * PERCENT_BASE;	-- 技能被打断的概率.基数1024
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		local npcZongkong = scene.GetNpcByNickName("boss1zongkong")
		if npcZongkong then
			npcZongkong.FireAIEvent(2001,0,0)
		end
	end
end
