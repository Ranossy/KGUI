------------------------------------------------
-- 文件名    :  战宝迦兰_6号BOSS_火_风生火起(子技能).lua
-- 创建人    :  李凯	
-- 创建时间  :  2009-7-11
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
tSkillData =
{
	...
	{nDamageBase = 1650   *0.8, nDamageRand = 1650  *0.4, nCostMana = 0},		--level 15
	...
	{nDamageBase = 2334   *0.8, nDamageRand = 2334  *0.4, nCostMana = 0},		--level 18
	{nDamageBase = 2384   *0.8, nDamageRand = 2384  *0.4, nCostMana = 0},		--level 19
	{nDamageBase = 2435   *0.8, nDamageRand = 2435  *0.4, nCostMana = 0},		--level 20
	{nDamageBase = 2485   *0.8, nDamageRand = 2485  *0.4, nCostMana = 0},		--level 21
	{nDamageBase = 2536   *0.8, nDamageRand = 2536  *0.4, nCostMana = 0},		--level 22
	...
	{nDamageBase = 2890   *0.8, nDamageRand = 2890  *0.4, nCostMana = 0},		--level 29
