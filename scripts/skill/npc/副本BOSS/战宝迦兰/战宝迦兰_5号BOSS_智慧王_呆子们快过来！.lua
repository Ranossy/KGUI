------------------------------------------------
-- 文件名    :  战宝迦兰_5号BOSS_智慧王_呆子们快过来！.lua
-- 创建人    :  李凯	
-- 创建时间  :  2009-7-20
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
-- 武功套路  :  无
-- 技能名称  :  呆子们快过来！
-- 技能效果  : 	每当镇恶生命下降20%，召唤1个戒律僧·冰，2个戒律僧·水，冰吃任何控制技能，水不吃其他控制，只吃减速。3小怪血量30000
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
    	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/战宝迦兰/战宝迦兰_5号BOSS_智慧王_呆子们快过来！.lua",				-- 属性值1
   		0														-- 属性值2
   		);
  ...
  -- 	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
  --skill.BindBuff(1,1332,1);		-- 设置1号位Buff 作用于自身的HOT
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		local npcZongkong = scene.GetNpcByNickName("boss4zongkong")
		if npcZongkong then
