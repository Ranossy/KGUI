...
-- 武功套路  :  无
-- 技能名称  :  串火掌·炎华
-- 技能效果  :  区域内所有玩家获得炎华DOT，该DOT可叠加10层，每层每2秒造成67点阳性内功伤害，持续75秒，叠加时刷新持续时间
...
function GetSkillLevelData(skill)
  ...
  -- 	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1,1278,1);		-- 设置1号位Buff 
	...
	skill.nMaxRadius		= 644 * LENGTH_BASE;		-- 技能施放的最大距离 
