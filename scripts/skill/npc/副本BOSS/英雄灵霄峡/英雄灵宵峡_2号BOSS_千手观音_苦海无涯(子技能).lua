------------------------------------------------
-- 文件名    :  英雄灵宵峡_2号BOSS_千手观音_苦海无涯(子技能).lua
-- 创建人    :  CBG	
-- 创建时间  :  2009-10-26
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/英雄灵霄峡/英雄灵宵峡_2号BOSS_千手观音_苦海无涯(子技能).lua",				-- 属性值1
   		0														-- 属性值2
   		);
	    ----------------- 技能施放Buff需求 ---------------------------------------------
	...
	--skill.AddSlowCheckDestBuff(1400, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);-- 需求目标Buff
	    ----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1,1496,1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if sum >= 75 then
		player.AddBuff(0,99,1493,1)
	elseif sum >= 50 then
		player.AddBuff(0,99,1494,1)
	elseif sum >= 25 then
		player.AddBuff(0,99,1495,1)
	else
		player.AddBuff(0,99,1497,1)
  	end
end
