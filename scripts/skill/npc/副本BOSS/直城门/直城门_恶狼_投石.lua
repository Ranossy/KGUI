...
tSkillData =
{
	{nDamageBase = 300000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 70000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 45000, nDamageRand = 0, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6990, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local nBuff = npc.GetBuff(6614, 1)
	if not nBuff then
		npc.CastSkill(8054,1)
	end
	if nBuff.nStackNum == 1 then
		npc.CastSkill(8054, 1)
	elseif nBuff.nStackNum == 2 then
		npc.CastSkill(8054, 2)
	elseif nBuff.nStackNum == 3 then
		npc.CastSkill(8054, 3)
	elseif nBuff.nStackNum == 4 then
		npc.CastSkill(8054, 4)
	else
		npc.CastSkill(8054, 5)
	end
end
