...
tSkillData =
{
	{nDamageBase = 370000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 43500, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 26100, nDamageRand = 0, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6615, dwSkillLevel);		-- 设置1号位Buff
