...
tSkillData =
{
	{nDamageBase = 3240000, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/直城门/直城门_AOE2.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 7059, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if npc_zk then
		npc_zk.SetCustomBoolean(10, true)
	end
end
