---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/田布戈_飞行飞斧.lua
-- 更新时间:	2014/8/22 10:56:22
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 34200, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 52200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 86900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 36100, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/太原之战_夜守孤城/田布戈_飞行飞斧.lua", -- 属性值1
		--0														-- 属性值2
	--);
...
function Apply(dwCharacterID, dwSkillSrcID)
	local TBG = GetNpc(dwCharacterID)
	local FUTOU = GetNpc(dwSkillSrcID)
	if TBG and TBG.dwTemplateID == 42415 then
		local SHULIANG = TBG.GetCustomInteger1(2)
		TBG.SetCustomInteger1(2, SHULIANG + 1)
		if TBG.GetCustomInteger1(2) == 5 then
			TBG.SetCustomInteger1(2, 0)
			TBG.FireAIEvent(2009, 0, 0)
		end
		FUTOU.SetDisappearFrames(1, 0)
	end
end
