---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_机雷自爆.lua
-- 更新时间:	2014/8/1 16:38:39
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 29300, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_机雷自爆.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 6 * GLOBAL.GAME_FPS;				-- 吟唱帧数
	if dwSkillLevel == 1 then
		skill.nPrepareFrames = 7.5 * GLOBAL.GAME_FPS;				-- 吟唱帧数
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcthis = GetNpc(dwSkillSrcID)
	if npcthis then
		npcthis.Die()
	end
end
