---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵射箭.lua
-- 更新时间:	2014/12/8 17:41:31
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵射箭.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(32, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵射箭.lua", player.dwID, npc.dwID)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npc then
		npc.CastSkill(13613, 1, TARGET.PLAYER, player.dwID)
	end
end
