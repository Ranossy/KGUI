---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/箭矢.lua
-- 更新时间:	2014/9/27 14:10:30
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/箭矢.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(48, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/箭矢.lua", player.dwID, npc.dwID)
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npc then
		if scene.dwMapID == 191 then
			npc.CastSkill(13413, 1, TARGET.PLAYER, player.dwID)
		elseif scene.dwMapID == 198 then
			npc.CastSkill(13413, 2, TARGET.PLAYER, player.dwID)
		elseif scene.dwMapID == 205 then
			npc.CastSkill(13413, 3, TARGET.PLAYER, player.dwID)
		elseif scene.dwMapID == 211 then
			npc.CastSkill(13413, 4, TARGET.PLAYER, player.dwID)
		end
	end
end
