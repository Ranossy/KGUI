---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/投石.lua
-- 更新时间:	2014/9/14 17:20:07
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/英雄投石.lua",
		0
	);
	...
	--skill.nCostMana = 9;	-- 技能消耗的内力
	--elseif dwSkillLevel == 2 then
	skill.nCostMana = 20;	-- 技能消耗的内力
	--end
	...
	----------------- 施放距离 -------------------------------------------------
	skill.nMinRadius		= 35 * LENGTH_BASE;		-- 技能施放的最小距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(48, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/英雄投石.lua", nX, nY)
	--player.CastSkillXYZ(13105, 1, nX, nY, nZ)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	nY = nParam2
	player.CastSkillXYZ(13105, 1, nX, nY, nZ)
	player.PlaySfx(1058, nParam1, nParam2, nZ + 500)
end
