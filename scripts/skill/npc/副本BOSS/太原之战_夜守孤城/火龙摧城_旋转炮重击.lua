---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_旋转炮.lua
-- 更新时间:	2014/9/27 16:16:50
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 58700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 58700/2, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 58700/3, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 103400, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 103400/2, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 103400/3, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 103400/4, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 103400/5, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 252700, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 252700/2, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 252700/3, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 252700/4, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamageBase = 252700/5, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamageBase = 113600, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamageBase = 113600/2, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamageBase = 113600/3, nDamageRand = 0, nCostMana = 0}, --level 16
};
...
function GetSkillLevelData(skill)
	...
	----------------- 时间相关 -------------------------------------------------
	--skill.nPrepareFrames  	= 0 * GLOBAL.GAME_FPS;				-- 吟唱帧数
