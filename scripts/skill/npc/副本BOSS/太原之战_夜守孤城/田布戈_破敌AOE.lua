---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/田布戈_破敌AOE.lua
-- 更新时间:	2014/10/24 15:02:19
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 57900, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 69500, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/田布戈_破敌AOE.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.PlaySfx(1065, player.nX, player.nY, player.nZ + 500)
	end
end
