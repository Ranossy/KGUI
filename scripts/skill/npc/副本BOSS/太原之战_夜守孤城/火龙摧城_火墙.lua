---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_火墙.lua
-- 更新时间:	2014/11/10 20:17:42
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 40200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 86200, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 77400, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_火墙.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8032, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerA then
		...
		local buffA = playerA.GetBuff(8032, 1)
		if buffA and buffA.nStackNum >= 1 then
			playerA.Die()
		end
	else
		...
		if npcA then
			...
			local buffA = npcA.GetBuff(8032, 1)
			if buffA and buffA.nStackNum >= 1 then
				npcA.Die()
			end
		end
