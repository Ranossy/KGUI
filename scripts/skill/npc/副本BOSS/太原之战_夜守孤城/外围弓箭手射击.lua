---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/外围弓箭手射击.lua
-- 更新时间:	2014/10/26 22:24:01
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/外围弓箭手射击.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(58, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/外围弓箭手射击.lua", player.dwID, npc.dwID)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npc then
		...
		if scene.dwMapID == 191 or scene.dwMapID == 211 then
			npc.CastSkill(13439, 1, TARGET.PLAYER, player.dwID)
		elseif scene.dwMapID == 198 or scene.dwMapID == 205 then
			npc.CastSkill(13439, 2, TARGET.PLAYER, player.dwID)
		end
	end
end
