---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/箭塔目标技能.lua
-- 更新时间:	2014/9/18 16:11:29
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/箭塔目标技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nDistance >= buff1.nCustomValue then
		...
		if npc and npc.dwTemplateID == 27566 then
			if nDistance - buff1.nCustomValue < 512 then
		...
		if npc and npc.dwTemplateID == 27566 then
			if buff1.nCustomValue - nDistance < 512 then
				return
			end
		end
...
function OnTimer(player, nParam1, nParam2)
	...
	player.CastSkill(13159, 1, type, dwID)
