---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/箭塔伤害.lua
-- 更新时间:	2014/9/19 16:07:26
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 112000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 112000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/太原之战_夜守孤城/箭塔伤害.lua", -- 属性值1
		--0														-- 属性值2
	--);
	...
	skill.AddSlowCheckDestBuff(8506, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
