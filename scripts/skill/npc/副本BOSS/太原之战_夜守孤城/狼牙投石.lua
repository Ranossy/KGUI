---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/狼牙投石.lua
-- 更新时间:	2014/9/28 11:23:10
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 27400, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/狼牙投石.lua",
		0
	);
	...
	skill.nMaxRadius = 400 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(44, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/狼牙投石.lua", npc.dwID, 0)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npc then
		...
		local MZID = npc.GetCustomInteger4(0)
		local MIAOZHUN = GetNpc(MZID)
		if MIAOZHUN then
			if scene.dwMapID == 191 then
				npc.CastSkillXYZ(13224, 1, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ)
				npc.PlaySfx(1059, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ )
			elseif scene.dwMapID == 198 then
				npc.CastSkillXYZ(13224, 2, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ)
				npc.PlaySfx(1059, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ )
			elseif scene.dwMapID == 205 then
				npc.CastSkillXYZ(13224, 3, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ)
				npc.PlaySfx(1059, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ )
			elseif scene.dwMapID == 211 then
				npc.CastSkillXYZ(13224, 4, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ)
				npc.PlaySfx(1059, MIAOZHUN.nX, MIAOZHUN.nY, MIAOZHUN.nZ )
			end
		end
	end
