---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵投石.lua
-- 更新时间:	2014/12/6 16:14:27
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵投石.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(44, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/门派入侵投石.lua", npc.dwID, 0)
end

function OnTimer(scene, nParam1, nParam2)
	local npc = GetNpc(nParam1)
	if npc then
		local nX = npc.GetCustomInteger4(20)
		local nY = npc.GetCustomInteger4(24)
		local nZ = npc.GetCustomInteger4(28)
		npc.CastSkillXYZ(13606, 1, nX, nY, nZ)
		npc.PlaySfx(1059, nX, nY, nZ )
	end
end
