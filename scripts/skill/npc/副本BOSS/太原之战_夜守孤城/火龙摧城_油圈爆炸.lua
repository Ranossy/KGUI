---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_油圈爆炸.lua
-- 更新时间:	2015/3/12 10:19:27
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 40200, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 3 then  --只有25挑战有穿透
		for i = 1, 6 do
			skill.AddAttribute(
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/火龙摧城_油圈爆炸.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
