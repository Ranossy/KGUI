---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/入口唐军射箭.lua
-- 更新时间:	2014/10/14 10:41:51
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 160000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/入口唐军射箭.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(16, "scripts/skill/npc/副本BOSS/太原之战_夜守孤城/入口唐军射箭.lua", npc.dwID, 0)
end

function OnTimer(scene, nParam1, nParam2)
	local npc = GetNpc(nParam1)
	if npc then
		npc.PlaySfx(553, npc.nX, npc.nY, npc.nZ)
	end
end
