---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/狼牙投弹.lua
-- 更新时间:	2014/10/26 21:02:09
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 35100, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 40900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 24800, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/狼牙投弹.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAngleRange = 48;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.PlaySfx(1070, player.nX, player.nY, player.nZ)
	end
end
