---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_夜守孤城/关卡_点燃烽火.lua
-- 更新时间:	2014/10/17 18:04:52
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_夜守孤城/关卡_点燃烽火.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 29 * GLOBAL.GAME_FPS;				-- 吟唱帧数
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcFireKongzhi = scene.GetNpcByNickName("fenghuokongzhi")
	if npcFireKongzhi then
		npcFireKongzhi.FireAIEvent(2001, 0, 0)
	end
end
