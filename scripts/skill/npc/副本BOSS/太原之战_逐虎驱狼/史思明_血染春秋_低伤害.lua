---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_血染春秋_低伤害.lua
-- 更新时间:	2014/10/13 14:56:32
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 25300, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 39400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 14500, nDamageRand = 1000, nCostMana = 0}, --level 4
