---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_门神_扇形AE.lua
-- 更新时间:	2014/10/23 17:18:43
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 28400, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 33300, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 38100, nDamageRand = 2000, nCostMana = 0}, --level 3
