---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_射雕手_单体.lua
-- 更新时间:	2014/10/23 15:34:09
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 38200, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 44800, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 51200, nDamageRand = 2000, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 2 * LENGTH_BASE;		-- 技能作用半径,120°
