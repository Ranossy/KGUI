---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_弓骑.lua
-- 更新时间:	2014/9/4 15:25:55
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 33225, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 64875, nDamageRand = 2000, nCostMana = 0}, --level 2	
	{nDamageBase = 117825, nDamageRand = 4000, nCostMana = 0},--level 3
	{nDamageBase = 34320, nDamageRand = 2000, nCostMana = 0}, --level 4
