---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_6尺内回血.lua
-- 更新时间:	2014/11/18 17:30:33
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 400000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 650000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 168000, nDamageRand = 0, nCostMana = 0}, --level 4
...
--[[
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_6尺内回血.lua",
		0														
		);
--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(7987, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
