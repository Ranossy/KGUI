---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/军阵_玩家_斩杀.lua
-- 更新时间:	2014/8/25 15:00:18
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 200000, nDamageRand = 10000, nCostMana = 0}, --level 1
	{nDamageBase = 200000, nDamageRand = 10000, nCostMana = 0}, --level 2
...
---[[
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/军阵_玩家_斩杀.lua",
		0
	);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 684);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		--[[print("斩杀后清除4层BUFF")
		for i = 1, 4 do
			player.DelBuff(7961, 1)
		end
		--]]
		player.DelGroupBuff(7961, 1)
	end
