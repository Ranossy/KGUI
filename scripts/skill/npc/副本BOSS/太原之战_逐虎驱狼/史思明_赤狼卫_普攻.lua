---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_赤狼卫_普攻.lua
-- 更新时间:	2014/11/6 17:49:12
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 10000, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 16000, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 26000, nDamageRand = 2000, nCostMana = 0}, --level 3
	{nDamageBase = 12000, nDamageRand = 1000, nCostMana = 0}, --level 4
