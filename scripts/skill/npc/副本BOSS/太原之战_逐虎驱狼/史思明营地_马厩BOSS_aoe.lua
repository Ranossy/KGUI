---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_马厩BOSS_aoe.lua
-- 更新时间:	2014/10/25 20:03:16
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 25300, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 41200, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 47100, nDamageRand = 0, nCostMana = 0}, --level 3
