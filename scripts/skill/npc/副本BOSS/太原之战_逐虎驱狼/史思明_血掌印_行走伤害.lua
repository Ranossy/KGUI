---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_血掌印_行走伤害.lua
-- 更新时间:	2014/9/20 15:45:17
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2900, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 3400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 3900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 3100, nDamageRand = 0, nCostMana = 0}, --level 4
