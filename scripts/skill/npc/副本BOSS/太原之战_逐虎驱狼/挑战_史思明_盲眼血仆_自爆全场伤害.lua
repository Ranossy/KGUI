---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/挑战_史思明_盲眼血仆_自爆全场伤害.lua
-- 更新时间:	2015/3/4 16:42:52
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 26300, nDamageRand = 1500, nCostMana = 0}, --level 1
	{nDamageBase = 26300, nDamageRand = 500, nCostMana = 0}, --level 2
