---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_巡营骠骑_冲刺.lua
-- 更新时间:	2014/10/23 20:40:09
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 34200, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 40200, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 38200, nDamageRand = 1000, nCostMana = 0}, --level 3
	{nDamageBase = 44800, nDamageRand = 1000, nCostMana = 0}, --level 4
	{nDamageBase = 46000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 51200, nDamageRand = 0, nCostMana = 0}, --level 6
...
--]]
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8347, dwSkillLevel);		-- 设置1号位Buff
