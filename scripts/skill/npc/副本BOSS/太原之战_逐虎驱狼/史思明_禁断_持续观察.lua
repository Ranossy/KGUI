---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_禁断_持续观察.lua
-- 更新时间:	2014/9/30 16:30:54
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
--[[
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8036, dwSkillLevel);		-- 设置1号位Buff
	skill.BindBuff(1, 8340, dwSkillLevel);		-- 设置2号位Buff
