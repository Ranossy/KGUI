---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_普攻.lua
-- 更新时间:	2014/11/6 11:29:27
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 81000, nDamageRand = 5000, nCostMana = 0}, --level 1
	{nDamageBase = 150000, nDamageRand = 5000, nCostMana = 0}, --level 2
	{nDamageBase = 218000, nDamageRand = 10000, nCostMana = 0}, --level 3
	{nDamageBase = 96000, nDamageRand = 5000, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_普攻.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buff = npc.GetBuff(8806, 1)
	if buff then
		local n = buff.nStackNum
		for i = 1, n do
			player_MT.AddBuff(0, 99, 8811, 1, 30)
		end
	end
end
