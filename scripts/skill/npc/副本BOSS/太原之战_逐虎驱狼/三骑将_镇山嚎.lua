---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_镇山嚎.lua
-- 更新时间:	2014/7/3 20:49:23
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 17100, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 17100, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 18150, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 18150, nDamageRand = 1000, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel > 1 then
		skill.BindBuff(1, 8014, 2);		-- 设置1号位Buff
	end
