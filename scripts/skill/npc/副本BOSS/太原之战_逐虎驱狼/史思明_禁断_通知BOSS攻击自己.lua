---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_禁断_通知BOSS攻击自己.lua
-- 更新时间:	2014/10/2 18:10:49
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_禁断_通知BOSS攻击自己.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	----删掉自己的监视DEBUFF，BUFF脚本里发送事件
	local player = GetPlayer(dwCharacterID)
	if not player then
		return
	end
	player.DelBuff(8340, 1)
	player.DelBuff(8340, 2)
	player.DelBuff(8340, 3)
	player.DelBuff(8340, 4)
end
