---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_大范围阳性AOE.lua
-- 更新时间:	2014/7/14 17:30:29
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 19600, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 19600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 19600, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 19600, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 19600, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 46000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 99800, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 41300, nDamageRand = 0, nCostMana = 0}, --level 9
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	if dwSkillLevel < 7 then    --普通版
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE,
		tSkillData[dwSkillLevel].nDamageBase * (1 + 0.2 * (dwSkillLevel - 1)) * 0.14,
		0
			);
		dwBuffLevel = 1
	elseif dwSkillLevel == 7 then    --英雄版
			skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE,
		...
		dwBuffLevel = 2
	elseif dwSkillLevel == 8 then --挑战版
		skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE,
		tSkillData[dwSkillLevel].nDamageBase * 0.14,
		...
		dwBuffLevel = 3
	elseif dwSkillLevel == 9 then --十人挑战版
		skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE,
		tSkillData[dwSkillLevel].nDamageBase * 0.14,
	...
	--"skill/npc/副本BOSS/太原之战·逐虎驱狼/白陶_大范围阳性AOE.lua", -- 属性值1
	--0														-- 属性值2
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7993, dwBuffLevel);		-- 设置1号位Buff
