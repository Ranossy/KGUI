---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_弓骑_AE子技能.lua
-- 更新时间:	2014/11/11 20:02:26
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	...
	{nDamageBase = 5475, nDamageRand = 400, nCostMana = 0}, --level 1
	{nDamageBase = 8550, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 9075, nDamageRand = 800, nCostMana = 0},  --level 3
	{nDamageBase = 5475, nDamageRand = 500, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_弓骑_AE子技能.lua",
		--0
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
