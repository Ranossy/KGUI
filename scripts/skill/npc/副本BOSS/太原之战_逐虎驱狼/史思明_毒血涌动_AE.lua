---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_毒血涌动_AE.lua
-- 更新时间:	2014/9/23 11:21:33
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3867, nDamageRand = 50, nCostMana = 0}, --level 1
	{nDamageBase = 4533, nDamageRand = 50, nCostMana = 0}, --level 2
	{nDamageBase = 7066, nDamageRand = 100, nCostMana = 0}, --level 3
	{nDamageBase = 4133, nDamageRand = 50, nCostMana = 0}, --level 4
