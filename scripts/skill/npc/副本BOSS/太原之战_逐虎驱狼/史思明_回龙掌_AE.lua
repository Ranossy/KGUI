---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_回龙掌_AE.lua
-- 更新时间:	2014/9/25 15:57:10
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 59100, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8306, dwSkillLevel);		-- 血印uff
	skill.BindBuff(2, 8319, dwSkillLevel);		    -- 破甲Buff
