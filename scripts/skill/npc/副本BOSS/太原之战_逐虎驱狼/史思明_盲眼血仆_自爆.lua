---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_盲眼血仆_自爆.lua
-- 更新时间:	2014/9/5 12:03:32
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 68500, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 80400, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 80400, nDamageRand = 500, nCostMana = 0}, --level 3
	{nDamageBase = 72300, nDamageRand = 500, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8012, dwSkillLevel);		-- 设置1号位Buff
