---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_轻骑.lua
-- 更新时间:	2014/9/4 15:25:43
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{	
	{nDamageBase = 35440, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 69200, nDamageRand = 4000, nCostMana = 0}, --level 2
	{nDamageBase = 125680, nDamageRand = 5000, nCostMana = 0}, --level 3
	{nDamageBase = 36960, nDamageRand = 4000, nCostMana = 0}, --level 4
