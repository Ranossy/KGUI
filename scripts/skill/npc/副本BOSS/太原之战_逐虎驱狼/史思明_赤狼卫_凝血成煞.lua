---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_赤狼卫_凝血成煞.lua
-- 更新时间:	2014/10/4 18:08:53
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 1800, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 3200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 7200, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 1900, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8351, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.nAreaRadius = 8 * LENGTH_BASE;		-- 技能作用半径,120°
