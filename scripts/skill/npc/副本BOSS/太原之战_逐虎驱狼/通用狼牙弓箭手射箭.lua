---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/通用狼牙弓箭手射箭.lua
-- 更新时间:	2014/11/3 20:40:50
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/通用狼牙弓箭手射箭.lua",
		0
	);
	...
	skill.nMaxRadius		= 65 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(48, "scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/通用狼牙弓箭手射箭.lua", player.dwID, npc.dwID)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npc then
		if player then
			npc.CastSkill(13432, 1, TARGET.PLAYER, player.dwID)
		end
	end
end
