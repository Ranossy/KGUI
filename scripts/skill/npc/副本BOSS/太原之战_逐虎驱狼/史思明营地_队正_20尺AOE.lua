---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_队正_20尺AOE.lua
-- 更新时间:	2014/10/24 11:45:58
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 24500, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 28700, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 32800, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 20 * LENGTH_BASE;		-- 技能作用半径,120°
