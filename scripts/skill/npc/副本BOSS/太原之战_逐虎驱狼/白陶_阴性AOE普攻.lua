---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性AOE普攻.lua
-- 更新时间:	2014/7/14 19:23:51
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 5250, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 4700, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 7800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 5250, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性AOE普攻.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(8025, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7992, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSrcID)
	...
	--if npcBOSS then
	--for i = 1, 3 do
	--player.AddBuff(npcBOSS.dwID,99,7993,1,1)
	--end
	--end
	...
	--if npcBOSS then
	--for i = 1, 3 do
	--npc.AddBuff(npcBOSS.dwID,99,7993,1,1)
	--end
	--end
	--end
end
