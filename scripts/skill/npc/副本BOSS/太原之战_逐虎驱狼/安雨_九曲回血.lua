---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_九曲回血.lua
-- 更新时间:	2014/11/14 10:10:15
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_九曲回血.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npcA then
		local NP = npcA.nCurrentMana / npcA.nMaxMana
		if NP > 0.3 then
			npcA.nCurrentLife = npcA.nCurrentLife + npcA.nMaxLife * (NP - 0.3)
			npcA.nCurrentMana = 0.3 * npcA.nMaxMana
		end
	end
end
