---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阳性莲花指.lua
-- 更新时间:	2015/4/7 19:40:49
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 54800, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 30600, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 57800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 27500, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阳性莲花指.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npcKH then
		player.AddBuff(npcKH.dwID, 99, 7993, nlevel)
	else
		player.AddBuff(0, 99, 7993, nlevel)
	end
end
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame)
	...
	player.CastSkill(9540, nBuffLevel)
