---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_普攻_重骑_AE子技能.lua
-- 更新时间:	2014/7/3 20:23:50
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	...
	{nDamageBase = 7300, nDamageRand = 300, nCostMana = 0}, --level 1
	{nDamageBase = 11400, nDamageRand = 400, nCostMana = 0}, --level 2
	{nDamageBase = 12100, nDamageRand = 500, nCostMana = 0},--level 3
	{nDamageBase = 7300, nDamageRand = 400, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_重骑_AE子技能.lua",
		0
	);
--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(7934, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(7933, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8010, dwSkillLevel);		-- 设置1号位Buff
