---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_十殿阎罗_玩家胜利后收到的群体伤害.lua
-- 更新时间:	2014/10/21 16:49:04
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 19600, nDamageRand = 600, nCostMana = 0}, --level 1
	{nDamageBase = 4900, nDamageRand = 100, nCostMana = 0}, --level 2
	{nDamageBase = 57400, nDamageRand = 2000, nCostMana = 0}, --level 3
	{nDamageBase = 28700, nDamageRand = 1000, nCostMana = 0}, --level 4
	{nDamageBase = 65600, nDamageRand = 2000, nCostMana = 0}, --level 5
	{nDamageBase = 32800, nDamageRand = 1000, nCostMana = 0}, --level 6
	{nDamageBase = 20700, nDamageRand = 2000, nCostMana = 0}, --level 7
	{nDamageBase = 5200, nDamageRand = 1000, nCostMana = 0}, --level 8
...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 8356, dwSkillLevel);		-- 设置3号位Buff
