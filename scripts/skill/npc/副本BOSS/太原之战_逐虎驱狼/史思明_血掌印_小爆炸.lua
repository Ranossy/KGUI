---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_血掌印_小爆炸.lua
-- 更新时间:	2014/9/20 15:47:30
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 9800, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 17200, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 30200, nDamageRand = 1500, nCostMana = 0}, --level 3
	{nDamageBase = 18600, nDamageRand = 1000, nCostMana = 0}, --level 4
