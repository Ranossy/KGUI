---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_疾风冲击子技能.lua
-- 更新时间:	2014/10/10 17:34:38
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 68000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 88000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 88000, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	local nDamage = 0
	local dwBuffLevel = 1
	--按debuff层数决定伤害等级 最多10层
	if dwSkillLevel <= 10 then
		nDamage = 31300 * (0.7 + 0.3 * dwSkillLevel) * 0.14
	elseif dwSkillLevel <= 20 then
		nDamage = 59700 * (1 + 0.1 * (dwSkillLevel-11)) * 0.14
		dwBuffLevel = 2
	elseif dwSkillLevel <= 30 then
		nDamage = 94500 * (1 + 0.35 * (dwSkillLevel-21)) * 0.14
		dwBuffLevel = 3
	elseif dwSkillLevel <= 40 then
		nDamage = 33000 * (1 + 0.1 * (dwSkillLevel-31)) * 0.14
		dwBuffLevel = 4
	end
