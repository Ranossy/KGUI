---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_能量输入直线.lua
-- 更新时间:	2014/8/7 16:50:32
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 17600, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 27600, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 31500, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 18600, nDamageRand = 0, nCostMana = 0}, --level 4
