---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_死士_4尺自爆AOE.lua
-- 更新时间:	2014/10/25 17:20:33
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 87100, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 102200, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 116800, nDamageRand = 1000, nCostMana = 0}, --level 3
	{nDamageBase = 87100, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 4 * LENGTH_BASE;		-- 技能作用半径,120°
