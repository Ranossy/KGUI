---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_三毒入体_爆炸.lua
-- 更新时间:	2014/11/5 21:42:20
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 20000, nDamageRand = 1000, nCostMana = 0}, --level 1
	{nDamageBase = 22933, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 91006, nDamageRand = 1000, nCostMana = 0}, --level 3
	{nDamageBase = 27600, nDamageRand = 1000, nCostMana = 0}, --level 4
