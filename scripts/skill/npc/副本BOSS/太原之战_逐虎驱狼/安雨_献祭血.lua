---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·夜守孤城/火龙摧城_火圈.lua
-- 更新时间:	2014/7/7 20:13:58
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 21000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 21000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 21000, nDamageRand = 0, nCostMana = 0}, --level 4
};
