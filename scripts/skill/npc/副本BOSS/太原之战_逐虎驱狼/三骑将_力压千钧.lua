---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_力压千钧.lua
-- 更新时间:	2014/7/3 20:05:03
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 14700, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 24800, nDamageRand = 200, nCostMana = 0}, --level 2
	{nDamageBase = 24800, nDamageRand = 200, nCostMana = 0}, --level 3
	{nDamageBase = 15500, nDamageRand = 200, nCostMana = 0}, --level 4
