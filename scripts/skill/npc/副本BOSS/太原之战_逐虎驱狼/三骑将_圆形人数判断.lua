---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_圆形人数判断.lua
-- 更新时间:	2014/11/11 11:01:13
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_圆形人数判断.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--技能只管判断人数，给NPC添加标记BUFF。
	npc.AddBuff(0, 99, 8222, 1)
end
