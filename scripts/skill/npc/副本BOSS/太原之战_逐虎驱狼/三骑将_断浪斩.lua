---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_断浪斩.lua
-- 更新时间:	2014/7/7 16:34:57
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 19600, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 34800, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 33100, nDamageRand = 2000, nCostMana = 0}, --level 3
	{nDamageBase = 20700, nDamageRand = 500, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8029, dwSkillLevel);		-- 设置1号位Buff
