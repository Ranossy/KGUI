---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_普攻_轻骑_AE子技能.lua
-- 更新时间:	2014/7/3 20:24:14
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	...
	{nDamageBase = 5840, nDamageRand = 400, nCostMana = 0}, --level 1
	{nDamageBase = 9120, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 9680, nDamageRand = 500, nCostMana = 0}, --level 3
	{nDamageBase = 5840, nDamageRand = 500, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_轻骑_AE子技能.lua",
		0
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8011, dwSkillLevel);		-- 设置1号位Buff
