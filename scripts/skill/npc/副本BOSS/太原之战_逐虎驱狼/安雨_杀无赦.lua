---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_杀无赦.lua
-- 更新时间:	2014/10/26 18:40:48
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 117400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 137900, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 196900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 123900, nDamageRand = 0, nCostMana = 0}, --level 4
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_杀无赦.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerA and playerA.nMoveState ~= MOVE_STATE.ON_DEATH then
		playerA.DelBuff(8042, nLevel)
	end
	local npcBingguan = scene.GetNpcByNickName("AY_bingguan" .. playerA.dwID)
	if npcBingguan then
		npcBingguan.Die()
	end
end
