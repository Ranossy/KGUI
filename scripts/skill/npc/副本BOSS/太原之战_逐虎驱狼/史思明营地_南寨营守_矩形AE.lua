---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明营地_南寨营守_矩形AE.lua
-- 更新时间:	2014/10/23 19:59:01
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 184000, nDamageRand = 4000, nCostMana = 0}, --level 1
	{nDamageBase = 500000, nDamageRand = 10000, nCostMana = 0}, --level 2
	{nDamageBase = 535000, nDamageRand = 10000, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 5 * LENGTH_BASE;		-- 技能作用半径,120°
