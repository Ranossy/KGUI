---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性普攻单体.lua
-- 更新时间:	2014/7/14 19:24:21
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 65400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 110000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 235700, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性普攻单体.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.BindBuff(2, 8025, dwSkillLevel);		-- 设置2号位Buff
