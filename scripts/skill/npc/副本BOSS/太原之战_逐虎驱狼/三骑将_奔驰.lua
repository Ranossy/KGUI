---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_奔驰.lua
-- 更新时间:	2014/8/13 16:30:31
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 7900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 6200, nDamageRand = 0, nCostMana = 0}, --level 4
