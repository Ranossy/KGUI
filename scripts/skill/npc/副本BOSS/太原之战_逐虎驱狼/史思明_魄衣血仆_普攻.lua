---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_魄衣血仆_普攻.lua
-- 更新时间:	2014/10/4 19:20:18
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 8000, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 25000, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 30000, nDamageRand = 1000, nCostMana = 0}, --level 3
