---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_链状AOE检测.lua
-- 更新时间:	2014/7/14 17:30:56
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_链状AOE检测.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerTarget.GetBuff(8027, nLevel) then
		return
	end
	local buff8027 = playerSrc.GetBuff(8027, nLevel)
	...
	if nDis < 2 * 64 then
		playerTarget.AddBuff(buff8027.dwSkillSrcID, 99, 8035, buff8027.nLevel, 1)
	end
end
