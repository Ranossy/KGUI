---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/安雨_血球爆治疗.lua
-- 更新时间:	2014/9/18 14:51:19
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{ nTherapy = 45000, nTherapyRand = 0, nCostMana = 0}, --level 1
	{ nTherapy = 52500, nTherapyRand = 0, nCostMana = 0}, --level 2
	{ nTherapy = 60000, nTherapyRand = 0, nCostMana = 0}, --level 3
	{ nTherapy = 47500, nTherapyRand = 0, nCostMana = 0}, --level 3
};
