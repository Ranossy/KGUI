---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性莲花指.lua
-- 更新时间:	2014/7/29 10:57:12
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_阴性莲花指.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npcPP then
		player.AddBuff(npcPP.dwID,99,7992,nlevel)
	else
		player.AddBuff(0,99,7992,nlevel)
	end
end
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame)
	...
	player.CastSkill(9541, nBuffLevel)
