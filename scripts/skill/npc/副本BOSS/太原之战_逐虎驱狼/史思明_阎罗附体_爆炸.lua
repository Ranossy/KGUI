---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_阎罗附体_爆炸.lua
-- 更新时间:	2014/9/23 16:51:52
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 61334, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 72000, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 105067, nDamageRand = 2000, nCostMana = 0}, --level 3
	{nDamageBase = 64667, nDamageRand = 2000, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 3 then
		...
		skill.nAreaRadius = 60 * LENGTH_BASE;	
	end
