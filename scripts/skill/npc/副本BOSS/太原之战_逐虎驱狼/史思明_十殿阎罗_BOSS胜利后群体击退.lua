---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_十殿阎罗_群体击退.lua
-- 更新时间:	2014/10/21 11:21:53
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 73400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 91900, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 105000, nDamageRand = 5000, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_十殿阎罗_群体击退.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	--skill.BindBuff(2, 7346, 1);		-- 设置4号位Buff
