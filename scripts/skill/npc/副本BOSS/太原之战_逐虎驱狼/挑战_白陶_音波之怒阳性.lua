---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/挑战_白陶_音波之怒阳性.lua
-- 更新时间:	
-- 更新用户:	ZHENGYUCHAO
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 39400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 78800, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 157600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 315200, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 630400, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 1260800, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 2521600, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 5043200, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 10086400, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 20172800, nDamageRand = 0, nCostMana = 0}, --level 10
};
