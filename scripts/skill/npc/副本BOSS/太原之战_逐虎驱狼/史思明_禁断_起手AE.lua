---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_禁断_起手AE.lua
-- 更新时间:	2014/9/29 16:37:26
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 8620, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 8620, nDamageRand = 0, nCostMana = 0}, --level 4
...
--[[
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_禁断_起手AE.lua",
		0
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.BindBuff(2, 8340, dwSkillLevel);		-- 设置2号位Buff
