---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_断长生_24~28尺.lua
-- 更新时间:	2014/9/26 17:36:56
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 80400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 105000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 72300, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(8821, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8306, dwSkillLevel);		-- 设置1号位Buff
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nProtectRadius = 24 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 0;				-- 吟唱帧数，2.5秒
