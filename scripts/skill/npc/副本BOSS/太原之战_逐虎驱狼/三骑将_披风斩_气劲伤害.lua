---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_披风斩_气劲伤害.lua
-- 更新时间:	2014/7/4 11:51:52
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 17100, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 23200, nDamageRand = 1000, nCostMana = 0}, --level 2
	{nDamageBase = 33100, nDamageRand = 1500, nCostMana = 0}, --level 3
	{nDamageBase = 18100, nDamageRand = 1000, nCostMana = 0}, --level 4
