---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_回龙掌_冲刺.lua
-- 更新时间:	2014/9/25 15:49:16
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 27400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 27400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 27400, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8220, dwSkillLevel);		-- 设置1号位Buff
