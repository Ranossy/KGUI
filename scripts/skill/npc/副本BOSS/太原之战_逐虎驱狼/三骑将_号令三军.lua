---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_号令三军.lua
-- 更新时间:	2014/9/23 17:27:54
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_号令三军.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 8005, nBuffLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.AddBuff(0, 99, 8005, LV)
	local boss1 = scene.GetNpcByNickName("boss1_qingqi")
	local boss2 = scene.GetNpcByNickName("boss1_gongqi")
	if boss1 then
		boss1.AddBuff(0, 99, 8005, LV)
	end
	if boss2 then
		boss2.AddBuff(0, 99, 8005, LV)
	end
end
