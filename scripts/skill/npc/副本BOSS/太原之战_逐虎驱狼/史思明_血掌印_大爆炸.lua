---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_血掌印_大爆炸.lua
-- 更新时间:	2014/9/23 17:13:55
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 44000, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 59700, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 68300, nDamageRand = 3000, nCostMana = 0}, --level 3
	{nDamageBase = 46500, nDamageRand = 2000, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel > 2 then
		skill.BindBuff(2, 8798, 1);		-- 设置2号位Buff
	end
