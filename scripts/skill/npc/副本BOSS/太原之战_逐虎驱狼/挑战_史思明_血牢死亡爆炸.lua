---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/挑战_史思明_血牢死亡爆炸.lua
-- 更新时间:	2015/3/13 11:22:14
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 32800, nDamageRand = 1500, nCostMana = 0}, --level 1
	{nDamageBase = 32800, nDamageRand = 500, nCostMana = 0}, --level 2
