---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_漫天雪舞.lua
-- 更新时间:	2014/7/16 17:15:34
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 5800, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 5800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 5800, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/太原之战_逐虎驱狼/白陶_漫天雪舞.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	local dwSrcBuffID = 0
	if npcPP  then
		dwSrcBuffID = npcPP.dwID
	end
	if player then
		player.AddBuff(dwSrcBuffID,99,7992,buffLevel)
	elseif npcTarget then
		npcTarget.AddBuff(dwSrcBuffID,99,7992,buffLevel)
	end
end
