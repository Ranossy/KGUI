---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/三骑将_迎风射日_AOE.lua
-- 更新时间:	2014/7/9 14:58:53
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 9800, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 11600, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 16600, nDamageRand = 700, nCostMana = 0}, --level 3
	{nDamageBase = 10300, nDamageRand = 500, nCostMana = 0}, --level 4
