---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/史思明_盲眼血仆_扇形攻击.lua
-- 更新时间:	2014/9/5 11:56:45
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 20500, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 28700, nDamageRand = 2000, nCostMana = 0}, --level 2
	{nDamageBase = 40700, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 42300, nDamageRand = 2000, nCostMana = 0}, --level 4
