---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/太原之战_逐虎驱狼/三骑将_普攻_重骑.lua
-- 更新时间:	2014/9/4 15:25:47
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	...
	{nDamageBase = 44300, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 86500, nDamageRand = 5000, nCostMana = 0}, --level 2
	{nDamageBase = 157100, nDamageRand = 5000, nCostMana = 0}, --level 3
	{nDamageBase = 52800, nDamageRand = 5000, nCostMana = 0}, --level 4
...
--[[
	skill.AddAttribute(
		...
		"scripts/skill/npc/副本BOSS/太原之战·逐虎驱狼/军阵_前排士兵判断.lua",
		0
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
