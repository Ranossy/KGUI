...
tSkillData =
{
	{nDamageBase = 12740, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 7670, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	  skill.AddSlowCheckDestBuff(5391, 3, BUFF_COMPARE_FLAG.EQUAL, dwSkillLevel, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
