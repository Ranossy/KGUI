...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	  skill.AddSlowCheckDestBuff(5379, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5379, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 161 then
		scene.CreateNpc(23968, player.nX, player.nY, player.nZ, 0, 480)
	else
		scene.CreateNpc(22597, player.nX, player.nY, player.nZ, 0, 480)
	end
end
