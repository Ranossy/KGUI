...
tSkillData =
{
	{nDamageBase = 23100, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 23100, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 19800, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 19800, nDamageRand = 0, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel ==2 or dwSkillLevel == 4 then
		skill.BindBuff(1, 5309, 1);		-- 设置1号位Buff
	end
