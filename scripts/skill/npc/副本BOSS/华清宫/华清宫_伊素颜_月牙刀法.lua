...
tSkillData =
{
	{nDamageBase = 28400, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 31600, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 9500, nDamageRand = 0, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  if dwSkillLevel ==2 then
	  	skill.BindBuff(1, 5301, 1);		-- 设置1号位Buff
	  end
	...
	--skill.nRectWidth = 0 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	  ...
	  skill.nAreaRadius		= 4.5 * LENGTH_BASE;		-- 技能作用半径 
