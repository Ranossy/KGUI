...
tSkillData =
{
	{nDamageBase = 1400*0.8, nDamageRand = 1400*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 2000*0.8, nDamageRand = 2000*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 50*0.8, nDamageRand = 50*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2731, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
