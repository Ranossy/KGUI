...
tSkillData =
{
	{nDamageBase = 4900*0.8, nDamageRand = 4900*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 10300*0.8, nDamageRand = 10300*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 25*0.8, nDamageRand = 25*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2326, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
