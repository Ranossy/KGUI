...
tSkillData =
{
	{nDamageBase = 4700*0.8, nDamageRand = 4700*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 7400*0.8, nDamageRand = 7400*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 135*0.8, nDamageRand = 135*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2732, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
