...
tSkillData =
{
	{nDamageBase = 9700*0.8, nDamageRand = 9700*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 13500*0.8, nDamageRand = 13500*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
	...
	----------------- 作用范围 -------------------------------------------------
	  skill.nAngleRange		= 12;					-- 攻击范围的扇形角度范围 
