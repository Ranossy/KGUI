...
tSkillData =
{
	{nDamageBase = 1800*0.8, nDamageRand = 1800*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 2300*0.8, nDamageRand = 2300*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 60*0.8, nDamageRand = 60*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2733, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
