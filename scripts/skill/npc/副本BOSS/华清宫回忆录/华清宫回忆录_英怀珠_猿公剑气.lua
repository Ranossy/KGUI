...
tSkillData =
{
	{nDamageBase = 15800, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/华清宫回忆录/华清宫回忆录_英怀珠_猿公剑气.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
      --skill.BindBuff(1, 5241, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	npc.AddBuff(0, 99, 5241, 1)
	--]]
	
	if (npc and npc.dwTemplateID == 21306) then
		npc.AddBuff(0, 99, 5241, 1)
	end
	if (npc and npc.dwTemplateID == 21307) then
		npc.AddBuff(0, 99, 5241, 1)
	end
	if (npc and npc.dwTemplateID == 21308) then
		npc.AddBuff(0, 99, 5241, 1)
	end
	if (npc and npc.dwTemplateID == 21309) then
		npc.AddBuff(0, 99, 5241, 1)
	end
end
