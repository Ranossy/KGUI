...
tSkillData =
{
	{nDamageBase = 25300, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 25300, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 25300, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 25300, nDamageRand = 0, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.BindBuff(1, 5254, 1);		-- 设置1号位Buff
	elseif dwSkillLevel == 2 then
		skill.BindBuff(1, 5255, 1);		-- 设置1号位Buff
	elseif dwSkillLevel == 4 then
		skill.BindBuff(1, 5256, 1);		-- 设置1号位Buff
	end
