---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/华清宫回忆录/华清宫回忆录_王三金_玩家换装.lua
-- 更新时间:	2013/3/29 10:33:16
-- 更新用户:	liguanghao1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/华清宫回忆录/华清宫回忆录_王三金_玩家换装.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player then 
		if player.nGender == CHARACTER_GENDER.MALE then 
			player.AddBuff(0, 99, 5252, 1)
		end
		if player.nRoleType == ROLE_TYPE.STANDARD_FEMALE then 
			player.AddBuff(0, 99, 5252, 2)
		end
