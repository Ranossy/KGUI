---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/副本通用技能/测试用10尺范围AOE红绿通杀.lua
-- 更新时间:	2016/10/13 17:52:36
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 90000000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/副本通用技能/测试用10尺范围AOE红绿通杀.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- 施放距离 -------------------------------------------------
	skill.nMinRadius = 100 * LENGTH_BASE;		-- 技能施放的最小距离
