...
tSkillData =
{
	{ nTherapyBase = 1, 	nTherapyRand = 1,	nCostMana = 199 * 0.9},		--level 1
	{ nTherapyBase = 10638000, 	nTherapyRand = 10638000,	nCostMana = 199 * 0.9},		--level 2
	{ nTherapyBase = 10638000, 	nTherapyRand = 10638000,	nCostMana = 199 * 0.9},		--level 3
	{ nTherapyBase = 10638000, 	nTherapyRand = 10638000,	nCostMana = 199 * 0.9},		--level 4
	{ nTherapyBase = 10638000, 	nTherapyRand = 10638000,	nCostMana = 199 * 0.9},		--level 5
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute(                                                           
	...
	skill.AddAttribute(
   	...
   	"Map/阵营首领/skill/回春妙手结束.lua",								--属性值1
   	0															--属性值2
    );
