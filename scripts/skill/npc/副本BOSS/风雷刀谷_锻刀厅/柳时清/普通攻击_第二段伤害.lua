---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳时清/普通攻击_第二段伤害.lua
-- 更新时间:	2017/3/21 18:24:44
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 12650 * 1.5, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 25300 * 1.5, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 50000 * 1.5, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 100000 * 1.2, nDamageRand = 0, nCostMana = 0}, --level 4
