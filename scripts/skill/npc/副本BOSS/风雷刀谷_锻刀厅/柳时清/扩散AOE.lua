---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳时清/扩散AOE.lua
-- 更新时间:	2017/2/13 17:39:14
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6890, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 11025, nDamageRand = 0, nCostMana = 0}, --level 2
