---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳愚/幻身Aoe.lua
-- 更新时间:	2017/4/7 17:46:02
-- 更新用户:	ZHENGYUCHAO-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 19250, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳愚/幻身Aoe.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local liuyuNpc = scene.GetNpcByNickName("LiuYu")

	if mapID == 263 then  -- 10人
		liuyuNpc.SetCustomInteger1(19,0)
	elseif mapID == 271 then -- 25人
		liuyuNpc.SetCustomInteger1(21,0)
	end
