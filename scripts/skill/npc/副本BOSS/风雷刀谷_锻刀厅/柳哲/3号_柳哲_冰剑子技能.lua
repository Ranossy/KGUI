---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳哲/3号_柳哲_冰剑子技能.lua
-- 更新时间:	2017/2/7 14:51:15
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 80, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 5200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 80, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/柳哲/3号_柳哲_冰剑子技能.lua", -- 属性值1
		0															--属性值2
	);
