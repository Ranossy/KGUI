---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/六合小怪自身圆形AOE.lua
-- 更新时间:	2017/2/10 16:21:26
-- 更新用户:	ZHENGYUCHAO-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 10000, nDamageRand = 0, nCostMana = 0}, --level 2 金虎普通AOE
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 3 金虎落地一击
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 4 扫尾一击
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 5  植尸将普通攻击
