---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/没有脱离全屏针惩罚.lua
-- 更新时间:	2017/1/11 14:26:37
-- 更新用户:	ZHENGYUCHAO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 156000, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 350000, nDamageRand = 0, nCostMana = 0}, --level 2
