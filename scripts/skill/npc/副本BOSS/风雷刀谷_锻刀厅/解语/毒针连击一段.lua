---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/单体_远程_普攻.lua
-- 更新时间:	2017/1/9 15:53:24
-- 更新用户:	ZHENGYUCHAO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 27500, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 61600, nDamageRand = 0, nCostMana = 0}, --level 2
