---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/牵丝曼罗吟唱.lua
-- 更新时间:	2017/2/28 15:56:09
-- 更新用户:	ZHENGYUCHAO-PC
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/牵丝曼罗吟唱.lua", --属性值1
		0															--属性值2
	);
	...
	--	ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
	--	ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
	--	"skill/npc/副本BOSS/引仙水榭/引仙水榭_花落吟唱.lua", -- 属性值1
	--	0														-- 属性值2
	--);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	local srcNpc = GetNpc(dwCharacterID)
	if not srcNpc then
		return
	end
	srcNpc.FireAIEvent(2004, srcNpc.dwID, 1)
end
