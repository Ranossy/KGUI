---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/六合扎针.lua
-- 更新时间:	2017/1/24 17:21:54
-- 更新用户:	ZHENGYUCHAO-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3000, nDamageRand = 200, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/解语/六合扎针.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	local targetLiuHeNpc = GetNpc(dwCharacterID)
	if not targetLiuHeNpc then
		return
	end
	...
	targetLiuHeNpc.AddBuff(srcNpc.dwID, srcNpc.nLevel, 11682, 1)
end
