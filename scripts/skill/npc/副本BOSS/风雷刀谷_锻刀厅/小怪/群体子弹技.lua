---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/小怪/群体子弹技.lua
-- 更新时间:	2017/3/6 15:10:36
...
tSkillData =
{
	...
	{nDamageBase = 5250, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.nMaxRadius		= 110 * LENGTH_BASE;		-- 技能施放的最大距离
