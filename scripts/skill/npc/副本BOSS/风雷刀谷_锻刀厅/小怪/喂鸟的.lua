---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/小怪/喂鸟的.lua
-- 更新时间:	2017/2/16 17:05:24
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/小怪/喂鸟的.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11763, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		if scene.dwMapID == 263 or scene.dwMapID == 273 then
			player.AddBuff(npc.dwID, npc.nLevel, 11763, 1)
		else
			player.AddBuff(npc.dwID, npc.nLevel, 11763, 2)
		end
