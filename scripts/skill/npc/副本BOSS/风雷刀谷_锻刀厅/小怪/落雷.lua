---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_锻刀厅/小怪/落雷.lua
-- 更新时间:	2017/4/1 11:35:45
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 17500, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_锻刀厅/小怪/落雷.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11742, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		local shichaoyingzongkong = scene.GetNpcByNickName("shichaoyingzongkong")
		if shichaoyingzongkong then
			local shichaoying = scene.GetNpcByNickName("shichaoying")
			if shichaoying and shichaoying.bFightState == true then
				shichaoyingzongkong.SetCustomInteger1(41, 1)
			end
		end
	end
end
