---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/阴山圣泉/阴山圣泉_3号_蛮击.lua
-- 更新时间:	2015/3/19 11:21:37
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3200, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/阴山圣泉/阴山圣泉_3号_蛮击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	--if player.GetBuff(8834, 1) then
		--player.DelBuff(8834, 1)
	--end

	--if player.GetBuff(8834, 2) then
		--player.DelBuff(8834, 2)
	--end
end
