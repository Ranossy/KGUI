---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/阴山圣泉/阴山圣泉_2号_道具霹雳弹.lua
-- 更新时间:	2015/3/26 10:59:35
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/阴山圣泉/阴山圣泉_2号_霹雳弹特效.lua",
		0
	);
	--[[skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/npc/副本BOSS/阴山圣泉/阴山圣泉_2号_道具霹雳弹.lua", --属性值1
		0															--属性值2
	);--]]
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npc.dwTemplateID == 41831 or npc.dwTemplateID == 41831 then
		npc.SetCustomInteger1(2, 1)
	end--]]
end
