---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/阴山圣泉/阴山圣泉_3号_天一余孽普通攻击.lua
-- 更新时间:	2015/6/10 17:27:31
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3300, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/阴山圣泉/阴山圣泉_3号_天一余孽普通攻击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 204 then
		if player then
			player.AddBuff(0, 99, 9024, 1, 10)
		end

		local npc = GetNpc(dwCharacterID)
		if npc then
			npc.AddBuff(0, 99, 9024, 1, 10)
		end
	end

	if scene.dwMapID == 227 then
		if player then
			player.AddBuff(0, 99, 9024, 2, 10)
		end

		local npc = GetNpc(dwCharacterID)
		if npc then
			npc.AddBuff(0, 99, 9024, 2, 10)
		end
	end
end
