---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_玩家左翻真.lua
-- 更新时间:	2014/3/10 20:06:27
-- 更新用户:	xiedixun2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_玩家左翻真.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(7607, 1) then
		player.DelBuff(7607, 1)
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_GREEN", GetEditorString(6, 3406), 1)
	end
end
