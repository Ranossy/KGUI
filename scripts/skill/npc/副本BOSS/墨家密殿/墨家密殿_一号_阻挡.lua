---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_一号_阻挡.lua
-- 更新时间:	2014/3/4 10:24:24
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_一号_阻挡.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nNpc = GetNpc(dwSkillSrcID)
	if not nNpc then
		return
	end
	
	if tNpc.dwTemplateID == 27668 then
		tNpc.AddBuff(0, 99, 7570, 1, 10)
		if tNpc.nCurrentLife > tNpc.nMaxLife * 0.144 then
			tNpc.nCurrentLife = tNpc.nCurrentLife - tNpc.nMaxLife * 0.144
		else
			tNpc.Die()	
		end
		nNpc.Die()
