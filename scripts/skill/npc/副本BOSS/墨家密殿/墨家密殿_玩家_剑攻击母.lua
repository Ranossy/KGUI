---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_玩家_剑攻击母.lua
-- 更新时间:	2014/3/17 10:58:27
-- 更新用户:	xiedixun2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_玩家_剑攻击母.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 709);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(7633,1) then
		player.CastSkill(8981,1)
		--player.DelBuff(7633,1)
		--player.AddBuff(0,99,7633,2,1)
	elseif player.GetBuff(7633, 2) then
		player.CastSkill(8982, 1)
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 1, false)
		--player.DelBuff(7633,2)
		--player.AddBuff(7633,3)
		return
	else
		player.CastSkill(8980,1)
	end
	RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 1, true)
	--player.AddBuff(0,99,7633,1,1)
end
