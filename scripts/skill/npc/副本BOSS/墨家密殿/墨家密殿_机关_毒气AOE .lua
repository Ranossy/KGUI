---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_机关_毒气AOE .lua
-- 更新时间:	2014/3/6 17:44:50
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_机关_毒气AOE .lua", -- 属性值1
		0														-- 属性值2
	);
	--skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 7573, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if not player.GetBuff(7592, 1) then
			player.AddBuff(0, 99, 7593, 1)
			player.AddBuff(0,99,7592,1)
		end
	end
	if npc  then
		local playerEmployer = GetPlayer(npc.dwEmployer)
		if playerEmployer and not npc.GetBuff(7592, 1) then
			npc.AddBuff(0, 99, 7593, 1)
			npc.AddBuff(0,99,7592,1)
		end
	end
end
