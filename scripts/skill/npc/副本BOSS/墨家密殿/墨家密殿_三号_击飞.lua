---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_击飞.lua
-- 更新时间:	2014/3/10 19:31:48
-- 更新用户:	xiedixun2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_击飞.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 7607, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(0, 99, 7346, 1, 3) --击飞换动作
		player.SetDynamicSkillGroup(136)  --为反制做准备屏蔽技能栏
		player.PlaySfx(702, player.nX, player.nY, player.nZ)
-----------------------------------------------------------------------
		player.AddBuff(0, 99, 7607, 1)  --3层dot
		player.AddBuff(0, 99, 7607, 1)
		player.AddBuff(0, 99, 7607, 1)
-----------------------------------------------------------------------
		--player.AddBuff(0, 99, 7621, 1, nTiaoshu) --3层计数
		--player.AddBuff(0, 99, 7621, 1, nTiaoshu)
		--player.AddBuff(0, 99, 7621, 1, nTiaoshu)
-----------------------------------------------------------------------
		--player.AddBuff(0, 99, 7622, 1, nTiaoshu) --按键失败
-----------------------------------------------------------------------
		player.AddBuff(0, 99, 7606, 1, nTiaoshu)  --反制机会BUFF
