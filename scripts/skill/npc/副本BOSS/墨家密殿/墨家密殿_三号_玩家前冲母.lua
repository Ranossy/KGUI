---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_玩家前冲母.lua
-- 更新时间:	2014/3/14 11:13:00
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
Include("scripts/skill/npc/副本BOSS/秦皇陵/墨家密殿_三号_反制失败.lua")
tSkillData = 
{
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/墨家密殿/墨家密殿_三号_玩家前冲母.lua",
		0
	);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(7623, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);			-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if player.GetBuff(7626, 1) then
			player.DelBuff(7626, 1)--删除前失败
			player.Stop()
			player.Stop()
			player.CastSkill(8976, 1)
			--player.DelBuff(7621, 1) 
			--player.DelBuff(7607, 1)
