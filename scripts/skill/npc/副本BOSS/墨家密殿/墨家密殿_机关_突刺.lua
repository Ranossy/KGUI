---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/墨家密殿/墨家密殿_机关_突刺.lua
-- 更新时间:	2014/3/11 14:57:16
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 57000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/墨家密殿/墨家密殿_机关_突刺.lua", -- 属性值1
		--0														-- 属性值2
	--);
	skill.AddAttribute(                                                           
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
