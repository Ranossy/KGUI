---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_天蝉啸月.lua
-- 更新时间:	2016/5/31 16:09:49
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3450, nDamageRand = 86, nCostMana = 0}, --level 1
	{nDamageBase = 5800, nDamageRand = 145, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_天蝉啸月.lua", --属性值1
		0															--属性值2
	);
