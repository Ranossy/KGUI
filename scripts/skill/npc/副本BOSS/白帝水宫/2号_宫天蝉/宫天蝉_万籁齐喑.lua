---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_万籁齐喑.lua
-- 更新时间:	2016/7/6 20:03:48
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 14500, nDamageRand = 725, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_万籁齐喑.lua", --属性值1
		0															--属性值2
	);
