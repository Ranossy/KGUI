---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_震林碎山.lua
-- 更新时间:	2016/6/30 15:03:35
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 11960, nDamageRand = 598, nCostMana = 0}, --level 1
	{nDamageBase = 17980, nDamageRand = 899, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_震林碎山.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if  player then
		player.PlaySfx(1313, player.nX, player.nY, player.nZ)
		if player.GetBuff(10927, 1) then
			player.DelBuff(10927, 1)
		end
	end
end
