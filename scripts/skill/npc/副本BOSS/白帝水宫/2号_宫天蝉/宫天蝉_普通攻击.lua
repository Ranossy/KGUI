---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/2号_宫天蝉/宫天蝉_普通攻击.lua
-- 更新时间:	2016/6/24 14:42:30
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 16650, nDamageRand = 832, nCostMana = 0}, --level 1
	{nDamageBase = 16650, nDamageRand = 0, nCostMana = 0}, --level 2
