---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/小怪/小怪_蛮力.lua
-- 更新时间:	2016/5/16 10:28:51
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 7200, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/小怪/小怪_蛮力.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.Stop()
	player.BeHitted(player.dwID, 5265, 1, 30)
	player.AddBuff(0, 99, 10788, 1, 5)
	npc.PlaySfx(635, npc.nX, npc.nY, npc.nZ)
	--scene.SetTimer(15, "scripts/skill/npc/副本BOSS/白帝水宫/小怪/小怪_蛮力.lua", player.dwID, 1)
end
