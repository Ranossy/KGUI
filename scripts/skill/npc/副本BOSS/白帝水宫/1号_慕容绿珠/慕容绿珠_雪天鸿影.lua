---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/1号_慕容绿珠/慕容绿珠_雪天鸿影.lua
-- 更新时间:	2016/7/6 20:04:29
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10000, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 16900, nDamageRand = 845, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/1号_慕容绿珠/慕容绿珠_雪天鸿影.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 242 then
		if  player then
			player.PlaySfx(1307, player.nX, player.nY, player.nZ + 600)
