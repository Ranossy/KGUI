---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/1号_慕容绿珠/慕容绿珠_星落云散.lua
-- 更新时间:	2016/6/22 21:05:06
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 11500, nDamageRand = 575, nCostMana = 0}, --level 1
	{nDamageBase = 17400, nDamageRand = 870, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/1号_慕容绿珠/慕容绿珠_星落云散.lua", --属性值1
		0															--属性值2
	);
