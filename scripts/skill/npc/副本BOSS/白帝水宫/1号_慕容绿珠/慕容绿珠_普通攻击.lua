---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/1号_慕容绿珠/慕容绿珠_普通攻击.lua
-- 更新时间:	2016/6/24 14:38:35
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 19980, nDamageRand = 999, nCostMana = 0}, --level 1
	{nDamageBase = 19980, nDamageRand = 0, nCostMana = 0}, --level 2
