---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_剑气破空·冰诀.lua
-- 更新时间:	2016/6/14 19:24:12
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 16100, nDamageRand = 805, nCostMana = 0}, --level 1
	{nDamageBase = 21750, nDamageRand = 1087, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	--	"skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_霜凝.lua", --属性值1
	--	0															--属性值2
	--	);
