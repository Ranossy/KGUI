---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_冰结地面.lua
-- 更新时间:	2016/6/22 20:55:58
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_冰结地面.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 242 then
		if  player and not player.GetBuff(10772, 1) then
			player.AddBuff(0, 99, 10772, 1)
		end
		if player and not player.GetBuff(10773, 1) then
			player.AddBuff(0, 99, 10773, 1)
		end
	end

	if scene.dwMapID == 244 then
		if  player and not player.GetBuff(10772, 2) then
			player.AddBuff(0, 99, 10772, 2)
		end
		if player and not player.GetBuff(10773, 2) then
			player.AddBuff(0, 99, 10773, 2)
		end
	end
end
