---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_心魂俱乱·狂焰.lua
-- 更新时间:	2016/6/29 14:21:41
-- 更新用户:	yangfan14
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 9200, nDamageRand = 460, nCostMana = 0}, --level 1
	{nDamageBase = 13700, nDamageRand = 685, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_心魂俱乱·狂焰.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if  player then
		if boss then
			boss.SetCustomInteger1(5, 1)
			boss.SetCustomInteger1(7, 1)
		end
	end
end
