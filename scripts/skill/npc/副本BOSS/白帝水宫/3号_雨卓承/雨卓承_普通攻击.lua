---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/白帝水宫/3号_雨卓承/雨卓承_普通攻击.lua
-- 更新时间:	2016/6/24 14:43:28
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 21090, nDamageRand = 1054, nCostMana = 0}, --level 1
	{nDamageBase = 21090, nDamageRand = 0, nCostMana = 0}, --level 2
