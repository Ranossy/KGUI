...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_4号_小怪技能CD.lua",							
		0														
	);
...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 17022 or npc.dwTemplateID == 20267 then
		npc.FireAIEvent(2001,0,0)
	elseif npc.dwTemplateID == 17023 or npc.dwTemplateID == 20268 then
