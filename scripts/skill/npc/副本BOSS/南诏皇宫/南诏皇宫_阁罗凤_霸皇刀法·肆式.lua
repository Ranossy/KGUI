...
tSkillData =
{
	{nDamageBase = 126000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 191200, nDamageRand = 0, nCostMana = 0},		--level 2
...
for i = 1,6 do
    ...
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
       skill.AddSlowCheckDestBuff(4836, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
  	if dwSkillLevel == 2 then
		skill.BindBuff(1, 4900, 1);		-- 设置1号位Buff
    	end
