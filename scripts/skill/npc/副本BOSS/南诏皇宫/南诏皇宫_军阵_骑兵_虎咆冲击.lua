...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_骑兵_虎咆冲击.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30052 then
		cNpc.CastSkill(4609, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30053 then
		cNpc.CastSkill(4610, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4611, 1,TARGET.NPC,dwCharacterID)
	end
end
