...
tSkillData =
{
	...
	{nDamageBase = 32500, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 52000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 71500, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 91000, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 110500, nDamageRand = 0, nCostMana = 0},		--level 6
