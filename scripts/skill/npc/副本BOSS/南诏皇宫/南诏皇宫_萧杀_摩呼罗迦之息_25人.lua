...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	...
   	--skill.AddAttribute(
   		...
   		--"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_萧杀_摩呼罗迦之息.lua",				
   		--0											
   			--);
   	--end
   	...
   	--skill.AddAttribute(
   		--ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,			
   		--ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								
   		--"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_萧杀_摩呼罗迦之息_25人.lua",				
   		--0											
   			--);
   	--end
	----------------- 技能施放Buff需求 ---------------------------------------------
    ...
    skill.nChannelInterval	= 12; 				-- 通道技间隔时间 
...
function Apply(dwCharacterID)
	...
	if  not  Kungfu then 
		if player.nCurrentLife <= 7400 then
			...
			player.nCurrentLife = player.nCurrentLife - 7400
		end
		return
	end
	...
	else if player.nCurrentMana <= 4400 then
		if player.nCurrentLife <= 7400 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 7400
		end
	else player.nCurrentMana = player.nCurrentMana - 4400
		end
	end
 end
