...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4292, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local nBuff1 = cPlayer.GetBuff(4292, 1)
	if nBuff1 then
		if nBuff1.nStackNum == 6 then
			cPlayer.DelBuff(4291,1)
		end
	end
	local nBuff2 = cPlayer.GetBuff(4292, 2)
	if nBuff2 then
		if nBuff2.nStackNum == 6 then
			cPlayer.DelBuff(4291,2)
		end
	end
end
