...
tSkillData =
{
	...
	{nDamageBase = 2900, nDamageRand = 0, nCostMana = 0},		--level 2
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
    ...
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
       skill.AddSlowCheckDestBuff(4658, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
        --skill.BindBuff(1, 4658, 1);		-- 设置1号位Buff
...
function UnApply(dwCharacterID)
	...
	local npc = scene.GetNpcByNickName("BingGuanCaster" .. dwCharacterID)
	if not npc then
		return
	end
