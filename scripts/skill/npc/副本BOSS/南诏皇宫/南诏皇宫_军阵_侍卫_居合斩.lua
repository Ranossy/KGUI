...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_侍卫_居合斩.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30053 then
		cNpc.CastSkill(4541, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4542, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4543, 1,TARGET.NPC,dwCharacterID)
	end
end
