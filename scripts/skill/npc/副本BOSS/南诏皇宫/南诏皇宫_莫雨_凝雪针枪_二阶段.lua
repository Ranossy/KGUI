...
tSkillData =
{
	{nDamageBase = 4620000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 19440000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_莫雨_凝雪针枪_二阶段.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 140 then
		if npc.nCurrentLife < 4620000 then
			npc.nCurrentLife = 0
		else
			npc.nCurrentLife = npc.nCurrentLife - 4620000
		end
	elseif scene.dwMapID == 155 then
		if npc.nCurrentLife < 19440000 then
			npc.nCurrentLife = 0
		else
			npc.nCurrentLife = npc.nCurrentLife - 19440000
		end
	end
end
