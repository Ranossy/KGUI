...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_小怪_方形AOE判断.lua",								--属性值1
		0															--属性值2
	);
	...
	--skill.nProtectRadius = 0 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	  ...
	  skill.nRectWidth = 24;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	  skill.nAngleRange		= 256;					-- 攻击范围的扇形角度范围
	  skill.nAreaRadius		= 24;		-- 技能作用半径 
...
function Apply(dwCharacterID, dwSrcID)
	...
	print(npc.dwTemplateID)
	npc.FireAIEvent(2001, 0, 1)
	npc.AddBuff(0,99,5178,1,3)
end
