...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_侍卫_安纲鬼切.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30053 then
		cNpc.CastSkill(4562, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4563, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4564, 1,TARGET.NPC,dwCharacterID)
	end
end
