...
tSkillData =
{
	{nDamageBase = 10800 * 0.8, nDamageRand = 10800 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 17300 * 0.8, nDamageRand = 17300 * 0.4, nCostMana = 0},		--level 1
...
function Apply(dwCharacterID)
	...
	if  not  Kungfu then 
		if player.nCurrentLife <= 2750 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 2750
		end
		return
	end
	if Kungfu.dwSkillID == 10224 or  Kungfu.dwSkillID == 10225 or Kungfu.dwSkillID == 10144 or Kungfu.dwSkillID == 10145 or Kungfu.dwSkillID == 10242 or Kungfu.dwSkillID == 10243 then
		if player.nCurrentLife <= 2750 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 2750
		end
	else if player.nCurrentMana <= 2750 then
		if player.nCurrentLife <= 2750 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 2750
		end
	else player.nCurrentMana = player.nCurrentMana - 2750
		end
	end
 end
