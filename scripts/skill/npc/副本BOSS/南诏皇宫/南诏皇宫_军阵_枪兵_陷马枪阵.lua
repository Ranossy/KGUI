...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_枪兵_陷马枪阵.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4625, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30052 then
		cNpc.CastSkill(4626, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4627, 1,TARGET.NPC,dwCharacterID)
	end
end
