...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_侍卫_天业云切.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30053 then
		cNpc.CastSkill(4552, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4553, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4554, 1,TARGET.NPC,dwCharacterID)
	end
end
