...
tSkillData =
{
	{nDamageBase = 15300, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(5102, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
         skill.BindBuff(1, 5066, dwSkillLevel);		-- 设置1号位Buff
	  skill.BindBuff(2, 5102, 1);		-- 设置2号位Buff
