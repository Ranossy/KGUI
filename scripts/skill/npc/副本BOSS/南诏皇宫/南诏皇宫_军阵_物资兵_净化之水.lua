...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_物资兵_净化之水.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30055 then
		cNpc.CastSkill(4578, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30057 then
		cNpc.CastSkill(4579, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4580, 1,TARGET.NPC,dwCharacterID)
	end
end
