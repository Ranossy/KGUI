...
tSkillData =
{
	{nDamageBase = 7400, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4299, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 140 then
		cNpc.CastSkill(4257, 1, TARGET.PLAYER, dwCharacterID)
	end
	if scene.dwMapID == 155 then
		cNpc.CastSkill(4257, 2, TARGET.PLAYER, dwCharacterID)
	end
end
