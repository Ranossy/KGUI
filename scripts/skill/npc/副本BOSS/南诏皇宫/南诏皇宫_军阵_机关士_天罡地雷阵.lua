---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_机关士_天罡地雷阵.lua
-- 更新时间:	2016/1/8 15:19:26
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 8960, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_机关士_天罡地雷阵.lua",
		0
	);
