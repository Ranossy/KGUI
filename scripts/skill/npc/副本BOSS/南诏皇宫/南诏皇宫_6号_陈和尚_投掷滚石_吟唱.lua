...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_6号_陈和尚_投掷滚石_吟唱.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	scene.CreateNpc(21594, npc.nX + 8 * 64 * math.cos(nDir), npc.nY + 8 * 64 * math.sin(nDir), npc.nZ, npc.nFaceDirection, 480)
end
