...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
         skill.BindBuff(1, 4473, dwSkillLevel);		-- 设置1号位Buff
...
function UnApply(dwCharacterID)
	...
	local nDir = cNpc.nFaceDirection * 2 * math.pi / 255
	local N_X = cNpc.nX  + 64  * math.cos(nDir)
	local N_Y = cNpc.nY + 64 * math.sin(nDir)
	cNpc.RunTo(N_X, N_Y)
end
