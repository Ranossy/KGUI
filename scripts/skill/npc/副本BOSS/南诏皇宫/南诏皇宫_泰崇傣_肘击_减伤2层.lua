...
tSkillData =
{
	{nDamageBase = 29800, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 400000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 96200, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 962000, nDamageRand = 0, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(4291, 2, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
