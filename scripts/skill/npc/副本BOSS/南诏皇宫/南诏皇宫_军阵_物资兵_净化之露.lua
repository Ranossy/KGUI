...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_物资兵_净化之露.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30055 then
		cNpc.CastSkill(4585, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30057 then
		cNpc.CastSkill(4586, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4587, 1,TARGET.NPC,dwCharacterID)
	end
end
