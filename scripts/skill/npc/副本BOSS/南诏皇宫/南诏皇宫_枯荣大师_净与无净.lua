...
tSkillData =
{
	{nDamageBase = 1100000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 8470000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"Map/南诏皇宫/skill/净与无净成就.lua",								--属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4249, dwSkillLevel);		-- 设置1号位Buff
