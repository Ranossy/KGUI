...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddAttribute(
			...
			"Map/南诏皇宫/skill/六脉神剑成就.lua",								--属性值1
			0															--属性值2
		);
	else
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,			-- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
			"Map/英雄南诏皇宫/skill/六脉神剑成就.lua",								--属性值1
			0															--属性值2
		);
	end
	...
	skill.AddSlowCheckDestBuff(4256, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
