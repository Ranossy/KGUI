...
tSkillData =
{
	{nDamageBase = 1700*0.8, nDamageRand = 1700*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 2700*0.8, nDamageRand = 2700*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 4308, 1);		-- 设置1号位Buff
