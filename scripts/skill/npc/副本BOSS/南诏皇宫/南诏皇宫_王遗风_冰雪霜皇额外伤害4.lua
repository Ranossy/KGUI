...
tSkillData =
{
	{nDamageBase = 16000*0.95, nDamageRand = 16000*0.1, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(4309, 4, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
