...
tSkillData =
{
	{nDamageBase = 203000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 203000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(4256, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
