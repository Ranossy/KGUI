...
tSkillData =
{
	{nDamageBase = 483170, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 483170, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_6号_康雪烛_玉石俱焚·狂骨_3层.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	local npc1 = scene.GetNpcByNickName("LiTanzongkong")
	if npc1 then
		npc1.SetCustomBoolean(9, true)
	end
end
