...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_枪斗士_虎牙炎枪阵.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if Num < 21 then
		tNpc.AddBuff(0,99,4613,1)
	end	
	if tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4657, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30052 then
		cNpc.CastSkill(4658, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4659, 1,TARGET.NPC,dwCharacterID)
	end
end
