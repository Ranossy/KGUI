...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_王遗风_冰雪霜皇_25人.lua",				
   		0														
   		);
...
local character = nil
	...
	if character then
		if not character.GetBuff(4309,2) then
			character.AddBuff(0, 99, 4309, 3)
		end
		local buff = character.GetBuff(4309,3)
		if buff and buff.nStackNum == 10 then
			character.AddBuff(0,99,4309,2)
		end
	end
end
