...
tSkillData =
{
	{nDamageBase = 38100, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 84000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 107000, nDamageRand = 0, nCostMana = 0},		--level 3
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 140 then
		scene.CreateNpc(18799, cPlayer.nX, cPlayer.nY, cPlayer.nZ, cPlayer.nFaceDirection, -1)
	end
