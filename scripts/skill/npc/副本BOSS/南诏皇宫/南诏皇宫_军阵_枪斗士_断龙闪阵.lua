...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_枪斗士_断龙闪阵.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4648, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30052 then
		cNpc.CastSkill(4649, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4650, 1,TARGET.NPC,dwCharacterID)
	end
end
