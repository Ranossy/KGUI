...
tSkillData =
{
	...
	{nDamageBase = 22300, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4474, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 140 then
		if player.nCurrentMana > 850 then
			player.nCurrentMana = player.nCurrentMana - 850
		else
			player.nCurrentMana = 0
		end
	end
	if scene.dwMapID == 155 then
		if player.nCurrentMana > 4000 then
			player.nCurrentMana = player.nCurrentMana - 4000
		else
			player.nCurrentMana = 0
		end
	end
