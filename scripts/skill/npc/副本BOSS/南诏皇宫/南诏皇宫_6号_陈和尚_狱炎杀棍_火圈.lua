...
function GetSkillLevelData(skill)
    ...
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
      skill.AddSlowCheckDestBuff(5101, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
        skill.BindBuff(1, 5065, dwSkillLevel);		-- 设置1号位Buff
	  skill.BindBuff(2, 5101, 1);		-- 设置2号位Buff
   ...
   --skill.nChannelFrame		= 64;	 			-- 通道技持续时间，单位帧数 
