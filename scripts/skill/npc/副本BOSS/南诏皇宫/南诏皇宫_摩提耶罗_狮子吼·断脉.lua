...
tSkillData =
{
	{nDamageBase = 254000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 301000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(4849, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
      skill.AddSlowCheckDestBuff(5204, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
