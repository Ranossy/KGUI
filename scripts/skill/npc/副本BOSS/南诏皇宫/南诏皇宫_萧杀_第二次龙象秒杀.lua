...
tSkillData =
{
	{nDamageBase = 166000*0.8, nDamageRand = 166000*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 256000*0.8, nDamageRand = 256000*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(4791, 3, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 4791, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	--if not character then
		--return
	--end
	--if character.GetBuff(4791, 1) then
		--character.Die()
	--end
end
