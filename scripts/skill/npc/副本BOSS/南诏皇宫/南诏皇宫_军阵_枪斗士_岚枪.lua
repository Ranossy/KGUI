...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/南诏皇宫/南诏皇宫_军阵_枪斗士_岚枪.lua",							
		0														
	);
...
function Apply(dwCharacterID,dwSkillSrcID)
	...
	if Num < 11 then
		tNpc.AddBuff(0,99,4604,1)
	end
	if tNpc.dwModelID == 30056 then
		cNpc.CastSkill(4637, 1,TARGET.NPC,dwCharacterID)
	elseif  tNpc.dwModelID == 30052 then
		cNpc.CastSkill(4638, 1,TARGET.NPC,dwCharacterID)
	else
		cNpc.CastSkill(4639, 1,TARGET.NPC,dwCharacterID)
	end
end
