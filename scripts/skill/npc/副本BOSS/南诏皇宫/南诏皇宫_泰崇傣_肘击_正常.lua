...
tSkillData =
{
	{nDamageBase = 149000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 2000000, nDamageRand = 0, nCostMana = 0},		--level 2  对NPC使用
	{nDamageBase = 481000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 4760000, nDamageRand = 0, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(4291, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4283, 1);		-- 设置1号位Buff
