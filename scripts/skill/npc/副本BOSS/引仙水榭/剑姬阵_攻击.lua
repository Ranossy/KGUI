---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/引仙水榭/剑姬阵_攻击.lua
-- 更新时间:	2015/6/11 20:40:05
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 860, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1510, nDamageRand = 0, nCostMana = 0}, --level 2
