---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/引仙水榭/平花秀夜_冲刺.lua
-- 更新时间:	2015/6/27 16:05:17
-- 更新用户:	zhengyuchao
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel; --等级表示冲击多少尺 最大为80尺
	if dwSkillLevel > 80 then
		dwSkillLevel = 80
	end
	...
	skill.AddAttribute(
		...
		math.floor(dwSkillLevel*64/72) /accelerate,
		80 * accelerate
	);
	--[[
   	skill.AddAttribute(
