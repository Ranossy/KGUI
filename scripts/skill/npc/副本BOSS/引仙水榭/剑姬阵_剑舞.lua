---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/引仙水榭/剑姬阵_剑舞.lua
-- 更新时间:	2015/10/11 19:54:08
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/引仙水榭/剑姬阵_剑舞.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9032, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	print(npcboss.szName)
	if npc then
		if npc.szName == "JianJiZhen_jing" then
			npcboss.AddBuff(0, 99, 9038, nLevel)
		elseif npc.szName == "JianJiZhen_bi" then
			npcboss.AddBuff(0, 99, 9039, nLevel)
		elseif npc.szName == "JianJiZhen_ning" then
			npcboss.AddBuff(0, 99, 9040, nLevel)
		elseif npc.szName == "JianJiZhen_jie" then
			npcboss.AddBuff(0, 99, 9041, nLevel)
		elseif npc.szName == "JianJiZhen_gong" then
			npcboss.AddBuff(0, 99, 9042, nLevel)
		end
	end
