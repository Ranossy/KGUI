---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/引仙水榭/引仙水榭_剑姬阵_被击回血.lua
-- 更新时间:	2015/6/24 16:46:48
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 23832, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/引仙水榭/引仙水榭_剑姬阵_被击回血.lua",
		0
		);
