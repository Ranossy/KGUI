------------------------------------------------
-- 文件名    :  天子峰_小怪_楚秀弄月弟子、昭秀舞风弟子_剑主天地(DEBUFF).lua
-- 创建人    :  韩正春
-- 创建时间  :  2009-5-21
-- 用途(模块):  副本
-- 武功门派  :  天子峰_小怪_楚秀弄月弟子、昭秀舞风弟子_剑主天地(DEBUFF)
-- 武功类型  :  
-- 武功套路  :  
-- 技能名称  :  
-- 技能效果  : 对当前目标造成1849.68点（造成防御天策22.7%血量伤害）混元性内功伤害，技能有效距离0~25米,CD10秒，并使目标移动速度降低50%，持续8秒。
----------------------低调的分割线--------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 1154, 1);		-- 设置1号位Buff
