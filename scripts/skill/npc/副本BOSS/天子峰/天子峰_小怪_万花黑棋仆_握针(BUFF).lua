------------------------------------------------
-- 文件名    :  英雄三才阵_3号BOSS_朴宗资_神机箭(DOT).lua
-- 创建人    :  韩正春
-- 创建时间  :  2009-5-21
-- 用途(模块):  副本
-- 武功门派  :  天子峰_小怪_万花黑棋仆_握针(BUFF)
-- 武功类型  :  
-- 武功套路  :  
-- 技能名称  :  
-- 技能效果  : 使当前敌对玩家仇恨列表中的最少血的友方目标（可以是自己）每3秒恢复的气血值提高677点(3%,NPC血量22736)，持续18秒，CD20秒。可驱散
----------------------低调的分割线--------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 1105, 1);		-- 设置1号位Buff
