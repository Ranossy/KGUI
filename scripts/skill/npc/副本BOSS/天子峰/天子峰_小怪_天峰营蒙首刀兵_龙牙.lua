------------------------------------------------
-- 文件名    :  天子峰_小怪_天峰营蒙首刀兵_龙牙.lua
-- 创建人    :  韩正春
-- 创建时间  :  2009-5-21
-- 用途(模块):  副本
-- 武功门派  :  天子峰_小怪_天峰营蒙首刀兵_龙牙
-- 武功类型  :  
-- 武功套路  :  
-- 技能名称  :  
-- 技能效果  :  对当前目标造成6835点（造成防御天策50%血量伤害）外功伤害，CD4秒。
----------------------低调的分割线--------------------------
...
{                                                                                     
	...
	{nDamageBase = 8350  *0.8, nDamageRand = 8350  *0.4, nCostMana = 0},		--level 17		
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
  	--skill.AddSlowCheckSelfBuff(1159, 1,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);			-- 需求自身Buff
   	skill.AddSlowCheckDestBuff(1159, 1,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);				-- 需求目标Buff
