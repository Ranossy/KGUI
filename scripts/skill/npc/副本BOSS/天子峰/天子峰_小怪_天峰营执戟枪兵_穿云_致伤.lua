------------------------------------------------
-- 文件名    :  天子峰_小怪_天峰营执戟枪兵_穿云_致伤.lua
-- 创建人    :  韩正春
-- 创建时间  :  2009-5-21
-- 用途(模块):  副本
-- 武功门派  : 天子峰_小怪_天峰营执戟枪兵_穿云_致伤
-- 武功类型  :  
-- 武功套路  :  
-- 技能名称  :  
-- 技能效果  : 三层致伤DEBUFF
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
    skill.AddSlowCheckDestBuff(1106, 2,BUFF_COMPARE_FLAG.GREATER_EQUAL,0, BUFF_COMPARE_FLAG.GREATER_EQUAL);			-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1,1159,1);										-- 设置1号位Buff
