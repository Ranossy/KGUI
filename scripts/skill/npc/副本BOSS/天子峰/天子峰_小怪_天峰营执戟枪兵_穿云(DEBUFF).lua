------------------------------------------------
-- 文件名    :  天子峰_小怪_天峰营蒙首刀兵_穿云.lua
-- 创建人    :  韩正春
-- 创建时间  :  2009-5-21
-- 用途(模块):  副本
-- 武功门派  :  天子峰_小怪_天峰营蒙首刀兵_穿云
-- 武功类型  :  
-- 武功套路  :  
-- 技能名称  :  
-- 技能效果  :对当前目标造成1574点（造成防御天策11%血量伤害）外功伤害,CD4秒，并造成1层致伤DEBUFF（受到的伤害提高1%，可叠加三层,持续10秒），三层致伤DEBUFF转化为致残DEBUFF（受到的伤害提高5%，龙牙发动条件，持续10秒）不能驱散。搿?                                   
----------------------低调的分割线--------------------------
...
function GetSkillLevelData(skill)
    ...
    --skill.nBrokenRate         = 100 * PERCENT_BASE;		-- 技能被打断的概率,默认1024
