...
tSkillData =
{
	{nDamageBase = 6700 * 0.8, nDamageRand = 6700 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 297 * 0.8, nDamageRand = 297 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 7500 * 0.8, nDamageRand = 7500 * 0.4, nCostMana = 0},		--level 3
	...
	{nDamageBase = 8500 * 0.8, nDamageRand = 8500 * 0.4, nCostMana = 0},		--level 15
