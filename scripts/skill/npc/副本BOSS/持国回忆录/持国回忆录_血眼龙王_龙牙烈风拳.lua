...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/持国回忆录/持国回忆录_血眼龙王_龙牙烈风拳.lua",								--属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 3542, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 131 then
		local num = Random(99)
		if num < 34 then
			cNpc.CastSkill(3540,1)
		elseif num < 67 then
			cNpc.CastSkill(3541,1)
		else
			cNpc.CastSkill(3542,1)
		end
	end
	if scene.dwMapID == 148 then
		local num = Random(99)
		if num < 34 then
			cNpc.CastSkill(3540,2)
		elseif num < 67 then
			cNpc.CastSkill(3541,2)
		else
			cNpc.CastSkill(3542,2)
		end
	end
end
