...
tSkillData =
{
	{nDamage = 3000, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
   	...
   	----------------- 魔法属性 -------------------------------------------------
		...
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
	   		...
	   		"skill/npc/副本BOSS/持国回忆录/持国回忆录_白龙长老_命脉之源.lua",	        			-- 属性值1
			0
		);
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 3967, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if cNpc.nCurrentLife < cNpc.nMaxLife * 0.8 then
		cNpc.nCurrentLife = cNpc.nCurrentLife + cNpc.nMaxLife * 0.2
	else 
