...
local tDirection = {}
	...
	tDirection[9] = npc.nFaceDirection -120 % 256
	tDirection[10] = npc.nFaceDirection - 150 % 256
	tDirection[11] = npc.nFaceDirection + 150 % 256
	tDirection[12] = npc.nFaceDirection + 180 % 256
	for i = 1 ,12 do
