...
tSkillData =
{
	{nDamage = 10300, nDamageRand = 695, nCostMana = 0},		--level 1
	{nDamage = 14900, nDamageRand = 745, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/持国回忆录/持国回忆录_血眼龙王_苍龙惊天掌_远.lua",				-- 属性值1
   		0														-- 属性值2
   	);
...
function Apply(dwCharacterID)
         ...
         if player then
                   ...
                   local npc = scene.GetNpcByNickName("longwang")
                   ...
                   if npc then				
                            ...
                            if nNow <= nMax then
                                     ...
                                     if scene.dwMapID ==131 then
                                     	npc.CastSkill(3523, 1)
                                     elseif scene.dwMapID ==148 then
                                     	npc.CastSkill(3523, 2) 
                                     end
