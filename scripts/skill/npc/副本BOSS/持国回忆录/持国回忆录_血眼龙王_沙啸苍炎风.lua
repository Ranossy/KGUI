...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 ------------------------------------------------
   	   	...
   	   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/持国回忆录/持国回忆录_血眼龙王_沙啸苍炎风.lua",								--属性值1
   			0															--属性值2
   		);
	...
	----------------- BUFF相关 -------------------------------------------------
   --skill.BindBuff(1, 3532, 1);		-- 设置1号位Buff
...
local tDirection = {}
	...
	tDirection[4] = npc.nFaceDirection - 120 % 256
	tDirection[5] = npc.nFaceDirection + 120 % 256
  for	i = 1, 5 do  
		...
		local npcYb = scene.CreateNpc(14894, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, -1)
		if npcYb then
			npcYb.RunTo(nX, nY)
		end
	end	
