...
tSkillData =
{
	{nDamageBase = 12400*0.8, nDamageRand = 12400*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 23400*0.8, nDamageRand = 23400*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 3544, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if cPlayer.nCurrentLife >cPlayer.nMaxLife * 0.95 then
		cPlayer.DelBuff(3544,1)
		cPlayer.DelBuff(3544,2)
	end
