...
tSkillData =
{
	{nDamage = 4300, nDamageRand = 215, nCostMana = 0},		--level 1
	{nDamage = 6600, nDamageRand = 330, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 3528, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if cPlayer.nCurrentLife >cPlayer.nMaxLife * 0.95 then
		cPlayer.DelBuff(3528,1)
		cPlayer.DelBuff(3528,2)
	end
end
