------------------------------------------------
-- 文件名    :  日轮山城_2号BOSS_雾影奈叶_忍法·炎朱雀.lua
-- 创建人    : 陈步高
-- 创建时间  :  2009-4-15
-- 用途(模块):  副本BOSS
-- 武功门派  :  日轮山城
...
tSkillData =
{
	{nDamageBase = 380, nDamageRand = 0, nCostMana = 2493},		--level 1
	{nDamageBase = 380, nDamageRand = 0, nCostMana = 2493},		--level 2
	{nDamageBase = 380, nDamageRand = 0, nCostMana = 2493},		--level 3
	{nDamageBase = 380,  nDamageRand = 0, nCostMana = 2493},		--level 4
