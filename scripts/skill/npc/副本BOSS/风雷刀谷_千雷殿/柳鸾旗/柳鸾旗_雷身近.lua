---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳鸾旗/柳鸾旗_雷身近.lua
-- 更新时间:	2016/12/12 17:08:20
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 18200, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 105000, nDamageRand = 0, nCostMana = 0}, --level 2
