---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳鸾旗/柳鸾旗_雷食兽雷吟.lua
-- 更新时间:	2016/12/20 14:40:30
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 29750, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 29750, nDamageRand = 0, nCostMana = 0}, --level 4
