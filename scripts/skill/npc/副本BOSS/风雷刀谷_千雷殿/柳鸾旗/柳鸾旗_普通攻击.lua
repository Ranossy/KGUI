---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳鸾旗/柳鸾旗_普通攻击.lua
-- 更新时间:	2016/12/5 14:12:31
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 70400, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳鸾旗/柳鸾旗_普通攻击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if playertarget then
		...
		if scene.dwMapID == 264 or scene.dwMapID == 272 then
			playertarget.AddBuff(playertarget.dwID, playertarget.nLevel, 11553, 1, 40)
		end

		if scene.dwMapID == 270 then
			playertarget.AddBuff(playertarget.dwID, playertarget.nLevel, 11553, 2, 40)
		end
	end
end
