---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_闪鸣真枪水1.lua
-- 更新时间:	2017/4/18 21:25:57
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 8750, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_闪鸣真枪水1.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then
		local npcSMZQ = scene.CreateNpc(56022, player.nX, player.nY, player.nZ + 5000, 0, - 1)
	end

	if scene.dwMapID == 270 then
		local npcSMZQ = scene.CreateNpc(56873, player.nX, player.nY, player.nZ + 5000, 0, - 1)
	end
end
