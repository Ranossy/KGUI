---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_灼烧吞噬高伤.lua
-- 更新时间:	2017/4/17 10:55:51
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 15000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 20000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 5
	--{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0}, --level 6
	--{nDamageBase = 10000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 20000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 35000, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 12
};
