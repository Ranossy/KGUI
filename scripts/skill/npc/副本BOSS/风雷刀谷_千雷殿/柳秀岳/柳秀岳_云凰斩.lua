---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_云凰斩.lua
-- 更新时间:	2017/3/10 17:13:37
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_云凰斩.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then
		npc.CastSkill(17492, 1)
		if npc.GetBuff(11779, 1) then
			local Nbuff = npc.GetBuff(11779, 1)
			local Num = Nbuff.nStackNum
			if Num == 1 then
				npc.CastSkill(17494, 1)
				npc.DoAction(0, 10058)
				npc.PlaySfx(8734, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256, 45)
			end		--一层火
			if Num == 2 then
				npc.CastSkill(17495, 1)
				npc.DoAction(0, 10066)
				npc.PlaySfx(8733, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256)
			end		--二层火
			if Num == 3 then
				npc.CastSkill(17496, 1)
				npc.DoAction(0, 10060)
				npc.PlaySfx(8732, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256)
			end		--三层火
		end
	else
		npc.CastSkill(17492, 2)
		if npc.GetBuff(11779, 2) then
			local Nbuff = npc.GetBuff(11779, 2)
			local Num = Nbuff.nStackNum
			if Num == 1 then
				npc.CastSkill(17494, 2)
				npc.DoAction(0, 10058)
				npc.PlaySfx(8734, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256, 45)
			end		--一层火
			if Num == 2 then
				npc.CastSkill(17495, 2)
				npc.DoAction(0, 10066)
				npc.PlaySfx(8733, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256)
			end		--二层火
			if Num == 3 then
				npc.CastSkill(17496, 2)
				npc.DoAction(0, 10060)
				npc.PlaySfx(8732, npc.nX, npc.nY, npc.nZ + 512, 360 * npc.nFaceDirection / 256)
			end		--三层火
		end
