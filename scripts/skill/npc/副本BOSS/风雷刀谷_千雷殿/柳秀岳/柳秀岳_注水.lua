...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_注水.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	skill.nAreaRadius	= 4 * LENGTH_BASE;		-- 技能作用半径向量方向平移点数(正数为正向量方向，负数为反向)
	----------------- 时间相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.GetBuff(11946, 1) then
		npc.DelGroupBuff(11946, 1)
		npc.PlaySfx(1549, npc.nX, npc.nY, npc.nZ+512)
	end
	npc.AddBuff(npc.dwID, npc.nLevel, 11951, 1)
	npc.PlaySfx(8777, npc.nX, npc.nY, npc.nZ+512)
end
