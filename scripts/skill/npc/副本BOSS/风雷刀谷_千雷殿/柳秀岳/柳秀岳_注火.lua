...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_注火.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.GetBuff(11945, 1) then
		npc.DelGroupBuff(11945, 1)
		npc.PlaySfx(1549, npc.nX, npc.nY, npc.nZ)
	end
	npc.PlaySfx(1336, 0, 0, 0)
	npc.AddBuff(npc.dwID, npc.nLevel, 11950, 1)
