---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_灼烧点爆高伤.lua
-- 更新时间:	2017/4/17 11:10:33
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 8
