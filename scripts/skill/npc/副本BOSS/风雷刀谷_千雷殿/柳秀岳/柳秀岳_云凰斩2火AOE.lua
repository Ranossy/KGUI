---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_云凰斩2火AOE.lua
-- 更新时间:	2017/3/10 18:06:27
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_云凰斩2火AOE.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then
		...
		if player.GetBuff(11772, 1) then
			...
			if Num > 2 then
				npc.CastSkill(17600, Num, TARGET.PLAYER, player.dwID)		--灼烧吞噬高伤
				player.DelGroupBuff(11772, 1)
			end
		end
	else
		...
		if player.GetBuff(11804, 2) then
			...
			local Num = Nbuff.nStackNum
			if Num > 2 then
				npc.CastSkill(17600, Num + 5, TARGET.PLAYER, player.dwID)		--灼烧吞噬高伤
