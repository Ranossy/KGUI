---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_加火Buff.lua
-- 更新时间:	2017/3/10 9:58:32
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_加火Buff.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then
		npc.AddBuff(npc.dwID, npc.nLevel, 11779, 1)		--加火buff
		if npc.GetBuff(11777, 1) then
			npc.DelBuff(11777, 1)
			npc.DelBuff(11779, 1)
			npc.AddBuff(npc.dwID, npc.nLevel, 11931, 1)
		end		--金+火=0
	end
	...
	if npc.GetBuff(11775, 1) then
		local nNum = npc.GetBuff(11775, 1).nStackNum
		npc.DelGroupBuff(11775, 1)
		for i = 1, nNum do
	...
	if scene.dwMapID == 270 then
		npc.AddBuff(npc.dwID, npc.nLevel, 11779, 2)		--加火buff
		if npc.GetBuff(11777, 2) then
			npc.DelBuff(11777, 2)
			npc.DelBuff(11779, 2)
			npc.AddBuff(npc.dwID, npc.nLevel, 11931, 2)
		end		--金+火=0
		...
		if npc.GetBuff(11775, 2) then
			local nNum = npc.GetBuff(11775, 2).nStackNum
			npc.DelGroupBuff(11775, 2)
			for i = 1, nNum do
