---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_断空雷切土2.lua
-- 更新时间:	2017/5/9 16:05:55
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_断空雷切土2.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then
		player.AddBuff(npc.dwID, npc.nLevel, 11907, 1)
		if not player.GetBuff(11909, 1) then
			player.AddBuff(npc.dwID, npc.nLevel, 11911, 1)
		end
		player.AddBuff(npc.dwID, npc.nLevel, 11910, 1)
	else
		player.AddBuff(npc.dwID, npc.nLevel, 11907, 2)
		if not player.GetBuff(11909, 2) then
			player.AddBuff(npc.dwID, npc.nLevel, 11911, 2)
		end
