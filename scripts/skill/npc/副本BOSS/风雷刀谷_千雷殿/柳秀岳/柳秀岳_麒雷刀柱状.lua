---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_麒雷刀柱状.lua
-- 更新时间:	2017/5/10 14:24:52
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 82500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 132000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_麒雷刀柱状.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	skill.nHeight = 90 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	for i = 1, 6 do
		local yinleikong = scene.GetNpcByNickName("yinleikong_" .. i)
		if yinleikong then
			yinleikong.PlaySfx(8670, player.nX, player.nY, player.nZ)
			yinleikong.CastSkillXYZ(17596, 1, player.nX, player.nY, player.nZ)
		end
	end
end
