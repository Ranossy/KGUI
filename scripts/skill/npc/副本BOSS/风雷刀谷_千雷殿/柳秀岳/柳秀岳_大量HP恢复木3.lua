---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_大量HP恢复木3.lua
-- 更新时间:	2017/5/2 17:41:54
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_大量HP恢复木3.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--回血
	if npc.nCurrentLife >= npc.nMaxLife * 0.9 then
	...
	if scene.dwMapID == 264 or scene.dwMapID == 272 then--攻击力buff
		--npc.AddBuff(npc.dwID, npc.nLevel, 11939, 1)
	else
		npc.AddBuff(npc.dwID, npc.nLevel, 11939, 2)
	end
end
