---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_千雷招来球体.lua
-- 更新时间:	2017/2/28 20:23:58
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2600, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 7000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 46000, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_千雷招来球体.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- 施放距离 -------------------------------------------------
	skill.nMinRadius	= 9 * LENGTH_BASE;		-- 技能施放的最小距离
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nProtectRadius = 9 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(11897, 1) then
		npc.CastSkillXYZ(17636, 1, player.nX, player.nY, player.nZ)		--炸团AOE
	end
end
