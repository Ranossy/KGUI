...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_淬水.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(npc.dwID, npc.nLevel, 11897, 2)
	player.AddBuff(npc.dwID, npc.nLevel, 11960, 1)
	if player.nMoveState == MOVE_STATE.ON_RUN then
		player.PlaySfx(8774, player.nX, player.nY, player.nZ)
	end
end
