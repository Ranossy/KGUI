---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_熔断伤害可被打断.lua
-- 更新时间:	2017/5/10 18:30:08
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 13750, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 13750, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/柳秀岳/柳秀岳_熔断伤害可被打断.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
