---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_小火焰.lua
-- 更新时间:	2017/1/9 16:36:01
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_小火焰.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	local nBoss = scene.GetNpcByNickName("yimamu")
	if not nBoss then
		return
	end

	nBoss.AddBuff(nBoss.dwID, nBoss.nLevel, 11599, 1)--]]
end
