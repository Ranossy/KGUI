---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_滚石冲撞实际伤害.lua
-- 更新时间:	2017/4/26 9:41:54
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 14300, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 15925, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_滚石冲撞实际伤害.lua", --属性值1
		0															--属性值2
	);
