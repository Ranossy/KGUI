---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_元火.lua
-- 更新时间:	2017/1/9 16:18:56
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_元火.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 270 then
		if player.nCurrentLife < player.nMaxLife * 0.3 then
			...
			player.nCurrentLife = player.nCurrentLife * 0.35
		end
	end
end
