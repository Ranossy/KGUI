---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_移形化火.lua
-- 更新时间:	2017/1/9 16:23:04
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 11700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 16800, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雷刀谷_千雷殿/伊玛目/伊玛目_移形化火.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAngleRange = 65;					-- 攻击范围的扇形角度范围
	...
	if playertarget then
		if npc then
			...
			if scene.dwMapID == 264 or scene.dwMapID == 272 then
				npc.AddBuff(npc.dwID, npc.nLevel, 11599, 1)
			end
