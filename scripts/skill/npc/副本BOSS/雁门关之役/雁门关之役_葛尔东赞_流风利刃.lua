---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_葛尔东赞_流风利刃.lua
-- 更新时间:	2014/10/23 16:59:34
-- 更新用户:	wanglpengfei
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 30400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 30400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 30400, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(5392, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5391, dwSkillLevel);		-- 设置1号位Buff
	--skill.BindBuff(2, 5392, 1);		-- 设置2号位Buff
	...
	----------------- 作用范围 -------------------------------------------------
	local nNum = dwSkillLevel
	if nNum > 4 then
		nNum = nNum - 4	
	end
	skill.nProtectRadius = 5 * LENGTH_BASE * (nNum + 1);                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	--skill.nHeight = 0 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	--skill.nRectWidth = 0 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	skill.nAngleRange = 224;					-- 攻击范围的扇形角度范围
	skill.nAreaRadius = 5 * LENGTH_BASE * (nNum + 2);		-- 技能作用半径
