---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_逃往雁门关_狼牙兵斧劈.lua
-- 更新时间:	2014/9/12 15:06:44
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 34800, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 120, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/雁门关之役/雁门关之役_逃往雁门关_狼牙兵斧劈.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if player then
		scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_逃往雁门关_狼牙兵斧劈.lua", player.dwID, 1)
		--player.PlaySfx(553, player.nX, player.nY, player.nZ + 500)
	end

	if npctarget then
		scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_逃往雁门关_狼牙兵斧劈.lua", npctarget.dwID, 1)
	end
end
