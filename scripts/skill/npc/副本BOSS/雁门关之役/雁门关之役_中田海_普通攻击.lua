---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_中田海_普通攻击.lua
-- 更新时间:	2014/9/28 10:45:16
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 53800, nDamageRand = 2000, nCostMana = 0}, --level 1
	{nDamageBase = 400, nDamageRand = 50, nCostMana = 0}, --level 2
	{nDamageBase = 27500, nDamageRand = 2000, nCostMana = 0}, --level 3
	{nDamageBase = 86200, nDamageRand = 2000, nCostMana = 0}, --level 4
	{nDamageBase = 107700, nDamageRand = 2000, nCostMana = 0}, --level 5
	{nDamageBase = 28500, nDamageRand = 2000, nCostMana = 0}, --level 6
