---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_拓跋离_主角技能_躲避_左.lua
-- 更新时间:	2014/10/8 11:32:23
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/雁门关之役/雁门关之役_拓跋离_主角技能_躲避_左.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	--playercaster.CastSkill(9005, 1)
	playercaster.ClearCDTime(167)
	playercaster.ClearCDTime(88)
	playercaster.AddBuff(0, 99, 8258, 1)
end
