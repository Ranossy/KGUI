---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_拓跋离_主角技能_躲避_扶摇.lua
-- 更新时间:	2017/3/19 16:24:40
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 25800, nDamageRand = 2000, nCostMana = 0}, --level 1（内城狼牙）
	{nDamageBase = 28000, nDamageRand = 2000, nCostMana = 0}, --level 2（狼牙校尉)
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/雁门关之役/雁门关之役_拓跋离_主角技能_躲避_扶摇.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 811);	--技能普通CD
	--skill.SetCheckCoolDown(1, 88);	--只检查不走的CD
	----------------- 经验升级相关 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	playercaster.AddBuff(0, 99, 208, 1, 30)
	playercaster.Jump(true, 0)
	playercaster.ClearCDTime(88)
	playercaster.AddBuff(0, 99, 8261, 1)
end
