---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_葛尔东赞_风卷残云_伤害.lua
-- 更新时间:	2014/10/11 15:14:03
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 39100, nDamageRand = 0, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID)
	...
	local npc_zk = scene.GetNpcByNickName("FengLangzongkong")
	if npc_zk then
		npc_zk.SetCustomBoolean(11, true)
	end
end
