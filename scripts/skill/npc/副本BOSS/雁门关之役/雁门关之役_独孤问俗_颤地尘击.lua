---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/雁门关之役/雁门关之役_独孤问俗_颤地尘击.lua
-- 更新时间:	2014/10/21 15:11:23
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 59100, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.BindBuff(1, 8480, 1)
	elseif dwSkillLevel == 2 then
		skill.BindBuff(1, 8480, 2)
	end
