...
-- 武功套路  :  
-- 技能名称  :  氢化植物油
-- 技能效果  :  配方表里的氢化植物油、植物奶油、起酥油、植脂末都含有反式脂肪酸。
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 1718 * 0.8, nDamageRand = 1718 * 0.4, nCostMana = 0},		--level 6
	{nDamageBase = 2363 * 0.8, nDamageRand = 2363 * 0.4, nCostMana = 0},		--level 7
	{nDamageBase = 2818 * 0.8, nDamageRand = 2818 * 0.4, nCostMana = 0},		--level 8
	...
	{nDamageBase = 5091 * 0.8, nDamageRand = 5091 * 0.4, nCostMana = 0},		--level 13
	{nDamageBase = 5545 * 0.8, nDamageRand = 5545 * 0.4, nCostMana = 0},		--level 14
	{nDamageBase = 6000 * 0.8, nDamageRand = 6000 * 0.4, nCostMana = 0},		--level 15
	{nDamageBase = 6698 * 0.8, nDamageRand = 6698 * 0.4, nCostMana = 0},		--level 16
	...
	{nDamageBase = 7153 * 0.8, nDamageRand = 7153 * 0.4, nCostMana = 0},		--level 19
	{nDamageBase = 7304 * 0.8, nDamageRand = 7304 * 0.4, nCostMana = 0},		--level 20
	{nDamageBase = 7456 * 0.8, nDamageRand = 7456 * 0.4, nCostMana = 0},		--level 21
	{nDamageBase = 7608 * 0.8, nDamageRand = 7608 * 0.4, nCostMana = 0},		--level 22
	{nDamageBase = 7759 * 0.8, nDamageRand = 7759 * 0.4, nCostMana = 0},		--level 23
	{nDamageBase = 7911 * 0.8, nDamageRand = 7911 * 0.4, nCostMana = 0},		--level 24
	{nDamageBase = 8063 * 0.8, nDamageRand = 8063 * 0.4, nCostMana = 0},		--level 25
	{nDamageBase = 8214 * 0.8, nDamageRand = 8214 * 0.4, nCostMana = 0},		--level 26
	{nDamageBase = 8366 * 0.8, nDamageRand = 8366 * 0.4, nCostMana = 0},		--level 27
	{nDamageBase = 8518 * 0.8, nDamageRand = 8518 * 0.4, nCostMana = 0},		--level 28
	{nDamageBase = 8669 * 0.8, nDamageRand = 8669 * 0.4, nCostMana = 0},		--level 29
	{nDamageBase = 8821 * 0.8, nDamageRand = 8821 * 0.4, nCostMana = 0},		--level 30
	{nDamageBase = 8973 * 0.8, nDamageRand = 8973 * 0.4, nCostMana = 0},		--level 31
};
