---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_幻魔问心附体aoe.lua
-- 更新时间:	2015/10/11 17:54:52
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 7700, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 4600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 8200, nDamageRand = 0, nCostMana = 0}, --level 4
