---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_幻魔腐蚀.lua
-- 更新时间:	2015/9/7 22:23:49
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 1900, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 3700, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 2300, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 2300, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 2300, nDamageRand = 0, nCostMana = 0}, --level 5
