---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲八式·月池近.lua
-- 更新时间:	2015/6/8 15:07:00
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamage = 20000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamage = 25000, nDamageRand = 0, nCostMana = 0},		--level 4
