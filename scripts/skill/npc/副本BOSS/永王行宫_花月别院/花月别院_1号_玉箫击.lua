---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_玉箫击.lua
-- 更新时间:	2015/9/7 22:32:58
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 13900, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 13900, nDamageRand = 0, nCostMana = 0}, --level 3
