---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_分川手穿透版.lua
-- 更新时间:	2015/10/9 19:43:00
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 99800, nDamageRand = 0, nCostMana = 0}, --level 1，25人
	{nDamageBase = 35200, nDamageRand = 0, nCostMana = 0}, --level 2，25人
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 3，25人
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 4，25人
	{nDamageBase = 99800, nDamageRand = 0, nCostMana = 0}, --level 5，10人挑战
	{nDamageBase = 35200, nDamageRand = 0, nCostMana = 0}, --level 6，10人挑战
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 7，10人挑战
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 8，10人挑战
	{nDamageBase = 146300, nDamageRand = 0, nCostMana = 0}, --level 9,25人挑战
	{nDamageBase = 59500, nDamageRand = 0, nCostMana = 0}, -- level 10,25人挑战
	{nDamageBase = 19800, nDamageRand = 0, nCostMana = 0}, --level 11,25人挑战
	{nDamageBase = 19800, nDamageRand = 0, nCostMana = 0}, --level 12,25人挑战
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_分川手穿透版.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAngleRange = 45;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 230 or scene.dwMapID == 233 then---25人和帮会花月
		player.AddBuff(0, 99, 8885, 2, 60)
	end

	if scene.dwMapID == 235 then---10人挑战
		player.AddBuff(0, 99, 8885, 3, 60)
	end

	if scene.dwMapID == 237 then---25人挑战
		player.AddBuff(0, 99, 8885, 4, 60)
	end
end
