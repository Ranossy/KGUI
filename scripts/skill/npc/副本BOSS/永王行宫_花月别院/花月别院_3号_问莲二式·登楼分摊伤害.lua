---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲二式·登楼分摊伤害.lua
-- 更新时间:	2015/6/1 11:04:27
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 60000, nDamageRand = 0, nCostMana = 0}, --level 1,10人
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 2,10人
	{nDamageBase = 7000, nDamageRand = 0, nCostMana = 0}, --level 3,10人
	{nDamageBase = 80000, nDamageRand = 0, nCostMana = 0}, --level 4，25人
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 5，25人
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0}, --level 6，25人
	{nDamageBase = 80000, nDamageRand = 0, nCostMana = 0}, --level 7，10人挑战
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 8，10人挑战
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0}, --level 9，10人挑战
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 10,25人挑战
	{nDamageBase = 50000, nDamageRand = 0, nCostMana = 0}, --level 11,25人挑战
	{nDamageBase = 10000, nDamageRand = 0, nCostMana = 0}, --level 12,25人挑战
	{nDamageBase = 50000, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamageBase = 70000, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamageBase = 120000, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamageBase = 150000, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamageBase = 180000, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamageBase = 200000, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamageBase = 210000, nDamageRand = 0, nCostMana = 0}, --level 20
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲二式·登楼分摊伤害.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 221 then
		if player.GetBuff(8969, 1) then
			player.DelBuff(8969, 1)
		end
	end

	if scene.dwMapID == 230 or scene.dwMapID == 233 then
		if player.GetBuff(8969, 2) then
			player.DelBuff(8969, 2)
		end
	end

	if scene.dwMapID == 235 then
		if player.GetBuff(8969, 3) then
			player.DelBuff(8969, 3)
		end
	end

	if scene.dwMapID == 237 then
		if player.GetBuff(8969, 4) then
			player.DelBuff(8969, 4)
		end
	end
end
