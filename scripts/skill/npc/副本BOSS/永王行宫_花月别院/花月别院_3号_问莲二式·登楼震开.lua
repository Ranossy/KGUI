---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲二式·登楼震开.lua
-- 更新时间:	2015/6/1 10:04:35
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲二式·登楼震开.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 221 then
		player.AddBuff(0, 99, 8968, 1)
	end

	if scene.dwMapID == 230 or scene.dwMapID == 233 then
		player.AddBuff(0, 99, 8968, 2)
	end

	if scene.dwMapID == 235 then
		player.AddBuff(0, 99, 8968, 3)
	end

	if scene.dwMapID == 237 then
		player.AddBuff(0, 99, 8968, 4)
	end
end
