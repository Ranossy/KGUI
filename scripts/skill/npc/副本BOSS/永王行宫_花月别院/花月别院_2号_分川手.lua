---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_分川手.lua
-- 更新时间:	2015/5/15 15:47:54
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 79300, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 26600, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 79300, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 26600, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0},		--level 8
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_分川手.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 230 or scene.dwMapID == 233 then---25人和帮会花月
		player.AddBuff(0, 99, 8885, 2, 30)
	end

	if scene.dwMapID == 235 then---10人挑战
		player.AddBuff(0, 99, 8885, 3, 30)
	end
end
