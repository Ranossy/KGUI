---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_青莲子剑掉落爆炸穿透版.lua
-- 更新时间:	2015/11/6 10:57:54
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 16000, nDamageRand = 0, nCostMana = 0}, -- level 3
	{nDamageBase = 16000, nDamageRand = 0, nCostMana = 0}, -- level 4
...
function GetSkillLevelData(skill)
 ...
 ----------------- 魔法属性 -------------------------------------------------
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_青莲子剑掉落爆炸穿透版.lua", -- 属性值1
		0 -- 属性值2
	);
