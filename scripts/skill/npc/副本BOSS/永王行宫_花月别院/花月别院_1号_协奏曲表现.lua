---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_协奏曲表现.lua
-- 更新时间:	2015/9/6 11:32:46
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 16 * 20;				-- 吟唱帧数
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.szName == "hanfeichi" then
		npc.CastSkill(14201, 1)
		npc.PlaySfx(1199, 0, 0, 0)
	else
		npc.CastSkill(14202, 1)
		npc.PlaySfx(1200, 0, 0, 0)
