---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_协奏曲幻象.lua
-- 更新时间:	2015/9/16 20:48:49
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_协奏曲幻象.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if DXflag then
		...
		if nLevel > 2 then
			npchy.CastSkillXYZ(14573, nLevel, player.nX, player.nY, player.nZ)
		end
		...
		npchy.CastSkill(14572, nLevel, TARGET.PLAYER, player.dwID)
