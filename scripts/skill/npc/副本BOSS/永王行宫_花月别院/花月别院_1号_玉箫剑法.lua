---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_1号_玉箫剑法.lua
-- 更新时间:	2015/9/7 22:32:43
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 8800, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 4900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 9100, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 1110, nDamageRand = 0, nCostMana = 0}, --level 5
