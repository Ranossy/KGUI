---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲五式·雾散扩.lua
-- 更新时间:	2015/6/25 15:29:07
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_3号_问莲五式·雾散扩.lua",
		0
	);
	...
	skill.nHeight = 2 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	...
	skill.nSpreadCircleTotalFrame = 7 * GLOBAL.GAME_FPS;  --总的释放帧数 skill.nSpreadCircleVelocity * skill.nSpreadCircleTotalFrame / 64 就是整个技能全过程的作用半径
