---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_辨玉掌子弹.lua
-- 更新时间:	2015/5/21 15:49:09
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_辨玉掌子弹.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npc then
		...
		scene.SetTimer(0.9 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_辨玉掌子弹.lua", dwSrcID, 1)
	end
end
