---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_奔流爪三百击.lua
-- 更新时间:	2015/5/20 15:04:38
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 7000, nDamageRand = 0, nCostMana = 0},		--level 1，10人
	{nDamage = 7000, nDamageRand = 0, nCostMana = 0},		--level 2，25人
	{nDamage = 28100, nDamageRand = 0, nCostMana = 0},		--level 3，10人
	{nDamage = 28100, nDamageRand = 0, nCostMana = 0},		--level 4，25人
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0},		--level 5，10人挑战
	{nDamage = 38000, nDamageRand = 0, nCostMana = 0},		--level 6，10人挑战
	{nDamage = 15000, nDamageRand = 0, nCostMana = 0},		--level 7，25人挑战
	{nDamage = 48000, nDamageRand = 0, nCostMana = 0},		--level 8，25人挑战
   ...
   skill.AddAttribute(
	...
	skill.AddAttribute(
   	...
   	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_花月别院/花月别院_2号_奔流爪三百击.lua",								--属性值1
		0															--属性值2
	);	
