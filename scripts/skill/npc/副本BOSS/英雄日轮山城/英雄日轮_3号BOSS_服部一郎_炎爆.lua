...
tSkillData =
{
	{nDamageBase = 228 * 0.8, nDamageRand = 228 * 0.4, nCostMana = 0},		--level 1
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
    	...
    	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/英雄日轮山城/英雄日轮_3号BOSS_服部一郎_炎爆.lua",				-- 属性值1
   		0														-- 属性值2
   		);
...
function Apply(dwCharacterID)
	...
	if player then
		...
		scene.SetCustomBoolean(SCENE_CUSTOM_VALUE_NAME.YINGXIONGRILUNSHANCHENG.SUCCESS_1169, true)
	end
end
