---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_小怪_蜘蛛毒液子技能.lua
-- 更新时间:	2016/7/21 10:54:00
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_小怪_蜘蛛毒液子技能.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget then
		...
		scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_小怪_蜘蛛毒液子技能.lua", dwCharacterID, dwSkillSrcID)
	end
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if scene.dwMapID == 241 or scene.dwMapID == 251 then
		playertarget.PlaySfx(1383, playertarget.nX, playertarget.nY, playertarget.nZ - 125)
		playertarget.AddBuff(npc.dwID, npc.nLevel, 11003, 1, 15)
	end

	if scene.dwMapID == 249 then
		playertarget.PlaySfx(1383, playertarget.nX, playertarget.nY, playertarget.nZ - 125)
		playertarget.AddBuff(npc.dwID, npc.nLevel, 11003, 2, 15)
	end
end
