---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/安庆绪/安庆绪_P2_飞锤_伤害.lua
-- 更新时间:	2016/9/30 17:31:48
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/安庆绪/安庆绪_P2_飞锤_伤害.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	--skill.BindBuff(2, 10923, 2);		-- 设置2号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 241 or scene.dwMapID == 251 then
		...
		if anqingxu then
			player.AddBuff(anqingxu.dwID, anqingxu.nLevel, 10923, 1)
		end
	end
	if scene.dwMapID == 249 then
		local anqingxu = scene.GetNpcByNickName("anqingxu")
		if anqingxu then
			player.AddBuff(anqingxu.dwID, anqingxu.nLevel, 10923, 2)
		end
	end
end
