---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/安庆绪/安庆绪_P2_踢飞.lua
-- 更新时间:	2016/9/30 17:29:44
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6580, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 15960, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/安庆绪/安庆绪_P2_踢飞.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11215, 2);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 241 or scene.dwMapID == 251 then
		...
		if anqingxu then
			player.AddBuff(anqingxu.dwID, anqingxu.nLevel, 11215, 1)
		end
	end
	if scene.dwMapID == 249 then
		local anqingxu = scene.GetNpcByNickName("anqingxu")
		if anqingxu then
			player.AddBuff(anqingxu.dwID, anqingxu.nLevel, 11215, 2)
			player.AddBuff(anqingxu.dwID, anqingxu.nLevel, 10870, 1)
		end
	end
end
