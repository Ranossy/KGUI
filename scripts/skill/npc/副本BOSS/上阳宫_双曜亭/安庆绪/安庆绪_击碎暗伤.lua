---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/安庆绪/安庆绪_击碎暗伤.lua
-- 更新时间:	2016/8/30 16:08:01
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 12900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 25800, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 38700, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 77400, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 116100, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 2800, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 11600, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 23200, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 46400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 92800, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 7
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 10871, 1);		-- 设置1号位Buff
