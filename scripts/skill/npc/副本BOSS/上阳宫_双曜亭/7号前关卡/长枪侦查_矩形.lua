---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/长枪侦查_矩形.lua
-- 更新时间:	2016/10/14 20:23:46
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/长枪侦查_圆形.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(11050, 1) then
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(10, 3940), 3)
		player.AddBuff(player.dwID, player.nLevel, 11050, 1)
		npc.ModifyThreat(player.dwID, 20)
		npc.Yell(player.szName .. GetEditorString(10, 3994))
	end
end
