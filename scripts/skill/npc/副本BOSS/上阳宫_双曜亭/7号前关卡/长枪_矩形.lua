---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/长枪_矩形.lua
-- 更新时间:	2016/8/15 16:47:54
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 1300, nDamageRand = 100, nCostMana = 0}, --level 1
	{nDamageBase = 2750, nDamageRand = 300, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/长枪_矩形.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nRectWidth = 200;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	skill.nAngleRange = 256;					-- 攻击范围的扇形角度范围
	skill.nAreaRadius = 640;		-- 技能作用半径
