---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/BUFF/射箭标记BUFF.lua
-- 更新时间:	2016/9/3 18:28:45
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function UnApply(dwCharacterID)
	...
	if player then
		...
		local tBuff = player.GetBuff(11063, 1)
		if not tBuff then
			player.AddBuff(player.dwID, player.nLevel, 11065, 1)
		end
	end
end
