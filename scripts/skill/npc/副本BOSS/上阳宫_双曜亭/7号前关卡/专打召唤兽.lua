---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/专打召唤兽.lua
-- 更新时间:	2016/9/2 14:35:59
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/7号前关卡/专打召唤兽.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nTargetCountLimit = 300;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制)
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(10, 3940), 3)
	player.AddBuff(player.dwID, player.nLevel, 10000, 1)
	npc.ModifyThreat(player.dwID, 20)
end
