---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_蜘蛛毒液吟唱空技能.lua
-- 更新时间:	2016/4/6 10:10:11
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_蜘蛛毒液吟唱空技能.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
		...
		scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_蜘蛛毒液吟唱空技能.lua", playertarget.dwID, 1)
	end
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if playertarget then
		playertarget.PlaySfx(1292, playertarget.nX, playertarget.nY, playertarget.nZ)
	end
end
