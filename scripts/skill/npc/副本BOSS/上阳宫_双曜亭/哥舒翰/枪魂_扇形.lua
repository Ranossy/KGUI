---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/枪魂_扇形.lua
-- 更新时间:	2016/7/4 17:47:20
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/枪魂_扇形.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAngleRange = 25.6					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nSMapId == 241 then
		npcGSH.CastSkill(15537, 1, TARGET.PLAYER, player.dwID)
	else
		npcGSH.CastSkill(15537, 2, TARGET.PLAYER, player.dwID)
	end
end
