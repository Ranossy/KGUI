---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/突刺_矩形2.lua
-- 更新时间:	2016/5/24 15:10:06
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 42000, nDamageRand = 250, nCostMana = 0}, --level 1
	{nDamageBase = 60000, nDamageRand = 500, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames  	= 1.5 * GLOBAL.GAME_FPS;				-- 吟唱帧数
