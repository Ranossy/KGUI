---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/落枪_圆形2.lua
-- 更新时间:	2016/5/24 15:16:50
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 14100, nDamageRand = 250, nCostMana = 0}, --level 1
	{nDamageBase = 14800, nDamageRand = 500, nCostMana = 0}, --level 2
