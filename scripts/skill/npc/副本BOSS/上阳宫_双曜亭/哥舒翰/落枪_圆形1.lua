---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/落枪_圆形1.lua
-- 更新时间:	2016/5/24 15:16:45
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 540, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1380, nDamageRand = 0, nCostMana = 0}, --level 2
