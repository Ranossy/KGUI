---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/BUFF/挑飞.lua
-- 更新时间:	2016/7/4 10:50:33
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function UnApply(dwCharacterID)
	...
	if player then
		...
		if MapID == 241 then
			if player.GetBuff(2685, 1) then
				player.DelBuff(2685, 1)
				player.CastSkill(15514, 1)
			else
				player.CastSkill(15514, 1)
			end
		else
