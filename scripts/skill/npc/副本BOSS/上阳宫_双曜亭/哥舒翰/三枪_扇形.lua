---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/三枪_扇形.lua
-- 更新时间:	2016/5/24 15:17:42
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel;
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/三枪_扇形.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nSMapId == 241 then
		npcGSH.CastSkill(15535, 1, TARGET.PLAYER, player.dwID)
	else
		npcGSH.CastSkill(15535, 2, TARGET.PLAYER, player.dwID)
	end
end
