---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/突刺_矩形1.lua
-- 更新时间:	2016/9/7 21:35:49
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 11000, nDamageRand = 250, nCostMana = 0}, --level 1
	{nDamageBase = 19000, nDamageRand = 500, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/突刺_矩形1.lua", --属性值1
		0															--属性值2
	);
	...
	if #playerlist ~= 0 then
		for i = 1, #playerlist do
			...
			if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
				if playertarget.GetBuff(10884, 1) then
					playertarget.DelBuff(10884, 1)
				end
			end
		end
	end
