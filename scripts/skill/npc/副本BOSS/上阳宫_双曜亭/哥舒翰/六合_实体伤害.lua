---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/六合_实体伤害.lua
-- 更新时间:	2016/9/29 17:09:53
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 4200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 1400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 700, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 15000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 10000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 7000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 4000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 29500, nDamageRand = 14750, nCostMana = 0}, --level 11
	{nDamageBase = 115300, nDamageRand = 57650, nCostMana = 0}, --level 12
	{nDamageBase = 230600, nDamageRand = 115300, nCostMana = 0}, --level 13
	{nDamageBase = 35200, nDamageRand = 17600, nCostMana = 0}, --level 14
...
function GetSkillLevelData(skill)
 ...
 - 1024,
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/六合_实体伤害.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nSMapID = scene.dwMapID
	if nSMapID == 241 or nSMapID == 251 then
		player.AddBuff(npc.dwID, npc.nLevel, 10887, 1)
		local nBuff = player.GetBuff(10887, 1)
		if nBuff and nBuff.nStackNum >= 3 then
			player.CustomDamage(npc.dwID, 15538, 1, 1, player.nMaxLife * 2)
		end
	else
		player.AddBuff(npc.dwID, npc.nLevel, 10887, 2)
		local nBuff = player.GetBuff(10887, 2)
		if nBuff and nBuff.nStackNum >= 3 then
			player.CustomDamage(npc.dwID, 15538, 1, 1, player.nMaxLife * 2)
		end
	end
