---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/横扫_实体伤害.lua
-- 更新时间:	2016/5/24 15:08:49
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 8000, nDamageRand = 250, nCostMana = 0}, --level 1
	{nDamageBase = 12800, nDamageRand = 250, nCostMana = 0}, --level 2
	{nDamageBase = 19200, nDamageRand = 250, nCostMana = 0}, --level 3
	{nDamageBase = 22000, nDamageRand = 250, nCostMana = 0}, --level 4
	{nDamageBase = 11200, nDamageRand = 250, nCostMana = 0}, --level 5
	{nDamageBase = 20000, nDamageRand = 250, nCostMana = 0}, --level 6
	{nDamageBase = 26400, nDamageRand = 250, nCostMana = 0}, --level 7
	{nDamageBase = 30000, nDamageRand = 250, nCostMana = 0}, --level 8
