---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/枪魂_矩形.lua
-- 更新时间:	2016/10/4 16:44:47
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 490, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1400, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_双曜亭/哥舒翰/枪魂_矩形.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nMaxRadius = 66 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcQHFW = scene.GetNpcByNickName("qihaofanwei")
	if not npcQHFW then
		return
	end
	npcQHFW.SetCustomInteger1(8, 1)
