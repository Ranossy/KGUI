---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_双曜亭/黑齿元佑_普通攻击.lua
-- 更新时间:	2016/3/29 15:19:02
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 7700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 40800, nDamageRand = 0, nCostMana = 0}, --level 2
