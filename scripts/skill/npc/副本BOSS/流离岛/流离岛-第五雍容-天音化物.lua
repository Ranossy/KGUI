...
tSkillData =
{
	{ nTherapyBase = 1500 * 0.8, 	nTherapyRand = 1500 * 0.4, 	nCostMana = 65}, 
	{ nTherapyBase = 2000000 * 0.8, 	nTherapyRand = 2000000 * 0.4, 	nCostMana = 92}, 
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
  		...
  		tSkillData[dwSkillLevel].nTherapyBase*0.14,							--属性值1
  		0							--属性值2
 		);
   	
   	skill.AddAttribute(
  		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,						-- 属性作用模式
  		ATTRIBUTE_TYPE.SKILL_THERAPY_RAND*0.14,								-- 魔法属性
