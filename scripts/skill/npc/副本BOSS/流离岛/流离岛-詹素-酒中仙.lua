...
tSkillData =
{
	{nTherapyBase = 70, nDamageRand = 0, nCostMana = 0},		--level 1
	{nTherapyBase = 60000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 3
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 4
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 5
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 6
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 7
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 8
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 9
	{nTherapyBase = 0, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5594, dwSkillLevel);		-- 设置1号位Buff
