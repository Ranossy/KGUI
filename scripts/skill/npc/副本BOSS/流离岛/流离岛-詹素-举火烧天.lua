---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/流离岛/流离岛-詹素-举火烧天.lua
-- 更新时间:	2013-4-10 18:31:39
-- 更新用户:	xiedixun1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/流离岛/流离岛-詹素-举火烧天.lua", -- 属性值1
		0														-- 属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if player then
		...
		if scene.dwMapID == 170 then
			scene.CreateNpc(23823, player.nX, player.nY, player.nZ, 0, 720)
		elseif scene.dwMapID == 169 then
			scene.CreateNpc(24985, player.nX, player.nY, player.nZ, 0, 720)
		end
	end
end
