---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/流离岛/流离岛-第五雍容-赐福.lua
-- 更新时间:	2013/5/17 9:30:15
-- 更新用户:	xiedixun2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/流离岛/流离岛-第五雍容-赐福.lua", -- 属性值1
		0														-- 属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5759, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 24034 or npc.dwTemplateID == 24085 or npc.dwTemplateID == 24194 or npc.dwTemplateID == 24190 or npc.dwTemplateID == 24094 then
		npc.AddBuff(0, 99, 5759, 2, 1)
	end
	
	if npc.dwTemplateID == 24994 or npc.dwTemplateID == 24996 or npc.dwTemplateID == 24997 or npc.dwTemplateID == 25003 or npc.dwTemplateID == 25005 then
		npc.AddBuff(0, 99, 5759, 1, 1)
	end
end
