---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/流离岛/释放瘴气.lua
-- 更新时间:	2013/5/14 22:03:23
-- 更新用户:	xiedixun2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/流离岛/释放瘴气.lua", -- 属性值1
		0														-- 属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if player then
		...
		if scene.dwMapID == 170 then
			player.AddBuff(0, 99, 5906, 2, 2)
		elseif scene.dwMapID == 169 then
			player.AddBuff(0, 99, 5906, 1, 2)
		end
	end
end
