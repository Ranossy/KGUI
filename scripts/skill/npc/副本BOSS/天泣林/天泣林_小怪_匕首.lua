---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/天泣林/天泣林_小怪_匕首.lua
-- 更新时间:	2015/3/11 17:36:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 4800, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/天泣林/天泣林_小怪_匕首.lua", --属性值1
		0															--属性值2
	);
