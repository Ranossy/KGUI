---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_扫_扇形1.lua
-- 更新时间:	2015/10/11 19:47:24
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	...
	{nDamage = 9900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 14400, nDamageRand = 0, nCostMana = 0}, --level 4
