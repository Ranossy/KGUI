---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_破_圆形.lua
-- 更新时间:	2015/9/10 10:44:43
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 9000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 5000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 2550, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 14000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamage = 7000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamage = 5000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamage = 3000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamage = 15840, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamage = 5940, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamage = 19440, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamage = 15000, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamage = 12000, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamage = 9000, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamage = 6480, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamage = 3000, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamage = 2000, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamage = 1000, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamage = 500, nDamageRand = 0, nCostMana = 0}, --level 20
};
