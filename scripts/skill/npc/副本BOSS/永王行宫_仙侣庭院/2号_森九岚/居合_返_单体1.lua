---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_返_单体1.lua
-- 更新时间:	2015/8/28 10:20:35
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 9400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 22000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 12000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 26400, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_返_单体1.lua", --属性值1
		0															--属性值2
	);
