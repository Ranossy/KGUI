---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_聚_圆形1.lua
-- 更新时间:	2015/10/15 17:06:38
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 3750, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 5000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 5280, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 5760, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_聚_圆形1.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if MAPID == 220 then
		npc.nCurrentLife = npc.nCurrentLife - (npc.nMaxLife / 100) * 35
	end
	if MAPID == 231 or MAPID == 232 or MAPID == 234 or MAPID == 236 then
		npc.nCurrentLife = npc.nCurrentLife - (npc.nMaxLife / 100) * 22
	end
end
