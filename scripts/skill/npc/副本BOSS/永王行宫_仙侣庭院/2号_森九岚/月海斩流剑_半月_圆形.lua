---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_半月_圆形.lua
-- 更新时间:	2015/7/22 10:05:30
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	...
	{nDamage = 12000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 10600, nDamageRand = 0, nCostMana = 0}, --level 3
