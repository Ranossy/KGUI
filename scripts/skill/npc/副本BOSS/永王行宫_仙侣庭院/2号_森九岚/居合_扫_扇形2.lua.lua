---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_扫_扇形2.lua.lua
-- 更新时间:	2015/7/22 9:32:14
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 15000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 20000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 19800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 28800, nDamageRand = 0, nCostMana = 0}, --level 4
