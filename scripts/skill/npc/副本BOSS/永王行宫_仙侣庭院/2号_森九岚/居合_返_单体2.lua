---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_返_单体2.lua
-- 更新时间:	2015/8/28 10:20:38
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 3510, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 7020, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 7500, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 19440, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamage = 5787, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamage = 15000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamage = 9900, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamage = 25000, nDamageRand = 0, nCostMana = 0}, --level 8
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/居合_返_单体2.lua", --属性值1
		0															--属性值2
	);
