---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_灭_圆形.lua
-- 更新时间:	2015/9/10 16:12:51
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 13750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 13750, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 14500, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_灭_圆形.lua", --属性值1
		0															--属性值2
	);
