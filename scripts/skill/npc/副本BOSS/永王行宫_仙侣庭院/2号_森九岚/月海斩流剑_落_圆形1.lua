---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/2号_森九岚/月海斩流剑_落_圆形1.lua
-- 更新时间:	2015/7/22 17:48:57
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 2500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 3750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 4950, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 5400, nDamageRand = 0, nCostMana = 0}, --level 4
