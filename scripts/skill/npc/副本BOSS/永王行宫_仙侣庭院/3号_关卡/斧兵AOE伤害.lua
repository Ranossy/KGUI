---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_关卡/斧兵AOE伤害.lua
-- 更新时间:	2015/8/24 17:54:07
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 8750, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 11550, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 14400, nDamageRand = 0, nCostMana = 0}, --level 4
