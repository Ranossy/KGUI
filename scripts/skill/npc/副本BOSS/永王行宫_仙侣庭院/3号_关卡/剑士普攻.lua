---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_关卡/剑士普攻.lua
-- 更新时间:	2015/7/30 11:22:37
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3750, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 9000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 4950, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 10800, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9203, dwSkillLevel);		-- 设置1号位Buff
