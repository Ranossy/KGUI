...
function GetSkillLevelData(skill)
	...
	"skill/npc/副本BOSS/副本BOSS/永王行宫_仙侣庭院/3号_关卡/弩兵母技能.lua", -- 属性值1
	0														-- 属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9122, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	Target.SetCustomInteger1(1, Target.GetCustomInteger1(1) + 1)
end
