---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_关卡/狙杀承伤.lua
-- 更新时间:	2015/8/27 11:45:19
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 12500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 16500, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 21600, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_关卡/狙杀承伤.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9325, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 9202, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	local Target = GetNpc(dwSkillSrcID)
	if not Target then
		return
	end
	...
	local Area_Con = scene.GetNpcByNickName("GuanqiaArea_Control")
	if Area_Con then
		Area_Con.SetCustomInteger1(1, Area_Con.GetCustomInteger1(1) + 1)
	end
end
