---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/4号_仲虚念/斗笠·破魔.lua
-- 更新时间:	2015/11/17 17:22:04
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 17500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 24000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 23100, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 29880, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	if dwSkillLevel == 1 or dwSkillLevel == 2 then
		skill.BindBuff(1, 9642, dwSkillLevel);		-- 设置1号位Buff
	elseif dwSkillLevel == 3 then
		skill.BindBuff(1, 10239, 1);		-- 设置1号位Buff
	else
		skill.BindBuff(1, 10239, 2);		-- 设置1号位Buff
	end
	...
	skill.nAngleRange = 7;					-- 攻击范围的扇形角度范围
