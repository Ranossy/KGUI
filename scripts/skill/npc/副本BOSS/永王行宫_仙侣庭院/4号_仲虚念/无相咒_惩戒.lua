---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/4号_仲虚念/无相咒_惩戒.lua
-- 更新时间:	2015/7/22 11:05:00
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3900, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 4290, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 6120, nDamageRand = 0, nCostMana = 0}, --level 3
