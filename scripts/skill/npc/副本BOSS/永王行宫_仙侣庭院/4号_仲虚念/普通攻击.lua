---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/4号_仲虚念/普通攻击.lua
-- 更新时间:	2015/11/2 12:06:23
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 12540, nDamageRand = 0, nCostMana = 0}, -- level 1
	{nDamageBase = 22500, nDamageRand = 0, nCostMana = 0}, -- level 2
	{nDamageBase = 29160, nDamageRand = 0, nCostMana = 0}, -- level 3
	{nDamageBase = 37600, nDamageRand = 0, nCostMana = 0}, -- level 4
