---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/4号_仲虚念/紫金钵·化.lua
-- 更新时间:	2015/7/16 10:00:48
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2880, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 5760, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 8640, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 11520, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 14400, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 17280, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 4750, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 10440, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 13440, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 16440, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 19440, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 22440, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamageBase = 6650, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamageBase = 13300, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamageBase = 16880, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamageBase = 19920, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamageBase = 22920, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamageBase = 25920, nDamageRand = 0, nCostMana = 0}, --level 18
};
...
function GetSkillLevelData(skill)
	...
	--"skill/npc/副本BOSS/梵空禅院/达摩捏诀_吟唱.lua", -- 属性值1
	--0														-- 属性值2
	--);
