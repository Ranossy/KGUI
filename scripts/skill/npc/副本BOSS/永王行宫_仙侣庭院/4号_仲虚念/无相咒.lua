---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/4号_仲虚念/无相咒.lua
-- 更新时间:	2015/7/22 11:01:49
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 5940, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 17820, nDamageRand = 0, nCostMana = 0}, --level 3
