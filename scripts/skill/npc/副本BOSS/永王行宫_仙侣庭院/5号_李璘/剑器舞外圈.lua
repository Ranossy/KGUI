...
tSkillData =
{
	{nDamageBase = 9000, nDamageRand = 0, nCostMana = 0}, --level 1   --10人普通
	{nDamageBase = 12000, nDamageRand = 0, nCostMana = 0}, --level 2   --25人英雄 帮会
	{nDamageBase = 15000, nDamageRand = 0, nCostMana = 0}, --level 3       --10人挑战
	{nDamageBase = 16000, nDamageRand = 0, nCostMana = 0}, --level 4       --25人挑战
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel ~= 1 then   --10人普通可以防御
		for i = 1,6 do
			skill.AddAttribute(
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nProtectRadius = 7 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
