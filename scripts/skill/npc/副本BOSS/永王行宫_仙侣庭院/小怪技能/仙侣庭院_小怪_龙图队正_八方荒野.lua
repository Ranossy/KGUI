---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/小怪技能/仙侣庭院_小怪_龙图队正_八方荒野.lua
-- 更新时间:	2015/8/6 16:23:28
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 9400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 11400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 12600, nDamageRand = 0, nCostMana = 0}, --level 3
