---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/小怪技能/仙侣庭院_小怪_一刀流高手_三连击.lua
-- 更新时间:	2015/8/6 16:36:18
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 7100, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 8600, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 9600, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8969, 1);		-- 设置1号位Buff
