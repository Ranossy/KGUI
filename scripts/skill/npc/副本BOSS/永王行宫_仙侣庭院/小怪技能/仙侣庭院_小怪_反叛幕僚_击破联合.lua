---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/小怪技能/仙侣庭院_小怪_反叛幕僚_击破联合.lua
-- 更新时间:	2015/8/7 10:13:11
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 89000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 89000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 89000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 89000, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9397, 1);		-- 设置1号位Buff
