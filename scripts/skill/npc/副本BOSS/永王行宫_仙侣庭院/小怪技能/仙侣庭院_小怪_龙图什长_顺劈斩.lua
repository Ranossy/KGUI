---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/小怪技能/仙侣庭院_小怪_龙图什长_顺劈斩.lua
-- 更新时间:	2015/8/5 10:14:34
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 21500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 26000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 32600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 32900, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 59000, nDamageRand = 0, nCostMana = 0}, --level 5
