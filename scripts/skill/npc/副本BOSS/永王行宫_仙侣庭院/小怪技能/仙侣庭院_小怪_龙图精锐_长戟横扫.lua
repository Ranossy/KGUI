---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/小怪技能/仙侣庭院_小怪_龙图精锐_长戟横扫.lua
-- 更新时间:	2015/8/18 11:49:41
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 8100, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 9000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 12300, nDamageRand = 0, nCostMana = 0}, --level 4
