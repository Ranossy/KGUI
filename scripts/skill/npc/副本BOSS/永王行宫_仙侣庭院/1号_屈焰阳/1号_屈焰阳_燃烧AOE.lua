...
tSkillData =
{
	...
	{nDamageBase = 2500, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 1470, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 2240, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 52350, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 62350, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 72350, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 82350, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 92350, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 102350, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(10263, 0, eCompareFlag, 1, eLevelCompareFlag);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(10263, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
 ...
 ----------------- BUFF相关 -------------------------------------------------
	if skill.dwLevel == 1 then
		skill.BindBuff(1, 9562, 1)
	elseif skill.dwLevel == 2 then
		skill.BindBuff(1, 9562, 2)
	elseif skill.dwLevel == 3 then
		skill.BindBuff(1, 9562, 3)
	elseif skill.dwLevel == 4 then
		skill.BindBuff(1, 9562, 4)
	else
		skill.BindBuff(1, 9562, 1)
	end;		-- 设置1号位Buff
	skill.BindBuff(2, 10263, 1);		-- 设置2号位Buff
