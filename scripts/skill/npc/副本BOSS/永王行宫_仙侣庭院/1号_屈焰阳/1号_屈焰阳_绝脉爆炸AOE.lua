...
tSkillData =
{
	...
	{nDamageBase = 15100, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 16830, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 21600, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 13800, nDamageRand = 0, nCostMana = 0}, --level 10
};
