---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/通用_一鼓作气_圆形.lua
-- 更新时间:	2016/12/2 11:31:10
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 562, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 907, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 1080, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamage = 11111, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamage = 11111, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamage = 11111, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamage = 11111, nDamageRand = 0, nCostMana = 0}, --level 8
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/通用_一鼓作气_圆形.lua", --属性值1
		0															--属性值2
	);
