---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/防御_转换状态_圆形.lua
-- 更新时间:	2015/8/18 10:56:47
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 6500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 11250, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 6930, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 11340, nDamageRand = 0, nCostMana = 0}, --level 4
