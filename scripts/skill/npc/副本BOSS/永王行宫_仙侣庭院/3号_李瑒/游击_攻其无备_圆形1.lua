---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/游击_攻其无备_圆形.lua
-- 更新时间:	2015/8/4 11:43:43
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 13750, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 17500, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 14520, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 20160, nDamageRand = 0, nCostMana = 0}, --level 4
