---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/游击_攻其无备_圆形2.lua
-- 更新时间:	2015/8/18 11:55:03
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 6250, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 8750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 8250, nDamageRand = 0, nCostMana = 0}, --level 3
