---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/攻击_无坚不摧_扇形3.lua
-- 更新时间:	2015/8/18 11:23:24
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 11100, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 16650, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 22200, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 27750, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamage = 65535, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamage = 16100, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamage = 20000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamage = 30000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamage = 75000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamage = 570000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamage = 14600, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamage = 21900, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamage = 29200, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamage = 36500, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamage = 87600, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamage = 19400, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamage = 24099, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamage = 36149, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamage = 90372, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamage = 570000, nDamageRand = 0, nCostMana = 0}, --level 20
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/攻击_无坚不摧_扇形3.lua", --属性值1
		0															--属性值2
	);
