---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/防御_步步为营_顺劈_扇形.lua
-- 更新时间:	2015/8/18 10:47:34
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 37600, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 60500, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 66000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 72600, nDamageRand = 0, nCostMana = 0}, --level 4
