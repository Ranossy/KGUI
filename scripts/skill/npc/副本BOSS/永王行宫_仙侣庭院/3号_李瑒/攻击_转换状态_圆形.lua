---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/攻击_转换状态_圆形.lua
-- 更新时间:	2015/8/18 11:23:55
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	...
	{nDamage = 9000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 6030, nDamageRand = 0, nCostMana = 0}, --level 3
