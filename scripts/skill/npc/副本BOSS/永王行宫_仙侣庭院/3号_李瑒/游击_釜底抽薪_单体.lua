---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/游击_釜底抽薪_单体.lua
-- 更新时间:	2015/10/24 15:20:46
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 7500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 9750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 7920, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 11232, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/游击_釜底抽薪_单体.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9423, 1);      	-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if MAPID == 231 or MAPID == 232 then
		player.AddBuff(0, 99, 9423, 2)
	end
	if MAPID == 220 then
		player.AddBuff(0, 99, 9423, 1)
	end

	if MAPID == 234 then
		player.AddBuff(0, 99, 9423, 3)
	end

	if MAPID == 236 then
		player.AddBuff(0, 99, 9423, 4)
	end
