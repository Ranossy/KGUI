---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/攻击_无坚不摧_扇形1.lua
-- 更新时间:	2015/8/18 11:18:32
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamage = 8750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 6600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 12600, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/永王行宫_仙侣庭院/3号_李瑒/攻击_无坚不摧_扇形1.lua", --属性值1
		0															--属性值2
	);
