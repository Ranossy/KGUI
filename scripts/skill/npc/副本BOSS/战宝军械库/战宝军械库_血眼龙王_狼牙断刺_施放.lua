...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_狼牙断刺_施放.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 160 then
		scene.CreateNpc(23302, player.nX, player.nY, player.nZ, 0, 160)
	else
		scene.CreateNpc(24925, player.nX, player.nY, player.nZ, 0, 160)
	end
