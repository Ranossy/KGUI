...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(5477, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5476, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 160 then
		local kongfu = player.GetKungfuMount()
		player.AddBuff(0, 99, 5477, 1)
		if not kongfu then
			player.AddBuff(0, 99, 5478, 1)
		end
		if kongfu.dwSkillID == 10062 or kongfu.dwSkillID == 10002 or kongfu.dwSkillID == 10243 then
			player.AddBuff(0, 99, 5479, 1)
		elseif kongfu.dwSkillID == 10080 or kongfu.dwSkillID == 10176 or kongfu.dwSkillID == 10028 then
			player.AddBuff(0, 99, 5480, 1)
		else
			player.AddBuff(0, 99, 5478, 1)
		end
	else
		local kongfu = player.GetKungfuMount()
		player.AddBuff(0, 99, 5477, 2)
		if not kongfu then
			player.AddBuff(0, 99, 5478, 2)
		end
		if kongfu.dwSkillID == 10062 or kongfu.dwSkillID == 10002 or kongfu.dwSkillID == 10243 then
			player.AddBuff(0, 99, 5479, 1)
		elseif kongfu.dwSkillID == 10080 or kongfu.dwSkillID == 10176 or kongfu.dwSkillID == 10028 then
			player.AddBuff(0, 99, 5480, 2)
		else
			player.AddBuff(0, 99, 5478, 2)
		end
	end
