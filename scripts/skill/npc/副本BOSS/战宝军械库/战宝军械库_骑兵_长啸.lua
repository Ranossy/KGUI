...
tSkillData =
{
	{nDamageBase = 156000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 195000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 234000, nDamageRand = 0, nCostMana = 0},		--level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5365, 1);		-- 设置1号位Buff
