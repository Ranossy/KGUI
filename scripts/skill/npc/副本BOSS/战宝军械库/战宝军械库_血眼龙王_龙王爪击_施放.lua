...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_龙王爪击_施放.lua",								--属性值1
		0															--属性值2
	);		
...
function Apply(dwCharacterID)
	...
	local N_X = npc.nX + 160 * math.cos(2 * npc.nFaceDirection * math.pi / 255) 
	local N_Y = npc.nY + 160 * math.sin(2 * npc.nFaceDirection * math.pi / 255)
	npc.PlaySfx(90, N_X - 96, N_Y, npc.nZ)
	npc.PlaySfx(90, N_X + 96, N_Y, npc.nZ)
	npc.PlaySfx(68, 0, 0, 0, 360 * npc.nFaceDirection/256 - 90)
end
