...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_内力散乱.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	local nNeiGong = player.GetKungfuMount().dwSkillID
	if not nNeiGong then
		player.AddBuff(0, 99, 5335, 1)
	end
	if nNeiGong == 10175 or nNeiGong == 10176 or nNeiGong == 10080 or nNeiGong == 10081 or nNeiGong == 10014 or nNeiGong == 10021 or nNeiGong == 10028 then
		if player.nCurrentMana <player.nMaxMana * 0.5 then
			player.AddBuff(0, 99, 5336, 1)
		end
	elseif nNeiGong == 10224 or nNeiGong == 10225 then
		player.AddBuff(0, 99, 5336, 1)
	else
		player.AddBuff(0,99,5335,1)
	end
