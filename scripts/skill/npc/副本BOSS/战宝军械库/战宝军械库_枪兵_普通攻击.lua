...
tSkillData =
{
	{nDamageBase = 336000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 403200, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 336000, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 370000, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 400000, nDamageRand = 0, nCostMana = 0},		--level 7
