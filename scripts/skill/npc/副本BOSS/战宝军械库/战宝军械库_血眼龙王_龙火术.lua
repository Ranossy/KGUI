...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_龙火术.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 160 then
		scene.CreateNpc(23304, player.nX, player.nY, player.nZ, 0, 320) 
	else
		scene.CreateNpc(24926, player.nX, player.nY, player.nZ, 0, 320)
	end
