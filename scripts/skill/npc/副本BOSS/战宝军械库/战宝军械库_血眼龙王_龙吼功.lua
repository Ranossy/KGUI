...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_龙吼功.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5325, 1);		-- 设置1号位Buff
	...
	--skill.nCostLife		= 0;									-- 技能消耗生命值
	  skill.nCostMana      	= 1642130;	-- 技能消耗的内力
...
function Apply(dwCharacterID)
	...
	local nSkillID = player.GetKungfuMount().dwSkillID
	if not nSkillID then
		return
	end
	if nSkillID == 10224 or nSkillID == 10225 then
		player.AddBuff(0,99,5326,1)
	end
end
