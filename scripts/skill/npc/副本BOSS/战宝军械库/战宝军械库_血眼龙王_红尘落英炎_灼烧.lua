---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_红尘落英炎_灼烧.lua
-- 更新时间:	2013/5/8 10:23:53
-- 更新用户:	wanglpengfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_红尘落英炎_灼烧.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.Stop()
	player.Jump(true, player.nFaceDirection)
	if scene.dwMapID == 160 then
		player.AddBuff(0, 99, 5340, 1)
	else
		player.AddBuff(0, 99, 5340, 2)
	end
end
