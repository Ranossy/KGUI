...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/战宝军械库/战宝军械库_血眼龙王_红尘落英炎.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID ==160 then
		scene.CreateNpc(23218, x1,y1,z, 0, 160) 
		scene.CreateNpc(23218, x2,y2,z, 0, 160) 
		scene.CreateNpc(23218, x1,y2,z, 0, 160) 
		scene.CreateNpc(23218, x2, y1, z, 0, 160)
	else
		scene.CreateNpc(24922, x1,y1,z, 0, 160) 
		scene.CreateNpc(24922, x2,y2,z, 0, 160) 
		scene.CreateNpc(24922, x1,y2,z, 0, 160) 
		scene.CreateNpc(24922, x2, y1, z, 0, 160)
	end
end
