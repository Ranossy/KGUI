...
tSkillData =
{
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 8
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 24300, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	--skill.nRectWidth = 0 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	  ...
	  skill.nTargetCountLimit	= 4+dwSkillLevel;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制) 
