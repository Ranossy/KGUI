---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/长安内城沈眠风/怒吼AOE.lua
-- 更新时间:	2013/9/6 10:58:40
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/长安内城沈眠风/怒吼AOE.lua", -- 属性值1
		0														-- 属性值2
	);
	skill.AddAttribute( 
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.dwID ~= tID  then
		if i <= 50 then
			player.AddBuff(dwSkillSrcID, npc.nLevel, 6519, 1, 40)
		else
			player.AddBuff(dwSkillSrcID, npc.nLevel, 6521, 1, 40)
		end
	end
end
