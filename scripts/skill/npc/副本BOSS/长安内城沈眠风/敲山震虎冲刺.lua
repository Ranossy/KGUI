---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/长安内城沈眠风/敲山震虎冲刺.lua
-- 更新时间:	2013/9/16 9:54:45
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/长安内城沈眠风/敲山震虎1.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function UnApply(dwCharacterID)
	...
	local id = npc.GetCustomInteger4(0)
	local player = GetPlayer(id)
	if not player then
		return
	end
	if npc then
		npc.CastSkill(8180, 1, TARGET.PLAYER, id)
		npc.SetCustomInteger4(0, 0)
		player.AddBuff(0, 99, 6856, 1, 1)
		npc.CastSkill(8181, 1)
		player.DelBuff(6856, 1)
	end
