...
tSkillData = 
{
	{nDamageBase = 5700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 11000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 14400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 34800, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_金蛇剑意_链状.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 7154, dwSkillLevel);		-- 设置1号位Buff
