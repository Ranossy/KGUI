---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_P3普通攻击.lua
-- 更新时间:	2013/11/8 11:08:01
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 54500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 108000, nDamageRand = 0, nCostMana = 0}, --level 2
