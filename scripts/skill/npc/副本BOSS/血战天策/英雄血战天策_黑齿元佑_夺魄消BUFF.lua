---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/英雄血战天策_黑齿元佑_夺魄消BUFF.lua
-- 更新时间:	2013/11/7 9:51:59
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/英雄血战天策_黑齿元佑_夺魄消BUFF.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if npctarget.GetBuff(7155, 1) then
		npctarget.DelBuff(7155, 1)
	end
	if not npctarget.GetBuff(7835, 1) then
		npctarget.AddBuff(0, 99, 7835, 1)
	end
end
