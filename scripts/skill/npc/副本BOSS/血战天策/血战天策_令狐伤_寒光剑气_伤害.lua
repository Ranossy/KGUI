...
tSkillData = 
{
	...
	{nDamageBase = 7600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 22000, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_寒光剑气_伤害.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6927, 1) or player.GetBuff(6927, 2) then
		player.Die()
	else
