---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_雷狼_打断.lua
-- 更新时间:	2014/5/23 16:16:32
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_雷狼_打断.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 652);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		if npc.dwTemplateID ~= 26108 and npc.dwTemplateID ~= 26110 and npc.dwTemplateID ~= 27123 and npc.dwTemplateID ~= 27125 then
