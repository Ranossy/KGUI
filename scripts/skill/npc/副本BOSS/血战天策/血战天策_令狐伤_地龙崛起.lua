...
function GetSkillLevelData(skill)
	...
	--[[skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_地龙崛起.lua",								--属性值1
		0															--属性值2
	);	--]]
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6956, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local nX, nY, nZ = npc.GetCoordinateSkillTarget()
	if not scene then
		return
	end
	...
	local npc = scene.CreateNpc(26891, nX, nY, nZ, 0, 240)	
end
