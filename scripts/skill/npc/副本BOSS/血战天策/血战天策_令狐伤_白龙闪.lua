...
tSkillData = 
{
	{nDamageBase = 39700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 77800, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 77800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 98500, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6949, dwSkillLevel);		-- 设置1号位Buff
