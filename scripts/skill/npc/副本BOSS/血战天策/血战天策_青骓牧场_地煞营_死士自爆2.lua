---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_青骓牧场_地煞营_死士自爆2.lua
-- 更新时间:	2013/10/21 15:33:09
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 127000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 125000, nDamageRand = 0, nCostMana = 0}, --level 2
