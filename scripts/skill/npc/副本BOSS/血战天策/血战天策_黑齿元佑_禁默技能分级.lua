---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_禁默技能分级.lua
-- 更新时间:	2013/9/26 10:18:05
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 3
	...
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 20
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6777, 2);		-- 设置1号位Buff
	...
	skill.nAreaRadius = (3 + dwSkillLevel) * LENGTH_BASE;		-- 技能作用半径
