...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(                                                           
		...
		"Map/血战天策/skill/狼牙据点-横扫千军-创建npc.lua",                                                                        
		0                                                                         
	); 	
	...
	-- 技能CD, CoolDownIndex为CD位(共3个), nCoolDownID为CoolDownList.tab内的CDID
	 -- skill.SetNormalCoolDown(1, 651);	--技能普通CD
	...
	--skill.nChannelInterval	= 4; 				-- 通道技间隔时间
...
function Apply(dwCharacterID)
	...
	--if not scene then
		--return
	--end
	--scene.CreateNpc(27014, npc.nX, npc.nY, npc.nZ, 0, 480)
end
