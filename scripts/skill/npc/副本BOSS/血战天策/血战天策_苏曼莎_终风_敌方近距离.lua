...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_苏曼莎_终风_敌方近距离.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6911, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if player.GetKungfuMount() then
			if player.GetKungfuMount().dwSkillID == 10145 or player.GetKungfuMount().dwSkillID == 10144 or player.GetKungfuMount().dwSkillID == 10242 or player.GetKungfuMount().dwSkillID == 10243 or player.GetKungfuMount().dwSkillID == 10224 or player.GetKungfuMount().dwSkillID == 10225 then
		...
		if player.nCurrentMana < player.nMaxMana * 0.015 then
			player.nCurrentLife = player.nCurrentLife - player.nMaxLife * 0.05
		else
			player.nCurrentMana = player.nCurrentMana - player.nMaxMana * 0.015
		end
	else
		if player.GetKungfuMount() then
			if player.GetKungfuMount().dwSkillID == 10145 or player.GetKungfuMount().dwSkillID == 10144 or player.GetKungfuMount().dwSkillID == 10242 or player.GetKungfuMount().dwSkillID == 10243 or player.GetKungfuMount().dwSkillID == 10224 or player.GetKungfuMount().dwSkillID == 10225 then
