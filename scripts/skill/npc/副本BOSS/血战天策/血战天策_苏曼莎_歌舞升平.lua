...
tSkillData = 
{
	{nDamageBase = 130000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_苏曼莎_歌舞升平.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6884, dwSkillLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 6966, dwSkillLevel + 2);  -- 设置2号位Buff
	skill.BindBuff(3, 6885, dwSkillLevel);		-- 设置3号位Buff
	--skill.BindBuff(4, 6885, 1);		-- 设置4号位Buff
...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 26459 or npc.dwTemplateID == 27198 then
		return
	else
		npc.AddBuff(0,99,7137,1)
	end
end
