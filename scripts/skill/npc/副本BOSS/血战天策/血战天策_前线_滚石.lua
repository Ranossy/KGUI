...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_前线_滚石.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 175 then
		if npctarget.dwTemplateID == 26040 or npctarget.dwTemplateID == 26043 or npctarget.dwTemplateID == 26045 or npctarget.dwTemplateID == 26046 or npctarget.dwTemplateID == 26742 or npctarget.dwTemplateID == 26924 then
			npc.FireAIEvent(2001, 0, 0)
		end
	end
	
	if scene.dwMapID == 176 then
		if npctarget.dwTemplateID == 27109 or npctarget.dwTemplateID == 27110 or npctarget.dwTemplateID == 27111 or npctarget.dwTemplateID == 27112 or npctarget.dwTemplateID == 27252 or npctarget.dwTemplateID == 27357 then
			npc.FireAIEvent(2001, 0, 0)
		end
	end
end
