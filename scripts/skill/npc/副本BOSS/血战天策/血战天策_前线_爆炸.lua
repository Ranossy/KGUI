...
tSkillData =
{
	...
	{nDamageBase = 178000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_前线_爆炸.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if npc.dwTemplateID == 26040 or npc.dwTemplateID == 26043 or npc.dwTemplateID == 26045 or npc.dwTemplateID == 26742 then
			--if not npc.GetBuff(6667, 1) then
				npc.AddBuff(0, 99, 6667, 1)
			--end
		end
	end
	
	if scene.dwMapID == 176 then
		if npc.dwTemplateID == 27109 or npc.dwTemplateID == 27110 or npc.dwTemplateID == 27111 or npc.dwTemplateID == 27252 then
			--if not npc.GetBuff(6667, 1) then
				npc.AddBuff(0, 99, 6667, 2)
			--end
		end
	end
end
