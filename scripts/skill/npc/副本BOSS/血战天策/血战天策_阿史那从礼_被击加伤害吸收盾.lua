---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_被击加伤害吸收盾.lua
-- 更新时间:	2013/9/29 15:41:48
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_被击加伤害吸收盾.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if not cNpc.GetBuff(6570, 1) then
			cNpc.AddBuff(6570,1)
		end
	else
		if not cNpc.GetBuff(6570, 2) then
			cNpc.AddBuff(6570,2)
		end
	end
end
