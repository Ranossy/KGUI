---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/英雄血战天策_令狐伤_一剑诀·一重.lua
-- 更新时间:	2016/1/8 15:17:31
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 1263000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/英雄血战天策_令狐伤_一剑诀·一重.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7257, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.nCurrentLife = player.nCurrentLife * 0.5
	player.nCurrentMana = player.nCurrentMana * 0.5
	player.PlaySfx(244, 0, 0, 0)
	npc.PlaySfx(502, 0, 0, 0)
	if npc.dwTemplateID == 26460 or npc.dwTemplateID == 26461 or npc.dwTemplateID == 26462 or npc.dwTemplateID == 26463 or npc.dwTemplateID == 26823 or npc.dwTemplateID == 26583 or npc.dwTemplateID == 26592 or npc.dwTemplateID == 27199 or npc.dwTemplateID == 27200 or npc.dwTemplateID == 27201 or npc.dwTemplateID == 27202 or npc.dwTemplateID == 27207 or npc.dwTemplateID == 27217 or npc.dwTemplateID == 27218 then
		npc.AddBuff(0, 99, 7252, 1)
	end
end
