---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_溅射.lua
-- 更新时间:	2013/9/11 17:08:56
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_溅射.lua",
		0
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(6763, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	--skill.AddSlowCheckDestBuff(6764, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6543, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local tplayer = cNpc.GetSkillTarget()
	if tplayer then
		--local nX, nY, nZ = player.GetCoordinateSkillTarget()
		--特效是临时的
		cNpc.PlaySfx(571, tplayer.nX, tplayer.nY, tplayer.nZ)
	end
end
