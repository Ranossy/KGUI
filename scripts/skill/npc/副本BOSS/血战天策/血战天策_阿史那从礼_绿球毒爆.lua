---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_绿球毒爆.lua
-- 更新时间:	2013/8/21 12:20:30
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamageBase = 22000, nDamageRand = 0, nCostMana = 0}, --level 3
...
--		skill.BindBuff(1, 6544, dwSkillLevel);		-- 设置1号位Buff
--	end
	skill.BindBuff(1, 6735, dwSkillLevel);		-- 设置2号位Buff
