---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_禁默子技能.lua
-- 更新时间:	2013/9/9 16:33:12
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_禁默子技能.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if playerthis.GetBuff(6778, 1) then
		local buff = playerthis.GetBuff(6778, 1)
		if buff then
			playerthis.CastSkill(8240, buff.nStackNum)
		end
	end
end
