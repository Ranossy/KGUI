---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_突厥秘术·斩_10_1.lua
-- 更新时间:	2013/9/16 10:50:15
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 33000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 39000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 250000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 250000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 250000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 250000, nDamageRand = 0, nCostMana = 0}, --level 6
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_突厥秘术·斩_10_1.lua",
		0
	);
    --]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	if dwSkillLevel == 1 then
		skill.AddSlowCheckDestBuff(6543, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	elseif dwSkillLevel == 2 then
		skill.AddSlowCheckDestBuff(6543, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 3 then
		skill.AddSlowCheckDestBuff(6817, 2, BUFF_COMPARE_FLAG.LESS, 1, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 4 then
		skill.AddSlowCheckDestBuff(6817, 3, BUFF_COMPARE_FLAG.LESS, 1, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 5 then
		skill.AddSlowCheckDestBuff(6817, 4, BUFF_COMPARE_FLAG.LESS, 1, BUFF_COMPARE_FLAG.EQUAL);
	end
