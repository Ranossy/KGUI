---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_雷狼_忠魂.lua
-- 更新时间:	2013/10/23 14:50:12
-- 更新用户:	liguanghao2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"scripts/skill/npc/副本BOSS/血战天策/血战天策_雷狼_忠魂.lua",
		0
	)
	----------------- 技能施放Buff需求 ---------------------------------------------
		...
		if scene then
			...
			if #tPlayer ~= 0 then
				for i = 1, #tPlayer do
					...
					if player then
						local Buff = player.GetBuff(6721, 1)
						if Buff then
