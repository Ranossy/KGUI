...
tSkillData =
{
	{nDamageBase = 54000, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 99000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	--[[
   	skill.SetSubsectionSkill(1, 1, 6999, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 6999, dwSkillLevel);
	skill.SetSubsectionSkill(3, 3, 6999, dwSkillLevel);
	skill.SetSubsectionSkill(4, 4, 6999, dwSkillLevel);
	--skill.SetSubsectionSkill(5, 5, 6995, dwSkillLevel);
	--]]
   skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6548, dwSkillLevel);		-- 设置1号位Buff
