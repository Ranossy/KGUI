...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_苏曼莎_月下夜影_狂乱.lua",								--属性值1
		0															--属性值2
	);	
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	if player.GetKungfuMount() then
		if player.GetKungfuMount().dwSkillID == 10224 or player.GetKungfuMount().dwSkillID == 10225 or player.GetKungfuMount().dwSkillID == 10268 or player.GetKungfuMount().dwSkillID == 10144 or player.GetKungfuMount().dwSkillID == 10145 or player.GetKungfuMount().dwSkillID == 10242 or player.GetKungfuMount().dwSkillID == 10223 then
			if player.nCurrentLife < player.nMaxLife * 0.7 then
				return false
			end
		elseif player.nCurrentMana < player.nMaxMana * 0.9 then
			return false
		else
			return nPreResult
		end
...
function Apply(dwCharacterID)
	...
	npc.CastSkill(8225, 1, TARGET.PLAYER, dwCharacterID)
	if player.GetKungfuMount().dwSkillID == 10224 or player.GetKungfuMount().dwSkillID == 10225 or player.GetKungfuMount().dwSkillID == 10268 or player.GetKungfuMount().dwSkillID == 10144 or player.GetKungfuMount().dwSkillID == 10145 or player.GetKungfuMount().dwSkillID == 10242 or player.GetKungfuMount().dwSkillID == 10223 then
			if player.nCurrentLife > player.nMaxLife * 0.7 then
				player.nCurrentLife = player.nCurrentLife - player.nMaxLife * 0.7
			else
