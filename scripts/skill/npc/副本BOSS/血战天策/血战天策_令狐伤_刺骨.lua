...
tSkillData = 
{
	{nDamageBase = 31000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 31000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 31000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 31000, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6962, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6962, 1) then
		if player.GetBuff(6962, 1).nStackNum == 3 then
			player.AddBuff(0,99,6933,1)
		end
	end
	if player.GetBuff(6962, 2) then
		if player.GetBuff(6962, 2).nStackNum == 3 then
			player.AddBuff(0,99,6933,2)
		end
	end
	if player.GetBuff(6962, 3) then
		if player.GetBuff(6962, 3).nStackNum == 3 then
			player.AddBuff(0,99,6933,3)
		end
	end
	if player.GetBuff(6962, 4) then
		if player.GetBuff(6962, 4).nStackNum == 3 then
			player.AddBuff(0,99,6933,4)
		end
	end		
end
