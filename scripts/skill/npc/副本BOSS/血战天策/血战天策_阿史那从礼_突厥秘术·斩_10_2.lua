...
tSkillData =
{
	...
	{nDamageBase = 17000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 65000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 65000, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 65000, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 65000, nDamageRand = 0, nCostMana = 0},		--level 6
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddSlowCheckDestBuff(6543, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	elseif dwSkillLevel == 2 then
		skill.AddSlowCheckDestBuff(6543, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 3 then
		skill.AddSlowCheckDestBuff(6817, 2, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 4 then
		skill.AddSlowCheckDestBuff(6817, 3, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	elseif dwSkillLevel == 5 then
		skill.AddSlowCheckDestBuff(6817, 4, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	end
