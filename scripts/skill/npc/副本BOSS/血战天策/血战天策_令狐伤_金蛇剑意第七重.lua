...
tSkillData = 
{
	{nDamageBase = 6800, nDamageRand = 0, nCostMana = 0}, --level 1 
	{nDamageBase = 70000, nDamageRand = 0, nCostMana = 0}, --level 2  
	{nDamageBase = 19100, nDamageRand = 0, nCostMana = 0}, --level 3  
	{nDamageBase = 80400, nDamageRand = 0, nCostMana = 0}, --level 4  
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_金蛇剑意第七重.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6927, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6927, 1) and player.GetBuff(6927, 1).nStackNum >= 5 then
		npc.CastSkill(8567, 3, TARGET.PLAYER, dwCharacterID)
		scene.CreateNpc(27435,player.nX,player.nY,player.nZ,0,480)
	end
	if player.GetBuff(6927, 2) and player.GetBuff(6927, 2).nStackNum >= 5 then
		npc.CastSkill(8567, 4, TARGET.PLAYER, dwCharacterID)
		scene.CreateNpc(27498,player.nX,player.nY,player.nZ,0,480)
	end
	if player.GetBuff(6927, 3) and player.GetBuff(6927, 3).nStackNum >= 5 then
		npc.CastSkill(8567, 13, TARGET.PLAYER, dwCharacterID)
		scene.CreateNpc(36033,player.nX,player.nY,player.nZ,0,480)
	end
	if player.GetBuff(6927, 4) and player.GetBuff(6927, 4).nStackNum >= 5 then
		npc.CastSkill(8567, 14, TARGET.PLAYER, dwCharacterID)
		scene.CreateNpc(36258,player.nX,player.nY,player.nZ,0,480)
	end	
end
