---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_折磨.lua
-- 更新时间:	2013/9/18 10:34:07
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	...
	{nDamageBase = 21300, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 28400, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 35500, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 42600, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 18900, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 28350, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 37800, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 47250, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 56700, nDamageRand = 0, nCostMana = 0}, --level 10
};
