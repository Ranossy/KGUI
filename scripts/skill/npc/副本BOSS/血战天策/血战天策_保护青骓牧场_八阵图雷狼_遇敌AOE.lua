---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_保护青骓牧场_八阵图雷狼_遇敌AOE.lua
-- 更新时间:	2013/11/5 10:01:55
-- 更新用户:	liguanghao2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_保护青骓牧场_八阵图雷狼_遇敌AOE.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	--print("八阵图-雷狼：".."搜索到的目标模板ID为："..npcTarget.dwTemplateID)
	local npcBoss = scene.GetNpcByNickName("bazhentuleilang")
	if not npcBoss then
		return
	end
	--[[
