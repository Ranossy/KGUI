---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_流血.lua
-- 更新时间:	2013/9/9 15:11:08
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_流血.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 6772,dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		playerthis.AddBuff(0, 99, 6772, 1)
	else
		playerthis.AddBuff(0, 99, 6772, 2)
	end
end
