...
tSkillData =
{
	...
	{nDamageBase = 1000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 2000, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 150, nDamageRand = 0, nCostMana = 0},		--level 5
	...
	{nDamageBase = 1200, nDamageRand = 0, nCostMana = 0}, 		--level 10
	{nDamageBase = 1800, nDamageRand = 0, nCostMana = 0},		--level 11
	{nDamageBase = 2400, nDamageRand = 0, nCostMana = 0},		--level 12
	{nDamageBase = 180, nDamageRand = 0, nCostMana = 0},		--level 13
	{nDamageBase = 360, nDamageRand = 0, nCostMana = 0},		--level 14
	{nDamageBase = 540, nDamageRand = 0, nCostMana = 0},		--level 15
	{nDamageBase = 720, nDamageRand = 0, nCostMana = 0},		--level 16
};
