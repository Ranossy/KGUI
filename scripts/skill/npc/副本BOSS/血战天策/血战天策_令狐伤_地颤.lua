...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6953, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6953, 1) then
		if player.GetBuff(6953, 1).nStackNum == 2 then
			player.AddBuff(0,99,6954,1)
		elseif player.GetBuff(6953, 1).nStackNum == 5 then
			player.AddBuff(0,99,6955,1)
		end
	end
end
