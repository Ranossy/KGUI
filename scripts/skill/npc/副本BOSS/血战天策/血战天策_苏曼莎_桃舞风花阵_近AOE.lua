...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6922, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6922, 1) and player.GetBuff(6922, 1).nStackNum == 30 then
		player.Die()			
	end
	if player.GetBuff(6922, 2) and player.GetBuff(6922, 2).nStackNum == 30 then
		player.Die()			
	end
end
