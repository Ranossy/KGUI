...
tSkillData = 
{
	{nDamageBase = 1400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 4000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 8900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 15100, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_白龙剑走.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if player.GetBuff(362, 0) or player.GetBuff(673, 0) or player.GetBuff(2836,0 ) or player.GetBuff(2837, 0) then
			npc.AddBuff(0,99,7167,1)
		end
		if player.GetBuff(112, 0) or player.GetBuff(720, 0) or player.GetBuff(2712, 0) then
			npc.nCurrentLife = npc.nCurrentLife + 40000
		end
		if player.GetBuff(382, 0) then
			npc.AddBuff(0,99,7168,1)
		end
	elseif scene.dwMapID == 176 then
		if player.GetBuff(362, 0) or player.GetBuff(673, 0) or player.GetBuff(2836,0 ) or player.GetBuff(2837, 0) then
			npc.AddBuff(0,99,7167,2)
		end
		if player.GetBuff(112, 0) or player.GetBuff(720, 0) or player.GetBuff(2712, 0) then
			npc.nCurrentLife = npc.nCurrentLife + 80000
		end
		if player.GetBuff(382, 0) then
			npc.AddBuff(0,99,7168,2)
		end
	elseif scene.dwMapID == 182 then
		if player.GetBuff(362, 0) or player.GetBuff(673, 0) or player.GetBuff(2836,0 ) or player.GetBuff(2837, 0) then
			npc.AddBuff(0,99,7167,3)
		end
		if player.GetBuff(112, 0) or player.GetBuff(720, 0) or player.GetBuff(2712, 0) then
			npc.nCurrentLife = npc.nCurrentLife + 80000
		end
		if player.GetBuff(382, 0) then
			npc.AddBuff(0,99,7168,3)
		end	
	else
		if player.GetBuff(362, 0) or player.GetBuff(673, 0) or player.GetBuff(2836,0 ) or player.GetBuff(2837, 0) then
			npc.AddBuff(0,99,7167,4)
		end
		if player.GetBuff(112, 0) or player.GetBuff(720, 0) or player.GetBuff(2712, 0) then
			npc.nCurrentLife = npc.nCurrentLife + 80000
		end
		if player.GetBuff(382, 0) then
			npc.AddBuff(0,99,7168,4)
		end	
	end
end
