...
tSkillData = 
{
	{nDamageBase = 15100, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 17800, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_小怪_致命猎杀.lua",								--属性值1
		0															--属性值2
	);	
