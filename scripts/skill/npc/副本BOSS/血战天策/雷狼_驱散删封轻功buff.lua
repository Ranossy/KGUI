---------------------------------------------------------------------->
-- 脚本名称:	scripts/Map/血战天策/skill/雷狼_驱散删封轻功buff.lua
-- 更新时间:	2013/11/18 17:15:26
-- 更新用户:	liguanghao2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame)
	local cNpc = GetNpc(nCharacterID)
	if not cNpc then
		return
	end
	...
	for i = 1, #playerlist do
		...
		if playertarget and playertarget.GetBuff(6708, 1) then
			playertarget.DelBuff(6708, 1)
		end
		if playertarget and playertarget.GetBuff(6708, 2) then
			playertarget.DelBuff(6708, 2)
		end
	end
end
