---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_黑暗治愈_治疗.lua
-- 更新时间:	2013/9/9 16:06:21
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 270000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 900000, nDamageRand = 0, nCostMana = 0}, --level 2
