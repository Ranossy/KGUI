...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_冰牙圆舞.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6927,1) then
		scene.CreateNpc(27044, 1, player.nX, player.nY, player.nZ, 0, 128)
	end
	if player.GetBuff(6927,2) then
		scene.CreateNpc(27403, 1, player.nX, player.nY, player.nZ, 0, 128)
	end
