...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_小怪_外袖寒光_伤害.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 7007, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSrcID)	
	...
	if player.GetBuff(7021, 1) then
		player.AddBuff(0,99,7007,1)
	end
	if player.GetBuff(7021, 2) then
		player.AddBuff(0,99,7007,2)
	end	
end
