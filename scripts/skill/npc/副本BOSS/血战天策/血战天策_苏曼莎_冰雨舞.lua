...
tSkillData = 
{
	...
	{nDamageBase = 22200, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6932, dwSkillLevel);		-- 设置1号位Buff
	  skill.BindBuff(2, 6934, dwSkillLevel);		-- 设置2号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6932, 1) and player.GetBuff(6932, 1).nStackNum == 5 then
		player.AddBuff(0, 99, 6933, 1)
	end
	if player.GetBuff(6932, 2) and player.GetBuff(6932, 2).nStackNum == 5 then
