...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_前线_喷火.lua",								--属性值1
		0															--属性值2
	);	
	...
	if dwSkillLevel == 1 then
		skill.BindBuff(1, 6670, 1);		-- 设置1号位Buff
	end
	
	if dwSkillLevel == 2 then
		skill.BindBuff(1, 6670, 2)
	end
	...
	--skill.nRectWidth = 0 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	  skill.nAngleRange		= 18;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if npc.dwTemplateID == 26047 or npc.dwTemplateID == 26249 or npc.dwTemplateID == 26292 or npc.dwTemplateID == 26293 then
			npc.FireAIEvent(2001, 0, 0)
		end
	end
	
	if scene.dwMapID == 176 then
		if npc.dwTemplateID == 27113 or npc.dwTemplateID == 27157 or npc.dwTemplateID == 27169 or npc.dwTemplateID == 27170 then
			npc.FireAIEvent(2001, 0, 0)
		end
	end
end
