...
tSkillData = 
{
	{nDamageBase = 700000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 780000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(                                                           
		...
		"skill/npc/副本BOSS/血战天策/血战天策_狼牙据点_爆炸2.lua",                                                                        
		0                                                                        
	);    
...
function Apply(dwCharacterID)
	...
	scene.CreateNpc(26886,npc.nX,npc.nY,npc.nZ,0,720)
end
