---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_天羽漫.lua
-- 更新时间:	2013/8/21 16:52:28
-- 更新用户:	mengxiangfei
-- 脚本说明:	
--------------脚本文件开始------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 2400, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_天羽漫.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if nPlayer.nCurrentMana <= nPlayer.nMaxMana * 0.02 then
		nPlayer.nCurrentMana = 0
	else
		nPlayer.nCurrentMana = nPlayer.nCurrentMana - nPlayer.nMaxMana * 0.02
	end
end
