...
tSkillData =
{
	{nDamageBase = 7600, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.SetSubsectionSkill(1, 1, 6995, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 6995, dwSkillLevel);
	--skill.SetSubsectionSkill(3, 3, 6995, dwSkillLevel);
	--skill.SetSubsectionSkill(4, 4, 6995, dwSkillLevel);
