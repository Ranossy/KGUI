---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_乾元·龙战.lua
-- 更新时间:	2013/9/24 15:43:49
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_乾元·龙战.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6539, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if nplayer.GetBuff(6539, 1) then
		local nbuffcount = nplayer.GetBuff(6539, 1).nStackNum
		if nbuffcount >= 8 then
			--nplayer.Die()
		end
	elseif nplayer.GetBuff(6539, 2) then 
		local nbuffcount = nplayer.GetBuff(6539, 2).nStackNum
		if nbuffcount >= 6 then
			--nplayer.Die()
		end
	end
end
