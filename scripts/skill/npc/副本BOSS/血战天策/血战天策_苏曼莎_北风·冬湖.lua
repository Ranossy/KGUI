...
tSkillData = 
{
	...
	{nDamageBase = 8700, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 17400, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_苏曼莎_北风·冬湖.lua",								--属性值1
		0															--属性值2
	);	
	
   skill.SetSubsectionSkill(1, 9, 8255, dwSkillLevel);	 
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6904, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6927, 1) then
		player.AddBuff(0,99,6962,1)
	end
	if player.GetBuff(6927, 2) then
		player.AddBuff(0,99,6962,2)
	end
	if player.GetBuff(6927, 3) then
		player.AddBuff(0,99,6962,3)
	end
	if player.GetBuff(6927, 4) then
		player.AddBuff(0,99,6962,4)
	end	
end
