...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_小怪_叶流术.lua",								--属性值1
		0															--属性值2
	);		
...
function Apply(dwCharacterID, dwSrcID)
	...
	local nBuff1 = npc.GetBuff(7009, 1)
	if nBuff1 then
		npc.CastSkill(8374, nBuff1.nStackNum, TARGET.PLAYER, dwCharacterID)
	end
	local nBuff2 = npc.GetBuff(7009, 2)
	if nBuff2 then
		npc.CastSkill(8374, nBuff2.nStackNum+5, TARGET.PLAYER, dwCharacterID)
	end
end
