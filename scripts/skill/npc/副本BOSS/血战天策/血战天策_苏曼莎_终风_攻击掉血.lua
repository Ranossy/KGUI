...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_苏曼莎_终风_攻击掉血.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 7139, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.nCurrentLife < player.nMaxLife * 0.015 then
		player.Die()
	else
		player.nCurrentLife = player.nCurrentLife - player.nMaxLife * 0.015
	end
end
