---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_青骓牧场_药师观_点燃稻草.lua
-- 更新时间:	2013/10/15 10:42:51
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_青骓牧场_药师观_点燃稻草.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 6984, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if npctarget.dwTemplateID ~= 26845 and npctarget.dwTemplateID ~= 27305 then
		return
	end
	if scene.dwMapID == 175 then
		npctarget.AddBuff(0, 99, 6984, 1)
	else
		npctarget.AddBuff(0, 99, 6984, 2)
	end
end
