...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_山狼_躲闪3.lua",								--属性值1
		0															--属性值2
	);	
	...
	-- 技能CD, CoolDownIndex为CD位(共3个), nCoolDownID为CoolDownList.tab内的CDID
  		skill.SetNormalCoolDown(1, 645);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6877, 1) then
		player.PlaySfx(449, 0, 0, 0)
		player.DelBuff(6877, 1)
		player.AddBuff(0, 99, 6878, 1, 5)
	end
