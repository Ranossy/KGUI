---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_枪.lua
-- 更新时间:	2014/5/23 16:16:08
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 46000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_黑齿元佑_枪.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 654);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		if npc.dwTemplateID ~= 27207 and npc.dwTemplateID ~= 27449 and npc.dwTemplateID ~= 27393 and npc.dwTemplateID ~= 27388
			and npc.dwTemplateID ~= 27390 and npc.dwTemplateID ~= 27391 and npc.dwTemplateID ~= 27392 and npc.dwTemplateID ~= 26525
			and npc.dwTemplateID ~= 27450 and npc.dwTemplateID ~= 27007 and npc.dwTemplateID ~= 27002 and npc.dwTemplateID ~= 27004
			and npc.dwTemplateID ~= 27005 and npc.dwTemplateID ~= 27006 then
			local player = GetPlayer(dwSkillSrcID)
			if player then
				player.DelGroupBuff(7041, 1)
				player.DelGroupBuff(244, 1)
				player.DownHorse()
