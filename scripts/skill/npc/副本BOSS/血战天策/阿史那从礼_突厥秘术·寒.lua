...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame)
	...
	if FANWEI_zongkong then
		nCount = FANWEI_zongkong.GetCustomInteger4(28)
	
		if nLeftFrame == 0 then
			--创建大冰
			scene.CreateNpc(1111, nPlayer.nX, nPlayer.nY, nPlayer.nZ, 0, -1, "dabingqiu"..nCount)
		else
			--创建小冰
			scene.CreateNpc(1111, nPlayer.nX, nPlayer.nY, nPlayer.nZ, 0, -1, "xiaobingqiu"..nCount)
		end
		
		nCount = nCount + 1
		FANWEI_zongkong.SetCustomInteger4(28, nCount)
	end
