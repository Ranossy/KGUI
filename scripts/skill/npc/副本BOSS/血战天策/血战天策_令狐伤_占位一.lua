---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_令狐伤_占位一.lua
-- 更新时间:	2013/11/1 16:27:00
-- 更新用户:	liguanghao2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_令狐伤_占位一.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if player then
		...
		if buff and buff.nCustomValue == 1 then
			if npcLhs then
				npcLhs.SetCustomBoolean(50, true)              ----------------QTE变量判断
			end
			RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 1, false)
			RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 8520)
		else
