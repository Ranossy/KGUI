---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_天羽漫蓝球被杀AOE.lua
-- 更新时间:	2013/8/21 17:28:15
-- 更新用户:	mengxiangfei
-- 脚本说明:	
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阿史那从礼_天羽漫蓝球被杀AOE.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if nplayer.GetBuff(6576, 1) then
		nplayer.DelBuff(6576, 1)
	end
	--[[
	if nplayer.GetBuff(6576, 2) then
		nplayer.DelBuff(6576, 2)
	end
	--]]
	if nplayer.nCurrentMana >= nplayer.nMaxMana * 0.5 then
		nplayer.nCurrentMana = nplayer.nMaxMana
	else
		nplayer.nCurrentMana = nplayer.nCurrentMana + nplayer.nMaxMana * 0.5
	end
end
