...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		local nBuff = npc.GetBuff(6811, 1)
		if nBuff then
			npc.CastSkill(8238, nBuff.nStackNum + 1)
			npc.CastSkill(8239, nBuff.nStackNum + 1)
		else
			npc.CastSkill(8238, 1)
			npc.CastSkill(8239, 1)
		end
	else
		local nBuff = npc.GetBuff(6811, 2)
		if nBuff then
			npc.CastSkill(8238, nBuff.nStackNum + 12)
			npc.CastSkill(8239, nBuff.nStackNum + 12)
		else
			npc.CastSkill(8238, 12)
			npc.CastSkill(8239, 12)
		end
	end
end
