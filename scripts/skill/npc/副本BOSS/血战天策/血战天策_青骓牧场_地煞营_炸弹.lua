---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_青骓牧场_地煞营_炸弹.lua
-- 更新时间:	2013/10/22 16:13:13
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	...
	{nDamageBase = 640000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	if GetDistanceSq(player.nX, player.nY, 0, 39546, 53874, 0) >= (64 * 100) ^ 2 then
