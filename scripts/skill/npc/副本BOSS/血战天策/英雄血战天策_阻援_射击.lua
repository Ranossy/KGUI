---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/英雄血战天策_阻援_射击.lua
-- 更新时间:	2013/11/11 9:35:16
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 240000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 140000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_前线_箭弩特效.lua",
		0
	);
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/英雄血战天策_阻援_射击.lua", --属性值1
		0															--属性值2
	);	
	...
	skill.SetNormalCoolDown(1, 656);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 175 then
		if npc.dwTemplateID == 26040 or npc.dwTemplateID == 26043 or npc.dwTemplateID == 26045 or npc.dwTemplateID == 26046 or npc.dwTemplateID == 26742 or npc.dwTemplateID == 26924 then
			npc.AddBuff(0, 99, 6987, 1, 8)
		end
	end
	
	if scene.dwMapID == 176 then
		if npc.dwTemplateID == 27109 or npc.dwTemplateID == 27110 or npc.dwTemplateID == 27111 or npc.dwTemplateID == 27112 or npc.dwTemplateID == 27252 or npc.dwTemplateID == 27357 then
			npc.AddBuff(0, 99, 6987, 2, 6)
		end
	end
end
