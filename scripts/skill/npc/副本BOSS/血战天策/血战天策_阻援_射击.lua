...
tSkillData =
{
	{nDamageBase = 1350000, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阻援_箭弩特效.lua",
		0
	);
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_阻援_射击.lua",								--属性值1
		0															--属性值2
	);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	-- 技能CD, CoolDownIndex为CD位(共3个), nCoolDownID为CoolDownList.tab内的CDID
	  skill.SetNormalCoolDown(1, 655);	--技能普通CD
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	RemoteCallToClient(player.dwID, "SetMaxCameraDistance", 200)
	--player.AddBuff(0, 99, 6484, 1, 1) --镜头恢复
	--player.AddBuff(0, 99, 6485, 1, 1) --镜头恢复
	player.AddBuff(0, 99, 6743, 1, 1)
	return nPreResult;
end
...
function Apply(dwCharacterID)
	...
	npctarget.PlaySfx(553, 0, 0, 0)
	if npctarget.dwTemplateID == 26343 or npctarget.dwTemplateID == 26676 or npctarget.dwTemplateID == 26678 or npctarget.dwTemplateID == 26679 or npctarget.dwTemplateID == 26883 or npctarget.dwTemplateID == 27176 or npctarget.dwTemplateID == 27226 or npctarget.dwTemplateID == 27227 or npctarget.dwTemplateID == 27228 or npctarget.dwTemplateID == 27334 then
		if npctarget.GetCustomInteger1(1) == 4 then
			npctarget.Die()
		end
	end
end
