---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/血战天策/血战天策_青骓牧场_药师观_重弩脱离.lua
-- 更新时间:	2013/10/25 11:05:00
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/英雄血战天策_青骓牧场_药师观_重弩脱离.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if playerthis.GetBuff(7066, 1) then
		playerthis.DelBuff(7066, 1)
	end
end
