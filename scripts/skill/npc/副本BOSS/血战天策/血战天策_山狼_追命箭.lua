...
tSkillData = 
{
	{nDamageBase = 284000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 333000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_山狼_追命箭.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(553, player.nX, player.nY, player.nZ + 300)
end
