...
tSkillData = 
{
	{nDamageBase = 42600, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/血战天策/血战天策_小怪_致死猎杀.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6992, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6927, 1) or player.GetBuff(6927, 2) or player.GetBuff(6938, 1) or player.GetBuff(6938, 2) or player.GetBuff(6992, 1) or player.GetBuff(6992, 2) then
		player.Die()
	end
	if player.GetBuff(6978, 1) or player.GetBuff(6978, 2) or player.GetBuff(6988, 1) or player.GetBuff(6988, 2) then
		player.Die()
	end
end
