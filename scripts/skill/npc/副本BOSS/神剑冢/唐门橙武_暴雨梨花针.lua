...
tSkillData =
{
	{nDamage = 4280 * 0.8, nDamageRand = 4280 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 185 * 0.95, nDamageRand = 185 * 0.1, nCostMana = 0},		--level 2
	{nDamageBase = 313 * 0.95, nDamageRand = 313 * 0.1, nCostMana = 0},		--level 3
	{nDamageBase = 450 * 0.95, nDamageRand = 450 * 0.1, nCostMana = 0},		--level 4
