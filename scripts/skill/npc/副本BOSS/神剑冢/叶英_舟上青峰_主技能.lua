---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/神剑冢/叶英_舟上青峰_主技能.lua
-- 更新时间:	2013/7/14 17:38:52
-- 更新用户:	liguanghao2
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/神剑冢/叶英_舟上青峰_主技能.lua",
		0														
	);
	----------------- 魔法属性 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		if scene then
			local feijian1 = scene.CreateNpc(25660, 17881, 5207, 1087040, 171, -1, "feijian1")
			local feijian2 = scene.CreateNpc(25660, 15670, 5207, 1087040, 214, -1, "feijian2")
			local feijian3 = scene.CreateNpc(25660, 14537, 3278, 1087040, 0, -1, "feijian3")
			local feijian4 = scene.CreateNpc(25660, 15663, 1319, 1087040, 43, -1, "feijian4")
			local feijian5 = scene.CreateNpc(25660, 17917, 1328, 1087040, 86, -1, "feijian5")
			local feijian6 = scene.CreateNpc(25660, 18822, 3283, 1087040, 128, - 1, "feijian6")
			local npcSrc = scene.GetNpcByNickName("95bossyeying")
			if npcSrc then
				feijian1.nMaxLife = 450000
				feijian1.nCurrentLife = 450000
				feijian2.nMaxLife = 450000
				feijian2.nCurrentLife = 450000
				feijian3.nMaxLife = 450000
				feijian3.nCurrentLife = 450000
				feijian4.nMaxLife = 450000
				feijian4.nCurrentLife = 450000
				feijian5.nMaxLife = 450000
				feijian5.nCurrentLife = 450000
				feijian6.nMaxLife = 450000
				feijian6.nCurrentLife = 450000
				return
			end
			---middle point(16781, 3260, 1086400)
		end
	end
end
