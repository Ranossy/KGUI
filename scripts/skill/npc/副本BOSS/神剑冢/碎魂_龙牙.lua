...
tSkillData =
{
	{nDamageBase = 64600*0.8, nDamageRand = 64600*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3188, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
