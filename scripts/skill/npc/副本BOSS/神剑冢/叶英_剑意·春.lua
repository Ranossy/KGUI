...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/神剑冢/叶英_剑意·春.lua",				
   		0														
   	);
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		if scene then
			local npcXueSong = scene.GetNpcByNickName("xuesong1")
			if not npcXueSong then
				local npcTaoShu1 = scene.CreateNpc(25643, 15203, 4173, 1086955, 171, 288, "taoshu1")
				local npcTaoShu2 = scene.CreateNpc(25643, 16678, 5207, 1086955, 214, 288, "taoshu2")
				local npcTaoShu3 = scene.CreateNpc(25643, 18313, 4200, 1086955, 0, 288, "taoshu3")
				local npcTaoShu3 = scene.CreateNpc(25643, 18333, 2363, 1086955, 43, 288, "taoshu4")
				local npcTaoShu3 = scene.CreateNpc(25643, 16733, 1502, 1086955, 86, 288, "taoshu5")
				local npcTaoShu3 = scene.CreateNpc(25643, 15187, 2340, 1086955, 128, 288, "taoshu6")
				local npcTaoShuZongKong = scene.CreateNpc(25678, 19515, 4521, 1086955, 128, -1, "taoshuzongkong")
			end
		end
	end
end
