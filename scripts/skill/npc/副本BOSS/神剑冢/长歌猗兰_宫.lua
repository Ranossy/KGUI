---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/神剑冢/长歌猗兰_宫.lua
-- 更新时间:	2015/10/14 15:08:36
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6600, nDamageRand = 600, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/神剑冢/长歌猗兰_宫.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(1217, player.nX, player.nY, player.nZ + 500)
end
