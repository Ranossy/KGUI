...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/神剑冢/叶英_剑意·冬.lua",				
   		0														
   	);
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		if scene then
			local npcTaoShu = scene.GetNpcByNickName("taoshu1")
			if not npcTaoShu then
				local npcXuesong1 = scene.CreateNpc(25644, 15203, 4173, 1086955, 171, 288, "xuesong1")
				local npcXuesong2 = scene.CreateNpc(25644, 16678, 5207, 1086955, 214, 288, "xuesong2")
				local npcXuesong3 = scene.CreateNpc(25644, 18313, 4200, 1086955, 0, 288, "xuesong3")
				local npcXuesong4 = scene.CreateNpc(25644, 18333, 2363, 1086955, 43, 288, "xuesong4")
				local npcXuesong5 = scene.CreateNpc(25644, 16733, 1502, 1086955, 86, 288, "xuesong5")
				local npcXuesong6 = scene.CreateNpc(25644, 15187, 2340, 1086955, 128, 288, "xuesong6")
				local npcXuesongZongKong = scene.CreateNpc(25678, 19515, 4521, 1086955, 128, -1, "taoshuzongkong")
			end
		end
	end
end
