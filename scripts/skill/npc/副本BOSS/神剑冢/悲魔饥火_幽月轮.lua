...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/神剑冢/悲魔饥火_幽月轮.lua",				
   		0														
   		);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 4445, 1);		-- 设置1号位Buff
...
local character = nil
	...
	if character then
		local buff = character.GetBuff(4445, 1)
		if buff and buff.nStackNum == 2 then
			character.AddBuff(0,99,4446,1)
		end
	end
end
