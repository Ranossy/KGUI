...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/神剑冢/炙狱邪龙_醉拳.lua",
		0
	);	
...
function Apply(dwCharacterID)
	...
	for n = 1, 6 do
		local npcJiutan1 = scene.CreateNpc(24305, npc.nX + 320 * math.cos(n / 3 * math.pi), npc.nY + 320 * math.sin(n / 3 * math.pi), 1086397, 0, -1)
		if npcJiutan1 then
			npcJiutan1.AddBuff(0, 99, 6005, 1)
		end
	end
	--[[local npcJiutan2 = scene.CreateNpc(24305, 16378, 2949, 1086397, 0, -1)
	if npcJiutan2 then
		npcJiutan2.AddBuff(0, 99, 6005, 1)
	end
	local npcJiutan3 = scene.CreateNpc(24305, 16302, 3436, 1086397, 0, -1)
	if npcJiutan3 then
		npcJiutan3.AddBuff(0, 99, 6005, 1)
	end
	local npcJiutan4 = scene.CreateNpc(24305, 16694, 3787, 1086397, 0, -1)
	if npcJiutan4 then
		npcJiutan4.AddBuff(0, 99, 6005, 1)
	end
	local npcJiutan5 = scene.CreateNpc(24305, 17172, 3597, 1086397, 0, -1)
	if npcJiutan5 then
		npcJiutan5.AddBuff(0, 99, 6005, 1)
	end
	local npcJiutan6 = scene.CreateNpc(24305, 17267, 3102, 1086397, 0, -1)
	if npcJiutan6 then
		npcJiutan6.AddBuff(0, 99, 6005, 1)
	end--]]
