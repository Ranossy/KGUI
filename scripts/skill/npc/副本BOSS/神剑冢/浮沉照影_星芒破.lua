...
tSkillData =
{
	{nDamageBase = 28800*0.8, nDamageRand = 28800*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/神剑冢/浮沉照影_星芒破.lua",				
   		0														
   		);	
...
function Apply(dwCharacterID)
	...
	local character = scene.GetNpcByNickName("QH_fuchenzhaoying")
	if character then
		character.nCurrentLife = character.nCurrentLife + 10800
	end
end
