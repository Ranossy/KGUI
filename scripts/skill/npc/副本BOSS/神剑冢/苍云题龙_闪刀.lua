---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/神剑冢/苍云题龙_闪刀.lua
-- 更新时间:	2014/11/14 10:26:04
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 53637, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"scripts/skill/npc/副本BOSS/神剑冢/苍云题龙_闪刀.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player then
		scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/神剑冢/苍云题龙_闪刀.lua", player.dwID, 1)
	end
end
