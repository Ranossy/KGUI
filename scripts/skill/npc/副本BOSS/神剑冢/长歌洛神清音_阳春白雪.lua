---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/神剑冢/长歌洛神清音_阳春白雪.lua
-- 更新时间:	2015/10/16 18:12:11
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 8600, nDamageRand = 800, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/神剑冢/长歌洛神清音_阳春白雪.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(177, player.nX, player.nY, player.nZ + 500)
end
