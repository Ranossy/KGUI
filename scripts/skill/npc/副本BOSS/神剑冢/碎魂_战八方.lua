...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/神剑冢/碎魂_战八方.lua",								--属性值1
   			0															--属性值2
   		);
...
local tDirection = {}
	...
	tDirection[3] = npc.nFaceDirection + 60 % 256
		...
		local npcYb = scene.CreateNpc(15600, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 160)
		npcYb.CastSkill(3201,1)
		npcYb.AddBuff(0,99,3205,1)
		if npcYb then
			npcYb.RunTo(nX, nY)
		end
end
