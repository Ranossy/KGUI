---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/神剑冢/长歌猗兰_羽.lua
-- 更新时间:	2015/10/16 18:12:40
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 4900, nDamageRand = 500, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/神剑冢/长歌猗兰_羽.lua", --属性值1
		0															--属性值2
	);
