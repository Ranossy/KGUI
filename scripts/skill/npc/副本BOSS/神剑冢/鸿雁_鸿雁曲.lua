...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
 	...
 	skill.AddAttribute(                                                           
		...
		"skill/npc/副本BOSS/神剑冢/鸿雁_鸿雁曲.lua",                                                                                                               
		0                                                                         
	);
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3173, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local npc = scene.CreateNpc(15604,player.nX,player.nY,player.nZ,0,480);
	if not npc then
		return
	end
	npc.AddBuff(0,99,3174,1)
	npc.AddBuff(0,99,3210,1)
end
