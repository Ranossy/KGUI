---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛_冲击波AOE_子技能.lua
-- 更新时间:	2015/6/23 23:34:18
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 23500 * 1, nDamageRand = 23500 * 0, nBuffLevel = 1}, --level 1
	{nDamageBase = 37000 * 1, nDamageRand = 37000 * 0, nBuffLevel = 1}, --level 2
