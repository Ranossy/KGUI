---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛_龙影剑气球爆炸.lua
-- 更新时间:	2015/5/21 19:50:51
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 50000*0.8, nDamageRand = 50000*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 4200*0.8, nDamageRand = 4200*0.4, nBuffLevel = 1},		--level 2
