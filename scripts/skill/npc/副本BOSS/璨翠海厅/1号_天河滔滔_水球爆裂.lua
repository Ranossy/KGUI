---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/1号_天河滔滔_水球爆裂.lua
-- 更新时间:	2015/5/21 20:41:17
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 36700 * 1, nDamageRand = 36700 * 0, nBuffLevel = 1}, --level 1
	{nDamageBase = 51100 * 1, nDamageRand = 51100 * 0, nBuffLevel = 2}, --level 2
	{nDamageBase = 32000 * 0.8, nDamageRand = 3200 * 0.4, nBuffLevel = 1}, --level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8912, tSkillData[dwSkillLevel].nBuffLevel)		-- 设置1号位Buff
