---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号莫雨_叹问苍穹.lua
-- 更新时间:	2015/5/21 20:13:16
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 122200 * 1, nDamageRand = 122200 * 0, nCostMana = 0}, --level 1
	{nDamageBase = 240000 * 1, nDamageRand = 240000 * 0, nCostMana = 0}, --level 2
