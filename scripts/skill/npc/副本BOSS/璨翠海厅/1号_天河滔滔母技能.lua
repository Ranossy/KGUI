---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/1号_天河滔滔母技能.lua
-- 更新时间:	2015/7/1 14:54:23
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/璨翠海厅/1号_天河滔滔母技能.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nA = Random(1, 256)
	local nR = Random(3, 27)
	local dwAngel = ((nA - 1) * 360 / 256) / 180 * 3.14159265
	local nX_point = npc.nX + 64 * nR * math.cos(dwAngel)
	local nY_point = npc.nY + 64 * nR * math.sin(dwAngel)
	scene.CreateNpc(43195, nX_point, nY_point, npc.nZ, 0, 10 * 16)
end
