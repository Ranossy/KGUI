---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛_龙影浩然.lua
-- 更新时间:	2015/5/21 20:19:01
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/璨翠海厅/2号毛毛_龙影浩然.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
		...
		if npc then
           npc.SetTarget(TARGET.PLAYER,player.dwID);
        	if scene.dwMapID ==200 then
           		npc.CastSkill(14005, 1)
           elseif scene.dwMapID ==222 then
            	npc.CastSkill(14005, 2) 
           end
         end
     end
end
