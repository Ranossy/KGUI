---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛_龙影斩击.lua
-- 更新时间:	2015/5/21 20:22:00
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 216400 * 1, nDamageRand = 216400 * 0, nCostMana = 0}, --level 1
	{nDamageBase = 425000 * 1, nDamageRand = 425000 * 0, nCostMana = 0}, --level 2
