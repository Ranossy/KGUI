---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛莫雨_对掌爆裂.lua
-- 更新时间:	2015/5/24 21:07:09
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(5581, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5568, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if npc then
		if npc.dwTemplateID ~= 42902 and npc.dwTemplateID ~= 43228 and npc.dwTemplateID ~= 42901 and npc.dwTemplateID ~= 43227 and
			npc.dwTemplateID ~= 43905 and npc.dwTemplateID ~= 43939 and npc.dwTemplateID ~= 43908 and npc.dwTemplateID ~= 43938 then
			return
		end
		...
		local npc1 = scene.GetNpcByNickName("zhakai")
		if npc1 then
			npc1.SetTarget(TARGET.NPC,npc.dwID);
			npc1.CastSkill(13921, 1)
		end
	end
end
