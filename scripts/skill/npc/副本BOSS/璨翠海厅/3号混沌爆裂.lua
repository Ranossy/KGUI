---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/3号混沌爆裂.lua
-- 更新时间:	2015/5/21 20:22:28
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 40000 * 1, nDamageRand = 40000 * 0, nBuffLevel = 1}, --level 1
	{nDamageBase = 8700 * 0.8, nDamageRand = 8700 * 0.4, nBuffLevel = 1}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/璨翠海厅/3号混沌爆裂.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player then
		local buff = player.GetBuff(8967, 1)
		if buff then
			return
		end
		local buff1 = player.GetBuff(8967, 2)
		if buff1 then
			return
		end
