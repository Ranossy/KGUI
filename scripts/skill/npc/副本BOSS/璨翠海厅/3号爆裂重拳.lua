---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/3号爆裂重拳.lua
-- 更新时间:	2015/5/21 20:24:14
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 83300 * 1, nDamageRand = 83300 * 0, nCostMana = 0}, --level 1
	{nDamageBase = 119000 * 1, nDamageRand = 119000 * 0, nCostMana = 0}, --level 2
