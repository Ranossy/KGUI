---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/1号_蹈海.lua
-- 更新时间:	2015/5/21 20:26:32
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 133300 * 1, nDamageRand = 133300 * 0, nCostMana = 0}, --level 1
	{nDamageBase = 190500 * 1, nDamageRand = 190500 * 0, nCostMana = 0}, --level 2
	{nDamageBase = 32000 * 0.8, nDamageRand = 3200 * 0.4, nCostMana = 0}, --level 3
