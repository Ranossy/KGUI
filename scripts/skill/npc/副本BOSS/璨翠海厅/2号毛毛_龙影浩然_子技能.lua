---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/2号毛毛_龙影浩然_子技能.lua
-- 更新时间:	2015/6/23 23:35:27
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 24500 * 1, nDamageRand = 24500 * 0, nCostMana = 0}, --level 1
	{nDamageBase = 27200 * 1, nDamageRand = 27200 * 0, nCostMana = 0}, --level 2
