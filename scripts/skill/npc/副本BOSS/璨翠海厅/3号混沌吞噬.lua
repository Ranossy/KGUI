---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/3号混沌吞噬.lua
-- 更新时间:	2015/5/21 20:23:14
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 66500 * 1, nDamageRand = 66500 * 0, nBuffLevel = 1}, --level 1
	{nDamageBase = 84800 * 1, nDamageRand = 84800 * 0, nBuffLevel = 1}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/璨翠海厅/3号混沌吞噬.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 2254, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	--player.AddBuff(0,99,tBuff[nNum][1],nbufflv)
