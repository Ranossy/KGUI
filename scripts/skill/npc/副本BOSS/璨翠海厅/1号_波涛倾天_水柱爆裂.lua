---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/璨翠海厅/1号_波涛倾天_水柱爆裂.lua
-- 更新时间:	2015/6/4 0:58:01
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 48900 * 1, nDamageRand = 48900 * 0, nBuffLevel = 1}, --level 1
	{nDamageBase = 76100 * 1, nDamageRand = 76100 * 0, nBuffLevel = 2}, --level 2
	{nDamageBase = 43200 * 1, nDamageRand = 3200 * 0.4, nBuffLevel = 1}, --level 3
