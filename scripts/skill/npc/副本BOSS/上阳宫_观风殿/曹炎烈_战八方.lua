---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_战八方.lua
-- 更新时间:	2016/3/22 16:35:51
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 8720, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 10800, nDamageRand = 0, nCostMana = 0}, --level 2
