---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复boss相关_消失指定旋风.lua
-- 更新时间:	2016/4/22 14:20:21
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复boss相关_消失指定旋风.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		if npctarget.dwTemplateID == 51101 then
			npctarget.SetDisappearFrames(1, 0)
		end
	end--]]
	...
	if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
		playertarget.AddBuff(npc.dwID, npc.nLevel, 10955, 1, 15)
	end
end
