---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_地上旋风母技能.lua
-- 更新时间:	2016/3/27 10:56:45
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_地上旋风母技能.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 240 or scene.dwMapID == 250 then
		npc.CastSkill(15693, 1)
	end

	if scene.dwMapID == 248 then
		player.Stop()
		npc.CastSkill(15693, 2)
	end
end
