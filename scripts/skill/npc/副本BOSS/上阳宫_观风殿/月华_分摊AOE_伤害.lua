...
tSkillData =
{
	{nDamageBase = 15000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 12200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 10800, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 9400, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 8000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 19000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 15800, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 14200, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 12600, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 8800, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamageBase = 170, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamageBase = 180, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamageBase = 190, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamageBase = 200, nDamageRand = 0, nCostMana = 0}, --level 20
	{nDamageBase = 210, nDamageRand = 0, nCostMana = 0}, --level 21
	{nDamageBase = 220, nDamageRand = 0, nCostMana = 0}, --level 22
	{nDamageBase = 230, nDamageRand = 0, nCostMana = 0}, --level 23
	{nDamageBase = 240, nDamageRand = 0, nCostMana = 0}, --level 24
	{nDamageBase = 250, nDamageRand = 0, nCostMana = 0}, --level 25
	{nDamageBase = 260, nDamageRand = 0, nCostMana = 0}, --level 26
	{nDamageBase = 270, nDamageRand = 0, nCostMana = 0}, --level 27
	{nDamageBase = 280, nDamageRand = 0, nCostMana = 0}, --level 28
	{nDamageBase = 290, nDamageRand = 0, nCostMana = 0}, --level 29
	{nDamageBase = 300, nDamageRand = 0, nCostMana = 0}, --level 30
};
...
function GetSkillLevelData(skill)
	...
	skill.nMaxRadius		= 880 * LENGTH_BASE;		-- 技能施放的最大距离
	...
	skill.nTargetCountLimit	= 200;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制)
