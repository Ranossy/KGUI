---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_箭爆.lua
-- 更新时间:	2016/3/22 19:12:21
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 1360, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 2720, nDamageRand = 0, nCostMana = 0}, --level 2
