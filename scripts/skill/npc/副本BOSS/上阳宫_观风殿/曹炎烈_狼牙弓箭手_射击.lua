---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_狼牙弓箭手_射击.lua
-- 更新时间:	2016/7/19 9:55:10
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_狼牙弓箭手_射击.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	--player.PlaySfx(554, 0, 0, 0)
	--player.PlaySfx(553, player.nX, player.nY, player.nZ + 500)
	scene.SetTimer(0.25 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_狼牙弓箭手_射击.lua", dwSrcID, dwCharacterID)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	player.PlaySfx(1361, player.nX, player.nY, player.nZ + 500)
end
