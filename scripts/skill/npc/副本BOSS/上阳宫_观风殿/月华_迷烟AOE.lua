---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/月华_迷烟AOE.lua
-- 更新时间:	2016/9/6 16:38:54
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/月华_迷烟AOE.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	skill.AddSlowCheckDestBuff(10813, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 10560, 1);		-- 设置1号位Buff
	...
	--skill.nRectWidth = 100 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		...
		if yuehua then
			if player then
				--for i = 1, 30 do
				player.AddBuff(yuehua.dwID, yuehua.nLevel, 10560, 1)
				--end
			end
		end
	end
