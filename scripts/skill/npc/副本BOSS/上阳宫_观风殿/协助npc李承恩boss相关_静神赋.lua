---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_静神赋.lua
-- 更新时间:	2016/8/24 16:39:01
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_静神赋.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		if npctarget.GetBuff(10637, 1) then
			npctarget.DelBuff(10637, 1)
		end
	end
	local scene = npctarget.GetScene()
	--for i = 1, 7 do
	if npctarget.dwTemplateID == 51452 then
		--if npctarget.GetCustomBoolean(11) == true then
			npctarget.FireAIEvent(2002, 0, 0)
			npctarget.AddBuff(npctarget.dwID, npctarget.nLevel, 11117, 1)
			--print("小怪眩晕")
		--end
	end
