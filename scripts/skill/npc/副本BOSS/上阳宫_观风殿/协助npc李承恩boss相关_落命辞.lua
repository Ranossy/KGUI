---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_落命辞.lua
-- 更新时间:	2016/4/22 10:43:56
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_落命辞.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		--if npctarget.dwTemplateID == 22222 then
			--npctarget.AddBuff(npc.dwID, npc.nLevel, 10712, 1, 5)
		--end

		local scene = npctarget.GetScene()
		scene.SetTimer(0.25 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_落命辞.lua", dwSkillSrcID, dwCharacterID)
	end
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if npctarget.dwTemplateID == 51219 or npctarget.dwTemplateID == 54329 then
		npctarget.Die()
	end
end
