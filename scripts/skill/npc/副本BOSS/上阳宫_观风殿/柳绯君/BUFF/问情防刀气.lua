---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/BUFF/问情防刀气.lua
-- 更新时间:	2016/9/29 21:31:24
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function UnApply(dwCharacterID)
	...
	if player then
		...
		local tBuff = player.GetBuff(10013, 1)
		if not tBuff then
			player.AddBuff(player.dwID, player.nLevel, 10013, 1, 1)
		end
	end
end
