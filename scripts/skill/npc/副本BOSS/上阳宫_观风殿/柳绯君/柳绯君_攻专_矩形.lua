---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_攻专_矩形.lua
-- 更新时间:	2016/8/25 17:25:41
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 5000, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 6500, nDamageRand = 250, nCostMana = 0}, --level 2
	{nDamageBase = 9700, nDamageRand = 0, nCostMana = 0}, --level 3
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tBuff = player.GetBuff(10638, 1)
	if tBuff then
		player.DelGroupBuff(10638, 1)
	end
end
