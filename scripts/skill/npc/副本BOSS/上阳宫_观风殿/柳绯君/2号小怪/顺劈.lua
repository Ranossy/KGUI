---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/2号小怪/顺劈.lua
-- 更新时间:	2016/8/30 15:52:22
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6000, nDamageRand = 3000, nCostMana = 0}, --level 1
	{nDamageBase = 12000, nDamageRand = 6000, nCostMana = 0}, --level 2
