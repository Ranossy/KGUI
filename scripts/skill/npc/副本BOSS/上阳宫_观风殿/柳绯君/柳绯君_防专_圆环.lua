---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_防专_圆环.lua
-- 更新时间:	2016/9/29 21:11:26
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 200, nDamageRand = 100, nCostMana = 0}, --level 1
	{nDamageBase = 350, nDamageRand = 200, nCostMana = 0}, --level 2
