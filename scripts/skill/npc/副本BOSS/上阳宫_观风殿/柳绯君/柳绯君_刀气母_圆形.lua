---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_刀气母_圆形.lua
-- 更新时间:	2016/7/5 11:49:28
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 16800, nDamageRand = 500, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_刀气母_圆形.lua", --属性值1
		0															--属性值2
	);
	...
	skill.AddSlowCheckDestBuff(10651, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--local tBuff = player.GetBuff(10636, 1)
	--if tBuff then
	--player.DelGroupBuff(10636, 1)
	--end
