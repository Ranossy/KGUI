---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_断骨_圆形.lua
-- 更新时间:	2016/9/30 17:18:50
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 18000, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 10800, nDamageRand = 200, nCostMana = 0}, --level 2
	{nDamageBase = 4800, nDamageRand = 200, nCostMana = 0}, --level 3
	{nDamageBase = 1800, nDamageRand = 200, nCostMana = 0}, --level 4
	{nDamageBase = 82000, nDamageRand = 550, nCostMana = 0}, --level 5
	{nDamageBase = 25000, nDamageRand = 110, nCostMana = 0}, --level 6
	{nDamageBase = 8000, nDamageRand = 110, nCostMana = 0}, --level 7
	{nDamageBase = 2000, nDamageRand = 110, nCostMana = 0}, --level 8
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 29500, nDamageRand = 14750, nCostMana = 0}, --level 1
	{nDamageBase = 115300, nDamageRand = 57650, nCostMana = 0}, --level 2
	{nDamageBase = 230600, nDamageRand = 115300, nCostMana = 0}, --level 3
	{nDamageBase = 35200, nDamageRand = 17600, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
 ...
 - 1024,
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/柳绯君/柳绯君_断骨_圆形.lua", --属性值1
		0															--属性值2
	);
	...
	if #playerlist ~= 0 then
		for i = 1, #playerlist do
			...
			if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
				if playertarget.GetBuff(10655, 1) then
					playertarget.DelGroupBuff(10655, 1)
				end
			end
		end
	end
	local MAPID = npc.GetMapID()
	if MAPID == 240 or MAPID == 250 then  --10PT
		player.AddBuff(npc.dwID, npc.nLevel, 10633, 1)
	end
	if MAPID == 248 then
		player.AddBuff(npc.dwID, npc.nLevel, 10633, 2)
	end
	if MAPID == 220 then
		player.AddBuff(npc.dwID, npc.nLevel, 9423, 1)
	end

	if MAPID == 234 then
		player.AddBuff(npc.dwID, npc.nLevel, 9423, 3)
	end
