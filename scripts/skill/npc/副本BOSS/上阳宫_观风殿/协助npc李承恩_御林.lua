---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩_御林.lua
-- 更新时间:	2016/4/15 14:59:31
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩_御林.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget then
		if playertarget.GetKungfuMount() ~= nil then
			if playertarget.GetKungfuMount().dwSkillID == 10389 or playertarget.GetKungfuMount().dwSkillID == 10390 then
				playertarget.nCurrentRage = playertarget.nCurrentRage + 10
			end

			if playertarget.GetKungfuMount().dwSkillID == 10026 or playertarget.GetKungfuMount().dwSkillID == 10062 then
				playertarget.ClearCDTime(96)
			end
		end
	end
end
