---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_普攻母_单体.lua
-- 更新时间:	2016/9/26 20:36:09
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_普攻母_单体.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if MapID == 240 or MapID == 250 then	--PT
		player.AddBuff(player.dwID, player.nLevel, 10989, 1)
		npc.CastSkill(16289, 1, TARGET.PLAYER, player.dwID)
	end
	if MapID == 248 then	--YX
		player.AddBuff(player.dwID, player.nLevel, 10989, 2)
		npc.CastSkill(16289, 2, TARGET.PLAYER, player.dwID)
	end
end
