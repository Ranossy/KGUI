---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/火焰_秒杀_单体.lua
-- 更新时间:	2016/7/20 17:47:08
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/火焰_秒杀_单体.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.PlaySfx(1397, player.nX, player.nY, player.nZ + 500)
	player.CustomDamage(npc.dwID, 16281, 1, 1, player.nMaxLife * 0.05)
