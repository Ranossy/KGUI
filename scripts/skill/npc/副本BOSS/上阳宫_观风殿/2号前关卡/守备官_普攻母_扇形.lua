---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/守备官_普攻母_扇形.lua
-- 更新时间:	2016/7/19 15:41:23
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/守备官_普攻母_扇形.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nSMapId == 240 or nSMapId == 250 then
		npc.PlaySfx(628, nX, nY, nZ)
		npc.nCurrentLife = npc.nCurrentLife + npc.nMaxLife * 0.01
		npc.CastSkill(16283, 1, TARGET.PLAYER, player.dwID)
	end
	if nSMapId == 248 then
		npc.PlaySfx(628, nX, nY, nZ)
		npc.nCurrentLife = npc.nCurrentLife + npc.nMaxLife * 0.01
		npc.CastSkill(16283, 2, TARGET.PLAYER, player.dwID)
	end
end
