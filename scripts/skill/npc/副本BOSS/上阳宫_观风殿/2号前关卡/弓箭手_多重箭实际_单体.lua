---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/弓箭手_多重箭实际_单体.lua
-- 更新时间:	2016/7/18 14:55:04
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 2600, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 3500, nDamageRand = 500, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/弓箭手_多重箭实际_单体.lua", --属性值1
		0															--属性值2
	);
