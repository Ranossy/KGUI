---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/火焰_地火_圆形.lua
-- 更新时间:	2016/7/25 11:21:03
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/火焰_地火_圆形.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID and scene.dwMapID ~= 248 then
		player.CustomDamage(npc.dwID, 16302, 1, 1, player.nMaxLife * 3 / 400)
	else
		player.CustomDamage(npc.dwID, 16302, 1, 1, player.nMaxLife * 6 / 400)
	end
