---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/长枪兵_普攻母_单体.lua
-- 更新时间:	2016/7/18 15:02:30
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/长枪兵_普攻母_单体.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if MapID == 240 or MapID == 250 then
		player.AddBuff(player.dwID, player.nLevel, 10990, 1)
		npc.CastSkill(16292, 1, TARGET.PLAYER, player.dwID)
	end
	if MapID == 248 then	--YX
		player.AddBuff(player.dwID, player.nLevel, 10990, 2)
		npc.CastSkill(16292, 2, TARGET.PLAYER, player.dwID)
	end
end
