---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/弓箭手_毒爆_圆形.lua
-- 更新时间:	2016/7/18 14:51:20
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 780, nDamageRand = 50, nCostMana = 0}, --level 1
	{nDamageBase = 1050, nDamageRand = 100, nCostMana = 0}, --level 2
