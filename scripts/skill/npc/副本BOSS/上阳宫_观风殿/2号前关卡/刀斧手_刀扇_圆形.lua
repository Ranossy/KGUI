---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_刀扇_圆形.lua
-- 更新时间:	2016/7/20 16:33:04
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 520, nDamageRand = 50, nCostMana = 0}, --level 1
	{nDamageBase = 1050, nDamageRand = 50, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_刀扇_圆形.lua", --属性值1
		0															--属性值2
	);
