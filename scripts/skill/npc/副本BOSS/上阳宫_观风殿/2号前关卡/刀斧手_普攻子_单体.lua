---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_普攻子_单体.lua
-- 更新时间:	2016/7/18 14:57:17
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 290, nDamageRand = 10, nCostMana = 0}, --level 1
	{nDamageBase = 560, nDamageRand = 50, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/刀斧手_普攻子_单体.lua", --属性值1
		0															--属性值2
	);
