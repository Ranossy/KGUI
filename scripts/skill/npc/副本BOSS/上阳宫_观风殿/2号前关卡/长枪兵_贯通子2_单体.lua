---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/长枪兵_贯通子2_单体.lua
-- 更新时间:	2016/7/18 15:14:12
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 520, nDamageRand = 80, nCostMana = 0}, --level 1
	{nDamageBase = 875, nDamageRand = 100, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/2号前关卡/长枪兵_贯通子2_单体.lua", --属性值1
		0															--属性值2
	);
