---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_鬼神乱.lua
-- 更新时间:	2016/4/21 9:58:29
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_鬼神乱.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		npctarget.AddBuff(npc.dwID, npc.nLevel, 10696, 1, 15)
	end

	if npc then
		npc.AddBuff(npc.dwID, npc.nLevel, 10698, 1, 600)
		local scene = npc.GetScene()
		scene.SetTimer(0.25 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_鬼神乱.lua", dwSkillSrcID, dwCharacterID)
	end
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	npc.PlaySfx(1363, npctarget.nX, npctarget.nY, npctarget.nZ)
end
