---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_君子思语.lua
-- 更新时间:	2016/4/20 17:44:34
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_君子思语.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget then
		playertarget.AddBuff(npc.dwID, npc.nLevel, 10690, 1, 15)
		playertarget.PlaySfx(1296, playertarget.nX, playertarget.nY, playertarget.nZ)
	end
end
