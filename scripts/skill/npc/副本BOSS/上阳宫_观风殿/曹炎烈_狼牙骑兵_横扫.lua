---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_狼牙骑兵_横扫.lua
-- 更新时间:	2016/7/20 17:33:22
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_狼牙骑兵_横扫.lua", -- 属性值1
		0															--属性值2
	);
	...
	skill.nAngleRange		= 127;					-- 攻击范围的扇形角度范围
