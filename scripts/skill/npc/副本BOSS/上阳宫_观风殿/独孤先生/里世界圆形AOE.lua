...
tSkillData =
{
	...
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0}, --level 2 金虎普通AOE
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0}, --level 3 金虎落地一击
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0}, --level 4 扫尾一击
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0}, --level 5  植尸将普通攻击
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 500 * LENGTH_BASE;		-- 公治菱普攻
