---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/引仙水榭/引仙水榭 1号 花落无痕剑.lua
...
tSkillData = 
{
	...
	{nDamageBase = 34000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/独孤先生/黄泉幻影灭.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	local thisHuanYing = GetNpc(dwCharacterID)
	if not thisHuanYing then
		return
	end
	thisHuanYing.DoAction(0,10055)
	thisHuanYing.SetCustomInteger1(21,0)
end
