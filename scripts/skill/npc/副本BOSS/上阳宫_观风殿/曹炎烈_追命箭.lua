---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_追命箭.lua
-- 更新时间:	2016/3/22 16:42:00
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 99000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 152000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_追命箭.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_追命箭.lua", dwSrcID, dwCharacterID)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	player.PlaySfx(1365, player.nX, player.nY, player.nZ)
end
