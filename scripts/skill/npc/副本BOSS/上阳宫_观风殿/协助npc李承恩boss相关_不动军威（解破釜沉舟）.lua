---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_不动军威（解破釜沉舟）.lua
-- 更新时间:	2016/4/21 16:02:06
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_不动军威（解破釜沉舟）.lua", -- 属性值1
		0															--属性值2
	);
