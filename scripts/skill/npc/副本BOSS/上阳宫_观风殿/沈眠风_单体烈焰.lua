---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/沈眠风_单体烈焰.lua
-- 更新时间:	2016/8/29 17:02:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 80000, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
 ...
 - 1024,
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/沈眠风_单体烈焰.lua", -- 属性值1
		0															--属性值2
	);
