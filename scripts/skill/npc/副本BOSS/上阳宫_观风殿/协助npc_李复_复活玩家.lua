---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc_李复_复活玩家.lua
-- 更新时间:	2016/11/4 15:11:21
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc_李复_复活玩家.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget and playertarget.nMoveState == MOVE_STATE.ON_DEATH then
		playertarget.Revive()
		playertarget.nCurrentLife = playertarget.nMaxLife
		playertarget.nCurrentMana = playertarget.nMaxMana
		playertarget.AddBuff(npc.dwID, npc.nLevel, 10715, 1, 15)
		playertarget.PlaySfx(1279, playertarget.nX, playertarget.nY, playertarget.nZ)
	end
end
