---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_飞爪母技能.lua
-- 更新时间:	2016/3/25 11:26:53
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_飞爪母技能.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	scene.SetTimer(0.8 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/上阳宫_观风殿/曹炎烈_飞爪母技能.lua", player.dwID, dwCharacterID)
	--player.Stop()
...
function OnTimer(scene, nParam1, nParam2)
	...
	if playertarget then
		...
		if npctarget then
			playertarget.CastSkill(15683, 1, TARGET.NPC, nParam2)
		end
	end
end
