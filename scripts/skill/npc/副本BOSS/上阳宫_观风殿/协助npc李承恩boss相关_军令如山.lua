---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_军令如山.lua
-- 更新时间:	2016/4/21 15:01:42
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李承恩boss相关_军令如山.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget then
		if playertarget.GetBuff(10635, 1) then
			playertarget.DelBuff(10635, 1)
		end
		if playertarget.GetBuff(10634, 1) then
			playertarget.DelBuff(10634, 1)
		end
	end
end
