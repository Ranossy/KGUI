---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_贪功好利_小型爆炸.lua
-- 更新时间:	2016/4/21 11:36:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 50000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 60000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 70000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 80000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 90000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 100000, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复_贪功好利_小型爆炸.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		if not npctarget.GetBuff(10700, 1) then
			npctarget.AddBuff(npc.dwID, npc.nLevel, 10700, 1, 10)
		end
	end
end
