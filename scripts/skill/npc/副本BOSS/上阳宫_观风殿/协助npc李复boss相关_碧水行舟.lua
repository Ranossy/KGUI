---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复boss相关_碧水行舟.lua
-- 更新时间:	2016/4/26 11:27:38
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/上阳宫_观风殿/协助npc李复boss相关_碧水行舟.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	npc.nCurrentMana = npc.nCurrentMana + npc.nMaxMana * 0.1
end
