---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/老鼠肉.lua
-- 更新时间:	2012-10-29 17:44:12
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/明教密道/老鼠肉.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	local tnpc1 = scene.CreateNpc(19986, nX, nY, nZ, 0, 480)
end
