---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/银枪·冲.lua
-- 更新时间:	2012-9-12 9:25:37
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamage = 10500 * 0.8, nDamageRand = 10500 * 0.4, nCostMana = 0}, --level 2
...
function UnApply(dwCharacterID)
	...
	if scene.dwMapID == 142 then
		tnpc.CastSkill(4401, 1)
	elseif scene.dwMapID == 141 then
		tnpc.CastSkill(4401, 2)
	end
end
