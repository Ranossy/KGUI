---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/银枪·挥.lua
-- 更新时间:	2012-10-15 17:15:59
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 145, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 14800 * 0.8, nDamageRand = 14800 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/明教密道/银枪·挥.lua",
		0
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4214, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local tnpc = scene.GetNpcByNickName("BOSS4")
	tnpc.SetCustomBoolean(6, true)
	tnpc.SetCustomInteger4(2, dwCharacterID)
end
