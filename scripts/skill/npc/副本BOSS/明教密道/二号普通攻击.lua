---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/二号普通攻击.lua
-- 更新时间:	2012-10-15 17:06:24
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 60 * 0.8, nDamageRand = 60 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 6300 * 0.8, nDamageRand = 6300 * 0.4, nCostMana = 0}, --level 2
