---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/水柱.lua
-- 更新时间:	2012-10-15 17:07:23
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 230 * 0.8, nDamageRand = 230 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 21600 * 0.8, nDamageRand = 21600 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 2 then	
		skill.BindBuff(1, 4220, 1);		-- 设置1号位Buff
	end
