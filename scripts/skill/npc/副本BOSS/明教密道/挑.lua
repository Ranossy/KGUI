---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/挑.lua
-- 更新时间:	2012-8-15 10:40:19
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 240 * 0.8, nDamageRand = 240 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 25400 * 0.8, nDamageRand = 25400 * 0.4, nCostMana = 0}, --level 2
