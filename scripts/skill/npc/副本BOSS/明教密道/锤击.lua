---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/锤击.lua
-- 更新时间:	2012-10-15 16:59:05
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 120 * 0.8, nDamageRand = 120 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 8400 * 0.8, nDamageRand = 8400 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.nAngleRange = 192;					-- 攻击范围的扇形角度范围
