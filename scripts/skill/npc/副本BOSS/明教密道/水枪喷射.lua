---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/水枪喷射.lua
-- 更新时间:	2012-10-15 17:10:41
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 180 * 0.8, nDamageRand = 180* 0.4, nCostMana = 0}, --level 1
	{nDamage = 10800 * 0.8, nDamageRand = 10800 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.BindBuff(1, 4231, 1);		-- 设置1号位Buff
	end
	...
	--skill.nRectWidth = 40 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
