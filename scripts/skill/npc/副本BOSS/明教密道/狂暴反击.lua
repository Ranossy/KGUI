---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/狂暴反击.lua
-- 更新时间:	2012-8-15 15:53:05
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 100 * 0.8, nDamageRand = 100 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 10000 * 0.8, nDamageRand = 10000 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4224, 1);		-- 设置1号位Buff
