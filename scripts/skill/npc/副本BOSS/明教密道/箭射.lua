---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/npc/副本BOSS/明教密道/箭射.lua
-- 更新时间:	2012-8-30 17:28:40
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 35, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 5100 * 0.8, nDamageRand = 5100 * 0.4, nCostMana = 0}, --level 2
