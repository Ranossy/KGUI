...
tSkillData =
{
	...
	{nDamageBase = 518 * 0.8, nDamageRand = 518 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 878 * 0.8, nDamageRand = 878 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 1259 * 0.8, nDamageRand = 1259 * 0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
		skill.BindBuff(1, 1635, 1);		-- 设置1号位Buff
