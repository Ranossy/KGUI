...
tSkillData =
{
	{nDamageBase = 17991*0.8, nDamageRand = 17991*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 23989*0.8, nDamageRand = 23989*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 2432, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
