...
tSkillData =
{
	{nDamageBase = 16200*0.8, nDamageRand = 16200*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 24900*0.8, nDamageRand = 24900*0.4, nBuffLevel = 1},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1, 2433, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
