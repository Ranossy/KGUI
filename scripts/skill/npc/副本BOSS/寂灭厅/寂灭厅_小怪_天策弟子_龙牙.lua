---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/寂灭厅/寂灭厅_小怪_天策弟子_龙牙.lua
-- 更新时间:	2013/8/16 11:11:49
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 17900 * 0.8, nDamageRand = 17900 * 0.4, nCostMana = 0}, --level 1
	{nDamageBase = 30200 * 0.8, nDamageRand = 30200 * 0.4, nCostMana = 0}, --level 2
