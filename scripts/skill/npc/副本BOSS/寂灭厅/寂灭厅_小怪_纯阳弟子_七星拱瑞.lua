...
tSkillData =
{
	{nDamageBase = 16215*0.8, nDamageRand = 16215*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 21621*0.8, nDamageRand = 21621*0.4, nBuffLevel = 1},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2416, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
