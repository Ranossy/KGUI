...
tSkillData =
{
	{nDamageBase = 26900*0.8, nDamageRand = 26900*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 34800*0.8, nDamageRand = 34800*0.4, nCostMana = 0},		--level 2
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(                                                           
    	...
    	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/寂灭厅/寂灭厅_1号BOSS_藏·剑邪鸠_云飞玉皇.lua",								--属性值1
   			0															--属性值2
   	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
  --skill.BindBuff(1, 2273, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local nCount = scene.GetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.JIMIETING.YUNFEI_COUNT)
	if nCount < 254 then
		scene.SetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.JIMIETING.YUNFEI_COUNT, nCount + 1)
	end
end
