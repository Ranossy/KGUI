...
tSkillData =
{
	{nDamageBase = 3600*0.8, nDamageRand = 3600*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 5100*0.8, nDamageRand = 5100*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2415, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
