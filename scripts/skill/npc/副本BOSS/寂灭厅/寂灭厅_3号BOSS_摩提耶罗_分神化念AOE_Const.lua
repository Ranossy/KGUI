...
tSkillData =
{
	{nDamageBase = 4100*0.8, nDamageRand = 4100*0.4, nCostMana = 0},		--level 1
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/寂灭厅/寂灭厅_3号BOSS_摩提耶罗_分神化念AOE_Const.lua",								--属性值1
   			0															--属性值2
   	);
   	----------------- 魔法属性 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local nCount = scene.GetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.JIMIETING.FENSHEN_COUNT)
	if nCount < 254 then
		scene.SetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.JIMIETING.FENSHEN_COUNT, nCount + 1)
	end
end
