...
tSkillData =
{
	{nDamageBase = 5400*0.8, nDamageRand = 5400*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 10400*0.8, nDamageRand = 10400*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
   	skill.BindBuff(1, 558, 5);		-- 设置1号位Buff
