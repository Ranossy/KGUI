...
tSkillData =
{
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 9300*0.8, nDamageRand = 9300*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 8900*0.8, nDamageRand = 8900*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
	{nDamageBase = 11100*0.8, nDamageRand = 11100*0.4, nBuffLevel=4, nCostMana = 0},		--level 4
	...
	skill.AddAttribute(
 	 ...
 	 skill.AddAttribute(
   		...
   		--	"skill/npc/副本BOSS/法王窟/法王窟_青翼蝠王_音波功.lua",								--属性值1
   			"skill/npc/副本BOSS/龙渊泽/龙渊泽_南诏双雄_刺客_技能2.lua",
   			0															--属性值2
	  );
   	--[[
   	skill.AddAttribute(
	...
	if npc then
		...
		if tPlayer then
			for i = 1, #tPlayer do
				...
				local bOut = Fx_GetOut(cPlayer, npc, 15 * 64)
				if not bOut then
					cPlayer.SetPosition(npc.nX + (64 - Random(1, 128)), npc.nY + (64 - Random(1, 128)), npc.nZ)
				end
			end
		end
	end
