...
tSkillData =
{
	...
	{nDamageBase = 2900*0.8, nDamageRand = 2900*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 2000*0.8, nDamageRand = 2000*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 2900*0.8, nDamageRand = 2900*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3093, 1);		-- 设置1号位Buff
