...
tSkillData =
{
	{nDamageBase = 2700*0.8, nDamageRand = 2700*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 10500*0.8, nDamageRand = 10500*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 8800*0.8, nDamageRand = 8800*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
	{nDamageBase = 12600*0.8, nDamageRand = 12600*0.4, nBuffLevel=4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
   		...
   		--	"skill/npc/副本BOSS/法王窟/法王窟_青翼蝠王_音波功.lua",								--属性值1
   			"skill/npc/副本BOSS/龙渊泽/龙渊泽_南诏双雄_刺客_技能3.lua",
   			0															--属性值2
	  );
   	--[[
   	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2915, 1);		-- 设置1号位Buff
