...
tSkillData =
{
	{nDamageBase = 3500*0.8, nDamageRand = 3500*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 9600*0.8, nDamageRand = 9600*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 7700*0.8, nDamageRand = 7700*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 19300*0.8, nDamageRand = 19300*0.4, nCostMana = 0},		--level 4
