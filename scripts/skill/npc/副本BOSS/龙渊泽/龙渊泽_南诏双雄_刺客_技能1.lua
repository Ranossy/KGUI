...
tSkillData =
{
	{nDamageBase = 2800*0.8, nDamageRand = 2800*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 12300*0.8, nDamageRand = 12300*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
	{nDamageBase = 9800*0.8, nDamageRand = 9800*0.4, nBuffLevel=3, nCostMana = 0},		--level 3
	{nDamageBase = 12300*0.8, nDamageRand = 12300*0.4, nBuffLevel=4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2914, 1);		-- 设置1号位Buff
