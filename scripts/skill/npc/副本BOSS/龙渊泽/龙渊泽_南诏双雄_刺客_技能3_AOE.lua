...
tSkillData =
{
	{nDamageBase = 600*0.8, nDamageRand = 600*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 1900*0.8, nDamageRand = 1900*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 1400*0.8, nDamageRand = 1400*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 2300*0.8, nDamageRand = 2300*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3092, 1);		-- 设置1号位Buff
