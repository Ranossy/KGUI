...
tSkillData =
{
	{nDamageBase = 2200*0.8, nDamageRand = 2200*0.4, nBuffLevel = 1, nCostMana = 0},		--level 1
	{nDamageBase = 8800*0.8, nDamageRand = 8800*0.4, nBuffLevel = 2, nCostMana = 0},		--level 2
	{nDamageBase = 7000*0.8, nDamageRand = 7000*0.4, nBuffLevel = 3, nCostMana = 0},		--level 3
	{nDamageBase = 17500*0.8, nDamageRand = 17500*0.4, nBuffLevel = 4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 2723, nBuffLevel);		-- 设置1号位Buff
