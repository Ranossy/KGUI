---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_严庄_乔装特技.lua
-- 更新时间:	2014/5/15 16:21:20
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_严庄_乔装特技.lua", --属性值1
		0															--属性值2
	);
	...
	skill.SetNormalCoolDown(1, 705);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if langyajieyinren then
		if langyajieyinren.GetCustomInteger1(3) == 5 then
			local step = langyajieyinren.GetCustomInteger1(2)
			step = step + 1
			langyajieyinren.SetCustomInteger1(2, step)
		end
	end
	player.DoAction(0, 10057)
	player.AddBuff(0, 99, 7859, 1, 2)
end
