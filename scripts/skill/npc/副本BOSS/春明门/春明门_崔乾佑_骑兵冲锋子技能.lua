---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_骑兵冲锋子技能.lua
-- 更新时间:	2014/6/26 11:25:33
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 56500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 84750, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 141250, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 169500, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 197750, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 226000, nDamageRand = 0, nCostMana = 0}, --level 6
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(7912, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7898, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 7912, 1);		-- 设置2号位Buff
