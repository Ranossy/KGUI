---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_打断回血.lua
-- 更新时间:	2014/6/3 20:37:38
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_崔乾佑_打断回血.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		--npc.Say("gjgj")
		local nStack = npc.GetCustomUnsigned1(1)
		if nStack < 7 then
			npc.SetCustomUnsigned1(1, nStack + 1)
			npc.DelBuff(8015,1)
		else
			npc.DelGroupBuff(8015, 1)
			npc.DelBuff(7892, 1)
			--print(npc.CastSkill(9252, 1))
			npc.RunTo(53398, 32904)
			npc.FireAIEvent(2010, 1, 1)
			npc.SetCustomUnsigned1(1,0)
		end
	end
end
