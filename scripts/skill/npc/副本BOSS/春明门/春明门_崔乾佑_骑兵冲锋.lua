---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_骑兵冲锋.lua
-- 更新时间:	2014/6/26 11:34:29
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_崔乾佑_骑兵冲锋.lua",								--属性值1
		0															--属性值2
	);
	...
	skill.BindBuff(1, 7912, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and npc then
		local buff = player.GetBuff(7898, 1)
		local nlevel = 1
		if buff then
			nlevel = 1 + buff.nStackNum
		end
		npc.SetTarget(TARGET.PLAYER, dwCharacterID)
		npc.CastSkill(9268, nlevel)
	end
end
