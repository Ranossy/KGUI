---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_悲酥清风.lua
-- 更新时间:	2014/7/11 21:45:23
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 30400, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_崔乾佑_悲酥清风.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7894, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc and player and player.nMoveState ~= MOVE_STATE.ON_DEATH then
		npc.SetCustomBoolean(0, true)
		local buff = player.GetBuff(208, 0)
		if buff then
			player.DelBuff(208, buff.nLevel)
		end
		local buff = player.GetBuff(139, 0)
		if buff then
			player.DelBuff(139, buff.nLevel)
		end
		local buff = player.GetBuff(3217, 0)
		if buff then
			player.DelBuff(3217, buff.nLevel)
		end
	end
end
