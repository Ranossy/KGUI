---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_灼烧.lua
-- 更新时间:	2014/6/3 20:37:45
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_崔乾佑_灼烧.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		if npc.dwTemplateID == 36523 then
			npc.FireAIEvent(2003, dwSkillSrcID, 2)
		end
	end
end
