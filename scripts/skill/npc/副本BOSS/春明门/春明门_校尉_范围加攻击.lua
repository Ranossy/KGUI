---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_校尉_范围加攻击.lua
-- 更新时间:	2014/6/19 11:31:48
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/春明门/春明门_校尉_范围加攻击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npc then
		npc.AddBuff(0, 99, 7921, 1, 10)
	end

	if npctarget then
		if npctarget.bFightState == true then
			npctarget.AddBuff(0, 99, 7921, 1, 10)
		end
	end
