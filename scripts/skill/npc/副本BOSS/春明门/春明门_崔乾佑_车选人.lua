---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/春明门/春明门_崔乾佑_选车.lua 拷贝
-- 更新时间:	2014/6/3 20:37:58
-- 更新用户:	xueyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		local _, nid = npc.GetTarget()
		local player = GetPlayer(nid)
		if player then
			npc.TurnToCharacter(player.dwID)
			npc.CastSkill(9220, 1)
		end
	end
end
