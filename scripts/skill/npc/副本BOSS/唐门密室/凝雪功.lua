...
function GetSkillLevelData(skill)
	...
	"skill/npc/副本BOSS/唐门密室/凝雪功.lua",				-- 属性值1
	0														-- 属性值2
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
    skill.AddSlowCheckDestBuff(3339,0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
...
local character = nil
	...
	character.nCurrentLife=character.nMaxLife*0.5
end
