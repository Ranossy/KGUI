...
tSkillData =
{
	...
	{nDamageBase = 7200*0.8, nDamageRand = 7200*0.4, nCostMana = 0},		--level 2
...
local character = nil
	...
	if character then
		local scene = character.GetScene()
		    ...
		    --此处写Boss名字+"_",只要加入名字,其他信息不变
		    scene.CreateNpc(15710,character.nX,character.nY,character.nZ,0,48);
		end
end
