...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3290, dwSkillLevel);		-- 设置1号位Buff
...
local character = nil
	...
	if character then
		local scene = character.GetScene()
		    scene.CreateNpc(16011,character.nX,character.nY,character.nZ,0,48);
		    scene.CreateNpc(16021,character.nX,character.nY,character.nZ,0,192);--此处写Boss名字+"_",只要加入名字,其他信息不变
		end
end
