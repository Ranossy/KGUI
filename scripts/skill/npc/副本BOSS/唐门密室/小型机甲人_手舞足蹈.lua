...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/唐门密室/小型机甲人_手舞足蹈.lua",				-- 属性值1
   		0														-- 属性值2
   		);
    ...
    skill.nTargetCountLimit	= 11;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制) 
...
if IsPlayer(dwCharacterID) then
	...
	if character then
	character.nCurrentLife=character.nMaxLife*0.03+character.nCurrentLife
	character.nCurrentMana=character.nMaxMana*0.03+character.nCurrentMana
		end
end
