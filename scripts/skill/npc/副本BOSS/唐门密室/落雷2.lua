...
tSkillData =
{
	...
	{nDamageBase = 300000*0.8, nDamageRand = 300000*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3291, 1);		-- 设置1号位Buff
...
local character = nil
	...
	if character then
		local scene = character.GetScene()
		    ...
		    scene.CreateNpc(15712,character.nX,character.nY,character.nZ,0,160);--此处写Boss名字+"_",只要加入名字,其他信息不变
		end
end
