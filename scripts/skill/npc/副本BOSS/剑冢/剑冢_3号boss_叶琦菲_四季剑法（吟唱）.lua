...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/剑冢/剑冢_3号boss_叶琦菲_四季剑法（吟唱）.lua",	        -- 属性值1
   		0											                                -- 属性值2
   		);
...
function Apply(dwCharacterID)
    ...
    local ZongKong = scene.GetNpcByNickName("yeqifeizongkong")
    if ZongKong then
    	ZongKong.FireAIEvent(2001, 0, 0)
    end
end
