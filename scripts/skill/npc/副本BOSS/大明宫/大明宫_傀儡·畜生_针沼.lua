...
tSkillData =
{
	{nDamageBase = 4000, nDamageRand = 0, nCostMana = 0},		--level 1
	...
	{nDamageBase = 6500, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 28400, nDamageRand = 0, nCostMana = 0},		--level 8
