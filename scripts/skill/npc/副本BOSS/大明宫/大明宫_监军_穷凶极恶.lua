---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/大明宫/大明宫_监军_穷凶极恶.lua
-- 更新时间:	2013/5/29 11:08:02
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_监军_穷凶极恶.lua",								--属性值1
		0															--属性值2
	);	
   --]]
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5962, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local nBuff = npc.GetBuff(5962, 1)
	if not nBuff then 
		return
	end
	if scene.dwMapID == 164 then
		if nBuff.nStackNum <= 3 then
			npc.CastSkill(6336, 1)
		elseif nBuff.nStackNum <= 7 then
			npc.CastSkill(6336, 2)
		else
			npc.CastSkill(6336, 3)
		end
	else
		if nBuff.nStackNum <= 5 then
			npc.CastSkill(6336, 4)
		elseif nBuff.nStackNum <= 10 then
			npc.CastSkill(6336, 5)
		else
			npc.CastSkill(6336, 6)
		end
	end
end
