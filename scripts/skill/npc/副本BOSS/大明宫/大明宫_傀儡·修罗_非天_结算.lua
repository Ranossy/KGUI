...
tSkillData =
{
	...
	{nDamageBase = 66200, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_傀儡·修罗_非天_结算.lua",								--属性值1
		0															--属性值2
	);	
	...
	if scene.dwMapID == 164 then
		...
		elseif nBuff1 and not nBuff2 then
			if nBuff1.nStackNum < 11 then
				player.AddBuff(0, 99, 5624, 1)
			elseif nBuff1.nStackNum < 21 then
				player.AddBuff(0, 99, 5624, 2)
			else
				player.AddBuff(0, 99, 5624, 3)
			end
		elseif not nBuff1 and nBuff2 then
			if nBuff2.nStackNum < 11 then
				player.AddBuff(0, 99, 5625, 1)
			elseif nBuff2.nStackNum < 21 then
				player.AddBuff(0, 99, 5625, 2)
			else
				player.AddBuff(0, 99, 5625, 3)
			end
		...
		elseif nBuff1 and not nBuff2 then
			if nBuff1.nStackNum < 6 then
				player.AddBuff(0, 99, 5624, 4)
			elseif nBuff1.nStackNum < 10 then
				player.AddBuff(0, 99, 5624, 5)
			else
				player.AddBuff(0, 99, 5624, 6)
			end
		elseif not nBuff1 and nBuff2 then
			if nBuff2.nStackNum < 6 then
				player.AddBuff(0, 99, 5625, 4)
			elseif nBuff2.nStackNum < 10 then
				player.AddBuff(0, 99, 5625, 5)
			else
				player.AddBuff(0, 99, 5625, 6)
			end
		elseif nBuff1 and nBuff2 then
			if nBuff1.nStackNum < nBuff2.nStackNum then
				if nBuff2.nStackNum < 6 then
