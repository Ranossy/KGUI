...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(												
		...
		"skill/npc/副本BOSS/大明宫/大明宫_耶律燕_NPC冲撞_冲刺.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 164 then
		npc.AddBuff(0, 99, 6073, 1, 5)
	end
	if scene.dwMapID == 165 then
		npc.AddBuff(0, 99, 6073, 1, 2)
	end
	scene.SetTimer(0.3 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/大明宫/大明宫_耶律燕_NPC冲撞_冲刺.lua", dwCharacterID, 1)
	scene.SetTimer(1 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/大明宫/大明宫_耶律燕_NPC冲撞_冲刺.lua", dwCharacterID, 2)
	--npc.PlaySfx(370, npc.nX, npc.nY, npc.nZ + 1024, npc.nFaceDirection * 360 / 256 + 90)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if  nParam2 == 1 then
		local x = npc.nX + math.cos((npc.nFaceDirection - 128) * math.pi * 2 / 256) * 64 * 8
		local y = npc.nY + math.sin((npc.nFaceDirection - 128) * math.pi * 2 / 256) * 64 * 8
		npc.PlaySfx(370, x, y, npc.nZ + 1024, npc.nFaceDirection * 360 / 256 + 90)
