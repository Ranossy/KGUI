...
tSkillData =
{
	{nDamageBase = 27600, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5717, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 164 then
		npc.CastSkill(5454, 1)
		npc.FireAIEvent(2001, 0, 0)
		npc.SetDisappearFrames(16, false)
	else
		npc.CastSkill(5454, 2)
		npc.FireAIEvent(2001, 0, 0)
		npc.SetDisappearFrames(16, false)
	end
end
