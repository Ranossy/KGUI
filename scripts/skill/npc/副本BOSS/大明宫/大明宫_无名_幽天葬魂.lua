---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/大明宫/大明宫_无名_幽天葬魂.lua
-- 更新时间:	2013/6/5 15:47:26
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	...
	{nDamageBase = 45000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 47500, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 45000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 42500, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 37500, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 35000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 30000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 44000, nDamageRand = 0, nCostMana = 0}, --level 11
};
