...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_傀儡·天_往生净土_净化.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 23337 or npc.dwTemplateID == 23343 or npc.dwTemplateID == 25176 or npc.dwTemplateID == 25170 then
		npc.SetDisappearFrames(1 * GLOBAL.GAME_FPS, false)
	end
end
