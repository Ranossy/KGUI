...
tSkillData =
{
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 68500, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 68500, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 68500, nDamageRand = 0, nCostMana = 0},		--level 8
	{nDamageBase = 68500, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 68500, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5690, 1);		-- 设置1号位Buff
