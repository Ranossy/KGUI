---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/大明宫/大明宫_剑圣_消除AOE.lua
-- 更新时间:	2013/6/3 19:42:59
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_剑圣_消除AOE.lua", --属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if npc.dwTemplateID == 23851 or npc.dwTemplateID == 23863 or npc.dwTemplateID == 23864 or npc.dwTemplateID == 23865 or npc.dwTemplateID == 23866 or
		npc.dwTemplateID == 23868 or npc.dwTemplateID == 23923 or npc.dwTemplateID == 23924 or npc.dwTemplateID == 24955 or npc.dwTemplateID == 24532 or
		npc.dwTemplateID == 24544 or npc.dwTemplateID == 24549 then		
		npc.SetDisappearFrames(1, 0)
	end
	if npc.dwTemplateID == 25226 or npc.dwTemplateID == 25227 or npc.dwTemplateID == 25228 or npc.dwTemplateID == 25229 or npc.dwTemplateID == 25230 or
		npc.dwTemplateID == 25231 or npc.dwTemplateID == 25236 or npc.dwTemplateID == 25237 or npc.dwTemplateID == 25323 or npc.dwTemplateID == 25329 or
		npc.dwTemplateID == 25330 or npc.dwTemplateID == 25379 or npc.dwTemplateID == 25380 then		
		npc.SetDisappearFrames(1, 0)
	end	
end
