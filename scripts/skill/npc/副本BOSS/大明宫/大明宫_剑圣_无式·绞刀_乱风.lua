...
tSkillData =
{
	...
	{nDamageBase = 42300, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5546, 1);		-- 设置1号位Buff
	  skill.BindBuff(2, 5611, dwSkillLevel);		-- 设置2号位Buff
...
function Apply(dwCharacterID)
	...
	local nBuff = player.GetBuff(5547, 1)
	if not nBuff then
		return
	end
	if nBuff.nStackNum == 3 then
		player.DelBuff(5547, 1)
		player.DelBuff(5547, 1)
		player.DelBuff(5547, 1)
		player.DelBuff(5546, 1)
		player.AddBuff(0,99,5548,1)
	end
end
