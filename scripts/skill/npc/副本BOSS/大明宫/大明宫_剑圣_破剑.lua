...
tSkillData =
{
	...
	{nDamageBase = 35800, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_剑圣_破剑.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5536, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local npc = scene.CreateNpc(24174, player.nX, player.nY, player.nZ, player.nFaceDirection-128, -1)
	npc.Jump(false,npc.nFaceDirection)
end
