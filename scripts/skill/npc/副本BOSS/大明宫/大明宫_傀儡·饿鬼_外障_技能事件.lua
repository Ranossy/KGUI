...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_傀儡·饿鬼_外障_技能事件.lua",								--属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 164 then
		local nBuff1 = player.GetBuff(5592, 1)
		if nBuff1 then
			player.AddBuff(0, 99, 5593, 1)
		end
		local nBuff2 = player.GetBuff(5592, 2)
		if nBuff2 then
			player.AddBuff(0, 99, 5593, 2)
		end
		local nBuff3 = player.GetBuff(5592, 3)
		if nBuff3 then
			player.AddBuff(0, 99, 5593, 3)
		end
	else
		local nBuff1 = player.GetBuff(5592, 1)
		if nBuff1 then
			player.AddBuff(0, 99, 5593, 4)
		end
		local nBuff2 = player.GetBuff(5592, 2)
		if nBuff2 then
			player.AddBuff(0, 99, 5593, 5)
		end
		local nBuff3 = player.GetBuff(5592, 3)
		if nBuff3 then
			player.AddBuff(0, 99, 5593, 6)
		end
	end
end
