...
tSkillData =
{
	...
	{nDamageBase = 78000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 94000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 103000, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 112000, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 131000, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 140000, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 149000, nDamageRand = 0, nCostMana = 0},		--level 8
	{nDamageBase = 158000, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 167000, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(5687, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5688, 1);		-- 设置1号位Buff
