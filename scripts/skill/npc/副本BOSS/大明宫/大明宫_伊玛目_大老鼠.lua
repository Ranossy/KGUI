...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_伊玛目_大老鼠.lua",								--属性值1
		0															--属性值2
	);	
	...
	skill.nMaxRadius		= 18 * LENGTH_BASE;		-- 技能施放的最大距离 
	...
	skill.nAreaRadius		= 18 * LENGTH_BASE;		-- 技能作用半径 
...
function Apply(dwCharacterID)
	...
	if not npc.GetBuff(5456, 1) then
		npc.Say(GetEditorString(3, 8495))
		npc.AddBuff(0, 99, 5456, 1)
	end
