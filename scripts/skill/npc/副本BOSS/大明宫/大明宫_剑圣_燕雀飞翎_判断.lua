...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_剑圣_燕雀飞翎_判断.lua",								--属性值1
		0															--属性值2
	);		
...
function Apply(dwCharacterID,dwSrcID)
	...
	if GetCharacterDistance(dwCharacterID, dwSrcID) == 512 or player.nMoveState == MOVE_STATE.ON_JUMP or player.nZ - npc.nZ > 3072 then
		npc.CastSkill(6307 , 1 ,TARGET.player , dwCharacterID)
	end
end
