...
tSkillData =
{
	{nDamageBase = 28500, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 28500, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 28500, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 28500, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 28500, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0},		--level 8
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 48900, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.BindBuff(1, 5713, nBuffLevel);		-- 设置1号位Buff
	...
	----------------- 作用范围 -------------------------------------------------
	if dwSkillLevel >= 1 and dwSkillLevel <6 then
		skill.nProtectRadius = (dwSkillLevel - 1) * 8 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	else
		skill.nProtectRadius = (dwSkillLevel - 6) * 8 * LENGTH_BASE;
	end
	skill.nHeight = 16 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	--skill.nRectWidth = 0 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
	skill.nAngleRange = 256;					-- 攻击范围的扇形角度范围
	if dwSkillLevel >= 1 and dwSkillLevel <6 then
		skill.nAreaRadius = 8 * LENGTH_BASE + (dwSkillLevel - 1) * 8 * LENGTH_BASE;		-- 技能作用半径
	else
		skill.nAreaRadius = 8 * LENGTH_BASE + (dwSkillLevel - 6) * 8 * LENGTH_BASE;		-- 技能作用半径
	end
...
function Apply(dwCharacterID)
	...
	--if scene.dwMapID == 164 then
		--playerthis.AddBuff(0, 99, 5173, 1)
	--else
		--playerthis.AddBuff(0, 99, 5173, 2)
	--end
end
