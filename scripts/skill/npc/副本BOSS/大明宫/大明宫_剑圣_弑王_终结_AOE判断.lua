...
function Apply(dwCharacterID)
	...
	local nBuff = npc.GetBuff(5607, 1)
	if not nBuff then
		return
	end
	if scene.dwMapID == 164 then
		if nBuff.nStackNum < 4 then
			npc.CastSkill(5633, 1)
		elseif nBuff.nStackNum < 8 then
			npc.CastSkill(5633, 2)
		else
			npc.CastSkill(5633, 3)
		end
	elseif scene.dwMapID == 165 then 
		if nBuff.nStackNum < 4 then
			npc.CastSkill(5633, 4)
		elseif nBuff.nStackNum < 8 then
			npc.CastSkill(5633, 5)
		else
			npc.CastSkill(5633, 6)
		end
	end
end
