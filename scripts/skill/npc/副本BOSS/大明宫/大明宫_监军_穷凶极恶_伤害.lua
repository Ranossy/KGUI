...
tSkillData =
{
	{nDamageBase = 15200, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 25000, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 45000, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 33100, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 50000, nDamageRand = 0, nCostMana = 0},		--level 5
	{nDamageBase = 68000, nDamageRand = 0, nCostMana = 0},		--level 6
