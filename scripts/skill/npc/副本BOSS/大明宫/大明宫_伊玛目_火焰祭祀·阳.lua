...
tSkillData =
{
	...
	{nDamageBase = 58700, nDamageRand = 0, nCostMana = 0},		--level 2
	...
	{nDamageBase = 20000, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 20000, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_伊玛目_火焰祭祀·阳.lua",								--属性值1
		0															--属性值2
	);	
