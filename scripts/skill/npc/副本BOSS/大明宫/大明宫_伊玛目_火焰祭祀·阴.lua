...
tSkillData =
{
	...
	{nDamageBase = 44000, nDamageRand = 0, nCostMana = 0},		--level 6
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 7
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 8
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 9
	{nDamageBase = 24500, nDamageRand = 0, nCostMana = 0},		--level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_伊玛目_火焰祭祀·阴.lua",								--属性值1
		0															--属性值2
	);	
