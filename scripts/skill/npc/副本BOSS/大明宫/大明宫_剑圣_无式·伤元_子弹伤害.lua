...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/大明宫/大明宫_剑圣_无式·伤元_子弹伤害.lua",								--属性值1
		0															--属性值2
	);		
...
function Apply(dwCharacterID)
	...
	elseif player.nCurrentMana > player.nMaxMana * 0.6 then
		if player.nCurrentLife < 16000 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 16000
		end
	elseif player.nCurrentMana > player.nMaxMana * 0.4 then
		if player.nCurrentLife < 12000 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 12000
		end
	elseif player.nCurrentMana > player.nMaxMana * 0.2 then
		...
		if player.nCurrentLife < 4000 then
			player.Die()
		else
			player.nCurrentLife = player.nCurrentLife - 4000
		end
	end	
end
