...
tSkillData =
{
	{nDamageBase = 115500, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 408000, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 610);	--技能普通CD
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if player.nX > 4605 and player.nX < 5270 and player.nY > 50609 and player.nY < 51404 then
		...
		if npc_zn then
			...
			npc_zn.DoAction(0, 10055)
			local nDir = npc_zn.nFaceDirection * 2 * math.pi / 256
			npc_zn.PlaySfx(466, npc_zn .nX + 100 * math.cos(nDir), npc_zn.nY + 100 * math.sin(nDir),  npc_zn.nZ, npc_zn.nFaceDirection * 360 / 255 - 192 *360/255)
		end
