---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/大明宫/大明宫_弓箭手_齐射.lua
-- 更新时间:	2013/5/29 15:08:16
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamageBase = 1250000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 1500000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 1750000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 2000000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 2250000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 4375000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 4750000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 5125000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 5500000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 5875000, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 6250000, nDamageRand = 0, nCostMana = 0}, --level 12
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	  skill.AddSlowCheckDestBuff(7141, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	--skill.nRectWidth = 30 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
...
function UnApply(dwCharacterID)
	...
	if npc.GetBuff(5899, 1) then
		npc.AddBuff(0, 99, 5898, 2, 1)
		npc.DelBuff(5899,1)
	end
end
