---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/梵空禅院/3号/普通攻击.lua
-- 更新时间:	2015/7/2 20:29:12
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3120, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 5460, nDamageRand = 0, nCostMana = 0}, --level 2
