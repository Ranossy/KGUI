---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/梵空禅院/2号/密探/小怪_单体远_外功.lua
-- 更新时间:	2015/6/18 15:52:07
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamage = 2300, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 3300, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/梵空禅院/2号/密探/小怪_单体远_外功.lua", --属性值1
		0															--属性值2
	);
