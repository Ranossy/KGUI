---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/梵空禅院/2号/圣者剑意_圆形AOE（单体）.lua
-- 更新时间:	2015/4/7 15:44:34
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamage = 4800, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 7900, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/梵空禅院/2号/圣者剑意_圆形AOE（单体）.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8860, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 8860, 1);		-- 设置2号位Buff
	skill.BindBuff(3, 9317, 1);		-- 设置3号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local Buff9317 = player.GetBuff(9317, 1)
	if Buff9317 then
		player.CustomDamage(npc.dwID, 13840, 1, 1, Buff9317.nStackNum * 15 * player.nMaxLife / 100)
	end
end
