---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/梵空禅院/1号/童子拜佛_AOE.lua
-- 更新时间:	2015/9/6 15:42:46
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3600, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 4500, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 6000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 9000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 18000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 8400, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 10500, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 14000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 21000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 42000, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/梵空禅院/1号/童子拜佛_AOE.lua", --属性值1
		--0															--属性值2
	--);
