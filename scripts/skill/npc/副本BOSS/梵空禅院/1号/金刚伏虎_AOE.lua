---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/梵空禅院/1号/金刚伏虎_AOE.lua
-- 更新时间:	2015/4/14 16:01:11
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 8840, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 10880, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 12920, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 14960, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 13100, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 17030, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 20960, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 24890, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 28820, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/梵空禅院/1号/金刚伏虎_AOE.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	local Skill_Con = scene.GetNpcByNickName("Skill_Control")
	if Skill_Con then
		Skill_Con.SetCustomInteger1(1, Skill_Con.GetCustomInteger1(1) + 1)
	end
end
