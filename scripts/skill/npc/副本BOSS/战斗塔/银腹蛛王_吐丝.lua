---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/战斗塔/银腹蛛王_吐丝.lua
-- 更新时间:	2012-7-11 19:23:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 733, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4082, 1);		-- 设置1号位Buff
