---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/战斗塔/黄金机甲龙_击倒.lua
-- 更新时间:	2012-6-29 10:51:32
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 7333, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.nAngleRange = 107;					-- 攻击范围的扇形角度范围
