...
tSkillData =
{
	{ nDamageBase = 56, 	nDamageRand = 05, 	nCostMana = 36},
	{ nDamageBase = 92, 	nDamageRand = 09, 	nCostMana = 66},
	{ nDamageBase = 125, 	nDamageRand = 13, 	nCostMana = 102},
	{ nDamageBase = 158, 	nDamageRand = 16, 	nCostMana = 131},
	{ nDamageBase = 192, 	nDamageRand = 20, 	nCostMana = 160},
	{ nDamageBase = 225, 	nDamageRand = 23, 	nCostMana = 190},
	{ nDamageBase = 258, 	nDamageRand = 27, 	nCostMana = 219},
	{ nDamageBase = 267, 	nDamageRand = 28, 	nCostMana = 241},
...
--增加额外内功AP加成0.5倍
    ...
    ----------------- 时间相关 -------------------------------------------------
    	skill.nPrepareFrames  	= 32;				-- 吟唱帧数  09年6月27改为32 ——CBG
