...
tSkillData =
{
	{nDamageBase = 9900*0.8, nDamageRand = 9900*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 15500*0.8, nDamageRand = 15500*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
 	...
 	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/无量宫/无量宫_多多_星火坠.lua",								--属性值1
   			0															--属性值2
   		);
...
function Apply(dwCharacterID)
	...
	local nCount = scene.GetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.WULIANGGONG.LIUXING_CONUT)
	if nCount < 254 then
		scene.SetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.WULIANGGONG.LIUXING_CONUT, nCount + 1)
	end
end
