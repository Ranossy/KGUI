...
tSkillData =
{
	...
	{nDamageBase = 12800*0.8, nDamageRand = 12800*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
  		skill.AddAttribute(
   			...
   			"Skill/npc/副本BOSS/无量宫/无量宫_濯尘_星云锁.lua",										--属性值1
   			0															--属性值2
		);
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2956, 1);		-- 设置1号位Buff
