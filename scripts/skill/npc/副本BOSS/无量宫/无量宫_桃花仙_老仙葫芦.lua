...
function Apply(dwCharacterID)
	...
	scene.CreateNpc(8167, npc.nX, npc.nY, npc.nZ, 0, -1)
	local Boss = scene.GetNpcByNickName("taoyexian")
	if not Boss then
		return
	end
	Boss.FireAIEvent(2001, 0, 1)
end
