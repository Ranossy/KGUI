...
tSkillData =
{
	{nDamageBase = 10700*0.8, nDamageRand = 10700*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 14300*0.8, nDamageRand = 14300*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 2167, 1);		-- 设置1号位Buff
