...
tSkillData =
{
	{nDamageBase = 5600*0.8, nDamageRand = 5600*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 14000*0.8, nDamageRand = 14000*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  	  skill.BindBuff(1, 2545, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
