...
tSkillData =
{
	{nDamageBase = 6300*0.8, nDamageRand = 6300*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 8300*0.8, nDamageRand = 8300*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3005, 1);		-- 设置1号位Buff
