...
tSkillData =
{
	{nDamageBase = 1600*0.8, nDamageRand = 1600*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 2200*0.8, nDamageRand = 2200*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 2357, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
