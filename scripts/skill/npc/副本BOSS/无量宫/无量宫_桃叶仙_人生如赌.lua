...
tSkillData =
{
	{nDamageBase = 8100*0.8, nDamageRand = 8100*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 10100*0.8, nDamageRand = 10100*0.4, nCostMana = 0},		--level 2
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(                                                           
	 ...
	 skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/无量宫/无量宫_桃叶仙_人生如赌.lua",								--属性值1
   			0															--属性值2
   		);
...
function Apply(dwCharacterID)
	...
	local nCount = scene.GetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.WULIANGGONG.RUDU_CONUT)
	if nCount < 254 then
		scene.SetCustomUnsigned1(SCENE_CUSTOM_VALUE_NAME.WULIANGGONG.RUDU_CONUT, nCount + 1)
	end
end
