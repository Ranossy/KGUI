---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/屠龙六式伤害120面向.lua
-- 更新时间:	2017/2/23 19:55:46
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3380, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/屠龙六式伤害120面向.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if  player then
		player.DelBuff(11733, 1)		--禁疗
		npc.AddBuff(npc.dwID, npc.nLevel, 11716, 1)		--雷神buff
		player.AddBuff(npc.dwID, npc.nLevel, 11733, 1)		--禁疗
		player.AddBuff(npc.dwID, npc.nLevel, 11805, 1)		--禁疗监控
		player.AddBuff(npc.dwID, npc.nLevel, 11825, 1)		--成就监控Buff
		player.AddBuff(npc.dwID, npc.nLevel, 11857, 1)		--刀伤buff
	end		--打人
end
