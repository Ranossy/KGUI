---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS2_云雷狂身.lua
-- 更新时间:	2017/2/16 22:35:57
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS2_云雷狂身.lua", -- 属性值1
		0															--属性值2
	);
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if  playerTarget then
		npc.CastSkill(17357, 1, TARGET.PLAYER, dwCharacterID)
		playerTarget.AddBuff(npc.dwID, npc.nLevel, 11710, 1)		--割裂
		playerTarget.AddBuff(npc.dwID, npc.nLevel, 11709, 1)		--割裂监控
	end		--打人
	if npcTarget then
		npc.CastSkill(17357, 1, TARGET.NPC, dwCharacterID)
		npcTarget.AddBuff(npc.dwID, npc.nLevel, 11710, 1)		--割裂
