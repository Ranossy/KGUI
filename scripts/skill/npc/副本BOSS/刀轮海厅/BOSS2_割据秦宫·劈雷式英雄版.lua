---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·劈雷式英雄版.lua
-- 更新时间:	2017/3/23 20:29:41
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·劈雷式英雄版.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerTarget then
		playerTarget.Stop()
		npc.CastSkill(17366, 2, TARGET.PLAYER, dwCharacterID)
	end
end
