---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/百鬼阵.lua
-- 更新时间:	2017/3/23 15:17:14
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/百鬼阵.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nRan = Random(100000)
	if not player then
		return
	end
	if nRan <= 25000 then
		player.SetPosition(20093, 8150, 1735566)		--左前1
	end
	if nRan > 25000 and nRan <= 50000 then
		player.SetPosition(22113, 5451, 1738682)		--左后1
	end
	if nRan > 50000 and nRan <= 75000 then
		player.SetPosition(20865, 9015, 1735912)		--右前1
	end
	if nRan > 75000 then
		player.SetPosition(23164, 6447, 1737526)		--右后1
	end
end
