---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/刀啸雷鸣.lua
-- 更新时间:	2017/2/16 23:03:55
...
tSkillData =
{
	...
	{nDamageBase = 20460, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/刀啸雷鸣.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.Stop()
		player.AddBuff(npc.dwID, npc.nLevel, 11713, 1)--点穴BUFF
		player.DelBuff(11824, 1)
	end
end
