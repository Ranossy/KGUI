---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/冲裂冲锋.lua
-- 更新时间:	2017/2/17 17:47:59
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/刀轮海厅/冲裂冲锋.lua", 
		--0											
	--);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not npc then
		--return
	--end
	--npc.AddBuff(npc.dwID,npc.nLevel,11720,1)
end
