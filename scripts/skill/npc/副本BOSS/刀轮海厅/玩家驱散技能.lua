---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/玩家驱散技能.lua
-- 更新时间:	2017/3/20 15:08:24
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/玩家驱散技能.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 262 then
		if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
			if playertarget.GetBuff(11634, 1) then
				playertarget.DelBuff(11634, 1)
				player.AddBuff(player.dwID, player.nLevel, 11634, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11635, 1) then
				playertarget.DelBuff(11635, 1)
				player.AddBuff(player.dwID, player.nLevel, 11635, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11636, 1) then
				playertarget.DelBuff(11636, 1)
				player.AddBuff(player.dwID, player.nLevel, 11636, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11637, 1) then
				playertarget.DelBuff(11637, 1)
				player.AddBuff(player.dwID, player.nLevel, 11637, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11641, 1) then
				playertarget.DelBuff(11641, 1)
				player.AddBuff(player.dwID, player.nLevel, 11641, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11915, 1) then
				playertarget.DelBuff(11915, 1)
				player.AddBuff(player.dwID, player.nLevel, 11915, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 1, TARGET.PLAYER, player.dwID)
			end
		end
		...
		if playertarget and playertarget.nMoveState ~= MOVE_STATE.ON_DEATH then
			if playertarget.GetBuff(11634, 1) then
				...
				player.AddBuff(player.dwID, player.nLevel, 11634, 1)
				player.DelBuff(11823, 1)
				playertarget.CastSkill(17526, 2, TARGET.PLAYER, player.dwID)
			end
			if playertarget.GetBuff(11635, 1) then
				playertarget.DelBuff(11635, 1)
				player.AddBuff(player.dwID, player.nLevel, 11635, 1)
