---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/屠龙六式打击四.lua
-- 更新时间:	2017/3/13 14:49:37
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/屠龙六式打击四.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if  npc then
		npc.DoAction(0, 10063)
		npc.CastSkill(17419, 1)		--击飞
		npc.CastSkill(17422, 1)		--打击四伤害
	end		--打人
	npc.AddBuff(npc.dwID, npc.nLevel, 11730, 1)		--打击五监控buff
end
