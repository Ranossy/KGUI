---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS1_白蛇毒.lua
-- 更新时间:	2017/3/20 16:33:13
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS1_白蛇毒.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	skill.nMaxRadius = 90 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if target then
		target.PlaySfx(3211, 0, 0, 0)
		if target.GetKungfuMount() ~= nil then
			local KungfuID = target.GetKungfuMount().dwSkillID
			if KungfuID == 10014 or KungfuID == 10021 then---混元气纯花间
				target.AddBuff(npc.dwID, npc.nLevel, 11637, 1)
			elseif KungfuID == 10175 or KungfuID == 10225  then--毒性毒经田螺
				target.AddBuff(npc.dwID, npc.nLevel, 11641, 1)
			elseif KungfuID == 10081 or KungfuID == 10447 then--阴性冰心莫问
				target.AddBuff(npc.dwID, npc.nLevel, 11635, 1)
			elseif KungfuID == 10002 or KungfuID == 10003 or KungfuID == 10243 or KungfuID == 10242 then---阳性洗髓易筋明尊焚影
				target.AddBuff(npc.dwID, npc.nLevel, 11634, 1)
			elseif KungfuID == 10028 or KungfuID == 10176  or KungfuID == 10448 or KungfuID == 10080 then--治疗离经补天相知云裳
				target.AddBuff(npc.dwID, npc.nLevel, 11915, 1)
			else
				target.AddBuff(npc.dwID, npc.nLevel, 11636, 1)  --外功
			end
		end
		if scene.dwMapID == 275 then
			target.AddBuff(npc.dwID, npc.nLevel, 11849, 1)
		end
	end
end
