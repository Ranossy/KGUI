---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/屠龙六式打击二.lua
-- 更新时间:	2017/3/13 14:39:39
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/屠龙六式打击二.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.CastSkill(17417, 1)		--击退
	npc.AddBuff(npc.dwID, npc.nLevel, 11750, 1)		--打击二伤害监控
	npc.AddBuff(npc.dwID, npc.nLevel, 11728, 1)		--打击三监控buff
end
