---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/剑破英雄版.lua
-- 更新时间:	2017/3/23 20:46:24
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/剑破英雄版.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.AddBuff(npc.dwID, npc.nLevel, 11723, 1)		--回蓝监控
	if  playerTarget then
		npc.CastSkill(17376, 2, TARGET.PLAYER, dwCharacterID)
	end		--打人
	if npcTarget then
		npc.CastSkill(17376, 2, TARGET.NPC, dwCharacterID)
	end		--打影子
end
