---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·劈雷式.lua
-- 更新时间:	2017/2/16 15:17:55
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·劈雷式.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerTarget then
		playerTarget.Stop()
		npc.CastSkill(17366, 1, TARGET.PLAYER, dwCharacterID)
	end
end
