---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/风切打断伤害.lua
-- 更新时间:	2017/2/16 15:08:06
...
tSkillData =
{
	{nDamageBase = 5720, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 8580, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/风切打断伤害.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.AddBuff(npc.dwID, npc.nLevel, 11705,1)
	end
end
