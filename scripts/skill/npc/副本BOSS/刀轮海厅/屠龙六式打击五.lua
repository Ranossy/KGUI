---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/屠龙六式打击五.lua
-- 更新时间:	2017/2/22 15:31:27
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/屠龙六式打击五.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tPos = CustomFunction.GetFrontNpcPosition(npc.nX, npc.nY, npc.nFaceDirection, 5 * 64)
	npc.RunTo(tPos.nX, tPos.nY)
	npc.AddBuff(npc.dwID, npc.nLevel, 11738, 1)		--第一下监控
end
