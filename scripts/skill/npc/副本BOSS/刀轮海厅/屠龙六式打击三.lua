---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/屠龙六式打击三.lua
-- 更新时间:	2017/3/13 14:47:53
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/屠龙六式打击三.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if  npc then
		npc.DoAction(0, 10062)
		npc.CastSkill(17418, 1)		--击倒
		npc.CastSkill(17421, 1)		--打击三伤害
	end		--打人S
	npc.AddBuff(npc.dwID, npc.nLevel, 11729, 1)		--打击四监控buff
end
