---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/项王击鼎·轰.lua
-- 更新时间:	2017/2/16 16:56:48
...
tSkillData =
{
	...
	{nDamageBase = 9240, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/项王击鼎·轰.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 262 then
		player.AddBuff(npc.dwID, npc.nLevel, 11734, 1)
	else
		player.AddBuff(npc.dwID, npc.nLevel, 11734, 1)
		player.AddBuff(npc.dwID, npc.nLevel, 11856, 1)
	end
end
