---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS2_松烟竹雾.lua
-- 更新时间:	2017/3/15 16:28:50
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS2_松烟竹雾.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		npc.AddBuff(Npc.dwID, Npc.nLevel, 11711, 1)--免控BUFF
	end
end
