---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS1_月泉流引.lua
-- 更新时间:	2017/3/30 19:57:52
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS1_月泉流引.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playertarget.nCurrentMana >= 0.05 then		--蓝量多于5%
		playertarget.nCurrentMana = playertarget.nCurrentMana - playertarget.nMaxMana * 0.01
		npc.AddBuff(npc.dwID, npc.nLevel, 11595, 1)
		npc.nCurrentMana = npc.nCurrentMana + npc.nMaxMana * 0.01
	else
		playertarget.nCurrentLife = playertarget.nCurrentLife - playertarget.nMaxLife * 0.02
		npc.nCurrentMana = npc.nCurrentMana + npc.nMaxMana * 0.02
	end
end
