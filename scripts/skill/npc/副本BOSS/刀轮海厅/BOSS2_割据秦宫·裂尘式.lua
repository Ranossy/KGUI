---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·裂尘式.lua
-- 更新时间:	2017/3/23 11:51:45
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 15080, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 21450, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS2_割据秦宫·裂尘式.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
