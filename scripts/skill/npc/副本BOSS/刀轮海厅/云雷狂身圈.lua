---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/云雷狂身圈.lua
-- 更新时间:	2017/3/14 16:17:29
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/云雷狂身圈.lua", -- 属性值1
		0															--属性值2
	);
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	playerTarget.AddAdvancedDynamicObstacleInCircle(npc.nX, npc.nY, npc.nZ - 2 * 64 * 8, 6 * 64, npc.nZ + 7 * 8 * 64, 6 * 16, ADVANCED_DYNAMIC_OBSTACLE_TYPE.ENEMY_PARTY)
