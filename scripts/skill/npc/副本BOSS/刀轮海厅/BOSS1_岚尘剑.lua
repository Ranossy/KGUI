---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/BOSS1_岚尘剑.lua
-- 更新时间:	2017/2/16 21:14:09
-- 更新用户:	CHENGSIHAN
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/刀轮海厅/BOSS1_岚尘剑.lua", -- 属性值1
		0															--属性值2
	);
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if  player and player.nMoveState ~= MOVE_STATE.ON_DEATH then
		...
		if player.GetBuff(11634, 1) or player.GetBuff(11635, 1)
			...
			npc.CastSkill(17370, 2, TARGET.PLAYER, dwCharacterID)
		else
			npc.CastSkill(17370, 1, TARGET.PLAYER, dwCharacterID)
		end
