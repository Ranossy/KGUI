---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/刀轮海厅/敛神.lua
-- 更新时间:	2017/2/17 10:48:47
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--回血
	if npc.nCurrentLife >= npc.nMaxLife * 0.7 then
		npc.nCurrentLife = npc.nMaxLife
	else
		npc.nCurrentLife = npc.nCurrentLife + npc.nMaxLife * 0.3
	end
	--回蓝
