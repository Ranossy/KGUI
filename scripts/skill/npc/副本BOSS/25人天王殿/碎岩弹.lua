...
tSkillData =
{
	{nDamageBase = 9200 * 0.8, nDamageRand = 9200 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 13700 * 0.8, nDamageRand = 13700 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 15600 * 0.8, nDamageRand = 15600 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 27100 * 0.8, nDamageRand = 27100 * 0.4, nCostMana = 0},		--level 4
	...
	{nDamageBase = 9900 * 0.8, nDamageRand = 9900 * 0.4, nCostMana = 0},		--level 15
	{nDamageBase = 5385 * 0.8, nDamageRand = 5385 * 0.4, nCostMana = 0},		--level 16
	{nDamageBase = 7500 * 0.8, nDamageRand = 7500 * 0.4, nCostMana = 0},		--level 17
	{nDamageBase = 5629 * 0.8, nDamageRand = 5629 * 0.4, nCostMana = 0},		--level 18
	{nDamageBase = 9300 * 0.8, nDamageRand = 9300 * 0.4, nCostMana = 0},		--level 19
