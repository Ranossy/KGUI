...
tSkillData =
{
	...
	{nDamageBase = 12000 * 0.8, nDamageRand = 12000 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 12300 * 0.8, nDamageRand = 12300 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 28000 * 0.8, nDamageRand = 28000 * 0.4, nCostMana = 0},		--level 4
	...
	{nDamageBase = 9600 * 0.8, nDamageRand = 9600 * 0.4, nCostMana = 0},		--level 15
	...
	{nDamageBase = 10500 * 0.8, nDamageRand = 10500 * 0.4, nCostMana = 0},		--level 19
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckDestBuff(1945, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);			-- 需求自身Buff
