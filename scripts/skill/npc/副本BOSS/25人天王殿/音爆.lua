...
tSkillData =
{
	{nDamageBase = 3400 * 0.8, nDamageRand = 3400 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 6400 * 0.8, nDamageRand = 6400 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 5100 * 0.8, nDamageRand = 5100 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 9000 * 0.8, nDamageRand = 9000 * 0.4, nCostMana = 0},		--level 4
	...
	{nDamageBase = 3000 * 0.8, nDamageRand = 3000 * 0.4, nCostMana = 0},		--level 17
	{nDamageBase = 5629 * 0.8, nDamageRand = 5629 * 0.4, nCostMana = 0},		--level 18
	{nDamageBase = 5800 * 0.8, nDamageRand = 5800 * 0.4, nCostMana = 0},		--level 19
