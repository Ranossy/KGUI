...
tSkillData =
{
	{nDamageBase = 0, nDamageRand = 0,nAreaRadius=22, nLevel = 1,nCostMana = 7000},		--level 1
	...
	{nDamageBase = 0, nDamageRand = 0,nAreaRadius=22, nLevel = 2,nCostMana = 7000},		--level 17
	{nDamageBase = 0, nDamageRand = 0,nAreaRadius=22, nLevel = 1,nCostMana = 0},		--level 18
	{nDamageBase = 0, nDamageRand = 0,nAreaRadius=12, nLevel = 3,nCostMana = 7000},		--level 19
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
	   		...
	   		"skill/npc/副本BOSS/25人天王殿/铜铃声.lua",	        	-- 属性值1
			0
	);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 1892, 1);		-- 设置1号位Buff
