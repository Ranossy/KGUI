---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/25人天王殿/石磬声.lua
-- 更新时间:	2012-7-11 15:06:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/25人天王殿/排鼓声.lua", -- 属性值1
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 1891, 1);		-- 设置1号位Buff
	if dwSkillLevel == 4 or dwSkillLevel == 5 then
		skill.BindBuff(1, 1891, dwSkillLevel-1)
	else
		skill.BindBuff(1, 1891, 1);
	end
