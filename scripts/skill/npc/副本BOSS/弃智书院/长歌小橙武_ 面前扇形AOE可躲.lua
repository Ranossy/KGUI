...
tSkillData =
{
	{nDamageBase = 13600, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 13600, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 120, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nAngleRange = 22;					-- 攻击范围的扇形角度范围
