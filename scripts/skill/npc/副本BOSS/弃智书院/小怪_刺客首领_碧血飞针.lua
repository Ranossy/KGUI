---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/弃智书院/小怪_刺客首领_碧血飞针.lua
-- 更新时间:	2015/7/5 17:22:41
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 4800, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/弃智书院/小怪_刺客首领_碧血飞针.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	--if npc then
		...
		--scene.SetTimer(1 * GLOBAL.GAME_FPS, "scripts\skill\npc\副本BOSS\弃智书院\小怪_刺客首领_碧血飞针.lua", dwSrcID, 1)
	--end
end
