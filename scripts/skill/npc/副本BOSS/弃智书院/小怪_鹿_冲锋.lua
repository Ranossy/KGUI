---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/弃智书院/小怪_鹿_冲锋.lua
-- 更新时间:	2015/6/18 20:16:55
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 20, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 20, nDamageRand = 0, nCostMana = 0}, --level 2
