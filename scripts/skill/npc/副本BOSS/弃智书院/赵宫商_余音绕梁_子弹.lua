---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/弃智书院/赵宫商_余音绕梁_子弹.lua
-- 更新时间:	2015/3/12 16:43:22
-- 更新用户:	guozhaoxing1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--	"skill/npc/副本BOSS/弃智书院/赵宫商_余音绕梁_子弹.lua", --属性值1
	--	0															--属性值2
	--);
...
--	print("加血")
--	local npcZhaogongshang = GetNpc(dwSkillSrcID)
--	local npcNiezheng = GetNpc(dwCharacterID)
--	if not npcAnyu or not npcNiezheng then
--		return
--	end
--	npcZhaogongshang.nCurrentMana = npc.nCurrentMana - npc.nMaxMana * 0.1
--	npcNiezheng.nCurrentLife = npcNiezheng.nCurrentLife + npcNiezheng.nMaxLife * 0.1
end
