---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/弃智书院/小怪_长歌门守卫_重击.lua
-- 更新时间:	2015/9/7 15:05:14
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/弃智书院/小怪_长歌门守卫_重击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.PlaySfx(1202, player.nX, player.nY, player.nZ + 75)
end
