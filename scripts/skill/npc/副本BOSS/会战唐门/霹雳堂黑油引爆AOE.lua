...
tSkillData =
{
	{nDamage = 19800 * 0.8, nDamageRand = 19800 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 28100 * 0.8, nDamageRand = 28100 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3918, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
