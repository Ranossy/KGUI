---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/会战唐门/特殊武器_无影无幻.lua
-- 更新时间:	2012-7-18 9:35:50
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 46800 * 0.8, nDamageRand = 46800 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 9360 * 0.8, nDamageRand = 9360 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 3991, dwSkillLevel);		-- 设置1号位Buff
