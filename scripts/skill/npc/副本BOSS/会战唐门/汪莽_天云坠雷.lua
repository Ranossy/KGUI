---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/会战唐门/汪莽_天云坠雷.lua
-- 更新时间:	2012-6-25 19:22:39
-- 更新用户:	taoli
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 10000 * 0.8, nDamageRand = 10000 * 0.4, nCostMana = 0}, --level 1
	{nDamageBase = 22000 * 0.8, nDamageRand = 22000 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/会战唐门/汪莽_天云坠雷.lua", -- 属性值1
		0														-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
