...
tSkillData =
{
	{nDamageBase = 34300*0.8, nDamageRand = 34300*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.nProtectRadius    = 8 * LENGTH_BASE;  
...
function UnApply(dwCharacterID)
	...
	if scene.dwMapID==136 then
    	ctarget.CastSkill(3758,1)
    elseif scene.dwMapID==138 then
    	ctarget.CastSkill(3758,2)
    end
end
