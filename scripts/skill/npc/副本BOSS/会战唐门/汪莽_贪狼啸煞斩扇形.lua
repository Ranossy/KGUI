...
tSkillData =
{
	...
	{nDamageBase = 24900 * 0.8, nDamageRand = 24900 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(                                                           
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/会战唐门/汪莽_贪狼啸煞斩扇形.lua",				-- 属性值1
   		0														-- 属性值2
   		);
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3808, dwSkillLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 4134, dwSkillLevel);		-- 设置2号位Buff
...
function Apply(dwCharacterID)
         ...
         local tbuff = tplayer.GetBuff(3807,1)
         if tbuff then
         tplayer.Die()
         end
end
