...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/会战唐门/雷火弹创建.lua",				-- 属性值1
   		0														-- 属性值2
   		);
...
function Apply(dwCharacterID)
	...
	if character then
		if scene.dwMapID == 136 then
			scene.CreateNpc(17243,character.nX,character.nY,character.nZ,0,-1);
		elseif scene.dwMapID == 138 then
			scene.CreateNpc(18084,character.nX,character.nY,character.nZ,0,-1);
		end
	end
end
