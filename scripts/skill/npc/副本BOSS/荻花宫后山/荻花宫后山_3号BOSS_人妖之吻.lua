...
tSkillData =
{
	{nDamageBase = 3213*0.8, nDamageRand = 3213*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 4285*0.8, nDamageRand = 4285*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2268, 1);		-- 设置1号位Buff
