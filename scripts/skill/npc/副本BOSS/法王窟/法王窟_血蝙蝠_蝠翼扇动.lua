...
tSkillData =
{
	{nDamageBase = 2500*0.8, nDamageRand = 2500*0.4, nBuffLevel = 1},		--level 1
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2625, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 2260, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置2号位Buff
