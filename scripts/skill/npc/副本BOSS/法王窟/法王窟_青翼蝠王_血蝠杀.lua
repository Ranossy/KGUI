...
tSkillData =
{
	{nDamageBase = 12800*0.8, nDamageRand = 12800*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 27800*0.8, nDamageRand = 27800*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2624, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
