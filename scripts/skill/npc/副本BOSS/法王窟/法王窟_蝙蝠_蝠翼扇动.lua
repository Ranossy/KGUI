...
tSkillData =
{
	{nDamageBase = 2300*0.8, nDamageRand = 2300*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2423, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 2625, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置2号位Buff
