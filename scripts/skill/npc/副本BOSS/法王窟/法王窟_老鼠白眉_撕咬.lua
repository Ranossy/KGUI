...
tSkillData =
{
	{nDamageBase = 1500*0.8, nDamageRand = 1500*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3300*0.8, nDamageRand = 3300*0.4, nBuffLevel = 2},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2598, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
