...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(4001, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3976, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 3976, 1);		-- 设置2号位Buff
