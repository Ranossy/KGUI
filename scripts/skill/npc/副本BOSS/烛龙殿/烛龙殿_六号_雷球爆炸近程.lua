...
tSkillData =
{
	{nDamage = 27000 * 0.8, nDamageRand = 27000 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 42800 * 0.8, nDamageRand = 42800 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.nProtectRadius    = 5 * LENGTH_BASE; 
