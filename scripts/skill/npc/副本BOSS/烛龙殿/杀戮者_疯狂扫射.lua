...
tSkillData =
{
	{nDamage = 170000 * 0.8, nDamageRand = 170000 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 185000 * 0.8, nDamageRand = 185000 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
   ...
   skill.AddAttribute(
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nAngleRange		= 24;					-- 攻击范围的扇形角度范围
