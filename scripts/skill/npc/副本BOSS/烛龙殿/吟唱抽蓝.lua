...
if ctarget then
                   local MaxMP = ctarget.nMaxMana
                   local CurrentMP = ctarget.nCurrentMana
                   
                    	if scene.dwMapID == 133 then
							if CurrentMP > 4000 then
								ctarget.nCurrentMana = CurrentMP - 4000
							else 
								ctarget.nCurrentMana = 10
							end
                   		elseif scene.dwMapID == 134 then 
							if CurrentMP > 2000 then
								ctarget.nCurrentMana = CurrentMP - 2000
							else 
								ctarget.nCurrentMana = 10
							end
                   		end
