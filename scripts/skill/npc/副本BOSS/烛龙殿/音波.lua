...
tSkillData =
{
	{nDamage = 9500 * 0.8, nDamageRand = 9500 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 11300 * 0.8, nDamageRand = 11300 * 0.4, nCostMana = 0},		--level 2
...
--	);
   skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3635, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if tplayer and IsPlayer(dwCharacterID) then
		tplayer.nCurrentLife = player.nCurrentLife - nNum
