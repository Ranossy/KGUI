...
tSkillData =
{
	{nDamage = 2500 , nDamageRand = 0 , nCostMana = 1},		--level 1
	{nDamage = 4000 , nDamageRand = 0 , nCostMana = 2},		--level 2
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3722, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 3619, tSkillData[dwSkillLevel].nCostMana);		-- 设置1号位Buff
	...
	skill.nMaxRadius		= 31 * LENGTH_BASE;		-- 技能施放的最大距离

	----------------- 作用范围 -------------------------------------------------
	skill.nAngleRange		= 256;					-- 攻击范围的扇形角度范围
	--skill.nAreaRadius		= 31 * LENGTH_BASE;		-- 技能作用半径
