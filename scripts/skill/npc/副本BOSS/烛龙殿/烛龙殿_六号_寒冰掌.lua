...
tSkillData =
{
	{nDamage = 12000 * 0.9, nDamageRand = 12000 * 0.2, nCostMana = 0},		--level 1
	{nDamage = 15000 * 0.9, nDamageRand = 15000 * 0.2, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/烛龙殿/playerstop.lua",				-- 属性值1
   		0														-- 属性值2
   		);
   	 ...
   	 skill.AddAttribute(
   	  ...
   	  skill.AddAttribute(
   		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,			-- 属性作用模式
   		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   		"skill/npc/副本BOSS/烛龙殿/烛龙殿_六号_寒冰掌.lua",				-- 属性值1
   		0														-- 属性值2
   		);
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3753, dwSkillLevel);		-- 设置1号位Buff
...
local character = nil
	...
	if character then
		...
		if scene.dwMapID == 134 then
		    scene.CreateNpc(16854,character.nX,character.nY,character.nZ,0,-1);
		elseif scene.dwMapID == 133 then
		    scene.CreateNpc(17417,character.nX,character.nY,character.nZ,0,-1);
		end
			--character.PlaySfx(138, character.nX, character.nY, character.nZ, 0)
	end
