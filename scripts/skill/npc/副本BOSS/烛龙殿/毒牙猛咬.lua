...
tSkillData =
{
	{nDamage = 10000, nDamageRand = 0, nCostMana = 1},		--level 1
	{nDamage = 20000, nDamageRand = 0, nCostMana = 2},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3625, tSkillData[dwSkillLevel].nCostMana);		-- 设置1号位Buff
