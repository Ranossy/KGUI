...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3765, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	skill.AddSlowCheckDestBuff(3766, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3765,1);		-- 设置1号位Buff
