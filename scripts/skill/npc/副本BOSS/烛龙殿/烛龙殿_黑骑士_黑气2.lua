...
tSkillData =
{
	{nDamage = 20000 , nDamageRand = 0 , nCostMana = 1},		--level 1
	{nDamage = 50000 , nDamageRand = 0 , nCostMana = 2},		--level 2
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3722, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
