...
tSkillData =
{
	{nDamage = 20900 * 0.8, nDamageRand = 20900 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 29800 * 0.8, nDamageRand = 29800 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 3770, 1);		-- 设置1号位Buff
