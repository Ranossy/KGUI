...
tSkillData =
{
	{nDamage = 1000, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   	skill.SetSubsectionSkill(1, 1, 3621, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 3621, dwSkillLevel);
	skill.SetSubsectionSkill(3, 3, 3621, dwSkillLevel);
	skill.SetSubsectionSkill(4, 4, 3621, dwSkillLevel);
	skill.SetSubsectionSkill(5, 5, 3621, dwSkillLevel);
   skill.AddAttribute(
