...
tSkillData =
{
	...
	{nDamage = 27000 * 0.8, nDamageRand = 27000 * 0.4, nCostMana = 0},		--level 2
...
function Apply(dwCharacterID)
	...
	local npcBOSS = scene.GetNpcByNickName("yinhuozhizhu")
	if not npcBOSS then
		return
	end
    npcBOSS.CastSkill(3715,1,TARGET.PLAYER,dwCharacterID)
