...
function Apply(dwCharacterID)
    if not IsPlayer(dwCharacterID) then
         ...
         if tplayer then
                   local MaxMP = tplayer.nMaxMana
                   local CurrentMP = tplayer.nCurrentMana
                   if CurrentMP > MaxMP * 0.15 then
                   	tplayer.nCurrentMana = CurrentMP - MaxMP * 0.15
					else
					tplayer.nCurrentMana = 10
                   end
         end
end
