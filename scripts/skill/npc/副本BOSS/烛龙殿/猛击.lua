...
tSkillData =
{
	{nDamage = 24200 * 0.8, nDamageRand = 24200 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 35000 * 0.8, nDamageRand = 35000 * 0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
   ...
   skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3826, 1);		-- 设置1号位Buff
