...
tSkillData =
{
	{nDamage = 8000 * 0.8, nDamageRand = 8000 * 0.4, nCostMana = 0},		--level 1
	{nDamage = 12200 * 0.8, nDamageRand = 12200 * 0.4, nCostMana = 0},		--level 2
	{nDamage = 4500 * 0.8, nDamageRand = 4500 * 0.4, nCostMana = 0},		--level 3
	{nDamage = 8000 * 0.8, nDamageRand = 8000 * 0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3854, dwSkillLevel);		-- 设置1号位Buff
