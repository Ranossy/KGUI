...
function GetSkillLevelData(skill)
   ...
   skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/烛龙殿/烛龙殿_六号_放电.lua",				-- 属性值1
   		0														-- 属性值2
   		);
...
local character = nil
	...
	if character then
		if scene.dwMapID == 134 then
		    scene.CreateNpc(16489,character.nX,character.nY,character.nZ,0,-1,"dianqiu");
		elseif scene.dwMapID == 133 then
			scene.CreateNpc(17419,character.nX,character.nY,character.nZ,0,-1,"dianqiu");
		end
            character.PlaySfx(140,character.nX,character.nY,character.nZ,0)
	end
end
