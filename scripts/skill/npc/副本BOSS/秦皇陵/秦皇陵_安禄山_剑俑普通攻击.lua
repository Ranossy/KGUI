---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_剑俑普通攻击.lua
-- 更新时间:	2014/3/5 14:55:18
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 23700, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 46100, nDamageRand = 0, nCostMana = 0},		--level 2
