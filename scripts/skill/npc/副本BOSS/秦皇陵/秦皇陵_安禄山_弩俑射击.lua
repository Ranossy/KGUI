---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_弩俑射击.lua
-- 更新时间:	2014/1/21 14:40:50
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 17400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 32200, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 15660, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_弩俑射击.lua",								--属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.nZ >= 1065472 then
		player.PlaySfx(554, player.nX, player.nY, 1065472)
	elseif player.nZ < 1065472 then
