---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_铁勾母技能.lua
-- 更新时间:	2014/3/12 19:50:09
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_铁勾母技能.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	scene.SetTimer(0.8 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_铁勾母技能.lua", player.dwID, 1)
	--player.Stop()
	--player.CastSkill(8746, 1)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if playertarget then
		playertarget.Stop()
		playertarget.DoAction(0, 10103)
		playertarget.CastSkill(8746, 1)
	end
end
