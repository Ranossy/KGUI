---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_黑暗之力中距离.lua
-- 更新时间:	2014/2/17 17:17:31
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 34800, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamage = 92700, nDamageRand = 0, nCostMana = 0},		--level 2
