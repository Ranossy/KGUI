---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/25人圣女_献身真理阳性伤害.lua
-- 更新时间:	2014/4/17 16:03:04
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 36000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 36000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/25人圣女_献身真理阳性伤害.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(7587, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	local tplayer = GetPlayer(dwSkillSrcID)  --释放者
	if not tplayer then
		return
	end
	local buff = tplayer.GetBuff(7583, 2)
	if buff then
