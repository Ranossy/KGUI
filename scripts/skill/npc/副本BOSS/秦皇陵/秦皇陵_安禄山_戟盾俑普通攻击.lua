---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_戟盾俑普通攻击.lua
-- 更新时间:	2014/3/5 14:56:12
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 51700, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 138400, nDamageRand = 0, nCostMana = 0},		--level 2
