---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_瘴气.lua
-- 更新时间:	2014/2/27 9:54:22
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 650, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1300, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 1900, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 2600, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 3000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 1200, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 2400, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 3600, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 4800, nDamageRand = 0, nCostMana = 0}, --level 9
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_瘴气.lua",								--属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(422, player.nX, player.nY, player.nZ)
end
