---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_滚石.lua
-- 更新时间:	2014/2/26 14:35:17
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 51100, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 53300, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_滚石.lua",								--属性值1
		0															--属性值2
	);
