---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/25人圣女_移魂换命吸血.lua
-- 更新时间:	2014/4/17 15:40:40
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nTherapy = 897750, nTherapyRand = 0, nTherapyPowerPercent = 0}, --level 1
	{nTherapy = 897750, nTherapyRand = 0, nTherapyPowerPercent = 0}, --level 2
	{nTherapy = 10000, nTherapyRand = 0, nTherapyPowerPercent = 0}, --level 3
	{nTherapy = 10000, nTherapyRand = 0, nTherapyPowerPercent = 0}, --level 4
};
