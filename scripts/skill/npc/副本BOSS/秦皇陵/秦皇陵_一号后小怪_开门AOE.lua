---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号后小怪_开门AOE.lua
-- 更新时间:	2014/3/14 16:50:52
-- 更新用户:	ZHOUMING
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_一号后小怪_开门AOE.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.nAreaRadius = 1.75 * LENGTH_BASE;		-- 技能作用半径
...
function Apply(dwCharacterID, dwSrc)
	...
	if player and npcSrc then
		local dwIndex = npcSrc.GetCustomUnsigned1(0) + 1
		local nNum = npcSrc.GetCustomUnsigned1(dwIndex)
		npcSrc.SetCustomUnsigned1(dwIndex,nNum + 1)
	end
end
