---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号_玩家驾车撞俑.lua
-- 更新时间:	2014/4/9 20:12:57
-- 更新用户:	liguanghao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 229000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1010000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_一号_玩家驾车撞俑.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		if scene then
			if scene.dwMapID == 182 then
				player.AddBuff(0, 99, 7738, 1)
			elseif scene.dwMapID == 183 then
				player.AddBuff(0, 99, 7738, 2)
			end
		end
	end
	local npc = GetNpc(dwCharacterID)
	if npc and npc.dwTemplateID == 30353 then
		npc.Die()
	...
	if npc and npc.dwTemplateID == 27623 then
		player.DelGroupBuff(7738, 1)
		player.DelGroupBuff(7581, 1)
		player.DelGroupBuff(7425, 1)
		player.SetModelID(0)
	...
	if npc and npc.dwTemplateID == 36183 then
		npc.Die()
	...
	if npc and npc.dwTemplateID == 36114 then
		player.DelGroupBuff(7738, 2)
		player.DelGroupBuff(7581, 2)
		player.DelGroupBuff(7425, 2)
		player.SetModelID(0)
