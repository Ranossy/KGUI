---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_白球撞击.lua
-- 更新时间:	2014/1/21 11:17:06
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_白球撞击.lua",								--属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	if scene.dwMapID == 182 then
		local heiyunBuff = player.GetBuff(7382, 1)
		if not heiyunBuff then
			player.AddBuff(0, 99, 7383, 1)
		else
			local num = heiyunBuff.nStackNum
			player.DelGroupBuff(7382, 1)
			for i = 1, num do
				player.AddBuff(0, 99, 7383, 1)
			end
		end
	...
	if scene.dwMapID == 183 then
		local heiyunBuff = player.GetBuff(7382, 2)
		if not heiyunBuff then
			player.AddBuff(0, 99, 7383, 2)
		else
			local num = heiyunBuff.nStackNum
			player.DelGroupBuff(7382, 2)
			for i = 1, num do
				player.AddBuff(0, 99, 7383, 2)
			end
		end
