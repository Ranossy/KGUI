---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_玩家战车冲锋启动.lua
-- 更新时间:	2014/3/7 11:34:27
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_玩家战车冲锋启动.lua",								--属性值1
		0															--属性值2
	);
	...
	skill.SetNormalCoolDown(1, 706);	--技能普通CD
