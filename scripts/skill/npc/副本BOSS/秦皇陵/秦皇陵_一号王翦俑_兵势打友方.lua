---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号王翦俑_兵势打友方.lua
-- 更新时间:	2014/2/10 17:33:28
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_一号王翦俑_兵势打友方.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAreaRadius		= 55 * LENGTH_BASE;		-- 技能作用半径 
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local cBoss = GetNpc(dwSkillSrcID)
	if not cBoss then
		return
	end
	
	if cnpc.dwTemplateID == 27625 or cnpc.dwTemplateID == 27673 then
		cnpc.Die()
		cBoss.AddBuff(0,99,7444,1)
	end
	if cnpc.dwTemplateID == 36115 or cnpc.dwTemplateID == 36140 then
		cnpc.Die()
		cBoss.AddBuff(0, 99, 7444, 2)
	end
end
