---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_二号雷麒麟_玩家右翻.lua
-- 更新时间:	2014/2/14 15:45:08
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
Include("scripts/skill/npc/副本BOSS/秦皇陵/二号雷麒麟左翻失败.lua")
tSkillData = 
{
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_二号雷麒麟_玩家右翻.lua",
		0
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(7514, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.nAreaRadius		= 256 * LENGTH_BASE;		-- 技能作用半径 
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if player.GetBuff(7711, 1) then
			player.DelBuff(7711, 1)--删除左失败
			player.Stop()
			player.Stop()
			player.CastSkill(8848, 1)
