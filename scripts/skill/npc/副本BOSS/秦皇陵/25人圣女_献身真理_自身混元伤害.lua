---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/25人圣女_献身真理_自身混元伤害.lua
-- 更新时间:	2014/4/17 16:10:03
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 31500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 42000, nDamageRand = 0, nCostMana = 0}, --level 2
