---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_安禄山普通踩踏.lua
-- 更新时间:	2014/2/8 14:49:07
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamage = 4300, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 8100, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_安禄山普通踩踏.lua",								--属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nProtectRadius = 8 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
...
function Apply(dwCharacterID)
	...
	--if player.GetOTActionState() == CHARACTER_OTACTION_TYPE.ACTION_SKILL_PREPARE or player.GetOTActionState() == CHARACTER_OTACTION_TYPE.ACTION_SKILL_CHANNEL then
		--player.AddBuff(0, 99, 7417, 1, 1)
		--player.PlaySfx(681, player.nX, player.nY, player.nZ)
	--end
end
