...
tSkillData = 
{
	{nDamageBase = 37400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 49800, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7443, dwSkillLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 7722, dwSkillLevel)
