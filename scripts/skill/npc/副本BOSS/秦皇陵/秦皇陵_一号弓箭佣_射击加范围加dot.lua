...
tSkillData = 
{
	...
	{nDamageBase = 8100, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddSlowCheckSelfBuff(7429, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
		skill.AddSlowCheckSelfBuff(7430, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	elseif dwSkillLevel == 2 then
		skill.AddSlowCheckSelfBuff(7429, 1, BUFF_COMPARE_FLAG.EQUAL, 2, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
		skill.AddSlowCheckSelfBuff(7430, 1, BUFF_COMPARE_FLAG.EQUAL, 2, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	end
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7440, dwSkillLevel);		-- 设置1号位Buff
