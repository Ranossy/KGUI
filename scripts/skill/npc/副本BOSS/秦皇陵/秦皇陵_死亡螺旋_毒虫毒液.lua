---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_毒虫毒液.lua
-- 更新时间:	2014/3/20 14:34:05
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 36500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 48700, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_毒虫毒液.lua",								--属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_死亡螺旋_毒虫毒液.lua", player.dwID, 1)
	--player.PlaySfx(693, player.nX, player.nY, player.nZ)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	if playertarget then
		playertarget.PlaySfx(693, playertarget.nX, playertarget.nY, playertarget.nZ)
	end
end
