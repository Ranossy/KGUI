---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_25人安禄山_玩家战车踩踏.lua
-- 更新时间:	2014/4/16 11:12:46
-- 更新用户:	ks13376-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 220000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 220000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_25人安禄山_玩家战车踩踏.lua",								--属性值1
		0															--属性值2
	);
