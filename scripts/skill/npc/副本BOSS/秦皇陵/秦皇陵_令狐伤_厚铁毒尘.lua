...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 7578, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(7578, 1) and player.GetBuff(7578, 1).nStackNum == 5 then
		npc.CastSkill(8920, 1, TARGET.PLAYER, dwCharacterID)
	end
	if player.GetBuff(7578, 2) and player.GetBuff(7578, 2).nStackNum == 5 then
		npc.CastSkill(8920, 2, TARGET.PLAYER, dwCharacterID)
	end	
end
