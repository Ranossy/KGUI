---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号后小怪_钉子.lua
-- 更新时间:	2014/2/19 15:22:55
-- 更新用户:	ZHOUMING
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 1285800, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1987000, nDamageRand = 0, nCostMana = 0}, --level 2
