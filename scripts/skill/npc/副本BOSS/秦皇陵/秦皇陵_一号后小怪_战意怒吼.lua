---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号后小怪_战意怒吼.lua
-- 更新时间:	2014/2/13 17:53:46
-- 更新用户:	ZHOUMING
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_一号后小怪_战意怒吼.lua",								--属性值1
		0															--属性值2
	);		
	...
	----------------- BUFF相关 -------------------------------------------------
	 -- skill.BindBuff(1, 7515, dwSkillLevel);		-- 设置1号位Buff
	  --skill.BindBuff(2, 7100, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID)
	...
	if npc and (npc.dwTemplateID == 27683 or npc.dwTemplateID == 27684) then
		npc.AddBuff(0,99,7515,1)
	elseif npc and (npc.dwTemplateID == 36148 or npc.dwTemplateID == 36149) then
              npc.AddBuff(0,99,7515,2)
	end
end
