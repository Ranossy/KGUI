---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_三号圣女_优艳火花3段.lua
-- 更新时间:	2014/2/12 11:52:32
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 44300, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 58600, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7474, dwSkillLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 7639, dwSkillLevel);		-- 设置2号位Buff
	...
	----------------- 作用范围 -------------------------------------------------
	skill.nProtectRadius = 3 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
