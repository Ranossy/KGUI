---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_一号车佣_前进.lua
-- 更新时间:	2014/3/19 16:39:16
-- 更新用户:	liguanghao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/秦皇陵/秦皇陵_一号车佣_前进.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		local nX = player.nX + 5 * 64 * math.cos(player.nFaceDirection / 256 * 2 * math.pi)
		local nY = player.nY + 5 * 64 * math.sin(player.nFaceDirection / 256 * 2 * math.pi)
