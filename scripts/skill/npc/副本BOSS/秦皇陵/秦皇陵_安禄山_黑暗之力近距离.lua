---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/秦皇陵/秦皇陵_安禄山_黑暗之力近距离.lua
-- 更新时间:	2014/2/17 17:14:54
-- 更新用户:	ks13376-PC
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 69600, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamage = 139100, nDamageRand = 0, nCostMana = 0},		--level 2
