------------------------------------------------
-- 文件名    :  荻花圣殿_9号BOSS_蛮熊之力_震地颤尘锤.lua
-- 创建人    :  张豪
-- 创建时间  :  2011-3-27
-- 用途(模块):  副本BOSS
-- 武功门派  :  无
...
tSkillData =
{
	{nDamageBase = 20000 * 0.8, nDamageRand = 20000 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 34100 * 0.8, nDamageRand = 34100 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 39600 * 0.8, nDamageRand = 39600 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 53300 * 0.8, nDamageRand = 53300 * 0.4, nCostMana = 0},		--level 4
	...
	{nDamageBase = 12562 * 0.8, nDamageRand = 12562 * 0.4, nCostMana = 0},		--level 31
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
		skill.BindBuff(1, 2970, 1);		-- 设置1号位Buff
