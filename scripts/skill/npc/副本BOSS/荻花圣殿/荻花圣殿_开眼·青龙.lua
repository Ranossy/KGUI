---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/荻花圣殿/荻花圣殿_开眼·青龙.lua
-- 更新时间:	2016/1/14 10:20:07
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamage = 1700000, nDamageRand = 10000, nCostMana = 0}, --level 1
	{nDamage = 1700000 / 2.5, nDamageRand = 10000, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(3968, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
