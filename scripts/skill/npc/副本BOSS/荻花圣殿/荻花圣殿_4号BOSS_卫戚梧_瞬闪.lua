...
function GetSkillLevelData(skill)
   ...
   if dwSkillLevel == 1 then
   	  skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_4号BOSS_卫戚梧_瞬闪.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 2 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/10人英雄荻花圣殿_4号BOSS_卫戚梧_瞬闪.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 3 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/25人普通荻花圣殿_4号BOSS_卫戚梧_瞬闪.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 4 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/25人英雄荻花圣殿_4号BOSS_卫戚梧_瞬闪.lua",								--属性值1
   			0															--属性值2
   		);
   	end
...
function Apply(dwCharacterID)
 ...
 local remnu = scene.CreateNpc(10410, npc.nX, npc.nY, npc.nZ, "renmu", 80)
