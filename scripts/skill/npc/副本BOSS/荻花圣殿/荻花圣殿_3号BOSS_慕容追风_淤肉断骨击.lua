...
tSkillData =
{
	{nDamageBase = 15700*0.8, nDamageRand = 15700*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 36900*0.8, nDamageRand = 36900*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 50200*0.8, nDamageRand = 50200*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 55200*0.8, nDamageRand = 55200*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2203, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
