...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   	   	...
   	   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_9号BOSS_血药.lua",								--属性值1
   			0															--属性值2
   		);
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 3301, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local scene = cNpc.GetScene()
		...
		cNpc.SetDisappearFrames(4)
	local dashe = scene.GetNpcByNickName("dashe_1")
		if not dashe then
			return
		end
		dashe.SetCustomBoolean(60,true)
end
