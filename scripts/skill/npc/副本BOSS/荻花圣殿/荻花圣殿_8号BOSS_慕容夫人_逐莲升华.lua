...
tSkillData =
{
	{nDamageBase = 500*0.8, nDamageRand = 500*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 3800*0.8, nDamageRand = 3800*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 3800*0.8, nDamageRand = 3800*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 8300*0.8, nDamageRand = 8300*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 2631, 1);		-- 设置1号位Buff
