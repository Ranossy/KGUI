------------------------------------------------
-- 文件名    :  荻花圣殿_4号BOSS_卫戚梧_返首刀(子技能).lua
-- 创建人    :  张豪
-- 创建时间  :  2010-10-21
-- 用途(模块):  副本BOSS
-- 武功门派  :  无
...
tSkillData =
{
	{nDamageBase = 4300*0.8, nDamageRand = 4300*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 8300*0.8, nDamageRand = 8300*0.4, nBuffLevel = 1},		--level 2
	{nDamageBase = 10800*0.8, nDamageRand = 10800*0.4, nBuffLevel = 1},		--level 3
	{nDamageBase = 13900*0.8, nDamageRand = 13900*0.4, nBuffLevel = 1},		--level 4
