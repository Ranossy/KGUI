...
tSkillData =
{
	...
	{nDamageBase = 12300*0.8, nDamageRand = 12300*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 10800*0.8, nDamageRand = 10800*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 14100*0.8, nDamageRand = 14100*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2628, dwSkillLevel);		-- 设置1号位Buff
