    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   	   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_9号BOSS_贪狼之牙_黑眼贪狼刀_施放子弹.lua",								--属性值1
   			0															--属性值2
   		);
...
local tDirection = {}
	...
	for	i = 1, 5 do
		...
		local npcYb = scene.CreateNpc(12284, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 8 * GLOBAL.GAME_FPS)
		if npcYb then
			npcYb.RunTo(nX, nY)
		end
	end
