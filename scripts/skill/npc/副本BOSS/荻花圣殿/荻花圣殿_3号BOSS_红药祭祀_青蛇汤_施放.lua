------------------------------------------------
-- 文件名    : 荻花圣殿_3号BOSS_红药祭祀_青蛇汤_施放.lua
-- 创建人    :  zhanghao
-- 创建时间  :  2011-01-23
-- 用途(模块):  副本BOSS
-- 武功门派  :  无
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	if dwSkillLevel == 1 then
   	  skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_3号BOSS_红药祭祀_青蛇汤_施放.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 2 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/10人英雄荻花圣殿_3号BOSS_红药祭祀_青蛇汤_施放.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 3 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/25人普通荻花圣殿_3号BOSS_红药祭祀_青蛇汤_施放.lua",								--属性值1
   			0															--属性值2
   		);
   	elseif dwSkillLevel == 4 then
   	  skill.AddAttribute(
   			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			-- 属性作用模式
   			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								-- 魔法属性
   			"skill/npc/副本BOSS/荻花圣殿/25人英雄荻花圣殿_3号BOSS_红药祭祀_青蛇汤_施放.lua",								--属性值1
   			0															--属性值2
   		);
   	end
	...
	if npc then 
		local scene = npc.GetScene()
				if scene then
					...
					if npc1 then
						npc.CastSkill(2115,1,TARGET.NPC,npc1.dwID) 
					end
				end
	end
end
