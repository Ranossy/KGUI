...
tSkillData =
{
	{nDamageBase = 1000*0.8, nDamageRand = 1000*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nBuffLevel = 1},		--level 2
	{nDamageBase = 1500*0.8, nDamageRand = 1500*0.4, nBuffLevel = 1},		--level 3
	{nDamageBase = 5400*0.8, nDamageRand = 5400*0.4, nBuffLevel = 1},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ...
   --skill.AddSlowCheckDestBuff(2626,0,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 2632, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
