...
tSkillData =
{
	{nDamage = 2000000, nDamageRand = 10000, nCostMana = 0},		--level 1
	{nDamage = 2000000 / 2.5, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
      skill.AddSlowCheckDestBuff(3968, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
