...
tSkillData =
{
	{nDamageBase = 700*0.8, nDamageRand = 700*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 2600*0.8, nDamageRand = 2600*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 4400*0.8, nDamageRand = 4400*0.4, nCostMana = 0},		--level 4
