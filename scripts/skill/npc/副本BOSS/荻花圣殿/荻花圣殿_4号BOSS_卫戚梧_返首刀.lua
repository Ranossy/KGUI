...
tSkillData =
{
	{nDamageBase = 3700*0.8, nDamageRand = 3700*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 9300*0.8, nDamageRand = 9300*0.4, nBuffLevel = 1},		--level 2
	{nDamageBase = 9300*0.8, nDamageRand = 9300*0.4, nBuffLevel = 1},		--level 3
	{nDamageBase = 9300*0.8, nDamageRand = 9300*0.4, nBuffLevel = 1},		--level 4
