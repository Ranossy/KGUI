...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_9号BOSS_蛮熊之力_震地颤尘锤.lua",				-- 属性值1
   		0														-- 属性值2
   		);
                   ...
                   if npc then
                            ...
                            if nNow <= nMax then
                                     ...
                                     if scene.dwMapID ==68 then
                                     	npc.CastSkill(2810, 1)
                                     elseif scene.dwMapID ==69 then
                                     	npc.CastSkill(2810, 2) 
                                     elseif scene.dwMapID ==70 then
                                     	npc.CastSkill(2810, 3)	
                                     elseif scene.dwMapID ==72 then
                                     	npc.CastSkill(2810, 4)
                                     end	
                                     scene.SetCustomBoolean(90, true)
