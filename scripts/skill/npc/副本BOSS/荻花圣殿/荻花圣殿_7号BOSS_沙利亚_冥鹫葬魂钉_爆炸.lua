...
tSkillData =
{
	{nDamageBase = 1600*0.8, nDamageRand = 1600*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 7900*0.8, nDamageRand = 7900*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 7900*0.8, nDamageRand = 7900*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 8700*0.8, nDamageRand = 8700*0.4, nCostMana = 0},		--level 4
