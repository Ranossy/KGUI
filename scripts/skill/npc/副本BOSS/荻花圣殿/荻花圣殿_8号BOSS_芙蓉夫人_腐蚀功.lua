...
tSkillData =
{
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 10300*0.8, nDamageRand = 10300*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 15800*0.8, nDamageRand = 15800*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 17300*0.8, nDamageRand = 17300*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_8号BOSS_芙蓉夫人_腐蚀功.lua",				-- 属性值1
   		0														-- 属性值2
   	);
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 2616, dwSkillLevel);		-- 设置1号位Buff
