...
tSkillData =
{
	{nDamage = 2300 *0.95, nDamageRand = 2300 *0.1, nDashSpeed = 100},   	-- Level 1 Dash速度单位 点/帧
	{nDamage = 7600 *0.95, nDamageRand = 7600 *0.1, nDashSpeed = 100},   	-- Level 2 Dash速度单位 点/帧
	{nDamage = 10800 *0.95, nDamageRand = 10800 *0.1, nDashSpeed = 100},   	-- Level 3 Dash速度单位 点/帧
	{nDamage = 12600 *0.95, nDamageRand = 12600 *0.1, nDashSpeed = 100},   	-- Level 4 Dash速度单位 点/帧
