...
tSkillData =
{
	{nDamageBase = 800*0.8, nDamageRand = 800*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 1200*0.8, nDamageRand = 1200*0.4, nBuffLevel = 1},		--level 2
	{nDamageBase = 1200*0.8, nDamageRand = 1200*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 3100*0.8, nDamageRand = 3100*0.4, nBuffLevel = 1},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 2606, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
