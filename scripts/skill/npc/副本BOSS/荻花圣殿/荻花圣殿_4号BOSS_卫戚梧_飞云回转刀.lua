...
tSkillData =
{
	{nDamageBase = 1800*0.8, nDamageRand = 1800*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3500*0.8, nDamageRand = 3500*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 4200*0.8, nDamageRand = 4200*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 5000*0.8, nDamageRand = 5000*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  	--skill.BindBuff(1, 2219, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
