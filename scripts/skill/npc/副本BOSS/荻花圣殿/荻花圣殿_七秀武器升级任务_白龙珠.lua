...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_七秀武器升级任务_白龙珠.lua",				-- 属性值1
   		0														-- 属性值2
   	);

	----------------- 技能施放Buff需求 ---------------------------------------------
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
    --skill.AddSlowCheckDestBuff(3211,1,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
...
function Apply(dwCharacterID)
	...
	if cNpc.dwTemplateID == 15573 then
		cNpc.SetCustomBoolean(2, true)
		cNpc.PlaySfx(17, cNpc.nX, cNpc.nY, cNpc.nZ)
	end
end
