...
tSkillData =
{
	{nDamageBase = 160000*0.8, nDamageRand = 160000*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 233000*0.8, nDamageRand = 23300*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 233000*0.8, nDamageRand = 233000*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 233000*0.8, nDamageRand = 233000*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
    ...
    skill.AddSlowCheckDestBuff(2786,0,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
