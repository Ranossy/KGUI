...
tSkillData =
{
	{nDamageBase = 3800*0.8, nDamageRand = 3800*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 8800*0.8, nDamageRand = 8800*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 8300*0.8, nDamageRand = 8300*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 15300*0.8, nDamageRand = 15300*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2231, dwSkillLevel);		-- 设置1号位Buff
