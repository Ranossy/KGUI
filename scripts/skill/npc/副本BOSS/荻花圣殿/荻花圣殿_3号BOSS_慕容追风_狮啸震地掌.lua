...
tSkillData =
{
	{nDamageBase = 4900*0.8, nDamageRand = 4900*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 9600*0.8, nDamageRand = 9600*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 12400*0.8, nDamageRand = 12400*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 15500*0.8, nDamageRand = 15500*0.4, nCostMana = 0},		--level 4
