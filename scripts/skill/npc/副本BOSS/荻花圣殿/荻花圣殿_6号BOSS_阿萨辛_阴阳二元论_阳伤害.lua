...
tSkillData =
{
	{nDamageBase = 3300*0.8, nDamageRand = 3300*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 6000*0.8, nDamageRand = 6000*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 5700*0.8, nDamageRand = 5700*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 19800*0.8, nDamageRand = 19800*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(2249,1,BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
    skill.AddSlowCheckDestBuff(2250,0,BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	----------------- BUFF相关 -------------------------------------------------
