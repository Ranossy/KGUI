...
tSkillData =
{
	{nDamageBase = 19800*0.8, nDamageRand = 19800*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 17800*0.8, nDamageRand = 17800*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 15800*0.8, nDamageRand = 15800*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 13800*0.8, nDamageRand = 13800*0.4, nCostMana = 0},		--level 4
	{nDamageBase = 11800*0.8, nDamageRand = 11800*0.4, nCostMana = 0},		--level 5
	{nDamageBase = 9800*0.8, nDamageRand = 9800*0.4, nCostMana = 0},		--level 6
	{nDamageBase = 7800*0.8, nDamageRand = 7800*0.4, nCostMana = 0},		--level 7
	{nDamageBase = 5800*0.8, nDamageRand = 5800*0.4, nCostMana = 0},		--level 8
	{nDamageBase = 3800*0.8, nDamageRand = 3800*0.4, nCostMana = 0},		--level 9
	{nDamageBase = 1800*0.8, nDamageRand = 1800*0.4, nCostMana = 0},		--level 10
	{nDamageBase = 800*0.8, nDamageRand = 800*0.4, nCostMana = 0},		--level 11
