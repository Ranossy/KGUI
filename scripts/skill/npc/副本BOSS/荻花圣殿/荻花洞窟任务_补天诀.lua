...
tSkillData =
{
	{nDamageBase = 24000*0.8, nDamageRand = 24000*0.4, nCostMana = 96},		--level 1
	{nDamageBase = 24000*0.8, nDamageRand = 24000*0.4, nCostMana = 48},		--level 2
...
function GetSkillLevelData(skill)
    ...
    ----------------- 时间相关 -------------------------------------------------
    skill.nPrepareFrames  	= tSkillData[dwSkillLevel].nCostMana;				-- 吟唱帧数
