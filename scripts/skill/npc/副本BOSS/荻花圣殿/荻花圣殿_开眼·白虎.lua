    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   	   	...
   	   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_开眼·白虎.lua",								--属性值1
   			0															--属性值2
   		);
...
function Apply(dwCharacterID)
	...
	local nTime = 4800
	if MapId == 220 or MapId == 234 or MapId == 221 or MapId == 235 or MapId == 240 or MapId == 241 then
		 nTime = 4800/2.5
	end
	local npcA = scene.CreateNpc(16582, cPlayer.nX , cPlayer.nY+ 5 * 64, cPlayer.nZ,cPlayer.nFaceDirection, nTime, "baihu1")
	local npcB = scene.CreateNpc(16582, cPlayer.nX , cPlayer.nY- 5 * 64, cPlayer.nZ,cPlayer.nFaceDirection, nTime, "baihu2")
	npcA.AddBuff(0,99,3701,1)
	npcB.AddBuff(0,99,3701,1)
end
