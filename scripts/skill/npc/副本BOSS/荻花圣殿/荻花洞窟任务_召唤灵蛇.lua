...
function GetSkillLevelData(skill)
   ...
   skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/荻花圣殿/荻花洞窟任务_召唤灵蛇.lua",				-- 属性值1
   		0														-- 属性值2
   		);
...
local character = nil
	...
	if character then
		local scene = character.GetScene()
		    scene.CreateNpc(16426,character.nX+100,character.nY,character.nZ,0,-1,"lingshe_1");
		    scene.CreateNpc(16427,character.nX-100,character.nY,character.nZ,0,-1,"lingshe_2");--此处写Boss名字+"_",只要加入名字,其他信息不变
		end
end
