...
tSkillData =
{
	{nDamageBase = 4900*0.8, nDamageRand = 4900*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 12000*0.8, nDamageRand = 12000*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 14800*0.8, nDamageRand = 14800*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 17800*0.8, nDamageRand = 17800*0.4, nBuffLevel = 4},		--level 4
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
    ...
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
      skill.AddSlowCheckDestBuff(2184, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
