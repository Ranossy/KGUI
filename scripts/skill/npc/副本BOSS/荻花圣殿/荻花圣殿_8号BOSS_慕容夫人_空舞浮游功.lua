...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   	   	...
   	   	skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_8号BOSS_慕容夫人_空舞浮游功.lua",								--属性值1
   			0															--属性值2
   		);
   ...
   skill.AddSlowCheckDestBuff(2631,1,BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2626, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	player.Stop()
	player.Jump(true,player.nDirectionXY)
end
