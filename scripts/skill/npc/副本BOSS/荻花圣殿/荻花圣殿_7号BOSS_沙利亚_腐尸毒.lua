...
tSkillData =
{
	...
	{nDamageBase = 9500*0.8, nDamageRand = 9500*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 10500*0.8, nDamageRand = 10500*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 11900*0.8, nDamageRand = 11900*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2582, dwSkillLevel);		-- 设置1号位Buff
	...
	----------------- 作用范围 -------------------------------------------------
	  ...
	  skill.nAreaRadius		= 999 * LENGTH_BASE;		-- 技能作用半径 
