...
tSkillData =
{
	{nDamage = 600000, nDamageRand = 0, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
   ...
   skill.AddAttribute(
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
    skill.AddSlowCheckDestBuff(3521, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
    skill.AddSlowCheckDestBuff(3522, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
