...
tSkillData =
{
	{nDamageBase = 4000*0.8, nDamageRand = 4000*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 9000*0.8, nDamageRand = 9000*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 12200*0.8, nDamageRand = 12200*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 14700*0.8, nDamageRand = 14700*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2674, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
	skill.BindBuff(2, 2977, 1);		-- 设置2号位Buff
