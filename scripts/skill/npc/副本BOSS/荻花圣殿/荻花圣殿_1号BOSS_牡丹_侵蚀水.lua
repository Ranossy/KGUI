...
tSkillData =
{
	{nDamageBase = 1300*0.8, nDamageRand = 1300*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3200*0.8, nDamageRand = 3200*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 1600*0.8, nDamageRand = 1600*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 3200*0.8, nDamageRand = 3200*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2180, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
	--skill.BindBuff(2, 2172, 1);		-- 设置2号位Buff
