...
tSkillData =
{
	{nDamageBase = 12500*0.8, nDamageRand = 12500*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 1700*0.8, nDamageRand = 1700*0.4, nCostMana = 0},		--level 2
...
function Apply(dwCharacterID)
    ...
    if scene.dwMapID ==69 then
    	scene.CreateNpc(15195,player.nX,player.nY,player.nZ,0,480);
    elseif scene.dwMapID ==72 then
 		scene.CreateNpc(15196,player.nX,player.nY,player.nZ,0,480);
    end
