...
tSkillData =
{
	...
	{nDamageBase = 6900*0.8, nDamageRand = 6900*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 8200*0.8, nDamageRand = 8200*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 13800*0.8, nDamageRand = 13800*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1, 2174, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
