...
tSkillData =
{
	...
	{nDamageBase = 15900*0.8, nDamageRand = 15900*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
	   	  skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_6号BOSS_阿萨辛_阴阳二元论_辨阴阳.lua",								--属性值1
   			0															--属性值2
   	   	  );	
		 skill.AddAttribute(
    ...
    skill.AddSlowCheckDestBuff(2250, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	if IsPlayer(dwCharacterID) then
		...
		if player then
			if player.nGender == 1 then
			   player.AddBuff(0,99,2249,1)
			end
			if player.nGender == 2 then
			   player.AddBuff(0,99,2248,1)
			end
		end
	end
end
