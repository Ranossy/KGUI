...
tSkillData =
{
	...
	{nDamageBase = 3527*0.8, nDamageRand = 3527*0.4, nCostMana = 0},		--level 11
	{nDamageBase = 3233*0.8, nDamageRand = 3233*0.4, nCostMana = 0},		--level 12
	{nDamageBase = 2984*0.8, nDamageRand = 2984*0.4, nCostMana = 0},		--level 13
	{nDamageBase = 2771*0.8, nDamageRand = 2771*0.4, nCostMana = 0},		--level 14
	{nDamageBase = 2586*0.8, nDamageRand = 2586*0.4, nCostMana = 0},		--level 15
	{nDamageBase = 2425*0.8, nDamageRand = 2425*0.4, nCostMana = 0},		--level 16
	{nDamageBase = 2282*0.8, nDamageRand = 2282*0.4, nCostMana = 0},		--level 17
	{nDamageBase = 2155*0.8, nDamageRand = 2155*0.4, nCostMana = 0},		--level 18
	{nDamageBase = 2042*0.8, nDamageRand = 2042*0.4, nCostMana = 0},		--level 19
	{nDamageBase = 1940*0.8, nDamageRand = 1940*0.4, nCostMana = 0},		--level 20
	{nDamageBase = 1847*0.8, nDamageRand = 1847*0.4, nCostMana = 0},		--level 21
	{nDamageBase = 1763*0.8, nDamageRand = 1763*0.4, nCostMana = 0},		--level 22
	{nDamageBase = 1686*0.8, nDamageRand = 1686*0.4, nCostMana = 0},		--level 23
	{nDamageBase = 1616*0.8, nDamageRand = 1616*0.4, nCostMana = 0},		--level 24
	{nDamageBase = 1552*0.8, nDamageRand = 1552*0.4, nCostMana = 0},		--level 25
