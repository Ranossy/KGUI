...
tSkillData =
{
	...
	{nDamageBase = 4000*0.8, nDamageRand = 4000*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 5500*0.8, nDamageRand = 5500*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1, 2580, 1);		-- 设置1号位Buff
