...
tSkillData =
{
	{nDamageBase = 15454*0.8, nDamageRand = 15454*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(2631,0,BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2631, dwSkillLevel);		-- 设置1号位Buff
