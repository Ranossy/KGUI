---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/npc/副本BOSS/荻花圣殿/少林特殊武器_毁天灭地.lua
-- 更新时间:	2012-7-23 17:04:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 53200 * 0.8, nDamageRand = 53200 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- 作用范围 -------------------------------------------------
	--skill.nAngleRange		= 14;
	skill.nHeight = 10 * LENGTH_BASE;   
	skill.nRectWidth = 6 * LENGTH_BASE-- 攻击范围的扇形角度范围 
