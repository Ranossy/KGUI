...
tSkillData =
{
	{nDamageBase = 7333*0.8, nDamageRand = 7333*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 3200*0.8, nDamageRand = 3200*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 3200*0.8, nDamageRand = 3200*0.4, nBuffLevel = 3},		--level 3
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1, 2179, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
