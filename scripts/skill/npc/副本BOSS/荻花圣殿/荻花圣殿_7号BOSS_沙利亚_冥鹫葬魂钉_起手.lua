...
tSkillData =
{
	{nDamageBase = 3900*0.8, nDamageRand = 3900*0.4, nBuffLevel = 1},		--level 1
	{nDamageBase = 7700*0.8, nDamageRand = 7700*0.4, nBuffLevel = 2},		--level 2
	{nDamageBase = 8700*0.8, nDamageRand = 8700*0.4, nBuffLevel = 3},		--level 3
	{nDamageBase = 10500*0.8, nDamageRand = 10500*0.4, nBuffLevel = 4},		--level 4
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2605, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
