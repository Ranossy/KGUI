...
tSkillData =
{
	{nDamageBase = 14000*0.8, nDamageRand = 14000*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 14200*0.8, nDamageRand = 14200*0.4, nCostMana = 0},		--level 2
	{nDamageBase = 14200*0.8, nDamageRand = 14200*0.4, nCostMana = 0},		--level 3
	{nDamageBase = 14200*0.8, nDamageRand = 14200*0.4, nCostMana = 0},		--level 4
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
   		...
   		skill.AddAttribute(
   			...
   			"skill/npc/副本BOSS/荻花圣殿/荻花圣殿_9号BOSS_狂蟒之怒_提高消耗.lua",								--属性值1
   			0															--属性值2
   		);
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 3368, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if kungfu.dwSkillID == 10080 or kungfu.dwSkillID == 10028 or kungfu.dwSkillID ==  10176 then
		cPlayer.AddBuff(0,99,3368,1)
	end
end
