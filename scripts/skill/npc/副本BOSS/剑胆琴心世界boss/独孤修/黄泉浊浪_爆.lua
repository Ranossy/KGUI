---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/独孤修/黄泉浊浪_爆.lua
-- 更新时间:	2017/5/25 12:41:00
-- 更新用户:	ZHENGYUCHAO-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/独孤修/黄泉浊浪_爆.lua", --属性值1
		0															--属性值2
	);
	...
	skill.nAreaRadius = 4.5 * LENGTH_BASE;		-- 公治菱普攻
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	tPlayer.AddBuff(srcNpc.dwID, srcNpc.nLevel, 12002, 1)
end
