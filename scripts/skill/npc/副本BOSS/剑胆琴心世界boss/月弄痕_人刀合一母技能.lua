---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_人刀合一母技能.lua
-- 更新时间:	2017/5/9 10:02:15
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_人刀合一母技能.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tType, tID = npc.GetTarget()
	if not tType or tType ~= TARGET.PLAYER then
		return
	end
	...
	player.AddBuff(0, 99, 11947, 1)
	npc.PlaySfx(1169, player.nX, player.nY, player.nZ)
	npc.CastSkill(17647, 1)
end
