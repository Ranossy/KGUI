---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_毁天灭地伤害.lua
-- 更新时间:	2017/5/5 10:36:46
...
tSkillData =
{
	{nDamageBase = 7000, nDamageRand = 700, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_毁天灭地伤害.lua", -- 属性值1
		--0											-- 属性值2
	--);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11943, 1);		-- 设置1号位Buff
