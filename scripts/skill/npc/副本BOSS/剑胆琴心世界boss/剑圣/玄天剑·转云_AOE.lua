---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/剑圣/玄天剑·转云_AOE.lua
-- 更新时间:	2015/9/30 15:16:39
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 24700, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.BindBuff(1, 9943, 1);		-- 设置1号位Buff
