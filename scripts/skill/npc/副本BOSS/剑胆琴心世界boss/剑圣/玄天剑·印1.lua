---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/剑圣/玄天剑·印1.lua
-- 更新时间:	2015/10/11 15:43:19
-- 更新用户:	WANGZEYU
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 9940, 1);		-- 设置1号位Buff
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/剑圣/玄天剑·印1.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if not TPlayer.GetBuff(9952, 1) and not TPlayer.GetBuff(9946, 1) then
		TPlayer.AddBuff(0, 99, 9940, 1)
	end
	if TPlayer.GetBuff(9941, 1) and not TPlayer.GetBuff(9942, 1) then
		TPlayer.DelBuff(9940, 1)
		TPlayer.DelBuff(9941, 1)
		TPlayer.AddBuff(0, 99, 9952, 1)
	end

	if TPlayer.GetBuff(9942, 1) and not TPlayer.GetBuff(9941, 1) then
		TPlayer.DelBuff(9940, 1)
		TPlayer.DelBuff(9942, 1)
		TPlayer.AddBuff(0, 99, 9946, 1)
	end

	if TPlayer.GetBuff(9945, 1) then
		TPlayer.Die()
	end
end
