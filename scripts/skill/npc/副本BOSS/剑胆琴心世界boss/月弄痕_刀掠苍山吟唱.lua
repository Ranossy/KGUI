---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_刀掠苍山吟唱.lua
-- 更新时间:	2017/5/5 11:22:03
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_刀掠苍山吟唱.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.CastSkill(17653, 1)
	--npc.PlaySfx(8788,npc.nX,npc.nY,npc.nZ,npc.nFaceDirection/256*360)
end
