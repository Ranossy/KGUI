---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_千痕卷雪清除buff.lua
-- 更新时间:	2017/5/9 10:51:41
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_千痕卷雪清除buff.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsHaveBuff(11943,1) then
		player.DelGroupBuff(11943, 1)
	end
end
