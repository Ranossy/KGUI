---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_冰圈.lua
-- 更新时间:	2017/5/31 17:56:35
-- 更新用户:	qingfupei
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_冰圈.lua", --属性值1
		0															--属性值2
		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if player.GetBuff(12020, 1) then
			player.DelBuff(12020, 1)
		else
			player.AddBuff(0, 99, 12021, 1, 6)
		end				
	end
end
