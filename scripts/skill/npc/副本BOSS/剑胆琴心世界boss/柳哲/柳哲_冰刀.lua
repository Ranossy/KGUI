---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_冰刀.lua
-- 更新时间:	2017/5/31 22:01:25
-- 更新用户:	qingfupei
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_冰刀.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	--print("ice hit player id:" .. dwCharacterID)
	--print("dwSkillSrcID:" .. dwSkillSrcID)
	...
	local nBuff = player.GetBuff(12021, 1)
	if nBuff then
		local nExDamagePer = nBuff.nStackNum * 0.5			
		player.CustomDamage(npc.dwID, 17724, 1, 3, nBaseDamage * nExDamagePer)
	end
end
