---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_火刀.lua
-- 更新时间:	2017/6/1 17:06:08
-- 更新用户:	qingfupei
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_火刀.lua", --属性值1
		0															--属性值2
		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nBuff = player.GetBuff(12020, 1)
	if nBuff then
		local nExDamagePer = nBuff.nStackNum * 0.5			
		player.CustomDamage(npc.dwID, 17725, 1, 1, nBaseDamage * nExDamagePer)
	end
