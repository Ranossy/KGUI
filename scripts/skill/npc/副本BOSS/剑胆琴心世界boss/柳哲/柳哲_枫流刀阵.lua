---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_枫流刀阵.lua
-- 更新时间:	2017/5/31 20:54:50
-- 更新用户:	qingfupei
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/柳哲/柳哲_枫流刀阵.lua", --属性值1
		0															--属性值2
		);
	...
	skill.nRectWidth = 1.5 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
