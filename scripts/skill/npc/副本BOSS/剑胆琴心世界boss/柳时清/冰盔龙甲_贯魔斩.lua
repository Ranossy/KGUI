---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/柳时清/冰盔龙甲_贯魔斩.lua
-- 更新时间:	2017/5/25 16:15:03
-- 更新用户:	qingfupei
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/柳时清/冰盔龙甲_贯魔斩.lua",
		0
		);	
	...
	skill.nRectWidth = 26 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
