---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/森九岚/月海斩流剑_落.lua
-- 更新时间:	2015/10/3 16:06:38
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 24700, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 81100, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 81100, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 56800, nDamageRand = 0, nCostMana = 0}, --level 4
