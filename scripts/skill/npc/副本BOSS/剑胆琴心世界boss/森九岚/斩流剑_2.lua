---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/森九岚/斩流剑_2.lua
-- 更新时间:	2015/10/7 15:46:30
-- 更新用户:	gudingyin
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/剑胆琴心世界boss/森九岚/斩流剑_2.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9977, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buffJS1 = player.GetBuff(9976, 1)
	if buffJS1 then
		player.DelBuff(9976, 1)
	end
	local buffJS2 = player.GetBuff(9977, 1)
	if not buffJS2 then
		player.AddBuff(0, 99, 9977, 1, 1)
	end
	local buffJS3 = player.GetBuff(9978, 1)
	if buffJS3 then
		player.DelBuff(9978, 1)
	end
	local buffJS4 = player.GetBuff(9979, 1)
	if buffJS4 then
		player.DelBuff(9979, 1)
	end
end
