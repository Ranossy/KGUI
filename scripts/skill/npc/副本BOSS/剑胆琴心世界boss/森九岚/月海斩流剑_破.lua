---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/森九岚/月海斩流剑_破.lua
-- 更新时间:	2015/10/3 16:06:37
-- 更新用户:	CHENJINGRU
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 16400, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamage = 20000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamage = 12000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamage = 6500, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamage = 5500, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamage = 9500, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamage = 6666, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamage = 3333, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamage = 2000, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamage = 55555, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamage = 33333, nDamageRand = 0, nCostMana = 0}, --level 12
	{nDamage = 33333, nDamageRand = 0, nCostMana = 0}, --level 13
	{nDamage = 22222, nDamageRand = 0, nCostMana = 0}, --level 14
	{nDamage = 11111, nDamageRand = 0, nCostMana = 0}, --level 15
	{nDamage = 10000, nDamageRand = 0, nCostMana = 0}, --level 16
	{nDamage = 9500, nDamageRand = 0, nCostMana = 0}, --level 17
	{nDamage = 6666, nDamageRand = 0, nCostMana = 0}, --level 18
	{nDamage = 3333, nDamageRand = 0, nCostMana = 0}, --level 19
	{nDamage = 2000, nDamageRand = 0, nCostMana = 0}, --level 20
};
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(10013, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 10013, 1);      	-- 设置1号位Buff
