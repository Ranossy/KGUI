---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_刀掠苍山伤害.lua
-- 更新时间:	2017/5/5 11:20:12
...
tSkillData =
{
	{nDamageBase = 26000, nDamageRand = 1200, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.nAngleRange = 30 * 256 / 360;                          -- 攻击范围的扇形角度范围
