---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_毁天灭地吟唱.lua
-- 更新时间:	2017/5/5 11:07:12
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/npc/副本BOSS/剑胆琴心世界boss/月弄痕_毁天灭地吟唱.lua", -- 属性值1
		--0											-- 属性值2
	--);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if tType and tType == TARGET.PLAYER then
		--local player = GetPlayer(tID)
		--if not player then
			--return
		--end
	--end
	--npc.PlaySfx(8685, player.nX, player.nY, player.nZ)
