------------------------------------------------
-- 文件名    :  英雄空雾峰_1号BOSS_夕罗双_夕罗双的嘲弄.lua
-- 创建人    :  CBG	
-- 创建时间  :  2009-9-8
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(1398, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);-- 需求目标Buff
    
	    ----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1,1399,1);		-- 设置1号位Buff
