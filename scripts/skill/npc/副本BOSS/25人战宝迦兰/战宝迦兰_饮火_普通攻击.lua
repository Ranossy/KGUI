...
tSkillData =
{
	...
	{nDamageBase = 8500 * 0.8, nDamageRand = 8500 * 0.4, nCostMana = 0},		--level 30
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/25人战宝迦兰/战宝迦兰_饮火_普通攻击.lua",				-- 属性值1
   		0														-- 属性值2
   		);
...
function Apply(dwCharacterID)
         ...
         if player then
                   ...
                   local npc = scene.GetNpcByNickName("huo")                   
                   if npc then
