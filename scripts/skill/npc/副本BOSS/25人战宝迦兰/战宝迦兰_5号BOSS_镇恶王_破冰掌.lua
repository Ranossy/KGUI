...
-- 武功套路  :  无
-- 技能名称  :  破冰掌
-- 技能效果  :  随机一个非当前目标受到阴性内功DOT伤害，不可卸除，每2秒500血，并减低移动速度，持续8秒
...
function GetSkillLevelData(skill)
  ...
  -- 	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1,1617,1);		-- 设置1号位Buff 减速 
	skill.BindBuff(2,1618,2);		-- 设置2号位Buff DOT
