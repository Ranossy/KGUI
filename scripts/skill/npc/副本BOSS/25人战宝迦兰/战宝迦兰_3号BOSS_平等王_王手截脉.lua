...
-- 武功套路  :  无
-- 技能名称  :  王眼镇魂
-- 技能效果  :  为目标添加王手截脉DEBUFF，持续10秒分钟，不可叠加，不可驱散。
----------------目标受到治疗效果降低20%，受到阳性攻击伤害增加85%，免疫王眼镇魂效果。
----------------火里栽莲与王手截脉互相替代。
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 0  *0.8, nDamageRand = 0   *0.4, nCostMana = 0},		--level 31
};               
...
function GetSkillLevelData(skill)
  ...
  -- 	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1,1610,1);		-- 设置1号位Buff 
	skill.BindBuff(2, 1611, 1);		-- 设置2号位Buff
