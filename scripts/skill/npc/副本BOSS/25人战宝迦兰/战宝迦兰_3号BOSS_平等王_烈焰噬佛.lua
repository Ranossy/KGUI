...
tSkillData =
{
	...
	{nDamageBase = 1182 * 0.8, nDamageRand = 1182 * 0.4, nCostMana = 0},		--level 7
	...
	{nDamageBase = 2773 * 0.8, nDamageRand = 2773 * 0.4, nCostMana = 0},		--level 14
	{nDamageBase = 3500 * 0.8, nDamageRand = 3500 * 0.4, nCostMana = 0},		--level 15
	{nDamageBase = 3349 * 0.8, nDamageRand = 3349 * 0.4, nCostMana = 0},		--level 16
	{nDamageBase = 3425 * 0.8, nDamageRand = 3425 * 0.4, nCostMana = 0},		--level 17
	...
	{nDamageBase = 3880 * 0.8, nDamageRand = 3880 * 0.4, nCostMana = 0},		--level 23
	...
	{nDamageBase = 4335 * 0.8, nDamageRand = 4335 * 0.4, nCostMana = 0},		--level 29
	{nDamageBase = 3510 * 0.8, nDamageRand = 3510 * 0.4, nCostMana = 0},		--level 30
	{nDamageBase = 4486 * 0.8, nDamageRand = 4486 * 0.4, nCostMana = 0},		--level 31
};
