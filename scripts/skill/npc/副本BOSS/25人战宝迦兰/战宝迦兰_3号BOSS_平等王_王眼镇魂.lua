...
-- 武功套路  :  无
-- 技能名称  :  王眼镇魂
-- 技能效果  :  自身为圆心范围60尺范围内所有玩家进入沉睡状态，不能被任何技能卸除。
----------------不响应任何操作，持续10秒。附加1分钟debuff，王眼镇魂，受内功攻击伤害提高800%，不可卸除
...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/25人战宝迦兰/战宝迦兰_3号BOSS_平等王_王眼镇魂.lua",				-- 属性值1
   		0														-- 属性值2
   		);

    
	----------------- 技能施放Buff需求 ---------------------------------------------
    --skill.AddSlowCheckDestBuff(1270, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
    --skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1,1609,1);		-- 设置1号位Buff 眩晕
	--skill.BindBuff(2,1284,1);		-- 设置2号位Buff 内伤提高800%
