...
tSkillData =
{
	{nDamageBase = 4750 * 0.8, nDamageRand = 4750 * 0.4, nCostMana = 0},		--level 1
	...
	{nDamageBase = 5750 * 0.8, nDamageRand = 5750 * 0.4, nCostMana = 0},		--level 5
...
function GetSkillLevelData(skill)
    ...
    ----------------- 施放距离 -------------------------------------------------
	skill.nMinRadius		= 17 * LENGTH_BASE;		-- 技能施放的最小距离 
