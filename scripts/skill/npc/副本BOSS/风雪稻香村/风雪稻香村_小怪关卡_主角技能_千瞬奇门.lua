---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_千瞬奇门.lua
-- 更新时间:	2014/1/7 9:39:05
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7313, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 698);	--技能普通CD
	...
	--skill.nChannelInterval = 0.5 * GLOBAL.GAME_FPS; 				-- 通道技间隔时间
	--skill.nMinChannelInterval	= -1; 				-- 急速效果最小通道技间隔时间：默认是-1，通道不受急速影响。大于等于0则受急速影响，最通道间隔时间为填的值
	--skill.nChannelFrame = 5 * GLOBAL.GAME_FPS;	 			-- 通道技持续时间，单位帧数
