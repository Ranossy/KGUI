---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_丢扇子_子技能_盲区.lua
-- 更新时间:	2014/2/10 10:56:22
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_丢扇子_子技能_盲区.lua", --属性值1
		0															--属性值2
	);	
	
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(7418, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
...
function Apply(dwCharacterID)
	...
	playerthis.AddBuff(0, 99, 7412, 1)		--跳舞成功
	if playerthis.GetBuff(7413, 1) then	--致死	
		playerthis.DelBuff(7413, 1)
	end
	local buffthis = playerthis.GetBuff(7412, 1)
	if buffthis then
		if buffthis.nStackNum >= 5 then
			playerthis.DelGroupBuff(7412, 1)
			playerthis.AddBuff(0, 99, 7419, 1)
			playerthis.AddBuff(0, 99, 7414, 1)
		end
	end
end
