---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_专注打击.lua
-- 更新时间:	2014/2/9 17:13:12
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 71100, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 173000, nDamageRand = 0, nCostMana = 0}, --level 2
