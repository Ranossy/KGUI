---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_十二生肖_酉鸡.lua
-- 更新时间:	2014/4/19 22:06:48
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 31300, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_十二生肖_酉鸡.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 7407, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSrcID)
	...
	if playerthis.GetOTActionState() == CHARACTER_ACTION_TYPE.ACTION_SKILL_PREPARE or playerthis.GetOTActionState() == CHARACTER_ACTION_TYPE.ACTION_SKILL_CHANNEL then
		playerthis.BreakOTSkill()
		playerthis.AddBuff(0, 99, 7407, 1)
	end
end
