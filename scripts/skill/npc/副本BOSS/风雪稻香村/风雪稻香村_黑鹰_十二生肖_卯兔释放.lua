---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_十二生肖_卯兔释放.lua
-- 更新时间:	2014/1/24 10:06:42
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_十二生肖_卯兔释放.lua", --属性值1
		0															--属性值2
	);	
		...
		if #tplayer_select ~= 0 then
			...
			if player_select then
				if scene.dwMapID == 177 then
					scene.CreateNpc(27638, player_select.nX, player_select.nY, player_select.nZ, 0, 10 * GLOBAL.GAME_FPS)
					table.remove(tplayer_select, nRandom)
				else
					scene.CreateNpc(36352, player_select.nX, player_select.nY, player_select.nZ, 0, 10 * GLOBAL.GAME_FPS)
					table.remove(tplayer_select, nRandom)
				end
			end
		else
