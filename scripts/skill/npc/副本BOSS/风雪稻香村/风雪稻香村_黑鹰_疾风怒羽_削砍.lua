---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_疾风怒羽_削砍.lua
-- 更新时间:	2014/1/17 11:15:14
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 27800, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_疾风怒羽_削砍.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7367, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.nHeight = 8 * 20 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	...
	skill.nChannelInterval	= 1 * GLOBAL.GAME_FPS; 				-- 通道技间隔时间
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	playertarget.PlaySfx(329, playertarget.nX, playertarget.nY, playertarget.nZ + 512)
	playertarget.Jump(1, 0)
end
