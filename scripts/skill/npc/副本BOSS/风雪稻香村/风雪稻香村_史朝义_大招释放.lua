---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_大招释放.lua
-- 更新时间:	2014/2/9 17:34:22
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 350000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 396400, nDamageRand = 0, nCostMana = 0}, --level 2
