---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_炸药桶_爆炸引爆.lua
-- 更新时间:	2014/3/5 10:38:32
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_炸药桶_爆炸引爆.lua",
		0
	);	
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(npcthis.dwTemplateID)
	if npcthis.dwTemplateID == 27670 then		--地刺
		if npcthis.dwForceID == 27 then
			npcthis.CastSkill(8863, 1)
			npcthis.PlaySfx(683, npcthis.nX, npcthis.nY, npcthis.nZ)
			npcthis.SetDisappearFrames(1, false)
		end
	end
	if npcthis.dwTemplateID == 36359 then		--25地刺
		if npcthis.dwForceID == 27 then
			npcthis.CastSkill(8863, 2)
			npcthis.PlaySfx(683, npcthis.nX, npcthis.nY, npcthis.nZ)
			npcthis.SetDisappearFrames(1, false)
		end
	end
	if npcthis.dwTemplateID == 27667 then		--焦油
		if npcthis.dwForceID == 27 then
			npcthis.CastSkill(8864, 1)
			npcthis.PlaySfx(683, npcthis.nX, npcthis.nY, npcthis.nZ)
			npcthis.SetDisappearFrames(1, false)
		end
	end
	if npcthis.dwTemplateID == 36357 then		--25焦油
		if npcthis.dwForceID == 27 then
			npcthis.CastSkill(8864, 2)
			npcthis.PlaySfx(683, npcthis.nX, npcthis.nY, npcthis.nZ)
			npcthis.SetDisappearFrames(1, false)
		end
	end
