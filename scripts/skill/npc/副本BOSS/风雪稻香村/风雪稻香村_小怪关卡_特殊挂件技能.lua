---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_特殊挂件技能.lua
-- 更新时间:	2014/4/9 18:11:50
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"Map/风雪稻香村/skill/觅影瓶表现.lua", --属性值1
		0															--属性值2
	);
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_特殊挂件技能.lua", --属性值1
		0															--属性值2
	);
	...
	skill.SetNormalCoolDown(1, 724);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npcthis.dwTemplateID == 26019 or npcthis.dwTemplateID == 36279 or npcthis.dwTemplateID == 36935 then
		if npcthis.GetBuff(7301, 1) then
			npcthis.DelBuff(7301, 1)
			npcthis.PlaySfx(47, npcthis.nX, npcthis.nY, npcthis.nZ)
			npcthis.AddBuff(0, 99, 7311, 1)
		end
	end
end
