---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_霞月长针.lua
-- 更新时间:	2014/1/7 11:10:03
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 385000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_霞月长针.lua",								--属性值1
		0															--属性值2
	);	
	...
	skill.SetNormalCoolDown(1, 701);	--技能普通CD
...
function Apply(dwCharacterID, dwSrcID)
	...
	if not playertarget or not playercaster then
		return
	end
	local kungfu = playercaster.GetKungfuMount()
	if kungfu then
		if kungfu.dwSkillID == 10028 or kungfu.dwSkillID == 10021 then
			playertarget.AddBuff(0, 99, 7347, 1)
		end
	end
end
