---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_寒冰真枪.lua
-- 更新时间:	2014/3/21 9:36:21
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_寒冰真枪.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 7323, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 702);	--技能普通CD
	...
	skill.nMaxRadius = 16 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local playercaster = GetPlayer(dwSkillSrcID)
	if not playercaster then
		return
	end
	if npctarget.dwTemplateID == 26019 or npctarget.dwTemplateID == 26121 then
		npctarget.AddBuff(playercaster.dwID, playercaster.nLevel, 7323, 1)
	end
end
