---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_老无名_玄劲溃散_BUFF添加.lua
-- 更新时间:	2014/3/4 10:03:45
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7566, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSrcID)
	...
	if scene.dwMapID == 177 then
		npcthis.CastSkill(8079, 1)
	else
		npcthis.CastSkill(8079, 2)
	end
	npcthis.PlaySfx(360, npcthis.nX, npcthis.nY, npcthis.nZ)
end
