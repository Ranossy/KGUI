---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_地字一号_普通攻击_内功.lua
-- 更新时间:	2013/12/10 15:46:48
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 44000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 58200, nDamageRand = 0, nCostMana = 0}, --level 2
