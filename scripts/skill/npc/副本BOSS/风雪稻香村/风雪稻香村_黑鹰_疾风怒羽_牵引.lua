---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_疾风怒羽_牵引.lua
-- 更新时间:	2014/1/17 10:31:00
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 6400 * 0.8, nDamageRand = 6400 * 0.4, nBuffLevel = 1}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7364, 1);		-- 设置1号位Buff
	...
	skill.nChannelFrame		= 8 * GLOBAL.GAME_FPS;	 			-- 通道技持续时间，单位帧数 
