---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_黑鹰_雪舞惧散.lua
-- 更新时间:	2014/1/20 10:51:31
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(7374, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7371, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	playerthis.Stop()
	local x = playerthis.nX + math.cos((nRandom + playerthis.nFaceDirection) * math.pi * 2 / 256) * 256
	local y = playerthis.nY + math.sin((nRandom + playerthis.nFaceDirection) * math.pi * 2 / 256) * 256
	playerthis.TurnTo(nRandom + playerthis.nFaceDirection)
	playerthis.RunTo(x, y)
end
