---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_地字一号_夜雪扩散.lua
-- 更新时间:	2014/2/18 10:22:09
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_地字一号_夜雪扩散.lua", --属性值1
		0															--属性值2
	);	
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if playerthis.GetBuff(7295, 1) or playerthis.GetBuff(7296, 1) or playerthis.GetBuff(7295, 2) or playerthis.GetBuff(7296, 2) then
		if scene.dwMapID == 177 then
			playerthis.CustomDamage(npccaster.dwID, 8663, 2, 0, 46700*0.14)
		else
			playerthis.CustomDamage(npccaster.dwID, 8663, 2, 0, 73500*0.14)
		end
		return
	end
	if scene.dwMapID == 177 then
