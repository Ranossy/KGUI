---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_玩家实体攻击_阳.lua
-- 更新时间:	2014/3/11 20:31:22
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	...
	{nDamageBase = 130000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 160000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 190000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 220000, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 250000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 280000, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 310000, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 340000, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 370000, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(7418, 1, BUFF_COMPARE_FLAG.LESS, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	--skill.SetNormalCoolDown(1, 707);	--技能普通CD
