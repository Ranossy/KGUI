---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_剑罡祛邪.lua
-- 更新时间:	2014/7/16 17:12:40
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_剑罡祛邪.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 743);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if playerthis.GetBuff(7295, 1) then
		playerthis.DelBuff(7295, 1)
	end
	if playerthis.GetBuff(7295, 2) then
		playerthis.DelBuff(7295, 2)
	end
	if playerthis.GetBuff(7296, 1) then
		playerthis.DelBuff(7296, 1)
	end
	if playerthis.GetBuff(7296, 2) then
		playerthis.DelBuff(7296, 2)
	end
end
