---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_卧龙盘山.lua
-- 更新时间:	2014/1/7 9:44:45
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_主角技能_卧龙盘山.lua",								--属性值1
		0															--属性值2
	);	
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7316, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 700);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not playerthis.GetBuff(7314, 1) then
		playerthis.AddBuff(playerthis.dwID, playerthis.nLevel, 7314, 1)
	end
end
