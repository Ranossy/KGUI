---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_重弩脱离.lua
-- 更新时间:	2014/7/15 20:41:23
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_重弩脱离.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if playerthis.GetBuff(8068, 1) then
		playerthis.DelBuff(8068, 1)
	end
end
