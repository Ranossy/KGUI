---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_主角技能_安置炸药桶.lua
-- 更新时间:	2014/3/5 10:38:22
-- 更新用户:	wangpengfei1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_史朝义_主角技能_安置炸药桶.lua",
		0
	);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(7695, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene.dwMapID == 177 then
		playerthis.CastSkillXYZ(8763, 1, nx, ny, nz)
	else
		playerthis.CastSkillXYZ(8763, 2, nx, ny, nz)
	end
	playerthis.CastSkillXYZ(8860, 1, nx, ny, nz)
	playerthis.DelBuff(7695, 1)
end
