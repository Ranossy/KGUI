---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_迷烟.lua
-- 更新时间:	2014/6/26 11:45:10
-- 更新用户:	wangpengfei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 16700, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/npc/副本BOSS/风雪稻香村/风雪稻香村_小怪关卡_迷烟.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	if npctarget.dwTemplateID == 26119 or npctarget.dwTemplateID == 26024 or npctarget.dwTemplateID == 26126 or npctarget.dwTemplateID == 26169
		or npctarget.dwTemplateID == 36328 or npctarget.dwTemplateID == 36306 or npctarget.dwTemplateID == 36284 or npctarget.dwTemplateID == 36299 then
		return 
	end
	npctarget.AddBuff(0, 99, 7944, 1)
end
