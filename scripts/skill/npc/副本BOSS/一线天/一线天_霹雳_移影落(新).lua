---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/一线天/一线天_霹雳_移影落(新).lua
-- 更新时间:	2013/3/25 10:32:45
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 23500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 12900, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5474, dwSkillLevel);		-- 设置1号位Buff
