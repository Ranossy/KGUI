---------------------------------------------------------------------->
-- 脚本名称:	E:/大明宫/client/scripts/skill/npc/副本BOSS/一线天/一线天_普通虎盾死士_攻击.lua
-- 更新时间:	2013/1/30 10:38:44
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 6900, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 2700, nDamageRand = 0, nCostMana = 0}, --level 2
