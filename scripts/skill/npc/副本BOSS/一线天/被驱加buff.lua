---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/npc/副本BOSS/一线天/被驱加buff.lua
-- 更新时间:	2013/3/21 9:35:48
-- 更新用户:	mengxiangfei
-- 脚本说明:	
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame)
	--print("1111")
	local tNPC = GetNpc(nCharacterID)
	...
	if tNPC then
		if nLeftFrame == 0 then
			...
			if scene.dwMapID == 157 then
				tNPC.AddBuff(0, 99, 5307, 1, 600)
			elseif scene.dwMapID == 167 then
				tNPC.AddBuff(0, 99, 5307, 2, 600)
			end
		end
	end
end
