...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/小橙武BOSS/小橙武BOSS_少林_大狮子吼.lua",				
   		0														
   		);
...
function Apply(dwCharacterID)
	...
	local npc = scene.GetNpcByNickName("ShaoLinShiLian")
	if player.GetBuff(388, 0) or player.GetBuff(389, 0) or player.GetBuff(390, 0) or player.GetBuff(2792, 0) or player.GetBuff(2793, 0) or player.GetBuff(2794, 0) or player.GetBuff(2795, 0) or player.GetBuff(2796, 0) or player.GetBuff(2797, 0) then
		npc.AddBuff(0, 99, 4366, 1)
	end
	if player.GetBuff(396, 0) or player.GetBuff(397, 0) or player.GetBuff(398, 0) then
		player.nCurrentLife = player.nCurrentLife + 30000
		if npc.nCurrentLife <= 50000 then
			npc.Die()
		else
			npc.nCurrentLife = npc.nCurrentLife - 50000
		end
	else
		player.AddBuff(0, 99, 572, 3)
	end
end
