...
tSkillData =
{
		{nPHYSICSDamage= 6000    * 0.95,nPHYSICSDamageRand= 6000    * 0.1,nCostMana= 157},
};
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
        ...
        0
     	...
     	skill.AddAttribute(
   		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			--判Z坐标	
   		ATTRIBUTE_TYPE.CALL_BUFF,								
   		5033,				
   		1														
   		);  
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 4624, 1);		-- 设置1号位Buff
