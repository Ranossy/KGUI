...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
   	...
   	skill.AddAttribute(
   		...
   		"skill/npc/副本BOSS/小橙武BOSS/小橙武BOSS_天策_穿云4尺.lua",				
   		0														
   		);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 4374, 1);		-- 设置1号位Buff
...
local character = nil
	...
	if character then
		character.AddBuff(0, 99, 4374, 1)
	end
	local buff = character.GetBuff(4374, 1)
	if buff and buff.nStackNum == 3 then
		character.AddBuff(0,99,4374,2)
	end
end
