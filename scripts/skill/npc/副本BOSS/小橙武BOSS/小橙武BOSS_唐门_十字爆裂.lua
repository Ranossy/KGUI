...
tSkillData =
{
	{nDamageBase = 4000 * 0.8, nDamageRand =4000 * 0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(4371, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 4371, 1);		-- 设置1号位Buff
	...
	skill.nRectWidth = 0.5 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadius
