...
tSkillData =
{
	{nDamageBase = 6000*0.8, nDamageRand = 6000*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 7900*0.8, nDamageRand = 7900*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 2366, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
    ...
    skill.nTargetCountLimit	= 7;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制) 
