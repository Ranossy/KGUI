...
tSkillData =
{
	{nDamageBase = 3087*0.8, nDamageRand = 3087*0.4, nBuffLevel=1, nCostMana = 0},		--level 1
	{nDamageBase = 4117*0.8, nDamageRand = 4117*0.4, nBuffLevel=2, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
        ...
        "skill/npc/副本BOSS/毒神殿/毒神殿_鲍穆侠_庚毒·筋固.lua", 			
        0
    );
	...
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 2348, tSkillData[dwSkillLevel].nBuffLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	if not IsPlayer(dwCharacterID) then
         ...
         if player then
					...
					scene.SetCustomBoolean(SCENE_CUSTOM_VALUE_NAME.DUSHENDIAN.BuZhong_JinGu, true)
         			--<<
         end
end
