...
tSkillData =
{
	...
	{nDamageBase = 12500*0.8, nDamageRand = 12500*0.4, nCostMana = 0},		--level 2
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(
        ...
        "skill/npc/副本BOSS/毒神殿/毒神殿_鲍穆侠_乙毒·蜘蛛.lua", 			
        0
    );
...
function Apply(dwCharacterID)
		if not IsPlayer(dwCharacterID) then
         ...
         if player then
					...
					scene.SetCustomBoolean(SCENE_CUSTOM_VALUE_NAME.DUSHENDIAN.BuZhong_ZhiZhu, true)
         			--<<
         end
end
