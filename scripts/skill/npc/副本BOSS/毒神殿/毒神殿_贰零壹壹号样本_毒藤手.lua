...
tSkillData =
{
	{nDamageBase = 11400*0.8, nDamageRand = 11400*0.4, nCostMana = 0},		--level 1
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(
        ...
        "skill/npc/副本BOSS/毒神殿/毒神殿_贰零壹壹号样本_毒藤手.lua", 			
        0
    );
...
function Apply(dwCharacterID)
		if not IsPlayer(dwCharacterID) then
         ...
         if player then
					...
					scene.SetCustomBoolean(SCENE_CUSTOM_VALUE_NAME.DUSHENDIAN.BuZhong_DuTengShou, true)
         			--<<
         end
end
