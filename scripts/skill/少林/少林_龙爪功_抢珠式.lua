...
tSkillData =
{
	{ nDamage = 0, nDamageRand = 0, nCostMana = 40},		-- Level 1
	{ nDamage = 0, nDamageRand = 0, nCostMana = 54},		-- Level 2
	{ nDamage = 0, nDamageRand = 0, nCostMana = 68},		-- Level 3
	{ nDamage = 0, nDamageRand = 0, nCostMana = 81},	-- Level 4
...
--	);
    ...
    skill.BindBuff(1, 445, dwSkillLevel);
    ----------------- 设置CoolDown ---------------------------------------------------------------------
    --SetPublicCoolDown(id)设置公共CD，SetNormalCoolDown(posi, id)设置技能CD，其中posi为CoolDown位(共3位)，id需要查CoolDownList.tab
	--skill.SetPublicCoolDown(16);		--公共CD1秒
	skill.SetNormalCoolDown(1, 75);
