---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_袈裟伏魔功_亦枯亦荣.lua
-- 更新时间:	2015/9/16 20:39:37
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetSubsectionSkill(1, 1, 226, dwSkillLevel);
	skill.SetSubsectionSkill(2, 2, 227, dwSkillLevel);
	skill.SetSubsectionSkill(3, 10, 253, dwSkillLevel);
