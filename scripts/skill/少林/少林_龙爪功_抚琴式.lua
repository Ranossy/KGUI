...
-- 武功套路  :  龙爪功
-- 技能名称  :  抚琴式
-- 技能效果  :  对单体目标造成阳性内功伤害，并使其减速50%，持续12秒
--                   
------------------------------------------------
...
tSkillData =
{
	{ nDamage = 0, nDamageRand = 0, nCostMana = 29 },		-- Level 1
	{ nDamage = 0, nDamageRand = 0, nCostMana = 53 },		-- Level 2
	{ nDamage = 0, nDamageRand = 0, nCostMana = 73 },		-- Level 3
	{ nDamage = 0, nDamageRand = 0, nCostMana = 94 },	-- Level 4
	{ nDamage = 0, nDamageRand = 0, nCostMana = 114},		-- Level 1
