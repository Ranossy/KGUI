...
tSkillData =
{
	{ nCostMana = 40 },		--level 1
	{ nCostMana = 65 },		--level 2
	{ nCostMana = 85 },		--level 3
	{ nCostMana = 106},		--level 4
	{ nCostMana = 126},		--level 5
...
function GetSkillLevelData(skill)
    ...
    skill.SetSubsectionSkill(1, 1, 214, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 215, dwSkillLevel);
    skill.SetSubsectionSkill(3, 10, 216, dwSkillLevel);
