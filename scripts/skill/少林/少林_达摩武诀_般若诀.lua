...
tSkillData =
{
	{ nCostMana = 13 },		--level 1
	{ nCostMana = 81 },		--level 2
	{ nCostMana = 130},		--level 3
	{ nCostMana = 171},		--level 4
	{ nCostMana = 212},		--level 5
	{ nCostMana = 253},		--level 6
	{ nCostMana = 304},		--level 7
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 382, dwSkillLevel)			-- 设置Buff
    ...
    skill.nCostManaBasePercent = 1006;	-- 技能消耗的内力
...
function OnSkillLevelUp(skill, player)
	if skill.dwLevel == skill.dwMaxLevel then
		player.AcquireAchievement(3829)
	end
end
