---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_袈裟伏魔功_袖衲乾坤.lua
-- 更新时间:	2013/4/25 17:29:46
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{ nCostMana = 73 }, --level 2
	{ nCostMana = 94 }, --level 3
	{ nCostMana = 114}, --level 4
	{ nCostMana = 135}, --level 5
...
function GetSkillLevelData(skill)
	...
	skill.SetSubsectionSkill(1, 1, 217, 5);
	skill.SetSubsectionSkill(2, 2, 218, 5);
	skill.SetSubsectionSkill(3, 10, 219, 5);
