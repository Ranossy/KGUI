...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2686, 1);			-- 设置Buff
	skill.BindBuff(2, 3718, 1);		-- 免疫减速
   ...
   -- skill.nCostMana      	= tSkillData[dwSkillLevel].nCostMana;					-- 技能消耗的内力
    ...
    skill.nCostManaBasePercent = 4;	-- 技能消耗的内力
    ----------------- 聚气相关 -------------------------------------------------
...
function UnApply(dwCharacterID)
	...
	if playerA.GetBuff(3718,1) then
		playerA.DelBuff(3718,1)
	end
end
