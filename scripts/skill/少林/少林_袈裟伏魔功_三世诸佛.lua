...
tSkillData =
{
	{nDamage = 386 * 0.95, nDamageRand = 386 * 0.1, nCostMana = 191, nFrame = 96},		--level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(566, 1,	BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL); 
	----------------- BUFF相关 -------------------------------------------------
