...
tSkillData =
{
	{ nDamage = 680 * 0.95,  nDamageRand = 680  * 0.1, nCostMana = 618},		-- Level 1  
};
...
function GetSkillLevelData(skill)
	...
	skill.SetSubsectionSkill(1, 1, 2870, dwSkillLevel);   	-- 1点气
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2707, 1);			-- 设置Buff
    ...
    skill.nCostManaBasePercent = 62;	-- 技能消耗的内力
    ----------------- 聚气相关 -------------------------------------------------
