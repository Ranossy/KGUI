...
tSkillData =
{
	{nDamage = 43 * 0.95, nDamageRand = 43 * 0.1, nCostMana = 0, nFrame = 32},		--level 1
	{nDamage = 53 * 0.95, nDamageRand = 53 * 0.1, nCostMana = 0, nFrame = 32},		--level 2
	{nDamage = 62 * 0.95, nDamageRand = 62 * 0.1, nCostMana = 0, nFrame = 32},		--level 3
	{nDamage = 72 * 0.95, nDamageRand = 72 * 0.1, nCostMana = 0, nFrame = 32},		--level 4
	{nDamage = 79 * 0.95, nDamageRand = 79 * 0.1, nCostMana = 0, nFrame = 32},		--level 5
