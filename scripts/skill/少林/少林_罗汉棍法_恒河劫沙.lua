---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_罗汉棍法_恒河劫沙.lua
-- 更新时间:	2013/4/25 17:28:20
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
-- 武功套路  :  龙爪功
-- 技能名称  :  抱残式
-- 技能效果  :  对单体目标造成阳性内功伤害附加武器伤害，并使其治疗效果降低，持续8秒
--                   
------------------------------------------------
...
tSkillData = 
{
	{ nDamage = 120, nDamageRand = 20, nCostMana = 54}, -- Level 1
	{ nDamage = 120, nDamageRand = 20, nCostMana = 40}, -- Level 2
	{ nDamage = 120, nDamageRand = 20, nCostMana = 45}, -- Level 3
	{ nDamage = 120, nDamageRand = 20, nCostMana = 50}, -- Level 4
	{ nDamage = 120, nDamageRand = 20, nCostMana = 54}, -- Level 1
...
--增加100%武器伤害 
	...
	skill.BindBuff(1, 576, 1);
	----------------- 设置CoolDown ---------------------------------------------------------------------
	--SetPublicCoolDown(id)设置公共CD，SetNormalCoolDown(posi, id)设置技能CD，其中posi为CoolDown位(共3位)，id需要查CoolDownList.tab
	skill.SetPublicCoolDown(16);		--公共CD1秒
	skill.SetNormalCoolDown(1, 71);
	skill.SetCheckCoolDown(1, 444);
	----------------- 设置技能消耗 ---------------------------------------------------------------------
	--skill.nCostMana	= tSkillData[dwSkillLevel].nCostMana;
	skill.nCostManaBasePercent = 201;	-- 技能消耗的内力
	----------------- 时间相关 -------------------------------------------------
