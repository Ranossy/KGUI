---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/90级奇穴/反弹眩晕易筋.lua
-- 更新时间:	2013/5/11 16:52:29
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(5877, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	skill.BindBuff(2, 5877, 1);		-- 设置2号位Buff
