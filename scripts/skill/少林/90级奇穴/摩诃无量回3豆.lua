---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/90级奇穴/摩诃无量回3豆.lua
-- 更新时间:	2016/5/12 22:20:26
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/少林/90级奇穴/摩诃无量回3豆.lua", -- 连协技
		0
	);

	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --为影响自己不回滚的魔法属性
		ATTRIBUTE_TYPE.MODIFY_COOL_DOWN, --蓄力的类型
		67,
 		-160                                                   	--暂时还没有意义
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	-----------------技能施放技能需求-------------------------------------------
	skill.AddCheckSelfLearntSkill(6587, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(1, "scripts/skill/少林/90级奇穴/摩诃无量回3豆.lua", 0, 0)
end
