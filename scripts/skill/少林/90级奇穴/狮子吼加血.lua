---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/90级奇穴/狮子吼加血.lua
-- 更新时间:	2017/4/25 14:21:14
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 6214, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	---判定学习了[禅语]奇穴，因为和大附魔共用了1个脚本
	if not player.GetBuff(7913, 1) then
			player.AddBuff(player.dwID, player.nLevel, 6214, 1)
		end
	end
