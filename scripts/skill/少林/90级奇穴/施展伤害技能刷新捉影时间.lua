---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/90级奇穴/施展伤害技能刷新捉影时间.lua
-- 更新时间:	2015/9/17 1:39:12
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/少林/90级奇穴/施展伤害技能刷新捉影时间.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nbuff = player.GetBuff(9812, 1)
	if nbuff then
		player.SetBuffLeftActiveCount(nbuff.nIndex, 4)
	end
end
