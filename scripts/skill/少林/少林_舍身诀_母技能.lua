---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_舍身诀_母技能.lua
-- 更新时间:	2016/5/11 15:23:58
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 444, dwSkillLevel);		-- 设置Debuff
	--skill.BindBuff(3, nBuffID, nBuffLevel);				-- 设置Dot
	--skill.BindBuff(4, nBuffID, nBuffLevel);				-- 设置Hot
	--skill.BindBuff(2,994,2);		-- 设置2号位Buff(击倒计时2秒BUFF)
	----------------- 设置Cool down --------------------------------------------
	...
	skill.nCostManaBasePercent = 93;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if IsPlayer(dwCharacterID) == false then
		if IsEnemy(dwSkillSrcID, dwCharacterID) == false then
			player.CastSkill(1893, 1)
		end
	end

	ModityCDToUI(player, 258, 0, 0)
end
