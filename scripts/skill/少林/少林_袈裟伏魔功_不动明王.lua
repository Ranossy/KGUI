...
function GetSkillLevelData(skill)
    ...
    skill.SetSubsectionSkill(1, 1, 205, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 206, dwSkillLevel);
    skill.SetSubsectionSkill(3, 10, 207, dwSkillLevel);
