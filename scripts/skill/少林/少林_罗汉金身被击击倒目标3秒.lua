---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_罗汉金身被击击倒目标3秒.lua
-- 更新时间:	2015/11/6 11:07:28
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.CALL_KNOCKED_DOWN, -- 魔法属性
		48, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		...
		"skill/少林/少林_罗汉金身被击击倒目标3秒.lua", -- 属性值1
		0											-- 属性值2
	);
	--判定是否成功击倒，成功击倒添加内置CD
	skill.AddAttribute(
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10109, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--[[
	if not player.GetBuff(10242, 1) then
		--player.nCurrentMana = player.nCurrentMana + player.nMaxMana * 0.1
		player.AddBuff(player.dwID, player.nLevel, 10242, 1)
	end
	--]]
end
