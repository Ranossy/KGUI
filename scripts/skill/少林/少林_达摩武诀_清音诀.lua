---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_达摩武诀_清音诀.lua
-- 更新时间:	2013/4/22 21:24:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 19}, --level 1
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 49}, --level 1
