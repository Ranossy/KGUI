...
tSkillData =
{
	{nDamage = 86  * 0.95, nDamageRand = 86  * 0.1, nCostMana = 0, nFrame = 48},		--level 1
	{nDamage = 106 * 0.95, nDamageRand = 106 * 0.1, nCostMana = 0, nFrame = 48},		--level 2
	{nDamage = 125 * 0.95, nDamageRand = 125 * 0.1, nCostMana = 0, nFrame = 48},		--level 3
	{nDamage = 144 * 0.95, nDamageRand = 144 * 0.1, nCostMana = 0, nFrame = 48},		--level 4
	{nDamage = 159 * 0.95, nDamageRand = 159 * 0.1, nCostMana = 0, nFrame = 48},		--level 5
