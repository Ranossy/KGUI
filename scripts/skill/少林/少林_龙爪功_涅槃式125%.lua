...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckSelfBuff(3880, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	----------------- BUFF相关 -------------------------------------------------
	...
	if dwSkillLevel <= 9 then
		skill.nChannelInterval = (160 + (dwSkillLevel-1) * 5)*1.15;	 			-- 通道技持续时间，单位帧数
	else
		skill.nChannelInterval = 200 * 1.2*1.15;
	end
