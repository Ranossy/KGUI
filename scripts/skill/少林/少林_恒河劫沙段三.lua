...
tSkillData =
{
	{nDamage = 130 * 0.95, nDamageRand = 130 * 0.1, nCostMana = 191, nFrame = 64},		--level 1
	{nDamage = 159 * 0.95, nDamageRand = 159 * 0.1, nCostMana = 240, nFrame = 64},		--level 2
	{nDamage = 188 * 0.95, nDamageRand = 188 * 0.1, nCostMana = 287, nFrame = 64},		--level 3
	{nDamage = 217 * 0.95, nDamageRand = 217 * 0.1, nCostMana = 336, nFrame = 64},		--level 4
	{nDamage = 239 * 0.95, nDamageRand = 239 * 0.1, nCostMana = 383, nFrame = 64},		--level 5
