---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_袈裟伏魔功_灵山施雨.lua
-- 更新时间:	2013/5/11 17:02:41
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{ nCostMana = 73 }, --level 1
	{ nCostMana = 94 }, --level 2
	{ nCostMana = 114}, --level 3
	{ nCostMana = 135}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.SetSubsectionSkill(1, 1, 223, 4);
	skill.SetSubsectionSkill(2, 2, 224, 4);
	skill.SetSubsectionSkill(3, 10, 225, 4);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(9278) == 1 then
		player.AddBuff(player.dwID,player.nLevel,405,6)
	else
		player.AddBuff(player.dwID,player.nLevel,405,4)
	end

	
	if player.GetSkillLevel(5909) == 1 then
		for i = 1, 5 do
			--player.AddBuff(dwCharacterID, player.nLevel, 5875, 1, 10)
		end
	end
end
