---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_罗汉棍法_行龙不雨.lua
-- 更新时间:	2013/6/1 4:39:38
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
--	);
	...
	skill.AddAttribute(
		...
		"skill/少林/少林_罗汉棍法_行龙不雨.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.nCostManaBasePercent = 696;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
