---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/罗汉金身给自身回血.lua
-- 更新时间:	2014/10/21 16:01:40
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(8414,1) then
		player.nCurrentLife = player.nCurrentLife + player.nMaxLife * 0.05
		player.AddBuff(player.dwID, player.nLevel, 8414, 1)
	end
end
