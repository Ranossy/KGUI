---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/少林_龙爪功_捉影式.lua
-- 更新时间:	2014/10/21 22:29:08
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
--加一点反击值
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 3473, 1);			-- 设置Buff
	skill.BindBuff(2, 3652, 1);		-- 设置Debuff
	skill.BindBuff(3, 6413, 1);		-- 设置Debuff
...
--   skill.SetPublicCoolDown(16);
	...
	skill.nCostManaBasePercent = 139;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if cPlayer.nMoveState == 18 then
		if cPlayer.GetBuff(6413, 1) == nil then
			...
			cPlayer.AddBuff(dwSkillSrcID, target.nLevel, 562, 14)		--点了奇穴的5秒
		end
	end
	--[[
	--奇穴缘断双捉影
