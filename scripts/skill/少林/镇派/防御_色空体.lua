---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/少林/镇派/防御_色空体.lua
-- 更新时间:	2013/6/1 2:43:26
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.PHYSICS_REFLECTION_PERCENT, -- 外功反弹百分比 
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.LUNAR_MAGIC_REFLECTION_PERCENT, -- 三种属性内功反弹百分比
		tSkillData[dwSkillLevel].nValue1,
		0
	); 
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.POISON_MAGIC_REFLECTION_PERCENT, --  毒反弹百分比
		tSkillData[dwSkillLevel].nValue1,
		0
	); 
