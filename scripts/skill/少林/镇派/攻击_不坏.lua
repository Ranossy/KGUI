...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 	--15%被击回豆
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 	--30%被击回豆
		ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER,
		655,															
		1
	);
   	...
   	skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,	--罗汉金身-CD
			ATTRIBUTE_TYPE.SET_TALENT_RECIPE,
			966, 
			dwSkillLevel
			);
