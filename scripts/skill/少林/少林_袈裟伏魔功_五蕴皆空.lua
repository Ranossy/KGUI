...
tSkillData =
{
	{ nCostMana = 49},		--level 1
	{ nCostMana = 62},		--level 2
	{ nCostMana = 76},		--level 3
	{ nCostMana = 90},		--level 4
};
...
skill.nCostManaBasePercent = 46;--技能消耗的内力
    ...
    skill.SetSubsectionSkill(1, 1, 220, dwSkillLevel);
    skill.SetSubsectionSkill(2, 2, 221, dwSkillLevel);
    skill.SetSubsectionSkill(3, 10, 222, dwSkillLevel);
