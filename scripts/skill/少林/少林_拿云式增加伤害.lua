...
tSkillData =
{
	{nDamage = 26 * 0.95, nDamageRand = 26 * 0.1, nCostMana = 191, nFrame = 32},		--level 1
	{nDamage = 30 * 0.95, nDamageRand = 30 * 0.1, nCostMana = 240, nFrame = 32},		--level 2
	{nDamage = 37 * 0.95, nDamageRand = 37 * 0.1, nCostMana = 287, nFrame = 32},		--level 3
	{nDamage = 43 * 0.95, nDamageRand = 43 * 0.1, nCostMana = 336, nFrame = 32},		--level 4
	{nDamage = 50 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 383, nFrame = 32},		--level 5
	{nDamage = 59 * 0.95, nDamageRand = 59 * 0.1, nCostMana = 383, nFrame = 32},		--level 5
};
...
function GetSkillLevelData(skill)
  ...
  skill.nChannelInterval		=77;			-- 通道技持续时间，单位帧数 
