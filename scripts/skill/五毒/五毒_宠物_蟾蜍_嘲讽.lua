...
tSkillData =
{
	{nDamageBase = 508 * 0.95, nDamageRand = 508 * 0.1, nThreat = 500},		--level 1           
};           
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 2503, 1);			-- 设置Buff
  ...
  skill.nChannelFrame		= tSkillData[dwSkillLevel].nFrame;			-- 通道技持续时间，单位帧数 
