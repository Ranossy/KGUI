...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(2315, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 女娲补天才能用
    --skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2851, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 2852, 1);		-- 设置2号位Buff
    ...
    skill.nCostManaBasePercent = 105;	-- 技能消耗的内力
    ----------------- 聚气相关 -------------------------------------------------
