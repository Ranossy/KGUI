...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 295*0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 295 * 0.4;
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 295 * 0.6;
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 295 * 0.8;
	else
		skill.nCostManaBasePercent = 295;
	end
	----------------- 聚气相关 -------------------------------------------------
	...
	skill.nChannelInterval = 45*1.15*1.5+28*0.55; 				-- 通道技间隔时间 
