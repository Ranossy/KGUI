...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
    	...
    	----------------- 魔法属性 -------------------------------------------------
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(2853, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 女娲补天不能用
    --skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2844, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 2844, 1);		-- 设置2号位Buff
	skill.BindBuff(3, 2844, 1);		-- 设置3号位Buff
	skill.BindBuff(4, 2853, 1);		-- 设置4号位Buff
