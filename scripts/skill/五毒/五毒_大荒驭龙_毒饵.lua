---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_大荒驭龙_毒饵.lua
-- 更新时间:	2017/3/20 14:36:04
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckSelfBuff(208, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff--吞日月，禁轻功
	skill.AddSlowCheckSelfBuff(1298, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff

	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2775, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 2776, 1);		-- 设置2号位Buff
	--skill.BindBuff(3, 3911, 1);		-- 设置3号位Buff
	...
	skill.nCostManaBasePercent = 6;	-- 技能消耗的内力
	----------------- 技能仇恨 -------------------------------------------------
	--skill.nBaseThreat		= 0;
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(208, lv)then
		...
		player.SetTimer(18, "scripts/skill/五毒/五毒_大荒驭龙_毒饵.lua", 0, 0)
