...
tSkillData =
{
	{nDamageBase = 20 *0.5* 0.95, nDamageRand = 115 *0.5*0.1, nCostMana = 40 },		--level 1
};
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(2316, 1,	BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
