...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(3919,0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3883, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 3919, 1);		-- 设置2号位Buff
