---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_大荒驭龙_蛊虫狂暴.lua
-- 更新时间:	2016/5/11 19:58:26
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/五毒_大荒驭龙_蛊虫狂暴.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player then
		local pet = GetNpc(player.dwPetID)
		if pet then
			player.CastSkill(2987, 1, TARGET.NPC, player.dwPetID)
	...
	pet.CastSkill(3459, 1, TARGET.PLAYER, player.dwID)

	ModityCDToUI(player, 2227, 0, 0)
end
