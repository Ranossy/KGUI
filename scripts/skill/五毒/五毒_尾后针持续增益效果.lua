---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_尾后针持续增益效果.lua
-- 更新时间:	2014/7/17 15:26:08
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/五毒_尾后针持续增益效果.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not player.GetBuff(8081,1) then
		player.AddBuff(player.dwID, player.nLevel, 8080, 1)
		--player.AddBuff(player.dwID,player.nLevel,8081,1)
	--end
end
