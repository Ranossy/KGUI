...
function Apply(dwCharacterID)
        if not IsPlayer(dwCharacterID) then
         ...
         if player then
                   ...
                   if pet and pet.nCurrentLife ~= pet.nMaxLife then
                   	pet.nCurrentLife = pet.nCurrentLife + pet.nMaxLife * 0.035
		  	 if pet.nCurrentLife > pet.nMaxLife then
