...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 269*0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 269 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 269 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 269 * 0.8;	-- 技能消耗的内力
	else
	...
	if dwSkillLevel < 10 then
 	...
 	elseif dwSkillLevel < 31 then
  		skill.nChannelInterval = 60 + (dwSkillLevel - 9) * 8
  	else
