---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_迷仙引梦.lua
-- 更新时间:	2015/10/19 20:17:32
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 2
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 3
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 4
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 5
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 10
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 1
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 2
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 3
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.nChannelInterval = 16 * 1.5 * (1 + (dwSkillLevel - 1) * 0.05)*1.5; 				-- 通道技间隔时间
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(333)
	target.nCurrentMana = target.nCurrentMana + target.nMaxMana * 0.03
end
