---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/子技能_蛊虫狂暴_自己.lua
-- 更新时间:	2016/3/24 20:45:53
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/子技能_蛊虫狂暴_自己.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestBuff(4677, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff

	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2840, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 4677, 1);		-- 虫毒
...
function Apply(dwCharacterID)
	...
	print(1111)
	if not player.GetBuff(10174, 1) then
		player.AddBuff(dwCharacterID, player.nLevel, 4677, 1, 1)
	end
end
