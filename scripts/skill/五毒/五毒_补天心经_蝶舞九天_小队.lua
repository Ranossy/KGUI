---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_补天心经_蝶舞九天.lua
-- 更新时间:	2013/5/11 14:36:26
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 626 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 626 * 0.4;
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 626 * 0.6;
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 626 * 0.8;
	else
		skill.nCostManaBasePercent = 626;
	end
	----------------- 聚气相关 -------------------------------------------------
