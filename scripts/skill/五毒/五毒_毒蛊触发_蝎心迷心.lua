---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_毒蛊触发_蝎心迷心.lua
-- 更新时间:	2013/4/29 11:46:59
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --8秒内最多触发一次	
	...
	skill.AddAttribute(
		...
		"skill/五毒/五毒_毒蛊触发_蝎心迷心.lua", -- 属性值1
		0														-- 属性值2
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(4678, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 2489, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(6031) == 1 then
		player.CastSkillXYZ(6196, 1, target.nX, target.nY, target.nZ)
	end
end
