---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_补天心经_金蝉吐瑞.lua
-- 更新时间:	2013/5/7 15:04:03
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	skill.AddAttribute(						--自动选择血最少的目标
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.AUTO_SELECT_TARGET_BY_LIFELESS, -- 魔法属性
		20 * LENGTH_BASE, -- 属性值1
		66														-- 属性值2				--关系属性掩码
	);
	skill.AddAttribute(													-- 子技能释放
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.CAST_SUB_SKILL, -- 魔法属性
		2449, --属性值1
		1										--属性值2
	);
	for i = 1, 30 do
	...
	skill.nCostManaBasePercent = 479;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
