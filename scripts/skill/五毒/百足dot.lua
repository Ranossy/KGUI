---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/百足dot.lua
-- 更新时间:	2017/3/16 14:25:02
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2509, dwSkillLevel);
	...
	elseif dwSkillLevel < 34 then
		skill.nChannelInterval = 48 + (dwSkillLevel - 9) * 6 * 1.1
	else
		skill.nChannelInterval = 232 * 1.1;     -- 通道技间隔时间
	end
