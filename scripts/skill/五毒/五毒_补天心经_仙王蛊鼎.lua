---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_补天心经_仙王蛊鼎.lua
-- 更新时间:	2013/4/27 20:44:44
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.nCostManaBasePercent = 258;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if doodad then
		...
		if ZhenPaiLevel == 2 then
			doodad.SetScript("scripts/skill/五毒/五毒_物件_仙王蛊鼎_镇派2.lua");			--镇派“仙鼎”2级
		elseif ZhenPaiLevel == 1 then
			doodad.SetScript("scripts/skill/五毒/五毒_物件_仙王蛊鼎_镇派2.lua");			--镇派“仙鼎”1级
		else
			doodad.SetScript("scripts/skill/五毒/五毒_物件_仙王蛊鼎_镇派2.lua");
		end
