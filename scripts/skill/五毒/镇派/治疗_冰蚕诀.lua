---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/镇派/治疗_冰蚕诀.lua
-- 更新时间:	2013/4/29 15:44:08
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nValue1 = 519, nValue2 = 477}, --level 1
	{nValue1 = 520, nValue2 = 478}, --level 2
	{nValue1 = 521, nValue2 = 478}, --level 3
};
