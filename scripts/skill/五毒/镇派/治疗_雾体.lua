...
tSkillData =
{
	{nValue1 = 509, nValue2 = 477},		--level 1
	{nValue1 = 510, nValue2 = 478},		--level 2
};
...
function Apply(dwCharacterID)
	...
	local a = playerA.GetSkillLevel(2956)
	if a == 1 then 
		playerA.AddBuff(0,99,3068,3)
	end
	if a == 2 then 
		playerA.AddBuff(0,99,3068,4)
	end			
end
