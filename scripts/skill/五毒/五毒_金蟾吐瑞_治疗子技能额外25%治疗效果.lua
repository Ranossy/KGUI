---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_金蟾吐瑞_治疗子技能额外25%治疗效果.lua
-- 更新时间:	2015/9/23 15:16:14
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase / 4*0.25,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand / 4*0.25,
		0
	);
	...
	skill.nChannelInterval = 64 / 4 * 1.15; 				-- 通道技间隔时间
