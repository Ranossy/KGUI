...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddSlowCheckDestOwnBuff(2296, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff   
	elseif dwSkillLevel == 2 then
		skill.AddSlowCheckDestOwnBuff(2509, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	else
		skill.AddSlowCheckDestOwnBuff(2295, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	end
	-----------------技能施放技能需求-------------------------------------------
