---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/90级奇穴/五毒_毒经_附魔后蝎心伤害附带回血效果.lua
-- 更新时间:	2014/7/2 11:05:08
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------------------------------------------------------------------------------
	skill.AddCheckSelfLearntSkill(9330, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	
	----------------技能伤害给小队回血------------------------------------------

	skill.nDamageToLifeForParty = 52	--技能伤害给小队成员百分比回血
