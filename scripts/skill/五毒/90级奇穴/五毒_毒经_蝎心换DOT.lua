...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_毒经_蝎心换DOT.lua",				-- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(2209) ~= 0 and player.GetSkillLevel(6621) == 0 then
		local lv = player.GetSkillLevel(2209)
		player.ForgetSkill(2209)
		--player.LearnSkill(6621)
		player.LearnSkillLevel(6621, lv, dwCharacterID)
		RecipeCopy(2209, lv, player, 6621)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 2209, 6621, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(6621) ~= 0 and player.GetSkillLevel(2209) == 0 then
		local lv = player.GetSkillLevel(6621)
		player.ForgetSkill(6621)
		--player.LearnSkill(2209)
		player.LearnSkillLevel(2209, lv, dwCharacterID)
		RecipeCopy(6621, lv, player, 2209)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6621, 2209, lv)
	end
end
