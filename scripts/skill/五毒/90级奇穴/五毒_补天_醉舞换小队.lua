...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_补天_醉舞换小队.lua",				-- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(2233) ~= 0 and player.GetSkillLevel(6675) == 0 then
		local lv = player.GetSkillLevel(2233)
		player.ForgetSkill(2233)
		--player.LearnSkill(6675)
		player.LearnSkillLevel(6675, lv, dwCharacterID)
		RecipeCopy(2233, lv, player, 6675)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 2233, 6675, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(6675) ~= 0 and player.GetSkillLevel(2233) == 0 then
		local lv = player.GetSkillLevel(6675)
		player.ForgetSkill(6675)
		--player.LearnSkill(2233)
		player.LearnSkillLevel(2233, lv, dwCharacterID)
		RecipeCopy(6675, lv, player, 2233)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6675, 2233, lv)
	end
end
