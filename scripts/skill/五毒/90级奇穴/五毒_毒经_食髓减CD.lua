---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/90级奇穴/五毒_毒经_食髓减CD.lua
-- 更新时间:	2014/11/2 19:55:54
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.SET_TALENT_RECIPE, -- 魔法属性
		1804, -- 属性值1
		1											-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_毒经_食髓减CD.lua", -- 属性值1
		0														-- 属性值2
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(2211) ~= 0 and player.GetSkillLevel(13430) == 0 then
		local lv = player.GetSkillLevel(2211)
		player.ForgetSkill(2211)
		--player.LearnSkill(6621)
		player.LearnSkillLevel(13430, lv, dwCharacterID)
		RecipeCopy(2211, lv, player, 13430)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 2211, 13430, lv)
	end
	--]]
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(13430) ~= 0 and player.GetSkillLevel(2211) == 0 then
		local lv = player.GetSkillLevel(13430)
		player.ForgetSkill(13430)
		--player.LearnSkill(2209)
		player.LearnSkillLevel(2211, lv, dwCharacterID)
		RecipeCopy(13430, lv, player, 2211)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 13430, 2211, lv)
	end
	--]]
end
