---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/90级奇穴/五毒_毒经_宠物加攻击.lua
-- 更新时间:	2015/10/11 22:20:44
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_毒经_宠物加攻击.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	local npc_pet = player.GetPet()
	if npc_pet then
		npc_pet.AddBuff(player.dwID, player.nLevel, 2827, 3)
	end
end
