...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_毒经_蟾啸换单体.lua",				-- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(2210) ~= 0 and player.GetSkillLevel(6626) == 0 then
		local lv = player.GetSkillLevel(2210)
		player.ForgetSkill(2210)
		--player.LearnSkill(6626)
		player.LearnSkillLevel(6626, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 2210, 6626, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(6626) ~= 0 and player.GetSkillLevel(2210) == 0 then
		local lv = player.GetSkillLevel(6626)
		player.ForgetSkill(6626)
		--player.LearnSkill(2210)
		player.LearnSkillLevel(2210, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6626, 2210, lv)
	end
end
