---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/90级奇穴/圣手AOE.lua
-- 更新时间:	2013/4/29 14:40:23
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nTherapyBase = 502 * 0.95, nTherapyRand = 502 * 0.1, nCostMana = 790}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyBase / 10, --属性值1
		0																--属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand/10, --属性值1
		0																--属性值2
	);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(2953, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
