...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/五毒/90级奇穴/五毒_补天_冰蚕换单体.lua",				-- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(2232) ~= 0 and player.GetSkillLevel(6662) == 0 then
		local lv = player.GetSkillLevel(2232)
		player.ForgetSkill(2232)
		--player.LearnSkill(6662)
		player.LearnSkillLevel(6662, lv, dwCharacterID)
		RecipeCopy(2232, lv, player, 6662)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 2232, 6662, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(6662) ~= 0 and player.GetSkillLevel(2232) == 0 then
		local lv = player.GetSkillLevel(6662)
		player.ForgetSkill(6662)
		--player.LearnSkill(2232)
		player.LearnSkillLevel(2232, lv, dwCharacterID)
		RecipeCopy(6662, lv, player, 2232)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6662, 2232, lv)
	end
end
