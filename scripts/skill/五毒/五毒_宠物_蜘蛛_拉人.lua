...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2556, 1);			-- 设置Buff
	skill.BindBuff(2, 3473, 1);		-- 设置Debuff
...
function Apply(dwCharacterID)
	...
	if npc then
		npc.AddBuff(0, 99, 2555, 1)
	elseif IsPlayer(dwCharacterID) then
		local player = GetPlayer(dwCharacterID)
		player.AddBuff(0, 99, 2555, 1)
	end
end
