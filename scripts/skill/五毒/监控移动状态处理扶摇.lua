---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/监控移动状态处理扶摇.lua
-- 更新时间:	2017/3/19 18:35:23
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	---只能在buff里面判定二段跳数处理，然后调用11817消失脚本，因为空中聂云及小轻功后移动状态都将切换至站立。
	if player.GetBuff(11817, 1)then
		if player.nJumpCount == 0 then
			player.DelBuff(11817, 1)
		end
	end
end
