---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/五毒/五毒_补天心经_迷仙引梦.lua
-- 更新时间:	2015/10/19 17:02:32
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/五毒/五毒_补天心经_迷仙引梦.lua",											-- 属性值1
   		0											-- 属性值2
   		);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 977);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npc_yingzi = scene.CreateNpcWithEmployerID(48049, nX, nY, nZ, player.nFaceDirection, 22 * 16, player.dwID)
	if npc_yingzi then
		...
		npc_yingzi.AddBuff(player.dwID, player.nLevel, 10131, 1)
