---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/唐门_机关_千机变_目标点.lua
-- 更新时间:	2015/3/19 21:30:18
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/唐门_机关_千机变_目标点.lua", --属性值1
		0															--属性值2
	);

	--这个技能现在是目标点范围技能,下面这段不会生效
	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if nResault == 1 then
		...
		cPlayer.SetTimer(30, "scripts/skill/唐门/唐门_机关_千机变_目标点.lua", battery.dwID, 0)
