---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/暴雨外功aoe.lua
-- 更新时间:	2013/11/20 17:06:31
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 523 * 0.95, nDamageRand = 523 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 523 * 0.95, nDamageRand = 523 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 523 * 0.95, nDamageRand = 523 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 523 * 0.95, nDamageRand = 523 * 0.1, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(7229, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff   
	...
	if dwSkillLevel == 2 then
		skill.nChannelInterval = 13; 				-- 通道技间隔时间
	end
