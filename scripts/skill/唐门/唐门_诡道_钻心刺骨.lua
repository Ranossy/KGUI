---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/唐门_诡道_钻心刺骨.lua
-- 更新时间:	2013/3/18 16:31:44
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 542);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	-- if skill.dwLevel == 1 then
		-- player.AcquireAchievement(2710)
	-- end
...
function Apply(dwCharacterID)
	...
	local sLV = player.GetSkillLevel(3113)
	if not player then
		return
	end
	if not sLV then
