---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/套路及子技能/飞星遁影buff1.lua
-- 更新时间:	2017/4/12 10:16:07
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if Skill_ID ~= nil then
		--删掉影子界面
			--print("Skill_ID" .. Skill_ID .. "bbbb")
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "FireUIEvent", "DELETE_ONE_HIDDEN", Skill_ID)
	end
	...
	if nCount == 0 then
		RemoteCallToClient(player.dwID, "CloseTangMenHiddenBar")
	end
