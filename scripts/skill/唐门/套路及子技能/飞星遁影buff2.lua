---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/套路及子技能/飞星遁影buff2.lua
-- 更新时间:	2017/4/12 16:18:23
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	--print(111)
	--print("nCustomValue"..nCustomValue)
	--[[
	local yingzi_npc = GetNpc(nCustomValue)
	if yingzi_npc then
	...
	if Skill_ID ~= nil then
		--删掉影子界面
		--print("Skill_ID" .. Skill_ID .. "aaaaa")
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "FireUIEvent", "DELETE_ONE_SHADOW", Skill_ID)
	end
	...
	if nCount == 0 then
		RemoteCallToClient(player.dwID, "CloseChangGeShadowBar")
	end
