...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 		--化血镖
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 		--蚀肌弹
		ATTRIBUTE_TYPE.SET_TALENT_RECIPE,
		934,															
		dwSkillLevel
	);
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 		--暗藏杀机
		ATTRIBUTE_TYPE.SET_TALENT_RECIPE,
		935,															
		dwSkillLevel
	);	
