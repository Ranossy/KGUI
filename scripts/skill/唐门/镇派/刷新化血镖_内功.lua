---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/镇派/刷新化血镖_内功.lua
-- 更新时间:	2013/5/6 17:01:38
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(3221, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff   
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32*1.3;
	elseif dwSkillLevel < 19 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 10)*1.3
	else
		skill.nChannelInterval =140*1.3;     -- 通道技间隔时间   
	end
