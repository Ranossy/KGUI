...
tSkillData =
{
	...
	{nDamageBase = 373 * 0.95, nDamageRand = 373 * 0.1, nCostMana = 0},		--level 10
	{nDamageBase = 418 * 0.95, nDamageRand = 418 * 0.1, nCostMana = 0},		--level 11
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 3229, 1);		-- 设置1号位Buff
