...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_惊羽_裂石弩_换单体.lua",				-- 属性值1
		0														-- 属性值2
		);
	--[[
	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(3097) ~= 0 and player.GetSkillLevel(6450) == 0 then
		local lv = player.GetSkillLevel(3097)
		player.ForgetSkill(3097)
		--player.LearnSkill(6450)
		player.LearnSkillLevel(6450, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 3097, 6450, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(6450) ~= 0 and player.GetSkillLevel(3097) == 0 then
		local lv = player.GetSkillLevel(6450)
		player.ForgetSkill(6450)
		--player.LearnSkill(3097)
		player.LearnSkillLevel(3097, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6450, 3097, lv)
	end
end
