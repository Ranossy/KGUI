...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(3712, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff
	--skill.AddSlowCheckDestOwnBuff(3195, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff
