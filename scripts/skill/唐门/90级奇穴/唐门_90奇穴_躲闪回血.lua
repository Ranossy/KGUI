...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_90奇穴_躲闪回血.lua",
		0														
	);	
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	  skill.AddSlowCheckSelfBuff(6086, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6086, 1);		-- 设置1号位Buff
