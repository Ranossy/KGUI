---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/唐门_惊羽_暴雨梨花针_换AOE.lua
-- 更新时间:	2013/11/20 11:27:30
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_惊羽_暴雨梨花针_换AOE.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(3093) ~= 0 and player.GetSkillLevel(6444) == 0 then
		local lv = player.GetSkillLevel(3093)
		player.ForgetSkill(3093)
		--player.LearnSkill(6444)
		player.LearnSkillLevel(6444, lv, dwCharacterID)
		RecipeCopy(3093, lv, player, 6444)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 3093, 6444, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(3093) == 0 and player.GetSkillLevel(6444) ~= 0 then
		local lv = player.GetSkillLevel(6444)
		player.ForgetSkill(6444)
		--player.LearnSkill(3093)
		player.LearnSkillLevel(3093, lv, dwCharacterID)
		RecipeCopy(6444, lv, player, 3093)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6444, 3093, lv)
	end
end
