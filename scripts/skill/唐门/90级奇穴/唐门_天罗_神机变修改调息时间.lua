---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/唐门_天罗_神机变修改调息时间.lua
-- 更新时间:	2015/3/19 19:57:28
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_天罗_神机变修改调息时间.lua", -- 属性值1
		0											-- 属性值2
		);
	--]]
	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(3109) ~= 0 and player.GetSkillLevel(13807) == 0 then
		local lv = player.GetSkillLevel(3109)
		player.ForgetSkill(3109)
		--player.LearnSkill(6450)
		player.LearnSkillLevel(13807, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 3109, 13807, lv)
	end
	--]]
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(13807) ~= 0 and player.GetSkillLevel(3109) == 0 then
		local lv = player.GetSkillLevel(13807)
		player.ForgetSkill(13807)
		--player.LearnSkill(3097)
		player.LearnSkillLevel(3109, lv, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 13807, 3109, lv)
	end
	--]]
end
