...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_90奇穴_神机值恢复.lua", -- 属性值1
		0														-- 属性值2
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	  skill.AddSlowCheckSelfBuff(6407, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  --skill.BindBuff(1, 6407, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	--print(111)
	if player.nCurrentEnergy < 20 then
		player.nCurrentEnergy = player.nCurrentEnergy + 30
		--print(222)
		player.AddBuff(dwCharacterID,player.nLevel,6407,1,1)
	end
end
