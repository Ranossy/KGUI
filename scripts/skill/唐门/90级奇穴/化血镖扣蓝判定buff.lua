...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(16903) == 1 and target.GetBuff(11297, 1) then
		target.nCurrentMana = target.nCurrentMana - math.min(target.nMaxMana * 0.01, target.nCurrentMana)
	end
end
