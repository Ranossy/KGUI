---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/唐门_90奇穴_追命箭_正常.lua
-- 更新时间:	2015/10/2 23:51:49
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(nRnd)
	if player.GetSkillLevel(14850) == 1 and nRnd <= 4000 then
		player.ClearCDTime(463)
	end
	--[[
	if player.GetSkillLevel(5721) == 1 then
		target.AddBuff(player.dwID, player.nLevel, 11873, 1,5)
	end
	--]]
end
