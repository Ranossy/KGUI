---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/唐门_90奇穴_千机变加增益.lua
-- 更新时间:	2013/9/6 10:27:22
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/唐门/90级奇穴/唐门_90奇穴_千机变加增益.lua", --属性值1
		0															--属性值2
	);	
...
function Apply(dwCharacterID, dwSrcID)
	...
	if player.GetSkillLevel(6506) == 1 then
		if not player.GetBuff(6112, 1) then
			player.AddBuff(0, 99, 6112, 1)
		end
	else
		player.DelBuff(6112,1)
	end

	if player.GetSkillLevel(6507) == 1 then
		if not player.GetBuff(6113, 1) then
			player.AddBuff(0, 99, 6113, 1)
		end
	else
