---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/瞬发蚀肌弹延迟.lua
-- 更新时间:	2017/3/9 10:11:24
-- 更新用户:	chenchen6-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function UnApply(dwCharacterID)
	...
	if not player.GetBuff(10130, 1) then
		if player.GetOTActionState() == 1 then
			--print(1111)
			player.AddBuff(player.dwID, player.nLevel, 11766, 1)
		else
			--print(2222)
			player.AddBuff(player.dwID, player.nLevel, 3281, 1)
		end
	end
end
