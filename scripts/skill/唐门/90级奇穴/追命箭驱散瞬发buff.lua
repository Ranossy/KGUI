---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/90级奇穴/追命箭驱散瞬发buff.lua
-- 更新时间:	2015/10/2 20:06:01
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--先删除一次残留的
	player.DelBuff(9984, 1)
	if player.GetSkillLevel(14854) == 1 and player.GetBuff(3276, 1) then
		--print(3333)
		player.AddBuff(player.dwID,player.nLevel,9984,1)
	end

	if player.GetBuff(3276,1)then
		player.DelBuff(3276, 1)
	elseif player.GetBuff(5781, 1) then	
