...
tSkillData =
{
	{nDamageBase = 30, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 15, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 or dwSkillLevel == 3 then 
		skill.AddSlowCheckSelfBuff(6359, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	else
		skill.AddSlowCheckSelfBuff(8509, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	end
	...
	----------------- BUFF相关 -------------------------------------------------
	if dwSkillLevel == 1 or dwSkillLevel == 3 then
		skill.BindBuff(1, 6359, 1);		-- 设置1号位Buff
	else
		skill.BindBuff(1, 8509, 1);		-- 设置1号位Buff
	end
