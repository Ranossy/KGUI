---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/唐门_弓弩_卸元箭.lua
-- 更新时间:	2013/5/13 16:18:14
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 40 * 0.95, nDamageRand = 40 * 0.1, nCostMana = 0}, --level 12
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5886, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 465);	--技能普通CD
