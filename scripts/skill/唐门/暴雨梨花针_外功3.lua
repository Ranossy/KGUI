---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/镇派/刷新化血镖_外功3.lua
-- 更新时间:	2013/10/29 15:16:27
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(7114, 3, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.nChannelInterval = 90 * 1.05*1.1; 				-- 通道技间隔时间 
