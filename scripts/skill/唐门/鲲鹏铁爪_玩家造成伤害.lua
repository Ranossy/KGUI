...
tSkillData =
{
	{nDamage = 209, nDamageRand = 20, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
    ...
    --skill.nChannelFrame		= 0;	 			-- 通道技持续时间，单位帧数 
  	--skill.nBulletVelocity		= 20;				-- 子弹速度，单位 点/帧
...
function Apply(dwCharacterID)
	...
	local cNpc = cPlayer.GetTrap()
	if not cNpc then
		return
	end
	cNpc.SetDisappearFrames(2, 0)
end
