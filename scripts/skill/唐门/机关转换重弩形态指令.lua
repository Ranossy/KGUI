...
function GetSkillLevelData(skill)
    ...
    --skill.SetNormalCoolDown(1, 482);	--技能普通CD	
...
function Apply(dwCharacterID)
	...
	--cNpc.SetDisappearFrames(960, 0) 
	local battery = scene.CreateBattery(16176, cNpc.nX, cNpc.nY, cNpc.nZ, cPlayer.nFaceDirection, cPlayer.dwID, false)
	battery.AddBuff(0, 99, 3486, 1)
	battery.AddBuff(0,99,6111,1)
	cPlayer.CastSkill(3305, 1, TARGET.NPC, battery.dwID)			--为炮台上镇派效果
	cPlayer.SetTimer(42, "scripts/skill/唐门/机关转换重弩形态指令.lua", battery.dwID, 0)
	battery.SetModelID(26329)
end
