...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
  	...
  	skill.AddAttribute(
   	...
   	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamage/5, 
		0
	);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
      skill.AddSlowCheckDestOwnBuff(3884, 3, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求自身Buff
    ...
    skill.nChannelInterval	= 145 * 1.1 *1.15; 				-- 通道技间隔时间 
