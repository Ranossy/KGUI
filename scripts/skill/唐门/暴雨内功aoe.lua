---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/暴雨内功aoe.lua
-- 更新时间:	2013/11/20 17:06:23
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 3 then
		skill.nChannelInterval = 14; 				-- 通道技间隔时间
	end
	if dwSkillLevel == 4 then
		skill.nChannelInterval = 19; 				-- 通道技间隔时间
	end
	if dwSkillLevel == 5 then
		skill.nChannelInterval = 27; 				-- 通道技间隔时间
	end
