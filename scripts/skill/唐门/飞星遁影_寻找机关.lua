...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(													
 		...
 		ATTRIBUTE_TYPE.CLEAR_COOL_DOWN,								-- 魔法属性
 		475,												--属性值1
 		0										--属性值2
 	); 
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
      --skill.AddSlowCheckSelfBuff(3249, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff30秒CD控制
    ...
    --skill.SetNormalCoolDown(1, 501);	--技能普通CD
