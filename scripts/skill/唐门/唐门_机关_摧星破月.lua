---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/唐门_机关_摧星破月.lua
-- 更新时间:	2016/6/17 20:23:37
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 976);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.DelGroupBuff(3281,1)
	player.DelGroupBuff(11838, 1)

	player.AddBuff(player.dwID, player.nLevel, 10130, 1, 12)		--添加状态buff,该buff自带免控效果
	player.AddBuff(player.dwID, player.nLevel, 10860, 1, 12)
