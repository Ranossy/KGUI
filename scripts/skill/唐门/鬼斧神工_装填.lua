...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 3425, 1);		-- 设置1号位Buff
    ...
    --skill.nPrepareFrames  	= 0;				-- 吟唱帧数
      skill.nChannelInterval	= 9; 				-- 通道技间隔时间 
...
function Apply(dwCharacterID)
	...
	local battery = cPlayer.GetBattery()
	if not battery then
		return
	end
	if cPlayer.GetSkillLevel(14857) == 1 then
		cPlayer.AddBuff(0, 99, 3426, 1)
		cPlayer.AddBuff(0, 99, 3426, 1)
		cPlayer.AddBuff(0, 99, 3426, 1)
		cPlayer.AddBuff(0, 99, 3426, 1)
		cPlayer.AddBuff(0, 99, 3426, 1)
		cPlayer.AddBuff(0, 99, 3426, 1)
		--[[battery.AddBuff(0, 99, 3426, 1, 2)
		battery.AddBuff(0, 99, 3426, 1, 2)
		battery.AddBuff(0, 99, 3426, 1, 2)
		battery.AddBuff(0, 99, 3426, 1, 2)--]]
	else
