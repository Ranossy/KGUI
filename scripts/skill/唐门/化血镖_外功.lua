---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/化血镖_外功.lua
-- 更新时间:	2014/6/30 17:28:35
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 19 then
		...
		skill.nChannelInterval = 245*1.05;     -- 通道技间隔时间
	end

	--skill.nChannelInterval	= 288; 				-- 通道技间隔时间
