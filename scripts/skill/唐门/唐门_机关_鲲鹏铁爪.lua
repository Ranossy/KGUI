...
function GetSkillLevelData(skill)
    ...
    -- 技能CD, CoolDownIndex为CD位(共3个), nCoolDownID为CoolDownList.tab内的CDID
      skill.SetNormalCoolDown(1, 480);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	local cNpc = scene.CreateTrap(15999, nX, nY, nZ, 0, cPlayer.dwID)
	cNpc.AddBuff(0,99,3361,1)
	cPlayer.SetTimer(40, "scripts/skill/唐门/唐门_机关_鲲鹏铁爪.lua", cNpc.dwID, 0)
	cNpc.SetModelID(26121) 
end
