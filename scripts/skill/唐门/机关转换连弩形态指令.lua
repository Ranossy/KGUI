...
function Apply(dwCharacterID)
	...
	local battery = scene.CreateBattery(16175, cNpc.nX, cNpc.nY, cNpc.nZ, cNpc.nFaceDirection, cPlayer.dwID, false)
	battery.AddBuff(0, 99, 3486, 1)
	battery.AddBuff(0,99,6111,1)
	cPlayer.CastSkill(3305, 1, TARGET.NPC, battery.dwID)			--为炮台上镇派效果
	cPlayer.SetTimer(40, "scripts/skill/唐门/机关转换连弩形态指令.lua", battery.dwID, 0)
	battery.SetModelID(26327)
end
