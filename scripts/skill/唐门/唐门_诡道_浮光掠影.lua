---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/唐门_诡道_浮光掠影.lua
-- 更新时间:	2017/4/15 21:34:28
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --删太虚BUFF
		ATTRIBUTE_TYPE.DEL_SINGLE_BUFF_BY_ID_AND_LEVEL,
		961,
		1
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --删回神BUFF
		ATTRIBUTE_TYPE.DEL_SINGLE_BUFF_BY_ID_AND_LEVEL,
		772,
		1
	);
	...
	skill.SetNormalCoolDown(1, 469);	--技能普通CD
