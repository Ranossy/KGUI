---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/唐门/飞星遁影_判断距离2.lua
-- 更新时间:	2017/4/12 18:48:13
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(3377, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	--skill.AddSlowCheckSelfBuff(3249, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);
	--skill.AddSlowCheckSelfOwnBuff(dwBuffID, nStackNum, BUFF_COMPARE_FLAG.Result, nLevel, BUFF_COMPARE_FLAG.Result);	-- 需求自身属于自己的Buff
	--skill.AddSlowCheckDestOwnBuff(3242, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	-----------------技能施放技能需求-------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if player.GetBuff(3377, 1) == nil then
		player.SendSystemMessage(GetEditorString(3, 9053))
