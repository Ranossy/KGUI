...
tSkillData =
{
	{nDamageBase = 886*0.95, 	nDamageRand = 886*0.1, nCostMana = 0},		--level 1
	...
	{nDamageBase = 886*0.95, 	nDamageRand = 886*0.1, nCostMana = 0},		--level 8
};
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(6400, dwSkillLevel, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	--end
	skill.nChannelInterval	= 240*1.1; 				-- 通道技间隔时间 
