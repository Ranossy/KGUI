...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(5990, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.SetDelaySubSkill(3, 6600, dwSkillLevel)		
	-----------------技能渐变相关-------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if target.nImmuneSkillMoveCount == 0 and player.GetBuff(5990, 1) then
...
function UnApply(dwCharacterID)
	...
	local dwSkillLevel = player.GetSkillLevel(5522)   --获得母技能 神龙摆尾 的等级
	player.CastSkill(5526,dwSkillLevel)
end
