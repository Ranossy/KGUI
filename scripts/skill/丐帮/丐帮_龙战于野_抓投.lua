...
function GetSkillLevelData(skill)
	...
	skill.SetDelaySubSkill(3, 6366, dwSkillLevel)
	skill.SetDelaySubSkill(9, 6367, dwSkillLevel)
	skill.SetDelaySubSkill(14, 6368, dwSkillLevel)	
	-----------------技能渐变相关-------------------------------------------
...
function Apply(dwCharacterID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 5527, 1, 34)
	end
end
