---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/龙游3.lua
-- 更新时间:	2013/9/27 11:52:48
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamageBase = 87 * 0.95, nDamageRand = 87 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 134 * 0.95, nDamageRand = 134 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 181 * 0.95, nDamageRand = 181 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 228 * 0.95, nDamageRand = 228 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 275 * 0.95, nDamageRand = 275 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 322 * 0.95, nDamageRand = 322 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 369 * 0.95, nDamageRand = 369 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 416 * 0.95, nDamageRand = 416 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 463 * 0.95, nDamageRand = 463 * 0.1, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.SKILL_PHYSICS_DAMAGE * 2,
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
		ATTRIBUTE_TYPE.SKILL_PHYSICS_DAMAGE_RAND * 2,
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 62;
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = 62 + (dwSkillLevel - 4) * 11
	else
		skill.nChannelInterval = 128 * 1.07;     -- 通道技间隔时间   
	end
