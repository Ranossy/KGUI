---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/龙游1.lua
-- 更新时间:	2013/9/27 11:52:26
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase / 6*2.5,
		0
	);
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 52;
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = 52 + (dwSkillLevel - 4) * 6
	else
		skill.nChannelInterval = 88 * 1.07;     -- 通道技间隔时间   
	end
