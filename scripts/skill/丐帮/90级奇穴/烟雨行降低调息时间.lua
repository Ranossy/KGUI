---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/90级奇穴/烟雨行降低调息时间.lua
-- 更新时间:	2015/9/20 23:09:42
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--气血低于30%重置
   	skill.AddAttribute(
   		...
   		"skill/丐帮/90级奇穴/烟雨行降低调息时间.lua",											-- 属性值1
   		0										-- 属性值2
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(player.dwID, player.nLevel, 9853, 1)
end
