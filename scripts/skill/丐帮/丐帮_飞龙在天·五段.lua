...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	  skill.AddSlowCheckSelfBuff(5993, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.SetDelaySubSkill(7, 6611, dwSkillLevel)	
	skill.SetDelaySubSkill(19, 6612, dwSkillLevel)
	skill.SetDelaySubSkill(22, 6613, dwSkillLevel)
	skill.SetDelaySubSkill(25, 6614, dwSkillLevel)		
	skill.SetDelaySubSkill(28, 6615, dwSkillLevel)	
	-----------------技能渐变相关-------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if target.nImmuneSkillMoveCount == 0 and player.GetBuff(5993, 1) then
...
function Apply(dwCharacterID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 5649, 1, 80)
	end
end
