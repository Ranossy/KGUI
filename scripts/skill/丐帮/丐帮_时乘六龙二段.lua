...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(5989, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	skill.SetDelaySubSkill(13, 6582, dwSkillLevel)	
	skill.SetDelaySubSkill(16, 6583, dwSkillLevel)		
	skill.SetDelaySubSkill(19, 6584, dwSkillLevel)
	skill.SetDelaySubSkill(22, 6585, dwSkillLevel)		
	-----------------技能渐变相关-------------------------------------------
