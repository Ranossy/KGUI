---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_天隼击_施放.lua
-- 更新时间:	2016/7/13 11:34:10
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 590);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(6942) and player.GetSkillLevel(6942) == 1 then
		if player.GetTarget() then
			player.CastSkill(6933, 1)
		end
	end
	if player.GetSkillLevel(6945) and player.GetSkillLevel(6945) == 1 then
		if player.GetTarget() then
			player.CastSkill(6935, 1)
		end
	end
	if player.GetSkillLevel(6946) and player.GetSkillLevel(6946) == 1 then
		if player.GetTarget() then
			player.CastSkill(6936, 1)
		end
	end
	if player.GetSkillLevel(6947) and player.GetSkillLevel(6947) == 1 then
		if player.GetTarget() then
			player.CastSkill(6937, 1)
		end
	end
	if player.GetSkillLevel(6948) and player.GetSkillLevel(6948) == 1 then
		if player.GetTarget() then
			player.CastSkill(6938, 1)
		end
	end
	if player.GetSkillLevel(16272) and player.GetSkillLevel(16272) == 1 then
		if player.GetTarget() then
			player.CastSkill(16273, 1)
		end
	end
end
