...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(6383, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6380, 1);		-- 设置1号位Buff
	...
	--skill.SetNormalCoolDown(1, nCoolDownID);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	local dwSkillLevel = player.GetSkillLevel(6919)
	if dwSkillLevel == 0 then 
		player.LearnSkill(6919)
	end
end
