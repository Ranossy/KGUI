...
function GetSkillLevelData(skill)
	...
	skill.SetDelaySubSkill(1, 6383, dwSkillLevel)
	skill.SetDelaySubSkill(8 * 0.528, 6384, dwSkillLevel)
	skill.SetDelaySubSkill(16 * 0.528, 6385, dwSkillLevel)
	skill.SetDelaySubSkill(22 * 0.528, 6386, dwSkillLevel)
	-----------------技能渐变相关-------------------------------------------
...
function Apply(dwCharacterID)
	...
	--print("11111")
	target.BeHitted(player.dwID,5358,1,33)
end
