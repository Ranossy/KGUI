---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_天下无狗.lua
-- 更新时间:	2013/6/8 14:23:07
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetHoardSkill(0, 11, 5357, dwSkillLevel);
	skill.SetHoardSkill(12, 23, 5358, dwSkillLevel);
	skill.SetHoardSkill(24, 25, 5359, dwSkillLevel);
	----------------- BUFF相关 -------------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	if player.GetSkillLevel(6824) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 6378, 1, 1)
	end
	return nPreResult;
end
...
function OnSkillLevelUp(skill, player)
	if skill.dwLevel == skill.dwMaxLevel then
		player.AcquireAchievement(3443)
	end	
end
