---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/6398_犬牙交错_伤害1.lua
-- 更新时间:	2013/9/27 14:26:36
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nAddRage = 35, nCostRage = 20, nDamage = 86 * 0.95, nDamageRand = 86 * 0.1}, -- Level 1 
	{nAddRage = 35, nCostRage = 20, nDamage = 45 * 0.95, nDamageRand = 45 * 0.1}, -- Level 2 
	{nAddRage = 35, nCostRage = 20, nDamage = 53 * 0.95, nDamageRand = 53 * 0.1}, -- Level 3 
	{nAddRage = 35, nCostRage = 20, nDamage = 61 * 0.95, nDamageRand = 61 * 0.1}, -- Level 4 
	{nAddRage = 35, nCostRage = 20, nDamage = 69 * 0.95, nDamageRand = 69 * 0.1}, -- Level 5 
	{nAddRage = 35, nCostRage = 20, nDamage = 77 * 0.95, nDamageRand = 77 * 0.1}, -- Level 6 
	{nAddRage = 35, nCostRage = 20, nDamage = 85 * 0.95, nDamageRand = 85 * 0.1}, -- Level 7 
	{nAddRage = 35, nCostRage = 20, nDamage = 93 * 0.95, nDamageRand = 93 * 0.1}, -- Level 8 
...
function GetSkillLevelData(skill)
	...
	skill.nChannelInterval = 192; 				-- 通道技间隔时间 
...
function Apply(dwCharacterID)
	...
	if player and player.nImmuneSkillMoveCount == 0 then	
		player.BeHitted(player.dwID, 5362, 1, 64)
	end
end
