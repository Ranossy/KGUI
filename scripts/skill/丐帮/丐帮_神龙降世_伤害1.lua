---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_神龙降世_伤害1.lua
-- 更新时间:	2013/9/27 14:30:21
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 139 * 0.95, nDamageRand = 139 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 200 * 0.95, nDamageRand = 200 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 291 * 0.95, nDamageRand = 291 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 382 * 0.95, nDamageRand = 382 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 525 * 0.95, nDamageRand = 525 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 626 * 0.95, nDamageRand = 626 * 0.1, nCostMana = 0}, --level 8
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6155, 1);		-- 设置1号位Buff
