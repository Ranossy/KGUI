...
tSkillData =
{
	...
	{nDamageBase = 27 * 0.95, nDamageRand = 27 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 37 * 0.95, nDamageRand = 37 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 63 * 0.95, nDamageRand = 63 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 90 * 0.95, nDamageRand = 90 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 131 * 0.95, nDamageRand = 131 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 172 * 0.95, nDamageRand = 172 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 236 * 0.95, nDamageRand = 236 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 282 * 0.95, nDamageRand = 282 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 327 * 0.95, nDamageRand = 327 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 373 * 0.95, nDamageRand = 373 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 418 * 0.95, nDamageRand = 418 * 0.1, nCostMana = 0}, --level 12
