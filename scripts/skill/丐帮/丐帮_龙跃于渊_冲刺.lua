---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_龙跃于渊_冲刺.lua
-- 更新时间:	2014/5/15 11:52:09
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local targetN = player.GetSelectCharacter()
	if not targetN then
		return
	end
	if player.GetBuff(7848, 1) then
		local nbuff = player.GetBuff(7848, 1)
		nbuff.nCustomValue = targetN.dwID
	end
end
