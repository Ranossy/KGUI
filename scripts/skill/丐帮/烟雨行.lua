---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/烟雨行.lua
-- 更新时间:	2017/3/22 10:33:43
-- 更新用户:	chenchen6-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 621);	--技能普通CD
	skill.SetCheckCoolDown(1, 88);	--只检查不走的CD
	skill.SetCheckCoolDown(2, 606);	--只检查不走的CD
...
function OnSkillLevelUp(skill, player)
	local dwSkillLevel = player.GetSkillLevel(10271)
	if dwSkillLevel == 0 then
		player.LearnSkill(10271)
	end
	for i = 5505, 5508 do player.LearnSkill(i) end
end

--技能遗忘时执行的函数,参数skill为遗忘的skill
function OnSkillForgotten(skill, player)
	for i = 5505, 5508 do player.ForgetSkill(i) end
end
...
function Apply(dwCharacterID)
	...
	local Chongci = player.GetSkillLevel(5505)
	if Chongci == 0 then
		for i = 5505, 5508 do player.LearnSkill(i) end
	end
	player.CastSkill(17520, 1)
