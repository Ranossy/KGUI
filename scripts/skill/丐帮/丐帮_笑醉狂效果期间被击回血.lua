---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_笑醉狂效果期间被击回血.lua
-- 更新时间:	2015/9/12 23:08:51
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/丐帮/丐帮_笑醉狂效果期间被击回血.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(6828) == 1 and not player.GetBuff(9718, 1) then
		player.AddBuff(player.dwID, player.nLevel, 9718, 1)
