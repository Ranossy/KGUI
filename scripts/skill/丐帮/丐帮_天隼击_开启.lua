...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/丐帮/丐帮_天隼击_开启.lua",
		0														
	);	
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(6460, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6460, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	player.SendSystemMessage(GetEditorString(5, 7950))
end
