---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/6397_恶狗拦路_伤害1.lua
-- 更新时间:	2013/9/27 14:26:23
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nAddRage = 35, nCostRage = 20, nDamage = 69 * 0.95, nDamageRand = 69 * 0.1}, -- Level 1 
	{nAddRage = 35, nCostRage = 20, nDamage = 77 * 0.95, nDamageRand = 77 * 0.1}, -- Level 2 
	{nAddRage = 35, nCostRage = 20, nDamage = 85 * 0.95, nDamageRand = 85 * 0.1}, -- Level 3 
	{nAddRage = 35, nCostRage = 20, nDamage = 93 * 0.95, nDamageRand = 93 * 0.1}, -- Level 4 
	{nAddRage = 35, nCostRage = 20, nDamage = 101 * 0.95, nDamageRand = 101 * 0.1}, -- Level 5 
	{nAddRage = 35, nCostRage = 20, nDamage = 109 * 0.95, nDamageRand = 109 * 0.1}, -- Level 6 
	{nAddRage = 35, nCostRage = 20, nDamage = 117 * 0.95, nDamageRand = 117 * 0.1}, -- Level 7 
	{nAddRage = 35, nCostRage = 20, nDamage = 125 * 0.95, nDamageRand = 125 * 0.1}, -- Level 8 
	{nAddRage = 35, nCostRage = 20, nDamage = 101 * 0.95, nDamageRand = 101 * 0.1}, -- Level 9 
	{nAddRage = 35, nCostRage = 20, nDamage = 109 * 0.95, nDamageRand = 109 * 0.1}, -- Level 10
	{nAddRage = 35, nCostRage = 20, nDamage = 117 * 0.95, nDamageRand = 117 * 0.1}, -- Level 11
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6074, 1);		-- 设置1号位Buff
	...
	elseif dwSkillLevel < 8 then
		skill.nChannelInterval = 70 + (dwSkillLevel - 3) * 14
	else
		skill.nChannelInterval = 140;  
	end
...
function Apply(dwCharacterID)
	...
	if player and player.nImmuneSkillMoveCount == 0 then
		player.BeHitted(player.dwID, 5361, 1, 64)
	end
end
