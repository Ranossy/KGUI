...
tSkillData =
{
	{nDamageBase = 18*0.95, 	nDamageRand = 18*0.1, nCostMana = 0}, --level 1
	{nDamageBase = 47*0.95, 	nDamageRand = 47*0.1, nCostMana = 0}, --level 2
	{nDamageBase = 77*0.95, 	nDamageRand = 77*0.1, nCostMana = 0}, --level 3
	{nDamageBase = 107*0.95, 	nDamageRand = 107*0.1, nCostMana = 0}, --level 4
	{nDamageBase = 136*0.95, 	nDamageRand = 136*0.1, nCostMana = 0}, --level 5
	{nDamageBase = 166*0.95, 	nDamageRand = 166*0.1, nCostMana = 0}, --level 6
	{nDamageBase = 196*0.95, 	nDamageRand = 196*0.1, nCostMana = 0}, --level 7
	{nDamageBase = 225*0.95, 	nDamageRand = 225*0.1, nCostMana = 0}, --level 8
	{nDamageBase = 255*0.95, 	nDamageRand = 255*0.1, nCostMana = 0}, --level 9
	{nDamageBase = 285*0.95, 	nDamageRand = 285*0.1, nCostMana = 0}, --level 10
	{nDamageBase = 315*0.95, 	nDamageRand = 315*0.1, nCostMana = 0}, --level 11
	{nDamageBase = 344*0.95, 	nDamageRand = 344*0.1, nCostMana = 0}, --level 12
	{nDamageBase = 374*0.95, 	nDamageRand = 374*0.1, nCostMana = 0}, --level 13
	{nDamageBase = 404*0.95, 	nDamageRand = 404*0.1, nCostMana = 0}, --level 1
	{nDamageBase = 433*0.95, 	nDamageRand = 433*0.1, nCostMana = 0}, --level 2
	{nDamageBase = 463*0.95, 	nDamageRand = 463*0.1, nCostMana = 0}, --level 3
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6383, 1);		-- 设置1号位Buff
	...
	--skill.nAngleRange		= 30;					-- 攻击范围的扇形角度范围
