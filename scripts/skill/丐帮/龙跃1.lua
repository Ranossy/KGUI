---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/龙跃1.lua
-- 更新时间:	2013/9/27 11:51:17
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 24 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 26 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 28 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 30 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 32 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 34 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 36 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 38 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 40 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 42 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 44 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 46 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 12
	{nDamageBase = 48 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 12
};
