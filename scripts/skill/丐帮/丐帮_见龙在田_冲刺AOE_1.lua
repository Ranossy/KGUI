---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_见龙在田_冲刺AOE_1.lua
-- 更新时间:	2013/9/27 14:28:05
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamageBase = 200 * 0.8, nDamageRand = 200 * 0.4, nCostMana = 0}, --level 4
	{nDamageBase = 291 * 0.8, nDamageRand = 291 * 0.4, nCostMana = 0}, --level 5
	{nDamageBase = 382 * 0.8, nDamageRand = 382 * 0.4, nCostMana = 0}, --level 6
	{nDamageBase = 525 * 0.8, nDamageRand = 525 * 0.4, nCostMana = 0}, --level 7
};
...
function GetSkillLevelData(skill)
	...
	skill.nRectWidth = 5 * LENGTH_BASE;                         -- 矩形AOE的宽度，全宽，不填为nAreaRadiusskill.nAngleRange		= 256;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID)
	...
	if player and player.nImmuneSkillMoveCount == 0 then	
		player.BeHitted(player.dwID, 5265, 1, 44)
	end
end
