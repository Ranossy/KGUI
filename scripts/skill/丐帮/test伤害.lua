---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/test伤害.lua
-- 更新时间:	2013/9/27 11:44:25
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nDamageBase = 42 * 0.95, nDamageRand = 42 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 72 * 0.95, nDamageRand = 72 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 103 * 0.95, nDamageRand = 103 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 150 * 0.95, nDamageRand = 150 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 196 * 0.95, nDamageRand = 196 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 270 * 0.95, nDamageRand = 270 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 322 * 0.95, nDamageRand = 322 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 374 * 0.95, nDamageRand = 374 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 426 * 0.95, nDamageRand = 426 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 478 * 0.95, nDamageRand = 478 * 0.1, nCostMana = 0}, --level 11
};
