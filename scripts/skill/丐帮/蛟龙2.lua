---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/蛟龙2.lua
-- 更新时间:	2013/9/27 11:51:56
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 23 * 0.95, nDamageRand = 23 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 63 * 0.95, nDamageRand = 63 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 103 * 0.95, nDamageRand = 103 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 143 * 0.95, nDamageRand = 143 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 183 * 0.95, nDamageRand = 183 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 223 * 0.95, nDamageRand = 223 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 263 * 0.95, nDamageRand = 263 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 303 * 0.95, nDamageRand = 303 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 343 * 0.95, nDamageRand = 343 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 383 * 0.95, nDamageRand = 383 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 423 * 0.95, nDamageRand = 423 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 463 * 0.95, nDamageRand = 463 * 0.1, nCostMana = 0}, --level 12
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase / 6,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand / 6,
		0
	);
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 17;
	elseif dwSkillLevel < 12 then
		skill.nChannelInterval = 17 + (dwSkillLevel - 4) * 3
	else
		skill.nChannelInterval = 41 * 1.07;     -- 通道技间隔时间   
	end
