---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_潜龙勿用_伤害7.lua
-- 更新时间:	2013/9/27 14:30:06
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 402 * 0.95, nDamageRand = 402 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 467 * 0.95, nDamageRand = 467 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 532 * 0.95, nDamageRand = 532 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 597 * 0.95, nDamageRand = 597 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 662 * 0.95, nDamageRand = 662 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 727 * 0.95, nDamageRand = 727 * 0.1, nCostMana = 0}, --level 8
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 0.3/10,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 0.3/10,
		0
	);
	...
	elseif dwSkillLevel < 6 then
		skill.nChannelInterval = 16 + (dwSkillLevel - 2) * 6.5
	else
		skill.nChannelInterval = 44;  
	end
