---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_飞龙在天_伤害2.lua
-- 更新时间:	2013/9/27 14:28:52
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 407 * 0.95, nDamageRand = 407 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 447 * 0.95, nDamageRand = 447 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 487 * 0.95, nDamageRand = 487 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 527 * 0.95, nDamageRand = 527 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 567 * 0.95, nDamageRand = 567 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 607 * 0.95, nDamageRand = 607 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 647 * 0.95, nDamageRand = 647 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 687 * 0.95, nDamageRand = 687 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 727 * 0.95, nDamageRand = 727 * 0.1, nCostMana = 0}, --level 9
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 0.6,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 0.6,
		0
	);
	...
	elseif dwSkillLevel < 9 then
		skill.nChannelInterval = 36 + (dwSkillLevel - 4) * 7.5
	else
		skill.nChannelInterval = 75;  
	end
