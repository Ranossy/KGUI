...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/丐帮/丐帮_天隼击_关闭.lua",
		0														
	);		
	
	----------------- 技能施放Buff需求 ---------------------------------------------
	  skill.AddSlowCheckSelfBuff(6460, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID)
	...
	player.SendSystemMessage(GetEditorString(5, 7951))	
end
