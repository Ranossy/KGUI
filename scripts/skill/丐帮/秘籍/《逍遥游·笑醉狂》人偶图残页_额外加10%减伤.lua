---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/秘籍/《逍遥游·笑醉狂》人偶图残页_额外加10%减伤.lua
-- 更新时间:	2013/8/19 16:50:17
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillRecipeData(skill, SkillRecipeID, SkillRecipeLevel)
	...
	skill.AddAttribute(
		...
		"skill/丐帮/秘籍/《逍遥游·笑醉狂》人偶图残页_额外加10%减伤.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	--player.AddBuff(dwCharacterID, player.nLevel, 5996, 2, 1)
