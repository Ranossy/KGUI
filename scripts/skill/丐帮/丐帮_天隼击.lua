...
tSkillData =
{
	{nDamageBase = 537, nDamageRand = 54, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	  skill.AddSlowCheckSelfBuff(6462, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.SetDelaySubSkill(40, 6939, dwSkillLevel)
	-----------------技能渐变相关-------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 6461, 1);		-- 设置1号位Buff
	...
	--skill.SetNormalCoolDown(1, 627);	--技能普通CD
	--skill.SetCheckCoolDown(1, 444)	
	--skill.SetNormalCoolDown(2, 627);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if num < 2000 then
		player.AddBuff(0, 99, 6462, 1)
	elseif num < 6000 then
		player.AddBuff(0, 99, 6462, 2)
	else
		player.AddBuff(0, 99, 6462, 3)
	end
end
