---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_亢龙有悔_伤害.lua
-- 更新时间:	2013/9/27 11:49:57
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 186 * 0.95, nDamageRand = 186 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 286 * 0.95, nDamageRand = 286 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 386 * 0.95, nDamageRand = 386 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 486 * 0.95, nDamageRand = 486 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 586 * 0.95, nDamageRand = 586 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 686 * 0.95, nDamageRand = 686 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 786 * 0.95, nDamageRand = 786 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 886 * 0.95, nDamageRand = 886 * 0.1, nCostMana = 0}, --level 7
};
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(6400, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	--skill.SetDelaySubSkill(5, 5371, 1)	
	-----------------技能渐变相关-------------------------------------------
	...
	--skill.SetNormalCoolDown(1, 622);	--技能普通CD
	...
	elseif dwSkillLevel < 8 then
		skill.nChannelInterval = 120 + (dwSkillLevel - 3) * 24
	else
...
function Apply(dwCharacterID)
	...
	if not player then 
		...
		if npc and npc.nImmuneSkillMoveCount == 0 then
			npc.BeHitted(0, 5528, 1, 28)
		end	
		if not npc then
			return
		end
	...
	if player and player.nImmuneSkillMoveCount == 0 then	
		player.BeHitted(player.dwID, 5528, 1, 28)
	end	
end
