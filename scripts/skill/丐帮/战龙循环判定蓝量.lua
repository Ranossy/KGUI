---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/战龙循环判定蓝量.lua
-- 更新时间:	2015/9/12 20:46:08
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.bFightState == true and player.nCurrentMana >= player.nMaxMana * 0.8 and not player.GetBuff(7790,1) and player.nMoveState ~= MOVE_STATE.ON_DEATH then
