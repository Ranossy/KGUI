...
function GetSkillLevelData(skill)
	...
	skill.SetCheckCoolDown(2, 624);	--只检查不走的CD
	skill.SetCheckCoolDown(3, 444)	
...
function UnApply(dwCharacterID)
	...
	local dwSkillLevel = player.GetSkillLevel(5367)   --获得母技能 蛟龙翻江 的等级
	player.CastSkill(6915, dwSkillLevel)
end
