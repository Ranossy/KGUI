---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_龙战于野·二段复制.lua
-- 更新时间:	2014/1/15 16:02:10
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetDelaySubSkill(1, 8491, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8503, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8492, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8504, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8493, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8505, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8494, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8506, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8495, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8507, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8496, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8508, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8497, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8509, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8498, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8510, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8499, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8511, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8500, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8512, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8501, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8513, dwSkillLevel)--奇穴翻倍
	--skill.SetDelaySubSkill(1, 8502, dwSkillLevel)
	--skill.SetDelaySubSkill(1, 8514, dwSkillLevel)--奇穴翻倍
	-----------------技能渐变相关-------------------------------------------
...
function Apply(dwCharacterID)
	...
	player.CastSkill(8543, lv)
	player.AddBuff(player.dwID, player.nLevel, 5754, 1, 33)
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 8490, 1, 48)
	end
