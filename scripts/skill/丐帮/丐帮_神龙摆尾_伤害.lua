---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_神龙摆尾_伤害.lua
-- 更新时间:	2013/11/26 16:53:01
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 61 * 0.95, nDamageRand = 61 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 71 * 0.95, nDamageRand = 71 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 81 * 0.95, nDamageRand = 81 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 91 * 0.95, nDamageRand = 91 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 101 * 0.95, nDamageRand = 101 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 111 * 0.95, nDamageRand = 111 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 121 * 0.95, nDamageRand = 121 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 131 * 0.95, nDamageRand = 131 * 0.1, nCostMana = 0}, --level 8
};
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 8 then
		skill.nChannelInterval = 50 + (dwSkillLevel - 3) * 6
	else
