---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/龙战2.lua
-- 更新时间:	2013/9/27 11:53:20
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32*1.1;
	elseif dwSkillLevel < 17 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 2.5)*1.1
	else
		skill.nChannelInterval = 52 * 1.2*1.1;     -- 通道技间隔时间   
	end
