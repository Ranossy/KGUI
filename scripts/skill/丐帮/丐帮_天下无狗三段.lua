---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_天下无狗三段.lua
-- 更新时间:	2015/10/14 15:28:31
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetDelaySubSkill(1, 6387, dwSkillLevel)
	skill.SetDelaySubSkill(8 * 0.528, 6388, dwSkillLevel)
	skill.SetDelaySubSkill(14 * 0.528, 6389, dwSkillLevel)
	skill.SetDelaySubSkill(21 * 0.528, 6390, dwSkillLevel)
	skill.SetDelaySubSkill(29 * 0.528, 6391, dwSkillLevel)
	skill.SetDelaySubSkill(37 * 0.528, 6392, dwSkillLevel)
	skill.SetDelaySubSkill(45 * 0.528, 6393, dwSkillLevel)
	-----------------技能渐变相关-------------------------------------------
