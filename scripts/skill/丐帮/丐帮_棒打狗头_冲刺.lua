---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_棒打狗头_冲刺.lua
-- 更新时间:	2014/11/26 11:18:03
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --回蓝8%
		ATTRIBUTE_TYPE.CALL_BUFF_STACK_8,
		5997,
		1
	);
	skill.AddAttribute(
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --回蓝4%
		ATTRIBUTE_TYPE.CALL_BUFF_STACK_4,
		5997,
		1
		);
