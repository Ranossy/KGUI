---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_龙跃于渊_伤害.lua
-- 更新时间:	2013/5/22 0:20:21
-- 更新用户:	chenbugao
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetDelaySubSkill(1, 6355, dwSkillLevel)
	skill.SetDelaySubSkill(8, 6356, dwSkillLevel)
	skill.SetDelaySubSkill(14, 6357, dwSkillLevel)	
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if target.nImmuneSkillMoveCount == 0 then
		...
		--player.AdjustPlayerDistance(target.dwID, 160)
	end
	return nPreResult;
end
...
function Apply(dwCharacterID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 5363, 1, 43)
	end
end
