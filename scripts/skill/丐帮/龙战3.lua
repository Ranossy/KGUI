---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/龙战3.lua
-- 更新时间:	2013/9/27 11:53:32
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamage = 17 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 1
	{nDamage = 24 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 2
	{nDamage = 28 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 3
	{nDamage = 33 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 4
	{nDamage = 35 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 5
	{nDamage = 37 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 6
	{nDamage = 39 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 7
	{nDamage = 41 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 8
	{nDamage = 43 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 9
	{nDamage = 45 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 10
	{nDamage = 47 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 11
	{nDamage = 49 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 12
	{nDamage = 51 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 13
	{nDamage = 53 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 1
	{nDamage = 55 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 2
	{nDamage = 57 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 3
	{nDamage = 59 * 0.95, nDamageRand = 50 * 0.1, nCostMana = 0}, --level 4
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5988, 1);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 90*1.1;
	elseif dwSkillLevel < 17 then
		skill.nChannelInterval = (90 + (dwSkillLevel - 9) * 6.5)*1.1
	else
		skill.nChannelInterval = 150 * 1.2*1.1;     -- 通道技间隔时间   
	end
