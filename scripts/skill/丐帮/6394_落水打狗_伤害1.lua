---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/6394_落水打狗_伤害1.lua
-- 更新时间:	2013/9/27 14:25:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nAddRage = 35, nCostRage = 20, nDamage = 37 * 0.95, nDamageRand = 37 * 0.1}, -- Level 1 
...
function Apply(dwCharacterID)
	...
	if player and player.nImmuneSkillMoveCount == 0 then
		player.BeHitted(player.dwID, 5351, 1, 66)
	end
end
