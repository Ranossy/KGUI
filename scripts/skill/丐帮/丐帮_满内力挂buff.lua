---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_满内力挂buff.lua
-- 更新时间:	2013/7/12 11:20:35
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6458, 1);		-- 设置1号位Buff
	...
	----------------- 自身血量需求 ---------------------------------------------
	--skill.nSelfLifePercentMin	= 100;				-- 血量最小值>=
...
function Apply(dwCharacterID)
	...
	if player.nCurrentMana >= player.nMaxMana * 0.80 then
		player.AddBuff(dwCharacterID, player.nLevel, 6377, 1, 1)
	end
end
