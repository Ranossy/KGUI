---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/丐帮_橙武_挂buff.lua
-- 更新时间:	2013/7/23 14:32:10
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6466, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(6466, 1) or player.GetBuff(6466, 2) or player.GetBuff(6466, 3) or player.GerBuff(6466, 4) then
