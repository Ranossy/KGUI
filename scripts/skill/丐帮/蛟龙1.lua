---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/丐帮/蛟龙1.lua
-- 更新时间:	2013/9/27 11:51:46
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 26;
	elseif dwSkillLevel < 12 then
		skill.nChannelInterval = 26 + (dwSkillLevel - 4) * 3
	else
		skill.nChannelInterval = 50 * 1.07;     -- 通道技间隔时间   
	end
