...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 170 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 170 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 170 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 170 * 0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 170;	-- 技能消耗的内力
	end
	----------------- 聚气相关 -------------------------------------------------
	--skill.bIsAccumulate	= true;				-- 技能是否需要聚气且消耗所有能量
	skill.nNeedAccumulateCount = 3;				-- 技能需要气点的个数
	...
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = 200 + (dwSkillLevel - 9) * 15
	else
		skill.nChannelInterval = 450;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
