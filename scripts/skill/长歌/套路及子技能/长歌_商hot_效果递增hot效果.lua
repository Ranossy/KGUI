---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_商hot_效果递增hot效果.lua
-- 更新时间:	2015/8/10 20:47:20
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9461, dwSkillLevel);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 30*1.05;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (30 + (dwSkillLevel - 9) * 2)*1.05
	else
		skill.nChannelInterval = 85*1.05;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
