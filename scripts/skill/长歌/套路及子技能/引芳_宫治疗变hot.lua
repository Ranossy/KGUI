---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/引芳_宫治疗变hot.lua
-- 更新时间:	2015/8/10 19:02:26
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/引芳_宫治疗变hot.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print("加载奇穴宫治疗变宫hot")
	local lv = player.GetSkillLevel(14137)
	if not player.GetBuff(9377, 1) and lv ~= 0 then
		--print(8)
		RecipeCopy(14137, lv, player, 14303)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14137, 14303, lv)	--吟唱换dot
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "NewSkillPanel_RefeshKungfuSkillAt", 14137)
	end
	--[[
	if lv ~= 0 then
		--print(8)
...
function UnApply(dwCharacterID)
	...
	--print("遗忘奇穴宫hot变回宫治疗")
	local lv = player.GetSkillLevel(14303)
	if not player.GetBuff(9377, 1) and lv ~= 0 then
		RecipeCopy(14303, lv, player, 14137)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14303, 14137, lv)	--dot换吟唱
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "NewSkillPanel_RefeshKungfuSkillAt", 14137)
	end
	--[[
	if lv ~= 0 then
