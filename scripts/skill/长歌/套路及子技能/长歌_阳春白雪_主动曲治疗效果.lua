---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_阳春白雪_主动曲治疗效果.lua
-- 更新时间:	2015/8/9 12:40:04
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapy*0.4,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand*0.4,
		0
	);
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_阳春白雪_主动曲治疗效果.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(9434, 3) then
		player.AddBuff(player.dwID, player.nLevel, 9434, 3)
		player.AddBuff(player.dwID, player.nLevel, 10217, 1)
	elseif player.GetBuff(9434, 2) then
		player.DelBuff(9434, 2)
		player.AddBuff(player.dwID, player.nLevel, 9434, 3)
		player.AddBuff(player.dwID, player.nLevel, 10217, 1)
	elseif player.GetBuff(9434, 1) then
		player.DelBuff(9434, 1)
		player.AddBuff(player.dwID, player.nLevel, 9434, 2)
		player.AddBuff(player.dwID, player.nLevel, 10217, 1)
	else
		player.AddBuff(player.dwID, player.nLevel, 9434, 1)
		player.AddBuff(player.dwID, player.nLevel, 10217, 1)
	end
end
