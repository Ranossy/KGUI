---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_角hot_间隔缩短效果递增hot效果.lua
-- 更新时间:	2015/8/10 21:02:38
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9466, dwSkillLevel);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 40*1.5*1.1;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (40 + (dwSkillLevel - 9) * 2)*1.5*1.1
	else
		skill.nChannelInterval = 95*1.5*1.1;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
