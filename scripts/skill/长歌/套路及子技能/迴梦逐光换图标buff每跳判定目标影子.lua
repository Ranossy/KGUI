...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nbuff_mark = player.GetBuff(9277, 1)
	if nbuff_mark then
		local nbuffleftcount = math.max(nbuff_mark.nLeftActiveCount - 2, 0)
		RemoteCallToClient(player.dwID, "ChangeSkillSurfaceNum", 14158, nbuffleftcount)
	end
	--[[
	for i = 1, 5 do
