---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_阳春白雪_主动曲伤害效果.lua
-- 更新时间:	2015/8/9 12:32:51
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_阳春白雪_主动曲伤害效果.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(9433, 3) then
		player.AddBuff(player.dwID, player.nLevel, 9433, 3)
		player.AddBuff(player.dwID, player.nLevel, 10216, 1)
	elseif player.GetBuff(9433, 2) then
		player.DelBuff(9433, 2)
		player.AddBuff(player.dwID, player.nLevel, 9433, 3)
		player.AddBuff(player.dwID, player.nLevel, 10216, 1)
	elseif player.GetBuff(9433, 1) then
		--print(22222222)
		player.DelBuff(9433, 1)
		player.AddBuff(player.dwID, player.nLevel, 9433, 2)
		player.AddBuff(player.dwID, player.nLevel, 10216, 1)
	else
		--print(111111)
		player.AddBuff(player.dwID, player.nLevel, 9433, 1)
		player.AddBuff(player.dwID, player.nLevel, 10216, 1)
	end
end
