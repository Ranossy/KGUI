---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_徵_有奇穴子技能D实际伤害.lua
-- 更新时间:	2015/8/6 15:15:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(9383, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 36 * 1.4;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (36 + (dwSkillLevel - 9) * 3) * 1.4
	else
		skill.nChannelInterval = 96 * 1.4;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
