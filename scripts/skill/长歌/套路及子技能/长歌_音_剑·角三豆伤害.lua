---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·角二豆伤害.lua
-- 更新时间:	2015/8/13 22:45:54
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.nChannelInterval = 195; 				-- 通道技间隔时间
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 200*0.8;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (200 + (dwSkillLevel - 9) * 25)*0.8
	else
		skill.nChannelInterval = 600*0.8;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
