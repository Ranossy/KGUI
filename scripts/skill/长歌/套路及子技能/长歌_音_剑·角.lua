---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·角.lua
-- 更新时间:	2015/8/13 22:37:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 200 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 200 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 200 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 200 * 0.8;	-- 技能消耗的内力
	else
	...
	skill.SetSubsectionSkill(1, 1, 14456, dwSkillLevel)
	skill.SetSubsectionSkill(2, 2, 14457, dwSkillLevel)
	skill.SetSubsectionSkill(3, 3, 14458, dwSkillLevel)
	skill.SetSubsectionSkill(4, 4, 14459, dwSkillLevel)
	skill.SetSubsectionSkill(5, 10, 14460, dwSkillLevel)
	----------------- 链状技能相关 ---------------------------------------------
	...
	skill.nTargetLifePercentMax	= 35;			-- 血量最大值<=
