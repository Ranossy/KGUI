---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·角五豆伤害.lua
-- 更新时间:	2015/8/13 22:50:23
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.nChannelInterval = 225; 				-- 通道技间隔时间
	...
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = 200 + (dwSkillLevel - 9) * 25
	else
		skill.nChannelInterval = 600;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
