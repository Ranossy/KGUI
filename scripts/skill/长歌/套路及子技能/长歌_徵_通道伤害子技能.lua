---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_徵_通道伤害子技能.lua
-- 更新时间:	2015/8/6 9:29:43
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 70, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 75, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 80, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 85, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 90, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 95, nDamageRand = 5, nCostMana = 0}, --level 6
	{nDamageBase = 100, nDamageRand = 5, nCostMana = 0}, --level 7
	{nDamageBase = 105, nDamageRand = 5, nCostMana = 0}, --level 8
	{nDamageBase = 110, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 115, nDamageRand = 10, nCostMana = 0}, --level 10
	{nDamageBase = 120, nDamageRand = 10, nCostMana = 0}, --level 11
	{nDamageBase = 125, nDamageRand = 10, nCostMana = 0}, --level 12
	{nDamageBase = 130, nDamageRand = 10, nCostMana = 0}, --level 13
	{nDamageBase = 135, nDamageRand = 10, nCostMana = 0}, --level 14
	{nDamageBase = 140, nDamageRand = 10, nCostMana = 0}, --level 15
	{nDamageBase = 145, nDamageRand = 10, nCostMana = 0}, --level 16
	{nDamageBase = 150, nDamageRand = 20, nCostMana = 0}, --level 17
	{nDamageBase = 155, nDamageRand = 20, nCostMana = 0}, --level 18
	{nDamageBase = 160, nDamageRand = 20, nCostMana = 0}, --level 19
	{nDamageBase = 165, nDamageRand = 20, nCostMana = 0}, --level 20
	{nDamageBase = 170, nDamageRand = 20, nCostMana = 0}, --level 21
	{nDamageBase = 175, nDamageRand = 20, nCostMana = 0}, --level 22
	{nDamageBase = 180, nDamageRand = 20, nCostMana = 0}, --level 23
	{nDamageBase = 185, nDamageRand = 20, nCostMana = 0}, --level 24
	{nDamageBase = 190, nDamageRand = 20, nCostMana = 0}, --level 25
};
...
function GetSkillLevelData(skill)
	...
	-----------------技能施放技能需求-------------------------------------------
	--skill.AddCheckSelfLearntSkill(14314, 0, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = 40 + (dwSkillLevel - 9) * 3
	else
