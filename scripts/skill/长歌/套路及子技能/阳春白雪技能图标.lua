---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/阳春白雪技能图标.lua
-- 更新时间:	2015/10/11 16:52:39
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nlev = player.GetSkillLevel(14070)
	local nSkill = player.GetKungfuMount()
	
	if nSkill ~= nil and nlev ~= 0 then
		if nSkill.dwSkillID == 10447 then
			RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14070, 14230, nlev)	--切换输出
		elseif nSkill.dwSkillID == 10448 then
			RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14070, 15090, nlev)	--切换治疗
		end
	end
end
...
function UnApply(dwCharacterID)
	...
	local nlev1 = player.GetSkillLevel(14230)
	local nlev2 = player.GetSkillLevel(15090)
	local nSkill = player.GetKungfuMount()
	
	if nSkill ~= nil and nlev ~= 0 then
		if nSkill.dwSkillID == 10447 and nlev1 ~= 0 then
			RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14230, 14070, nlev1)	--切换输出
		elseif nSkill.dwSkillID == 10448 and nlev2 ~= 0 then
			RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 15090, 14070, nlev2)	--切换治疗
		end
	end

	if player.GetBuff(10056, 1) then
		player.DelBuff(10056, 1)
	end
end
