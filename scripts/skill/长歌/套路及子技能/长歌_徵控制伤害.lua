...
tSkillData =
{
	{nAddRage = 0, nCostRage = 0,nDamageBase = 60, nDamageRand = 6}, -- Level 1 }
...
function GetSkillLevelData(skill)
	...
	-- skill.SetNormalCoolDown(1, 893)   	--技能普通CD
	...
	if dwSkillLevel < 8 then
		skill.nChannelInterval = 32*1.5;
	elseif dwSkillLevel < 33 then
		skill.nChannelInterval = 32 + (dwSkillLevel - 7) * 5*1.5
	else
