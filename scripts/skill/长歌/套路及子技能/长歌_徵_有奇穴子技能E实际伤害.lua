---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_徵_有奇穴子技能E实际伤害.lua
-- 更新时间:	2015/8/6 15:20:15
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 100, nDamageRand = 0, nCostMana = 0}, --level 2
	...
	{nDamageBase = 100, nDamageRand = 0, nCostMana = 0}, --level 11
	{nDamageBase = 100, nDamageRand = 0, nCostMana = 0}, --level 12
	...
	{nDamageBase = 100, nDamageRand = 0, nCostMana = 0}, --level 21
	{nDamageBase = 100, nDamageRand = 0, nCostMana = 0}, --level 22
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(9384, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 36 * 1.6;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (36 + (dwSkillLevel - 9) * 3) * 1.6
	else
		skill.nChannelInterval = 96 * 1.6;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
