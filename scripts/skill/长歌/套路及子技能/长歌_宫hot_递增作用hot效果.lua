---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_宫hot_递增作用hot效果.lua
-- 更新时间:	2015/8/10 19:52:42
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9456, dwSkillLevel);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 30*1.15;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (30 + (dwSkillLevel - 9) * 3)*1.15
	else
		skill.nChannelInterval = 90*1.15;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
