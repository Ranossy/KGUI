---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_相知橙武吞噬角hot.lua
-- 更新时间:	2015/10/24 11:32:59
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_莫问橙武吞噬角dot.lua
-- 更新时间:	2015/10/24 11:28:37
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckSelfBuff(10193, 1, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	--skill.nCostManaBasePercent = 0.5*(1+dwSkillLevel/8)*318;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
