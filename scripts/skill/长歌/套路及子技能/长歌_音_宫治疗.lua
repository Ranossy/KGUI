...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 250 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 250 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 250 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 250 * 0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 250;	-- 技能消耗的内力
	end
	----------------- 聚气相关 -------------------------------------------------
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(14303) ~= lv then 
