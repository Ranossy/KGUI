---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_商_正常dot效果.lua
-- 更新时间:	2015/8/5 14:21:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9358, dwSkillLevel);		-- 设置1号位Buff
	...
	--3秒dot变为2秒了,所以加层系数要对应提高1.5倍
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 48*1.5;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (48 + (dwSkillLevel - 9) * 7)*1.5
	else
		skill.nChannelInterval = 160*1.5;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
