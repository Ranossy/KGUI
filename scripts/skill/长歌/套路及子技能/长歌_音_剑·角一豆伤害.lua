---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·角一豆伤害.lua
-- 更新时间:	2015/8/13 22:44:13
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 200*0.6;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (200 + (dwSkillLevel - 9) * 25)*0.6
	else
		skill.nChannelInterval = 600*0.6;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
