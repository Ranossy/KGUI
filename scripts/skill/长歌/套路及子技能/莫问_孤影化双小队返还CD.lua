---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/莫问_孤影化双小队返还CD.lua
-- 更新时间:	2015/10/23 21:08:51
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nbuff and nbuff.nCustomValue ~= 1 then
		target.nCurrentLife = target.nMaxLife * nbuff.nCustomValue / 100
