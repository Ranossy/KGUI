---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_影子伤害攻击宫伤害.lua
-- 更新时间:	2015/10/9 11:27:31
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
tSkillData =
{
	{nDamageBase = 34, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 45, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 55, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 65, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 75, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 85, nDamageRand = 5, nCostMana = 0}, --level 6
	{nDamageBase = 90, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 93, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 96, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 99, nDamageRand = 10, nCostMana = 0}, --level 10
	{nDamageBase = 102, nDamageRand = 10, nCostMana = 0}, --level 11
	{nDamageBase = 105, nDamageRand = 10, nCostMana = 0}, --level 12
	{nDamageBase = 108, nDamageRand = 10, nCostMana = 0}, --level 13
	{nDamageBase = 111, nDamageRand = 20, nCostMana = 0}, --level 14
	{nDamageBase = 114, nDamageRand = 20, nCostMana = 0}, --level 15
	{nDamageBase = 117, nDamageRand = 20, nCostMana = 0}, --level 16
	{nDamageBase = 120, nDamageRand = 20, nCostMana = 0}, --level 17
	{nDamageBase = 125, nDamageRand = 20, nCostMana = 0}, --level 18
	{nDamageBase = 130, nDamageRand = 30, nCostMana = 0}, --level 19
	{nDamageBase = 135, nDamageRand = 30, nCostMana = 0}, --level 20
	{nDamageBase = 140, nDamageRand = 30, nCostMana = 0}, --level 21
	{nDamageBase = 145, nDamageRand = 30, nCostMana = 0}, --level 22
	{nDamageBase = 150, nDamageRand = 40, nCostMana = 0}, --level 23
	{nDamageBase = 155, nDamageRand = 40, nCostMana = 0}, --level 24
	{nDamageBase = 160, nDamageRand = 40, nCostMana = 0}, --level 25
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_影子伤害攻击宫伤害.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	-----------------技能施放技能需求-------------------------------------------
	--skill.AddCheckSelfLearntSkill(14308, 0, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 80 * 0.2 * 0.85;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (80 + (dwSkillLevel - 9) * 6) * 0.2 * 0.85
	else
		skill.nChannelInterval = 200 * 0.2 *0.85;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	print(1111111)
	npc.AddBuff(npc.dwID, npc.nLevel, 10040, 1)
	--]]
end
