---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_气_云生结海.lua
-- 更新时间:	2015/7/27 15:00:32
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_气_云生结海.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--创建云生结海气场NPC
	local npc = scene.CreateNpcWithEmployerID(44765, target.nX, target.nY, target.nZ, 0, 8 * 16, player.dwID, false, player.dwIdentityVisiableID)
	...
	if npc then
		...
		--持续打效果的buff
		npc.AddBuff(player.dwID, player.nLevel, 9264, 1, 8)
		...
		player.CastSkillXYZ(14150, 1, npc.nX, npc.nY, npc.nZ)
