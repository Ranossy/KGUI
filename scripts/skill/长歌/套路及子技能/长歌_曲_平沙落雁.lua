---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_曲_平沙落雁.lua
-- 更新时间:	2015/8/10 12:02:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_曲_平沙落雁.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--[[
	--学习替换技能面板的标记技能,等新功能
	player.LearnSkillLevel(14351, 1, player.dwID)
	--]]

	RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "FireUIEvent", "CHANGE_ACCUMULATE_STYLE", 4)
