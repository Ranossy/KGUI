---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/孤影化双换技能图标.lua
-- 更新时间:	2016/3/29 16:57:27
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(14164) == 1 then
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14081, 17571, 1)	--孤影化双图标切换
	else
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14081, 14162, 1)	--孤影化双图标切换
	end
end
...
function UnApply(dwCharacterID)
	...
	--print(1111)
	if player.GetSkillLevel(14164) == 1 then
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 17571, 14081, 1)	--孤影化双图标切换
	else
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14162, 14081, 1)	--孤影化双图标切换
	end
	...
	ModityCDToUI(player, 14076, 0, 0)
	ModityCDToUI(player, 14222, 0, 0)
	ModityCDToUI(player, 14223, 0, 0)
	ModityCDToUI(player, 14224, 0, 0)
end
