---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/镇派/长歌_冲秋冥击退.lua
-- 更新时间:	2015/8/18 21:24:38
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 537, 1);			-- 设置Buff 过渡DEBUFF
	...
	--skill.SetNormalCoolDown(1, 889);				--自身CD15秒
	...
	--skill.nCostManaBasePercent = 202;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
	...
	--skill.nBulletVelocity		= 30;				-- 子弹速度，单位 点/帧
	skill.nDismountingRate = PERCENT_BASE;		--落马率为100%
