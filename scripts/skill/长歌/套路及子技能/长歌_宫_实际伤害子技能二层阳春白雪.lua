---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_宫_实际伤害子技能.lua
-- 更新时间:	2015/8/18 9:12:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckSelfBuff(10216, 2, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = 80 + (dwSkillLevel - 9) * 6
	else
		skill.nChannelInterval = 200;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
