---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_曲_万籁之寂.lua
-- 更新时间:	2015/7/14 22:50:30
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_曲_万籁之寂.lua", --属性值1
		0															--属性值2
	);
	...
	skill.SetNormalCoolDown(1, 874);				--自身CD，60秒
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(14090) == 1 then
		player.AddBuff(0, 99, 9206, 1, 9)
	else
		player.AddBuff(0, 99, 9208, 1, 6)
	end
end
