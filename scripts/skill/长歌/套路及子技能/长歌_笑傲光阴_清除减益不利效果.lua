---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_养心决_清风垂露.lua
-- 更新时间:	2013/9/5 10:46:08
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
-- 武功套路  :  养心决
-- 技能名称  :  清风垂露
-- 技能效果  :  给队友解除2个中性内伤效果，给队友解除2个点穴效果
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetNormalCoolDown(1, 430);  --58号CD3分钟
