---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_宫.lua
-- 更新时间:	2015/8/5 9:51:08
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if not player.GetBuff(9430, 1) then
		...
		player.DelGroupBuff(10216, 1)
		player.DelGroupBuff(10217, 1)
		player.AddBuff(player.dwID, player.nLevel, 9430, 1, 16)	--阳春白雪主动技能buff
	else
		--print(7777)
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(14302) ~= 0 and player.GetSkillLevel(14302) ~= lv then
		player.LearnSkillLevel(14302, lv, player.dwID)	--学习宫dot		
	end
