---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/平沙落雁换技能图标.lua
-- 更新时间:	2015/7/31 9:31:38
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--[[
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14073, 14222, 1)	--切换笑傲光阴
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14074, 14223, 1)	--切江逐月天
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14075, 14224, 1)	--切云生结海
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14154, 14225, 1)	--切迴梦逐光
	--]]
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14073, 14222, 1)	--切换笑傲光阴
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14074, 14223, 1)	--切江逐月天
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14075, 14224, 1)	--切云生结海
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14154, 14225, 1)	--切迴梦逐光

	ModityCDToUI(player, 14073, 14222, 0)
	ModityCDToUI(player, 14074, 14223, 0)
	ModityCDToUI(player, 14075, 14224, 0)	
end
...
function UnApply(dwCharacterID)
	...
	--[[
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14222, 14073, 1)	--切换笑傲光阴
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14223, 14074, 1)	--切江逐月天
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14224, 14075, 1)	--切云生结海
	RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14225, 14154, 1)	--切迴梦逐光
	--]]
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14222, 14073, 1)	--切换笑傲光阴
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14223, 14074, 1)	--切江逐月天
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14224, 14075, 1)	--切云生结海
	RemoteCallToClient(player.dwID, "OnSkillReplace", 14225, 14154, 1)	--切迴梦逐光
