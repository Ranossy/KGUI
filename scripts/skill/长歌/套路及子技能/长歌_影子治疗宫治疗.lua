...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.CAST_SKILL_TARGET_DST, -- Call治疗
		15181,
		dwSkillLevel
		);
	skill.AddAttribute(
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32*0.2;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 3)*0.2
	else
		skill.nChannelInterval = 95*0.2;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
