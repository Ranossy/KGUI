---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·宫.lua
-- 更新时间:	2015/8/13 21:55:14
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9507, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 917);	--技能普通CD
	...
	--skill.nCostManaBasePercent = 156;							-- 技能消耗的内力百分比
	...
	elseif dwSkillLevel < 25 then
		...
		skill.nChannelInterval = 250;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
