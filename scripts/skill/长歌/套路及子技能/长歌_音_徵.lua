---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_徵.lua
-- 更新时间:	2015/8/6 9:00:00
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 350 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 350 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 350 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 350 * 0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 350;	-- 技能消耗的内力
	end
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkillLevel(14299, lv, player.dwID)	--学习变徵
	player.LearnSkillLevel(14451, lv, player.dwID)	--学习剑·徵
