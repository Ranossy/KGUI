---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_影子治疗宫治疗_目标小队.lua
-- 更新时间:	2015/10/24 1:13:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_影子治疗宫治疗.lua
-- 更新时间:	2015/10/10 0:58:35
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10189, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32 * 0.2*1.2;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 3) * 0.2*1.2
	else
		skill.nChannelInterval = 95 * 0.2*1.2;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
