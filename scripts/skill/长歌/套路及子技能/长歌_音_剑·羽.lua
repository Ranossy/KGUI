---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_音_剑·羽.lua
-- 更新时间:	2015/9/7 11:33:37
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 918);	--技能普通CD
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 175 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 175 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 175 * 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 175 * 0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 175;	-- 技能消耗的内力
	end
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(1, "scripts/skill/长歌/套路及子技能/长歌_音_剑·羽.lua", 0, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	player.CastSkill(15205, 1) --放必中的冲刺
end
...
function UnApply(dwCharacterID)
	...
	local dwSkillLevel = player.GetSkillLevel(14452)   --获得剑羽母技能
	player.CastSkill(14455, dwSkillLevel)
end
