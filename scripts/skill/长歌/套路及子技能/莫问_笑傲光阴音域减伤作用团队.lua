---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/莫问_笑傲光阴音域减伤作用团队.lua
-- 更新时间:	2015/10/23 21:22:04
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/长歌/套路及子技能/莫问_笑傲光阴音域减伤作用团队.lua",											-- 属性值1
   		0											-- 属性值2
   		);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(15178) ~= 1 then
		player.LearnSkillLevel(15178, 1, player.dwID)
	end
end
