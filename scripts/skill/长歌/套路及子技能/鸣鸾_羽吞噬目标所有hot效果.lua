---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/鸣鸾_羽吞噬目标所有hot效果.lua
-- 更新时间:	2015/9/7 9:32:36
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/鸣鸾_羽吞噬目标所有hot效果.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "FireUIEvent", "UPDATE_SKILL_ICON")
end
