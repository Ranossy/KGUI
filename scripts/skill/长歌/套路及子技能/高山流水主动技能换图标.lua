...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nSkill ~= nil then
		if nSkill.dwSkillID == 10447 then
			local nlev1 = player.GetSkillLevel(14298)
			if nlev1 ~= 0 then
				if player.GetSkillLevel(14308) == 1 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14302, 14298, nlev1)	--瞬发换移动
				else
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14064, 14298, nlev1)	--吟唱换移动
				end
			end
		else
			local nlev2 = player.GetSkillLevel(14300)
			if nlev2 ~= 0 then
				if player.GetSkillLevel(14361) == 1 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14303, 14300, nlev2)	--瞬发换移动
				else
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14137, 14300, nlev2)	--吟唱换移动
				end
			end
		end
	end
...
function UnApply(dwCharacterID)
	...
	if nSkill ~= nil then
		if nSkill.dwSkillID == 10447 then
			local nlev3 = player.GetSkillLevel(14302)
			local nlev4 = player.GetSkillLevel(14064)
			
			if player.GetSkillLevel(14308) == 1 then
				if nlev3 ~= 0 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14298, 14302, nlev3)	--移动换瞬发
				end
			else
				if nlev4 ~= 0 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14298, 14064, nlev4)	--移动换吟唱
				end
			end
		else
			local nlev5 = player.GetSkillLevel(14303)
			local nlev6 = player.GetSkillLevel(14137)

			if player.GetSkillLevel(14361) == 1 then
				if nlev5 ~= 0 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14300, 14303, nlev5)	--移动换瞬发
				end
			else
				if nlev6 ~= 0 then
					RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14300, 14137, nlev6)	--移动换吟唱
				end
			end
		end
	end
