---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/莫问_孤影化双记录小队成员调息时间.lua
-- 更新时间:	2015/10/23 20:42:17
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/长歌/套路及子技能/莫问_孤影化双记录小队成员调息时间.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(15175) ~= 1 then
		player.LearnSkillLevel(15175, 1, player.dwID)
	end
end
