---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/相知_疏影横斜影子群体治疗.lua
-- 更新时间:	2015/10/23 21:54:45
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/长歌/套路及子技能/相知_疏影横斜影子群体治疗.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(15180) ~= 1 then
		player.LearnSkillLevel(15180, 1, player.dwID)
	end
end
