---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_宫dot_增加效果dot效果.lua
-- 更新时间:	2015/8/5 19:50:48
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9375, dwSkillLevel);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 40 * 0.9;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (40 + (dwSkillLevel - 9) * 9) * 0.9
	else
		skill.nChannelInterval = 200 * 0.9;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
