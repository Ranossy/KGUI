---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_角_效果递增且间隔缩短dot效果.lua
-- 更新时间:	2015/8/5 15:26:03
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
		...
		"skill/长歌/套路及子技能/长歌_角_正常dot效果.lua",
		0
		);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9364, dwSkillLevel);		-- 设置1号位Buff
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 48*1.5;
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = (48 + (dwSkillLevel - 9) * 8)*1.5
	else
		skill.nChannelInterval = 180*1.5;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
