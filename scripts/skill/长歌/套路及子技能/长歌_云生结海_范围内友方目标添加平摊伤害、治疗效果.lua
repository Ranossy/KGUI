---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/套路及子技能/长歌_云生结海_范围内友方目标添加平摊伤害、治疗效果.lua
-- 更新时间:	2015/7/27 15:08:20
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/长歌/套路及子技能/长歌_云生结海_范围内友方目标添加平摊伤害、治疗效果.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(14151) == 1 then
		--只平摊伤害效果
		target.AddBuff(player.dwID, player.nLevel, 9266, 1)
	else
		--平摊伤害、治疗效果
		target.AddBuff(player.dwID, player.nLevel, 9265, 1)
	end
end
