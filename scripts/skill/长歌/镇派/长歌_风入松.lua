---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/长歌/镇派/长歌_风入松.lua
-- 更新时间:	2015/8/7 9:21:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--自身加速30%
	player.AddBuff(player.dwID, player.nLevel, 9395, 1)
	--目标减速30%
	target.AddBuff(player.dwID, player.nLevel, 9217, 1)
