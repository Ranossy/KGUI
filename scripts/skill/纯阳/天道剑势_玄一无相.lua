...
tSkillData =
{
	{nBuffID = 132, nBuffLevel = 1, nCostMana = 129},	--level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.BindBuff(1, 132, tSkillData[dwSkillLevel].nBuffLevel)
...
function Apply(dwCharacterID)
	...
	--player.SetTimer(20, "scripts/skill/纯阳/天道剑势_玄一无相.lua", 0, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	--player.SetRepresentID(EQUIPMENT_REPRESENT.WEAPON_ENCHANT2, 2)
end
