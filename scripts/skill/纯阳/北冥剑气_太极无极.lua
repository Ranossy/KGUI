---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/北冥剑气_太极无极.lua
-- 更新时间:	2013/6/22 17:54:20
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetNormalCoolDown(1, 16);	--公共CD
	skill.SetNormalCoolDown(1, 608);	--公共CD
	--破绽段位
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 265*0.2;		-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 265 * 0.4;		-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 265 * 0.6;		-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 265*0.8;		-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 265;		-- 技能消耗的内力
	end
	----------------- 设置杂项参数 ----------------------------------------------------------------------
