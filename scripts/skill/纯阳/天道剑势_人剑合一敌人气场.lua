---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/天道剑势_人剑合一敌人气场.lua
-- 更新时间:	2014/4/8 21:45:19
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/纯阳/天道剑势_人剑合一敌人气场.lua", -- 属性值1
		0															-- 属性值2
		);
	...
	if dwSkillLevel == 1 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级1.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 2 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级2.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 3 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级3.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 4 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级4.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 5 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级5.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 6 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级6.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 7 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级7.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 8 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级8.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 9 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级9.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 10 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级10.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 11 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级11.lua", -- 属性值1
			0															-- 属性值2
		);
	elseif dwSkillLevel == 12 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级12.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 13 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级13.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 14 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级14.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 15 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级15.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 16 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级16.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 17 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级17.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 18 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级18.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 19 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级19.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 20 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级20.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 21 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级21.lua", -- 属性值1
			0															-- 属性值2
			);
	elseif dwSkillLevel == 22 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/纯阳/天道剑势_人剑合一对敌人_等级22.lua", -- 属性值1
			0															-- 属性值2
		);
	end
	--]]
