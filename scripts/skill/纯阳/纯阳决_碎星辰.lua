---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳决_碎星辰.lua
-- 更新时间:	2013/4/22 21:16:16
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 243);		-- 6秒CD
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.SetTimer(45, "scripts/skill/纯阳/纯阳决_碎星辰.lua", npc.dwID, 0)
	end
end
