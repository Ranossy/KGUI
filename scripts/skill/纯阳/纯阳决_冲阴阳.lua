---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳决_冲阴阳.lua
-- 更新时间:	2013/4/22 21:15:50
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.SetTimer(45, "scripts/skill/纯阳/纯阳决_冲阴阳.lua", npc.dwID, 0)
	end
	player.CastSkillXYZ(4081, 1, npc.nX, npc.nY, npc.nZ)	--镇派自身双倍
end
