---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/子技能_天地无极_有玄一剑冲双Buff.lua
-- 更新时间:	2013/12/11 15:14:36
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 1.2/10,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 1.2/10,
		0
	);
	...
	skill.AddSlowCheckDestBuff(450, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	skill.AddSlowCheckDestBuff(574, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	--破绽段位
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 16*1.2*1.1;
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 9) * 4)*1.2*1.1; 
	else
		skill.nChannelInterval = 120*1.2*1.1;
	end
