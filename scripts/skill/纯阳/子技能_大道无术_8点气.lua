...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 554, 4);						-- 设置Debuff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(6466) == 1 then
		target.AddBuff(dwSkillSrcID, player.nLevel, 6082, 4, 1)
	else
		target.AddBuff(dwSkillSrcID, player.nLevel, 554, 4, 1)
	end
end
