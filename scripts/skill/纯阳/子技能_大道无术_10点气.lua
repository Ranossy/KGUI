---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/子技能_大道无术_10点气.lua
-- 更新时间:	2013/4/18 11:34:35
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  子技能_凌太虚_10点气.lua
-- 创建人    :  kingbeyond	
-- 创建时间  :  2008-07-07
-- 用途(模块):  武功技能
-- 武功门派  :  纯阳
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
		...
		"skill/纯阳/子技能_大道无术_10点气.lua", -- 连协技
		0
	);
	--[[
   	skill.AddAttribute(
	...
	--skill.BindBuff(1, 554, 5);						-- 设置Debuff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(6466) == 1 then
		target.AddBuff(dwSkillSrcID, player.nLevel, 6082, 5, 1)
	else
		target.AddBuff(dwSkillSrcID, player.nLevel, 554, 5, 1)
	end
end
