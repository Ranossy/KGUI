---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/秘笈/纯阳_人剑合一_增加AOE距离.lua
-- 更新时间:	2013/10/23 10:46:21
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillRecipeData(skill, SkillRecipeID, SkillRecipeLevel)
	...
	if skill.dwSkillID == 589 or skill.dwSkillID == 1115 then
		if SkillRecipeID == 57 then			-- 真传残页
			skill.nAreaRadius = skill.nAreaRadius + 51
		elseif SkillRecipeID == 58 then		-- 断篇
			skill.nAreaRadius = skill.nAreaRadius + 64
		elseif SkillRecipeID == 59 then		-- 绝章
