---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳_万剑归宗多25%伤害.lua
-- 更新时间:	2015/9/30 14:14:19
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase / 10*1.25,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand / 10*1.25,
		0
	);
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 24*1.25*1.1;
	elseif dwSkillLevel < 31 then
		skill.nChannelInterval = (24 + (dwSkillLevel - 9) * 3)*1.25*1.1;
	else
		skill.nChannelInterval = 100*1.25*1.1;
	end
