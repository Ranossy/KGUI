---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/五方延迟加会心效果.lua
-- 更新时间:	2015/9/30 23:55:24
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if player.GetSkillLevel(14997) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 1908, 1, 4 + nBuffLevel + nStackNum)
	else
		player.AddBuff(player.dwID, player.nLevel, 1908, 1, 4 + nBuffLevel)
	end
end
