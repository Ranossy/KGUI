---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/子技能_三才化生_3点气.lua
-- 更新时间:	2013/5/13 17:23:06
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  子技能_三才化生_3点气.lua
-- 创建人    :  kingbeyond	
-- 创建时间  :  2007-12-11
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/纯阳/子技能_三才化生_3点气.lua", -- 属性值1
		0															-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	--skill.BindBuff(1, 2290, 2);		-- 设置Debuff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(5836) == 0 then
		target.AddBuff(dwSkillSrcID, player.nLevel, 2290, 2, 1)
	end
	if player.GetSkillLevel(5841) == 0 then
		target.AddBuff(dwSkillSrcID, player.nLevel, 5901, 1, 12)
	else
		target.AddBuff(dwSkillSrcID, player.nLevel, 5901, 1, 6)
	end
end
