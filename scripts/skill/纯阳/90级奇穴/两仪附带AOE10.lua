---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/两仪附带AOE10.lua
-- 更新时间:	2013/4/19 9:39:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/ 15*0.2, -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand / 15/20, -- 属性值1
		0																-- 属性值2
	);
