---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/凝神聚气增益AOE.lua
-- 更新时间:	2013/4/18 16:17:17
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/纯阳/90级奇穴/凝神聚气增益AOE.lua", -- 连协技
		0
	);  	  
...
function Apply(dwCharacterID)
	...
	player.nCurrentLife = player.nCurrentLife + player.nMaxLife * 0.005
	player.nCurrentMana = player.nCurrentMana + player.nMaxMana * 0.005
end
