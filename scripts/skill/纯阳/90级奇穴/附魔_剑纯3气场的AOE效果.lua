---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/附魔_剑纯3气场的AOE效果.lua
-- 更新时间:	2014/7/3 10:13:20
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/纯阳/90级奇穴/附魔_剑纯3气场的AOE效果.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--[[
	if nplayer.GetSkillLevel(9352) ~= 1 then
		nplayer.LearnSkillLevel(9352, 1, nplayer.dwID)
	end
	--]]
	nplayer.AddBuff(0, 99, 8186, 1)
	local nbuff = nplayer.GetBuff(8186,1)
	if nbuff then
...
function UnApply(dwCharacterID)
	...
	if nplayer.GetSkillLevel(9352) == 1 then
		nplayer.ForgetSkill(9352)
	end

	if nplayer.GetBuff(8186, 1) then
		nplayer.DelBuff(8186,1)
	end
end
