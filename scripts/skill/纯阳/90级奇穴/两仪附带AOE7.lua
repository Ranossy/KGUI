---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/两仪附带AOE7.lua
-- 更新时间:	2013/4/19 9:38:40
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/ 17*0.2, -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand/ 17/20, -- 属性值1
		0																-- 属性值2
	);
	...
	skill.nChannelInterval = 98; 				-- 通道技间隔时间 
