---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/两仪附带AOE4.lua
-- 更新时间:	2013/5/21 10:32:21
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/ 19*0.2, -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand/ 19/20, -- 属性值1
		0																-- 属性值2
	);
