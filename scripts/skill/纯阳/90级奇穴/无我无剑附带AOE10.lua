---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/无我无剑附带AOE10.lua
-- 更新时间:	2013/4/18 15:26:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/15*10*0.5/10,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand/15*10*0.5/10,
		0
	);
	...
	skill.nChannelInterval = 19*10*0.75 ; 				-- 通道技间隔时间 
