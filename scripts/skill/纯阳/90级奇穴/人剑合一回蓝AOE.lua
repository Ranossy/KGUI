---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/人剑合一回蓝AOE.lua
-- 更新时间:	2013/6/5 0:32:49
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddAttribute(
			...
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 2 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE2.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 3 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE3.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 4 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE4.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 5 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE5.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 6 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE6.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 7 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE7.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 8 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE8.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 9 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE9.lua", -- 连协技
			0
		);
	end
	if dwSkillLevel == 10 then
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
			"skill/纯阳/90级奇穴/人剑合一回蓝AOE10.lua", -- 连协技
			0
		);
	end
