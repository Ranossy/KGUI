---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/90级奇穴/无我无剑附带AOE2.lua
-- 更新时间:	2013/4/18 14:09:45
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/20*0.5,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand/20*0.5,
		0
	);
	...
	skill.nChannelInterval = 19*2*0.75; 				-- 通道技间隔时间 
