---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/子技能_八卦洞玄_10点气.lua
-- 更新时间:	2013/5/28 1:29:07
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  子技能_八卦洞玄_10点气.lua
-- 创建人    :  kingbeyond	
-- 创建时间  :  2007-12-11
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
tSkillData = 
{
	{ nDamageBase = 34, nDamageRand = 0, nCostMana = 0}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * nSubsection / 10, -- 属性值1
		0																-- 属性值2
	);
	...
	skill.BindBuff(1, 557, 5);						-- 设置Debuff
