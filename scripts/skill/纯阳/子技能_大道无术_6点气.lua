...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 554, 3);						-- 设置Debuff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(6466) == 1 then
		target.AddBuff(dwSkillSrcID, player.nLevel, 6082, 3, 1)
	else
		target.AddBuff(dwSkillSrcID, player.nLevel, 554, 3, 1)
	end
end
