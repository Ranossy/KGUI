...
-- 创建人   :  王洋	
-- 创建时间	:  2009-03-12
-- 效果备注	:  四象轮回子技能_只能在目标定身或无法移动时施放成功
------------------------------------------------
...
tSkillData =
{
	{ nDamageBase = 317, 	nDamageRand = 12,  	nRate = 1000},  		--level 1
	{ nDamageBase = 361, 	nDamageRand = 16,  	nRate = 2000},  		--level 2
	{ nDamageBase = 406, 	nDamageRand = 21,   nRate = 3000},  		--level 3
};
