---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳_天地无极打断锁足提高自己AP.lua
-- 更新时间:	2015/9/30 15:30:00
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/纯阳/纯阳_天地无极打断锁足提高自己AP.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9947, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 9948, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--player.AddBuff(player.dwID, player.nLevel, 9948, 1)
end
