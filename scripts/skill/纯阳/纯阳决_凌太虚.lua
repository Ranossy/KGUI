---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳决_凌太虚.lua
-- 更新时间:	2013/4/22 21:16:03
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
--[[
  ...
  --]]  
	...
	skill.SetNormalCoolDown(1, 242);		-- 6秒CD
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.SetTimer(45, "scripts/skill/纯阳/纯阳决_凌太虚.lua", npc.dwID, 0)
	end
end
