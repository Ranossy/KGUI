---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/六合独尊延迟加伤害.lua
-- 更新时间:	2015/9/30 23:21:20
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if nBuffLevel == 1 then
		player.AddBuff(player.dwID, player.nLevel, 9966, 1)
	elseif nBuffLevel == 2 then
		player.DelBuff(9966,1)
		player.AddBuff(player.dwID, player.nLevel, 9966, 2)
	elseif nBuffLevel == 3 then
		player.DelBuff(9966,2)
		player.AddBuff(player.dwID, player.nLevel, 9966, 3)
	else
		player.DelBuff(9966,3)
		player.AddBuff(player.dwID, player.nLevel, 9966, 4)
	end
end
