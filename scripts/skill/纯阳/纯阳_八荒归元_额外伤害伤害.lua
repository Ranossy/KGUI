---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳_八荒归元_额外伤害伤害.lua
-- 更新时间:	2015/9/21 9:48:25
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase / 3 * 0.25,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand / 3 * 0.25,
		0
	);
	...
	skill.AddSlowCheckDestBuff(748, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	skill.nChannelInterval = (128 + 16 * dwSkillLevel) * 0.25*1.1; 				-- 通道技间隔时间
	...
	----------------- 武器伤害相关 ---------------------------------------------
	skill.nWeaponDamagePercent = 2048 * 0.25;			-- 武器伤害百分比,对外功伤害有用。填0表示此次外功攻击不计算武器伤害,1024为100%
