---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/坐忘经_返本归元.lua
-- 更新时间:	2013/4/22 16:38:37
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nBuffID = 50, nBuffLevel = 1, nCostMana = 31}, --level 1         
};
...
function GetSkillLevelData(skill)
	...
	skill.SetPublicCoolDown(16);	-- 公告CD 1.5秒
