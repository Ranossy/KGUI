---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/两仪化形_正常伤害10豆.lua
-- 更新时间:	2013/11/26 11:16:52
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nAddRage = 0, nCostRage = 0, nDamageBase = 300, nDamageRand = 8}, -- Level 1 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 450, nDamageRand = 16}, -- Level 2 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 550, nDamageRand = 23}, -- Level 3 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 650, nDamageRand = 31}, -- Level 4 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 750, nDamageRand = 39}, -- Level 5 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 770, nDamageRand = 47}, -- Level 6 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 790, nDamageRand = 55}, -- Level 7 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 810, nDamageRand = 62}, -- Level 8 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 830, nDamageRand = 70}, -- Level 9 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 850, nDamageRand = 78}, -- Level 10 
	{nAddRage = 0, nCostRage = 0, nDamageBase = 870, nDamageRand = 86}, -- Level 11
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * nSubsection / 100, -- 属性值1
		0																-- 属性值2
	);
	...
	----------------- 施放距离 -------------------------------------------------
	--skill.nMinRadius		= 20 * LENGTH_BASE;		-- 技能施放的最小距离 
	...
	elseif dwSkillLevel < 35 then
		...
		skill.nChannelInterval = 22.5 * nSubsection * 0.85*1.1*1.1*1.05;     -- 通道技间隔时间 
	end
