---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/北冥剑气_太极无极_锁足定身.lua
-- 更新时间:	2013/9/5 10:24:59
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  北冥剑气_太极无极_锁足定身.lua
-- 创建人    :  CBG
-- 创建时间  :  2010-12-2
-- 用途(模块):  武功技能
-- 武功门派  :  纯阳
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestOwnBuff(6424, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
