---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/玄门_实际伤害.lua
-- 更新时间:	2017/4/11 18:50:16
-- 更新用户:	xueyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(11885, 1, BUFF_COMPARE_FLAG.LESS, 0, BUFF_COMPARE_FLAG.LESS);		-- 需求目标Buff
	...
	elseif dwSkillLevel < 17 then
		skill.nChannelInterval = 32 + (dwSkillLevel - 1) * 3; 				-- 通道技间隔时间
	else
