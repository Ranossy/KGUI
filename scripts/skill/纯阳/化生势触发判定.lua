---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/化生势触发判定.lua
-- 更新时间:	2016/3/24 22:45:53
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(10569, 1) then
		player.AddBuff(dwCharacterID, player.nLevel, 1094, 1, 1)
	end
end
