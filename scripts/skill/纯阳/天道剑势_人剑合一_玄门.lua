---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/天道剑势_人剑合一_玄门.lua
-- 更新时间:	2017/4/18 17:55:57
-- 更新用户:	xueyan3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
Include("scripts/skill/纯阳/人剑合一_气场变剑魂.lua")
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1198);						-- 196号CD10秒
...
--	print(1111)
	...
	player.SetTimer(2, "scripts/skill/纯阳/天道剑势_人剑合一_玄门.lua", Npcjzfz.dwID, 0)
