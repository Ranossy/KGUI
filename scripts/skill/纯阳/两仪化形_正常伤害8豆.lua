---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/两仪化形_正常伤害8豆.lua
-- 更新时间:	2013/4/19 9:52:04
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  子技能_两仪交合_8点气.lua
-- 创建人    :  kingbeyond	
-- 创建时间  :  2008-07-08
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(3472, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.SetNormalCoolDown(1, 489);					--公共CD 1.5秒
