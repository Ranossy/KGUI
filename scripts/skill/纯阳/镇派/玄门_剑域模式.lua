---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/镇派/玄门_剑域模式.lua
-- 更新时间:	2017/4/11 19:44:16
-- 更新用户:	xueyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkillLevel(17580, lv, player.dwID)
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if lv ~= 0 then
		--print(111)
	--	RecipeCopy(588, lv, player, 17580)
		RemoteCallToClient(player.dwID, "OnSkillReplace", 588, 17580, lv, 588) 
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 588, 17580, 1)	--吟唱换dot
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "NewSkillPanel_RefeshKungfuSkillAt", 588)
...
function UnApply(dwCharacterID)
	...
	if  lv ~= 0 then
		--print(222)
	--	RecipeCopy(17580, lv, player, 588)
		RemoteCallToClient(player.dwID, "OnSkillReplace", 17580, 588, lv, 17580) 
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 17580, 588, lv)	--dot换吟唱
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "NewSkillPanel_RefeshKungfuSkillAt", 588)
