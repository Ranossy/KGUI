---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳_万剑归宗正常伤害.lua
-- 更新时间:	2015/9/30 14:11:08
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 24*1.1*1.25;
	elseif dwSkillLevel < 31 then
		skill.nChannelInterval = (24 + (dwSkillLevel - 9) * 3)*1.1*1.25;
	else
		skill.nChannelInterval = 100*1.1*1.25;
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--]]
	if player.GetSkillLevel(16901) == 1 then
		player.ModifyCoolDown(83, - 32)
	end
end
