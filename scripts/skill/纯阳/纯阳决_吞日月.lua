---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳决_吞日月.lua
-- 更新时间:	2013/4/22 21:16:25
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.nCostManaBasePercent = 240;	-- 技能消耗的内力
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(14986) == 1 then
		npc = scene.CreateGas(
		dwCharacterID, 4981, 384, 3574,
		623, 2, 0, 0, 0, 0, false,
		1095, 1, 0, 0, 0, 0, false,
	...
	if npc then
		...
		player.SetTimer(45, "scripts/skill/纯阳/纯阳决_吞日月.lua", npc.dwID, 0)
	end
end
