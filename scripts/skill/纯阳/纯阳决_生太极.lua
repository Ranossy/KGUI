---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/纯阳决_生太极.lua
-- 更新时间:	2013/4/22 21:15:28
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(14835) == 1 then
		npc = scene.CreateGas(
			dwCharacterID, 4976, 384, 3574,
			618, 2, 0, 0, 0, 0, true,
			615, 1, 0, 0, 0, 0, false,
	...
	if npc then
		...
		player.SetTimer(45, "scripts/skill/纯阳/纯阳决_生太极.lua", npc.dwID, 0)
	end
end
