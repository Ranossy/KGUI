---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/子技能_气场效果_凌太虚.lua
-- 更新时间:	2015/9/22 8:51:57
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  子技能_气场效果_凌太虚.lua
-- 创建人    :  kingbeyond
-- 创建时间  :  2008-07-09
-- 用途(模块):  武功技能
-- 武功门派  :  无
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/纯阳/子技能_气场效果_凌太虚.lua", -- 属性值1
		0															-- 属性值2
	);

	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(561, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL, dwSkillLevel, BUFF_COMPARE_FLAG.LESS);		-- 需求目标Buff
	--skill.AddSlowCheckDestBuff(2927, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL, dwSkillLevel, BUFF_COMPARE_FLAG.LESS);		-- 需求目标Buff
	--skill.AddSlowCheckDestBuff(2928, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL, dwSkillLevel, BUFF_COMPARE_FLAG.LESS);		-- 需求目标Buff

	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 373, 1)			-- 设置Buff
	skill.BindBuff(1, 561, dwSkillLevel);		-- 设置Debuff
	...
	skill.nLeastFormationPopulation = 6;		-- 结阵的范围的最少队员数（包括队长）
