---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/纯阳/北冥剑气_七星拱瑞.lua
-- 更新时间:	2013/4/18 9:07:34
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
-- 武功套路  :  北冥剑气
-- 技能名称  :  七星拱瑞
-- 技能效果  :  击昏迷对手（效果根据气的格数而定，3~30秒），
--				受到伤害恢复，一次只能有一个目标被昏，效果递减
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.BindBuff(1, 556, dwSkillLevel);			-- 设置Debuff
	...
	skill.nCostManaBasePercent = 291;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
