---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/天策特殊武器_左转.lua
-- 更新时间:	2013/1/29 9:42:28
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local npc = scene.GetNpcByNickName("benhongchi_" .. player.dwID)
	npc.FireAIEvent(2002,0,2)
end
