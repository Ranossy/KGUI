---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/天策特殊武器_判定用.lua
-- 更新时间:	2013/1/16 16:02:26
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetNormalCoolDown(1, 108);
	--skill.SetNormalCoolDown(2, 193);
	--skill.SetNormalCoolDown(CoolDownIndex, nCoolDownID);	--技能普通CD
	skill.SetCheckCoolDown(1, 108);	--只检查不走的CD
	skill.SetCheckCoolDown(2, 193);
	----------------- 经验升级相关 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	--player.ResetCD(108)
	--player.ResetCD(193)
	local n = player.CastSkill(4972, 1)
	if n ~= 1 then
		player.CastSkill(5215, 1)
	end
end
