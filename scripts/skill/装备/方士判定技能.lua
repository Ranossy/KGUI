---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/方士判定技能.lua
-- 更新时间:	2016/6/23 10:34:55
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 30000, nDamageRand = 5000, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE, -- 魔法属性
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.SKILL_SOLAR_DAMAGE_RAND, -- 魔法属性
		tSkillData[dwSkillLevel].nDamageRand, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.CALL_SOLAR_DAMAGE, -- 魔法属性
		0, -- 属性值1
		0											-- 属性值2
		);
	skill.AddAttribute(
		...
		"skill/装备/方士判定技能.lua", -- 属性值1
		0											-- 属性值2
		);

	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10879, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(10862, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
