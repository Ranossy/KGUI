---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_外4号.lua
-- 更新时间:	2015/8/13 10:47:24
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_外4号.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 942);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--
	player.DoAction(player.dwID, 13290) --动作ID
end
