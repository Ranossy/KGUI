---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/寒琼_SKILL_开启技能栏.lua
-- 更新时间:	2016/8/19 11:16:16
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/寒琼_SKILL_开启技能栏.lua",
		0
	);
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(1575, 0) then			--有伞就处理关闭
		...
		player.DoAction(0, 13331)			--播放开伞动作
		player.AddBuff(0, 99, 1576, 16)		--添加开伞后加持伞换动作Buff
	end
end
