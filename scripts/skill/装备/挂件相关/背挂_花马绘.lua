---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_花马绘.lua
-- 更新时间:	2017/5/27 15:18:56
-- 更新用户:	ZHANGYAN0-PC
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/背挂_花马绘.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 1219);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.ApplyDoEmotionAction(106)--表情动作ID
end
