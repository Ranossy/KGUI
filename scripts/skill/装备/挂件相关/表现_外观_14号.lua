---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_外观_14号.lua
-- 更新时间:	2016/10/31 14:53:09
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_外观_14号.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 1162);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--
	player.DoAction(0, 13347)
	player.ApplyDoEmotionAction(83)--表情动作ID
end
