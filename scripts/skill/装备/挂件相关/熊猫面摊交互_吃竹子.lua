---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/熊猫面摊交互_吃竹子.lua
-- 更新时间:	2016/2/20 14:25:25
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	player.DoAction(0, 110030)--背挂吃竹子
	player.SetTimer(6 * GLOBAL.GAME_FPS, "scripts/skill/装备/挂件相关/熊猫面摊交互_吃竹子.lua", 0, 0)
end
