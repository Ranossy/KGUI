---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_外6号.lua
-- 更新时间:	2015/11/8 15:18:43
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
 ...
 ----------------- 魔法属性 -------------------------------------------------
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_外6号.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 990);
...
function Apply(dwCharacterID, dwSkillSrcID)
 ...
 --
	player.DoAction(player.dwID, 13294) -- 动作ID
end
