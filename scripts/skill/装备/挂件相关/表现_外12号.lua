---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_外12号.lua
-- 更新时间:	2016/6/30 20:34:21
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_外12号.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 1071);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--
	player.ApplyDoEmotionAction(70)--表情动作ID
end
