---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_中秋_绿色树.lua
-- 更新时间:	2016/9/12 17:55:17
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	if npcX then
		...
		player.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/装备/挂件相关/背挂_中秋_绿色树.lua", 0, 0)
	end
end
