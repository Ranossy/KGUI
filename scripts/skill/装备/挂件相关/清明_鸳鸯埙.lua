---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/清明_鸳鸯埙.lua
-- 更新时间:	2017/3/29 14:28:29
...
function GetSkillLevelData(skill)
	...
	----------------- 设置Cool down --------------------------------------------
	-- 公共CD
	skill.SetPublicCoolDown(1195);							-- 公共CD 1.5秒
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if player.dwWaistItemIndex ~= 19374 then
		return
	end
	return nPreResult;
end
