---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/鹤梅_开合处理.lua
-- 更新时间:	2015/11/26 15:48:31
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(1575, 0) then			--有伞就处理关闭
		...
		player.DoAction(0, 13298)			--播放开伞动作
		player.AddBuff(0, 99, 1576, 15)	--添加开伞后加持伞换动作Buff
		--动态技能栏添加
