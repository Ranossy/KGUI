---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_小熊猫_召唤.lua
-- 更新时间:	2016/4/19 15:29:10
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1035); -- 技能普通CD
...
function Apply(dwCharacterID)
	...
	-- 召唤宠物
	player.GetScene().CreateFellowPet(51084, player.nX + 30, player.nY + 30, player.nZ + 30, 0, - 1, player.dwID)
	...
	player.AddBuff(0, 99, 10685, 1, 600)
