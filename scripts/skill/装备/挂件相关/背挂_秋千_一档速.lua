---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_秋千_一档速.lua
-- 更新时间:	2016/5/24 10:18:31
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local buff1 = npc.GetBuff(10793, 1)
	if buff1 then
		npc.DelBuff(10793, 1)
	end

	local buff2 = npc.GetBuff(10800, 1)
	if buff2 then
		npc.DelBuff(10800, 1)
	end

	npc.AddBuff(0, 99, 10795, 1, 1000) -- 一档速
