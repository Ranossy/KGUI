---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_七夕_外装_加buff.lua
-- 更新时间:	2016/8/3 10:26:34
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_七夕_外装_加buff.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 1086);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--
	local buff = player.GetBuff(11005, 1)
	if not buff then
		player.AddBuff(0, 99, 11005, 1, 3600)
	end
