---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_秋千2_静止.lua
-- 更新时间:	2017/2/9 19:18:34
-- 更新用户:	FENGMENGJIE-PC
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local buff1 = npc.GetBuff(11691, 1)
	if buff1 then
		npc.DelBuff(11691, 1)
	end
	...
	npc.AddBuff(0, 99, 11689, 1, 1000) -- 静止
