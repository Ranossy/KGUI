---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_外1号.lua
-- 更新时间:	2015/8/13 10:47:17
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_外1号.lua",
		0
	);
	
	skill.SetPublicCoolDown(938);
	skill.SetNormalCoolDown(1, 939);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--
	player.DoAction(player.dwID, 13287) --动作ID
end
