---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/纱伞_交互3.lua
-- 更新时间:	2015/7/30 14:56:08
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if not doodad_now then
		doodad = scene.CreateDoodad(1728, nX, nY, player.nZ, player.nFaceDirection, "ShaSan_" .. player.dwID)
		if doodad then
