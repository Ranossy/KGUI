---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_元宵_外装_依偎.lua
-- 更新时间:	2017/1/17 16:39:10
-- 更新用户:	FENGMENGJIE-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件相关/表现_元宵_外装_依偎.lua",
		0
	);

	skill.SetPublicCoolDown(938);
	--skill.SetNormalCoolDown(1, 1042);
...
function CanCast(player, nPreResult) -- 判断玩家的状态，以判断是否可以发出技能
	...
	------------------------------------------------------------
	local dwRepresentID = player.GetRepresentID(EQUIPMENT_REPRESENT.CHEST_STYLE)
	if dwRepresentID ~= 574 then
		return false
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if targetType ~= TARGET.PLAYER then
		RemoteCallToClient(player.dwID, "OnSendSystemAnnounce", GetEditorString(11, 3382), "yellow")
		return 
	end
...
--===================================M2============================================================
	if player.nRoleType == ROLE_TYPE.STANDARD_MALE and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_MALE then--M2_M2
		player.ApplyDoEmotionAction(85)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_MALE and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_FEMALE then--M2_F2
		player.ApplyDoEmotionAction(85)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_FEMALE and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_MALE then--F2_M2
		player.ApplyDoEmotionAction(85)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_MALE and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_BOY then--M2_M1
		player.ApplyDoEmotionAction(86)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_BOY and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_MALE then--M1_M2
		player.ApplyDoEmotionAction(86)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_MALE and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_GIRL then--M2_F1
		player.ApplyDoEmotionAction(86)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_GIRL and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_MALE then--F1_M2
		player.ApplyDoEmotionAction(86)
--===================================F2============================================================
	elseif player.nRoleType == ROLE_TYPE.STANDARD_FEMALE and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_FEMALE then--F2_F2
		player.ApplyDoEmotionAction(86)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_FEMALE and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_BOY then--F2_M1
		player.ApplyDoEmotionAction(85)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_BOY and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_FEMALE then--M1_F2
		player.ApplyDoEmotionAction(85)
	elseif player.nRoleType == ROLE_TYPE.STANDARD_FEMALE and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_GIRL then--F2_F1
		player.ApplyDoEmotionAction(84)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_GIRL and DstPlayer.nRoleType == ROLE_TYPE.STANDARD_FEMALE then--F1_F2
		player.ApplyDoEmotionAction(84)
--===================================M1============================================================
	elseif player.nRoleType == ROLE_TYPE.LITTLE_BOY and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_BOY then--M1_M1
		player.ApplyDoEmotionAction(84)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_BOY and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_GIRL then--M1_F1
		player.ApplyDoEmotionAction(86)
	elseif player.nRoleType == ROLE_TYPE.LITTLE_GIRL and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_BOY then--F1_M1
		player.ApplyDoEmotionAction(86)
--===================================F1============================================================
	elseif player.nRoleType == ROLE_TYPE.LITTLE_GIRL and DstPlayer.nRoleType == ROLE_TYPE.LITTLE_GIRL then--F1_F1
		player.ApplyDoEmotionAction(85)
	end
end
