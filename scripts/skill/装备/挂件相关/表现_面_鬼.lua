---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/表现_面_鬼.lua
-- 更新时间:	2015/8/13 10:47:26
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	------------------------------------------------------------
	if ArtistActionCheck(player, 13901) then
	    return nPreResult
	end

	if player.dwFaceItemIndex ~= 13901 then --[13901鬼王面具]
		return false
	end
