---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_秋千_交互.lua
-- 更新时间:	2016/6/5 17:31:18
-- 更新用户:	FENGMENGJIE
-- 脚本说明:
----------------------------------------------------------------------<
-------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1045);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	------主驾动作-------------
	local buff1 = caster.GetBuff(10262, 1)
	if buff1 then
		local npc = scene.GetNpcByNickName("qq_fxf0520" .. caster.dwID)
		if npc then
	...
	----------------------------------
	------副驾动作--------------------
	local buff2 = caster.GetBuff(10796, 1)
	if buff2 then
		local buff3 = caster.GetBuff(10802, 1)
		if buff3 then
