---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件相关/背挂_秋千2_一档速.lua
-- 更新时间:	2017/2/9 19:20:38
-- 更新用户:	FENGMENGJIE-PC
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local buff2 = npc.GetBuff(11691, 1)
	if buff2 then
		npc.DelBuff(11691, 1)
	end

	npc.AddBuff(0, 99, 11690, 1, 1000) -- 一档速
