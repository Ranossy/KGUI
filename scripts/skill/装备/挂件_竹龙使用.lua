---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件_竹龙使用.lua
-- 更新时间:	2016/6/1 14:36:07
-- 更新用户:	xutong3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/挂件_竹龙使用.lua",
		0
	);
	skill.SetNormalCoolDown(1, 1054);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if ArtistActionCheck(player, 17537) then
		return nPreResult
	end
	
	if player.dwBackItemIndex ~= 17537 then
		return false
	end
	return nPreResult;
end
...
function Apply(dwCharacterID)
	...
	if player.GetBuff(10811, 1) then
		return
	end
	player.AddBuff(player.dwID,player.nLevel,10811,1,5)
