...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
		--skill.BindBuff(1, 2200, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
         ...
         if player then
         	player.AddBuff(0, 99, 2200, 1)
         	player.nCurrentLife = player.nCurrentLife + 375
