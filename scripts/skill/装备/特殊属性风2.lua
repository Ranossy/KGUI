---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/特殊属性风2.lua
-- 更新时间:	2013/10/22 15:07:11
-- 更新用户:	xueyan-pc
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.BindBuff(1, 6360, dwSkillLevel);
	if dwSkillLevel == 13 then--血魂
		skill.AddAttribute(
			ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, -- 属性作用模式
			ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
			"skill/装备/特殊属性风2.lua", -- 属性值1
			0											-- 属性值2
		);
	end
	----------------- 魔法属性 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player and player.nMoveState ~= MOVE_STATE.ON_DEATH and not player.GetBuff(7913,1) and player.dwShapeShiftID == 0 then
