---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/明教特殊武器_召唤NPC非战斗.lua
-- 更新时间:	2013/1/26 15:28:55
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/明教特殊武器_召唤NPC非战斗.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	local npc = scene.CreateNpc(21701, nX, nY, nZ, 0, 180, player.dwID)
end
