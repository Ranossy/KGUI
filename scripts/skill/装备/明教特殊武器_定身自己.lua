---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/明教特殊武器_定身自己.lua
-- 更新时间:	2013/1/16 10:19:17
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	npc.AddBuff(0, 99, 5138, 1, 1)
	local buff = npc.GetBuff(5138, 1)
	if not buff then
		return
	end
	if buff.nStackNum == 3 then
		npc.AddBuff(0, 99, 5139, 1, 1)
		npc.DelBuff(5138, 1)
		npc.DelBuff(5138, 1)
		npc.DelBuff(5138, 1)
		npc.DelBuff(5137, 1)
