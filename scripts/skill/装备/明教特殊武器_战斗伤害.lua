---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/明教特殊武器_战斗伤害.lua
-- 更新时间:	2013/1/26 14:38:54
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5186, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local targetTP, targetID = npc.GetTarget()
	if IsPlayer(targetID) then
		npc.ModifyThreat(targetID, 3000)
		npc.ModifyThreat(dwSkillSrcID, -3000)
	end
end
