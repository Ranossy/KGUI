---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/腰部挂件沧海行.lua
-- 更新时间:	2013/1/25 14:13:32
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if ArtistActionCheck(player, 8007) then
		return nPreResult
	end
		-- 检查是不是装了背部挂件，腰部用 EQUIPMENT_REPRESENT.WAIST_EXTEND 
	   if player.dwWaistItemIndex ~= 8007 and player.dwWaistItemIndex ~= 19254 then
		   return false
	   end
	return nPreResult;
end
