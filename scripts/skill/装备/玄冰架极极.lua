...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 944);	--技能普通CD
...
if player.dwBackItemIndex ~= 11329 then -- 检查是不是装了背部挂件，腰部用 EQUIPMENT_REPRESENT.WAIST_EXTEND
...
function Apply(dwCharacterID)
	...
	--召唤宠物
	player.GetScene().CreateFellowPet(45620, player.nX + 30, player.nY + 30, player.nZ + 30, 0, -1, player.dwID)
