---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/挂件_七彩风车挥舞.lua
-- 更新时间:	2016/5/25 19:20:40
-- 更新用户:	xutong3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1053);
...
function Apply(dwCharacterID)
	...
	player.DoAction(0, 13984)
	--player.AddBuff(0, 99, 1683, 1)
