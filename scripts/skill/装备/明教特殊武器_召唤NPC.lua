---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/装备/明教特殊武器_召唤NPC.lua
-- 更新时间:	2013/1/28 11:36:05
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/装备/明教特殊武器_召唤NPC.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID)
	...
	--print(player.CastSkillXYZ(5212, 1, nX, nY, nZ))
	if player.bFightState then
		player.CastSkillXYZ(5244, 1, nX, nY, nZ)
	else
		player.CastSkillXYZ(5212, 1, nX, nY, nZ + 500)
		--player.PlaySfx(346, nX, nY, nZ)
	end	
end
