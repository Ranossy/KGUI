---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/装备/狮子头通道1.lua
-- 更新时间:	2012-8-27 14:38:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4203, 1);		-- 设置1号位Buff
	...
	elseif dwSkillLevel == 2 then
		skill.nPrepareFrames = 70;
	elseif dwSkillLevel == 3 then
		skill.nPrepareFrames = 70;
	end
	--skill.nChannelInterval = 8; 				-- 通道技间隔时间 
	--skill.nChannelFrame = 88;	 			-- 通道技持续时间，单位帧数 
