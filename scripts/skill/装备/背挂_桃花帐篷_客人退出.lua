---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/装备/背挂_桃花帐篷_客人退出.lua
-- 更新时间:	2017/5/17 23:52:28
-- 更新用户:	ZHANGYAN0-PC
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if buff1 then
		...
		if npc1 then
			...
			if dwPlayer_fjID == nil then
				if player.GetDynamicSkillGroup() == 340 or player.GetDynamicSkillGroup() == 341 then
	...
	if buff2 then
		local buff6 = player.GetBuff(11973, 1)
		if buff6 then
