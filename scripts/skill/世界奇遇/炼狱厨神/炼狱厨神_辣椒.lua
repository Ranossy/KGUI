---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/世界奇遇/炼狱厨神/炼狱厨神_辣椒.lua
-- 更新时间:	2015/10/13 0:45:20
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10046, 1) then
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 3, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15087)
		player.DelBuff(10046, 1)
		player.SendSystemMessage(GetEditorString(8, 6406))
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_GREEN", GetEditorString(8, 6406), 4)
	end
end
