---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/世界奇遇/炼狱厨神/炼狱厨神_鱼.lua
-- 更新时间:	2015/10/13 0:44:34
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10044, 1) then
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 1, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15085)
		player.DelBuff(10044, 1)
		player.SendSystemMessage(GetEditorString(8, 6405))
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_GREEN", GetEditorString(8, 6405), 4)
	end
end
