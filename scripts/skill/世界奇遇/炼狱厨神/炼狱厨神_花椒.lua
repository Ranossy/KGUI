---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/世界奇遇/炼狱厨神/炼狱厨神_花椒.lua
-- 更新时间:	2015/10/13 0:45:41
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10047, 1) then
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 4, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15088)
		player.DelBuff(10047, 1)
		player.SendSystemMessage(GetEditorString(8, 6400))
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_GREEN", GetEditorString(8, 6400), 4)
	end
end
