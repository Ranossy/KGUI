---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/世界奇遇/寻宝/舞蹈1.lua
-- 更新时间:	2016/7/31 20:09:01
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npc = player.GetScene().GetNpcByNickName("LuLinBoss" .. player.dwID)
	if npc and npc.GetBuff(11014, 2) then 
		npc.SetCustomInteger1(tRobAdventure.tBossCustomValueID.nPlayerDance, 1)
		npc.SetCustomUnsigned4(tRobAdventure.tBossCustomValueID.dwPlayTime, GetCurrentTime())
	end
end
