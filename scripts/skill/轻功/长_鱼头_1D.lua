---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/长_鱼头_1D.lua
-- 更新时间:	2015/10/6 17:58:18
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	player.AddBuff(0, 99, 10041, 1)
	player.AddBuff(0, 99, 10052, 1)
	player.CastSkill(15093, 1)
end
