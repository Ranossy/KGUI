---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/轻功通用/丐帮水冲刺C.lua
-- 更新时间:	2016/5/30 11:20:13
-- 更新用户:	zhangyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	---------
	--执行子技能触发
	local nSkillid = 15955--丐帮水冲刺C执行子技能
	local nSkilllv = 1
	----------
	...
	-------------------------------------------------
	--执行子技能触发
	--player.CastSkill(15955, 1)--丐帮水冲刺C执行子技能
end
