---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/万花/万花_切入.lua
-- 更新时间:	2016/3/22 20:10:53
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
--	player.AddBuff(0, 99, 10052, 1)--长歌拖尾右
	...
	---------
	--执行子技能触发
	local nSkillid = 15555  --万花切入执行子技能
	local nSkilllv = 1		
	----------
	...
	--执行子技能触发
	--	player.CastSkill(15578, 1)--万花切入执行子技能
	--player.CastSkill(15555, 1)--万花切入执行子技能
end
