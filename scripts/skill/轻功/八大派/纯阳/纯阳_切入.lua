---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/纯阳/纯阳_切入.lua
-- 更新时间:	2016/3/22 20:09:02
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
--	player.AddBuff(0, 99, 10052, 1)--长歌拖尾右
	...
	---------
	--执行子技能触发
	local nSkillid = 15567  --纯阳切入执行子技能
	local nSkilllv = 1		
	----------
	...
	----------
	--执行子技能触发
	--player.CastSkill(15567, 1)--纯阳切入执行子技能
end
