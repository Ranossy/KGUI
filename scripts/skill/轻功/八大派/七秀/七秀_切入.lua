---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/七秀/七秀_切入.lua
-- 更新时间:	2016/3/22 20:08:28
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
--	player.AddBuff(0, 99, 10693, 1, 1000)--七秀飘带控制
	...
	---------
	--执行子技能触发
	local nSkillid = 15564  --七秀切入执行子技能
	local nSkilllv = 1		
	----------
	...
	----------
	--执行子技能触发
	--player.CastSkill(15564, 1)--七秀切入执行子技能
end
