---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/七秀/七秀段数第三.lua
-- 更新时间:	2016/3/22 22:04:13
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	--检查，判断等情况
		...
		--player.AddBuff(0, 99, 9891, 1, 60 * 10)--滞空标记
		local buffid_yes = 10694 --七秀飘带
	...
	-------------------------------------------------
	--执行子技能触发
	player.CastSkill(15600, 1)--七秀第三执行子技能
end
