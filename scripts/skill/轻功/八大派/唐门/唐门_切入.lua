---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/唐门/唐门_切入.lua
-- 更新时间:	2016/3/22 20:07:10
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	-------------------------------------------------
	--检查，判断等情况
--	player.AddBuff(0, 99, 10041, 1)--长歌拖尾左
--	player.AddBuff(0, 99, 10052, 1)--长歌拖尾右
		-------------------------------------------------
		...
		player.AddBuff(0, 99, 9891, 5, 60 * 10)--唐门滞空标记
	-------------------------------------------------
	
	--	player.AddBuff(0, 99, 10666, 1, 70)
	...
	--执行子技能触发
--	player.CastSkill(15573, 1)--唐门切入执行
