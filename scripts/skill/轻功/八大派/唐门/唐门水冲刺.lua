---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/唐门/唐门水冲刺.lua
-- 更新时间:	2016/5/30 11:27:26
-- 更新用户:	zhangyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	---------
	--执行子技能触发
	local nSkillid = 15943	--唐门水冲刺执行子技能
	local nSkilllv = 1		
	----------
	...
	-------------------------------------------------
	--执行子技能触发
	--player.CastSkill(15943, 1)--唐门水冲刺执行子技能
end
