---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/藏剑/藏剑_切入.lua
-- 更新时间:	2016/3/22 19:36:00
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	---------
	--执行子技能触发
	local nSkillid = 15558  --藏剑切入执行子技能
	local nSkilllv = 1		
	----------
	...
	----------
	--执行子技能触发
	--player.CastSkill(15558, 1)--藏剑切入执行子技能
end
