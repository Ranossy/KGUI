---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/八大派/少林/少林水冲刺.lua
-- 更新时间:	2016/5/17 20:42:32
-- 更新用户:	zhangyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID)
	...
	---------
	--执行子技能触发
	local nSkillid = 15919	--少林水冲刺执行子技能
	local nSkilllv = 1		
	----------
	...
	-------------------------------------------------
	--执行子技能触发
	--player.CastSkill(15919, 1)--少林水冲刺执行子技能
end
