...
function GetSkillLevelData(skill)
	...
	skill.SetHoardSkill(0, 25, 13189, dwSkillLevel);
	skill.SetHoardSkill(26, 39, 13190, dwSkillLevel);
	skill.SetHoardSkill(40, 46, 13191, dwSkillLevel);
	
	--skill.SetHoardSkill(0, 17, 13189, dwSkillLevel);
	--skill.SetHoardSkill(18, 27, 13190, dwSkillLevel);
	--skill.SetHoardSkill(28, 32, 13191, dwSkillLevel);
