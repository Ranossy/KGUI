---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/霸刀/霸刀段数小跳.lua
-- 更新时间:	2016/9/21 16:11:53
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	--if not player.bSprintFlag then--登顶中使用此技能
		--nPreResult = false
	--end
	return nPreResult;
end
...
--	player.Talk(16838)
	...
	-------------------------------------------------
	--执行子技能触发
	player.CastSkill(16838, 1)--霸刀小跳执行子技能
end
