---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/鱼头地面蓄力.lua
-- 更新时间:	2014/9/23 10:39:51
-- 更新用户:	yutou
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetHoardSkill(0, 5, 13532, dwSkillLevel);
	skill.SetHoardSkill(6, 15, 13481, dwSkillLevel);
	skill.SetHoardSkill(16, 22, 13482, dwSkillLevel);
	skill.SetHoardSkill(23, 30, 13483, dwSkillLevel);
	skill.SetHoardSkill(31, 32, 13482, dwSkillLevel);
	--skill.SetHoardSkill(0, 8, 13185, dwSkillLevel);
	--skill.SetHoardSkill(9, 15, 13186, dwSkillLevel);
	--skill.SetHoardSkill(16, 22, 13187, dwSkillLevel);
	--skill.SetHoardSkill(23, 28, 13188, dwSkillLevel);
	--skill.SetHoardSkill(29, 32, 13187, dwSkillLevel);
	----------------- BUFF相关 -------------------------------------------------
	...
	--skill.SetNormalCoolDown(1, 598);	--技能普通CD
	...
	--skill.nCostManaBasePercent = 0.1 * 1024;					-- 技能消耗的内力
