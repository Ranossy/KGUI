---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/轻功/协同轻功/协同冲刺通用脚本.lua
-- 更新时间:	2017/5/11 11:48:44
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function UnApply(dwCharacterID)
	...
	local bValue = true
	if nTargetType and nTargetType == 4 then
	...
	if tNow then
		--player.Talk("启动22222" .. tNow[1])
		player.CastSkill(tNow[1], tNow[2])
	end
