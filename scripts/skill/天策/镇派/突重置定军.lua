---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/镇派/突重置定军.lua
-- 更新时间:	2015/10/17 22:20:26
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nSkill = nplayer.GetKungfuMount()
	if not nplayer then
		return
	end
	if nSkill ~= nil and nSkill.dwSkillID == 10062 then
		nplayer.AddBuff(nplayer.dwID, nplayer.nLevel, 10107, 1)
	end
end
