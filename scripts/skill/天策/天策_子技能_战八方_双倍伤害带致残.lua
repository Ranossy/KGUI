---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_子技能_战八方_正常伤害AOE.lua
-- 更新时间:	2015/9/21 21:46:02
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32*2;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 3)*2
	else
		skill.nChannelInterval = 100*2;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
