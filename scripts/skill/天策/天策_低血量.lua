---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_低血量.lua
-- 更新时间:	2013/5/30 17:27:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  天策_留侯_格挡重置定军.lua
-- 创建人    : zhanghao
-- 创建时间  :  2011-4-9
-- 用途(模块):  天策
-- 武功门派  : 
...
function GetSkillLevelData(skill)
	...
	--);	   
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(6167, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	
    
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 6160, 1);								-- 设置1号位Buff
	skill.BindBuff(2, 6161, 1);			
	--skill.BindBuff(3, 6167, 1);		-- 设置3号位Buff
