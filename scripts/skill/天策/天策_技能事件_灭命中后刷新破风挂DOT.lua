---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_技能事件_灭命中后刷新破风挂DOT.lua
-- 更新时间:	2013/9/24 10:17:03
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/天策/天策_技能事件_灭命中后刷新破风挂DOT.lua", -- 属性值1
		0														-- 属性值2
		);
	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nSkill ~= nil and nSkill.dwSkillID == 10026 or nSkill.dwSkillID == 10062 then
