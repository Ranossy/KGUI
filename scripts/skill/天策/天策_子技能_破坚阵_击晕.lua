---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_子技能_破坚阵_击晕.lua
-- 更新时间:	2015/9/21 19:21:00
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  天策_技能事件_破坚阵_击倒.lua
-- 创建人    :  张奇
-- 创建时间  :  2008-09-01
-- 用途(模块):  武功技能
-- 武功门派  :  天策
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/天策/天策_子技能_破坚阵_击晕.lua",
		0
		);
	--]]
--	skill.BindBuff(1,719,1);
	...
	skill.AddSlowCheckDestBuff(540, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
