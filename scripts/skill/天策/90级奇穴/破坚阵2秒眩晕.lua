---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/90级奇穴/破坚阵2秒眩晕.lua
-- 更新时间:	2015/9/21 19:32:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(9865, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9866, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 9972, 1);		-- 设置2号位Buff
	...
	skill.SetNormalCoolDown(1, 954);	--技能普通CD
