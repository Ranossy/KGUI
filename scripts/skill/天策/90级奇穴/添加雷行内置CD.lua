---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/90级奇穴/添加雷行内置CD.lua
-- 更新时间:	2016/5/12 19:32:55
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 6127, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	player.AddBuff(player.dwID, player.nLevel, 6127, 1, 1)
end
