---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/90级奇穴/疾风aoe延迟.lua
-- 更新时间:	2013/5/9 9:55:28
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	target.AddBuff(dwCharacterID, player.nLevel, 5863, 1, 1)
	player.AddBuff(dwCharacterID, player.nLevel, 5862, 1, 1)
end
