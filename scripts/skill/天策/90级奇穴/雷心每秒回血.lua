---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/90级奇穴/雷心每秒回血.lua
-- 更新时间:	2015/9/19 23:13:39
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(7913,1) and player.dwShapeShiftID == 0 and player.nCurrentLife <= player.nMaxLife * 0.4 then
		player.nCurrentLife = player.nCurrentLife + player.nMaxLife * 0.03
	else
		player.DelBuff(6161,1)
	end
end
