---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/90级奇穴/附魔_战八方连续伤害.lua
-- 更新时间:	2014/7/16 17:42:46
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/天策/90级奇穴/附魔_战八方连续伤害.lua", -- 属性值1
		0											-- 属性值2
	);
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(9437) == 1 then
		player.ForgetSkill(9437)
	end
