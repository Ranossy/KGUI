---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_奔雷枪术_御持续时间到根据剩余层数回血.lua
-- 更新时间:	2015/9/21 17:44:39
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if player.GetSkillLevel(14828) == 1 and nLeftFrame == 0 and not player.GetBuff(7913,1) and player.dwShapeShiftID == 0 then
		player.nCurrentLife = player.nCurrentLife + player.nMaxLife * 0.05 * nStackNum
	end
