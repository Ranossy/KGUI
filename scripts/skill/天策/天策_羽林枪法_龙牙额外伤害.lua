---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_羽林枪法_龙牙额外伤害.lua
-- 更新时间:	2015/10/1 18:57:22
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nAddRage = 0, nCostRage = 10, nDamage = 81 * 0.5, nDamageRand = 5, }, -- Level 1 
	{nAddRage = 0, nCostRage = 10, nDamage = 94 * 0.5, nDamageRand = 5, }, -- Level 2 
	{nAddRage = 0, nCostRage = 10, nDamage = 107 * 0.5, nDamageRand = 5, }, -- Level 3 
	{nAddRage = 0, nCostRage = 10, nDamage = 120 * 0.5, nDamageRand = 5, }, -- Level 4 
	{nAddRage = 0, nCostRage = 10, nDamage = 133 * 0.5, nDamageRand = 5, }, -- Level 5 
	{nAddRage = 0, nCostRage = 10, nDamage = 146 * 0.5, nDamageRand = 5, }, -- Level 6 
	{nAddRage = 0, nCostRage = 10, nDamage = 159 * 0.5, nDamageRand = 5, }, -- Level 7 
	{nAddRage = 0, nCostRage = 10, nDamage = 172 * 0.5, nDamageRand = 5, }, -- Level 8 
	{nAddRage = 0, nCostRage = 10, nDamage = 185 * 0.5, nDamageRand = 5, }, -- Level 9 
	{nAddRage = 0, nCostRage = 10, nDamage = 198 * 0.5, nDamageRand = 5, }, -- Level 10
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamage*0.1,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand*0.1,
		0
	);
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 100 * 1.1 * 0.1* 1.1;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (100 + (dwSkillLevel - 9) * 5) * 1.1 * 0.1 * 1.1
	else
		skill.nChannelInterval = 197 * 1.1 * 0.1 * 1.1;     -- 通道技间隔时间   
	end
	----------------- 阵法相关 -------------------------------------------------
	...
	----------------- 武器伤害相关 ---------------------------------------------
	skill.nWeaponDamagePercent = 1024*0.1;			-- 武器伤害百分比,对外功伤害有用。填0表示此次外功攻击不计算武器伤害,1024为100%
