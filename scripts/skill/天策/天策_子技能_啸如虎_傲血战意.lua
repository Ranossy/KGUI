---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_子技能_啸如虎_傲血战意.lua
-- 更新时间:	2014/12/11 11:21:22
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  天策_子技能_啸如虎_傲血战意.lua
-- 创建人    :  张奇
-- 创建时间  :  2008-03-5
-- 用途(模块):  武功技能
-- 武功门派  :  天策
...
-- 武功套路  :  虎牙令
-- 技能名称  :  啸如虎
-- 技能效果  :  少于30%生命使用,大幅提高外功AP,大幅提高外功会心值
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/天策/天策_子技能_啸如虎_傲血战意.lua", -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, -- 属性作用模式
