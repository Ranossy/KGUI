---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/天策/天策_游龙骑法_破重围.lua
-- 更新时间:	2015/10/22 17:27:37
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(5523, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.SetDelaySubSkill(12 * 0.528, 6376, dwSkillLevel)
	skill.SetDelaySubSkill(10, 15163, 1)
	skill.SetDelaySubSkill(16, 15163, 2)
	skill.SetDelaySubSkill(17, 15163, 3)
	skill.SetDelaySubSkill(18, 15163, 4)
	skill.SetDelaySubSkill(19, 15163, 5)
	skill.SetDelaySubSkill(20, 15163, 6)
	skill.SetDelaySubSkill(21, 15163, 7)
	skill.SetDelaySubSkill(22, 15163, 8)
	skill.SetDelaySubSkill(23, 15163, 9)
	skill.SetDelaySubSkill(25, 15163, 10)
	skill.SetDelaySubSkill(40, 15163, 11)
	----------------- BUFF相关 -------------------------------------------------
	...
	skill.SetNormalCoolDown(1, 981);	--技能普通CD
...
-- 注意，最终以脚本返回的结果为准
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技
	if not player then
...
function Apply(dwCharacterID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		--target.BeHitted(player.dwID, 5258, 1, 30)
		target.BeHitted(player.dwID, 15158, 1, 30)
	end

	ModityCDToUI(player, 15158, 0, 0)
end
