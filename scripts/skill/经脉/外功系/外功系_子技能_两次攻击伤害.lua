...
tSkillData =
{
   {nCostMana = 0, nAPAdd = 0, nDamageRand = 0, nMinRadius = 0, nMaxRadius = 25, nAngleRange = 128, nPrepareFrames = 0, nBulletVelocity = 0, nBreakRate = 1024},
...
--设置伤害---------	
    ...
    --skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
     skill.AddSlowCheckSelfBuff(3017, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
