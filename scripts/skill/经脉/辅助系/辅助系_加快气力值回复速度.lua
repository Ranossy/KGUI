...
tSkillData =
{
	{nDamage = 2, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamage = 4, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamage = 6, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamage = 8, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamage = 10, nDamageRand = 0, nCostMana = 0},		--level 5
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.ADD_SPRINT_POWER_REVIVE,
