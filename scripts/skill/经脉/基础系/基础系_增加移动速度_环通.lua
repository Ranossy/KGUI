...
tSkillData =
{
	{nMoveSpeedPercent = 11 },		
	{nMoveSpeedPercent = 21 },		
	{nMoveSpeedPercent = 31 },		
	{nMoveSpeedPercent = 41 },		
	{nMoveSpeedPercent = 51 },		
	{nMoveSpeedPercent = 62 },		
	{nMoveSpeedPercent = 72 },		
	{nMoveSpeedPercent = 82 },		
	{nMoveSpeedPercent = 92 },		
	{nMoveSpeedPercent = 102 },						
};          
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nMoveSpeedPercent,
		0
	);
...
function OnSkillLevelUp(skill, player)
	...
	player.AddAchievementCount(1157,2)
