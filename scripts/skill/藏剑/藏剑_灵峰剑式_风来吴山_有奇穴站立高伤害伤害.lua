---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_灵峰剑式_风来吴山_有奇穴站立高伤害伤害.lua
-- 更新时间:	2015/9/12 18:27:05
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddCheckSelfLearntSkill(6543, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	----------------- 设置技能消耗 ---------------------------------------------------------------------
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 80*1.3;
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (80 + (dwSkillLevel - 5) * 15)*1.3
	else
