---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_灵峰剑式_九溪弥烟_伤害AOE.lua
-- 更新时间:	2015/10/7 0:13:54
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 4) * 1) * 1.1*2
	else
		skill.nChannelInterval = 48 * 1.1*2;     -- 通道技间隔时间
	end
