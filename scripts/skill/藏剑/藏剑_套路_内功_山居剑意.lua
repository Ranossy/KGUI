---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_套路_内功_山居剑意.lua
-- 更新时间:	2015/9/25 17:32:43
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_套路_内功_山居剑意.lua
-- 更新时间:	2013/9/6 9:54:47
-- 更新用户:	taoli
-- 脚本说明:
...
--[[	skill.AddAttribute(
    ...
    if dwSkillLevel >= 2 then
    	skill.AddAttribute(
	        ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,
	        ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER,							-- 技能事件335：施展灵峰剑式10%几率获得不耗剑气buff
	        335,
	        0
	    );
    end
...
function OnSkillLevelUp(skill, player)
	...
	--player.LearnSkill(1728);
	player.LearnSkillLevel(1728, dwSkillLevel, player.dwID)
	player.LearnSkill(1729)
end
