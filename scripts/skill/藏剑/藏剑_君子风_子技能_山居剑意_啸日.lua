...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/藏剑_君子风_子技能_山居剑意_啸日.lua",
		0
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,
...
function Apply(dwCharacterID)
	...
	if bResult then
		player.UmountKungfu()
		player.MountKungfu(10144,nWenshuijueLvl)
		player.DelBuff(1903, 1)
		if player.GetBuff(7701, 1) then
			player.DelGroupBuff(7701, 1)
		end
	end
