---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/镇派/藏剑剑_怜光轻剑状态下判定加buff.lua
-- 更新时间:	2014/4/2 12:14:36
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/镇派/藏剑剑_怜光轻剑状态下判定加buff.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetKungfuMount() ~= nil and player.GetKungfuMount().dwSkillID == 10144 and player.GetSkillLevel(5957) == 1 then
		--player.AddBuff(player.dwID, player.nLevel, 7700, 1, 35)
		player.AddBuff(player.dwID, player.nLevel, 7701, 1, 40)
	end
end
