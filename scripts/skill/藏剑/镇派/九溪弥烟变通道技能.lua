---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/镇派/九溪弥烟变通道技能.lua
-- 更新时间:	2015/10/5 18:54:04
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/藏剑/镇派/九溪弥烟变通道技能.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(1579) ~= 0 and player.GetSkillLevel(15053) == 0 then
		local lv = player.GetSkillLevel(1579)
		player.ForgetSkill(1579,0)
		player.LearnSkillLevel(15053, lv, 0)
		RecipeCopy(1579, lv, player, 15053)
		--RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 1579, 15053, lv)
		RemoteCallToClient(player.dwID, "OnSkillReplace", 1579, 15053, lv, 1579) ---九溪弥烟技能替换
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(15053) ~= 0 and player.GetSkillLevel(1579) == 0 then
		local lv = player.GetSkillLevel(15053)
		player.ForgetSkill(15053,0)
		player.LearnSkillLevel(1579, lv, 0)
		RecipeCopy(15053, lv, player, 1579)
		--RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 15053, 1579, lv)
		RemoteCallToClient(player.dwID, "OnSkillReplace", 15053, 1579, lv, 15053) ---九溪弥烟技能替换
