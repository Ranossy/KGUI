---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/镇派/问水调息降低1.5秒.lua
-- 更新时间:	2015/10/14 15:04:31
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/镇派/问水调息降低1.5秒.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetKungfuMount() ~= nil and player.GetKungfuMount().dwSkillID == 10144 and not player.GetBuff(9900, 1) then
