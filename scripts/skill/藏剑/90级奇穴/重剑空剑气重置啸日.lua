---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/90级奇穴/重剑空剑气重置啸日.lua
-- 更新时间:	2013/7/24 9:27:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/90级奇穴/重剑空剑气重置啸日.lua", -- 属性值1
		0														-- 属性值2
	);  
...
function Apply(dwCharacterID)
	...
	--player.AddBuff(dwCharacterID, player.nLevel, 6157, 1, 1)
		--print(5555)
		player.SetTimer(8, "scripts/skill/藏剑/90级奇穴/重剑空剑气重置啸日.lua", 0, 0)
		--[[
...
function OnTimer(player, nParam1, nParam2)
	...
	--print(666666)
		if player.GetCDLeft(347) ~= 0 and player.GetKungfuMount() ~= nil and player.GetKungfuMount().dwSkillID == 10145 then
			--print(7777)
			player.ClearCDTime(347)
			player.AddBuff(dwCharacterID, player.nLevel, 6141, 1, 1)
		end
