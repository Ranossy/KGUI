---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_灵峰剑式_松舍问霞伤害.lua
-- 更新时间:	2017/3/15 15:10:27
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 240, nDamageRand = 15, nCostMana = 0}, --level 1
	{nDamageBase = 250, nDamageRand = 15, nCostMana = 0}, --level 2
	{nDamageBase = 260, nDamageRand = 15, nCostMana = 0}, --level 3
	{nDamageBase = 270, nDamageRand = 15, nCostMana = 0}, --level 4
	{nDamageBase = 280, nDamageRand = 20, nCostMana = 0}, --level 5
	{nDamageBase = 290, nDamageRand = 20, nCostMana = 0}, --level 6
	{nDamageBase = 300, nDamageRand = 20, nCostMana = 0}, --level 7
	{nDamageBase = 310, nDamageRand = 20, nCostMana = 0}, --level 8
	{nDamageBase = 320, nDamageRand = 20, nCostMana = 0}, --level 9
	{nDamageBase = 330, nDamageRand = 20, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/藏剑_灵峰剑式_松舍问霞伤害.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 960);	--技能普通CD
	...
	skill.nChannelInterval = (264 + 32) * (1 + 0.05 * (dwSkillLevel - 1)) * 1.1 * 1.1 * 1.1; 				-- 通道技间隔时间
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--player.SetTimer(4,"scripts/skill/藏剑/藏剑_灵峰剑式_松舍问霞伤害.lua",dwCharacterID,player.nCurrentRage)
end
