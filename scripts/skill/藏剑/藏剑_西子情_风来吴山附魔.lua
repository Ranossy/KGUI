---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_西子情_风来吴山附魔.lua
-- 更新时间:	2015/10/17 20:08:43
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if nStackNum == 1 then
		if nBuffLevel == 1 then
			player.AddBuff(player.dwID, player.nLevel, 10104, 1)
		elseif nBuffLevel == 2 then
			player.DelBuff(10104,1)
			player.AddBuff(player.dwID, player.nLevel, 10104, 2)
		elseif nBuffLevel == 3 then
			player.DelBuff(10104,2)
			player.AddBuff(player.dwID, player.nLevel, 10104, 3)
		elseif nBuffLevel == 4 then
			player.DelBuff(10104,3)
			player.AddBuff(player.dwID, player.nLevel, 10104, 4)
		elseif nBuffLevel == 5 then
			player.DelBuff(10104,4)
			player.AddBuff(player.dwID, player.nLevel, 10104, 5)
		elseif nBuffLevel == 6 then
			player.DelBuff(10104,5)
			player.AddBuff(player.dwID, player.nLevel, 10104, 6)
		else
			player.DelBuff(10104,6)
			player.AddBuff(player.dwID, player.nLevel, 10104, 7)
		end
	end
end
