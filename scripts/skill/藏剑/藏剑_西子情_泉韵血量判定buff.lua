---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_西子情_泉韵血量判定buff.lua
-- 更新时间:	2015/9/12 15:26:57
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nCurrentLife <= player.nMaxLife * 0.4 and not player.GetBuff(9709,1) and player.bFightState ==true then
