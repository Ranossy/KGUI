...
tSkillData =
{
	...
	{ nThreat= 869  },		--level 6             
	{ nThreat= 955   },		--level 7
	{ nThreat= 1040  },		--level 8
	{ nThreat= 1125  },		--level 9
	{ nThreat= 1256  },		--level 10           
};
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(1902, 1, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
