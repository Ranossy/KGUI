---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/藏剑/藏剑_雾锁_添加无视目标防御buff.lua
-- 更新时间:	2017/3/15 16:09:35
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/藏剑/藏剑_雾锁_添加无视目标防御buff.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(4, "scripts/skill/藏剑/藏剑_雾锁_添加无视目标防御buff.lua", 0, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	for i = 1, 3 do
		player.AddBuff(player.dwID, player.nLevel, 9714, 1)
	end
end
