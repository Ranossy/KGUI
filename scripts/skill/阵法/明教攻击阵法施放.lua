...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(4678);--阵法第1重
	player.LearnSkill(4679);--阵法第2重
	player.LearnSkill(4680);--阵法第3重
	player.LearnSkill(4681);--阵法第4重
	player.LearnSkill(4682);--阵法第5重
	player.LearnSkill(4683);--阵法第6重
	player.LearnSkill(4675);--关闭阵法
