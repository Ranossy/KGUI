---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/天策防御阵法施放.lua
-- 更新时间:	2013/5/7 21:47:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(856);--阵法第1重
	player.LearnSkill(758);--阵法第2重
	player.LearnSkill(757);--阵法第3重
	player.LearnSkill(857);--阵法第4重
	player.LearnSkill(858);--阵法第5重
	player.LearnSkill(859);--阵法第6重
	player.LearnSkill(759);--关闭阵法
