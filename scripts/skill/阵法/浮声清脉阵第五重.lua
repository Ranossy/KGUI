---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/浮声清脉阵第五重.lua
-- 更新时间:	2015/8/12 12:32:59
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(9475, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 9483, 1);		-- 设置1号位Buff
	...
	----------------- 阵法相关 -------------------------------------------------
	skill.bIsFormationSkill	= true;			-- 是否阵眼技能
