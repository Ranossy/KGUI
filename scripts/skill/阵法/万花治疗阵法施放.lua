...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(864);--阵法第1重
	player.LearnSkill(865);--阵法第2重
	player.LearnSkill(434);--阵法第3重
	player.LearnSkill(866);--阵法第4重
	player.LearnSkill(867);--阵法第5重
	player.LearnSkill(868);--阵法第6重
	player.LearnSkill(435);--关闭阵法
