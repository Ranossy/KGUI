...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(16155);--阵法第1重
	player.LearnSkill(16156);--阵法第2重
	player.LearnSkill(16157);--阵法第3重
	player.LearnSkill(16158);--阵法第4重
	player.LearnSkill(16159);--阵法第5重
	player.LearnSkill(16160);--阵法第6重
	player.LearnSkill(16152);--关闭阵法	
end
