---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/苍云阵法第四重阵眼获得怒气.lua
-- 更新时间:	2014/10/18 18:04:43
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(2869, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);  --内置6秒CD
