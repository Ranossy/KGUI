...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(4691);--阵法第1重
	player.LearnSkill(4692);--阵法第2重
	player.LearnSkill(4693);--阵法第3重
	player.LearnSkill(4694);--阵法第4重
	player.LearnSkill(4695);--阵法第5重
	player.LearnSkill(4696);--阵法第6重
	player.LearnSkill(4688);--关闭阵法
