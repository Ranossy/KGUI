...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(2494);--阵法第1重
	player.LearnSkill(2495);--阵法第2重
	player.LearnSkill(2496);--阵法第3重
	player.LearnSkill(2497);--阵法第4重
	player.LearnSkill(2498);--阵法第5重
	player.LearnSkill(2499);--阵法第6重
	player.LearnSkill(2480);--关闭阵法
