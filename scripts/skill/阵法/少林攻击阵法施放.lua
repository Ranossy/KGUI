---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/少林攻击阵法施放.lua
-- 更新时间:	2013/5/7 21:35:45
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(893);--阵法第1重
	player.LearnSkill(764);--阵法第2重
	player.LearnSkill(765);--阵法第3重
	player.LearnSkill(894);--阵法第4重
	player.LearnSkill(895);--阵法第5重
	player.LearnSkill(766);--阵法第6重
	player.LearnSkill(767);--关闭阵法
