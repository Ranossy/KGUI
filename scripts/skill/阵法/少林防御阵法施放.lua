...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(890);--阵法第1重
	player.LearnSkill(231);--阵法第2重
	player.LearnSkill(760);--阵法第3重
	player.LearnSkill(891);--阵法第4重
	player.LearnSkill(892);--阵法第5重
	player.LearnSkill(761);--阵法第6重
	player.LearnSkill(762);--关闭阵法
