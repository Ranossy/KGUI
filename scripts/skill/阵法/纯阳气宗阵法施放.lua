...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(872);--阵法第1重
	player.LearnSkill(873);--阵法第2重
	player.LearnSkill(798);--阵法第3重
	player.LearnSkill(874);--阵法第4重
	player.LearnSkill(875);--阵法第5重
	player.LearnSkill(876);--阵法第6重
	player.LearnSkill(799);--关闭阵法
