---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/五毒攻击阵法释放.lua
-- 更新时间:	2013/5/7 21:56:31
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(2501);--阵法第1重
	player.LearnSkill(2502);--阵法第2重
	player.LearnSkill(2503);--阵法第3重
	player.LearnSkill(2504);--阵法第4重
	player.LearnSkill(2505);--阵法第5重
	player.LearnSkill(2506);--阵法第6重
	player.LearnSkill(2486);--关闭阵法
