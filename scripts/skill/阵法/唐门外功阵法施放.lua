---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/唐门外功阵法施放.lua
-- 更新时间:	2013/5/7 21:49:28
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(3335);--阵法第1重
	player.LearnSkill(3336);--阵法第2重
	player.LearnSkill(3337);--阵法第3重
	player.LearnSkill(3338);--阵法第4重
	player.LearnSkill(3339);--阵法第5重
	player.LearnSkill(3340);--阵法第6重
	player.LearnSkill(3323);--关闭阵法
