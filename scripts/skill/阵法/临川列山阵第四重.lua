---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/阵法/临川列山阵第四重.lua
-- 更新时间:	2014/9/29 15:41:49
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(2868, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);   --CD处理
	skill.BindBuff(1, 2868, 1);
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(2, 8339, 1);		-- 设置1号位Buff
