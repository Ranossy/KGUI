...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(887);--阵法第1重
	player.LearnSkill(793);--阵法第2重
	player.LearnSkill(794);--阵法第3重
	player.LearnSkill(796);--阵法第4重
	player.LearnSkill(888);--阵法第5重
	player.LearnSkill(889);--阵法第6重
	player.LearnSkill(795);--关闭阵法
