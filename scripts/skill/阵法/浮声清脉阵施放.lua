...
function OnSkillLevelUp(skill, player)
	local dwSkillLevel = skill.dwLevel;
	player.LearnSkillLevel(14173, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14174, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14175, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14176, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14177, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14178, skill.dwLevel, player.dwID)
	player.LearnSkillLevel(14179, 1, player.dwID) --关阵
