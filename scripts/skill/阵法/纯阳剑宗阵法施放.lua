...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(877);--阵法第1重
	player.LearnSkill(878);--阵法第2重
	player.LearnSkill(879);--阵法第3重
	player.LearnSkill(880);--阵法第4重
	player.LearnSkill(881);--阵法第5重
	player.LearnSkill(882);--阵法第6重
	player.LearnSkill(789);--关闭阵法
