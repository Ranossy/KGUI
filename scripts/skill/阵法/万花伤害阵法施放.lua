...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(869);--阵法第1重
	player.LearnSkill(436);--阵法第2重
	player.LearnSkill(437);--阵法第3重
	player.LearnSkill(870);--阵法第4重
	player.LearnSkill(871);--阵法第5重
	player.LearnSkill(439);--阵法第6重
	player.LearnSkill(528);--关闭阵法
