...
function OnSkillLevelUp(skill, player)
	...
	player.LearnSkill(883);--阵法第1重
	player.LearnSkill(790);--阵法第2重
	player.LearnSkill(791);--阵法第3重
	player.LearnSkill(884);--阵法第4重
	player.LearnSkill(885);--阵法第5重
	player.LearnSkill(886);--阵法第6重
	player.LearnSkill(792);--关闭阵法
