---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/监控散流霞.lua
-- 更新时间:	2016/9/2 11:32:49
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function UnApply(dwCharacterID)
	...
	if player.GetBuff(10814,1) then
		if player.GetSkillLevel(16739) == 1 then
			player.AddBuff(player.dwID, player.nLevel, 11151, 1, 5)
		else
			player.AddBuff(player.dwID, player.nLevel, 11151, 1, 3)
		end
	end
end
