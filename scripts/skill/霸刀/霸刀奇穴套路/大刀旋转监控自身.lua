---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/霸刀奇穴套路/大刀旋转监控自身.lua
-- 更新时间:	2016/9/24 11:18:19
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetOTActionState() ~= 1 and player.GetOTActionState() ~= 2 and not player.GetBuff(11336, 1) then
		player.DelBuff(11077, 1)
	end
end
