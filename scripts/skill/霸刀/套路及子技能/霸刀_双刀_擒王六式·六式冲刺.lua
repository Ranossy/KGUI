---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·六式冲刺.lua
-- 更新时间:	2016/10/2 20:02:44
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·六式冲刺.lua",
		0
	);
	...
	--skill.AddSlowCheckSelfBuff(11282, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	skill.SetDelaySubSkill(4, 16943, dwSkillLevel)
	skill.SetDelaySubSkill(10, 16944, dwSkillLevel)
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 16875, 1, 39)
	end
	...
	player.DelBuff(11282, 1)
	--player.AddBuff(player.dwID, player.nLevel, 11283, 1)
