---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_闹须弥skillmove效果.lua
-- 更新时间:	2016/9/30 20:05:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_双刀_闹须弥skillmove效果.lua",
		0						--1是自己，0是目标
		);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetDelaySubSkill(32, 17061, dwSkillLevel)
	----------------- BUFF相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 16375, 1, 39)
	end
end
