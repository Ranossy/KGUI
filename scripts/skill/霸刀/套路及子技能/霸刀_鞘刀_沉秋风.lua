---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_沉秋风.lua
-- 更新时间:	2016/8/19 14:33:08
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16025) ~= 0 and player.GetSkillLevel(16025) ~= lv then
		player.LearnSkillLevel(16025, lv, player.dwID)
	end

	if player.GetSkillLevel(16386) ~= 0 and player.GetSkillLevel(16386) ~= lv then
		player.LearnSkillLevel(16386, lv, player.dwID)
	end
end
