---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_醉斩白蛇20尺伤害.lua
-- 更新时间:	2016/9/2 16:40:13
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 16*1.2*1.2; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 1) * 3)*1.2*1.2; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 64*1.2*1.2; 				-- 通道技间隔时间
	end
