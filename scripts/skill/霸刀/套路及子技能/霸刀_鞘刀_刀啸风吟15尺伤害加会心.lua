---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_刀啸风吟15尺伤害.lua
-- 更新时间:	2016/9/2 15:45:33
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 100, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 110, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 120, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 130, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 140, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 150, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 160, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 170, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 180, nDamageRand = 10, nCostMana = 0}, --level 9
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 50*1.2*1.15; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (50 + (dwSkillLevel - 1) * 14)*1.2*1.15; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 256*1.2*1.15; 				-- 通道技间隔时间
	end
