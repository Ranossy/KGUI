---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_碎江天.lua
-- 更新时间:	2016/8/3 21:54:03
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16136) ~= 0 and player.GetSkillLevel(16136) ~= lv then
		player.LearnSkillLevel(16136, lv, player.dwID)
	end
end
