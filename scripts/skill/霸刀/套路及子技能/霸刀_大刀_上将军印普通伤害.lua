---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_上将军印普通伤害.lua
-- 更新时间:	2016/9/17 16:31:49
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(11241, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);	-- 需求自身属于自己的Buff
	skill.AddSlowCheckDestOwnBuff(11241, 3, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60*1.3; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 10)*1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 160*1.3; 				-- 通道技间隔时间
	end
