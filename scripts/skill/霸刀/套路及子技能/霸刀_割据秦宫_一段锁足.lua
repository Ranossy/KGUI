---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_一段锁足.lua
-- 更新时间:	2016/9/14 19:41:23
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_割据秦宫_一段锁足.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11150, 1);		-- 设置1号位Buff
	...
	elseif dwSkillLevel < 15 then
		...
		skill.nChannelInterval = 176; 				-- 通道技间隔时间
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(2, "scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_一段锁足.lua", dwCharacterID, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	if IsPlayer(nParam1) then
		player.CastSkill(16768, 1, TARGET.PLAYER, nParam1)
	else
		player.CastSkill(16768, 1, TARGET.NPC, nParam1)
	end
end
