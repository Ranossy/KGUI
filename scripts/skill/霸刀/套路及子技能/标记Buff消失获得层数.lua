---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/标记Buff消失获得层数.lua
-- 更新时间:	2016/9/18 9:36:13
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if player.GetSkillLevel(16807) == 1 then
		---残余伤害递增
		--player.AddBuff(player.dwID, player.nLevel, 11247, nStackNum)
		player.AddBuff(player.dwID, player.nLevel, 11247, 3)
	end
end
