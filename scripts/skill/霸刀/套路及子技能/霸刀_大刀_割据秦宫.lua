---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_割据秦宫.lua
-- 更新时间:	2016/9/2 0:27:03
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_割据秦宫.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 1111);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nMaxOverDraftCount, nDraftCount = player.GetOverDraftCoolDown(1111)
	if nDraftCount == 1 then
		player.CastSkill(16481, lv)
		if player.GetSkillLevel(16732) == 1 then
			player.AddCDTime(1111, 160)
		else
			player.AddCDTime(1111, 320)
		end
	elseif nDraftCount == 2 then
		player.CastSkill(16482, lv)
		if player.GetSkillLevel(16732) == 1 then
			player.AddCDTime(1111, 160)
		else
			player.AddCDTime(1111, 320)
		...
		player.CastSkill(16480, lv)
	end
	player.SetOverDraftCoolDown(1111, nDraftCount + 1)
end
