---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_击倒标记.lua
-- 更新时间:	2016/9/14 20:21:42
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_割据秦宫_击倒标记.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	-----------------技能施放技能需求-------------------------------------------
	skill.AddCheckSelfLearntSkill(16765, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(3, "scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_击倒标记.lua", 0, 0)
	--print(player.AddBuff(player.dwID,player.nLevel,11216,1))
end
...
function OnTimer(player, nParam1, nParam2)
	...
	--if not player.GetBuff(11216, 1)then
	player.AddBuff(player.dwID, player.nLevel, 11216, 3)
end
