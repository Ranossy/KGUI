---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野.lua
-- 更新时间:	2017/3/2 16:38:26
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野.lua",
		0
	);

	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10816, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 大刀姿态
	...
	skill.SetNormalCoolDown(1, 1115);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc_daoqi then
		player.SetTimer(2, "scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野.lua", npc_daoqi.dwID, 0)
...
function OnTimer(player, nParam1, nParam2)
	...
	---距离越远伤害越高,有奇穴才释放25尺伤害子技能,S_16911无视距离打最大伤害，S_16730距离提高5尺
