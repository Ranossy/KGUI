---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/删除空痕奇穴无消耗效果.lua
-- 更新时间:	2016/9/18 17:55:12
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "Character_ShowOutline",player.dwID, 10, 1, {160, 255, 40, 40})
end
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if player.GetBuff(11202, 1) then
		player.DelBuff(11202, 1)
	end

	RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "Character_HideOutline",player.dwID)
end
