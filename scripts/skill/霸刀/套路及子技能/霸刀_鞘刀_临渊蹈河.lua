---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_临渊蹈河.lua
-- 更新时间:	2016/9/15 14:57:33
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_临渊蹈河.lua",
		0						--1是自己，0是目标
	);
	--[[
	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11319, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 1125);	--技能普通CD
	--skill.SetNormalCoolDown(2, 1133);	--技能普通CD
	skill.SetCheckCoolDown(1, 444);	--只检查不走的CD
	skill.SetCheckCoolDown(2, 1143);	--只检查不走的CD
	----------------- 经验升级相关 ---------------------------------------------
