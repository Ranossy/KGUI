---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_腿_绝云逐电伤害效果.lua
-- 更新时间:	2016/9/7 11:32:42
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_腿_绝云逐电伤害效果.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(16595)
	
	----绝云逐电附加易伤
	if lv ~= 0 and player.GetSkillLevel(16695) == 1 then
		player.CastSkill(16675, lv, player.GetSkillTarget())
	end
	---绝云逐电减少破釜沉舟调息
	if player.GetSkillLevel(16696) == 1 then
		player.ModifyCoolDown(1112, -32)
	end
end
