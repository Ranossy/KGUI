---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_西楚悲歌小队增益判定.lua
-- 更新时间:	2016/10/13 18:07:36
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(17054) == 1 then
		--12尺大圈
		player.CastSkillXYZ(17066, 1, npc_self.nX, npc_self.nY, npc_self.nZ)
		--npc_self.CastSkill(17066, 1)
	else
		--8尺小圈
		player.CastSkillXYZ(17066, 2, npc_self.nX, npc_self.nY, npc_self.nZ)
		--npc_self.CastSkill(17066, 2)
	end
end
