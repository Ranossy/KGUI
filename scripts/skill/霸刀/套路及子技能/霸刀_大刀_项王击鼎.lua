---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎.lua
-- 更新时间:	2016/9/12 10:13:10
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 1
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 2
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 3
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 4
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 5
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 6
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 7
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 8
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 9
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 10
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 11
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 12
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 13
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 14
	{nDamageBase = 1000, nDamageRand = 200, nCostMana = 0}, --level 15
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.AddSlowCheckSelfBuff(11148, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--大刀姿态
	skill.AddSlowCheckSelfBuff(11149, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--大刀姿态
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if player.GetSkillLevel(17071) == 1 and player.GetBuff(11475, 1) then
		if player.nCurrentLife <= player.nMaxLife * 0.05 then
			return SKILL_RESULT_CODE.FAILED
		end
	end
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(17078) ~= lv then
		player.LearnSkillLevel(17078, lv, player.dwID)
	end
	if player.GetSkillLevel(17079) ~= lv then
		player.LearnSkillLevel(17079, lv, player.dwID)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--施展招式期间免控
	player.AddBuff(player.dwID, player.nLevel, 11361, 1)
	
	--添加延迟Buff执行奇穴和表现
	player.AddBuff(player.dwID, player.nLevel, 11212, 1)
end
