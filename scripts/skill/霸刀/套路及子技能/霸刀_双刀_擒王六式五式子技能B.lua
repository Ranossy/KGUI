---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式五式子技能B.lua
-- 更新时间:	2016/9/23 23:52:33
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 30, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 35, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 40, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 45, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 50, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 55, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 60, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 65, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 70, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 85, nDamageRand = 15, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 25*1.3; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (25 + (dwSkillLevel - 1) * 10)*1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 128*1.3; 				-- 通道技间隔时间
	end
