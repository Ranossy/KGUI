---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_雷走风切子技能释放判定.lua
-- 更新时间:	2016/9/6 11:13:13
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_雷走风切子技能释放判定.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--local a, b = player.GetSkillTarget()
	...
	local lv = player.GetSkillLevel(16629)
	if target.GetOTActionState() == 1 or target.GetOTActionState() == 2 then
		if IsPlayer(dwCharacterID) then
			player.CastSkill(16632, lv, TARGET.PLAYER, dwCharacterID)
		else
			player.CastSkill(16632, lv, TARGET.NPC, dwCharacterID)
		end
	else
		if IsPlayer(dwCharacterID) then
			player.CastSkill(16631, lv, TARGET.PLAYER, dwCharacterID)
		else
			player.CastSkill(16631, lv, TARGET.NPC, dwCharacterID)
		end
	end
end
