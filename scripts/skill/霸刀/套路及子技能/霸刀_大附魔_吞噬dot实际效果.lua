---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大附魔_吞噬dot实际效果.lua
-- 更新时间:	2016/10/14 15:19:14
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/霸刀/套路及子技能/霸刀_大附魔_吞噬dot实际效果.lua",											-- 属性值1
   		0											-- 属性值2
   		);
	...
	skill.AddSlowCheckDestOwnBuff(11447, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nLev = player.GetSkillLevel(17057)
	if nLev ~= 0 then
		local nbuff = target.GetBuffByOwner(11447, nLev, player.dwID)
		if nbuff then
			target.SetBuffNextActiveFrame(nbuff.nIndex, 1 + GetLogicFrameCount())
		end
	end
end
