---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_二段实际伤害.lua
-- 更新时间:	2016/10/6 10:40:27
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 32 * 1.05*0.9; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 1) * 9) * 1.05*0.9; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 176 * 1.05*0.9; 				-- 通道技间隔时间
	end
