---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_闹须弥_流血刷新效果.lua
-- 更新时间:	2016/10/12 10:25:29
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/霸刀/套路及子技能/霸刀_闹须弥_流血刷新效果.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nlev ~= 0 then
		if IsPlayer(dwCharacterID) then
			player.CastSkill(17060, nlev, TARGET.PLAYER, dwCharacterID)
		else
			player.CastSkill(17060, nlev, TARGET.NPC, dwCharacterID)
		end
	end
end
