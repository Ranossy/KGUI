---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_腿_龙骧虎步.lua
-- 更新时间:	2016/9/4 0:11:46
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16628) ~= lv then
		player.LearnSkillLevel(16628, lv, player.dwID)
	end

	if skill.dwLevel == skill.dwMaxLevel and not player.IsAchievementAcquired(5479) then
		player.AcquireAchievement(5479)
	end
end
