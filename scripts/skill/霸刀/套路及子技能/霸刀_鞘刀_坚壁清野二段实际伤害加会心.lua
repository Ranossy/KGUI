---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野残留实际伤害.lua
-- 更新时间:	2016/9/16 16:36:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 20, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 30, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 40, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 50, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 60, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 70, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 80, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 90, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 100, nDamageRand = 15, nCostMana = 0}, --level 10
	{nDamageBase = 110, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 120, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 130, nDamageRand = 20, nCostMana = 0}, --level 8
	{nDamageBase = 140, nDamageRand = 20, nCostMana = 0}, --level 9
	{nDamageBase = 150, nDamageRand = 20, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野残留实际伤害.lua",
		0
	);

	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(11235, 11, BUFF_COMPARE_FLAG.LESS, 2, BUFF_COMPARE_FLAG.LESS);		-- 需求自身Buff   --避免同时攻击目标多次
	...
	--skill.nMaxHitRadius = 1 * 64					--距离释放者的最大距离限定s
	--skill.nMaxHoodleRadius = 10 * LENGTH_BASE  	--弹射搜索距离
	--skill.nMaxSearchCount = 1 					--是否限制弹射目标(0为不限 1为只打一个目标)
	----------------- 作用范围 -------------------------------------------------
	--skill.nProtectRadius = 5 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	--skill.nHeight = 8 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = 60 + (dwSkillLevel - 1) * 20; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 352; 				-- 通道技间隔时间
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.nCurrentSunEnergy = player.nCurrentSunEnergy + math.min(2, player.nMaxSunEnergy - player.nCurrentSunEnergy)
end
