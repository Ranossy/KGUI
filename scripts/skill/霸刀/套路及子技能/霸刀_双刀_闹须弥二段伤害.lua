---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_闹须弥二段伤害.lua
-- 更新时间:	2016/10/12 11:43:34
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (50 + (dwSkillLevel - 1) * 25); 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 290; 				-- 通道技间隔时间
	end
