---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/逐鹿延迟执行.lua
-- 更新时间:	2016/9/11 19:50:08
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	--[[
	if player.GetBuff(11208, 3) then
		player.AddBuff(player.dwID, player.nLevel, 11208, 3)
		player.AddBuff(player.dwID, player.nLevel, 11333, 1)
	elseif player.GetBuff(11208, 2) then
		player.DelBuff(11208, 2)
		player.AddBuff(player.dwID, player.nLevel, 11208, 3)
		player.AddBuff(player.dwID, player.nLevel, 11333, 1)
	elseif player.GetBuff(11208, 1) then
		player.DelBuff(11208, 1)
		player.AddBuff(player.dwID, player.nLevel, 11208, 2)
		player.AddBuff(player.dwID, player.nLevel, 11333, 1)
	else
		player.AddBuff(player.dwID, player.nLevel, 11208, 1)
		player.AddBuff(player.dwID, player.nLevel, 11333, 1)
	end
	--]]
	local nMark = 0
