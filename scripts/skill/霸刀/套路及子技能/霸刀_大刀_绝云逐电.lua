---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_绝云逐电.lua
-- 更新时间:	2016/9/2 21:55:01
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_绝云逐电.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 1116);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16595) ~= 0 and player.GetSkillLevel(16595) ~= lv then
		player.LearnSkillLevel(16595, lv, player.dwID)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(16626)
	local nMaxOverDraftCount, nDraftCount = player.GetOverDraftCoolDown(1116)
	if nDraftCount ~= 0 then
		player.AddCDTime(1116, 128)
	end

	player.CastSkill(16630, lv)
	player.SetOverDraftCoolDown(1116, nDraftCount + 1)
end
