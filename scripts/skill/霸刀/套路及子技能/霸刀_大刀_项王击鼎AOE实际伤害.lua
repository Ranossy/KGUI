---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎AOE实际伤害.lua
-- 更新时间:	2016/9/17 23:12:23
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 50, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 60, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 70, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 80, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 90, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 110, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 120, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 130, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 140, nDamageRand = 15, nCostMana = 0}, --level 10
	{nDamageBase = 150, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 160, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 170, nDamageRand = 15, nCostMana = 0}, --level 8
	{nDamageBase = 180, nDamageRand = 15, nCostMana = 0}, --level 9
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎AOE实际伤害.lua",
		0
	);
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 16*0.9; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 1) * 7)*0.9; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 128*0.9; 				-- 通道技间隔时间
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	---删除项王击鼎增加跳数和时长Buff
	for i = 1, 9 do
		player.DelBuff(11208, i)
		player.DelBuff(11209, i)
		player.DelGroupBuff(11332, 1)
		player.DelGroupBuff(11333, 1)
	end
	--[[
	---项王击鼎减少破釜沉舟调息
	if player.GetSkillLevel(16696) == 1 then
		player.ModifyCoolDown(1112, - 16)
	end
	--]]
	---秘籍附带减速
	if player.IsSkillRecipeActive(4146, 1) then
		target.AddBuff(player.dwID, player.nLevel, 11245, 1)
		--target.AddBuff(player.dwID, player.nLevel, 562, 22)
	end
end
