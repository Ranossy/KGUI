---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/坚壁清野npc标记技能.lua
-- 更新时间:	2016/9/16 21:46:47
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/坚壁清野npc标记技能.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	target.CastSkill(16793, 1)
	--[[
	if player.GetSkillLevel(16730) == 1 then
		target.CastSkill(16928, 1)
	else
		target.CastSkill(16793, 1)
	end
	--]]
	--[[
	--友方目标加速技能调息
	if player.GetSkillLevel(16809) == 1 then
		target.CastSkill(16810, 1)
	end
	--]]
end
