---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_沉秋风.lua
-- 更新时间:	2016/8/19 14:34:02
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16085) ~= 0 and player.GetSkillLevel(16085) ~= lv then
		player.LearnSkillLevel(16085, lv, player.dwID)
	end
end
