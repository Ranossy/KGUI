---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_碎江天_实际伤害效果.lua
-- 更新时间:	2016/9/4 15:08:40
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 40, nDamageRand = 10, nCostMana = 0}, --level 2
	{nDamageBase = 60, nDamageRand = 10, nCostMana = 0}, --level 3
	{nDamageBase = 80, nDamageRand = 10, nCostMana = 0}, --level 4
	{nDamageBase = 100, nDamageRand = 10, nCostMana = 0}, --level 5
	{nDamageBase = 120, nDamageRand = 20, nCostMana = 0}, --level 6
	{nDamageBase = 140, nDamageRand = 20, nCostMana = 0}, --level 7
	{nDamageBase = 160, nDamageRand = 20, nCostMana = 0}, --level 8
	{nDamageBase = 180, nDamageRand = 20, nCostMana = 0}, --level 9
	{nDamageBase = 200, nDamageRand = 20, nCostMana = 0}, --level 10
	{nDamageBase = 220, nDamageRand = 30, nCostMana = 0}, --level 11
	{nDamageBase = 240, nDamageRand = 30, nCostMana = 0}, --level 12
	{nDamageBase = 260, nDamageRand = 30, nCostMana = 0}, --level 13
	{nDamageBase = 280, nDamageRand = 30, nCostMana = 0}, --level 14
	{nDamageBase = 300, nDamageRand = 30, nCostMana = 0}, --level 15
}
;
--设置武功技能级别相关数值
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(11001, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	--skill.SetNormalCoolDown(1, 1062);	--技能普通CD
	...
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = 48 + (dwSkillLevel - 1) * 18;
	else
		skill.nChannelInterval = 304; 				-- 通道技间隔时间	
	end
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if player.nCurrentRage < nRageCost and player.nCurrentEnergy < nEnergyCost then
		return SKILL_RESULT_CODE.FAILED
	end
	--]]
	return nPreResult;
