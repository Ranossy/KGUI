---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_大刀绝沧海.lua
-- 更新时间:	2016/8/3 17:44:51
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16330) ~= 0 and player.GetSkillLevel(16330) ~= lv then 
		player.LearnSkillLevel(16330, lv, player.dwID)	
	end
