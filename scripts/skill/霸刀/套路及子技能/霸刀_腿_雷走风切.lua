---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_腿_雷走风切.lua
-- 更新时间:	2016/9/3 17:16:35
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1110);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16629) ~= lv then
		player.LearnSkillLevel(16629, lv, player.dwID)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(1111)
	local lv = player.GetSkillLevel(16598)
	if target.GetOTActionState() == 1 or target.GetOTActionState() == 2 then
		player.CastSkill(16600, lv, player.GetSkillTarget())
	else
		player.CastSkill(16599, lv, player.GetSkillTarget())
	end
end
