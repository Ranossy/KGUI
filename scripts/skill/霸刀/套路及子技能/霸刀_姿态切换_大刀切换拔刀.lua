---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_姿态切换_大刀切换拔刀.lua
-- 更新时间:	2016/9/5 0:09:43
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_姿态切换_大刀切换拔刀.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if lv_SDleizoufengqie ~= 0 then
		...
		RecipeCopy(16629, lv_SDleizoufengqie, player, 16598)
	end
	...
	--踏宴扬旗从透支切单次OB通知
	ModityCDToUI(player, 16633, 16460, 0)
end
