---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野Npc增益矩形技能.lua
-- 更新时间:	2016/9/18 14:32:26
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野Npc增益矩形技能.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(77777)
	local playerlist = player.GetPartyMemberList()
	if not playerlist then
		playerlist = {player.dwID}
	end
	for i = 1, #playerlist do
		if dwCharacterID == playerlist[i] then
			target.AddBuff(player.dwID, player.nLevel, 11249, 1)
		end
	end
end
