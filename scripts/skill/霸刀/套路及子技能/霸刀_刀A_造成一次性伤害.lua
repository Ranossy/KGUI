---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_刀A_造成一次性伤害.lua
-- 更新时间:	2016/6/24 16:12:39
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2222, nDamageRand = 3333, nCostMana = 4444}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_刀A_造成一次性伤害.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(10916, 1) then
		player.AddBuff(player.dwID, player.nLevel, 10916, 1)
	else
		player.DelBuff(10916,1)
	end
end
