---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野5尺实际伤害.lua
-- 更新时间:	2016/9/15 20:50:59
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60*1.2*0.7; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 16)*1.2*0.7; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 288*1.2*0.7; 				-- 通道技间隔时间
	end
