---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_殷雷腿_踏宴扬旗.lua
-- 更新时间:	2016/9/3 22:22:40
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10816, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		--不是鞘刀姿态
	skill.AddSlowCheckSelfBuff(11077, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--霸刀大刀旋转
	skill.AddSlowCheckSelfBuff(10815, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 不是大刀姿态
	skill.AddSlowCheckSelfBuff(11152, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 散流霞监控状态
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11112, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 1098);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16633) ~= lv then
		player.LearnSkillLevel(16633, lv, player.dwID)
	end
end
