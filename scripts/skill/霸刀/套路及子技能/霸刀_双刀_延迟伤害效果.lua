---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_延迟伤害效果.lua
-- 更新时间:	2016/9/6 23:26:35
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --冲到身边后将放位移技
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_双刀_延迟伤害效果.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(11077, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--霸刀大刀旋转
	skill.AddSlowCheckSelfBuff(10814, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	--需要双刀姿态Buff
	skill.AddSlowCheckSelfBuff(11448, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 无二段buff
	...
	--skill.SetDelaySubSkill(2, 16377, 1)
	--skill.SetDelaySubSkill(2, 16744, 1)
	--skill.SetDelaySubSkill(4, 16377, 2)
	--skill.SetDelaySubSkill(4, 16744, 2)
	--skill.SetDelaySubSkill(16, 16377, 2)
	--skill.SetDelaySubSkill(16, 16744, 2)
	--skill.SetDelaySubSkill(32, 16377, 2)
	--skill.SetDelaySubSkill(32, 16744, 2)
	--skill.SetDelaySubSkill(48, 16377, 2)
	--skill.SetDelaySubSkill(48, 16744, 2)
	--skill.SetDelaySubSkill(64, 16377, 2)
	--skill.SetDelaySubSkill(64, 16744, 2)
	--skill.SetDelaySubSkill(78, 16377, 2)
	--skill.SetDelaySubSkill(78, 16744, 2)
	--skill.SetDelaySubSkill(80, 16378, 1)
	--skill.SetDelaySubSkill(80, 16378, 2)
	--skill.SetDelaySubSkill(80, 16378, 3)
	--skill.SetDelaySubSkill(80, 16378, 4)
	--skill.SetDelaySubSkill(80, 16378, 5)
	--skill.SetDelaySubSkill(80, 16378, 6)
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11167, 1);		-- 设置1号位Buff
	...
	--skill.SetNormalCoolDown(1, 1089);	--技能普通CD
	--skill.SetNormalCoolDown(2, 1133);	--技能普通CD
	skill.SetCheckCoolDown(1, 444);	--只检查不走的CD
	skill.SetCheckCoolDown(2, 1133);	--只检查不走的CD
	----------------- 经验升级相关 ---------------------------------------------
