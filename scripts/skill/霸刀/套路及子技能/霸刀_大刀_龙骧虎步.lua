---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_龙骧虎步.lua
-- 更新时间:	2016/9/12 21:24:53
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_龙骧虎步.lua",
		0
	);
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16028) ~= lv then
		player.LearnSkillLevel(16028, lv, player.dwID)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(16628)
	if not player.GetBuff(11218, 1) then
		player.CastSkill(16774, lv)
		player.AddBuff(player.dwID, player.nLevel, 11218, 1)
	else
		player.DelBuff(11218, 1)
		player.CastSkill(16775, lv)
	end
end
