---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_锁足标记.lua
-- 更新时间:	2016/9/14 19:50:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_割据秦宫_锁足标记.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(dwSkillSrcID)
	player.SetTimer(3, "scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_锁足标记.lua", 0, 0)
...
function OnTimer(player, nParam1, nParam2)
	...
	player.AddBuff(player.dwID, player.nLevel, 11216, 1)
	--end
end
