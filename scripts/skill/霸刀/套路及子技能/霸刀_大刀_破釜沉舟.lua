---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_破釜沉舟.lua
-- 更新时间:	2016/10/5 14:44:47
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 90, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 86, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 110, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 130, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 150, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 170, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 190, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 210, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 230, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 250, nDamageRand = 15, nCostMana = 0}, --level 10
	{nDamageBase = 270, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 290, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 310, nDamageRand = 15, nCostMana = 0}, --level 8
	{nDamageBase = 330, nDamageRand = 15, nCostMana = 0}, --level 9
	{nDamageBase = 350, nDamageRand = 20, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_破釜沉舟.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/霸刀/套路及子技能/破釜沉舟无调息.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 1112);	--技能普通CD
	...
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (80 + (dwSkillLevel - 1) * 22)*0.9; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 400*0.9; 				-- 通道技间隔时间
	end
...
function OnSkillLevelUp(skill, player)
	if skill.dwLevel == skill.dwMaxLevel and not player.IsAchievementAcquired(5474) then
		player.AcquireAchievement(5474)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsSkillRecipeActive(4154, 1) then
		player.AddBuff(player.dwID, player.nLevel, 11344, 1)
	end
end
