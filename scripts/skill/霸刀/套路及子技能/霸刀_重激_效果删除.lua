---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_重激_效果删除.lua
-- 更新时间:	2016/9/20 10:24:20
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_重激_效果删除.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(2, "scripts/skill/霸刀/套路及子技能/霸刀_重激_效果删除.lua", 0, 0)
end
