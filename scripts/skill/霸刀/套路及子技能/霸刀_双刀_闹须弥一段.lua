---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_闹须弥一段.lua
-- 更新时间:	2016/10/12 8:49:13
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckSelfBuff(11448, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 无二段buff
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16375) ~= lv then
		player.LearnSkillLevel(16375, lv, player.dwID)
	end
end
...
function UnApply(dwCharacterID)
	...
	local nlv = player.GetSkillLevel(17057)
	if nlv ~= 0 then
		player.CastSkill(17058, nlv)
	end
end
