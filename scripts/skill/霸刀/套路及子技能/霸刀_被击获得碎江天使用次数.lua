---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_被击获得碎江天使用次数.lua
-- 更新时间:	2016/9/17 23:47:00
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_被击获得碎江天使用次数.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsSkillRecipeActive(4162, 1) then
		if not player.GetBuff(11001,1) then
			player.AddBuff(player.dwID, player.nLevel, 11001, 1, 1)
		elseif player.GetSkillLevel(16930) == 1 then
			player.AddBuff(player.dwID, player.nLevel, 11001, 1, 1)	
		end
	end
end
