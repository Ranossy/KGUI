---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_闹须弥_流血刷新效果实际dot伤害.lua
-- 更新时间:	2016/10/12 10:33:19
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 50*1.3; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (50 + (dwSkillLevel - 1) * 25)*1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 280*1.3; 				-- 通道技间隔时间
	end
