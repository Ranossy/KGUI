---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_腿_龙骧虎步冲刺.lua
-- 更新时间:	2016/11/11 15:59:07
-- 更新用户:	SHITONG1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDashSpeed = 100}, -- Level 1 Dash速度单位 点/帧
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_腿_龙骧虎步冲刺.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10814, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckSelfBuff(11156, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身有冲刺监控Buff
