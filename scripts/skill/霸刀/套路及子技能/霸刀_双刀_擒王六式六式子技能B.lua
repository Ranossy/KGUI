---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式六式子技能B.lua
-- 更新时间:	2016/9/23 23:52:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 95, nDamageRand = 15, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 30*1.3; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (30 + (dwSkillLevel - 1) * 12) * 1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 144*1.3; 				-- 通道技间隔时间
	end
