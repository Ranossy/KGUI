---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_沉秋风子弹表现技能.lua
-- 更新时间:	2016/8/10 10:51:20
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 1111, nDamageRand = 2222, nCostMana = 3333}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	--skill.AddSlowCheckDestBuff(10816, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(10915, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求自身属于自己的Buff
	...
	skill.nSkillBulletSubType = 2;				--子弹的子类型,(和BulletType一起确定不同子弹的不同表现，取值范围0~256)
