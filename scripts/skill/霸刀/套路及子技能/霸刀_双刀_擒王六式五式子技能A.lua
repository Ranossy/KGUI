---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式五式子技能A.lua
-- 更新时间:	2016/9/23 23:52:26
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 80, nDamageRand = 10, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 10 then
		...
		skill.nChannelInterval = 112*1.3; 				-- 通道技间隔时间
	end
