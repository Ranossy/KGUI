---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎旋转伤害递增.lua
-- 更新时间:	2016/9/13 12:37:57
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎旋转伤害递增.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	-----------------技能施放技能需求-------------------------------------------
	skill.AddCheckSelfLearntSkill(16777, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	---项王击鼎伤害递增
	if player.GetBuff(11222, 1) then
		player.DelBuff(11222, 1)
		player.AddBuff(player.dwID, player.nLevel, 11222, 2)
	elseif player.GetBuff(11222, 2) then
		player.DelBuff(11222, 2)
		player.AddBuff(player.dwID, player.nLevel, 11222, 3)
	elseif player.GetBuff(11222, 3) then
		player.DelBuff(11222, 3)
		player.AddBuff(player.dwID, player.nLevel, 11222, 4)
	elseif player.GetBuff(11222, 4) then
		player.DelBuff(11222, 4)
		player.AddBuff(player.dwID, player.nLevel, 11222, 5)
	elseif player.GetBuff(11222, 5) then
		player.DelBuff(11222, 5)
		player.AddBuff(player.dwID, player.nLevel, 11222, 6)
	elseif player.GetBuff(11222, 6) then
		player.DelBuff(11222, 6)
		player.AddBuff(player.dwID, player.nLevel, 11222, 7)
	elseif player.GetBuff(11222, 7) then
		player.DelBuff(11222, 7)
		player.AddBuff(player.dwID, player.nLevel, 11222, 8)
	elseif player.GetBuff(11222, 8) then
		player.DelBuff(11222, 8)
		player.AddBuff(player.dwID, player.nLevel, 11222, 9)
	elseif player.GetBuff(11222,9) then
		player.DelBuff(11222, 9)
		player.AddBuff(player.dwID, player.nLevel, 11222, 10)
	elseif player.GetBuff(11222,10) then
		player.DelBuff(11222, 10)
		player.AddBuff(player.dwID, player.nLevel, 11222, 11)
	elseif player.GetBuff(11222,11) then
		player.DelBuff(11222, 11)
		player.AddBuff(player.dwID, player.nLevel, 11222, 12)
	else
		player.DelBuff(11222, 12)
	end
