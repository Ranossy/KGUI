---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_上将军印连续命中四次伤害.lua
-- 更新时间:	2016/10/12 1:19:53
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 140, nDamageRand = 10, nCostMana = 0}, --level 2
	{nDamageBase = 160, nDamageRand = 10, nCostMana = 0}, --level 3
	{nDamageBase = 180, nDamageRand = 10, nCostMana = 0}, --level 4
	{nDamageBase = 200, nDamageRand = 10, nCostMana = 0}, --level 5
	{nDamageBase = 220, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 240, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 260, nDamageRand = 15, nCostMana = 0}, --level 8
	{nDamageBase = 280, nDamageRand = 15, nCostMana = 0}, --level 9
	{nDamageBase = 300, nDamageRand = 15, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_上将军无奇穴伤害.lua",
		0
	);
	...
	--skill.AddSlowCheckDestBuff(11241, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);	-- 需求自身属于自己的Buff
	skill.AddSlowCheckDestOwnBuff(11241, 4, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff

	-----------------技能施放技能需求-------------------------------------------
	skill.AddCheckSelfLearntSkill(16799, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11241, 1);		-- 设置1号位Buff
	...
	--skill.SetNormalCoolDown(1, 1127);	--技能普通CD
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60 * 1.4; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 10) * 1.4; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 160 * 1.4; 				-- 通道技间隔时间
	end
