---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_上将军无奇穴伤害.lua
-- 更新时间:	2016/9/20 12:11:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	-----------------技能施放技能需求-------------------------------------------
	skill.AddCheckSelfLearntSkill(16799, 0, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	--skill.SetNormalCoolDown(1, 1060);	--技能普通CD
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60*0.9; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 10)*0.9; 				-- 通道技间隔时间
	else
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--[[
	--其他伤害子技能也调用了该脚本
	if player.GetSkillLevel(16847) == 1 then
		--player.nCurrentRage = player.nCurrentRage + math.min(1, player.nMaxRage - player.nCurrentRage)
		player.ModifyCoolDown(1126, - 16)
	end
	--]]
end
