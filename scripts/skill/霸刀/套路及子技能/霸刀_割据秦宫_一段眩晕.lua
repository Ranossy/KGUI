---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_一段眩晕.lua
-- 更新时间:	2016/9/13 0:22:35
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 500, nDamageRand = 10, nCostMana = 0}, --level 1
	{nDamageBase = 600, nDamageRand = 20, nCostMana = 0}, --level 2
	{nDamageBase = 700, nDamageRand = 30, nCostMana = 0}, --level 3
	{nDamageBase = 800, nDamageRand = 40, nCostMana = 0}, --level 4
	{nDamageBase = 900, nDamageRand = 50, nCostMana = 0}, --level 5
	{nDamageBase = 1000, nDamageRand = 60, nCostMana = 0}, --level 6
	{nDamageBase = 1100, nDamageRand = 70, nCostMana = 0}, --level 7
	{nDamageBase = 1200, nDamageRand = 80, nCostMana = 0}, --level 8
	{nDamageBase = 1300, nDamageRand = 90, nCostMana = 0}, --level 9
	{nDamageBase = 1400, nDamageRand = 100, nCostMana = 0}, --level 10
	{nDamageBase = 500, nDamageRand = 10, nCostMana = 0}, --level 11
	{nDamageBase = 600, nDamageRand = 20, nCostMana = 0}, --level 12
	{nDamageBase = 700, nDamageRand = 30, nCostMana = 0}, --level 13
	{nDamageBase = 800, nDamageRand = 40, nCostMana = 0}, --level 14
	{nDamageBase = 900, nDamageRand = 50, nCostMana = 0}, --level 15
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_割据秦宫_一段眩晕.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.nChannelInterval = 20; 				-- 通道技间隔时间
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(2, "scripts/skill/霸刀/套路及子技能/霸刀_割据秦宫_一段眩晕.lua", dwCharacterID, 0)
end
