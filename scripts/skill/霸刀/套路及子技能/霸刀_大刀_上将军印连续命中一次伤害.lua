---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_上将军印连续命中一次伤害.lua
-- 更新时间:	2016/9/17 16:31:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(11241, 2, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60*1.2; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 10)*1.2; 				-- 通道技间隔时间
	else
