---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_刀啸风吟10尺伤害.lua
-- 更新时间:	2016/9/2 15:44:53
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 50*1.2*1.1; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (50 + (dwSkillLevel - 1) * 14)*1.2*1.1; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 256*1.2*1.1; 				-- 通道技间隔时间
	end
