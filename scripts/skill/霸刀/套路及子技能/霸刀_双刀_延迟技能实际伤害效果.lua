---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_延迟技能实际伤害效果.lua
-- 更新时间:	2016/8/5 16:33:07
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 5555, nDamageRand = 6666, nCostMana = 7777}, --level 1
	{nDamageBase = 5555, nDamageRand = 6666, nCostMana = 7777}, --level 1
	{nDamageBase = 5555, nDamageRand = 6666, nCostMana = 7777}, --level 1
	{nDamageBase = 5555, nDamageRand = 6666, nCostMana = 7777}, --level 1
	{nDamageBase = 5555, nDamageRand = 6666, nCostMana = 7777}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(11038, dwSkillLevel, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	...
	--skill.nMinPrepareFrames  	= -1;				-- 急速效果最小吟唱帧数：默认是-1，吟唱不受急速影响。大于等于0则受急速影响，最小读条时间为填的值
	  skill.nChannelInterval	= 50 + (30 * (dwSkillLevel - 1)); 				-- 通道技间隔时间
