---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀绝沧海_实际伤害效果.lua
-- 更新时间:	2016/8/14 0:35:56
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 200, nDamageRand = 200, nCostMana = 200}, --level 1
	{nDamageBase = 400, nDamageRand = 400, nCostMana = 400}, --level 2
	{nDamageBase = 600, nDamageRand = 600, nCostMana = 600}, --level 3
	{nDamageBase = 800, nDamageRand = 800, nCostMana = 800}, --level 4
	{nDamageBase = 1000, nDamageRand = 1000, nCostMana = 1000}, --level 5
	{nDamageBase = 1200, nDamageRand = 1200, nCostMana = 1200}, --level 6
	{nDamageBase = 1400, nDamageRand = 1400, nCostMana = 1400}, --level 7
	{nDamageBase = 1600, nDamageRand = 1600, nCostMana = 1600}, --level 8
	{nDamageBase = 1800, nDamageRand = 1800, nCostMana = 1800}, --level 9
	{nDamageBase = 2000, nDamageRand = 2000, nCostMana = 2000}, --level 10
	{nDamageBase = 2200, nDamageRand = 2200, nCostMana = 2200}, --level 11
	{nDamageBase = 2400, nDamageRand = 2400, nCostMana = 2400}, --level 12
	{nDamageBase = 2600, nDamageRand = 2600, nCostMana = 2600}, --level 13
	{nDamageBase = 2800, nDamageRand = 2800, nCostMana = 2800}, --level 14
	{nDamageBase = 3000, nDamageRand = 3000, nCostMana = 3000}, --level 15
	{nDamageBase = 3200, nDamageRand = 3200, nCostMana = 3200}, --level 16
	{nDamageBase = 3400, nDamageRand = 3400, nCostMana = 3400}, --level 17
	{nDamageBase = 3600, nDamageRand = 3600, nCostMana = 3600}, --level 18
	{nDamageBase = 3800, nDamageRand = 3800, nCostMana = 3800}, --level 19
	{nDamageBase = 4000, nDamageRand = 4000, nCostMana = 4000}, --level 20
};
--设置武功技能级别相关数值
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10815, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.nChannelInterval = 20 + (dwSkillLevel + 1 ); 				-- 通道技间隔时间
