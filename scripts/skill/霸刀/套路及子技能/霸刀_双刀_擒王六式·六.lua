---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·六.lua
-- 更新时间:	2016/9/21 21:19:30
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·六.lua",
		0
	);
	...
	--skill.SetDelaySubSkill(4, 16943, 1)
	--skill.SetDelaySubSkill(10, 16944, 1)
