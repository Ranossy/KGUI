---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_开九天_功能效果.lua
-- 更新时间:	2016/7/18 9:44:32
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_开九天_功能效果.lua",
		0
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --- 实际伤害技能
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.nCurrentRage = math.min(player.nCurrentRage + 10, 100)
	player.nCurrentEnergy = math.max(math.min(player.nCurrentEnergy, 100 - player.nCurrentRage), 0)
end
