---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎一段.lua
-- 更新时间:	2016/9/11 21:01:46
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(11149, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--三段标记Buff
	skill.AddSlowCheckSelfBuff(11148, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	--二段标记Buff
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 40*1.2*0.9; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (40 + (dwSkillLevel - 1) * 11)*1.2*0.9; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 200*1.2*0.9; 				-- 通道技间隔时间
	end
