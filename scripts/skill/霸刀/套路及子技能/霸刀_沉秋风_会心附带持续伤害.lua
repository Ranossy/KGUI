---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_沉秋风_会心附带持续伤害.lua
-- 更新时间:	2016/9/1 20:43:58
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_沉秋风_会心附带持续伤害.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(16304)
	if lv ~= 0 then
		player.CastSkill(16486, lv, player.GetSkillTarget())
	end
end
