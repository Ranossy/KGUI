---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_散流霞驱散和回血.lua
-- 更新时间:	2016/9/23 1:21:10
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_散流霞驱散和回血.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(1111)
	--[[
	if player.GetSkillLevel(16739) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 11202, 1, 5)
	else
		player.AddBuff(player.dwID, player.nLevel, 11202, 1, 3)
	end
	--]]
end
