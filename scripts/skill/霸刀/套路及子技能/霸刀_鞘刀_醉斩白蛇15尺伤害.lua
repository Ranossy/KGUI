---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_醉斩白蛇15尺伤害.lua
-- 更新时间:	2016/9/2 16:40:09
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 45, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 60, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 75, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 90, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 105, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 120, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 135, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 150, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 165, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 180, nDamageRand = 15, nCostMana = 0}, --level 10
	{nDamageBase = 195, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 210, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 225, nDamageRand = 20, nCostMana = 0}, --level 8
	{nDamageBase = 240, nDamageRand = 20, nCostMana = 0}, --level 9
	{nDamageBase = 255, nDamageRand = 20, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 16*1.2*1.15; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 1) * 3)*1.2*1.15; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 64*1.2*1.15; 				-- 通道技间隔时间
	end
