---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_鞘刀绝沧海.lua
-- 更新时间:	2016/7/29 11:49:32
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16345) ~= 0 and player.GetSkillLevel(16345) ~= lv then 
		player.LearnSkillLevel(16345, lv, player.dwID)	
	end

	if	player.GetSkillLevel(16101) ~= 0 and player.GetSkillLevel(16101) ~= lv then
		player.LearnSkillLevel(16101, lv, player.dwID)
	end
end
