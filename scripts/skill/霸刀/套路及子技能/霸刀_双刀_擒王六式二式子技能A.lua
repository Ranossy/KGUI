---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式二式子技能A.lua
-- 更新时间:	2016/9/23 23:29:32
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 16*1.3; 				-- 通道技间隔时间
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 1) * 5)*1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 64*1.3; 				-- 通道技间隔时间
	end
