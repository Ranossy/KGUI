---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/破釜沉舟无调息.lua
-- 更新时间:	2016/10/5 14:17:01
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--施展招式期间免控
	if not player.GetBuff(11362, 1) then
		player.AddBuff(player.dwID, player.nLevel, 11361, 1)
		player.AddBuff(player.dwID, player.nLevel, 11362, 1)
	end

	player.AddBuff(player.dwID, player.nLevel, 11442, 1)
end
