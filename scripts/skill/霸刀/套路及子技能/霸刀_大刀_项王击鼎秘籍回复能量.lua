---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎秘籍回复能量.lua
-- 更新时间:	2016/9/25 14:15:15
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/霸刀/套路及子技能/霸刀_大刀_项王击鼎秘籍回复能量.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsSkillRecipeActive(4147, 1) and not player.GetBuff(11312, 1) then
		player.nCurrentRage = player.nCurrentRage + math.min(5, player.nMaxRage - player.nCurrentRage)
		player.AddBuff(player.dwID, player.nLevel, 11312, 1)
	end
end
