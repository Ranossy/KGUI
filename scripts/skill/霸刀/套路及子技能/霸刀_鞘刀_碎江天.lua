---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_碎江天.lua
-- 更新时间:	2016/8/10 11:18:40
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16304) ~= 0 and player.GetSkillLevel(16304) ~= lv then 
		player.LearnSkillLevel(16304, lv, player.dwID)
	end
	
	if player.GetSkillLevel(16350) ~= 0 and player.GetSkillLevel(16350) ~= lv then
		player.LearnSkillLevel(16350, lv, player.dwID)
	end
end
