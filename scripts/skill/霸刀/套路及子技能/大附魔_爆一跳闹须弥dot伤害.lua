---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/大附魔_爆一跳闹须弥dot伤害.lua
-- 更新时间:	2016/10/14 14:53:27
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/霸刀/套路及子技能/大附魔_爆一跳闹须弥dot伤害.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(17069) == 0 then
		player.LearnSkillLevel(17069, 1, player.dwID)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(17069) == 1 then
		player.ForgetSkill(17069)
	end
end
