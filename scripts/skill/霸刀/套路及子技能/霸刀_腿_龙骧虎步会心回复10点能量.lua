---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_腿_龙骧虎步会心回复10点能量.lua
-- 更新时间:	2016/10/12 1:46:56
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/霸刀/套路及子技能/霸刀_腿_龙骧虎步会心回复10点能量.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(11441, 1) then
		player.AddBuff(player.dwID, player.nLevel, 11441, 1)
		player.nCurrentEnergy = player.nCurrentEnergy + math.min(10, player.nMaxEnergy - player.nCurrentEnergy)
