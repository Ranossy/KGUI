---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·一式冲刺.lua
-- 更新时间:	2016/10/2 19:38:34
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·一式冲刺.lua",
		0
	);
	...
	skill.SetDelaySubSkill(3, 16933, dwSkillLevel)
	skill.SetDelaySubSkill(10, 16934, dwSkillLevel)
	----------------- BUFF相关 -------------------------------------------------
	...
	--skill.SetNormalCoolDown(1, 1130);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if target.nImmuneSkillMoveCount == 0 then
		target.BeHitted(player.dwID, 16870, 1, 39)
	end
	...
	player.DelBuff(11283, 1)
	player.SetTimer(6, "scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式·一式冲刺.lua", 0, 0)
...
function OnTimer(player, nParam1, nParam2)
	...
	player.AddBuff(player.dwID, player.nLevel, 11278, 1)
end
