---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_西楚悲歌正常伤害.lua
-- 更新时间:	2016/10/6 15:08:49
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 110, nDamageRand = 20, nCostMana = 0}, --level 1
	{nDamageBase = 110, nDamageRand = 20, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.nHeight = 30 * LENGTH_BASE;                            -- AOE的高度，全高，圆柱体 AOE中不填为2倍的nAreaRadius，矩形AOE中不填为nAreaRadius
	...
	skill.nChannelInterval	= 96*0.9; 				-- 通道技间隔时间
