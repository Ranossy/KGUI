---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野添加标记Buff.lua
-- 更新时间:	2016/9/16 0:31:31
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野添加标记Buff.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(2, "scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野添加标记Buff.lua", dwCharacterID, 0)
	...
	--一段锁足
	if player.GetSkillLevel(16807) == 1 then
		local nbuff = player.GetBuff(11235, 1)
		if nbuff and nbuff.nStackNum <= 10 then
			target.AddBuff(player.dwID, player.nLevel, 11309, 1)
		end
	end
	--]]
end
