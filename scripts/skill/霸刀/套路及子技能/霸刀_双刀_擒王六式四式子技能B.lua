---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_双刀_擒王六式四式子技能B.lua
-- 更新时间:	2016/9/23 23:52:21
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	elseif dwSkillLevel < 10 then
		skill.nChannelInterval = (25 + (dwSkillLevel - 1) * 9)*1.3; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 120*1.3; 				-- 通道技间隔时间
	end
