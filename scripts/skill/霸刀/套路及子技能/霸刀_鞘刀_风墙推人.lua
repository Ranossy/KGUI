---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_风墙推人.lua
-- 更新时间:	2016/10/12 16:25:38
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
 	...
 	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_鞘刀_风墙推人.lua",
		0
		);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(11459, 10, BUFF_COMPARE_FLAG.LESS, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(11458, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	if dwSkillLevel == 1 then
		...
		skill.nRectOffset = -2* LENGTH_BASE;						--向量方向平移点数(正数为正向量方向，负数为反向)
