---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_雷走风切.lua
-- 更新时间:	2016/9/2 21:57:17
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_雷走风切.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 1117);	--技能普通CD
	skill.SetNormalCoolDown(2, 1158);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16598) ~= lv then
		player.LearnSkillLevel(16598, lv, player.dwID)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nMaxOverDraftCount, nDraftCount = player.GetOverDraftCoolDown(1117)
	if nDraftCount ~= 0 then
		if player.GetSkillLevel(16732) == 1 then
			player.AddCDTime(1117, 128)
		else
			player.AddCDTime(1117, 256)
		end
	end
	player.CastSkill(16635,1)
	player.SetOverDraftCoolDown(1117, nDraftCount + 1)
end
