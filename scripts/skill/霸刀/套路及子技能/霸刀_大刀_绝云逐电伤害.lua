---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_大刀_绝云逐电伤害.lua
-- 更新时间:	2016/9/8 15:22:55
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/霸刀/套路及子技能/霸刀_大刀_绝云逐电伤害.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if lv ~= 0 and player.GetSkillLevel(16695) == 1 then
		if IsPlayer(dwCharacterID) then
			player.CastSkill(16675, lv, TARGET.PLAYER, dwCharacterID)
		else
			player.CastSkill(16675, lv, TARGET.NPC, dwCharacterID)
		end
	end
	---绝云逐电减少破釜沉舟调息
