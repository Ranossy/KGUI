---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/霸刀/套路及子技能/霸刀_鞘刀_坚壁清野20尺实际伤害.lua
-- 更新时间:	2016/9/15 20:50:54
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 150, nDamageRand = 5, nCostMana = 0}, --level 1
	{nDamageBase = 170, nDamageRand = 5, nCostMana = 0}, --level 2
	{nDamageBase = 190, nDamageRand = 5, nCostMana = 0}, --level 3
	{nDamageBase = 210, nDamageRand = 5, nCostMana = 0}, --level 4
	{nDamageBase = 230, nDamageRand = 5, nCostMana = 0}, --level 5
	{nDamageBase = 250, nDamageRand = 10, nCostMana = 0}, --level 6
	{nDamageBase = 270, nDamageRand = 10, nCostMana = 0}, --level 7
	{nDamageBase = 290, nDamageRand = 10, nCostMana = 0}, --level 8
	{nDamageBase = 310, nDamageRand = 10, nCostMana = 0}, --level 9
	{nDamageBase = 330, nDamageRand = 15, nCostMana = 0}, --level 10
	{nDamageBase = 350, nDamageRand = 15, nCostMana = 0}, --level 6
	{nDamageBase = 370, nDamageRand = 15, nCostMana = 0}, --level 7
	{nDamageBase = 390, nDamageRand = 20, nCostMana = 0}, --level 8
	{nDamageBase = 410, nDamageRand = 20, nCostMana = 0}, --level 9
	{nDamageBase = 430, nDamageRand = 20, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	----------------- 作用范围 -------------------------------------------------
	--skill.nProtectRadius = 15 * LENGTH_BASE;                     -- 环形和矩形AOE的保护距离，范围内不受伤害
	...
	if dwSkillLevel == 1 then
		skill.nChannelInterval = 60*1.35*0.7; 				-- 通道技间隔时间
	elseif dwSkillLevel < 15 then
		skill.nChannelInterval = (60 + (dwSkillLevel - 1) * 16)*1.35*0.7; 				-- 通道技间隔时间
	else
		skill.nChannelInterval = 288*1.35*0.7; 				-- 通道技间隔时间
	end
