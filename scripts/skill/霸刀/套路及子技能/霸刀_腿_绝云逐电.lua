...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1109);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	...
	if player.GetSkillLevel(16626) ~= 0 and player.GetSkillLevel(16626) ~= lv then
		player.LearnSkillLevel(16626, lv, player.dwID)
	end
end
