...
tSkillData =
{
      	{BUFFID = 3037,BUFFLEVEL = 1 }, -- 1，霸刀
        {BUFFID = 3038,BUFFLEVEL = 1 }, -- 2，藏经阁
        {BUFFID = 3039,BUFFLEVEL = 1 }, -- 3，大理宫
        {BUFFID = 3040,BUFFLEVEL = 1 }, -- 4，九黎族
        {BUFFID = 3041,BUFFLEVEL = 1 }, -- 5，塔纳
      	{BUFFID = 3042,BUFFLEVEL = 1 }, -- 6，天南王家
        {BUFFID = 3043,BUFFLEVEL = 1 }, -- 7，五毒
        {BUFFID = 3044,BUFFLEVEL = 1 }, -- 8，轩辕社
        {BUFFID = 3045,BUFFLEVEL = 1 }, -- 9，镇南镖局
        {BUFFID = 3046,BUFFLEVEL = 1 }, -- 10，祝融殿
        {BUFFID = 5298,BUFFLEVEL = 1 }, -- 11，拜火教
};
