---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_苍蛟扫狼.lua
-- 更新时间:	2016/9/8 16:26:56
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_苍蛟扫狼.lua", --属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11298, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		npctarget.AddBuff(0, 99, 11181, 1, 5)
	end
end
