---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/item/荻花圣殿_少林特殊武器5.lua
-- 更新时间:	2012-7-30 11:47:59
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	local result = tplayer.CastSkill(4101, 1)
	tplayer.PlayCameraAnimation(17,0)
	if result ~= 1 then
		tplayer.CastSkill(4142, 1)
