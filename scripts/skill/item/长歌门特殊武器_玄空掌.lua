---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_玄空掌.lua
-- 更新时间:	2016/9/23 14:08:57
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_玄空掌.lua", -- 属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11300, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		npctarget.AddBuff(npctarget.dwID, npctarget.nLevel, 11301, 1, 15)
		npctarget.PlaySfx(1363, npctarget.nX, npctarget.nY, npctarget.nZ + 256)
		npctarget.PlayCharacterSound(19188)
	end
