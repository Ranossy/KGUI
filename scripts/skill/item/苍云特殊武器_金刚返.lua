---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_金刚返.lua
-- 更新时间:	2016/3/24 14:35:10
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_金刚返.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	npc.AddBuff(0, 99, 10563, 1, 3)
	npc.SetCustomInteger4(16, npc.nCurrentLife)
end
