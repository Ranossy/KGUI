---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_鸣雷也母技能.lua
-- 更新时间:	2016/9/23 16:40:27
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_鸣雷也母技能.lua", -- 属性值1
		0															--属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11305, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		if npctarget.GetBuff(11303, 1) then
			player.CastSkill(16909, 2)
			npctarget.DelBuff(11303, 1)
		else
			player.CastSkill(16909, 1)
		end
	end
end
