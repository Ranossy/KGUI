---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_武器中寻首击山释放.lua
-- 更新时间:	2016/6/8 17:01:38
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 40000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 60000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 80000, nDamageRand = 0, nCostMana = 0}, --level 5
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_武器中寻首击山释放.lua", -- 属性值1
		0															--属性值2
	);
	...
	if dwSkillLevel == 6 then
		--skill.BindBuff(1, 11182, 3);		-- 设置1号位Buff
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.PlayCharacterSound(19197)
		player.PlayCharacterSound(19202)
		player.PlaySfx(63, 0, 0, 0)
		player.PlaySfx(73, 0, 0, 0, 360 * player.nFaceDirection / 256 + 90)
		player.PlaySfx(1446, 0, 0, 0, 360 * player.nFaceDirection / 256 + 90)
		player.PlaySfx(1447, X2, Y2, player.nZ+472, 360 * player.nFaceDirection / 256 + 90)
		player.PlaySfx(1448, X2, Y2, player.nZ+472, 360 * player.nFaceDirection / 256 + 90)
	end
	player.SetTimer(0.2 * GLOBAL.GAME_FPS, "scripts/skill/item/苍云特殊武器_武器中寻首击山释放.lua", dwSrcID, 1)
end
