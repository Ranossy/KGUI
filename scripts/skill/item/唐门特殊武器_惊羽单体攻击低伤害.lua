---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/item/唐门特殊武器_惊羽单体攻击低伤害.lua
-- 更新时间:	2012-7-30 10:38:42
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(4213, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4213, 1);		-- 1秒打1次标记
