---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_浮云剑母技能.lua
-- 更新时间:	2016/9/23 15:39:20
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_浮云剑母技能.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		if npctarget.GetBuff(11301, 1) then
			player.CastSkill(16905, 2)
			npctarget.DelBuff(11301, 1)
		else
			player.CastSkill(16905, 1)
		end
	end
end
