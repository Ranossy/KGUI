---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/李白醉剑.lua
-- 更新时间:	2016/9/27 15:04:33
-- 更新用户:	yangcheng3
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 19652, nDamageRand = 0, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		npctarget.PlaySfx(1485, npctarget.nX, npctarget.nY, npctarget.nZ + 256)
		--npctarget.AddBuff(0, 99, 11314, 1, 10)
		--if npctarget.GetBuff(11323, 1) then
			--npctarget.AddBuff(0, 99, 11324, 1, 10)
			npctarget.DoAction(0, 10073)
		--end
	end
end
