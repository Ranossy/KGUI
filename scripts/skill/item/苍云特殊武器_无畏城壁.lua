---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_无畏城壁.lua
-- 更新时间:	2016/3/25 9:42:15
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_无畏城壁.lua", -- 属性值1
		0															--属性值2
	);
	...
	----------------- 设置Cool down --------------------------------------------
	-- 公共CD
	skill.SetNormalCoolDown(1, 1101)
...
function Apply(dwCharacterID, dwSrcID)
	...
	--scene.SetTimer(1.2 * GLOBAL.GAME_FPS, "scripts/skill/item/长歌门特殊武器_启动.lua", dwSrcID, 1)
	player.AddBuff(0, 99, 10565, 1, 12)----加无畏
	player.AddBuff(0, 99, 10567, 1, 30)----加城壁
	player.DelBuff(10558, 1)---删除苍龙真炎dot
	--player.DoAction(0, 13233)
	player.PlaySfx(141,0,0,0)
end
