---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/谢师恩.lua
-- 更新时间:	2017/3/10 17:35:01
-- 更新用户:	LINGJIAJIA-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print("dwCharacterID, dwSkillSrcID",dwCharacterID, dwSkillSrcID)
	tMasterAndDiscipleQuest.GiveMasterGift(GetPlayer(dwSkillSrcID), player, 4)
end
