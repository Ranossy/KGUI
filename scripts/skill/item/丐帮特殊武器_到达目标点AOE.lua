---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/丐帮特殊武器_到达目标点AOE.lua
-- 更新时间:	2016/10/8 13:17:00
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 47000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 23500, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 15666, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 11750, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 9400, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 7833, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 6714, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 5875, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 5222, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 4700, nDamageRand = 0, nCostMana = 0}, --level 10
	{nDamageBase = 4272, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 3916, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 3615, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 3357, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 3133, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 2937, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 2764, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 2611, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 2473, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 2350, nDamageRand = 0, nCostMana = 0}, --level 10
};
