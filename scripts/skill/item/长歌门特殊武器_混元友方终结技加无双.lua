---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_混元友方终结技加无双.lua
-- 更新时间:	2016/10/6 14:04:32
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_混元友方终结技加无双.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		--if player.GetKungfuMount() ~= nil then
			--if player.GetKungfuMount().dwSkillID == 10021 or player.GetKungfuMount().dwSkillID == 10014 then
