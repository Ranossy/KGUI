---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/太白醉酒.lua
-- 更新时间:	2016/9/27 15:05:43
-- 更新用户:	yangcheng3
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 29478, nDamageRand = 0, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		--npctarget.AddBuff(0, 99, 11323, 1, 10)
		npctarget.PlaySfx(1515, npctarget.nX, npctarget.nY, npctarget.nZ + 256)
	end
end
