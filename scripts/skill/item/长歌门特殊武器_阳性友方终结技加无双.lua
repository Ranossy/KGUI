---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_阳性友方终结技加无双.lua
-- 更新时间:	2016/10/5 15:46:40
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_阳性友方终结技加无双.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		--if player.GetKungfuMount() ~= nil then
			--if player.GetKungfuMount().dwSkillID == 10002 or player.GetKungfuMount().dwSkillID == 10003 or player.GetKungfuMount().dwSkillID == 10242 or player.GetKungfuMount().dwSkillID == 10243 then
