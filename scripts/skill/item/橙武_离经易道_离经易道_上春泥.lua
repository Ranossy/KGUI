---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/橙武_离经易道_离经易道_上春泥.lua
-- 更新时间:	2013/7/10 17:03:31
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/橙武_离经易道_离经易道_上春泥.lua", -- 连协技
		0
	);
	----------------- 魔法属性 -------------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 122, 7);		-- 设置1号位Buff    
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(5779) == 1 then
		--for i = 1, 5 do 
		target.AddBuff(dwSkillSrcID, player.nLevel, 6264, lv, 1)
		--end
	else
		--for i = 1, 5 do 
