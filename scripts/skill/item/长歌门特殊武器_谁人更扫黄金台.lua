---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_谁人更扫黄金台.lua
-- 更新时间:	2016/9/27 20:01:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_谁人更扫黄金台.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.GetKungfuMount() ~= nil then
		if player.GetKungfuMount().dwSkillID == 10242 and player.GetKungfuMount().dwSkillID == 10243 then
			player.AddBuff(player.dwID, player.nLevel, 11331, 1, 15)
		end
	end
end
