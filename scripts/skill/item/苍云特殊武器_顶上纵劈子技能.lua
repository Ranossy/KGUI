---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_顶上纵劈子技能.lua
-- 更新时间:	2016/3/24 17:42:59
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(10565, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
