---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_吹萧.lua
-- 更新时间:	2016/3/14 10:58:53
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_吹萧.lua", -- 属性值1
		0															--属性值2
		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if yingzi1 then
		yingzi1.AddBuff(0, 99, 10525, 1, 30)
		yingzi1.PlaySfx(1482, yingzi1.nX, yingzi1.nY, yingzi1.nZ + 512)
		yingzi1.PlaySfx(1483, yingzi1.nX, yingzi1.nY, yingzi1.nZ+128)
	end

	if yingzi3 then
		local step = yingzi3.GetCustomInteger4(8)
		step = step + 1
		yingzi3.SetCustomInteger4(8, step)
	end
end
