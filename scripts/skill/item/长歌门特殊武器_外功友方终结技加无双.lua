---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_外功友方终结技加无双.lua
-- 更新时间:	2016/10/6 14:14:17
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_外功友方终结技加无双.lua",
		0
	);
	...
	if dwSkillLevel == 1 then
		skill.BindBuff(1, 11377, 1);		-- 设置1号位Buff
	else
		skill.BindBuff(2, 11377, 2);		-- 设置2号位Buff
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		--if player.GetKungfuMount() ~= nil then
			--if player.GetKungfuMount().dwSkillID == 10015 or player.GetKungfuMount().dwSkillID == 10026 or player.GetKungfuMount().dwSkillID == 10062 or player.GetKungfuMount().dwSkillID == 10389 or player.GetKungfuMount().dwSkillID == 10390 or player.GetKungfuMount().dwSkillID == 10144 or player.GetKungfuMount().dwSkillID == 10145 or player.GetKungfuMount().dwSkillID == 10464 or player.GetKungfuMount().dwSkillID == 10224 then
				--player.AddBuff(player.dwID, player.nLevel, 11377, 1, 60)
			--end
		--end
	end
end
