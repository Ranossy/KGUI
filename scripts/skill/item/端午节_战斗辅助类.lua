...
tSkillData =
{
      	{BUFFID = 2992,BUFFLEVEL = 1 }, 
        {BUFFID = 2992,BUFFLEVEL = 2 }, 
        {BUFFID = 2992,BUFFLEVEL = 3 },
        {BUFFID = 2992,BUFFLEVEL = 4 },
        {BUFFID = 2992,BUFFLEVEL = 5 },
        {BUFFID = 2992,BUFFLEVEL = 6 },
        {BUFFID = 2992,BUFFLEVEL = 7 },
        {BUFFID = 2992,BUFFLEVEL = 8 },
        {BUFFID = 2993,BUFFLEVEL = 1 },
        {BUFFID = 2993,BUFFLEVEL = 2 },
        {BUFFID = 2993,BUFFLEVEL = 3 },
