---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_武器中的争神炎舞母技能.lua
-- 更新时间:	2016/6/8 14:23:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_武器中的争神炎舞母技能.lua", -- 属性值1
		0											-- 属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.DoAction(0, 60123)
		player.CastSkill(15990, 1)
		--player.DelBuff(8400, 1)
		player.DelBuff(11036, 1)
		player.DelBuff(11036, 2)
		player.DelBuff(8576, 1)
		player.DelBuff(10821, 1)
		player.DelBuff(10823, 1)
		player.DelBuff(10824, 1)
		player.DelBuff(10825, 1)
		player.DelBuff(11106, 1)
		player.DelBuff(11197, 1)---删除魂吸buff
		player.SetDynamicSkillGroup(0)
		player.PlayCharacterSound(19199)
		player.PlaySfx(1451, X2, Y2, player.nZ+64, 360 * player.nFaceDirection / 256 - 90)
		player.SetTimer(0.6 * GLOBAL.GAME_FPS, "scripts/skill/item/苍云特殊武器_武器中的争神炎舞母技能.lua", dwSrcID, 1)
	end
end
...
function OnTimer(player, nParam1, nParam2)
	...
	player.CastSkill(16717, 1)
	player.PlayCharacterSound(19200)
	player.PlaySfx(1452, X2, Y2, player.nZ + 128, 360 * player.nFaceDirection / 256 - 90)
