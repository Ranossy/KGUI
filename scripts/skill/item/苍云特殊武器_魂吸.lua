---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_魂吸.lua
-- 更新时间:	2016/9/9 15:51:56
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npctarget then
		npctarget.nCurrentMana = npctarget.nCurrentMana - 100
	end

	if player then
		player.nCurrentRage = player.nCurrentRage + 3
		local X1 = player.nX
		local Y1 = player.nY
		local H = 50  
		...
		player.PlayCharacterSound(19203)
		player.PlaySfx(1438, X2, Y2, player.nZ + 256, 360 * player.nFaceDirection / 256 + 90)
