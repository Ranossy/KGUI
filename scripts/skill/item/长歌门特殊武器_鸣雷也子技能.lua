---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_鸣雷也子技能.lua
-- 更新时间:	2016/9/23 17:12:14
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 44218, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 110544, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 7500, nDamageRand = 0, nCostMana = 0}, --level 3
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_鸣雷也子技能.lua", -- 属性值1
		0												--属性值2
	);
	...
	if dwSkillLevel == 4 then
		--skill.BindBuff(1, 11327, 1);		-- 设置1号位Buff
		--skill.BindBuff(2, 11328, 1);		-- 设置2号位Buff
	end
	...
	if dwSkillLevel == 2 then
		--skill.BindBuff(1, 11328, 1);		-- 设置1号位Buff
	end
