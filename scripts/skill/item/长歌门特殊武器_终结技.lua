---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_终结技.lua
-- 更新时间:	2016/3/15 10:47:43
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_终结技.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if yingzi3 then
		if yingzi2 then
			buffLevel = yingzi2.GetCustomInteger4(16)
		end

		if yingzi3.GetCustomInteger4(8) == 2 and yingzi3.GetCustomInteger4(20) == 1 then----113
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(0, 99, 10533, buffLevel)--阳性伤害提高
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end

		if yingzi3.GetCustomInteger4(8) == 1 and yingzi3.GetCustomInteger4(12) == 1 and yingzi3.GetCustomInteger4(20) == 1 then----123
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(0, 99, 10531, buffLevel)--阴性伤害提高
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end

		if yingzi3.GetCustomInteger4(8) == 1 and yingzi3.GetCustomInteger4(20) == 2 then----133
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(player.dwID, player.nLevel, 10529,  buffLevel)----dot
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end

		if yingzi3.GetCustomInteger4(12) == 1 and yingzi3.GetCustomInteger4(20) == 2 then----233
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(player.dwID, player.nLevel, 11123, buffLevel)----混元伤害提高
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end

		if yingzi3.GetCustomInteger4(12) == 2 and yingzi3.GetCustomInteger4(20) == 1 then----223
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(0, 99, 10534, buffLevel)--毒性伤害提高
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end

		if yingzi3.GetCustomInteger4(20) == 3 then----333
			if npctarget then
				if buffLevel then
					npctarget.AddBuff(0, 99, 10530, buffLevel)--外功伤害提高
					player.PlaySfx(1280, npctarget.nX, npctarget.nY, npctarget.nZ + 500)
				end
			end
		end
	...
	player.PlaySfx(1495, 0, 0, 0)
	if npctarget then
		player.PlaySfx(442, npctarget.nX, npctarget.nY, npctarget.nZ)
	end
end
