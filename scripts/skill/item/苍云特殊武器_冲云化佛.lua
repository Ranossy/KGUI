---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_冲云化佛.lua
-- 更新时间:	2016/3/24 10:59:05
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_冲云化佛.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	npc.AddBuff(0, 99, 10559, 1)
	local player = GetPlayer(dwCharacterID)
	if player then
		npc.CastSkill(15670, 1, TARGET.PLAYER, player.dwID)
