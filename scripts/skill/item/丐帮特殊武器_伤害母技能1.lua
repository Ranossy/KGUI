---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/丐帮特殊武器_伤害母技能1.lua
-- 更新时间:	2016/10/10 22:51:52
-- 更新用户:	ZHANGGUANYI
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/丐帮特殊武器_伤害母技能1.lua", -- 属性值1
		0															--属性值2
	);
	--[[
   	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		if npc then
			player.AddBuff(player.dwID, player.nLevel, 11422, 1)
			--print("母技能")
		end
	end
	player.AddBuff(player.dwID, player.nLevel, 11423, 1)
end
