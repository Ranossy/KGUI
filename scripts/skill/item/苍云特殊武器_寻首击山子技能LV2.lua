---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_寻首击山子技能LV2.lua
-- 更新时间:	2016/3/25 10:10:51
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_寻首击山子技能LV2.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	npctarget.DelGroupBuff(10574, 1)
	npctarget.DelGroupBuff(10581, 1)
	npctarget.DelBuff(10559, 1)
end
