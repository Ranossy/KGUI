---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_琴音扩散.lua
-- 更新时间:	2016/3/14 16:06:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 25195, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 25195, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 25195, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 25195, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 25195, nDamageRand = 0, nCostMana = 0}, --level 5
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		--skill.BindBuff(1, 11329, 1);		-- 设置4号位Buff
	end

	if dwSkillLevel == 2 then
		--skill.BindBuff(1, 11330, 1);		-- 设置4号位Buff
	end
	...
	skill.nAreaRadius = 4 * LENGTH_BASE;        -- 技能起始作用环的外圈半径
	...
	skill.nSpreadCircleVelocity = 20; --环每帧运动点数，4就是1尺/秒，可以为负的，负表示朝内收缩
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		--player.PlaySfx(1451, X2, Y2, player.nZ+128, 360 * player.nFaceDirection / 256 + 90)
		player.PlaySfx(1476, X2, Y2, player.nZ + 512, 360 * player.nFaceDirection / 256 - 90)
	end
	if yingzi1 then
		yingzi1.PlaySfx(1484,yingzi1.nX,yingzi1.nY,yingzi1.nZ+512)
	end
end
