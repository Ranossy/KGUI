---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_弹琴.lua
-- 更新时间:	2016/3/14 10:59:32
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_弹琴.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if yingzi2 then
		yingzi2.AddBuff(0, 99, 10526, 1, 30)
	end

	if yingzi3 then
		local step = yingzi3.GetCustomInteger4(12)
		step = step + 1
		yingzi3.SetCustomInteger4(12, step)
	end
end
