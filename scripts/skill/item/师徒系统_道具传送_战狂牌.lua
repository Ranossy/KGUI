...
--	if player.nCurrentStamina < player.GetSkillStaminaCost(1032,1)  then
--			player.SendSystemMessage("精力太少，无法施展招式")
--			return false;
--	end
--    return nPreResult;
    return nPreResult;
...
function Apply(dwCharacterID)
	...
	player.CostItemInAllPackage(ITEM_TABLE_TYPE.OTHER, 6233, 1)
end
