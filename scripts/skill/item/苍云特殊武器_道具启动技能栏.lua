---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_道具启动技能栏.lua
-- 更新时间:	2016/3/25 9:39:34
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_道具启动技能栏.lua", -- 属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetDynamicSkillGroup(251)
	player.DoAction(0, 60120)
	player.PlaySfx(187,0,0,0)
end
