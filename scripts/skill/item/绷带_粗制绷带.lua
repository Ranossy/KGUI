...
tSkillData =
{
	{nTherapy = 300, nTherapyRand = 300, nCostMana = 0}
};
  ...
  local bRetCode     	= false
    ...
    skill.SetNormalCoolDown(1, 359);
	  --skill.AddSlowCheckSelfBuff(409, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL)   --需求剑舞BUFF
		...
		--skill.AddSlowCheckDestBuff(1846, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL); 
		--skill.BindBuff(1, 1846, 1);
	----------------- 设置技能消耗 ---------------------------------------------------------------------
    ...
    skill.nChannelFrame		= 2 * GAME_FPS;			-- 通道技持续时间，单位帧数 
