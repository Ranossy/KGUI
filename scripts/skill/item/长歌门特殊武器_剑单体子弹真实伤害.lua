---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/长歌门特殊武器_剑单体子弹真实伤害.lua
-- 更新时间:	2016/3/14 19:05:08
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 11600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 46700, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/长歌门特殊武器_剑单体子弹真实伤害.lua", -- 属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	--scene.SetTimer(0.5 * GLOBAL.GAME_FPS, "skill/item/长歌门特殊武器_剑单体子弹.lua", dwCharacterID, 1)
...
function OnTimer(scene, nParam1, nParam2)
	...
	--return
	--end
	--npc.PlaySfx(553, player.nX, player.nY, player.nZ + 500)
end
