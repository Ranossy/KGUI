---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/item/苍云特殊武器_武器中的寻首击山母技能.lua
-- 更新时间:	2016/6/8 15:45:57
-- 更新用户:	zhangdongen
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/item/苍云特殊武器_武器中的寻首击山母技能.lua", -- 属性值1
		0											-- 属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10825, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.DoAction(0, 60121)
		player.PlayCharacterSound(19196)
		player.AddBuff(0, 99, 10825, 1, 40) --寻首击山开始图标为黑
		player.AddBuff(0, 99, 10823, 1, 40) --争神炎舞图标为黑
		player.AddBuff(0, 99, 11106, 1, 40) --炎帝反击图标为黑
		player.DelBuff(11183, 1)--寻首击山手动图标亮
		player.DelBuff(10824, 1)---删除被击响应
		player.DelBuff(11197, 1)---删除魂吸buff
		--player.DelBuff(8400, 1)
		player.DelBuff(11036, 1)
		player.DelBuff(11036, 2)
		player.CastSkill(17062, 1)--空吟唱
		player.AddBuff(0, 99, 10828, 1, 5)---技能强制释放倒计时buff
		player.PlaySfx(1445, 0, 0, 0)
	end
end
