...
tSkillData =
{
	{nDamageBase = 12000*0.95, nDamageRand = 12000*0.1, nCostMana = 0},		--level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local paotai = GetNpc(dwSkillSrcID)
	if not paotai then 
		return
	end
	...
	local npc1 = scene.CreateNpc(20016, character.nX, character.nY, character.nZ, 0, 90)
	local npc2 = scene.CreateNpc(20026, character.nX, character.nY, character.nZ, 0, 90)
	npc1.AddBuff(0, 99, 4643, 1)
	npc1.SetBattleFieldSide(paotai.nBattleFieldSide)
	npc2.SetBattleFieldSide(paotai.nBattleFieldSide)
	npc1.AddBuff(0, 99, 4611, 1)
	npc2.AddBuff(0, 99, 4611, 1)
end
