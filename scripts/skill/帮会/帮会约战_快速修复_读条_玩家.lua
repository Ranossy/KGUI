...
Include("scripts/Map/帮会约战/include/DataManager.lua")
...
--	character.SetCustomUnsigned4(PATROL_GUARD_VALUE.DW_HP, character.nCurrentLife)

	character.DoAction(0, 0)
end
