...
tSkillData =
{
	{nDamageBase = 125000*0.8, nDamageRand = 125000*0.4, nCostMana = 0},		--level 1
	{nDamageBase = 239890*0.8, nDamageRand = 239890*0.4, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
  --skill.BindBuff(1, 2450, 1);		-- 设置1号位Buff
