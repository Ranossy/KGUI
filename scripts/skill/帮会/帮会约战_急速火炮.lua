---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/帮会/帮会约战_急速火炮.lua
-- 更新时间:	2012-9-13 14:20:29
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 320000 * 0.8, nDamageRand = 320000 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--kill.nTargetCountLimit = 25;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制) 
