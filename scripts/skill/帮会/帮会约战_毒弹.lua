...
tSkillData =
{
	{nDamageBase = 11000*0.95, nDamageRand = 11000*0.1, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 4644, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	if IsPlayer(dwCharacterID) then
		...
		character.AddBuff(0,99,4644,1)
	else
		character = GetNpc(dwCharacterID)
		character.AddBuff(0,99,4644,2)
	end
