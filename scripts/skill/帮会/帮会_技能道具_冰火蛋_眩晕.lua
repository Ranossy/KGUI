...
tSkillData =
{
	{nDamageBase = 75000*0.8, nDamageRand = 75000*0.4, nCostMana = 0},		--level 1
};
...
function GetSkillLevelData(skill)
    ...
    skill.AddSlowCheckDestBuff(2454, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1, 2454, 1);		-- 设置1号位Buff
