---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防摧城车_投石.lua
-- 更新时间:	2015/9/12 22:28:52
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetDelaySubSkill(1, 6381, dwSkillLevel)
	--skill.SetDelaySubSkill(10 * 0.528, 6382, dwSkillLevel)
	-----------------技能渐变相关-------------------------------------------
	...
	skill.nDismountingRate = 1024;					-- 将目标击落下马几率,基数1024，默认0
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetTimer(32, "scripts/skill/Carrier/攻防摧城车_投石.lua", nX, nY)

	if player.nCurrentMana < 1000 - 100 then
		player.nCurrentMana = player.nCurrentMana + 100
	end
end
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 14687
	local dwSkillID_Up = 14688
	...
	player.CastSkillXYZ(dwSkillID, nTargetPlayerLevel, nX, nY, nZ)
	player.CastSkillXYZ(dwSkillID_Up, nTargetNpcLevel, nX, nY, nZ)

	player.PlaySfx(1022, nParam1, nParam2, nZ)
end
