---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机台_照明弹大.lua
-- 更新时间:	2014/4/22 18:42:11
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机台_照明弹大.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.DelBuff(3203, 1)
		player.DelBuff(4052, 1)
		player.DelBuff(3203, 2)
		player.DelBuff(4052, 2)
		player.DelBuff(3203, 3)
		player.DelBuff(4052, 3)
		player.DelBuff(3203, 4)
		player.DelBuff(4052, 4)
	end
end
