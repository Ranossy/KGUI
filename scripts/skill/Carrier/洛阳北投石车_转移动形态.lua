---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/洛阳北投石车_转移动形态.lua
-- 更新时间:	2016/2/24 17:24:01
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/洛阳北投石车_转移动形态.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 18 then
		player.Stop()
		...
		player.StartShapeShift(17)
		player.SetTimer(2, "scripts/skill/Carrier/洛阳北投石车_转移动形态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.DoAction(0, 55156)
		player.nCurrentLife = nParam2
		player.SetTimer(41, "scripts/skill/Carrier/洛阳北投石车_转移动形态.lua", 2, 0)
