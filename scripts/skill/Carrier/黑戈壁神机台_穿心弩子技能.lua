---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机台_穿心弩子技能.lua
-- 更新时间:	2015/10/1 22:02:59
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/黑戈壁神机台_穿心弩子技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	...
	if buff_RanHuo then
		player.CastSkill(15017, nTargetPlayerLevel, type, dwID)
		player.CastSkill(15019, nTargetNpcLevel, type, dwID)
	else
		player.CastSkill(15018, nTargetPlayerLevel, type, dwID)
		player.CastSkill(15020, nTargetNpcLevel, type, dwID)
	end
