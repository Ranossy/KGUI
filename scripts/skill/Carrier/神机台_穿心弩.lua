---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机台_穿心弩.lua
-- 更新时间:	2014/4/16 1:28:50
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
		...
		"skill/Carrier/神机台_穿心弩.lua", -- 属性值1
		0														-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if buff_RanHuo then
		player.CastSkill(9082, nTargetPlayerLevel)
		player.CastSkill(9084, nTargetNpcLevel)
	else
		player.CastSkill(9081, nTargetPlayerLevel)
		player.CastSkill(9083, nTargetNpcLevel)
	end
end
