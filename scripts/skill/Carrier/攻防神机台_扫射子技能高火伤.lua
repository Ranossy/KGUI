---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机台_扫射子技能高火伤.lua
-- 更新时间:	2015/8/18 16:33:54
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
local nDamageStandard = 60000*1.5
...
tSkillData =
{
	...
	{nDamageBase = nDamageStandard * 2, nDamageRand = 0, nCostMana = 0}, --level 5 摧城 提高100%伤害
	{nDamageBase = nDamageStandard * 2, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = nDamageStandard * 2.1, nDamageRand = 0, nCostMana = 0}, --level 7 鬼斧+摧城 提高 110%伤害
};
