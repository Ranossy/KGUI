---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/摧城车_裂火石.lua
-- 更新时间:	2014/7/9 14:39:18
-- 更新用户:	lilin-kingsoft
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetTimer(32, "scripts/skill/Carrier/摧城车_裂火石.lua", nX, nY)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 9402
	local dwSkillID_Up = 9403
