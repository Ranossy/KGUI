---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机台_穿心弩.lua
-- 更新时间:	2015/8/18 16:31:50
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机台_穿心弩.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.CastSkillXYZ(14383, 1, nX, nY, nZ)
		player.CastSkillXYZ(9151, 1, nX, nY, nZ)--子弹表现
		player.SetTimer(2, "scripts/skill/Carrier/攻防神机台_穿心弩子技能.lua", 0, 0)
	end
end
