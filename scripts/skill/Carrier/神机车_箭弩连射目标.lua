---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机车_箭弩连射目标.lua
-- 更新时间:	2014/4/17 22:24:32
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机车_箭弩连射目标.lua", -- 属性值1
		0														-- 属性值2
	);
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	...
	player.CastSkill(8969, nTargetPlayerLevel, type, dwID)
	player.CastSkill(9041, nTargetNpcLevel, type, dwID)
