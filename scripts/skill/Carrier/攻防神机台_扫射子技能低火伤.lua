---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机台_扫射子技能低火伤.lua
-- 更新时间:	2015/8/18 16:33:30
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
local nDamageStandard = 10000*1.5
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(7734, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
