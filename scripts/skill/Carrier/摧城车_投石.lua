---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/摧城车_投石.lua
-- 更新时间:	2014/7/4 14:53:35
-- 更新用户:	lilin-kingsoft
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetTimer(32, "scripts/skill/Carrier/摧城车_投石.lua", nX, nY)
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 9397
	local dwSkillID_Up = 9398
