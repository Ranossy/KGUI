---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防箭塔死亡范围加成就.lua
-- 更新时间:	2015/10/22 17:28:37
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防箭塔死亡范围加成就.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
	...
	skill.AddSlowCheckDestBuff(10176, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 10176, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not target.IsAchievementAcquired(5173) then
		target.AddAchievementCount(5173, 1)
	end
end
