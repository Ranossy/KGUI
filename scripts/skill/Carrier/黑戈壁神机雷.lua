---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机雷.lua
-- 更新时间:	2015/10/13 15:43:51
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nCount = player.GetItemAmount(ITEM_TABLE_TYPE.OTHER, 25838)
	if nCount < 1 then
		return
	end
	player.CostItemInAllPackage(ITEM_TABLE_TYPE.OTHER, 25838, 1)
	...
	if npcTemp then
		...
		player.SetTimer(16, "scripts/skill/Carrier/黑戈壁神机雷.lua", npcTemp.dwID, 0)
	end
end
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 15107
	local dwSkillID_Up = 15108
