---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_过热.lua
-- 更新时间:	2015/8/18 16:35:02
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 10 then
		player.Stop()
		...
		player.StartShapeShift(9)
		player.SetTimer(1, "scripts/skill/Carrier/攻防神机车_过热.lua", 1, 0)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.SetTimer(108, "scripts/skill/Carrier/攻防神机车_过热.lua", 2, 0)
	elseif nParam1 == 2 then
		...
		player.CastSkill(14381, nTargetPlayerLevel)
		player.CastSkill(14478, nTargetNpcLevel)
