---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_十矢俱发.lua
-- 更新时间:	2016/2/16 11:25:35
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机车_十矢俱发.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9938, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 972);	--技能普通CD
...
function CanCast(player, nPreResult) -- 判断玩家的状态，以判断是否可以发出技能
	player.AddBuff(player.dwID, player.nLevel, 9938, 1, 6)
	return nPreResult;
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.CastSkillXYZ(14788, nTargetPlayerLevel, nX, nY, nZ)
	player.CastSkillXYZ(14789, nTargetNpcLevel, nX, nY, nZ)

	player.CastSkillXYZ(9148, 1, nX, nY, nZ)--子弹效果
end
