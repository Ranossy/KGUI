---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防摧城车_石爆.lua
-- 更新时间:	2015/9/26 20:28:34
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetTimer(32, "scripts/skill/Carrier/攻防摧城车_石爆.lua", nX, nY)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 14983
	local dwSkillID_Up = 14984
