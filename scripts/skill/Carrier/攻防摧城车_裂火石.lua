---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防摧城车_裂火石.lua
-- 更新时间:	2015/9/12 22:28:50
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSrcID)
	...
	player.SetTimer(32, "scripts/skill/Carrier/攻防摧城车_裂火石.lua", nX, nY)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	local dwSkillID = 14691
	local dwSkillID_Up = 14692
	...
	player.PlaySfx(1023, nParam1, nParam2, nZ)
end
