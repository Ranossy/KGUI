---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机车_箭弩连射.lua
-- 更新时间:	2014/3/12 15:42:27
-- 更新用户:	gaoweilong1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机车_箭弩连射.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		...
		player.CastSkillXYZ(9142, 1, nX, nY, nZ)
		player.CastSkillXYZ(9148, 1, nX, nY, nZ)
		player.SetTimer(2, "scripts/skill/Carrier/神机车_箭弩连射目标.lua", 0, 0)
	end	
end
