---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_箭弩连射子技能.lua
-- 更新时间:	2015/8/18 16:37:49
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机车_箭弩连射子技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	...
	player.CastSkill(14475, nTargetPlayerLevel, type, dwID)
	player.CastSkill(14476, nTargetNpcLevel, type, dwID)
