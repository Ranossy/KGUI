---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机台_穿心弩目标技能.lua
-- 更新时间:	2014/4/18 11:04:59
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机台_穿心弩目标技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	...
	if buff_RanHuo then
		player.CastSkill(9076, nTargetPlayerLevel, type, dwID)
		player.CastSkill(9078, nTargetNpcLevel, type, dwID)
	else
		player.CastSkill(9075, nTargetPlayerLevel, type, dwID)
		player.CastSkill(9077, nTargetNpcLevel, type, dwID)
	end
