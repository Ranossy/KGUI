---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_燃火箭.lua
-- 更新时间:	2015/10/2 16:24:42
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机车_燃火箭.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.CastSkill(14379, nTargetPlayerLevel)
	player.CastSkill(14477, nTargetNpcLevel)
end
