---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机车_过热.lua
-- 更新时间:	2015/10/1 22:02:48
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 15 then
		player.Stop()
		player.AddBuff(0, 99, 7616, 1, 100)
		...
		player.EndShapeShiftNoDelay()
		player.StartShapeShift(14)
		player.SetTimer(1, "scripts/skill/Carrier/黑戈壁神机车_过热.lua", 1, 0)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		player.Stop()
		player.AddBuff(0, 99, 7615, 1, 55)
		player.AddBuff(0, 99, 7616, 1, 100)
		player.PlayCameraAnimation(102, 0)
		player.DoAction(0, 55071)
		player.SetTimer(108, "scripts/skill/Carrier/黑戈壁神机车_过热.lua", 2, 0)
	elseif nParam1 == 2 then
		player.PlayCameraAnimation(0, 0)
		player.DelBuff(7616, 1)
		...
		player.CastSkill(15013, nTargetPlayerLevel)
		player.CastSkill(15014, nTargetNpcLevel)
