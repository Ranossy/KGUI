---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机车_转移动形态.lua
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/黑戈壁神机车_转移动形态.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 15 then
		...
		player.SetTimer(1, "scripts/skill/Carrier/黑戈壁神机车_转移动形态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.DoAction(0, 55044)
		player.nCurrentLife = nParam2
		player.SetTimer(41, "scripts/skill/Carrier/黑戈壁神机车_转移动形态.lua", 2, 0)
