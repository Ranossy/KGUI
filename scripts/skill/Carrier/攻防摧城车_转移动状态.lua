---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防摧城车_转移动状态.lua
-- 更新时间:	2015/9/12 22:37:41
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 13 then
		player.Stop()
		...
		player.StartShapeShift(12)
		player.SetTimer(2, "scripts/skill/Carrier/攻防摧城车_转移动状态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.SetTimer(41, "scripts/skill/Carrier/攻防摧城车_转移动状态.lua", 2, 0)
