---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机台_扫射.lua
-- 更新时间:	2015/10/1 22:03:03
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/黑戈壁神机台_扫射.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if buff_RanHuo then
		player.CastSkill(15022, nTargetPlayerLevel)
		player.CastSkill(15024, nTargetNpcLevel)
	else
		player.CastSkill(15023, nTargetPlayerLevel)
		player.CastSkill(15025, nTargetNpcLevel)
	end
end
