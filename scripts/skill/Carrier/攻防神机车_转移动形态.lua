---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_转移动形态.lua
-- 更新时间:	2015/8/17 17:41:09
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 10 then
		...
		player.SetTimer(1, "scripts/skill/Carrier/攻防神机车_转移动形态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.SetTimer(41, "scripts/skill/Carrier/攻防神机车_转移动形态.lua", 2, 0)
