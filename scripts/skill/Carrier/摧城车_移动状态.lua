---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/摧城车_移动状态.lua
-- 更新时间:	2014/6/30 15:57:16
-- 更新用户:	lilin-kingsoft
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 5 then
		player.Stop()
		...
		player.StartShapeShift(4)
		player.SetTimer(2, "scripts/skill/Carrier/摧城车_移动状态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.SetTimer(41, "scripts/skill/Carrier/摧城车_移动状态.lua", 2, 0)
