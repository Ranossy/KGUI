---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机台_扫射.lua
-- 更新时间:	2015/10/9 21:41:49
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机台_扫射.lua", -- 属性值1
		0														-- 属性值2
	);

	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(7755, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(7754, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求自身属于自己的Buff
	...
	skill.SetNormalCoolDown(1, 723);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if buff_RanHuo then
		player.CastSkill(14484, nTargetPlayerLevel)
		player.CastSkill(14485, nTargetNpcLevel)
	else
		player.CastSkill(14388, nTargetPlayerLevel)
		player.CastSkill(14404, nTargetNpcLevel)
	end
end
