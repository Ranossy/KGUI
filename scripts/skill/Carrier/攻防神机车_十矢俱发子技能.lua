---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_十矢俱发子技能.lua
-- 更新时间:	2016/2/16 11:28:14
-- 更新用户:	wangsongtao-pc
-- 脚本说明:	这才是母技能-备份用，此脚本废弃了
----------------------------------------------------------------------<
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	player.AddBuff(player.dwID, player.nLevel, 9938, 1, 9)
	return nPreResult;
end
...
function Apply(dwCharacterID)
	...
	player.CastSkillXYZ(14787, 1, nX, nY, nZ)
end
