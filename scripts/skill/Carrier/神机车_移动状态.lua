---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机车_移动状态.lua
-- 更新时间:	2014/3/14 9:27:22
-- 更新用户:	gaoweilong1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.dwShapeShiftID == 2 then
		...
		player.SetTimer(1, "scripts/skill/Carrier/神机车_移动状态.lua", 1, CurrentLife)
	end
end
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	if nParam1 == 1 then
		...
		player.SetTimer(41, "scripts/skill/Carrier/神机车_移动状态.lua", 2, 0)
