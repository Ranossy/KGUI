---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/攻防神机车_箭弩连射.lua
-- 更新时间:	2015/8/18 16:37:32
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/攻防神机车_箭弩连射.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.CastSkillXYZ(14377, 1, nX, nY, nZ)--子技能
		player.CastSkillXYZ(9148, 1, nX, nY, nZ)--子弹效果
		player.SetTimer(2, "scripts/skill/Carrier/攻防神机车_箭弩连射子技能.lua", 0, 0)
	end
end
