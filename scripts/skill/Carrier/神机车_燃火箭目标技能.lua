---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机车_燃火箭目标技能.lua
-- 更新时间:	2014/4/17 22:49:24
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机车_燃火箭目标技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function OnTimer(player, nParam1, nParam2)				-- 一定时间后生效
	...
	player.CastSkillXYZ(8957, nTargetPlayerLevel, target.nX, target.nY, target.nZ)
	player.CastSkillXYZ(9056, nTargetNpcLevel, target.nX, target.nY, target.nZ)
