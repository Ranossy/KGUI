---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/摧城车_冲撞.lua
-- 更新时间:	2014/7/1 9:42:22
-- 更新用户:	lilin-kingsoft
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	local npc = scene.GetNpcByNickName(player.dwID .. 36718)
	if not npc then
		return nPreResult
	end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local dwSkillID = 9399
	local dwSkillID_Up = 9400
	...
	player.SetTimer(38, "scripts/skill/Carrier/摧城车_冲撞.lua", npc.dwID, 0)
end
