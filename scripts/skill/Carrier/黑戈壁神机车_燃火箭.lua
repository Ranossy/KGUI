---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/黑戈壁神机车_燃火箭.lua
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/黑戈壁神机车_燃火箭.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.CastSkill(15010, nTargetPlayerLevel)
	player.CastSkill(15011, nTargetNpcLevel)
end
