---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Carrier/神机台_穿心弩BUFF子技能.lua
-- 更新时间:	2014/4/18 10:56:39
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Carrier/神机台_穿心弩BUFF子技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if npc then
		...
		player.CastSkillXYZ(9150, 1, nX, nY, nZ)
		player.CastSkillXYZ(9151, 1, nX, nY, nZ)
		player.SetTimer(2, "scripts/skill/Carrier/神机台_穿心弩目标技能.lua", 0, 0)
	end	
end
