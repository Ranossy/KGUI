...
function GetSkillLevelData(skill)
	...
	--skill.SetDelaySubSkill(1, 6588, dwSkillLevel)
	--skill.SetDelaySubSkill(16, 6588, dwSkillLevel)	
	-----------------技能渐变相关-------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 6312, 1);		-- 设置1号位Buff
	...
	--skill.nCostManaBasePercent = 0.3 * 1024;					-- 技能消耗的内力
...
function Apply(dwCharacterID)
	...
	if player.dwJumpType == 9 and player.bSprintFlag then
		player.AddBuff(0,99,6313,1)
	end	
end
