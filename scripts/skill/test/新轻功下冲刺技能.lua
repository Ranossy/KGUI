---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/test/新轻功下冲刺技能.lua
-- 更新时间:	2013/5/6 19:15:00
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if nTargetType and nTargetType == TARGET.PLAYER then
		...
		if player_Target and player_Target.GetBuff(11594, 0) then	--战场背旗子的不能被丐帮轻功带着飞
			return false
		end
