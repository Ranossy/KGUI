---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/test/大唐监狱_开锁左转.lua
-- 更新时间:	2013/6/19 17:41:36
-- 更新用户:	gaoweilong1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player then
		...
		if buff and buff.nCustomValue == 1 then
			...
			RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(6, 415), 5)
