---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/秦皇预热_霜寒斩释放.lua
-- 更新时间:	2014/3/7 17:54:30
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 7596, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
			...
			player.AddBuff(0, 99, 7467, 1, 8)  --反制机会BUFF
			player.SetDynamicSkillGroup(119)  --为反制做准备屏蔽技能栏
			--player.PlaySfx(680, player.nX, player.nY, player.nZ)
	end
end
