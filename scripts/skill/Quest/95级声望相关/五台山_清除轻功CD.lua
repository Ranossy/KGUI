---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/五台山_清除轻功CD.lua
-- 更新时间:	2015/8/11 19:58:23
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	local tCDList = {
		-- 藏剑：(1580) 玉泉鱼跃  鹤归孤山  (1577) 玉虹贯日 (1589) 梦泉虎跑
		-- 少林: (498) 千斤坠   拿云式
		-- 天策：(424) 天策-疾  突，灭
		-- 万花：(228) 太阴指
		-- 纯阳：(346) 梯云纵   剑冲阴阳
		...
		-- 五毒: (2228) 化蝶
		-- 唐门: (3118) 鸟翔碧空  子母飞爪
		-- 明教: (3970) 幻光步 (3967) 净世破魔击 [流光囚影]
		-- 丐帮: (5269) 烟雨行  [龙战于野][龙跃于渊][棒打狗头][烟雨行] (5265) 见龙在田
		-- 苍云: (13424) 撼地  [盾猛][闪刀]
		16,
		45, -- 少林_龙爪手_拿云式
		88, -- 轻功
