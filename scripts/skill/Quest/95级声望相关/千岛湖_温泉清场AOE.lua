---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/千岛湖_温泉清场AOE.lua
-- 更新时间:	2015/8/22 20:04:16
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 15000, nDamageRand = 5000, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/95级声望相关/千岛湖_温泉清场AOE.lua",
		0
	);
--[[
	skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.CustomDamage(npc.dwID, 14519, 1, 1, player.nMaxLife * 0.2)
end
