---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/阴山大草原_摔跤比试_回风落叶母技能.lua
-- 更新时间:	2015/8/20 16:51:59
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/95级声望相关/阴山大草原_摔跤比试_回风落叶母技能.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not buff9367 then
		player.CastSkill(14517, 1)
	elseif buff9367.nStackNum then
		player.CastSkill(14517, buff9367.nStackNum+1)
	end
end
