---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/阴山大草原_摔跤比试_格挡反击.lua
-- 更新时间:	2015/10/22 21:57:30
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 1250, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/95级声望相关/阴山大草原_摔跤比试_格挡反击.lua", -- 属性值1
		0											-- 属性值2
	);
...
--[[
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.BE_THERAPY_COEFFICIENT,
		1024,
		0
	);
...
--]]
	...
	--skill.SetNormalCoolDown(1, 930);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buff9367 = player.GetBuff(9367, 1)
	if not buff9367 then
		player.CastSkill(14516, 1)
	elseif buff9367.nStackNum then
		player.CastSkill(14516, buff9367.nStackNum + 1)
	end
end
