---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/阴山大草原_道具治疗.lua
-- 更新时间:	2015/10/24 22:48:48
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/95级声望相关/阴山大草原_道具治疗.lua", -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(9529, 1, 1, 1, 1);		-- 需求自身Buff
	skill.AddSlowCheckDestBuff(9346, 1, 1, 1, 1);		-- 需求目标Buff
	...
	--skill.SetNormalCoolDown(1, 928);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npcTarget then
		...
		if not buff1 then
			RemoteCallToClient(player.dwID, "OnSendSystemAnnounce", GetEditorString(8, 8206), "red")
			return
		end
	end

	--player.DoAction(0, 20102)
	--player.DelBuff(9529, 1)
