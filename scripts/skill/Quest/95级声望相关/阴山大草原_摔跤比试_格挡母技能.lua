---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/95级声望相关/阴山大草原_摔跤比试_格挡母技能.lua
-- 更新时间:	2015/8/20 16:32:36
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/95级声望相关/阴山大草原_摔跤比试_格挡母技能.lua",											-- 属性值1
		0											-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 943);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if buff9367 then
		local nBuffLevel = buff9367.nStackNum + 1
		player.AddBuff(0, 99, 9548, nBuffLevel)
	else
		player.AddBuff(0, 99, 9548, 1)
	end
end
