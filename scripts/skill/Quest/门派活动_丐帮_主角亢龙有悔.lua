---------------------------------------------------------------------->
-- 脚本名称:	G:/Head/client/scripts/skill/Quest/门派活动_丐帮_主角亢龙有悔.lua
-- 更新时间:	2013/5/19 23:01:53
-- 更新用户:	chenbugao
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/门派活动_丐帮_主角亢龙有悔.lua",
		0														
	);	
	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	local guoyan = scene.GetNpcByNickName("gaibangdizi9")
	if not guoyan then 
		return
	end
