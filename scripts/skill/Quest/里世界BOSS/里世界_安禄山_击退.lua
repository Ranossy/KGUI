---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/里世界BOSS/里世界_安禄山_击退.lua
-- 更新时间:	2016/8/30 19:12:24
-- 更新用户:	lilin101
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/里世界BOSS/里世界_安禄山_击退.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(11, 1522), 5)
end
