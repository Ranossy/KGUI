---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/里世界BOSS/里世界_萧沙_暴风尘流抓人.lua
-- 更新时间:	2016/11/1 17:49:32
-- 更新用户:	qinfupi
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/里世界BOSS/里世界_萧沙_暴风尘流抓人.lua", -- 属性值1
		0														-- 属性值2
	)
...
function Apply(dwCharacterID)
	...
	if player then
		player.SendSystemMessage(GetEditorString(11, 1844))	
	end
end
