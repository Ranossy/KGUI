---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/里世界BOSS/里世界_安禄山_疾驰.lua
-- 更新时间:	2016/8/30 14:17:16
-- 更新用户:	lilin101
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 6600, nDamageRand = 400, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(11135, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 11135, 1);		-- 设置1号位Buff
