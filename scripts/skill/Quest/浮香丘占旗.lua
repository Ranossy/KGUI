---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/浮香丘占旗.lua
-- 更新时间:	2017/1/11 15:15:49
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nCamp + 1 == player.nCamp then
		tBattleFunction.AddPlayerQuestValue(player, 16471, 0, 1, 30)
	else
		tBattleFunction.AddPlayerQuestValue(player, 16452, 0, 1, 30)
	end
end
