---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/安史之乱_令狐伤活动_召唤·狼牙军士.lua
-- 更新时间:	2013/6/9 16:43:02
-- 更新用户:	xutong3
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_令狐伤活动_召唤·狼牙军士.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 638);	--技能普通CD
...
local tFormation = {
--dwID,true,nRadius,nFace,nRadian,nDisFrames,szName--npcID,npc还是doodad,半径长度，相对主npc朝向。角度。小时时间,别名
	{25452, true, 500, 0, 0, LASTTIME},
	{25452, true, 300, 0, (1 / 6 * math.pi), LASTTIME},
	{25452, true, 300, 0, (1 / 2 * math.pi), LASTTIME},
	{25452, true, 300, 0, (5 / 6 * math.pi), LASTTIME},
	{25452, true, 500, 0, (1 * math.pi), LASTTIME},
	{25452, true, 300, 0, (7 / 6 * math.pi), LASTTIME},
	{25452, true, 300, 0, (9 / 6 * math.pi), LASTTIME},
	{25452, true, 300, 0, (11 / 6 * math.pi), LASTTIME},
}
...
function Apply(dwCharacterID)
	...
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(5, 8700), 3)
end

--魔法属性反应用时的执行函数,dwCharacterID是魔法属性作用的目标ID
function UnApply(dwCharacterID)
end
function CreatNpcByRadiation(npc, tFormation)--根据特殊的阵型表创建npc或doodad。npc：主npc。被阵型围绕的npc。随从的名字是主人名字加Fi
