...
function Apply(dwCharacterID)
	...
	local npc = scene.CreateNpc(1636, player.nX, player.nY, player.nZ, player.nFaceDirection, 960 + 16)
	scene.SetTimer(960, "scripts/skill/Quest/寇岛_施放机甲人.lua", npc.dwID, 0)
end
...
function OnTimer(scene, dwID, nParam2)
