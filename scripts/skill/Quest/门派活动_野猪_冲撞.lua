---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/门派活动_野猪_冲撞.lua
-- 更新时间:	2015/9/6 16:55:16
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/门派活动_野猪_冲撞.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		local npcBOSS = scene.GetNpcByNickName("ACT308_Boss_" .. player.dwID)
		if npcBOSS then
			dwCasterID = npcBOSS.dwID
		end
	end
	player.CustomDamage(dwCasterID, 14570, 1, 3, player.nMaxLife * 0.05)
end
