---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/逐鹿中原/御城·励.lua
-- 更新时间:	2014/2/13 10:44:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/逐鹿中原/御城·励.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	for i = 1, 500 do
		szName = "CastleGuard" .. buff.nLevel .. i
		local npc_Guard = scene.GetNpcByNickName(szName)
		if npc_Guard then
			npc_Guard.AddBuff(0, 99, 7494, 1)
		end
	end
end
