---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/逐鹿中原/御城·极.lua
-- 更新时间:	2014/2/13 15:00:39
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	skill.SetSubsectionSkill(1, 1, 15102, dwSkillLevel);
	skill.SetSubsectionSkill(2, 2, 15102, dwSkillLevel);
	skill.SetSubsectionSkill(3, 3, 15102, dwSkillLevel);
	skill.SetSubsectionSkill(4, 4, 15102, dwSkillLevel);
	skill.SetSubsectionSkill(5, 5, 15102, dwSkillLevel);
	skill.AddAttribute(
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(10076, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.SetNormalCoolDown(1, 688);	--技能普通CD
