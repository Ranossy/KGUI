---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/逐鹿中原/神机雷_子技能NPC.lua
-- 更新时间:	2016/12/24 21:54:22
-- 更新用户:	wangsongtao-pc
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 1420000, nDamageRand = 0, nCostMana = 0}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/逐鹿中原/神机雷_子技能NPC.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	-- GF任务
	local nQuestIdx = player.GetQuestIndex(16415)
	if nQuestIdx and not player.GetBuff(11591, 1) then
		...
		player.SetQuestValue(nQuestIdx, 0, math.min(100, nValue + 50))
		if nValue + 50 >= 100 then
			player.ForceFinishQuest(16415)
		end
	end
end
