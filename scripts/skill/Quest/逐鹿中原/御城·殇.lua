---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/逐鹿中原/御城·殇.lua
-- 更新时间:	2014/3/21 15:13:31
-- 更新用户:	lilin-kingsoft
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/逐鹿中原/御城·殇.lua", -- 属性值1
		0											-- 属性值2
	);
	--[[
   	skill.AddAttribute(
	...
	skill.SetNormalCoolDown(1, 691);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buff = player.GetBuff(CastleFight.BuffList.Flag.dwBuffID, 0)
	if not buff then
		return
	end
