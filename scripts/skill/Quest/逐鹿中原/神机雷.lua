---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/逐鹿中原/神机雷.lua
-- 更新时间:	2014/4/9 11:24:05
-- 更新用户:	gaoweilong1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 715);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)	
	...
	if player then
		...
		if not CastleFight.GetMapFightState(scene.dwMapID) then -- 地图是否开战
			return
		end
		player.CostItem(5, 21298, 1)
		player.CastSkill(9053, 1)
		player.CastSkill(9054, 1)
		player.AddAchievementCount(4181, 1)
		player.PlaySfx(665, player.nX, player.nY, player.nZ)
		player.Die()
	end
