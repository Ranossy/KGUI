...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
	skill.SetSubsectionSkill(1, 1, 8817, dwSkillLevel);
	skill.SetSubsectionSkill(2, 2, 8817, dwSkillLevel);
	skill.SetSubsectionSkill(3, 3, 8817, dwSkillLevel);
	skill.SetSubsectionSkill(4, 4, 8817, dwSkillLevel);
	skill.SetSubsectionSkill(5, 5, 8817, dwSkillLevel);
	skill.AddAttribute(
