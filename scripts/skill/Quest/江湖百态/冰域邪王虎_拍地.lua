---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/冰域邪王虎_拍地.lua
-- 更新时间:	2016/9/21 21:43:56
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
    ...
    if player.nMoveState == MOVE_STATE.ON_RUN or player.nMoveState == MOVE_STATE.ON_WALK or player.nMoveState == MOVE_STATE.ON_STAND then
    	if not player.GetBuff(11284, 1) then
		    player.AddBuff(player.dwID, player.nLevel, 11284, 1, 10)
		end
    end
