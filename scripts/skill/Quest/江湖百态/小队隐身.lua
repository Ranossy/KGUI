---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/小队隐身.lua
-- 更新时间:	2016/6/16 17:00:46
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/江湖百态/小队隐身.lua", -- 属性值1
		0														-- 属性值2
		)
...
--	local player = GetPlayer(dwSkillSrcID)
	...
	if dwCharacterID == dwSkillSrcID then
		target.AddBuff(0, 99, 10852, 1, 3)
		--print("yes", target.szName)
		return
	end
	if IsParty(dwCharacterID, dwSkillSrcID) then
		target.AddBuff(0, 99, 10852, 1, 3)
	end
	--print("yes", target.szName)
end
