---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/入里世界门.lua
-- 更新时间:	2016/11/15 16:43:35
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(11522, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nLevel < 95 then
		return
	end
	local szText = GetEditorString(11, 1991);
	player.AddBuff(0, 99, 11522, 1)
	RemoteCallToClient(player.dwID, "OnMessageBoxRequest", 33, szText, GetEditorString(6, 7070), GetEditorString(6, 7069), dwSkillSrcID);
