---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/艺人_反馈子弹3.lua
-- 更新时间:	2016/7/13 22:32:30
-- 更新用户:	wangwei2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/江湖百态/艺人_反馈子弹3.lua", -- 属性值1
		0														-- 属性值2
	)
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(actor.dwID, actor.nLevel, 10972, 1)
	actor.Talk(GetEditorString(10, 3034) .. player.szName .. GetEditorString(10, 3035))
end
