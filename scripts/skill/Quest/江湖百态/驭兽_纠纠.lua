---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/驭兽_纠纠.lua
-- 更新时间:	2016/7/5 19:17:50
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2250, nDamageRand = 0, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(10941, 1) then
		player.AddBuff(player.dwID, player.nLevel, 10941, 1, 30)
	end
	if not player.GetBuff(10941, 1) then
		local nRandom = Random(1, 100000)
		if nRandom > 50000 then
			player.AddBuff(0, 99, 10941, 1, 5)
		end
	end
end
