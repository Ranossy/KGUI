---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/方士_主角_挖宝.lua
-- 更新时间:	2016/8/14 17:15:41
-- 更新用户:	lilin101
-- 脚本说明:
----------------------------------------------------------------------<
...
Include("scripts/Map/寻宝系统/item/寻宝挖宝的铲子.lua")
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 316);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		...
		npc.CastSkill(16437, 1)
	end
	player.SetTimer(2, "scripts/skill/Quest/江湖百态/方士_主角_挖宝.lua", player.dwID, 0)
	--OnDigHoro(player)
end
