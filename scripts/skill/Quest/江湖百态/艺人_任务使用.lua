---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/艺人_任务使用.lua
-- 更新时间:	2016/7/15 16:15:25
-- 更新用户:	YANGYUBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nQuestId = 15487
	local nQuestIndex = player.GetQuestIndex(nQuestId)
	local nQuestPhase = player.GetQuestPhase(nQuestId)
	if nQuestIndex and nQuestPhase == 1 then
		player.SetQuestValue(nQuestIndex, 1, 1)
	end
	local nQuestValue = player.GetQuestValue(nQuestIndex, 0)
	local scene = player.GetScene()
	local npc1 = scene.GetNpcByNickName("Artist_QuestXue" .. player.dwID)
	local npc2 = scene.GetNpcByNickName("Artist_QuestGuShou1" .. player.dwID)
	local npc3 = scene.GetNpcByNickName("Artist_QuestGuShou2" .. player.dwID)
	if nQuestValue == 1 then
		player.PlaySfx(1358, 29289, 31553, 1078099)
		player.PlaySfx(1358, 29389, 31653, 1078099)
		player.PlaySfx(1358, 29350, 31600, 1078099)
		player.PlaySfx(1358, 29289, 31177, 1078099)
		player.PlaySfx(1358, 29300, 31200, 1078099)
		if npc1 then
			npc1.Yell(GetEditorString(10, 2655))
			npc1.SetDisappearFrames(1)
		end       if npc2 then
			npc2.Die()
		end
		if npc3 then
