---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/艺人_反馈子弹1.lua
-- 更新时间:	2016/7/12 20:45:41
-- 更新用户:	wangwei2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/江湖百态/艺人_反馈子弹1.lua", -- 属性值1
		0														-- 属性值2
	)
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(actor.dwID, actor.nLevel, 10969, 1)
	actor.Talk(GetEditorString(10, 3030) .. player.szName .. GetEditorString(10, 3038))
end
