---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/艺人_技能16036.lua
-- 更新时间:	2016/7/9 20:26:27
-- 更新用户:	YANGYUBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/江湖百态/艺人_技能16036.lua",
		0
	);
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	if player.GetSkillLevel(16036) ~= 1 then
		return false
	end
	return nPreResult;
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if ArtistIdentity then
		ArtistIdentity.UpdateArtistCastSkill(16036)
	end
end
