---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/驭兽师_恐惧.lua
-- 更新时间:	2016/6/22 17:14:01
-- 更新用户:	lilin101
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	if player.GetBuff(Identity_YuShou.BuffList.PetState.dwID, Identity_YuShou.BuffList.PetState.nLevel) then
		player.DelBuff(Identity_YuShou.BuffList.PetState.dwID, Identity_YuShou.BuffList.PetState.nLevel)
	end
end
