---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/方士_贴符标记.lua
-- 更新时间:	2016/8/11 11:03:06
-- 更新用户:	lilin101
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	local dwMarkID = npc.GetCustomUnsigned2(Identity_Wizard.Ghost.ValueName.dwMarkID)
	scene.RemoveMapMark(dwMarkID)

	local dwPlayerID = npc.GetCustomUnsigned4(Identity_Wizard.Ghost.ValueName.dwOwnerID)
