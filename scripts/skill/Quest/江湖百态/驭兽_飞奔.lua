---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/驭兽_飞奔.lua
-- 更新时间:	2016/6/28 19:05:35
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/江湖百态/驭兽_飞奔.lua", -- 属性值1
		0														-- 属性值2
	)
	----------------- 魔法属性 -------------------------------------------------
	--skill.AddAttribute(
...
--	);
	...
	skill.SetNormalCoolDown(1, 1063);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(10855, 1) then
		player.AddBuff(player.dwID, player.nLevel, 10855, 1, 60)
	end
end
