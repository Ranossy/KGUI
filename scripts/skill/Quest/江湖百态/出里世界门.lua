---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/江湖百态/出里世界门.lua
-- 更新时间:	2016/11/15 16:28:49
-- 更新用户:	linjiajia2
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local szText = GetEditorString(11, 1955);
	RemoteCallToClient(player.dwID, "OnMessageBoxRequest", 34, szText, GetEditorString(11, 1946), GetEditorString(11, 1947), dwSkillSrcID);
end
