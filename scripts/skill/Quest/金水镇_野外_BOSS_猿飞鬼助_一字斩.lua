...
-- 武功套路  :  无
-- 技能名称  : 	一字斩
-- 技能效果  : 	对正前方释放半径20米扇形范围（60度）造成阴性内功伤害（6000点）
------------------------------------------------
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
   	...
   	skill.AddAttribute(
   		...
   		"skill/Quest/金水镇_野外_BOSS_猿飞鬼助_一字斩.lua",				-- 属性值1
   		0														-- 属性值2
   		);
	----------------- 技能施放Buff需求 ---------------------------------------------
  ...
  --skill.BindBuff(1,1331,1);		-- 设置1号位Buff 作用于自身的HOT
	...
	skill.nMaxRadius		= 19 * LENGTH_BASE;		-- 技能施放的最大距离 

	----------------- 作用范围 -------------------------------------------------
	skill.nAngleRange		= 114;					-- 攻击范围的扇形角度范围 
	skill.nAreaRadius		= 19 * LENGTH_BASE;		-- 技能作用半径 
