...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 3588, 1);		-- 设置1号位Buff
	skill.BindBuff(2, 3598, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID)
	...
	if character then
		character.nCurrentLife = character.nCurrentLife - character.nMaxLife * 0.5
	end
end
