---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/血战预热_力挽狂澜.lua
-- 更新时间:	2013/11/2 18:01:25
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/血战预热_力挽狂澜.lua", -- 属性值1
		0														-- 属性值2
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	--   skill.AddSlowCheckSelfBuff(4093, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--   skill.BindBuff(1, 4174, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 665);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if  player then
		player.AddBuff(0, 99, 7134, 1, 5) --5秒无敌
