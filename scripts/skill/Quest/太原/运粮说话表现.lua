---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/太原/运粮说话表现.lua
-- 更新时间:	2015/6/29 19:23:53
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
local tSay = {
	GetEditorString(7, 6531),
	GetEditorString(7, 6532),
	GetEditorString(7, 6533),
	GetEditorString(7, 6534),
	GetEditorString(7, 6535),
	GetEditorString(7, 6544),
	GetEditorString(7, 6548),
}
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/太原/运粮说话表现.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	if Random(100) < 30 then		
		local npcWeiGuan = GetNpc(dwCharacterID)
		local player = GetPlayer(dwSkillSrcID)
		if npcWeiGuan and player then
			if npcWeiGuan.dwTemplateID == 39413 then
				npcWeiGuan.SayTo(player.dwID, tSay[Random(#tSay)])
			end
		end
	end
end
