---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/太原/狼牙_投石砸房屋.lua
-- 更新时间:	2014/10/30 15:40:39
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 34700, nDamageRand = 0, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npczz = GetNpc(dwSkillSrcID)
	if npc and npc.szName == GetEditorString(6, 9780) then
		if npc.nCurrentLife <= npc.nMaxLife * 0.1 + 100000 then
			 npc.nCurrentLife = npc.nMaxLife * 0.1
		else
		npc.nCurrentLife = npc.nCurrentLife - 100000			
		end
	end
end
