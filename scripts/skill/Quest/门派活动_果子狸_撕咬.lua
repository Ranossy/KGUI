---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/门派活动_果子狸_撕咬.lua
-- 更新时间:	2015/9/6 16:43:23
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 400, nDamageRand = 400 * 0.1, nCostMana = 0}, --level 1
...
--	skill.AddSlowCheckSelfBuff(8327, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 段位切换
	...
	--skill.SetNormalCoolDown(1, 838);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		local npc = scene.GetNpcByNickName("ACT308_Boss_" .. player.dwID)
		if npc then
			dwCasterID = npc.dwID
		end
		player.CustomDamage(dwCasterID, 14569, 1, 0, player.nMaxLife * 0.01)
	end
end
