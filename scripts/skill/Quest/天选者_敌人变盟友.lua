---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/天选者_敌人变盟友.lua
-- 更新时间:	2013/11/28 14:50:36
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/天选者_敌人变盟友.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	----------------- 设置Cool down --------------------------------------------
	skill.SetNormalCoolDown(1, 676);	--技能普通CD
	-- 公共CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not scene.CheckPlayerInKillersSet(player.dwID) then
		player.AddBuff(0, 99, 7241, 1, 10)
		scene.AddPlayerToKillersSet(player.dwID)
	end
end
