---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/Quest/门派活动_焚野轰.lua
-- 更新时间:	2012-11-14 17:20:52
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 50000 * 0.8, nDamageRand = 50000 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 551);	--技能普通CD
