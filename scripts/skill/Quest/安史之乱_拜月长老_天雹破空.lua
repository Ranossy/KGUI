...
tSkillData =
{
	{nDamageBase = 37234 * 1, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 37234 * 2, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 37234 * 3, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 37234 * 4, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 37234 * 5, nDamageRand = 0, nCostMana = 0},		--level 5
...
function GetSkillLevelData(skill)
   ...
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_拜月长老_天雹破空.lua",
		0														
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	  skill.AddSlowCheckDestBuff(5822, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5820, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSrcID)
	...
	local tValueIndex = {nX = 12, nY = 16, nZ = 20, nFlag = 24}
	if npc.dwTemplateID == 24232 then
		tValueIndex = {nX = 15, nY = 19, nZ = 23, nFlag = 27}
	end
	
	local dwFlag = npc.GetCustomUnsigned1(tValueIndex.nFlag)
	if dwFlag == 1 then
		return
	end

	npc.SetCustomUnsigned1(tValueIndex.nFlag, 1)
	local nX = npc.GetCustomUnsigned4(tValueIndex.nX)
	local nY = npc.GetCustomUnsigned4(tValueIndex.nY)
	local nZ = npc.GetCustomUnsigned4(tValueIndex.nZ)
	npc.PlaySfx(490, nX, nY, nZ)
end
