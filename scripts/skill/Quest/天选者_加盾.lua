---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/天选者_加盾.lua
-- 更新时间:	2013/11/29 11:39:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	if skill.dwSkillID == 8602 then
		skill.BindBuff(1, 7240, 1);		-- 设置1号位Buff
	elseif skill.dwSkillID == 13615 then
		skill.BindBuff(1, 7240, 11);
	elseif skill.dwSkillID == 14717 then
		skill.BindBuff(1, 7240, 12);
	elseif skill.dwSkillID == 17067 then
		skill.BindBuff(1, 7240, 13);	
	else
		skill.BindBuff(1, 7240, skill.dwSkillID-8614);		-- 设置1号位Buff
	end
	...
	skill.SetNormalCoolDown(1, 674);	--技能普通CD
