---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/云湖新自爆.lua
-- 更新时间:	2017/1/11 15:32:14
-- 更新用户:	qinfupi
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.SOLAR_ATTACK_POWER_PERCENT,
		0,
		0
	);
	...
	----------------- 设置Cool down --------------------------------------------
	skill.SetNormalCoolDown(1, 1167);	--技能普通CD
	-- 公共CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if targetPlayer.dwID == dwSkillSrcID then	--释放者自身死		
		targetPlayer.CustomDamage(dwSkillSrcID, 17260, 1, 1, targetPlayer.nMaxLife * 1.0)
		targetPlayer.Die()
	else
		targetPlayer.CustomDamage(dwSkillSrcID, 17260, 1, 1, targetPlayer.nMaxLife * 0.5)
	end		
