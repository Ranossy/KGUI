...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,                        
		...
		"skill/Quest/白眉鼠王_饕餮盛宴_子技能_回血.lua",                                     
		0                                                                         
	);                                                                            
	...
	----------------- BUFF相关 -------------------------------------------------
 	skill.BindBuff(1, 2730, 1);	-- 设置1号位Buff
...
function Apply(dwCharacterID)
   ...
   local CurrentLife = npc.nCurrentLife
   npc.nCurrentLife = CurrentLife + 800000
end
