...
tSkillData =
{
	{nDamageBase = 41000*0.8, nDamageRand = 41000*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	----------------- BUFF相关 -------------------------------------------------
  skill.BindBuff(1,2741,1);		-- 设置1号位Buff
    ...
    -- 技能CD, CoolDownIndex为CD位共3个), nCoolDownID为CoolDownList.tab内的CDID
