---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/Quest/大唐监狱_霸甩.lua
-- 更新时间:	2013/3/1 10:15:42
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buff = target.GetBuff(5312, 1)
	if not buff then
		return
	end
	local n = buff.nStackNum
	for i = 1, n do
		target.DelBuff(5312, 1)
		target.AddBuff(0, 99, 5313, 1, 1)
	end
end
