---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/苍云_风箭长廊AOE.lua
-- 更新时间:	2014/11/5 19:07:11
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/苍云_风箭长廊AOE.lua", -- 属性值1
		0														-- 属性值2
	);
	--skill.AddAttribute(
	--ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--local buffFengjian = player.GetBuff(8531, 1)
	--if not buffFengjian and not player.GetBuff(8577, 1) then
		--player.AddBuff(0, 99, 8531, 1)
		--return
	--end
	...
	--else
		...
		--player.SetTimer(1 * GLOBAL.GAME_FPS, "scripts/skill/Quest/苍云_风箭长廊AOE.lua", player.dwID, 0)
	--end
end

--function OnTimer(player, nParam1, nParam2)
	--RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", "你被机关击中了。", 5)
	--player.SetPosition(21482, 28540, 1085312)
	--player.DelBuff(8531, 1)
--end
