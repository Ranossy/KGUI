---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_风雷刀谷预热/绝浪滔天伤害.lua
-- 更新时间:	2017/3/1 10:02:49
...
tSkillData =
{
	{nDamageBase = 4000, nDamageRand = 150, nCostMana = 0}, --level 1
	{nDamageBase = 4000, nDamageRand = 150, nCostMana = 0}, --level 2
	{nDamageBase = 4000, nDamageRand = 150, nCostMana = 0}, --level 3
	{nDamageBase = 4000, nDamageRand = 150, nCostMana = 0}, --level 4
