---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_风雷刀谷预热/绝浪滔天吟唱.lua
-- 更新时间:	2017/3/1 10:01:59
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_风雷刀谷预热/绝浪滔天吟唱.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSrcID)
	...
	npc.PlaySfx(1174, npc.nX, npc.nY, npc.nZ)
	npc.CastSkill(17445,1)
end
