---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_风雷刀谷预热/旋风日月斩.lua
-- 更新时间:	2017/3/1 16:49:29
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_风雷刀谷预热/旋风日月斩.lua",
		0
	);
	...
	--skill.nChannelFrame		= 5*16;	 			-- 通道技持续时间，单位帧数
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(8, "scripts/skill/Quest/ACT_风雷刀谷预热/旋风日月斩.lua", npc.dwID, 0)
...
function OnTimer(scene, nParam1, nParam2)
	...
	npc.PlaySfx(319, npc.nX, npc.nY, npc.nZ, (npc.nFaceDirection + 70) * 360 / 256)
	npc.CastSkill(17454,1)
end
