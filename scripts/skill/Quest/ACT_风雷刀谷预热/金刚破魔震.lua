---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_风雷刀谷预热/金刚破魔震.lua
-- 更新时间:	2017/2/28 20:06:20
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_风雷刀谷预热/金刚破魔震.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	scene.SetTimer(16, "scripts/skill/Quest/ACT_风雷刀谷预热/金刚破魔震.lua", npc.dwID, 0)
end
...
function OnTimer(scene, nParam1, nParam2)
	...
	npc.PlaySfx(1338,npc.nX,npc.nY,npc.nZ)
	npc.CastSkill(17453,1)
end
