---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/元宵节/冲刺移动.lua
-- 更新时间:	2013/12/9 10:06:46
-- 更新用户:	ZHOUMING
-- 脚本说明:	
----------------------------------------------------------------------<
...
tSkillData = 
{
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 10}, --level 1
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 20}, --level 2
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 30}, --level 3
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 40}, --level 4
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 50}, --level 5
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 60}, --level 6
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 70}, --level 7
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 80}, --level 8
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 90}, --level 9
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0,nDashSpeed = 100}, --level 10
};
