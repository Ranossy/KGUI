---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/元宵节/2017打花灯_花灯死亡AOE.lua
-- 更新时间:	2017/1/22 18:00:23
-- 更新用户:	JIANGZHEFEI-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
Include("scripts/Map/ACT_元宵节/include/2017打花灯头文件.lua")
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/元宵节/2017打花灯_花灯死亡AOE.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	AddThisLaternPointToPlayer(npcCaster, player)
end
