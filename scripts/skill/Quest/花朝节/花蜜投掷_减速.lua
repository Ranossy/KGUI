---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/花朝节/花蜜投掷_减速.lua
-- 更新时间:	2016/3/8 12:48:51
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/花朝节/花蜜投掷_减速.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npcTarget.dwTemplateID == 50983 then
		if npcTarget.GetBuff(10514, 1) then
			npcTarget.DelBuff(10514, 1)
		end
		npcTarget.AddBuff(0, 99, 10515, 1, 5)
	elseif npcTarget.dwTemplateID == 50980 or npcTarget.dwTemplateID == 50981 or npcTarget.dwTemplateID == 50982 or npcTarget.dwTemplateID == 42374 or npcTarget.dwTemplateID == 42414 then
		npcTarget.AddBuff(0, 99, 10517, 1, 15)
	end
end
