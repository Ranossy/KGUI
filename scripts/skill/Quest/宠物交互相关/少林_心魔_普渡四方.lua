---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/宠物交互相关/少林_心魔_普渡四方.lua
-- 更新时间:	2016/4/21 14:53:55
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 90, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 124, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 156, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 189, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 223, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 256, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 288, nDamageRand = 0, nCostMana = 0}, --level 7
