---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/宠物交互相关/宠物交互4号位.lua
-- 更新时间:	2014/7/15 9:54:15
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/宠物交互相关/宠物交互4号位.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		for i = 1, 99 do
			local buff = player.GetBuff(8057, i)
			if buff then
				nActionIndex = GetFellowPetActionSkillInfo(9386, i)
			end
		end
