---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/宠物交互相关/大草原QTE_按键1.lua
-- 更新时间:	2016/10/16 12:21:19
-- 更新用户:	zhangyan-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
--Include("scripts/Map/世界奇遇/宠物奇缘奇遇/Skill/石敢当奇遇_按键1.lua")
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"Map/世界奇遇/宠物奇缘奇遇/Skill/青草歌_跑马QTE_按键1.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
