---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/宠物交互相关/宠物交互3号位第二轮.lua
-- 更新时间:	2015/3/18 11:20:07
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/宠物交互相关/宠物交互3号位第二轮.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		for i = 1, 99 do
			local buff = player.GetBuff(10661, i)
			if buff then
				nActionIndex = GetFellowPetActionSkillInfo(13800, i)
			end
		end
