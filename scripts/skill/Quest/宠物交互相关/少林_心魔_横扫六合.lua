---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/宠物交互相关/少林_心魔_横扫六合.lua
-- 更新时间:	2016/4/21 15:06:27
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 136, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 186, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 235, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 286, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 335, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 384, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 433, nDamageRand = 0, nCostMana = 0}, --level 7
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 10704, dwSkillLevel);		-- 设置1号位Buff
