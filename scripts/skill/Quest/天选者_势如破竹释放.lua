---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/大战郭萌萌_剑冲阴阳_释放伤害.lua
-- 更新时间:	2013/3/7 10:27:30
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 300000 * 0.95, nDamageRand = 300000 * 0.1, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- 设置Cool down --------------------------------------------
	skill.SetNormalCoolDown(1, 675);	--技能普通CD
	-- 公共CD
...
function Apply(dwCharacterID)
	...
	local n = Random(1, 6)
	if n == 1 then 
		player.Talk(GetEditorString(5, 482), 5)
	end
	if n == 2 then 
		player.Talk(GetEditorString(5, 483), 5)
	end
	if n == 3 then 
		player.Talk(GetEditorString(5, 484), 5)
	end
end
