...
--			);	
  ...
  skill.AddSlowCheckSelfBuff(1369, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);  
	----------------- BUFF相关 -------------------------------------------------
  	skill.BindBuff(1,1369,1);		-- 设置1号位Buff 作用于自身的HOT
	--skill.BindBuff(2,1369,1);		-- 设置2号位Buff
