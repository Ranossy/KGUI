---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/洛阳城北/枪兵_击退前方敌人.lua
-- 更新时间:	2016/9/21 20:39:43
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/洛阳城北/枪兵_击退前方敌人.lua",
		0
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not npc.GetBuff(11391, 1) then--这其实是个无关的cdbuff.随便用一下
		npc.PlaySfx(57, npc.nX, npc.nY, npc.nZ + 500, math.floor(360 * ((npc.nFaceDirection - 192) % 256) / 256))
		npc.AddBuff(npc.dwID,npc.nLevel,11391,1,12)
	end
