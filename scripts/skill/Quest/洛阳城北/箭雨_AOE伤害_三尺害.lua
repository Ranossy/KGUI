---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/洛阳城北/箭雨_AOE伤害_三尺害.lua
-- 更新时间:	2016/9/19 20:27:59
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 3000, nDamageRand = 500, nCostMana = 0}, --level 1
	{nDamageBase = 6000, nDamageRand = 500, nCostMana = 0}, --level 2
	{nDamageBase = 9000, nDamageRand = 500, nCostMana = 0}, --level 3
	{nDamageBase = 12000, nDamageRand = 500, nCostMana = 0}, --level 4
	{nDamageBase = 15000, nDamageRand = 500, nCostMana = 0}, --level 5
	{nDamageBase = 18000, nDamageRand = 500, nCostMana = 0}, --level 6
	{nDamageBase = 21000, nDamageRand = 500, nCostMana = 0}, --level 7
	{nDamageBase = 24000, nDamageRand = 500, nCostMana = 0}, --level 8
	{nDamageBase = 27000, nDamageRand = 500, nCostMana = 0}, --level 9
	{nDamageBase = 30000, nDamageRand = 500, nCostMana = 0}, --level 10
};
