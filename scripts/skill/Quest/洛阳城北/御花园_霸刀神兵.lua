---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/洛阳城北/御花园_霸刀神兵.lua
-- 更新时间:	2016/9/16 16:54:42
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 400000 * 0.8, nDamageRand = 4000 * 0.4, nCostMana = 0}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 1,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 1,
		0
	);
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	local npc = GetNpc(targetID)
	if not npc then
		return false
	end
	if npc.dwTemplateID == 53192 or npc.dwTemplateID == 53193 or npc.dwTemplateID == 53148 then
		return nPreResult;
	end
	return false
end
