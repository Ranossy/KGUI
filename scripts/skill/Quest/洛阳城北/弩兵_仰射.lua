---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/洛阳城北/弩兵_仰射.lua
-- 更新时间:	2016/9/22 19:20:20
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.PlaySfx(1503, npc.nX, npc.nY, npc.nZ + 500, math.floor(360 * ((npc.nFaceDirection + 64) % 256) / 256))
	npc.CastSkill(16896, 1)
end
