...
tSkillData =
{
	{nDamageBase = 30769 * 3, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 30769 * 6, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	  ...
	  skill.AddSlowCheckDestBuff(6533, 2, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
