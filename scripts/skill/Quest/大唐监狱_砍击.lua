---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/Quest/大唐监狱_砍击.lua
-- 更新时间:	2012/12/26 14:44:38
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 9429 * 0.8, nDamageRand = 9429 * 0.4, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID)
	...
	if tbuff then
		...
		local npc = scene.CreateNpc(21010, target.nX, target.nY, target.nZ, target.nFaceDirection + 128, 8)
		npc.CastSkill(7805, 1)
		npc.PlaySfx(333, npc.nX, npc.nY, npc.nZ)
	end
	target.AddBuff(0, 99, 5029, 1, 1)
end
