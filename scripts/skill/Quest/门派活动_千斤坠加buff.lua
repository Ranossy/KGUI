---------------------------------------------------------------------->
-- 脚本名称:	f:/zhugan/client/scripts/skill/Quest/门派活动_千斤坠加buff.lua
-- 更新时间:	2012/11/26 15:35:44
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4810, 1);		-- 设置1号位Buff
	...
	--skill.SetNormalCoolDown(1, 557);	--技能普通CD
...
function UnApply(dwCharacterID)
	...
	player.CastSkill(7739, 1)
	player.CastSkill(7740, 1)
