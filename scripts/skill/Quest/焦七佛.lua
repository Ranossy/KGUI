...
function Apply(dwCharacterID)
    ...
    if player then
        ...
        if nQuestIndex and nQuestPhase == 1 then
            player.SendSystemMessage(GetEditorString(5, 4309))
            RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(5, 4309), 5)
        end
    end
end
