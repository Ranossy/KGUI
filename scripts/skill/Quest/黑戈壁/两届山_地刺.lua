---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/黑戈壁/两届山_地刺.lua
-- 更新时间:	2015/9/12 17:09:47
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
tSkillData =
{
	{nDamageBase = 500, nDamageRand = 20, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.nAreaRadius = 0.5 * LENGTH_BASE;		-- 技能作用半径
