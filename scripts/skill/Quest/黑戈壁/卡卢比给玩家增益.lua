---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/黑戈壁/卡卢比给玩家增益.lua
-- 更新时间:	2015/10/4 15:16:30
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/黑戈壁/卡卢比给玩家增益.lua",
		0
	);

	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 10003, dwSkillLevel);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local xiangliu = scene.GetNpcByNickName("gcyj_xiangliu")
	if xiangliu then
		xiangliu.AddBuff(0, 99, 10004, 1)
	end
end
