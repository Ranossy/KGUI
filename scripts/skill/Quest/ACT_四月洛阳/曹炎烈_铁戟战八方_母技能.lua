---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/曹炎烈_铁戟战八方_母技能.lua
-- 更新时间:	2016/12/2 17:10:15
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_四月洛阳/曹炎烈_铁戟战八方_母技能.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npcBoss then
		npcBoss.CastSkill(17179, 1)
		npcBoss.CastSkill(17180, 1)
	end
end
