---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/黑衣人血鹰爪.lua
-- 更新时间:	2016/4/21 21:45:26
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_四月洛阳/黑衣人血鹰爪.lua", --属性值1
		0															--属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcBOSS = scene.GetNpcByNickName("qiongkouyizhuibossP" .. player.dwID)
	if npcBOSS then
	...
	--player.Die()
	player.CustomDamage(dwCasterID, 15820, 1, 1, player.nCurrentLife - 150)
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(10, 972), 4)
