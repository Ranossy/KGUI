---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/PQ加分技能.lua
-- 更新时间:	2016/4/26 23:06:56
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_四月洛阳/PQ加分技能.lua", --属性值1
		0															--属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--	print(dwSkillSrcID)
	...
	local nPQID = 161
	CommonPQ_AddPlayerPQValueTips(player, nPQID,  2)
	--CommonPQ_AddValue(nPQID, 1, 10, scene)
end
