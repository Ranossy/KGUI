---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/山狼_追命箭.lua
-- 更新时间:	2016/4/13 17:42:07
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_四月洛阳/山狼_追命箭.lua",								--属性值1
		0															--属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
--[[	local scene = player.GetScene()
	...
	local damage = 9000 + math.random(4000)
	player.CustomDamage(dwCasterID, 15762, 1, 1, damage)
	--]]
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(10, 971), 4)
end
