---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/曹炎烈_旋风戟_软甲.lua
-- 更新时间:	2016/12/2 17:51:19
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2100 * 0.8, nDamageRand = 2100 * 0.4, nCostMana = 0}, --level 1
...
--[[
	...
	skill.AddSlowCheckDestBuff(10622, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
