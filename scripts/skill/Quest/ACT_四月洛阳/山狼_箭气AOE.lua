---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_四月洛阳/山狼_箭气AOE.lua
-- 更新时间:	2016/12/2 17:59:41
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_四月洛阳/山狼_箭气AOE.lua", -- 属性值1
		0											-- 属性值2
	);
----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not scene then
		--return
	--end
	--player.CustomDamage(dwSkillSrcID, 15759, 1, 1, 1000)
	-- 这里处理给没有穿独孤九装备的玩家加DOT
	if not player.GetBuff(10622, 1) then
		player.AddBuff(0, 99, 10621, 1, 10)
	end
end
