---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/苍云_梅花桩回原点.lua
-- 更新时间:	2014/11/23 2:47:09
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/苍云_梅花桩回原点.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	player.SetPosition(23957, 33874, 1085440)
	player.TurnTo(189)
	RemoteCallToClient(player.dwID, "OnChangeCameraYaw", 189)
end
