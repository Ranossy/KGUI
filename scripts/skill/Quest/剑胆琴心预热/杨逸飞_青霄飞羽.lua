---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/杨逸飞_青霄飞羽.lua
-- 更新时间:	2015/9/15 16:07:43
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/Quest/剑胆琴心预热/杨逸飞_青霄飞羽.lua",											-- 属性值1
   		0											-- 属性值2
   		);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(9764, 0, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	local npcSelf = GetNpc(dwSkillSrcID)
	if npcSelf then
		--npcSelf.DoAction(0,10150)
		npcSelf.JumpTo(npcSelf.nX, npcSelf.nY, npcSelf.nZ + 64 * 8 * 1, 0, 48)
		npcSelf.CastSkill(14720, 1)
		--npcSelf.AddBuff(npcSelf.dwID, npcSelf.nLevel, 9764, 1)
	end
end
