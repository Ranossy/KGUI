---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/完成任务AOE.lua
-- 更新时间:	2015/9/11 9:53:54
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/剑胆琴心预热/完成任务AOE.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if tNPC_Quest[npc.dwTemplateID][1] == 14652 then
		--if player.GetQuestPhase(tNPC_Quest[npc.dwTemplateID][1])  == 1 then
			--player.SetQuestValue(nQuestIndex, tNPC_Quest[npc.dwTemplateID][2], player.GetQuestValue(nQuestIndext, tNPC_Quest[npc.dwTemplateID][2]) + tNPC_Quest[npc.dwTemplateID][3])
			--return
		--end
	--end
