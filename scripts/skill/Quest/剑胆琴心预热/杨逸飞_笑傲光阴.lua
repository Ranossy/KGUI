---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/杨逸飞_笑傲光阴.lua
-- 更新时间:	2015/9/15 18:31:45
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/Quest/剑胆琴心预热/杨逸飞_笑傲光阴.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcAOE = scene.GetNpcByNickName("PQ62_XiaoAo")
	if not npcAOE then
		npcAOE = scene.CreateNpc(46225, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 20 * GLOBAL.GAME_FPS, "PQ62_XiaoAo")
		if npcAOE then
			npcAOE.AddBuff(0, 99, 9774, 1)
		end
	end
end
