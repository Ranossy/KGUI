---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/杨逸飞_云生结海.lua
-- 更新时间:	2015/9/16 21:19:18
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/剑胆琴心预热/杨逸飞_云生结海.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcAOE = scene.GetNpcByNickName("PQ62_YunSheng")
	if not npcAOE then
		npcAOE = scene.CreateNpc(46269, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 20 * GLOBAL.GAME_FPS, "PQ62_YunSheng")
	end
end
