---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/杨逸飞_江逐月天.lua
-- 更新时间:	2015/9/15 21:55:51
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/剑胆琴心预热/杨逸飞_江逐月天.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcAOE = scene.GetNpcByNickName("PQ62_JiangZhu")
	if not npcAOE then
		npcAOE = scene.CreateNpc(46224, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 20 * GLOBAL.GAME_FPS, "PQ62_JiangZhu")
	end
end
