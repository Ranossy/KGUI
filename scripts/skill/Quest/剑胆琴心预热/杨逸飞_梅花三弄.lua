---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/剑胆琴心预热/杨逸飞_梅花三弄.lua
-- 更新时间:	2015/9/15 18:30:56
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/剑胆琴心预热/杨逸飞_梅花三弄.lua",											-- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		--print(npc.CastSkill(14724, 1))
		--print(npc.CastSkill(14725,1))
		npc.CastSkill(14724, 1)
		npc.CastSkill(14725,1)
	end
end
