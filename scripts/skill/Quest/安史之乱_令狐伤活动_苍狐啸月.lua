---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/安史之乱_令狐伤活动_苍狐啸月.lua
-- 更新时间:	2013/8/24 18:05:36
-- 更新用户:	xutong3
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 47900 * 0.8, nDamageRand = 27900 * 0.4, nCostMana = 0}, --level 1
	{nDamageBase = 47900 * 0.8, nDamageRand = 27900 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_令狐伤活动_苍狐啸月.lua", 
		0														-- 属性值2
	);
	skill.AddAttribute(
