---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/赤兔AOE.lua
-- 更新时间:	2014/4/18 17:36:17
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.CALL_KNOCKED_DOWN, -- 魔法属性 击倒2秒
		32, -- 属性值1
		0											-- 属性值2
		);
	--]]
	...
	skill.AddSlowCheckDestBuff(7798, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标此Buff
	skill.AddSlowCheckDestBuff(7799, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标无此Buff
