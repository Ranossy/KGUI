---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/天策门派跟宠_加大火力.lua
-- 更新时间:	2016/4/26 16:23:53
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/天策门派跟宠_加大火力.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10741, 1) then
		player.DelBuff(10741, 1)
		player.AddBuff(0, 99, 10740, 1, 1)
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 1, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15861)
