---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/套马索赤兔读条版.lua
-- 更新时间:	2014/4/18 15:54:45
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
Include("scripts/Map/驯养系统/skill/马驹捕捉处理.lua")
tSkillData =
{
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"Map/驯养系统/skill/马驹捕捉处理.lua",
		0
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
		"Map/集群刷马/skill/集群刷马的马匹捕捉.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 480;				-- 吟唱帧数--------------------------【】【】【】【】【】【】【】【】【】30秒读条
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	...
	if CheckHorseCanBeCaught(player) == true then
