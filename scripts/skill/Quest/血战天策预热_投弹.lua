---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/血战天策预热_投弹.lua
-- 更新时间:	2013/10/23 15:31:41
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/血战天策预热_投弹.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 662);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	local NPCpaodan = scene.GetNpcByNickName("paodan" .. player.dwID)
	if NPCpaodan then
		NPCpaodan.FireAIEvent(2001, 0, 0)
	end
end
