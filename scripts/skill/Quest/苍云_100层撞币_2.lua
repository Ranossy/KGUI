---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/苍云_100层撞币_2.lua
-- 更新时间:	2014/11/17 22:39:01
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/苍云_100层撞币_2.lua", -- 属性值1
		0														-- 属性值2
	);
	--skill.AddAttribute(
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nQuestValue = player.GetQuestValue(nQuestIndex, 0) + 3
