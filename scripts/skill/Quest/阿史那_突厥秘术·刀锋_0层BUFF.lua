...
tSkillData =
{
	{nDamageBase = 30769, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 30769 * 2, nDamageRand = 0, nCostMana = 0},		--level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(6533, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
