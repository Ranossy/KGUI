---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/一传十活动_给我花.lua
-- 更新时间:	2013/4/27 16:16:28
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/一传十活动_给我花.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5660, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 583);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if not player.IsMoneyEnough(1,0,0) then
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", "你身上的金钱已经不足1金！", 4)
		player.ClearCDTime(583)
		return 
	end
	player.CostMoney(1, 0, 0)
	player.AddBuff(player.dwID,99,5660,1,1)
end
