---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/安史之乱_令狐伤活动_召唤·狼牙弓箭手.lua
-- 更新时间:	2013/5/29 19:50:10
-- 更新用户:	zhengfeng4
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_令狐伤活动_召唤·狼牙弓箭手.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	--end
	--end
	--RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", "存在的狼牙首领过多。", 3)
