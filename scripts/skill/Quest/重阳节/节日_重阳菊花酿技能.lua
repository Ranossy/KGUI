---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/重阳节/节日_重阳菊花酿技能.lua
-- 更新时间:	2014/9/19 16:59:24
-- 更新用户:	renjei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 105000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 142000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/重阳节/节日_重阳菊花酿技能.lua", --属性值1
		0															--属性值2	
	);
	...
	--skill.SetNormalCoolDown(1, 664);	--技能普通CD
	...
	skill.nMaxRadius = 17 * LENGTH_BASE;		-- 技能施放的最大距离
...
function Apply(dwCharacterID, dwSkillSrcId)
	...
	local npcBoss = scene.GetNpcByNickName("chongyangjijia")
	if not npcBoss then
		return
	end
	scene.CreateNpc(37278,nX,nY,nZ,100,360)
end
