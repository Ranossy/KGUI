---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/重阳节/节日_重阳击飞.lua
-- 更新时间:	2014/9/11 17:19:18
-- 更新用户:	renjei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcId)
	...
	playerT.CustomDamage(npc.dwID, 13029, 1, 0, playerT.nMaxLife * 0.1)
end
