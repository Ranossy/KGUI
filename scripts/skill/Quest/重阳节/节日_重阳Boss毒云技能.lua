---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/重阳节/节日_重阳Boss毒云技能.lua
-- 更新时间:	2014/9/20 19:56:58
-- 更新用户:	renjei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/重阳节/节日_重阳Boss毒云技能.lua",
		0
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 8298, 1);		-- 设置1号位Buff
...
--魔法属性应用时的执行函数,dwCharacterID是魔法属性作用的目标ID
	function Apply(dwCharacterID, dwSkillSrcId)
		...
		playerT.CustomDamage(npc.dwID, 13030, 1, 0, playerT.nMaxLife * 0.3)
	end
