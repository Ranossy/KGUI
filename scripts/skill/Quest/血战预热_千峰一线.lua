---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/血战预热_千峰一线.lua
-- 更新时间:	2013/10/27 18:37:42
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/血战预热_千峰一线.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(7080, 1) then
		local B = player.GetBuff(7080, 1).nStackNum
		if B == 1 then
			player.CastSkill(8517, 1)
		elseif B == 2 then
			player.CastSkill(8517, 1)
		elseif B == 3 then
			player.CastSkill(8517, 1)
		elseif B == 4 then
			player.CastSkill(8518, 1)
		end
	else
		player.CastSkill(8517, 1)
	end
