---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/满级指引_掌门搜索.lua
-- 更新时间:	2015/7/2 22:08:38
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/满级指引_掌门搜索.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- 施放距离 -------------------------------------------------
	skill.nMinRadius		= 25 * LENGTH_BASE;		-- 技能施放的最小距离
...
function Apply(dwCharacterID, dwSkillSrcID)
	local tbQuestId = {
		[10002] = {13019, 2339}, --少林
		[10021] = {13020, 76}, --万花
		[10026] = {13021, 8078}, --天策·战乱
		[10014] = {13022, 11810}, --纯阳
		[10080] = {13023, 8045}, --七秀
		[10175] = {13025, 7118}, --五毒
		[10224] = {13026, 12264}, --唐门
		[10145] = {13024, 5092}, --藏剑
		[10268] = {13028, 10693}, --丐帮
		[10242] = {13027, 9276}, --明教
		[10389] = {13029, 12340}, --苍云
		[10003] = {13019, 2339}, --少林
		[10028] = {13020, 76}, --万花
		[10062] = {13021, 8078}, --天策·战乱
		[10015] = {13022, 11810}, --纯阳
		[10081] = {13023, 8045}, --七秀
		[10176] = {13025, 7118}, --五毒
		[10225] = {13026, 12264}, --唐门
		[10144] = {13024, 5092}, --藏剑
		[10243] = {13027, 9276}, --明教
		[10390] = {13029, 12340}, --苍云
	}
	local tbMenpai = {
		[10002] = 5, --少林
		[10021] = 2, --万花
	...
	if not skillKungfu then
		return
	end
	if tbMenpai[skillKungfu.dwSkillID] ~= scene.dwMapID then
		return
	end
	local nQuestIndex1 = player.GetQuestIndex(tbQuestId[skillKungfu.dwSkillID][1])
	local nQuestPhase1 = player.GetQuestPhase(tbQuestId[skillKungfu.dwSkillID][1])
	local nQuestIndex2 = player.GetQuestIndex(tbQuestId[skillKungfu.dwSkillID][2])
	local nQuestPhase2 = player.GetQuestPhase(tbQuestId[skillKungfu.dwSkillID][2])
	if (nQuestIndex1 and nQuestPhase1 == 1) or (nQuestIndex2 and nQuestPhase2 == 1) then
		if not player.GetBuff(9167, 1) then
			player.AddBuff(0, 99, 9167, 1)
		end
	end
end
