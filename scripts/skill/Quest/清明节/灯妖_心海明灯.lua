---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/清明节/灯妖_心海明灯.lua
-- 更新时间:	2017/3/20 20:44:38
...
tSkillData =
{
	{nDamageBase = 8000, nDamageRand = 400, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/清明节/灯妖_心海明灯.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.PlaySfx(124, npc.nX, npc.nY, npc.nZ)
end
