---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_龙舟渔网对玩家.lua
-- 更新时间:	2017/5/25 20:04:34
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_龙舟渔网对玩家.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 11956, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nSkillLevel = 0
	local nLevelBuff = playerSelf.GetBuff(11984, 1)
	...
	if nbuff then
		nbuff.nCustomValue = math.max(0, nbuff.nCustomValue - (nSkillLevel * 2 + 18))
