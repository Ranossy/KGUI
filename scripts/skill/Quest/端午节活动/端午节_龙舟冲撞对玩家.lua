---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_龙舟冲撞对玩家.lua
-- 更新时间:	2017/5/25 19:46:58
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_龙舟冲撞对玩家.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nSkillLevel = 0
	local nLevelBuff = playerSelf.GetBuff(11983, 1)
	...
	if nbuff then
		nbuff.nCustomValue = math.max(0, nbuff.nCustomValue - (nSkillLevel * 3 + 17))
