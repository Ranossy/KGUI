---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_鳄鱼泡泡.lua
-- 更新时间:	2015/5/13 11:55:47
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_鳄鱼泡泡.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.CustomDamage(dwCasterID, 13860, 1, 3, player.nMaxLife * 0.25)
	player.AddBuff(0, 99, 8880, 1, 10)
end
