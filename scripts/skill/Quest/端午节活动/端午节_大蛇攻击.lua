---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_大蛇攻击.lua
-- 更新时间:	2017/5/25 21:47:49
...
tSkillData =
{
	{nDamageBase = 5000, nDamageRand = 300, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_大蛇攻击.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.nAngleRange = 256 * 90 / 360;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nbuff then
		nbuff.nCustomValue = math.max(0, nbuff.nCustomValue - 50)
		...
		if nbuff.nCustomValue == 0 then
			...
			RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(11, 6703), 4)
