---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_龙舟主炮.lua
-- 更新时间:	2017/5/23 21:49:59
...
tSkillData =
{
	...
	{nDamageBase = 85000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 90000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 95000, nDamageRand = 0, nCostMana = 0}, --level 4
...
function GetSkillLevelData(skill)
	...
	--"skill/Quest/端午节活动/端午节_龙舟主炮.lua",
	--0
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
