---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_鳄鱼冲击波.lua
-- 更新时间:	2015/5/21 10:13:15
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_鳄鱼冲击波.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		npc.AddBuff(0, 99, 8886, 1, 60)
	end
	local player = GetPlayer(dwCharacterID)
	if player then		
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_YELLOW", GetEditorString(7, 4938), 4)		
	end
end
