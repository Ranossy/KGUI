---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_龙舟爆炸烟花伤害.lua
-- 更新时间:	2017/5/23 21:49:30
...
tSkillData =
{
	...
	{nDamageBase = 55000, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 60000, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 65000, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 70000, nDamageRand = 0, nCostMana = 0}, --level 5
...
function GetSkillLevelData(skill)
	...
	--"skill/Quest/端午节活动/端午节_龙舟爆炸烟花伤害.lua", -- 属性值1
	--0											-- 属性值2
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--return
	--end
	--local playerOpp = GetNpc(dwCharacterID)  --temp
	--if not playerOpp then
	--return
	--end
	--player.CustomDamage(dwCharacterID, 17668, 1, 3, playerOpp.nMaxLife * 0.25)
end
