---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_乌龟泡泡.lua
-- 更新时间:	2017/5/25 21:53:45
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_乌龟泡泡.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nbuff then
		nbuff.nCustomValue = math.max(0, nbuff.nCustomValue - 100)
