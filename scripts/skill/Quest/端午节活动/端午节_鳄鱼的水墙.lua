---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_鳄鱼的水墙.lua
-- 更新时间:	2015/6/15 10:28:06
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_鳄鱼的水墙.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if scene then
		local npcBOSS = scene.GetNpcByNickName("duanwu_EYuBOSS")
		if npcBOSS then
			dwCasterID = npcBOSS.dwID
		end
	end
	player.CustomDamage(dwCasterID, 13904, 1, 3, player.nMaxLife * 0.1)
	if player.GetBuff(8880, 1) then
		player.DelBuff(8880, 1)
	end
end
