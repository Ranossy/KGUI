---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_龙舟渔网.lua
-- 更新时间:	2017/5/17 17:13:26
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_龙舟渔网.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 1213);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player and player.nMoveState ~= MOVE_STATE.ON_DEATH then
		...
		player.PlaySfx(8779, player.nX - npcX, player.nY - npcY, player.nZ)
		local nBuff = player.GetBuff(11984, 1)
		if not nBuff then
			player.CastSkillXYZ(17675, 1, player.nX - npcX, player.nY - npcY, player.nZ)
			player.CastSkillXYZ(17773, 1, player.nX - npcX, player.nY - npcY, player.nZ)
		elseif nBuff then
			player.CastSkillXYZ(17675, nBuff.nStackNum + 1, player.nX - npcX, player.nY - npcY, player.nZ)
			player.CastSkillXYZ(17773, nBuff.nStackNum + 1, player.nX - npcX, player.nY - npcY, player.nZ)
		end
	end
end
