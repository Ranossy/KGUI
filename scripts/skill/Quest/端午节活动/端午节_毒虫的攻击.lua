---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/端午节活动/端午节_毒虫的攻击.lua
-- 更新时间:	2016/6/1 12:06:28
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/端午节活动/端午节_毒虫的攻击.lua", --属性值1
		0															--属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcBOSS = scene.GetNpcByNickName("npcDu" .. player.dwID .. "_" .. 1)
	if npcBOSS then
		dwCasterID = npcBOSS.dwID
	end
	--player.PlaySfx(553, player.nX, player.nY, player.nZ + 500)
	player.CustomDamage(dwCasterID, 15977, 1, 1, player.nMaxLife * 0.02)
end
