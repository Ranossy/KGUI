...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(                                                           
		...
		"skill/Quest/冰雪重击_中雪球.lua",                                                                                                               
		0                                                                         
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
    skill.AddSlowCheckDestBuff(2720,1, BUFF_COMPARE_FLAG.EQUAL,1,BUFF_COMPARE_FLAG.GREATER_EQUAL);	--需求目标BUFF
