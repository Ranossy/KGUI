---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/小强强之怒右.lua
-- 更新时间:	2014/7/15 16:33:48
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/小强强之怒右.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.AddBuff(0, 99, 8062, 1, 5) --维持3秒的右1换右2，时间到会自动换回来
		player.AddBuff(0, 99, 8063, 1, 5) --维持4秒的急速效果，可以叠加20层，每层提速20%
		player.AddBuff(0, 99, 8089, 1, 4) --4小时右2暴击的技能需求
	end
