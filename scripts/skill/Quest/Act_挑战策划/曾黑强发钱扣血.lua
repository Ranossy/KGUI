---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/曾黑强发钱扣血.lua
-- 更新时间:	2014/7/23 15:09:20
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/曾黑强发钱扣血.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		...
		if StateInfo == ACTIVITY_STATE.NORMAL_ON or StateInfo == ACTIVITY_STATE.RECOVER_ON  then
			npc.CastSkill(10353, 1) --828专用
		else
			for i = 1, 10 do 
				npc.CastSkill(9516, 1)	
			end
		end
	end
end
