---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/胖妹子倒地.lua
-- 更新时间:	2014/7/18 16:24:36
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/胖妹子倒地.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 746);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.SetTimer(20, "scripts/skill/Quest/Act_挑战策划/胖妹子倒地.lua", 0, 0)
	end
end
	

function OnTimer(player, nParam1, nParam2)
	player.CastSkill(9473, 1)
end
