---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/步高教技能实际828.lua
-- 更新时间:	2014/8/14 16:33:33
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/步高教技能实际828.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if player.GetDynamicSkillGroup() == 171 then
			RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_WARNING_GREEN", GetEditorString(6, 7607), 6)
			return
		else
