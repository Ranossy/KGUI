---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/防打扰.lua
-- 更新时间:	2014/7/25 14:36:11
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/防打扰.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(0, 99, 8151, 1, 3)  --有此BUFF不会被感染
	player.DelBuff(8150, 1) --刀客换摸
	player.DelBuff(8152, 1) --剑客换摸
	player.DelBuff(8154, 1) --胖妹子换摸
	player.DelBuff(8153, 1) --昆仑奴换摸
	player.DelBuff(8155, 1) --胖妹子换摸
	player.SetDynamicSkillGroup(0)
	player.SetModelID(0) --这里应该是删除各种BUFF
	RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_GREEN", GetEditorString(6, 7440), 8)
