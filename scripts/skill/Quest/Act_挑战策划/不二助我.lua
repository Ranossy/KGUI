---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/不二助我.lua
-- 更新时间:	2014/7/24 20:29:57
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/不二助我.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local ZZ = 200
	--local BaoXiang1 =
	local laonainai1 = scene.CreateNpc(36973, Dian[1][1], Dian[1][2], npc.nZ + ZZ, 125, 160, "XY_buer1")
	local laonainai2 = scene.CreateNpc(36973, Dian[2][1], Dian[2][2], npc.nZ + ZZ, 125, 160, "XY_buer2")
	local laonainai3 = scene.CreateNpc(36973, Dian[3][1], Dian[3][2], npc.nZ + ZZ, 125, 160, "XY_buer3")
	local laonainai4 = scene.CreateNpc(36973, Dian[4][1], Dian[4][2], npc.nZ + ZZ, 125, 160, "XY_buer4")
	local laonainai5 = scene.CreateNpc(36973, Dian[5][1], Dian[5][2], npc.nZ + ZZ, 125, 160, "XY_buer5")
	if laonainai1 then
