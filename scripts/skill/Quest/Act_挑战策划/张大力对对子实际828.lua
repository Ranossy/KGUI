---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/张大力对对子实际828.lua
-- 更新时间:	2014/8/14 16:58:25
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/张大力对对子实际828.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tTxtWenan = {
		[1] = {
			GetEditorString(6, 7497),
			GetEditorString(6, 7461)
		},
		[2] = {
			GetEditorString(6, 7498),
			GetEditorString(6, 7463)
		},
		[3] = {
			GetEditorString(6, 7499),
			GetEditorString(6, 7465)
		},
		[4] = {
			GetEditorString(6, 7500),
			GetEditorString(6, 7467)
		},
		[5] = {
			GetEditorString(6, 7468),
		"20"},
		[6] = {
			GetEditorString(6, 7501),
			GetEditorString(6, 7470)
		},
		[7] = {
			GetEditorString(6, 7502),
			GetEditorString(6, 7472)
		},
		[8] = {
			GetEditorString(6, 7503),
			GetEditorString(6, 7474)
		},
	}
	local tTxtWenan828 = {
		[1] = {
			GetEditorString(6, 7666),
			GetEditorString(6, 7461)
		},
		[2] = {
			GetEditorString(6, 7667),
			GetEditorString(6, 7463)
		},
		[3] = {
			GetEditorString(6, 7668),
			GetEditorString(6, 7465)
		},
		[4] = {
			GetEditorString(6, 7669),
			GetEditorString(6, 7467)
		},
		[5] = {
			GetEditorString(6, 7687),
		"D"},
		[6] = {
			GetEditorString(6, 7670),
			GetEditorString(6, 7470)
		},
		[7] = {
			GetEditorString(6, 7671),
			GetEditorString(6, 7472)
		},
		[8] = {
			GetEditorString(6, 7672),
			GetEditorString(6, 7474)
		},
	}
	...
	if StateInfo == ACTIVITY_STATE.NORMAL_ON or StateInfo == ACTIVITY_STATE.RECOVER_ON  then
		if not player.GetBuff(8160, 1) then
			if not player.GetBuff(8157, nNum) then
				player.AddBuff(0, 99, 8157, nNum, 30) --题目1
				local string0 = tTxtWenan828[nNum][1]
				RemoteCallToClient(player.dwID, "OnUserInput", string0, "On_TZCHhuodong_1")
			end
		end
		...
		if not player.GetBuff(8160, 1) then
			if not player.GetBuff(8157, nNum) then
				player.AddBuff(0, 99, 8157, nNum, 30) --题目1
				local string0 = tTxtWenan[nNum][1]
				RemoteCallToClient(player.dwID, "OnUserInput", string0, "On_TZCHhuodong_1")
			end
		end
