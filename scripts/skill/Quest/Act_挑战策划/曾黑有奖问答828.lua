---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/曾黑有奖问答828.lua
-- 更新时间:	2014/8/14 15:41:32
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/曾黑有奖问答828.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nNum = Random(8)
	local tTxtShuzhi = {
		[1] = {GetEditorString(6, 7452), "2"},
		[2] = {GetEditorString(6, 7453), "0"},
		[3] = {GetEditorString(6, 7454), "13"},
		[4] = {GetEditorString(6, 7455), "0.75"},
		[5] = {GetEditorString(6, 7456), "20"},
		[6] = {GetEditorString(6, 7457), "3.1415926535"},
		[7] = {GetEditorString(6, 7458), "15"},
		[8] = {GetEditorString(6, 7493), "13"},
	}
	local tTxtShuzhi828 = {
		[1] = {GetEditorString(6, 7658), "2"},
		[2] = {GetEditorString(6, 7659), "0"},
		[3] = {GetEditorString(6, 7660), "13"},
		[4] = {GetEditorString(6, 7661), "0.75"},
		[5] = {GetEditorString(6, 7662), "20"},
		[6] = {GetEditorString(6, 7663), "3.1415926535"},
		[7] = {GetEditorString(6, 7664), "15"},
		[8] = {GetEditorString(6, 7665), "13"},
	}
	...
	if StateInfo == ACTIVITY_STATE.NORMAL_ON or StateInfo == ACTIVITY_STATE.RECOVER_ON  then
		if not player.GetBuff(8160, 1) then
			if not player.GetBuff(8149, nNum) then
				player.AddBuff(0, 99, 8149, nNum, 30) --题目1
				local string0 = tTxtShuzhi828[nNum][1]
				RemoteCallToClient(player.dwID, "OnUserInput", string0, "On_TZCHhuodong_1")
				player.AddBuff(0, 99, 8160, 1, 30)
			end
		end
		...
		if not player.GetBuff(8160, 1) then
			if not player.GetBuff(8149, nNum) then
				player.AddBuff(0, 99, 8149, nNum, 30) --题目1
				local string0 = tTxtShuzhi[nNum][1]
				RemoteCallToClient(player.dwID, "OnUserInput", string0, "On_TZCHhuodong_1")
				player.AddBuff(0, 99, 8160, 1, 30)
			end
		end
