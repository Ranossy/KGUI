---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/老奶奶击飞.lua
-- 更新时间:	2014/7/24 20:06:07
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/老奶奶击飞.lua", -- 属性值1
		0														-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(48, "scripts/skill/Quest/Act_挑战策划/老奶奶击飞.lua", 0, 0)
