---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/小强强之怒左爆.lua
-- 更新时间:	2014/7/15 16:34:41
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/小强强之怒左爆.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.AddBuff(0, 99, 8061, 1, 5) --维持右爆
		...
		if jsBuff then
			if jsBuff.nStackNum >= 20 then
				...
				player.AddBuff(0, 99, 8079, 1, 5) --100暴击
				player.DelBuff(8089, 1)
				player.SetTimer(72, "scripts/skill/Quest/Act_挑战策划/小强强之怒左爆.lua", 0, 0)
			end
		end
	end
end
