---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/张大力对对子实际.lua
-- 更新时间:	2014/7/26 11:29:57
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/张大力对对子实际.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.DelBuff(8119, 1)
	player.SetTimer(48, "scripts/skill/Quest/Act_挑战策划/张大力对对子实际.lua", 0, 0)
	local nNum = Random(8)
	local tTxtWenan = {
		[1] = {
