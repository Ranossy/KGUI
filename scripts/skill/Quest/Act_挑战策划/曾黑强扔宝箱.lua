---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/Act_挑战策划/曾黑强扔宝箱.lua
-- 更新时间:	2014/7/22 17:32:36
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/Act_挑战策划/曾黑强扔宝箱.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local Dian = SkillPosition(npc, 960, 5) --15尺
	local scene = npc.GetScene()
	--local BaoXiang1 = 
	scene.CreateNpc(36966, Dian[1][1], Dian[1][2], 1083608, 125, 240, "SZ_baoxiang1")
	scene.CreateNpc(36966, Dian[2][1], Dian[2][2], 1083608, 125, 240, "SZ_baoxiang2")
	scene.CreateNpc(36966, Dian[3][1], Dian[3][2], 1083608, 125, 240, "SZ_baoxiang3")
	scene.CreateNpc(36966, Dian[4][1], Dian[4][2], 1083608, 125, 240, "SZ_baoxiang4")
	scene.CreateNpc(36966, Dian[5][1], Dian[5][2], 1083608, 125, 240, "SZ_baoxiang5")
end
