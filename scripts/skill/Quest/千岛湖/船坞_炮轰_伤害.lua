---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/千岛湖/船坞_炮轰_伤害.lua
-- 更新时间:	2015/10/15 20:08:48
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 100000, nDamageRand = 20000, nCostMana = 0}, --level 1
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		if nQuestIndex and nQuestPhase == 1 then
			...
			--player.SetTimer(2 * GLOBAL.GAME_FPS, "scripts/skill/Quest/千岛湖/船坞_炮轰.lua", nX, nY)
