---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/美人图活动_被抓AOE.lua
-- 更新时间:	2014/4/18 10:45:42
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/美人图活动_被抓AOE.lua", -- 连协技
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		if not player.GetBuff(3384, 1) then
			player.AddBuff(0, 99, 3355, 1, 1)
			player.AddBuff(0, 99, 3356, 1, 1)
		end
	end
end
