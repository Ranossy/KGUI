...
tSkillData =
{
	{nDamageBase = 7447 * 1, nDamageRand = 0, nCostMana = 0},		--level 1
	{nDamageBase = 7447 * 2, nDamageRand = 0, nCostMana = 0},		--level 2
	{nDamageBase = 7447 * 3, nDamageRand = 0, nCostMana = 0},		--level 3
	{nDamageBase = 7447 * 4, nDamageRand = 0, nCostMana = 0},		--level 4
	{nDamageBase = 7447 * 5, nDamageRand = 0, nCostMana = 0},		--level 5
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_拜月长老_风卷残云_伤害.lua",
		0														
	); 	
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	  skill.AddSlowCheckDestBuff(5816, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 5814, dwSkillLevel);		-- 设置1号位Buff
