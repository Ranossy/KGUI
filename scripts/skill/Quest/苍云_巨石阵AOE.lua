---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/苍云_巨石阵AOE.lua
-- 更新时间:	2014/11/5 22:43:25
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/苍云_巨石阵AOE.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.nAreaRadius = 2.5 * LENGTH_BASE;		-- 技能作用半径
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.CustomDamage(dwSkillSrcID, 13599, 1, 1, player.nMaxLife * 0.06)
	--if not player.GetBuff(8532, 1) then
		--player.AddBuff(0, 99, 8532, 1)
	--end
	--local buffFengjian = player.GetBuff(8532, 1)
	...
	--else
		...
		--player.SetTimer(1 * GLOBAL.GAME_FPS, "scripts/skill/Quest/苍云_巨石阵AOE.lua", player.dwID, 0)
	--end
end

--function OnTimer(player, nParam1, nParam2)
	--RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", "你被巨石机关击中了。", 5)
	--player.SetPosition(19116, 39144, 1082752)
	--player.DelBuff(8532, 1)
--end
