---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/大战郭萌萌_人剑合一_打玩家.lua
-- 更新时间:	2013/3/7 10:26:39
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 150000 * 0.95, nDamageRand = 80000 * 0.1, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/大战郭萌萌_人剑合一_打玩家.lua",
		0														
	);
	skill.AddAttribute(
...
function Apply(dwCharacterID)
	...
	if not player.GetBuff(4974, 1) then	--只喊一次
		local n = Random(1, 6)
		if n == 1 then 
			player.Talk(GetEditorString(5, 479), 5)
		end
		if n == 2 then 
			player.Talk(GetEditorString(5, 480), 5)
		end
		if n == 3 then 
			player.Talk(GetEditorString(5, 481), 5)
		end
		player.AddBuff(0, 99, 4974, 1)
	end
end
