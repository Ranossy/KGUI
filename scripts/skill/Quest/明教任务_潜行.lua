---------------------------------------------------------------------->
-- 脚本名称:	G:/zhugan/client/scripts/skill/Quest/明教任务_潜行.lua
-- 更新时间:	2012-11-12 20:40:07
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4729, 1);		-- 设置1号位Buff
...
function UnApply(dwCharacterID)
	...
	local nQuestIndex = player.GetQuestIndex(9347)
	local nQuestPhase = player.GetQuestPhase(9347)
