---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/霸刀场景/橙武_柳静海_坚壁清野.lua
-- 更新时间:	2016/10/7 15:06:03
-- 更新用户:	wangwei2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10000, nDamageRand = 100, nCostMana = 0}, --level 1
	{nDamageBase = 2500, nDamageRand = 100, nCostMana = 0}, --level 2
	{nDamageBase = 5000, nDamageRand = 100, nCostMana = 0}, --level 3
