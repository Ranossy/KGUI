---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/霸刀场景/橙武_完成挑战任务.lua
-- 更新时间:	2016/10/7 15:52:51
-- 更新用户:	wangwei2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/霸刀场景/橙武_完成挑战任务.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if tQuestID[npc.dwTemplateID] then
		local nQuestPhase = player.GetQuestPhase(tQuestID[npc.dwTemplateID])
		local nQuestIndex = player.GetQuestIndex(tQuestID[npc.dwTemplateID])
