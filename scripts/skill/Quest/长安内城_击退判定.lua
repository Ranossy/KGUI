---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/长安内城_击退判定.lua
-- 更新时间:	2013/8/23 17:12:59
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local sNpc = GetNpc(dwSkillSrcID)
	if npc.dwTemplateID == 25736 or npc.dwTemplateID == 25751 then
		sNpc.CastSkill(8044, 1, TARGET.NPC, dwCharacterID)
	end
end
