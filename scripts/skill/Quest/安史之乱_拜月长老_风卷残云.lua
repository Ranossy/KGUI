...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/安史之乱_拜月长老_风卷残云.lua",
		0														
	); 
...
function Apply(dwCharacterID, dwSrcID)
	...
	local npc_Wind = scene.CreateNpc(24241, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, 5 * GLOBAL.GAME_FPS, "BaiYue_Wind")
	if npc_Wind then
		npc_Wind.SetCustomUnsigned4(0, npc.GetCustomUnsigned4(0))
	end
end
