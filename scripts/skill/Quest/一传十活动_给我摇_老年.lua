---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/一传十活动_给我摇_老年.lua
-- 更新时间:	2013/4/27 15:30:07
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/一传十活动_给我摇_老年.lua", -- 属性值1
		0														-- 属性值2
	);
	...
	skill.SetNormalCoolDown(1, 584);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	if not player.IsMoneyEnough(1, 0, 0) then
		...
		player.ClearCDTime(584)
		return
	end
	player.CostMoney(1,0,0)
	player.DoAction(0, 12114)
end
