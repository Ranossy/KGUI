---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/长安内城_蛊惑.lua
-- 更新时间:	2013/8/27 14:10:00
-- 更新用户:	zhouyixiao1
-- 脚本说明:	
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/长安内城_蛊惑.lua", -- 属性值1
		0														-- 属性值2
	);
    
	----------------- 技能施放Buff需求 ---------------------------------------------
      skill.AddSlowCheckSelfBuff(6634, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
...
function Apply(dwCharacterID)
	...
	local nBiaoji = NPClangya.GetCustomUnsigned1(10)
	if nBiaoji == 1 then
		player.Talk(GetEditorString(5, 9959))
	elseif nBiaoji == 2 then
		player.Talk(GetEditorString(5, 9960))
	end
	NPClangya.FireAIEvent(2005, 0, 0)
end
