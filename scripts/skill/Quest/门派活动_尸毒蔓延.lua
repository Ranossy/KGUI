...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
		...
		"skill/Quest/门派活动_尸毒蔓延.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 4965, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local tbuff = npc.GetBuff(4966,1)
	if not tbuff then
		npc.PlaySfx(324, npc.nX, npc.nY, npc.nZ)
		npc.AddBuff(0,99,4966,1,1)
	end
end
