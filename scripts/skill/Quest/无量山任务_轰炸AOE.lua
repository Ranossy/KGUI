...
tSkillData =
{
	{nDamageBase = 99999*0.8, nDamageRand = 99999*0.4, nCostMana = 0},		--level 1
...
function GetSkillLevelData(skill)
  ...
  skill.AddAttribute( 
   ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,                        
	...
	skill.AddAttribute(                                                           
		...
		0                                                                         
   	  ...
   	  skill.AddAttribute(
   			...
   			"skill/Quest/无量山任务_轰炸AOE.lua",								--属性值1
   			0															--属性值2
   		);
    ...
    skill.AddSlowCheckDestBuff(2623,1,BUFF_COMPARE_FLAG.GREATER_EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求目标Buff
    
	----------------- BUFF相关 -------------------------------------------------
  --skill.BindBuff(1, 2413, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	local npc = GetNpc(dwCharacterID)
		...
		local biaoxian =  scene.CreateDoodad(2712,npc.nX,npc.nY,npc.nZ,0);
		if biaoxian then
			biaoxian.SetDisappearFrames(24, 0)
		end
