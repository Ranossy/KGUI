---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/儿童节/制作糖果.lua
-- 更新时间:	2015/5/19 17:34:20
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npcMachine.AddBuff(0, 99, 8950, 1, 1)
	local scene = npcMachine.GetScene()
	if scene then
		scene.CreateNpc(43073, npcMachine.nX, npcMachine.nY, npcMachine.nZ, Random(255), 3 * GLOBAL.GAME_FPS, npcMachine.szName .. "_1")
		--if npcTangguodui then
			--npcTangguodui.Die()
		--end
	end
