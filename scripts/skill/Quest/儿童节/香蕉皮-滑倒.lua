---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/儿童节/香蕉皮-滑倒.lua
-- 更新时间:	2015/5/27 18:14:09
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	...
	{nDamageBase = 5500 * 0.8, nDamageRand = 5500 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/儿童节/香蕉皮-滑倒.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player then
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(10, 1256), 4)
	end
end
