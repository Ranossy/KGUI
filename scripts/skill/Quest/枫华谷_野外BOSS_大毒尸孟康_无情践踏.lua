...
tSkillData =
{
	{nDamageBase = 305 * 0.8, nDamageRand = 305 * 0.4, nCostMana = 0},		--level 1
	{nDamageBase = 417 * 0.8, nDamageRand = 417 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 707 * 0.8, nDamageRand = 707 * 0.4, nCostMana = 0},		--level 3
	{nDamageBase = 1014 * 0.8, nDamageRand = 1014 * 0.4, nCostMana = 0},		--level 4
	{nDamageBase = 1476 * 0.8, nDamageRand = 1476 * 0.4, nCostMana = 0},		--level 5
	...
	{nDamageBase = 60000 * 0.8, nDamageRand = 60000 * 0.4, nCostMana = 0},		--level 20
	...
	{nDamageBase = 9266 * 0.8, nDamageRand = 9266 * 0.4, nCostMana = 0},		--level 26
	{nDamageBase = 9437 * 0.8, nDamageRand = 9437 * 0.4, nCostMana = 0},		--level 27
	{nDamageBase = 9608 * 0.8, nDamageRand = 9608 * 0.4, nCostMana = 0},		--level 28
	{nDamageBase = 9779 * 0.8, nDamageRand = 9779 * 0.4, nCostMana = 0},		--level 29
	{nDamageBase = 9950 * 0.8, nDamageRand = 9950 * 0.4, nCostMana = 0},		--level 30
	{nDamageBase = 10121 * 0.8, nDamageRand = 10121 * 0.4, nCostMana = 0},		--level 31
};
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	skill.AddAttribute(
   		...
   		"skill/Quest/枫华谷_野外BOSS_大毒尸孟康_无情践踏.lua",				-- 属性值1
   		0														-- 属性值2
   		);
