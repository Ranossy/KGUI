---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_峰值201611玩家变身/烈焰喷发外壳.lua
-- 更新时间:	2016/11/18 17:59:25
-- 更新用户:	qinfupi
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_峰值201611玩家变身/烈焰喷发外壳.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(59, player.nX, player.nY, player.nZ)
	player.CastSkill(17165,1)
end
