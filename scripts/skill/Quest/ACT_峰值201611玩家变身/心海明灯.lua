---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_峰值201611玩家变身/心海明灯.lua
-- 更新时间:	2016/11/18 9:43:27
-- 更新用户:	qinfupi
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_峰值201611玩家变身/心海明灯.lua", -- 属性值1
		0														-- 属性值2
		);
	...
	skill.SetNormalCoolDown(1, 1169);
	...
	skill.nChannelInterval = 26; 				-- 通道技间隔时间
...
function Apply(dwCharacterID)
	...
	player.PlaySfx(124, player.nX, player.nY, player.nZ)
end
