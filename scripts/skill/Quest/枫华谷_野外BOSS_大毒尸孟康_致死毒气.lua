...
tSkillData =
{
	...
	{nDamageBase = 40000 * 0.8, nDamageRand = 40000 * 0.4, nCostMana = 0},		--level 2
	{nDamageBase = 60000 * 0.8, nDamageRand = 60000 * 0.4, nCostMana = 0},		--level 3
};
