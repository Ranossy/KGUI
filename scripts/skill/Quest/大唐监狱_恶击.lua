---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/Quest/大唐监狱_恶击.lua
-- 更新时间:	2013/3/1 10:25:47
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5312, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc = GetNpc(dwSkillSrcID)
	local buff = target.GetBuff(5313, 1)
	if buff then
		target.DelBuff(5313, 1)
		npc.AddBuff(0, 99, 5314, 1, 1)
	end
end
