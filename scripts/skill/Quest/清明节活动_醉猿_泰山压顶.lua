---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/清明节活动_醉猿_泰山压顶.lua
-- 更新时间:	2013/3/26 10:48:13
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    : 清明节活动_醉猿_泰山压顶.lua
-- 创建人    :  zhanghao
-- 创建时间  :  2011-03-15
-- 用途(模块):  节日活动BOSS
-- 武功门派  :  无
...
tSkillData = 
{
	{nDamageBase = 10300 * 0.8, nDamageRand = 10300 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"Map/节日清明/skill/醉猿泰山压顶.lua", --属性值1
		0															--属性值2
	);	
