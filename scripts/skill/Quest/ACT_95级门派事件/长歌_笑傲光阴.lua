---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/长歌_笑傲光阴.lua
-- 更新时间:	2015/12/3 20:00:18
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/长歌_笑傲光阴.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcXAGY = scene.GetNpcByNickName("MPSJ_CG_XAGY" .. npc.dwID)
	if not npcXAGY then
		npcXAGY = scene.CreateNpc(50405, npc.nX, npc.nY, npc.nZ, npc.nFaceDirection, GLOBAL.GAME_FPS * 10, "MPSJ_CG_XAGY" .. npc.dwID) -- 10s笑傲光阴气场
		npcXAGY.SetCustomUnsigned4(0, npc.dwID)
	end
end
