...
tSkillData =
{
	{nDamageBase = 1500, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 1800, nDamageRand = 0, nCostMana = 0}, --level 2 金虎普通AOE
	{nDamageBase = 3000, nDamageRand = 0, nCostMana = 0}, --level 3 金虎落地一击
	{nDamageBase = 3000, nDamageRand = 0, nCostMana = 0}, --level 4 扫尾一击
	{nDamageBase = 2500, nDamageRand = 0, nCostMana = 0}, --level 5  植尸将普通攻击
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.nAreaRadius = 25 * LENGTH_BASE;		-- 公治菱普攻
	elseif dwSkillLevel == 2 then
		skill.nAreaRadius = 10 * LENGTH_BASE;		-- 金虎普攻
	elseif dwSkillLevel == 3 then
		skill.nAreaRadius = 20 * LENGTH_BASE;		-- 金虎跳击
	elseif dwSkillLevel == 4 then
		skill.nAreaRadius = 25 * LENGTH_BASE;		-- 金虎扫尾
	elseif dwSkillLevel == 5 then
		skill.nAreaRadius = 15 * LENGTH_BASE;    -- 植尸将普攻
	end
