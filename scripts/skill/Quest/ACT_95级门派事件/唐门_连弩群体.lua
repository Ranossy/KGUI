---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_连弩群体.lua
-- 更新时间:	2016/2/1 15:47:16
-- 更新用户:	zhangchennan
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 330000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
 ...
 - 2,
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/唐门_连弩群体.lua",
		0
	);
	...
	skill.SetNormalCoolDown(1, 1021);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tnpc = scene.GetNpcByNickName("baxiangqiangnu" .. player.dwID)
	local nX, nY, nZ = player.GetCoordinateSkillTarget()
	if not tnpc then
		return
	end
	player.PlaySfx(202, nX, nY, nZ)
