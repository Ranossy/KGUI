---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱.lua
-- 更新时间:	2016/10/27 9:41:47
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	----------------- 设置Cool down --------------------------------------------
	-- 公共CD
	skill.SetPublicCoolDown(1164);							-- 公共CD 1.5秒
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcTrap = scene.GetNpcByNickName("bdtrap" .. player.dwID)
	if not npcTrap then
		local npcTrap = scene.CreateNpc(55326, player.nX, player.nY, player.nZ, 1, 30 * 16, "bdtrap" .. player.dwID)
		npcTrap.SetCustomUnsigned4(0,player.dwID)
	end	
	--player.SetTimer(3*GLOBAL.GAME_FPS,"scripts/skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱.lua",0,0)
end
...
--function OnTimer(player, nParam1, nParam2)
	...
	--if not npcTrap then
		--return
	--end
	--player.CastSkillXYZ(17084, 1, npcTrap.nX, npcTrap.nY, npcTrap.nZ)
	--player.SetTimer(0.5 * GLOBAL.GAME_FPS, "scripts/skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱.lua", 0, 0)
--end
