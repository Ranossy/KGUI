---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/七秀_白璃予_音波球.lua
-- 更新时间:	2015/12/28 21:18:54
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/七秀_白璃予_音波球.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.CustomDamage(dwCasterID, 15358, 1, 3, player.nMaxLife * 0.15)
	elseif npcTarget then
		npcTarget.nCurrentLife = npcTarget.nCurrentLife - 30000
	end
end
