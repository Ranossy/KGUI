---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_连弩单体.lua
-- 更新时间:	2016/1/26 16:18:43
-- 更新用户:	zhangchennan
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 132000, nDamageRand = 0, nCostMana = 0}, --level 1
 ...
 - 2,
	...
	skill.AddAttribute(
 	...
 	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/唐门_连弩单体.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local tnpc = scene.GetNpcByNickName("baxiangqiangnu" .. target.dwID)
	if not tnpc then 
		return
	end
