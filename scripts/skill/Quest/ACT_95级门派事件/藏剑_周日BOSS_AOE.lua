---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/藏剑_周日BOSS_AOE.lua
-- 更新时间:	2015/12/23 19:55:53
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 800, nDamageRand = 100, nCostMana = 0}, --level 1
	{nDamageBase = 800, nDamageRand = 100, nCostMana = 0}, --level 2
