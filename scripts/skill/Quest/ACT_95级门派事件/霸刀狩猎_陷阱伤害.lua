---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱伤害.lua
-- 更新时间:	2016/10/27 10:19:12
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
 ...
 - 1024, -- 属性值1
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀狩猎_陷阱伤害.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npc = scene.GetNpcByNickName("bdtrap" .. player.dwID)
	if not npc then
		return
	end
	npc.SetDisappearFrames(2)
end
