---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/丐帮_钓鱼_抖动钓线.lua
-- 更新时间:	2016/1/26 11:41:23
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/丐帮_钓鱼_抖动钓线.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(10475, 1) then
		return
	end
	if player.GetBuff(10453, 1) then
		player.DelBuff(10453, 1)
		player.AddBuff(0, 99, 10461, 1, 1)
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 2, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15421)
	end
end
