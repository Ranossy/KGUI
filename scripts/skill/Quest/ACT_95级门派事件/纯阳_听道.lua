---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/纯阳_听道.lua
-- 更新时间:	2015/11/30 11:47:15
-- 更新用户:	zhangchennan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/纯阳_听道.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 16 * 60;				-- 吟唱帧数
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10285, 1) then
		CommonPQ_AddPlayerPQValueTips(player, nPQID, nAddPlayerValue * 5)
		player.SendSystemMessage(GetEditorString(9, 932) )
	end
