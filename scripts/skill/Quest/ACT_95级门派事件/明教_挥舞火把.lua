---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/明教_挥舞火把.lua
-- 更新时间:	2016/1/8 10:39:05
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/明教_挥舞火把.lua",
		0
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nPrepareFrames = 16 * 4;				-- 吟唱帧数
...
--	print(player.dwID)
	...
	CommonPQ_AddPlayerPQValueTips(player, 143, 1, GetEditorString(9, 8812)) -- player，pqID,本次增加的个人贡献度,pq的名称
	local scene = player.GetScene()
	CommonPQ_AddValue(143, 1, 1, scene)
end
