---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_鲲鹏铁爪.lua
-- 更新时间:	2016/11/14 18:10:35
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 8994 * 0.8, nDamageRand = 8994 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 8176 * 0.8, nDamageRand = 8176 * 0.4, nCostMana = 0}, --level 2
...
--[[
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_鲲鹏铁爪.lua",
		0
	);
--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 562, 7);		-- 设置1号位Buff
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	if player then
		...
		--end
		--end
		player.CustomDamage(dwCasterID, 17096, 1, 4, player.nMaxLife * 0.1)
	end--]]
end
