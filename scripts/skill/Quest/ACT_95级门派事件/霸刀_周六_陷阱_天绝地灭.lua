---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_天绝地灭.lua
-- 更新时间:	2016/11/14 18:10:09
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 3270 * 0.8, nDamageRand = 3270 * 0.4, nCostMana = 0}, --level 1
	{nDamage = 3270 * 0.8, nDamageRand = 3270 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_天绝地灭.lua",
		--0
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not npc then
		--return
	--end
	--npc.PlaySfx(1552, npc.nX, npc.nY, npc.nZ)
--[[	local player = GetPlayer(dwCharacterID)
	...
	if player then
		...
		--end
		--end
		player.CustomDamage(dwCasterID, 17095, 1, 4, player.nMaxLife * 0.02)
	end--]]
end
