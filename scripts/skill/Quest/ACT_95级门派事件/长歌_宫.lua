---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/长歌_宫.lua
-- 更新时间:	2015/12/1 11:43:09
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 8000, nDamageRand = 231 * 0.4, nCostMana = 0}, --level 1
	{nDamageBase = 3500, nDamageRand = 391 * 0.4, nCostMana = 0}, --level 2
