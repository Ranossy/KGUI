---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_蛇仙女_潜蛇弄影.lua
-- 更新时间:	2016/11/9 20:52:44
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_蛇仙女_潜蛇弄影.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	npc.Yell(GetEditorString(11, 1868))
	local nNum = 10
	local szName = "ACT_BD_SXN_SHE_"
	for i = 1, nNum do
		if not scene.GetNpcByNickName(szName .. i) then
			scene.CreateNpc(55352, npc.nX, npc.nY, npc.nZ, math.floor(256 / nNum * i), GLOBAL.GAME_FPS * 60 * 2, szName .. i)
		end
	end
end
