---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/长歌_迷仙引梦.lua
-- 更新时间:	2015/11/29 14:26:53
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 147000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/长歌_迷仙引梦.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not scene.GetNpcByNickName("PQ115yinmeng" .. character.dwID) then
		local npc_yingzi = scene.CreateNpc(50329, character.nX, character.nY, character.nZ, character.nFaceDirection, 10 * 16, "PQ115yinmeng" .. character.dwID, character.dwID)
	end
