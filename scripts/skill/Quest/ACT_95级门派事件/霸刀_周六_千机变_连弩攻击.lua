---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_连弩攻击.lua
-- 更新时间:	2016/11/12 21:48:14
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 1962 * 0.8, nDamageRand = 1962 * 0.4, nCostMana = 0}, --level 1
...
--[[	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_连弩攻击.lua",
		0
	);--]]
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.CustomDamage(dwCasterID, 17110, 1, 4, player.nMaxLife * 0.05)
	end
end
