---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_路障重弩AOE.lua
-- 更新时间:	2016/1/15 15:26:04
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/唐门_路障重弩AOE.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10451, 1) or player.GetBuff(10451, 2) then
		player.SetDynamicSkillGroup(0)
		RemoteCallToClient(player.dwID, "OnOutputWarningMessage", "MSG_NOTICE_RED", GetEditorString(9, 8655), 4)
	end
end
