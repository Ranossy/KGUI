---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_重弩攻击.lua
-- 更新时间:	2016/11/12 21:55:07
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 3597 * 0.8, nDamageRand = 3597 * 0.4, nCostMana = 0}, --level 1
...
--[[	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_重弩攻击.lua",
		0
	);--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	if player then
		...
		player.CustomDamage(dwCasterID, 17111, 1, 4, player.nMaxLife * 0.10)
	end--]]
end
