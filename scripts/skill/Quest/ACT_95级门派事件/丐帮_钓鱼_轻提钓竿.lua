---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/丐帮_钓鱼_轻提钓竿.lua
-- 更新时间:	2016/1/26 11:46:06
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/丐帮_钓鱼_轻提钓竿.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10462, 1) then
		player.DelBuff(10462, 1)
		player.AddBuff(0, 99, 10461, 1, 1)
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 4, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15441)
	end
end
