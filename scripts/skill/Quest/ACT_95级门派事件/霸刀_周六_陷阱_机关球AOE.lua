---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_机关球AOE.lua
-- 更新时间:	2016/11/13 20:51:57
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 2616 * 0.8, nDamageRand = 2616 * 0.4, nCostMana = 0}, --level 1	
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/Quest/ACT_95级门派事件/霸刀_周六_陷阱_机关球AOE.lua",
		--0
	--);
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	--if not npc then
		--return
	--end
	--npc.PlaySfx(1550, npc.nX, npc.nY, npc.nZ)
--[[	if player then
