...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcGangQi = scene.GetNpcByNickName("PQ140_yanqiangqi")
	npc.PlaySfx(1276, npc.nX, npc.nY, npc.nZ)
	npc.CastSkill(15472, 1)
	npc.SetDisappearFrames(16, false)
	if npcGangQi then
		npcGangQi.SetDisappearFrames(16, false)
	end
end
