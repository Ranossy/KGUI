---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_毒刹攻击.lua
-- 更新时间:	2016/11/12 21:57:23
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
--[[	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_千机变_毒刹攻击.lua",
		0
	);--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	if player then
		...
		player.CustomDamage(dwCasterID, 17112, 1, 4, player.nMaxLife * 0.04)
	end--]]
end
