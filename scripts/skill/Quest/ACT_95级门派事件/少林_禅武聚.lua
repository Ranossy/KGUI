---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/少林_禅武聚.lua
-- 更新时间:	2016/1/10 18:33:12
-- 更新用户:	kelin-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 3000, nDamageRand = 1000, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"scripts/skill/Quest/ACT_95级门派事件/少林_禅武聚.lua",
		0
		);
		----------------- 魔法属性 -------------------------------------------------
	skill.AddAttribute(
	...
	skill.nAngleRange		= 360;					-- 攻击范围的扇形角度范围
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.GetBuff(10351, 1) then
		return
	end
	npc.AddBuff(0, 99, 10351, 1, 10)
end
