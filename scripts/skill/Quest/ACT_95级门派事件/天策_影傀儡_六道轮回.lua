---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/天策_影傀儡_六道轮回.lua
-- 更新时间:	2016/1/13 10:37:04
-- 更新用户:	mantong2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/天策_影傀儡_六道轮回.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	local tKuiLei = {
		{50566, 17522, 67067, 1080832, 253},
		{50567, 18190, 67509, 1080832, 199},
		{50568, 18964, 67400, 1080832, 146},
		{50569, 18988, 66416, 1080832, 110},
		{50571, 18213, 66166, 1080832, 50},
		{50572, 17672, 66479, 1080832, 17},
		}
	local npc = GetNpc(dwCharacterID)
	local scene = npc.GetScene()
	for i = 1, 6 do
		if not scene.GetNpcByNickName("PQ_ZhouMo_KuiLei" .. i) then
			local npc1 = scene.CreateNpc(tKuiLei[i][1], tKuiLei[i][2], tKuiLei[i][3], tKuiLei[i][4], tKuiLei[i][5], - 1, "PQ_ZhouMo_KuiLei" .. i)
			if npc1 then
				npc1.SetNpcTeamID(26542)
				npc1.SetCustomInteger2(0, 108)
			end
		end
	end
end
