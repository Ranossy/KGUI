---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_蛇仙女_攻击.lua
-- 更新时间:	2016/11/9 20:40:56
-- 更新用户:	zhengfeng5
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 87000, nDamageRand = 0, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/Quest/ACT_95级门派事件/长歌_毒液四溅.lua", -- 属性值1
		--0											-- 属性值2
	--);
	----------------- 魔法属性 -------------------------------------------------
	--[[
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 10284, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--end
	--character.PlaySfx(1251, character.nX, character.nY, character.nZ)
end
