---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/七秀_通用环形AOE.lua
-- 更新时间:	2015/12/27 22:17:09
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/七秀_通用环形AOE.lua",
		0
	);
	...
	skill.nSpreadCircleTotalFrame = 6 * GLOBAL.GAME_FPS;  --总的释放帧数 skill.nSpreadCircleVelocity * skill.nSpreadCircleTotalFrame / 64 就是整个技能全过程的作用半径
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.CustomDamage(dwSkillSrcID, 15333, 1, 3, player.nMaxLife * 0.05)
end
