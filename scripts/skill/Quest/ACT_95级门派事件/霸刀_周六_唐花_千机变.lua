---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_唐花_千机变.lua
-- 更新时间:	2016/11/13 23:00:25
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/Quest/ACT_95级门派事件/霸刀_周六_唐花_千机变.lua",
		--0
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	--local n = Random(1, 3)
	--if n == 1 then
		--target.GetScene().CreateNpc(16452, target.nX, target.nY, target.nZ, 0, 480)
		--target.GetScene().CreateNpc(16453, target.nX, target.nY, target.nZ, 0, 480)
	--end
	--if n == 2 then
		--target.GetScene().CreateNpc(16452, target.nX, target.nY, target.nZ, 0, 480)
		--target.GetScene().CreateNpc(16454, target.nX, target.nY, target.nZ, 0, 480)
	--end
	--if n == 3 then
		--target.GetScene().CreateNpc(16452, target.nX, target.nY, target.nZ, 0, 480)
		--target.GetScene().CreateNpc(16455, target.nX, target.nY, target.nZ, 0, 480)
	--end
end
