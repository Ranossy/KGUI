---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/七秀_白璃予_声啸九天.lua
-- 更新时间:	2015/12/28 21:35:00
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/七秀_白璃予_声啸九天.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		...
		player.CustomDamage(dwCasterID, 15357, 1, 1, player.nMaxLife * 0.05)
