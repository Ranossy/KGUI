---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_周六_机甲驱散.lua
-- 更新时间:	2016/2/1 20:57:17
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/唐门_周六_机甲驱散.lua",
		0
		);
	--]]
	skill.AddAttribute(
	...
	skill.AddSlowCheckDestBuff(10476, 1, BUFF_COMPARE_FLAG.EQUAL, 2, BUFF_COMPARE_FLAG.EQUAL);	
	...
	skill.SetNormalCoolDown(1, 1019);	--技能普通CD
