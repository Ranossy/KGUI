---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/藏剑_精血铸剑.lua
-- 更新时间:	2015/12/9 23:47:14
-- 更新用户:	wangwei-pc2
-- 脚本说明:	15274
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/藏剑_精血铸剑.lua",
		0
	);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.nChannelFrame = 176;	 			-- 通道技持续时间，单位帧数
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	print("111111111111")
	----------每次开始读条时都清掉所有的标记BUFF----------
	if player.GetBuff(10336, 1) then
		print("删除已有的标记BUFF")
		player.DelGroupBuff(10336, 1)
	end
	--]]
end
