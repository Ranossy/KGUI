---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/明教_安雨_阴极_刺骨.lua
-- 更新时间:	2016/2/15 17:37:25
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/Quest/ACT_95级门派事件/明教_安雨_阴极_刺骨.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
--	print(23333)
	...
	--	print("damage")
		player.CustomDamage(dwCasterID, 15481, 1, 3, player.nMaxLife * 0.1)
		--if player.GetBuff(10502, 1) then
			--player.DelGroupBuff(10502, 1)
		--end
	end
end
