---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_重楼子_吐息冰.lua
-- 更新时间:	2016/11/14 11:31:19
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 5312 * 0.8, nDamageRand = 5312 * 0.4, nCostMana = 0}, --level 1	
	{nDamage = 4000 * 0.8, nDamageRand = 4000 * 0.4, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.nChannelFrame = 78;	 			-- 通道技持续时间，单位帧数
