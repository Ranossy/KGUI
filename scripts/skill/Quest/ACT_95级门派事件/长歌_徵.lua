---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/长歌_徵.lua
-- 更新时间:	2015/12/3 10:11:23
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 10000, nDamageRand = 231 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/Quest/ACT_95级门派事件/长歌_徵.lua", -- 属性值1
		--0											-- 属性值2
	--);
	----------------- 魔法属性 -------------------------------------------------
	--[[
