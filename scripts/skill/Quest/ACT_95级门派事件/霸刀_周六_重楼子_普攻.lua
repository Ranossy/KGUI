---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_重楼子_普攻.lua
-- 更新时间:	2016/11/14 11:36:18
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
--[[
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_重楼子_普攻.lua", --属性值1
		0															--属性值2
	);
--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	if not player or not npcBoss then
		return
	end
	local dwCasterID = npcBoss.dwID
	player.CustomDamage(dwCasterID, 17120, 1, 3, player.nMaxLife * 0.1)
