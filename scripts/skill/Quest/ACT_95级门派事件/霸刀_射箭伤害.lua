---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_射箭伤害.lua
-- 更新时间:	2016/10/31 10:51:25
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
 ...
 - 1024, -- 属性值1
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_射箭伤害.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	skill.AddSlowCheckDestOwnBuff(11501, 0,  BUFF_COMPARE_FLAG.EQUAL, 0,  BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(dwSkillSrcID, 1, 11507, 1, 1)
	local npc = scene.GetNpcByNickName("Laohu_Badao1_5")
	if not npc then
		return
	end
	npc.AddBuff(dwSkillSrcID, 1, 11501, 1, 1)	
end
