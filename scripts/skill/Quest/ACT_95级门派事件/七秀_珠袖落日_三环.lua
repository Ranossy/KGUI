---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/七秀_珠袖落日_三环.lua
-- 更新时间:	2015/12/27 22:34:44
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/七秀_珠袖落日_二环.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		npc.PlaySfx(1265, npc.nX, npc.nY, npc.nZ)
		--npc.AddBuff(0, 99, 10400, 1, 2)
	end
end
