---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/天策_无名_幽天魂葬.lua
-- 更新时间:	2016/1/13 10:22:48
-- 更新用户:	mantong2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
		skill.AddAttribute(
			...
			"skill/Quest/ACT_95级门派事件/天策_无名_镜花鬼舞.lua", -- 属性值1
			0														-- 属性值2
			);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not scene.GetNpcByNickName("PQ_ZhouMo_HuanShen") then
		scene.CreateNpc(50573, 19265, 66273, 1080832, 124, 15 * 16, "PQ_ZhouMo_HuanShen")
	end
end
