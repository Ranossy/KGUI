---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/长歌_晒才的长歌弟子.lua
-- 更新时间:	2015/12/3 19:39:00
-- 更新用户:	zhengfeng4
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/长歌_晒才的长歌弟子.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 魔法属性 -------------------------------------------------
	--[[
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not npc then
		--return
	--end
	--if npc.dwTemplateID ~= 50123 then
		--npc.CastSkill(15277, 1)
	--end	
end
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	--npc.AddBuff(npc.dwID, 99, 10252, 1, 6 * 60) -- buff10S一跳
	--print(nLeftFrame)
	if nLeftFrame <= (6 * 60 * 10 - 1) * 16  then
		--print(111)
		npc.FireAIEvent(2001, 0, 0)
	end	
	--npc.SetDialogFlag(1)
	--npc.Say("说好要跟我过招的人又跑了，真是无趣！")
end
