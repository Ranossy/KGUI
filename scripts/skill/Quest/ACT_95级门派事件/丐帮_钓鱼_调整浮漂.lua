---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/丐帮_钓鱼_调整浮漂.lua
-- 更新时间:	2016/1/26 11:41:33
-- 更新用户:	zhangtianhui1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/丐帮_钓鱼_调整浮漂.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(10454, 1) then
		player.DelBuff(10454, 1)
		player.AddBuff(0, 99, 10461, 1, 1)
		RemoteCallToClient(player.dwID, "OnDynamicSkillHighlightChanged", 3, false)
		RemoteCallToClient(player.dwID, "CallUIGlobalFunction", "QTEPanel_HitNotify", 15422)
	end
end
