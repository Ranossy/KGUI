---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_狩猎boss母技能.lua
-- 更新时间:	2016/11/7 17:24:08
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_狩猎boss母技能.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not npc then
		--return
	--end
	--player.AddBuff(dwSkillSrcID, 1, 11498, 1, 100)
	--player.SetTimer(1.3 * GLOBAL.GAME_FPS, "scripts/skill/Quest/ACT_95级门派事件/霸刀_狩猎boss母技能.lua", 0, 0)
end
