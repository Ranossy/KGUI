---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_周六_机甲怒击.lua
-- 更新时间:	2016/2/1 20:47:00
-- 更新用户:	wangwei-pc2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 360000, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 360000, nDamageRand = 0, nCostMana = 0}, --level 2
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1022);	--技能普通CD
