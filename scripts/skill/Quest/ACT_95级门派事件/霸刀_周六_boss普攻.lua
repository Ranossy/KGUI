---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/霸刀_周六_boss普攻.lua
-- 更新时间:	2016/11/13 23:59:37
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamage = 6541 * 0.8, nDamageRand = 6541 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	--[[	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/霸刀_周六_boss普攻.lua",
		0
	);--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
--[[	local player = GetPlayer(dwCharacterID)
	...
	if player and npc then
		player.CustomDamage(npc.dwID, 17117, 1, 4, player.nMaxLife * 0.1)		
	end	--]]
end
