---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/唐门_机甲血量判断.lua
-- 更新时间:	2016/1/29 1:22:43
-- 更新用户:	zhangchennan
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc.nCurrentLife > npc.nMaxLife * 0.98 then
		npc.DelBuff(10485, 1)
		npc.DelBuff(10484, 1)
		npc.SetCustomInteger1(1, 2)
		npc.nCurrentLife = npc.nMaxLife
	elseif npc.nCurrentLife < npc.nMaxLife * 0.1 then
		npc.SetCustomInteger1(1, 1)
		npc.DelBuff(10485, 1)
		npc.DelBuff(10484, 1)
		npc.nCurrentLife = npc.nMaxLife
	else
		npc.AddBuff(0, 99, 10485, 1, 30)
	end
end
