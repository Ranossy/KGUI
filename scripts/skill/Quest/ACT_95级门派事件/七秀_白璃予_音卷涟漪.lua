---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/ACT_95级门派事件/七秀_白璃予_音卷涟漪.lua
-- 更新时间:	2015/12/28 21:21:27
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/ACT_95级门派事件/七秀_白璃予_音卷涟漪.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.CustomDamage(dwSkillSrcID, 15336, 1, 3, player.nMaxLife * 0.05)
	elseif npcTarget then
		npcTarget.nCurrentLife = npcTarget.nCurrentLife - 10000
	end
end
