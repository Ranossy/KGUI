---------------------------------------------------------------------->
-- 脚本名称:	F:/zhugan/client/scripts/skill/Quest/大唐监狱_绝尘刀.lua
-- 更新时间:	2012/12/26 14:44:54
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 43023 * 0.8, nDamageRand = 43023 * 0.4, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5029, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	local npc = scene.CreateNpc(21010, nX, nY, nZ, player.nFaceDirection + 128, 8)
	npc.PlaySfx(333, npc.nX, npc.nY, npc.nZ)
end
