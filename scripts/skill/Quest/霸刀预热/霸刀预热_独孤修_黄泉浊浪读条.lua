---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/霸刀预热/霸刀预热_独孤修_黄泉浊浪读条.lua
-- 更新时间:	2016/9/9 11:49:57
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
Include("scripts/Map/ACT_霸刀预热/include/独孤修通用数据.lua")
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/霸刀预热/霸刀预热_独孤修_黄泉浊浪读条.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local npcSkill
	for i = 1, nRange1Max + nRange2Max do
		npcSkill = scene.GetNpcByNickName("PQ164_HuangQuan_" .. i)
		if npcSkill then
			npcSkill.PlaySfx(1469, 0, 0, 0)
			npcSkill.CastSkill(16698, 1)
		end
	end
end
