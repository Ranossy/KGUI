---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/梦回稻香/莫雨_情绪失控母技能.lua
-- 更新时间:	2016/8/13 23:14:37
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/梦回稻香/莫雨_情绪失控母技能.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if npc then
		npc.AddBuff(npc.dwID, npc.nLevel, 11084, 1, 10)
		npc.CastSkill(16433, 1)
		--npc.CastSkill(16434, 1)
		local buff = npc.GetBuff(11084, 1)
		if buff then
			buff.nCustomValue = npc.nCurrentLife
		end
	end
end
