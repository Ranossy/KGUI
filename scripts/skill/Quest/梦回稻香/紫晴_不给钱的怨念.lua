---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/梦回稻香/紫晴_不给钱的怨念.lua
-- 更新时间:	2016/8/11 15:15:22
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	--if player then
		--local tQuestID = {15570, 15680, 15681, 15688}
		--for i = 1, #tQuestID do
			--player.ClearQuest(tQuestID[i])
		--end
		--if player.GetQuestPhase(15689) < 3 then
			--player.ClearQuest(15689)
		--end
		--if player.GetQuestPhase(15690) < 3 then
			--player.ClearQuest(15690)
		--end
	--end
end
