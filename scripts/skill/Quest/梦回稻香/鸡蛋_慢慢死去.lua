---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/梦回稻香/鸡蛋_慢慢死去.lua
-- 更新时间:	2016/8/20 21:15:10
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		player.CustomDamage(player.dwID, 16428, 1, 4, player.nMaxLife * 0.1)
		if player.nCurrentLife <= player.nMaxLife * 0.1 then
			player.Die()
			PlayEnding(player, 19)
			player.DelBuff(11083, 2)
		end
	end
end
