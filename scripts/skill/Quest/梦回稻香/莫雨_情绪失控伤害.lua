---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/梦回稻香/莫雨_情绪失控伤害.lua
-- 更新时间:	2016/8/16 11:48:21
-- 更新用户:	jiangzhefei1
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 2600, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 2400, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 2800, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 3000, nDamageRand = 0, nCostMana = 0}, --level 6
	{nDamageBase = 3200, nDamageRand = 0, nCostMana = 0}, --level 7
	{nDamageBase = 3400, nDamageRand = 0, nCostMana = 0}, --level 8
	{nDamageBase = 3600, nDamageRand = 0, nCostMana = 0}, --level 9
	{nDamageBase = 3800, nDamageRand = 0, nCostMana = 0}, --level 10
};
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestBuff(11098, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
