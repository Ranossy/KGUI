---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/梦回稻香/咸鱼_普通攻击.lua
-- 更新时间:	2016/7/12 10:03:06
-- 更新用户:	zhangkaiyuan
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/Quest/梦回稻香/咸鱼_普通攻击.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player then
		--player.AddBuff(dwSkillSrcID, 1, 10967, 1)
		player.CustomDamage(dwSkillSrcID, 16173, 1, 1, player.nMaxLife * 0.05)
	end
end
