...
-- 武功套路  :  无
-- 技能名称  :  无
-- 技能效果  :  3秒施法，对自身周围8尺范围内的玩家造成伤害，并对BOSS和周围玩家都施加BUFF，提高伤害100%，持续15秒
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	scene.CreateNpc(12663,npc.nX,npc.nY,npc.nZ,0,45);
end
