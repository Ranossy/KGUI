...
function Apply(dwCharacterID, dwSrcID)
	...
	local num = Random(100000)
	if num > 10000 or player.GetBuff(6507, 1) then
		return
	end
	...
	player.AddBuff(0,99,6507,1)
	scene.CreateNpc(17467, player.nX, player.nY, player.nZ, player.nFaceDirection, 70 * GLOBAL.GAME_FPS,"RiMian" .. player.dwID)
	
	scene.CreateNpc(7578, 54095, 28114, 1083136, 208, 3 * GLOBAL.GAME_FPS)
	local npc_Wizard = scene.CreateNpc(Prince_AShiNa.Wizard.dwTemplateID, 54095, 28114, 1083136, 208, 180 * GLOBAL.GAME_FPS)
	if npc_Wizard then
		npc_Wizard.SetCustomUnsigned4(Prince_AShiNa.Wizard.ValueName.dwDstX, player.nX - 64 * 1)
		npc_Wizard.SetCustomUnsigned4(Prince_AShiNa.Wizard.ValueName.dwDstY, player.nY)
		npc_Wizard.SetCustomUnsigned4(Prince_AShiNa.Wizard.ValueName.dwBossID, npc.dwID)
		npc_Wizard.SetCustomUnsigned4(Prince_AShiNa.Wizard.ValueName.dwPlayerID, player.dwID)
		npc_Wizard.SetTarget(TARGET.PLAYER, player.dwID)
	end
end
