...
function Apply(dwCharacterID)
	...
	if character then
		character.Jump(true,0)
		character.AddBuff(0,99,3664,1,3)
		character.GetScene().CreateNpc(14088,character.nX,character.nY,character.nZ,0,999999)
	end	
end
