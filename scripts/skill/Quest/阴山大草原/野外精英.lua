---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/Quest/阴山大草原/野外精英.lua
-- 更新时间:	2015/9/25 15:46:26
-- 更新用户:	xiedixun2
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local ID = npc.GetCustomInteger1(0)
	if player and npc then
		RemoteCallToClient(player.dwID, "UpdateMinimapMark", 1, ID, false, npc.nX, npc.nY, npc.nZ, npc.szName, 6000)
	end
end
