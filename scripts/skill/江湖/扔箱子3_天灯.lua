...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/江湖/扔箱子3_天灯.lua",
		0														
	);	
    skill.AddSlowCheckSelfBuff(7833, 10, BUFF_COMPARE_FLAG.LESS, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--  skill.BindBuff(1, 7833, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if height then
	--	local npc = scene.CreateNpc(36486, player.nX, player.nY, player.nZ, 0, -1)
		Creat3(player)
	end
end
