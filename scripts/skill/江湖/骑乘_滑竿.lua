---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/江湖/骑乘_滑竿.lua
-- 更新时间:	2017/3/15 14:31:40
-- 更新用户:	ZHANGYAN0-PC
-- 脚本说明:
----------------------------------------------------------------------<
-------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 244, 16);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if item.dwIndex == 20986 then --滑竿
		player.AddBuff(0, 99, 244, 16)
		
	
		player.SetDynamicSkillGroup(330)
		player.AddBuff(0, 99, 5718, 1, 24 * 3600 * 3680)--监控动态技能栏
	end
