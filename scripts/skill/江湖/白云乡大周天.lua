---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/江湖/白云乡大周天.lua
-- 更新时间:	2017/3/15 11:57:25
-- 更新用户:	ZHANGYAN0-PC
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 1187);	--技能普通CD
	----------------- 经验升级相关 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if item.dwIndex == 20986 then --滑竿

		if player.IsMoneyEnough(1, 0, 0) then
			player.CostMoney(1, 0, 0)
			player.AddBuff(0, 99, 11810, 1)
		end
	end
