...
function Apply(dwCharacterID)
	...
	if nItem.dwIndex == 566 then--水牛
		player.AddBuff(0, 99, 244, 2 )
		player.AddBuff(0, 99, 5763, 1 )
	elseif nItem.dwIndex == 13788 then--金翅苍宇雕1
		player.AddBuff(0, 99, 244, 9)
	elseif nItem.dwIndex == 13789 then--金翅苍宇雕2
		player.AddBuff(0, 99, 244, 10)
	elseif nItem.dwIndex == 13790 then--金翅苍宇雕3
