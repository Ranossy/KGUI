...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
	  ...
	  skill.AddSlowCheckSelfBuff(10814, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);  ---需求双刀
	  skill.AddSlowCheckSelfBuff(11079, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);  ---没有特效
