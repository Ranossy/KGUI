---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/江湖/骑乘_画舫.lua
-- 更新时间:	2015/3/29 17:04:55
-- 更新用户:	zhangyan3
-- 脚本说明:
----------------------------------------------------------------------<
-------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nMoveState == MOVE_STATE.ON_FLOAT then
		if item.dwIndex == 13704 then --船
			player.AddBuff(0, 99, 244, 8)
			player.SetDynamicSkillGroup(195)
		else
			if item.dwIndex == 20176 then --双人酒船
				player.AddBuff(0, 99, 244, 14)
				player.SetDynamicSkillGroup(307)
			end
			
			if item.dwIndex == 21102 then --2017年6月画舫3号
				player.AddBuff(0, 99, 244, 20)
				player.SetDynamicSkillGroup(307)
			end
		end
	end
