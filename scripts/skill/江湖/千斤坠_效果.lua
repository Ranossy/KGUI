...
tSkillData=
{
	{nSolarDamage = 10,nSolarDamageRand=3},
	{nSolarDamage = 20,nSolarDamageRand=3},
	{nSolarDamage = 30,nSolarDamageRand=3},
	{nSolarDamage = 40,nSolarDamageRand=3},
	{nSolarDamage = 50,nSolarDamageRand=3},
	{nSolarDamage = 60,nSolarDamageRand=3}
};
--设置武功技能级别相关数值
