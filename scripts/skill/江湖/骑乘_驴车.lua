...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 244, 5);		-- 设置1号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if item.dwIndex == 11770 or item.dwIndex == 18305 then
		player.AddBuff(0, 99, 244, 5)
		player.AddBuff(0, 99, 8101, 1, 2)
		player.AddBuff(0, 99, 8145, 1)
	elseif item.dwIndex ~= 567 and item.dwIndex ~= 11105 then
		playerAddBuff(0, 99, 244, 1)
	end
