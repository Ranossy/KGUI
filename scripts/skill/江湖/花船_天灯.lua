...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(8178, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckSelfBuff(7698, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckSelfBuff(7732, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	  skill.BindBuff(1, 7712, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 8178, 1);		-- 设置2号位Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.FlyJump()
	player.AddBuff(0,99,8022,1)
	player.DelBuff(7844, 1)
	player.DelBuff(8178, 1)
end
