...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/江湖/扔箱子4_天灯.lua",
		0														
	);	
    skill.AddSlowCheckSelfBuff(7834, 20, BUFF_COMPARE_FLAG.LESS, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);	
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	----------------- BUFF相关 -------------------------------------------------
	--  skill.BindBuff(1, 7834, 1);		-- 设置1号位Buff
...
if height then
		--local npc = scene.CreateNpc(36487, player.nX, player.nY, player.nZ, 0, -1)
		Creat4(player)
	end
end
