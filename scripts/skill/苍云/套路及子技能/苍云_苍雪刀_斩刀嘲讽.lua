---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_斩刀嘲讽.lua
-- 更新时间:	2014/10/22 14:01:07
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_斩刀嘲讽.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	-----------------技能施放技能需求-------------------------------------------
	--有跳斩奇穴
	skill.AddCheckSelfLearntSkill(13357, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	--elseif dwSkillLevel < 22 then
		--skill.nChannelInterval = 50 + (dwSkillLevel - 4) * 10;
	--else
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lvZD = player.GetSkillLevel(13054) --斩刀
	player.CastSkill(13358, lvZD)--嘲讽技
end
