---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_血刀添加流血效果.lua
-- 更新时间:	2014/10/13 20:11:26
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_血刀添加流血效果.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local XRbuff = player.GetBuffByOwner(8248, 1, player.dwID)
	if XRbuff then
