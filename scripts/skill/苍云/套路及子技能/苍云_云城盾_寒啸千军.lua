---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_寒啸千军.lua
-- 更新时间:	2017/3/19 2:01:52
-- 更新用户:	chenchen6-pc
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_寒啸千军.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 973);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nbuff_mark = player.GetBuff(10030, 1)
	local nSkill = target.GetKungfuMount()
	if nbuff_mark and nbuff_mark.nStackNum >= 15 then
		return
	else
		if nSkill ~= nil and (nSkill.dwSkillID == 10026 or nSkill.dwSkillID == 10224 or nSkill.dwSkillID == 10390 or nSkill.dwSkillID == 10015 or
		nSkill.dwSkillID == 10144 or nSkill.dwSkillID == 10145 or nSkill.dwSkillID == 10268 or nSkill.dwSkillID == 10003 or nSkill.dwSkillID == 10021 or
		nSkill.dwSkillID == 10014 or nSkill.dwSkillID == 10081 or nSkill.dwSkillID == 10175 or nSkill.dwSkillID == 10225 or nSkill.dwSkillID == 10242 or
		nSkill.dwSkillID == 10447 or nSkill.dwSkillID == 10464) then
			target.AddBuff(player.dwID, player.nLevel, 10031, 1)
			player.AddBuff(player.dwID, player.nLevel, 10030, 1)
		end
	end
	ModityCDToUI(player, 15072, 0, 0)
end
