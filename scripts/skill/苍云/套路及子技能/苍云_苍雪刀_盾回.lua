---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_盾回.lua
-- 更新时间:	2014/10/16 16:43:02
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_盾回.lua",
		0
	);
	--skill.AddAttribute(
		--ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
		--ATTRIBUTE_TYPE.RECOVERY_SHIELD,
		--13050,
		--0
	--);
	...
	--skill.SetNormalCoolDown(1, 819);	--技能普通CD
--	skill.SetNormalCoolDown(2, 814);	--技能普通CD
	--skill.SetNormalCoolDown(3, 836);	--隐刀0.5秒
	skill.SetCheckCoolDown(1, 444);	--只检查不走的CD
	--skill.SetCheckCoolDown(2, 822);	--只检查不走的CD
	----------------- 经验升级相关 ---------------------------------------------
...
--	skill.nCostRage = 10
	...
	--skill.nBulletVelocity = 80;				-- 子弹速度，单位 点/帧
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if player.GetSkillLevel(13366) == 1 then  --从容，盾飞提高10%基础攻击力
		--if not player.GetBuff(8424, 1) then
	player.AddBuff(0, 99, 8424, 1, 8) --8秒坚定
		--end
	--end
	...
	--player.DelBuff(8391, 1) --删除飞盾期间标记BUFF,  盾飞到手里时再清楚盾回图标，优化手感，避免秒收，按错马上有丢了
