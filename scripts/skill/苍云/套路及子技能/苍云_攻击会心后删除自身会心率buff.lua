---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_攻击会心后删除自身会心率buff.lua
-- 更新时间:	2014/10/8 21:55:03
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--当自身存在B_8267效果且没有B_8320稳定效果的时候，才能叠加B_8320稳定效果
	skill.AddSlowCheckSelfBuff(8320, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckSelfBuff(8267, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
...
function UnApply(dwCharacterID)
	...
	if player.GetBuff(8267, 1) then
		player.DelGroupBuff(8267, 1)
	end
end
