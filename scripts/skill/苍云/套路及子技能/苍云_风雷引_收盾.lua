---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_风雷引_收盾.lua
-- 更新时间:	2014/9/22 19:39:17
-- 更新用户:	mengxiangfei
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_风雷引_收盾.lua",											-- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
	...
	skill.SetNormalCoolDown(1, 840);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.ResetSkillCD(13049)
	ModityCDToUI(player, 13049, 0, 0)
	--player.SetTimer(4, "scripts/skill/苍云/套路及子技能/苍云_风雷引_收盾.lua", 0, 0)
end
