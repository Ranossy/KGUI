---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_招架后回复怒气.lua
-- 更新时间:	2014/10/21 19:59:17
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_招架后回复怒气.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(8522,1) and not player.GetBuff(7913,1) and player.dwShapeShiftID == 0 then
		player.nCurrentLife = player.nCurrentLife + player.nMaxLife * 0.05
		player.AddBuff(player.dwID, player.nLevel, 8522, 1)
	end
end
