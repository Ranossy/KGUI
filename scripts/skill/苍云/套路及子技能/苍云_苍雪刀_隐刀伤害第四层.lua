---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_隐刀伤害第四层.lua
-- 更新时间:	2014/10/13 14:03:57
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 600, nDamageRand = 600*0.1, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_隐刀伤害第四层.lua",
		0
	);
	...
	----------------- 时间相关 -------------------------------------------------
	skill.nChannelInterval = 45;     -- 通道技间隔时间
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	for i = 1, 4 do
		if i == nbuff_lev then
			player.AddBuff(player.dwID, player.nLevel, 8567, nbuff_lev)
		else
			if player.GetBuff(8567, i) then
				player.DelBuff(8567, i)
			end
		end
	end
