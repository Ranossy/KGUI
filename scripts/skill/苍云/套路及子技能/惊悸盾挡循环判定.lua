---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/惊悸盾挡循环判定.lua
-- 更新时间:	2015/10/15 9:55:17
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nMoveState ~= MOVE_STATE.ON_DEATH and player.nCurrentLife <= player.nMaxLife * 0.35 and not player.GetBuff(9887, 1) then
		player.AddBuff(player.dwID, player.nLevel, 10087, 1)
