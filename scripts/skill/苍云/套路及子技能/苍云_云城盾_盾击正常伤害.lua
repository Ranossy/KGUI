---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾击正常伤害.lua
-- 更新时间:	2014/9/14 18:16:43
-- 更新用户:	mengxiangfei
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamageBase = 150, nDamageRand = 50*0.1, nCostMana = 0}, --level 1
	{nDamageBase = 180, nDamageRand = 80*0.1, nCostMana = 0}, --level 2
	{nDamageBase = 210, nDamageRand = 100*0.1, nCostMana = 0}, --level 3
	{nDamageBase = 240, nDamageRand = 120*0.1, nCostMana = 0}, --level 4
	{nDamageBase = 270, nDamageRand = 140*0.1, nCostMana = 0}, --level 5
	{nDamageBase = 300, nDamageRand = 160*0.1, nCostMana = 0}, --level 6
	{nDamageBase = 320, nDamageRand = 180*0.1, nCostMana = 0}, --level 7
	{nDamageBase = 340, nDamageRand = 200*0.1, nCostMana = 0}, --level 8
	{nDamageBase = 360, nDamageRand = 240*0.1, nCostMana = 0}, --level 9
	{nDamageBase = 380, nDamageRand = 280*0.1, nCostMana = 0}, --level 10
	{nDamageBase = 400, nDamageRand = 320*0.1, nCostMana = 0}, --level 11
	{nDamageBase = 420, nDamageRand = 360*0.1, nCostMana = 0}, --level 12
	{nDamageBase = 440, nDamageRand = 400*0.1, nCostMana = 0}, --level 13
	{nDamageBase = 460, nDamageRand = 440*0.1, nCostMana = 0}, --level 14
	{nDamageBase = 480, nDamageRand = 480*0.1, nCostMana = 0}, --level 15
	{nDamageBase = 520, nDamageRand = 520*0.1, nCostMana = 0}, --level 16
};
...
function GetSkillLevelData(skill)
	...
	--奇穴步临13111盾击附带眩晕和降加速效果
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
		"skill/苍云/套路及子技能/苍云_云城盾_盾击正常伤害.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(8254, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	skill.AddSlowCheckSelfBuff(8255, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);	-- 需求自身属于自己的Buff
	--skill.AddSlowCheckDestOwnBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);	-- 需求目标属于自己的Buff

	-----------------技能施放技能需求-------------------------------------------
	--skill.AddCheckSelfLearntSkill(13109, 0, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	skill.SetNormalCoolDown(1, 808);	--技能普通CD
	...
	elseif dwSkillLevel < 16 then
		skill.nChannelInterval = 16 + (dwSkillLevel - 4) * 5;
	else
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--有奇穴步临13111 盾击伤害附带眩晕和降加速效果
	if player.GetSkillLevel(13111) == 1 then
		player.CastSkill(13112, 1, player.GetSkillTarget())
	end

	if player.GetSkillLevel(13113) == 1 then --胜前
		local Parry = ((player.nParry / (player.nParry + 2.237 * 775)) * 100 + 3)
		local nSkill = player.GetKungfuMount()
		--print(Parry)
		if nSkill ~= nil and nSkill.dwSkillID == 10389 then  --铁骨衣心法
			player.nCurrentLife = player.nMaxLife * Parry *0.005 + player.nCurrentLife
		end
	end
end
