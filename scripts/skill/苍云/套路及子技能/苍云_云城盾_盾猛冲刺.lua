---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾猛冲刺.lua
-- 更新时间:	2014/10/9 22:14:55
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾猛冲刺.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	nTarget.AddBuff(0, 99, 8327, 1, 1)  --锁足1.5秒
	nTarget.AddBuff(0, 99, 8460, 1, 5)  --抗摔5秒
	player.AddBuff(0, 99, 8366, 1, 40)  --冲刺结束后放击退
