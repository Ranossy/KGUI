---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾刀二段攻击.lua
-- 更新时间:	2014/9/16 19:19:16
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 32
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 33
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 34
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 35
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 36
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 37
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 38
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 0}, --level 39
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾刀二段攻击.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.DelBuff(8232, 1)
	if not player.GetBuff(8262, 1) then
		player.AddBuff(player.dwID, player.nLevel, 8262, 1, 1)  --盾刀第一段的图标换为第三段的
		local lv = player.GetSkillLevel(13044)
		player.CastSkill(13244, lv) --第二段盾刀是AOE伤害
	end

	local lvCC = player.GetSkillLevel(13121)
	local nSkill =  player.GetKungfuMount()
	if lvCC == 1 then--奇穴，出尘，第三段攻击追加一次伤害
		local Parry = ((player.nParry * 0.0111) + 3) * 100
		if nSkill ~= nil and nSkill.dwSkillID == 10390 then  --分山劲心法
			local nNum = Random(10000)
			if nNum <= Parry * 3 then
				player.AddBuff(0, 99, 8286, 1, 1) --追加伤害需求buff
			end
		end
