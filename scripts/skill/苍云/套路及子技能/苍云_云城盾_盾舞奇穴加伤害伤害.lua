---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾舞奇穴加伤害伤害.lua
-- 更新时间:	2014/11/9 13:55:19
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾舞奇穴加伤害伤害.lua",
		0
	);
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 16 * 1.25;
	elseif dwSkillLevel < 16 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 4)) * 1.25;
	else
		skill.nChannelInterval = 30 * 1.25;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
