---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_盾反取人数.lua
-- 更新时间:	2014/10/28 21:54:24
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,  --取人数
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
		"skill/苍云/套路及子技能/苍云_盾反取人数.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	--盾墙状态不能施展技能
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	nTarget.AddBuff(player.dwID, player.nLevel, 8473, 1, 2) --避免延迟时误伤
	
	player.AddBuff(0, 99, 8471, 1, 5) --5秒记录打了多少人
	player.AddBuff(0, 99, 8472, 1, 1) --半秒后出伤害
