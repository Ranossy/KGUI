---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_斩刀.lua
-- 更新时间:	2014/9/28 12:02:25
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_斩刀.lua
-- 更新时间:	2014/9/13 19:13:03
-- 更新用户:	mengxiangfei
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 801);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	if skill.dwLevel == skill.dwMaxLevel then
		player.AcquireAchievement(4304)
	end
end
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--秘籍解除锁足
	if player.IsSkillRecipeActive(1845, 1) then
		player.CastSkill(13394, 1)
	end
	
	--[[
	if player.GetSkillLevel(13091) == 1 then  --斩刀解除锁足
		player.CastSkill(13394, 1)
	end
	--]]
	player.SetTimer(1, "scripts/skill/苍云/套路及子技能/苍云_苍雪刀_斩刀.lua", 0, 0)

	--斩刀消耗30点怒气，有奇穴13073 赤心 回血
...
function OnTimer(player, nParam1, nParam2)
	...
	if lvZD ~= 0 then
		--print(player.CastSkill(13454, lvZD))
		player.CastSkill(13454, lvZD) --放必中的冲刺
	end
end
