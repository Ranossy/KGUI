---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_盾刀删除减伤20%buff.lua
-- 更新时间:	2014/9/16 20:56:57
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_盾刀删除减伤20%buff.lua",
		0
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(8266, 1) then
		player.DelBuff(8266, 1)
	end
end
