...
tSkillData =
{
	{nDamageBase = 35, nDamageRand = 35*0.1, nCostMana = 0}, --level 1
	{nDamageBase = 75, nDamageRand = 45*0.1, nCostMana = 0}, --level 2
	{nDamageBase = 85, nDamageRand = 55*0.1, nCostMana = 0}, --level 3
	{nDamageBase = 95, nDamageRand = 65*0.1, nCostMana = 0}, --level 4
	{nDamageBase = 105, nDamageRand = 75*0.1, nCostMana = 0}, --level 5
	{nDamageBase = 115, nDamageRand = 85*0.1, nCostMana = 0}, --level 6
	{nDamageBase = 125, nDamageRand = 95*0.1, nCostMana = 0}, --level 7
	{nDamageBase = 135, nDamageRand = 105*0.1, nCostMana = 0}, --level 8
	{nDamageBase = 150, nDamageRand = 120*0.1, nCostMana = 0}, --level 9
	{nDamageBase = 165, nDamageRand = 135*0.1, nCostMana = 0}, --level 10
	{nDamageBase = 180, nDamageRand = 150*0.1, nCostMana = 0}, --level 11
	{nDamageBase = 195, nDamageRand = 165*0.1, nCostMana = 0}, --level 12
	{nDamageBase = 210, nDamageRand = 180*0.1, nCostMana = 0}, --level 13
	{nDamageBase = 225, nDamageRand = 195*0.1, nCostMana = 0}, --level 14
	{nDamageBase = 240, nDamageRand = 210*0.1, nCostMana = 0}, --level 15
	{nDamageBase = 255, nDamageRand = 225*0.1, nCostMana = 0}, --level 16
	{nDamageBase = 270, nDamageRand = 240*0.1, nCostMana = 0}, --level 17
	{nDamageBase = 285, nDamageRand = 255*0.1, nCostMana = 0}, --level 18
	{nDamageBase = 300, nDamageRand = 270*0.1, nCostMana = 0}, --level 19
	{nDamageBase = 315, nDamageRand = 285*0.1, nCostMana = 0}, --level 20
	{nDamageBase = 330, nDamageRand = 300*0.1, nCostMana = 0}, --level 21
	{nDamageBase = 345, nDamageRand = 315*0.1, nCostMana = 0}, --level 22
	{nDamageBase = 360, nDamageRand = 330*0.1, nCostMana = 0}, --level 23
	{nDamageBase = 375, nDamageRand = 345*0.1, nCostMana = 0}, --level 24
	{nDamageBase = 390, nDamageRand = 360*0.1, nCostMana = 0}, --level 25
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/3, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.SKILL_PHYSICS_DAMAGE_RAND, -- 魔法属性
		tSkillData[dwSkillLevel].nDamageRand/3, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
	...
	--"skill/苍云/套路及子技能/苍云_云城盾_盾猛基础伤害.lua", -- 属性值1
	--0											-- 属性值2
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.AddSlowCheckDestOwnBuff(8248, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff   

	-----------------技能施放技能需求-------------------------------------------
	--有奇穴锋鸣打N倍的伤害并且会心几率提高50%
	skill.AddCheckSelfLearntSkill(13103, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	elseif dwSkillLevel < 25 then
		skill.nChannelInterval = 40 + (dwSkillLevel - 4) * 4;
	else
