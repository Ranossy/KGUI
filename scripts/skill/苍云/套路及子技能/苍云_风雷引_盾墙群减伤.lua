---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_风雷引_盾墙群减伤.lua
-- 更新时间:	2014/10/22 10:12:52
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_风雷引_盾墙群减伤.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	skill.nSectorDirection = 127;  --中心线偏移
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	nTarget.AddBuff(0, 99, 8427, 1, 1) --1秒全局减伤50%
end
