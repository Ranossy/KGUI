...
tSkillData =
{
	{nDamageBase = 150, nDamageRand = 20 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 160, nDamageRand = 45 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 170, nDamageRand = 60 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 180, nDamageRand = 75 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 190, nDamageRand = 90 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 200, nDamageRand = 105 * 0.1, nCostMana = 0}, --level 6
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(8568, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff   --盾墙状态下标记buff
	...
	--skill.nMaxSearchCount = 0 --不限制弹射目标   0为不限 1为 只打一个目标
	----------------- 作用范围 -------------------------------------------------
