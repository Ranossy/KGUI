---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_斩刀命中虚弱目标添加流血效果.lua
-- 更新时间:	2014/9/28 12:39:34
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_斩刀命中虚弱目标添加流血效果.lua",
		0
	);
	...
	elseif dwSkillLevel < 22 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 9) * 4)*1.5
	else
		skill.nChannelInterval = 70*1.5;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local XRbuff = nTarget.GetBuffByOwner(8248, 1, player.dwID)
	if XRbuff then
		nTarget.DelBuffByIndex(XRbuff.nIndex)
	end
end
