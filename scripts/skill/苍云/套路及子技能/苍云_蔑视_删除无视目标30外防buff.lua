---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_蔑视_删除无视目标30外防buff.lua
-- 更新时间:	2015/9/25 9:32:48
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	--]]
   	skill.AddAttribute(
   		...
   		"skill/苍云/套路及子技能/苍云_蔑视_删除无视目标30外防buff.lua",											-- 属性值1
   		0											-- 属性值2
   		);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(2, "scripts/skill/苍云/套路及子技能/苍云_蔑视_删除无视目标30外防buff.lua", 0, 0)	
end
