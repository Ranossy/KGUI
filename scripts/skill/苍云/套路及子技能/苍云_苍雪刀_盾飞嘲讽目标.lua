---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_盾飞嘲讽目标.lua
-- 更新时间:	2014/10/23 0:10:01
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
--		dwSkillLevel
--	);
	skill.AddSlowCheckDestBuff(8430, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
	skill.AddCheckSelfLearntSkill(13368, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级

	skill.BindBuff(1, 8426, 1); --当关仇恨BUFF
	skill.BindBuff(2, 8430, 1); --当关仇恨BUFF
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_盾飞嘲讽目标.lua",
		0
		);
