---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾舞奇穴虚弱目标加伤害伤害.lua
-- 更新时间:	2014/11/9 13:55:56
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	...
	{nDamageBase = 40, nDamageRand = 40 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 55, nDamageRand = 55 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 70, nDamageRand = 70 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 85, nDamageRand = 85 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 105, nDamageRand = 105 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 125, nDamageRand = 125 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 145, nDamageRand = 145 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 165, nDamageRand = 165 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 185, nDamageRand = 185 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 205, nDamageRand = 205 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 225, nDamageRand = 225 * 0.1, nCostMana = 0}, --level 12
	{nDamageBase = 245, nDamageRand = 245 * 0.1, nCostMana = 0}, --level 13
	{nDamageBase = 265, nDamageRand = 265 * 0.1, nCostMana = 0}, --level 14
	{nDamageBase = 285, nDamageRand = 285 * 0.1, nCostMana = 0}, --level 15
	{nDamageBase = 305, nDamageRand = 305 * 0.1, nCostMana = 0}, --level 16
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾舞奇穴虚弱目标加伤害伤害.lua",
		0
	);
	...
	skill.AddSlowCheckDestOwnBuff(8248, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff
	...
	elseif dwSkillLevel < 16 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 4)) * 1.1;
	else
		skill.nChannelInterval = 30*1.1;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
