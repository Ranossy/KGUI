---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾舞正常伤害.lua
-- 更新时间:	2014/11/9 13:50:19
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 90, nDamageRand = 25 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 130, nDamageRand = 40 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 140, nDamageRand = 55 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 170, nDamageRand = 70 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 190, nDamageRand = 85 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 210, nDamageRand = 105 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 230, nDamageRand = 125 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 240, nDamageRand = 145 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 250, nDamageRand = 165 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 260, nDamageRand = 185 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 270, nDamageRand = 205 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 280, nDamageRand = 225 * 0.1, nCostMana = 0}, --level 12
	{nDamageBase = 290, nDamageRand = 245 * 0.1, nCostMana = 0}, --level 13
	{nDamageBase = 300, nDamageRand = 265 * 0.1, nCostMana = 0}, --level 14
	{nDamageBase = 315, nDamageRand = 285 * 0.1, nCostMana = 0}, --level 15
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾舞正常伤害.lua",
		0
	);
	...
	-----------------技能施放技能需求-------------------------------------------
	--需求自身在没有奇穴下施展正常伤害
	--skill.AddCheckSelfLearntSkill(13278, 0, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	elseif dwSkillLevel < 16 then
		...
		skill.nChannelInterval = 30*1.15;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsHaveBuff(8265, 1) then --盾墙姿态
		player.CastSkill(13459, 1)	
	end
	if player.nPoseState == 2 then--擎盾姿态非盾墙下
		if not player.IsHaveBuff(8265, 1) then
