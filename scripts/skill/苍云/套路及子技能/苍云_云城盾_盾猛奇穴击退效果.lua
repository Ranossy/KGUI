---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾猛奇穴击退效果.lua
-- 更新时间:	2014/11/8 22:21:32
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾猛奇穴击退效果.lua",
		0
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK,
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	nTarget.AddBuff(0, 99, 8569, 1, 40) --停滑结束眩晕
	if player.GetSkillLevel(13414) == 1 then  ---方形击晕
		player.CastSkill(13465, 1) --方形击晕
	end
