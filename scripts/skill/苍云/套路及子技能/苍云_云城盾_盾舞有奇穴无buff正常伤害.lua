---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾舞有奇穴无buff正常伤害.lua
-- 更新时间:	2014/11/9 13:51:29
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
tSkillData =
{
	{nDamageBase = 25, nDamageRand = 25 * 0.1, nCostMana = 0}, --level 1
	{nDamageBase = 60, nDamageRand = 40 * 0.1, nCostMana = 0}, --level 2
	{nDamageBase = 75, nDamageRand = 55 * 0.1, nCostMana = 0}, --level 3
	{nDamageBase = 90, nDamageRand = 70 * 0.1, nCostMana = 0}, --level 4
	{nDamageBase = 105, nDamageRand = 85 * 0.1, nCostMana = 0}, --level 5
	{nDamageBase = 125, nDamageRand = 105 * 0.1, nCostMana = 0}, --level 6
	{nDamageBase = 145, nDamageRand = 125 * 0.1, nCostMana = 0}, --level 7
	{nDamageBase = 165, nDamageRand = 145 * 0.1, nCostMana = 0}, --level 8
	{nDamageBase = 185, nDamageRand = 165 * 0.1, nCostMana = 0}, --level 9
	{nDamageBase = 205, nDamageRand = 185 * 0.1, nCostMana = 0}, --level 10
	{nDamageBase = 225, nDamageRand = 205 * 0.1, nCostMana = 0}, --level 11
	{nDamageBase = 245, nDamageRand = 225 * 0.1, nCostMana = 0}, --level 12
	{nDamageBase = 265, nDamageRand = 245 * 0.1, nCostMana = 0}, --level 13
	{nDamageBase = 285, nDamageRand = 265 * 0.1, nCostMana = 0}, --level 14
	{nDamageBase = 305, nDamageRand = 285 * 0.1, nCostMana = 0}, --level 15
	{nDamageBase = 325, nDamageRand = 305 * 0.1, nCostMana = 0}, --level 16
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾舞有奇穴无buff正常伤害.lua",
		0
	);
	...
	skill.AddSlowCheckDestOwnBuff(8249, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	-----------------技能施放技能需求-------------------------------------------
	--需求自身在没有奇穴下施展正常伤害
	skill.AddCheckSelfLearntSkill(13278, 1, SKILL_COMPARE_FLAG.EQUAL);     --检查比较Caster自己已学习的技能ID和等级
	...
	elseif dwSkillLevel < 16 then
		skill.nChannelInterval = 16 + (dwSkillLevel - 4);
	else
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetBuff(8265, 1) then --盾墙姿态
		player.CastSkill(13459, 1)	
	end
	if player.nPoseState == 2 then--擎盾姿态非盾墙下
		if not player.GetBuff(8265, 1) then
