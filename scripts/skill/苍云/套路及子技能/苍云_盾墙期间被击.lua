---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_盾墙期间被击.lua
-- 更新时间:	2014/11/8 15:57:08
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
--	skill.AddSlowCheckSelfBuff(8265, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 盾墙
	...
	--skill.SetNormalCoolDown(1, 812);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not player.GetBuff(8562, 1) then  --内置2秒CD
		player.nCurrentRage = player.nCurrentRage + 5 --回复5点怒气
		player.nCurrentEnergy = player.nCurrentEnergy - 1 --降低2点格挡值
		--player.AddBuff(0, 99, 8562, 1, 2) --2秒内置CD
	--end
end
