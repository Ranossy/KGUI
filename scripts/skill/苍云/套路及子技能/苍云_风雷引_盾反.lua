---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_风雷引_盾反.lua
-- 更新时间:	2014/9/19 9:45:26
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--需求盾壁结束后的标记buff
	skill.AddSlowCheckSelfBuff(8287, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.SetNormalCoolDown(1, 1013);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print(22222)
	player.DelBuff(8365, 1)

	player.CastSkill(13409, 1) --取人数
	
	--盾反消耗50点怒气，有奇穴13073 赤心 回血
