---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_苍雪刀_血怒第三层.lua
-- 更新时间:	2014/10/15 18:55:16
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_苍雪刀_血怒第三层.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(8383, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		--第三层
	--skill.AddSlowCheckSelfBuff(8382, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		--第二层
...
function Apply(dwCharacterID, dwSkillSrcID)
		...
		if nSkill.dwSkillID == 10390 then	--输出心法
			if player.GetSkillLevel(13304) == 1 then --奇穴愤恨，扣血20%
				...
				--	player.CastSkill(13343, 1) --额外恢复25点怒气
					...
					player.AddBuff(player.dwID, player.nLevel, 8385, 1, 25 + nNum) --防御心法添加75%内外防效果
				--	player.CastSkill(13343, 1) --额外恢复25点怒气
				end
			else
				if  player.GetBuff(8384, 1) then
	...
	player.AddBuff(0, 99, 8582, 1, 10 + nNum)  --血怒表现
	--回血秘籍
