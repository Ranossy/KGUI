---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_风雷引_盾毅释放.lua
-- 更新时间:	2014/11/4 20:47:27
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_风雷引_盾毅释放.lua",
		0
	);
...
---------------------------------
	...
	if nTarget.nImmuneSkillMoveCount == 0 then
		nTarget.BeHitted(player.dwID, 13068, 1, 30)
		nTarget.AddBuff(player.dwID, player.nLevel, 8467, 1, 5)
		player.SetTimer(26, "scripts/skill/苍云/套路及子技能/苍云_风雷引_盾毅释放.lua", 0, 0)
	end
	player.AddBuff(0, 99, 8483, 1, 3)

	--zhujue.AddBuff(0, 99, 8387, 1, 1)
...
function OnTimer(player, nParam1, nParam2)
	--print(1111111111)
	if player.GetSkillLevel(13386) == 1 then  --盾毅第二段后抛
		player.AddBuff(0, 99, 8441, 1, 4) --1秒换图 盾抛
	else
		player.AddBuff(0, 99, 8440, 1, 4) --1秒换图标盾毅二
	end
