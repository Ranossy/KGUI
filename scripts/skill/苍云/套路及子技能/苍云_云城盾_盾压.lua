---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾压.lua
-- 更新时间:	2014/9/14 14:32:11
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase/2, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.SKILL_PHYSICS_DAMAGE_RAND, -- 魔法属性
		tSkillData[dwSkillLevel].nDamageRand/2, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_盾压冲刺.lua", -- 属性值1
		0											-- 属性值2
	);
	--回复怒气
	skill.AddAttribute(
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_DEST_NOT_ROLLBACK, -- 属性作用模式
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/苍云/套路及子技能/苍云_云城盾_盾压.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	...
	skill.SetNormalCoolDown(1, 802);	--技能普通CD
	...
	elseif dwSkillLevel < 24 then
		...
		skill.nChannelInterval = 190;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(8738,1) then
		nTarget.AddBuff(player.dwID, player.nLevel, 562, 15, 4)  --4秒封轻功
		player.AddBuff(player.dwID,player.nLevel,8738,1)	
	end
	--触发橙武特效情况盾压无CD切额外回复怒气
