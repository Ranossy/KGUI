---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾墙下的盾舞.lua
-- 更新时间:	2014/11/8 16:39:31
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_云城盾_盾墙下的盾舞.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	--B_8265为判定玩家是否在盾墙状态,盾墙状态无法施展技能
	skill.AddSlowCheckSelfBuff(8265, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	skill.SetNormalCoolDown(1, 813);	--技能普通CD
	--触发的1sGCD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(14849) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 9896, 1)
	end
	
--	player.AddBuff(0, 99, 8563, 1, 5) --每跳释放击退
	--player.DelBuff(8564, 1) --删除加强版盾舞的切换标记BUFF
	--player.DelBuff(8265, 1) --离开盾墙姿态
	--盾舞消耗40点怒气，有奇穴13073 赤心 回血
	--[[
