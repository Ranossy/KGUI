---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_风雷引_盾毅二.lua
-- 更新时间:	2014/10/24 13:59:01
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/套路及子技能/苍云_风雷引_盾毅二.lua",
		0
	);
	...
	skill.AddSlowCheckSelfBuff(8440, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	--盾毅标记
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
	skill.AddSlowCheckDestOwnBuff(8467, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 盾毅标记
	--skill.AddSlowCheckSelfOwnBuff(8440, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if nTarget.nImmuneSkillMoveCount == 0 then	
		nTarget.BeHitted(player.dwID, 13387, 1, 30)
		nTarget.AddBuff(0, 99, 8566, 1, 5) --5秒封轻功
	end
	player.AddBuff(0, 99, 8483, 1, 4)
	player.AddBuff(0, 99, 8442, 1, 5)
	player.DelBuff(8440, 1)
end
