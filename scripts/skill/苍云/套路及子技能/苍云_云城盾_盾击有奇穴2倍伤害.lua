...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase*2/5,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand*2/5,
		0
	);
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 16*1.6;
	elseif dwSkillLevel < 16 then
		skill.nChannelInterval = (16 + (dwSkillLevel - 4) * 5)*1.6;
	else
		skill.nChannelInterval = 100*1.6;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
