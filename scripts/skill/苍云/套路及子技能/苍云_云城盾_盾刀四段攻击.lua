---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_云城盾_盾刀四段攻击.lua
-- 更新时间:	2014/9/18 22:29:58
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT, -- 魔法属性
		"skill/苍云/套路及子技能/苍云_云城盾_盾刀四段攻击.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	skill.AddSlowCheckSelfBuff(8263, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 一段切二段
	...
	if dwSkillLevel < 5 then
		skill.nChannelInterval = 25;
	elseif dwSkillLevel < 33 then
		skill.nChannelInterval = 25 + (dwSkillLevel - 4) * 4;
	else
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if target and player.GetSkillLevel(13321) == 1 then
		target.AddBuff(player.dwID, player.nLevel, 8398, 1, 6) -- 目标减速60%
	end
	
	player.DelBuff(8263, 1)
	-----------------------------------------------------血怒回血
