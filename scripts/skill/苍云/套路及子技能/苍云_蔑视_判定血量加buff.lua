---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_蔑视_判定血量加buff.lua
-- 更新时间:	2015/9/25 9:05:31
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/苍云/套路及子技能/苍云_蔑视_判定血量加buff.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nCurrentLife / player.nMaxLife >= target.nCurrentLife / target.nMaxLife then
		player.SetTimer(4, "scripts/skill/苍云/套路及子技能/苍云_蔑视_判定血量加buff.lua", 0, 0)
		--player.AddBuff(player.dwID, player.nLevel, 9889, 1)
	end
end
...
function OnTimer(player, nParam1, nParam2)
	...
	if player.GetBuff(9889, 1) then
		player.DelGroupBuff(9889, 1)
	end
	player.AddBuff(player.dwID, player.nLevel, 9889, 1)
end
