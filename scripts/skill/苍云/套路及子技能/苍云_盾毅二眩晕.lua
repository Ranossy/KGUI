---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/苍云_盾毅二眩晕.lua
-- 更新时间:	2014/10/25 10:27:30
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if IsPlayer(dwCharacterID) then
		...
		nTarget.SetTimer(32, "scripts/skill/苍云/套路及子技能/苍云_盾毅二眩晕.lua", nTarget.dwID, 0)
	else
		nTarget = GetNpc(dwCharacterID)
	end
	--nTarget.AddBuff(0, 99, 8455, 1, 3)
