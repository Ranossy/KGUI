---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/套路及子技能/监控格挡值.lua
-- 更新时间:	2015/9/25 10:31:23
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nCurrentEnergy <= 20 and not player.GetBuff(9894, 1) and player.nMoveState ~= MOVE_STATE.ON_DEATH and player.bFightState == true then
		player.AddBuff(player.dwID, player.nLevel, 9894, 1)
		player.AddBuff(player.dwID, player.nLevel, 9895, 1)
	end
end
