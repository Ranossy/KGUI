...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.IsHaveBuff(8250, 1) then
		nCost = nCost - 10
	end

	if player.nCurrentRage >= nCost then
		nNum = math.floor((player.nCurrentRage - nCost) / 10) 
	end
