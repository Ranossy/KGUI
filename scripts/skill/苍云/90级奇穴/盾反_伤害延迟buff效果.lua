---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/盾反_伤害延迟buff效果.lua
-- 更新时间:	2014/9/19 9:54:11
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nbuff = player.GetBuff(8288, 1)	--命中目标数量的标记buff
	local nlevel = 1
	if nbuff then
		...
		if nMax < 10000 then
			...
			nlevel = math.min((nMax - 10000) / 2000 + 2 + nbuffcount - 1, 100)
		end 
	end

	--施放反伤技能
	player.CastSkill(13166,nlevel)
end
