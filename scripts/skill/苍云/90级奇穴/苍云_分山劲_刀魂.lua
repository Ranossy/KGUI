---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_分山劲_刀魂.lua
-- 更新时间:	2014/11/14 12:44:46
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(0, 99, 8393, 1, 10) --刀魂监控
end
...
function UnApply(dwCharacterID)
	...
	player.DelBuff(8393, 1) -- 删除刀魂监控
	player.DelBuff(8627, 1) -- 删除刀魂
end
