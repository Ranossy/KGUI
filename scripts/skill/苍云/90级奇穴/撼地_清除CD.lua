...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(8533, 1) then --跳跃没有击中目标
		if not player.GetBuff(8534, 1) then  --成功放空一次
			--print(3333)
			player.ClearCDTime(812) --清撼地CD
			player.AddBuff(0, 99, 8534, 1, 10)
			player.AddBuff(0, 99, 8541, 1, 10) --跳跃击中目标，为4秒后处理
		end
	else
		player.ResetCD(812) --击中目标
	end
end
