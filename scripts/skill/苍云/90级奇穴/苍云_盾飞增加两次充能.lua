---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_盾飞增加两次充能.lua
-- 更新时间:	2014/11/19 16:20:12
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
		...
		--"skill/苍云/90级奇穴/苍云_盾飞增加两次充能.lua",
		--0
	--);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--if not player then
		--return
	--end
	--player.ClearCDTime(818)
	--player.ClearCDTime(820)
	--player.ClearCDTime(823)
