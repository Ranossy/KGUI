---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_盾立_被击为自身回复5点怒气.lua
-- 更新时间:	2014/11/8 16:56:25
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.CURRENT_RAGE, -- 魔法属性
		5, -- 属性值1
		0											-- 属性值2
	);
	skill.AddAttribute(
		...
		"skill/苍云/90级奇穴/苍云_盾立_被击为自身回复5点怒气.lua",
		0
	);
