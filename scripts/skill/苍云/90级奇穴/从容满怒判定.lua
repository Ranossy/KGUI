...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(13366) == 1 and player.nCurrentRage > player.nMaxRage * 0.8 and not player.GetBuff(9051, 1) and player.nMoveState ~= MOVE_STATE.ON_DEATH then
		player.AddBuff(0, 99, 8423, 1, 40) --30秒从容
		--player.AddBuff(0, 99, 9050, 1)
		player.AddBuff(0, 99, 9051, 1)
	end

	--[[
	if player.GetSkillLevel(13366) == 1 and player.nCurrentRage <= player.nMaxRage * 0.8 then
		if player.GetBuff(9050, 1) then
			player.DelBuff(9050, 1)
		end
	--]]
end
