---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_分山劲_绝刀变AOE.lua
-- 更新时间:	2014/11/11 16:35:15
-- 更新用户:	zhouyixiao2
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/90级奇穴/苍云_分山劲_绝刀变AOE.lua",
		0
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(0, 99, 8579, 1, 1000) --绝刀AOE换动作
...
function UnApply(dwCharacterID)
	...
	player.DelBuff(8579, 1) --绝刀AOE换动作
end
