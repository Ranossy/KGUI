---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_分山劲_从容加判定监控buff.lua
-- 更新时间:	2015/6/15 11:36:40
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/90级奇穴/苍云_分山劲_从容加判定监控buff.lua", -- 属性值1
		0											-- 属性值2
	);
