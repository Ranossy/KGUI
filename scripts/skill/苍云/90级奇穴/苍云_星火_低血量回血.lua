---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_星火_低血量回血.lua
-- 更新时间:	2014/9/16 21:31:48
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/苍云/90级奇穴/苍云_星火_低血量回血.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--添加8268持续判定buff
	if not player.GetBuff(8268,1) then
		player.AddBuff(player.dwID, player.nLevel, 8268, 1)
	end
end
...
function UnApply(dwCharacterID)
	...
	--遗忘奇穴删除8268持续判定buff
	if player.GetBuff(8268, 1) then
		player.DelBuff(8268, 1)
	end
	...
	--删除加强版防御回血buff
	if player.GetBuff(8258, 1) then
		player.DelBuff(8258, 1)
	end
