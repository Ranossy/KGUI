---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/岌危添加记录血量.lua
-- 更新时间:	2014/9/17 9:23:19
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local HP_begin = player.nCurrentLife / player.nMaxLife
	if player.GetBuff(8273, 1) then
		local buff_jiwei = player.GetBuff(8273, 1)
		buff_jiwei.nCustomValue = HP_begin
	end
end
