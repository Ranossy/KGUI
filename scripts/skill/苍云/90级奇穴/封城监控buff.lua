...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nPoseState == 2 and player.nMoveState ~= MOVE_STATE.ON_DEATH then
		if player.GetSkillLevel(13319) == 1 then
			if not player.GetBuff(8395, 1) then
				player.AddBuff(0, 99, 8395, 1, 600)
			end
		else
