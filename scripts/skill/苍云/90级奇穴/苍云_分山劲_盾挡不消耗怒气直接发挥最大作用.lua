---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/苍云/90级奇穴/苍云_分山劲_盾挡不消耗怒气直接发挥最大作用.lua
-- 更新时间:	2015/10/15 9:50:19
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/苍云/90级奇穴/苍云_分山劲_盾挡不消耗怒气直接发挥最大作用.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(player.dwID, player.nLevel, 10088, 1)
end
...
function UnApply(dwCharacterID)
	...
	player.DelBuff(10088, 1)
	player.DelBuff(10087, 1)
	player.DelBuff(9887, 1)
end
