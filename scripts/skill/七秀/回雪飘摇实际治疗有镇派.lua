---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/回雪飘摇实际治疗有镇派.lua
-- 更新时间:	2013/6/2 2:07:19
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	...
	{nTherapy  = 668/3*0.95, 	nTherapyRand = 668/3*0.1,  nCostMana = 61 },
	{nTherapy  = 705/3*0.95, 	nTherapyRand = 705/3*0.1,  nCostMana = 88 },
	{nTherapy  = 742/3*0.95, 	nTherapyRand = 742/3*0.1,  nCostMana = 108},
	{nTherapy  = 779/3*0.95, 	nTherapyRand = 779/3*0.1,  nCostMana = 129},
	{nTherapy  = 816/3*0.95, 	nTherapyRand = 816/3*0.1,  nCostMana = 149},
	{nTherapy  = 853/3*0.95, 	nTherapyRand = 853/3*0.1,  nCostMana = 170},
	{nTherapy  = 890/3*0.95, 	nTherapyRand = 890/3*0.1,  nCostMana = 190},
	{nTherapy  = 927/3*0.95, 	nTherapyRand = 927/3*0.1,  nCostMana = 211},
	{nTherapy  = 964/3*0.95, 	nTherapyRand = 964/3*0.1,  nCostMana = 211},
	{nTherapy  = 1001/3*0.95, nTherapyRand = 1001/3*0.1, nCostMana = 211},
	{nTherapy  = 1038/3*0.95, nTherapyRand = 1038/3*0.1, nCostMana = 190},
	{nTherapy  = 1075/3*0.95, nTherapyRand = 1075/3*0.1, nCostMana = 211},
	{nTherapy  = 1112/3*0.95, nTherapyRand = 1112/3*0.1, nCostMana = 211},
	{nTherapy  = 1149/3*0.95, nTherapyRand = 1149/3*0.1, nCostMana = 211},
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapy/5,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand/5,
		0
	);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(6250, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	--skill.AddSlowCheckSelfBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求自身Buff
	--skill.AddSlowCheckDestBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);		-- 需求目标Buff
	--skill.AddSlowCheckSelfOwnBuff(dwBuffID, nStackNum, eCompareFlag, nLevel, eLevelCompareFlag);	-- 需求自身属于自己的Buff
	skill.AddSlowCheckDestOwnBuff(680, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	skill.AddSlowCheckDestOwnBuff(681, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
	...
	skill.nChannelInterval = 48 * 1.05*1.05; 				-- 通道技间隔时间
...
function CanCast(player, nPreResult)    --判断玩家的状态，以判断是否可以发出技能
	if player.GetSkillLevel(5887) == 1 then
		return nPreResult;
	else
		return false
	end
