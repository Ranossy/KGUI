---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/名动四方_去除剑舞.lua
-- 更新时间:	2013/5/1 12:02:12
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(1383, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff 自己已经有剑舞则不能释放名动四方
