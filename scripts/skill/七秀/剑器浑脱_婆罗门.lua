...
tSkillData =
{
	...
	{ nCostMana = 428 },		--level 7
	{ nCostMana = 428 },		--level 8
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
      skill.BindBuff(1, 673, dwSkillLevel)			-- 设置Buff 增加全属性 dwSkillLevel：注意与等级一致
	...
	skill.nCostManaBasePercent = 2342*0.5;	-- 技能消耗的内力力
    ----------------- 聚气相关 -------------------------------------------------
