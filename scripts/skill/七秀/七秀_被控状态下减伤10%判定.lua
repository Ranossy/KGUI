---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/七秀_被控状态下减伤10%判定.lua
-- 更新时间:	2015/9/15 13:02:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/七秀/七秀_被控状态下减伤10%判定.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.nMoveState ~= MOVE_STATE.ON_DEATH and player.bFightState == true and not player.GetBuff(9763, 1) then
		player.AddBuff(player.dwID, player.nLevel, 9763, 1)
	end
end
