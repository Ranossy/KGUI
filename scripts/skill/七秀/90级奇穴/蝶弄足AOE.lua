---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/90级奇穴/蝶弄足AOE.lua
-- 更新时间:	2013/5/31 16:48:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/七秀/90级奇穴/蝶弄足AOE.lua", -- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if IsPlayer(dwCharacterID) then
		player.CastSkill(13986, lv, TARGET.PLAYER, dwCharacterID)
		player.CastSkill(13987, lv, TARGET.PLAYER, dwCharacterID)
	else
		player.CastSkill(13986, lv, TARGET.NPC, dwCharacterID)
		player.CastSkill(13987, lv, TARGET.NPC, dwCharacterID)
	end
end
