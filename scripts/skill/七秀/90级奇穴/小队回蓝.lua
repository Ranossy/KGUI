---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/90级奇穴/小队回蓝.lua
-- 更新时间:	2013/5/31 10:54:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(6185, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	...
	if dwSkillLevel == 1 then
		skill.BindBuff(1, 6184, 1);		-- 设置1号位Buff
	else
		skill.BindBuff(1, 6423, 1);		-- 设置1号位Buff
	end
