---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/90级奇穴/王母AOE.lua
-- 更新时间:	2013/5/1 10:23:50
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(5794, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
	...
	if dwSkillLevel < 10 then
 	...
 	elseif dwSkillLevel < 28 then
  		skill.nChannelInterval = 32 + (dwSkillLevel - 9) * 1
  	else
  		skill.nChannelInterval =75;     -- 通道技间隔时间   
 	end
