---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/90级奇穴/左旋右转额外aoe.lua
-- 更新时间:	2013/5/11 13:41:49
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  七秀_霓裳羽衣_左旋右转.lua
-- 创建人    :  吴娟	
-- 创建时间  :  2008-08-26
-- 用途(模块):  武功技能
-- 武功门派  :  七秀
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.ACTIVE_THREAT_COEFFICIENT, -- 魔法属性
		0, -- 属性值1
		-306																-- 属性值2
	);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(676, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 691, 1)			-- 设置Buff  dwSkillLevel：注意与等级一致
	...
	--skill.nCostManaBasePercent = 0.5*(1+dwSkillLevel/7)*1293;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
