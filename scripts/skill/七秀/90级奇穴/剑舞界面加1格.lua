---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/90级奇穴/剑舞界面加1格.lua
-- 更新时间:	2013/5/1 12:12:00
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel == 1 then
		skill.AddSlowCheckSelfBuff(1383, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
		skill.AddSlowCheckSelfBuff(8528, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	elseif dwSkillLevel == 2 then
		skill.AddSlowCheckSelfBuff(1383, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
		skill.AddSlowCheckSelfBuff(8528, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	else
		skill.AddSlowCheckSelfBuff(1383, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
		skill.AddSlowCheckSelfBuff(8528, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求自身Buff
	end
