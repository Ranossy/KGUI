---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/回雪飘摇实际治疗2个.lua
-- 更新时间:	2013/6/2 19:36:41
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapy * 1.2/5,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand * 1.2/5,
		0
	);
	...
	skill.AddSlowCheckSelfBuff(6250, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);	
	...
	skill.nChannelInterval = 48 * 1.05*1.05 * 1.3; 				-- 通道技间隔时间
