---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/西河剑器_雷霆震怒.lua
-- 更新时间:	2015/9/15 18:51:03
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 682, dwSkillLevel);			-- 设置Buff
	...
	skill.SetNormalCoolDown(1, 117);			--自身CD，120秒
	...
	skill.nMaxRadius = tSkillData[dwSkillLevel].nMaxRadius * LENGTH_BASE;					-- 技能施放的最大距离
