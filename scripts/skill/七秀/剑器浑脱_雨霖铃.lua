...
tSkillData =
{
	{ nCostMana = 123 },		--level 1
	{ nCostMana = 169 },		--level 2
	{ nCostMana = 239 },		--level 3
	{ nCostMana = 290 },		--level 4
};
...
function GetSkillLevelData(skill)
 ...
 -- 		);
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 676, dwSkillLevel)			-- 设置Buff  dwSkillLevel：注意与等级一致
	...
	skill.nCostManaBasePercent = 1938;	-- 技能消耗的内力
    ----------------- 聚气相关 -------------------------------------------------
