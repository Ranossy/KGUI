---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/七秀_霓裳羽衣_王母挥袂_正常.lua
-- 更新时间:	2013/5/1 10:19:12
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
  		skill.nChannelInterval = 64*1.05;
 	elseif dwSkillLevel < 28 then
  		skill.nChannelInterval = (64 + (dwSkillLevel - 9) * 2)*1.05
  	else
  		skill.nChannelInterval =150*1.05;     -- 通道技间隔时间   
 	end
