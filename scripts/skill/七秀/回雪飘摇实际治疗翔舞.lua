---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/回雪飘摇实际治疗翔舞.lua
-- 更新时间:	2013/6/2 3:23:01
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapy * 1.1/5,
		0
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand * 1.1/5,
		0
	);
	...
	skill.AddSlowCheckDestOwnBuff(681, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	
	...
	skill.nChannelInterval = 48 * 1.05 * 1.15*1.05; 				-- 通道技间隔时间
