...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
    skill.BindBuff(1, 680, dwSkillLevel);			-- 设置Buff
	...
	if dwSkillLevel <= 6 then
		skill.nCostManaBasePercent = 458*0.8*0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 458*0.8 * 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 18 then
		skill.nCostManaBasePercent = 458*0.8*0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 24 then
		skill.nCostManaBasePercent = 458*0.8*0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 458*0.8;	-- 技能消耗的内力
	end
    ----------------- 聚气相关 -------------------------------------------------
