---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/镇派/玳弦急曲额外伤害.lua
-- 更新时间:	2013/12/3 10:06:47
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID)
	...
	player.AddBuff(dwCharacterID, player.nLevel, 7248, 1, 1)
end
