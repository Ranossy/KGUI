---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/镇派/七秀_玲珑刷新上元.lua
-- 更新时间:	2014/7/1 20:31:47
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/七秀/镇派/七秀_玲珑刷新上元.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if IsPlayer(dwCharacterID) then
		player.CastSkill(9322, nlev, TARGET.PLAYER, target.dwID) 
		player.CastSkill(9323, nlev, TARGET.PLAYER, target.dwID)
	else
		player.CastSkill(9322, nlev, TARGET.NPC, target.dwID)
		player.CastSkill(9323, nlev, TARGET.NPC, target.dwID)
	end
end
