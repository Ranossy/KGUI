...
tSkillData = 
{
	{nDamageBase = 346, nDamageRand = 0, nCostMana = 0}, --level 1
	{nDamageBase = 400, nDamageRand = 0, nCostMana = 0}, --level 2
	{nDamageBase = 460, nDamageRand = 0, nCostMana = 0}, --level 3
	{nDamageBase = 520, nDamageRand = 0, nCostMana = 0}, --level 4
	{nDamageBase = 580, nDamageRand = 0, nCostMana = 0}, --level 5
	{nDamageBase = 640, nDamageRand = 0, nCostMana = 0}, --level 6
