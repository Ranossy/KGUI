...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(3830, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff   
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 3830, dwSkillLevel);		-- 设置1号位Buff
