---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/镇派/低气血闪避.lua
-- 更新时间:	2013/5/31 10:56:40
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{ nEventHandleID1 = 259, nEventHandleID2 = 486}, 
	{ nEventHandleID1 = 485, nEventHandleID2 = 487}, 
};
...
function GetSkillLevelData(skill)
	...
	--tSkillData[dwSkillLevel].nEventHandleID1,														
	--0
	--);
