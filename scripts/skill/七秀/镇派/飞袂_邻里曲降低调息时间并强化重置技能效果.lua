---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/镇派/飞袂_邻里曲降低调息时间并强化重置技能效果.lua
-- 更新时间:	2015/9/16 16:04:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/七秀/镇派/飞袂_邻里曲降低调息时间并强化重置技能效果.lua", -- 属性值1
		0											-- 属性值2
		);
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function UnApply(dwCharacterID)
	...
	--player.DelBuff(9779, 1)
	--player.DelBuff(9780,1)
end
