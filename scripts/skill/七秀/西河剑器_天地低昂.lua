---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/西河剑器_天地低昂.lua
-- 更新时间:	2013/8/19 15:22:03
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 684, 1);			-- 设置Buff 减伤30%
	--skill.BindBuff(2, 775, 1);		-- 设置Debuff
	...
	skill.SetNormalCoolDown(1, 119);				--自身CD，60秒
	...
	skill.nCostManaBasePercent = 286;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.IsSkillRecipeActive(187, 1) then
		player.AddBuff(player.dwID, player.nLevel, 684, 1, 13)		--天地减伤
		player.AddBuff(player.dwID, player.nLevel, 775, 1, 8)		--降低威胁
	else
