...
tSkillData =
{
	...
	{nCostMana =61 },		--level 2
	{nCostMana =78 },		--level 3
	{nCostMana =95 },		--level 4
	{nCostMana =112},		--level 5
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
 	skill.BindBuff(1, 683, dwSkillLevel)			-- 设置Buff 增加阴性内伤效果30%
    ...
    skill.SetNormalCoolDown(1, 115); 					    -- 自身CD 5分钟
