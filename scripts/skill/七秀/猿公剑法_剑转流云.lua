---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/猿公剑法_剑转流云.lua
-- 更新时间:	2013/5/30 21:29:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  七秀_猿公剑法_剑转流云.lua
-- 创建人    :  吴娟	
-- 创建时间  :  2008-08-25
-- 用途(模块):  武功技能
-- 武功门派  :  七秀
...
-- 武功套路  :  猿公剑法
-- 技能名称  :  剑转流云
-- 技能效果  :  1级驱散掉对方1个阴性内功气劲，需要剑舞状态，2级驱散三种内功各一个
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	--skill.SetNormalCoolDown(2, 58);  --58号CD3分钟
	...
	skill.nCostManaBasePercent = 640;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
