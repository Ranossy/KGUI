---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/剑器浑脱_鹊踏枝.lua
-- 更新时间:	2016/5/11 21:00:31
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 677, dwSkillLevel)			-- 设置Buff  dwSkillLevel：注意与等级一致
	--skill.BindBuff(2, 2847, dwSkillLevel);		-- 设置Debuff
	...
	skill.SetNormalCoolDown(1, 114);						--自身CD2分钟
	...
	skill.nCostManaBasePercent = 219;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
