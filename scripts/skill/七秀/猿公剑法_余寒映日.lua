---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/猿公剑法_余寒映日.lua
-- 更新时间:	2015/9/26 23:24:35
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
tSkillData =
{
	{nDamageBase = 90, nDamageRand = 10, nCostMana = 0}, --level 1
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 10121, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 962);	--技能普通CD
