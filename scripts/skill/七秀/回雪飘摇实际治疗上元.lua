---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/七秀/回雪飘摇实际治疗上元.lua
-- 更新时间:	2013/6/2 2:17:02
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckDestOwnBuff(680, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
	...
	skill.nChannelInterval = 48 * 1.05*1.05 * 1.15; 				-- 通道技间隔时间
