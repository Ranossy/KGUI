---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/无名魂锁被打解除状态后眩晕2秒.lua
-- 更新时间:	2015/9/21 11:39:40
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function OnRemove(nCharacterID, BuffID, nBuffLevel, nLeftFrame, nCustomValue, dwSkillSrcID, nStackNum, nBuffIndex, dwCasterID, dwCasterSkillID)
	...
	--[[
	if player.GetSkillLevel(14819) == 1 and nLeftFrame ~= 0 then
		target.AddBuff(player.dwID, player.nLevel, 9856, 1)
	end
	--]]
end
