---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_返回记录的日值.lua
-- 更新时间:	2015/9/21 14:50:53
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--print("sun>>>>>>>>>>")
	if nbuff_sun then
		player.nCurrentSunEnergy = player.nCurrentSunEnergy + nbuff_sun.nCustomValue
