...
--明教场景隐身删除
		...
		skill.AddAttribute(
   		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,			--5秒惩罚CD用			
   		ATTRIBUTE_TYPE.CALL_BUFF,						
   		4913,																
   		1																	
		);
   	skill.AddAttribute(
   		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,				--仇恨
   		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,								
   		"skill/明教/明教_暗尘弥散_显形.lua",				
   		0														
   		);
