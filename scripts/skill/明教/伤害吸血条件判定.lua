---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/伤害吸血条件判定.lua
-- 更新时间:	2016/6/21 20:43:46
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not player.GetBuff(7913, 1) and player.dwShapeShiftID == 0 then
		if not player.GetBuff(10869, 1) then
			player.AddBuff(player.dwID, player.nLevel, 10869, 1)
		end
	else
