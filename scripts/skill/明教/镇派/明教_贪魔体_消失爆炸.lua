---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/镇派/明教_贪魔体_消失爆炸.lua
-- 更新时间:	2013/5/8 19:58:29
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4875, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.nChannelInterval = 50 * dwSkillLevel; 				-- 通道技间隔时间 
