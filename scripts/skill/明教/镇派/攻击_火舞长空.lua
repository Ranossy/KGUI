...
tSkillData =
{
	{nValue1 = 50,   nValue2 = 150},		--level 1
	{nValue1 = 100, nValue2 = 300},		--level 2
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
      	 	...
      	 	ATTRIBUTE_TYPE.SOLAR_CRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE,				
 	...
 	skill.AddAttribute(
      	 	ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, 
      	 	ATTRIBUTE_TYPE.LUNAR_CRITICAL_DAMAGE_POWER_BASE_KILONUM_RATE,				
		tSkillData[dwSkillLevel].nValue1,
      		0
		);
