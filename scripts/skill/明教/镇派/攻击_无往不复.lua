---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/镇派/攻击_无往不复.lua
-- 更新时间:	2013/4/26 20:27:41
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, --会心后加月能
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK, --会心后加日能
		ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER,
		728 + dwSkillLevel,
		0
	);
