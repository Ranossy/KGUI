---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_渡厄力.lua
-- 更新时间:	2013/4/27 10:58:43
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/90级奇穴/渡厄力奇穴增强.lua", -- 属性值1
		0														-- 属性值2
	);
   	--标记连击通用
	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4244, 4);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 526);	--技能普通CD
