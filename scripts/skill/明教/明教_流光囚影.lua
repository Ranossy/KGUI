---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_流光囚影.lua
-- 更新时间:	2013/4/26 21:32:53
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/明教_流光囚影.lua",
		0														
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --队友	
	...
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, --敌人	
		ATTRIBUTE_TYPE.CAST_SKILL_TARGET_DST,
		4229,
		1														
	);
	...
	--skill.SetCheckCoolDown(2, 519);	--后跳公共CD
	----------------- 经验升级相关 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	--流光后自身减伤20%
	if player.GetSkillLevel(5983) == 1 then
		player.AddBuff(dwCharacterID, player.nLevel, 5746, 1, 1)
	end
