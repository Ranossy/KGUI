---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_幽月轮_第三下.lua
-- 更新时间:	2013/6/4 2:23:08
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
--增加武器伤害 
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 40*1.2;
	elseif dwSkillLevel < 24 then
		skill.nChannelInterval =(40 + (dwSkillLevel - 9) * 3)*1.2
	else
		skill.nChannelInterval =80*1.2;     -- 通道技间隔时间   
	end
