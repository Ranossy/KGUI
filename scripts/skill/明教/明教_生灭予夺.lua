---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_生灭予夺.lua
-- 更新时间:	2013/6/4 5:46:20
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/生灭重置贪魔体.lua",
		0														
	);
	skill.AddAttribute(
		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK,
		ATTRIBUTE_TYPE.EXECUTE_SCRIPT,
		"skill/明教/明教_生灭予夺.lua",
		0														
	);
	skill.AddAttribute(
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4056, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 520);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	ModityCDToUI(player, 3978, 0, 0)
	ModityCDToUI(player, 3974, 0, 0)
	ModityCDToUI(player, 3975, 0, 0)
...
function UnApply(dwCharacterID)
	...
	player.DelBuff(4725, 1) --特效buff
	player.DelBuff(4726, 1) --特效buff
end
