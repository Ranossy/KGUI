---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/90级奇穴/朝圣言减cd.lua
-- 更新时间:	2016/5/12 23:09:06
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/90级奇穴/朝圣言减cd.lua",
		0
	);

	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(5749, 30, BUFF_COMPARE_FLAG.LESS, 2, BUFF_COMPARE_FLAG.LESS);		-- 需求自身Buff
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 5749, 1);		-- 设置1号位Buff
...
function Apply(dwCharacterID)
	...
	player.SetTimer(1, "scripts/skill/明教/90级奇穴/朝圣言减cd.lua", 0, 0)
end
