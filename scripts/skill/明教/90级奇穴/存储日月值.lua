---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/90级奇穴/存储日月值.lua
-- 更新时间:	2015/9/21 13:37:26
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/明教/90级奇穴/存储日月值.lua",											-- 属性值1
   		0											-- 属性值2
		);
	--记录日月值
   	skill.AddAttribute(
   		ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,					-- 属性作用模式
   		ATTRIBUTE_TYPE.SKILL_EVENT_HANDLER,								-- 魔法属性
   		1317,											-- 属性值1
   		0											-- 属性值2
		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(player.dwID, player.nLevel, 9858, 1)		--存储日能量
	player.AddBuff(player.dwID, player.nLevel, 9859, 1)		--存储月能量
end
...
function UnApply(dwCharacterID)
	...
	player.DelBuff(9858, 1)
	player.DelBuff(9859, 1) 
end
