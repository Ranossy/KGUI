---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/90级奇穴/明教贪魔体实际回血效果.lua
-- 更新时间:	2014/6/26 21:36:42
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/90级奇穴/明教贪魔体实际回血效果.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if not nplayer.GetBuff(7965,1) then
		if nplayer.nCurrentLife >= nplayer.nMaxLife * 0.9 then
			nplayer.nCurrentLife = nplayer.nMaxLife
		else
			nplayer.nCurrentLife = nplayer.nCurrentLife + nplayer.nMaxLife * 0.1
		end
		nplayer.AddBuff(0,99,7965,1)
	end
end
