---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/90级奇穴/15%吸血.lua
-- 更新时间:	2016/6/21 20:12:51
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	print(3333)
	player.AddBuff(player.dwID, player.nLevel, 10868, 1)
end
...
function UnApply(dwCharacterID, dwSkillSrcID)
	...
	player.DelBuff(10868, 1)
	player.DelBuff(10869, 1)
end
