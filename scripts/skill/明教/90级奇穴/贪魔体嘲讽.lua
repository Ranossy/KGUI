---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/90级奇穴/贪魔体嘲讽.lua
-- 更新时间:	2013/4/27 15:00:33
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nLunarDamage = 150 * 2 * 0.98, nLunarDamageRand = 150 * 2 * 0.04, nCostMana = 30 }, 
	{nLunarDamage = 301 * 2 * 0.98, nLunarDamageRand = 301 * 2 * 0.04, nCostMana = 50 }, 
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 5753, dwSkillLevel);		-- 设置1号位Buff
...
function UnApply(dwCharacterID)
	...
	local level = player.GetSkillLevel(3991)
	if level then
		player.CastSkill(4067, level)
		player.CastSkill(6180, level)
	end	
end
