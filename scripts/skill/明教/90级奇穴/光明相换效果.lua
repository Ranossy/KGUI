...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/90级奇穴/光明相换效果.lua",				-- 属性值1
		0														-- 属性值2
	);
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(3969) == 1 and player.GetSkillLevel(6767) == 0 then
		player.ForgetSkill(3969)
		player.LearnSkillLevel(6767, 1, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 3969, 6767, 1)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(3969) == 0 and player.GetSkillLevel(6767) == 1 then
		player.ForgetSkill(6767)
		player.LearnSkillLevel(3969, 1, dwCharacterID)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 6767, 3969, 1)
	end	
end
