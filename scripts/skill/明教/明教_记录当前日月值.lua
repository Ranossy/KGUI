---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_记录当前日月值.lua
-- 更新时间:	2015/9/21 14:42:45
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nbuff_sun = player.GetBuff(9858, 1)
	local nbuff_moon = player.GetBuff(9859, 1)
	--print("--------------------------")
	if nbuff_sun then
		if player.nCurrentSunEnergy ~= 0 and player.nCurrentSunEnergy ~= 10000 then
			nbuff_sun.nCustomValue = player.nCurrentSunEnergy
			--print("sun="..player.nCurrentSunEnergy.." sunbuff="..nbuff_sun.nCustomValue)
		end
	end

	if nbuff_moon then
		if player.nCurrentMoonEnergy ~= 0 and player.nCurrentMoonEnergy ~= 10000 then
			nbuff_moon.nCustomValue = player.nCurrentMoonEnergy
			--print("moon="..player.nCurrentMoonEnergy.." moonbuff="..nbuff_moon.nCustomValue)
		end
	end
end
