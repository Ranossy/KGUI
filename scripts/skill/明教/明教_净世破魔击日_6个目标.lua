...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 38*1.15;
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval =(38 + (dwSkillLevel - 9) * 2.4)*1.15
	else
		skill.nChannelInterval =106*1.15;     -- 通道技间隔时间   
	end
	
	--skill.nChannelInterval	=132; 				-- 通道技间隔时间 
