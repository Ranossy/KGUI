...
tSkillData =
{
	{nDamageBase = 20, nDamageRand = 5, nCostMana = 0}, 		--level 5
	{nDamageBase = 132 * 0.95, nDamageRand = 114 * 0.1, nCostMana = 0},		--level 2
	{nDamageBase = 198 * 0.95, nDamageRand = 166 * 0.1, nCostMana = 0},		--level 3
	{nDamageBase = 304 * 0.95, nDamageRand = 238 * 0.1, nCostMana = 0},		--level 4
	{nDamageBase = 412 * 0.95, nDamageRand = 312 * 0.1, nCostMana = 0}, 		--level 5
};
...
function GetSkillLevelData(skill)
    ...
    skill.AddAttribute(
        ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, 		--每击中一个人加一次能量
...
--增加武器伤害 
	...
	----------------- BUFF相关 -------------------------------------------------
    --skill.BindBuff(1, 4413, dwSkillLevel);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 506);	--技能普通CD
    ...
    skill.nChannelFrame		= 120;	 			-- 通道技持续时间，单位帧数 
