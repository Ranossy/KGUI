---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_银月斩dot伤害技能.lua
-- 更新时间:	2016/9/20 22:44:54
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/明教/明教_银月斩dot伤害技能.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 40 * 1.1 * 1.1 * 1.2;
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval = (40 + (dwSkillLevel - 9) * 4) * 1.1 * 1.1 * 1.2
	else
		skill.nChannelInterval = 128 * 1.1 * 1.1 * 1.2;     -- 通道技间隔时间
	end
	----------------- 阵法相关 -------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(16851) == 1 then
		target.AddBuff(player.dwID, player.nLevel, 4054, 3)
	end
end
