---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_赤日轮_第二下眩晕目标.lua
-- 更新时间:	2015/2/4 14:40:09
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 25 * 1.2 * 1.15;
	elseif dwSkillLevel < 33 then
		skill.nChannelInterval = (25 + (dwSkillLevel - 9) * 1.5) * 1.2 * 1.15
	else
