---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_赤日轮_第一下眩晕目标.lua
-- 更新时间:	2015/2/4 14:40:27
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddSlowCheckSelfBuff(4025, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	----------------- 设置技能消耗 ---------------------------------------------------------------------
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 26 * 1.2 * 1.15;
	elseif dwSkillLevel < 33 then
		skill.nChannelInterval = (26 + (dwSkillLevel - 9) * 1.5) * 1.2 * 1.15
	else
		skill.nChannelInterval = 77 * 1.2 * 1.15;     -- 通道技间隔时间
	end
...
function Apply(dwCharacterID)
	...
	RemoteCallToClient(player.dwID, "ChangeSkillSurfaceNum", 3962, 2)
end
