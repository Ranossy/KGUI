---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_驱夜断愁_背后1.lua
-- 更新时间:	2013/4/26 21:17:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
--增加武器伤害 
	...
	--skill.AddSlowCheckSelfBuff(5269, 1, BUFF_COMPARE_FLAG.EQUAL, 1, BUFF_COMPARE_FLAG.EQUAL);		-- 需求目标Buff
	...
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval =120 + (dwSkillLevel - 9) * 5
	else
