...
--增加武器伤害 
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 4418, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 508);	--技能普通CD
	...
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval =(64 + (dwSkillLevel - 9) * 3)*1.1
	else
		skill.nChannelInterval =141*1.1;     -- 通道技间隔时间   
	end
