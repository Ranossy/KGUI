---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_归寂道.lua
-- 更新时间:	2015/9/14 19:12:03
-- 更新用户:	mengxiangfei11
-- 脚本说明:
--------------脚本文件开始------------------------------------------------
...
tSkillData =
{
	{nDamage = 4 * 0.95, nDamageRand = 4 * 0.1, nThreat = 1268, nCostMana = 12}, --level 1
	{nDamage = 4 * 0.95, nDamageRand = 4 * 0.1, nThreat = 1501, nCostMana = 12}, --level 1
	{nDamage = 4 * 0.95, nDamageRand = 4 * 0.1, nThreat = 1983, nCostMana = 12}, --level 1
	{nDamage = 4 * 0.95, nDamageRand = 4 * 0.1, nThreat = 2584, nCostMana = 12}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 4428, 1);		-- 减速
	--skill.BindBuff(2, 4429, dwSkillLevel);		-- 减攻击
	...
	skill.SetNormalCoolDown(1, 513);	--技能普通CD
...
function OnSkillLevelUp(skill, player)
	if skill.dwLevel == skill.dwMaxLevel then
		player.AcquireAchievement(3290)
	end
end
