---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_暗尘弥散_战斗状态添加免控.lua
-- 更新时间:	2015/9/14 23:28:58
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	--奇穴延长2秒持续时间
	if player.GetSkillLevel(14694) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 4052, 2, 7)
	else
		player.AddBuff(player.dwID, player.nLevel, 4052, 2, 5)
	end
end
