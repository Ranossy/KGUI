---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_极乐引.lua
-- 更新时间:	2013/4/27 14:40:08
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.SetNormalCoolDown(1, 523);	--技能普通CD
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	if player.GetSkillLevel(6011) == 1 then
		player.AddBuff(dwCharacterID, player.nLevel, 5752, 1, 1)
	end

	ModityCDToUI(player, 3971, 0, 0)
end
