...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 51*1.15;
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval =(51 + (dwSkillLevel - 9) * 2.4)*1.15
	else
		skill.nChannelInterval =117*1.15;     -- 通道技间隔时间   
	end
	
	--skill.nChannelInterval	=146; 				-- 通道技间隔时间 
