---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/明教/明教_幽月轮_第一下眩晕目标.lua
-- 更新时间:	2015/2/4 14:40:49
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
--增加武器伤害
	...
	skill.AddSlowCheckSelfBuff(4019, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	----------------- 设置技能消耗 ---------------------------------------------------------------------
	...
	elseif dwSkillLevel < 24 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 2) * 1.2 * 1.15
	else
		skill.nChannelInterval = 70 * 1.2 * 1.15;     -- 通道技间隔时间
	end
...
function Apply(dwCharacterID)
	...
	RemoteCallToClient(player.dwID, "ChangeSkillSurfaceNum", 3959, 2)
end
