...
function GetSkillLevelData(skill)
	...
	--skill.AddAttribute(
	--ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_NOT_ROLLBACK, 		--计数
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 77*1.15;
	elseif dwSkillLevel < 32 then
		skill.nChannelInterval =(77 + (dwSkillLevel - 9) * 2.4)*1.15
	else
		skill.nChannelInterval =139*1.15;     -- 通道技间隔时间   
	end
	
	--skill.nChannelInterval	=174; 				-- 通道技间隔时间 
