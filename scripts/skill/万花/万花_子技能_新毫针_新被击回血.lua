---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_子技能_新毫针_新被击回血.lua
-- 更新时间:	2015/9/13 13:48:54
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/万花_子技能_新毫针_新被击回血.lua", -- 属性值1
		0														-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckSelfBuff(9724, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
