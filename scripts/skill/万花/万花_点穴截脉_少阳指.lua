---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_点穴截脉_少阳指.lua
-- 更新时间:	2013/5/7 19:27:55
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{ nDamageBase = 35, nDamageRand = 5, nCostMana = 82}, --level 1
	{ nDamageBase = 40, nDamageRand = 5, nCostMana = 206}, --level 2
	{ nDamageBase = 45, nDamageRand = 5, nCostMana = 320}, --level 3
};
