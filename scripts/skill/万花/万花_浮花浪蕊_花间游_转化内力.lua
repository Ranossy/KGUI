...
tSkillData =
{
	{ nCutMana = 257 }, -- Level 1
	{ nCutMana = 300 }, -- Level 2
	{ nCutMana = 343 }, -- Level 3
};
...
function GetSkillLevelData(skill)
    ...
    local dwSkillLevel = skill.dwLevel;
   	...
   	----------------- 魔法属性 -------------------------------------------------
		...
		--]]
   		...
   		ATTRIBUTE_TYPE.CURRENT_MANA,									-- 魔法属性
   		tSkillData[dwSkillLevel].nCutMana * 0.4,								-- 属性值1
   		0																-- 属性值2
   		);
	...
	--skill.BindBuff(2, 585, 1);							-- 设置Debuff
	--skill.BindBuff(1, 687, 1);				-- 设置Dot
