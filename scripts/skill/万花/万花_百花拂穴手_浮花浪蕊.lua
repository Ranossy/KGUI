---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_百花拂穴手_浮花浪蕊.lua
-- 更新时间:	2014/10/30 17:38:30
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  万花_百花拂穴手_浮花浪蕊.lua
-- 创建人    :  南剑
-- 创建时间  :  2008-8-12
-- 用途(模块):  武功技能
-- 武功门派  :  万花
...
-- 武功套路  :  百花拂穴手
-- 技能名称  :  浮花浪蕊
-- 技能效果  :  减少对方内力，并附带中性内伤造成内力消耗增加,在花间游内功下转化内力的效果。
------------------------------------------------
...
--[[	skill.AddAttribute(
	...
	--skill.BindBuff(1, 687, 1);		-- 设置Debuff
