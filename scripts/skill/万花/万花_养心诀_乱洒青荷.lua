---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_养心诀_乱洒青荷.lua
-- 更新时间:	2013/4/24 11:28:55
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 320 * 0.8, nDamageRand = 320 * 0.4, nCostMana = 0}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	skill.BindBuff(1, 2719, 1);		-- 设置1号位Buff
	--skill.BindBuff(2, 2726, 1);		-- 设置2号位Buff
	...
	skill.SetNormalCoolDown(1, 428);	--技能普通CD
