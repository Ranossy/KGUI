---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/商阳指溅射.lua
-- 更新时间:	2013/4/24 11:09:44
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/90级奇穴/商阳指溅射.lua",
		0
	);	
    
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(5695, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(180)
	if IsPlayer(dwCharacterID) then
		player.CastSkill(6140, lv, TARGET.PLAYER, dwCharacterID)
	else
		player.CastSkill(6140, lv, TARGET.NPC, dwCharacterID)
	end
end
