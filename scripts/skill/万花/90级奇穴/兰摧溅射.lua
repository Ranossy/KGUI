---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/兰摧溅射.lua
-- 更新时间:	2013/4/24 10:57:25
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(190)
	if IsPlayer(dwCharacterID) then
		player.CastSkill(6142, lv, TARGET.PLAYER, dwCharacterID)
	else
		player.CastSkill(6142, lv, TARGET.NPC, dwCharacterID)
	end
end
