---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/刷新商阳指.lua
-- 更新时间:	2013/4/24 10:15:51
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
--增加额外内功AP加成2倍
	...
	----------------- 魔法属性 -------------------------------------------------
	skill.BindBuff(1, 666, skill.dwLevel);
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(666, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);
	...
	--skill.nCostManaBasePercent = 0.5*(1+dwSkillLevel/12)*148;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
