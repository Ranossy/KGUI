---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/钟林溅射.lua
-- 更新时间:	2013/4/24 10:55:34
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local lv = player.GetSkillLevel(189)
	if IsPlayer(dwCharacterID) then
		player.CastSkill(6141, lv, TARGET.PLAYER, dwCharacterID)
	else
		player.CastSkill(6141, lv, TARGET.NPC, dwCharacterID)
	end
end
