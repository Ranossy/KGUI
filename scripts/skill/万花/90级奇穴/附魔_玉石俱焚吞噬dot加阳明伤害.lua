---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/附魔_玉石俱焚吞噬dot加阳明伤害.lua
-- 更新时间:	2014/7/18 22:44:25
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/90级奇穴/附魔_玉石俱焚吞噬dot加阳明伤害.lua", -- 属性值1
		0											-- 属性值2
	);
