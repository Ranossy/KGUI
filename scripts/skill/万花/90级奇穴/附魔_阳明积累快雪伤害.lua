---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/附魔_阳明积累快雪伤害.lua
-- 更新时间:	2014/7/17 22:21:31
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/90级奇穴/附魔_阳明积累快雪伤害.lua", -- 属性值1
		0											-- 属性值2
	);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.AddBuff(0, 99, 8186, 1)
	local nbuff = player.GetBuff(8186,1)
	if nbuff then
		nbuff.nCustomValue = 3
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(9464) == 1 then
		player.ForgetSkill(9464)
	end
	if player.GetSkillLevel(9465) ~= 0 then
		player.ForgetSkill(9465)
	end

	if player.GetSkillLevel(9466) ~= 0 then
		player.ForgetSkill(9466)
	end

	if player.GetBuff(8186, 1) then
