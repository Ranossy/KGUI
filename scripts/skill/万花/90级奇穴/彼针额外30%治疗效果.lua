...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyBase/3*0.35, --属性值1
		0							--属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand/3*0.35, --属性值1
		0							--属性值2
	);
	...
	if dwSkillLevel < 15 then
		...
		skill.nChannelInterval = 82*0.3;     -- 通道技间隔时间   
	end
