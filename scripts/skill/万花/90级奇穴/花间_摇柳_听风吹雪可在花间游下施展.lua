---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/花间_摇柳_听风吹雪可在花间游下施展.lua
-- 更新时间:	2015/9/13 11:52:41
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		"skill/万花/90级奇穴/花间_摇柳_听风吹雪可在花间游下施展.lua",											-- 属性值1
   		0											-- 属性值2
   		);
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.LearnSkillLevel(14639, 1, player.dwID)
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(14639) ~= 0 then
		player.ForgetSkill(14639)
	end
end
