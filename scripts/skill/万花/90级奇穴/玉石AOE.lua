---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/90级奇穴/玉石AOE.lua
-- 更新时间:	2013/4/23 21:24:44
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	----------------- 技能施放Buff需求 ---------------------------------------------
	skill.AddSlowCheckDestOwnBuff(5691, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);
	...
	skill.nTargetCountLimit = 4 + dwSkillLevel * 2;				-- 技能作用目标数量限制,(小于0 代表目标数量不限制) 
	...
	elseif dwSkillLevel == 2 then
		...
		skill.nChannelInterval =210;     -- 通道技间隔时间   
	end
	
	--skill.nChannelInterval = 70 * dwSkillLevel; 				-- 通道技间隔时间 
