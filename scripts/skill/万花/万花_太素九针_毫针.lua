---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_太素九针_毫针.lua
-- 更新时间:	2016/5/11 18:44:41
-- 更新用户:	XIAXIANBO
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
-- 武功套路  :  太素九针
-- 技能名称  :  毫针
-- 技能效果  :  友方下次受伤害时恢复血量；并增强外功防御，持续12秒
------------------------------------------------
...
tSkillData =
{
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 341},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 421},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 501},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 582},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 662},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 327},
	{ nDamageBase = 0, nDamageRand = 0, nCostMana = 327},
};
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		ATTRIBUTE_TYPE.CALL_BUFF_STACK_4, -- 魔法属性
		126, -- 属性值1
		dwSkillLevel											--属性值2
	);
	...
	skill.nCostManaBasePercent = 423;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
