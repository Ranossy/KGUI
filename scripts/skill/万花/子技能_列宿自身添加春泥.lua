---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/子技能_列宿自身添加春泥.lua
-- 更新时间:	2017/4/19 11:43:14
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	player.SetTimer(1, "scripts/skill/万花/子技能_列宿自身添加春泥.lua", 0, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	if lv ~= 0 then
		player.AddBuff(player.dwID, player.nLevel, 11920, lv)
	end
end
