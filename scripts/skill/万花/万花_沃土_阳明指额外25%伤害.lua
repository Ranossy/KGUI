...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 0.35 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 0.35 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	--]]
	skill.nChannelInterval = (130*1.25 + 24) * 0.15;     -- 通道技间隔时间
	--skill.nChannelInterval = 130; 				-- 通道技间隔时间
