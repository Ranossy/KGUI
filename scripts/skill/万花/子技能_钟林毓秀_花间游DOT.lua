...
tSkillData =
{
	{ nDotID = 674, nDotLevel = 1 },		-- Level 1
	{ nDotID = 674, nDotLevel = 2 },		-- Level 2
	{ nDotID = 674, nDotLevel = 3 },		-- Level 3
	{ nDotID = 674, nDotLevel = 4 },		-- Level 4
	{ nDotID = 674, nDotLevel = 5 },		-- Level 5
	{ nDotID = 674, nDotLevel = 6 },		-- Level 6
...
--增加额外内功AP加成3倍
   	skill.AddAttribute(
   		...
   		ATTRIBUTE_TYPE.NEUTRAL_ATTACK_POWER_PERCNET,								-- 魔法属性
   		6800,							-- 属性值1
   		0																-- 属性值2
   		);
   	----------------- 魔法属性 -------------------------------------------------
    ...
    skill.nChannelInterval	= 175; 				-- 通道技间隔时间 
