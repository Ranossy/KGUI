---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/子技能_太素九针_长针_正常.lua
-- 更新时间:	2017/3/16 10:26:40
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyBase / 4, --属性值1
		0																--属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nTherapyRand / 4, --属性值1
		0																--属性值2
	);
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 80 * 1.1;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (80 + (dwSkillLevel - 9) * 7) * 1.1
	else
		skill.nChannelInterval = 230 * 1.1;     -- 通道技间隔时间
	end

	--skill.nChannelInterval = 230; 				-- 通道技间隔时间
