---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_提针额外治疗自身实际效果.lua
-- 更新时间:	2017/3/16 10:54:02
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 64 * 0.25 * 1.1;
	elseif dwSkillLevel < 28 then
		skill.nChannelInterval = (64 + (dwSkillLevel - 9) * 4) * 0.25 * 1.1
	else
		skill.nChannelInterval = 143 * 0.25 * 1.1;     -- 通道技间隔时间
	end
