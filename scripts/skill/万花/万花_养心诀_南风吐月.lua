---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_养心诀_南风吐月.lua
-- 更新时间:	2016/11/3 16:05:29
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- BUFF相关 -------------------------------------------------
	--skill.BindBuff(1, 9934, 1);		-- 设置1号位Buff
	...
	skill.SetNormalCoolDown(1, 968);	--技能普通CD
...
function Apply(dwCharacterID)
	...
	--停止移动状态，避免南风定身效果受击倒影响
	player.Stop()
	player.AddBuff(player.dwID, player.nLevel, 11495, 1)
	player.SetTimer(9, "scripts/skill/万花/万花_养心诀_南风吐月.lua", 0, 0)


	ModityCDToUI(player, 14965, 0, 0)
end
...
function OnTimer(player, nParam1, nParam2)
	...
	player.DelGroupBuff(11495, 1)
	player.Stop()
	player.AddBuff(player.dwID, player.nLevel, 9934, 1)
end
