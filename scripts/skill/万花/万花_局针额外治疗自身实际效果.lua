---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_局针额外治疗自身实际效果.lua
-- 更新时间:	2017/3/16 10:54:26
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 48 * 0.25;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (48 + (dwSkillLevel - 9) * 1) * 0.25 * 1.1
	else
		skill.nChannelInterval = 80 * 0.25;     -- 通道技间隔时间
	end
