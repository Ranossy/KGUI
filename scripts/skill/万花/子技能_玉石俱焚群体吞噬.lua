---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/子技能_玉石俱焚群体吞噬.lua
-- 更新时间:	2015/9/13 16:25:45
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function GetSkillLevelData(skill)
	...
	----------------- 魔法属性 -------------------------------------------------
   	skill.AddAttribute(
   		...
   		ATTRIBUTE_TYPE.CONSUME_BUFF,								-- 魔法属性
   		666,											-- 属性值1
   		0											-- 属性值2
		);
   	skill.AddAttribute(
	...
	--skill.AddSlowCheckDestOwnBuff(9729, 0, BUFF_COMPARE_FLAG.EQUAL, 0, BUFF_COMPARE_FLAG.EQUAL);	-- 需求目标属于自己的Buff
