...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel <= 4 then
		skill.nCostManaBasePercent = 356*0.85 * 0.2;	-- 技能消耗的内力
	elseif dwSkillLevel <= 8 then
		skill.nCostManaBasePercent = 356 *0.85* 0.4;	-- 技能消耗的内力
	elseif dwSkillLevel <= 12 then
		skill.nCostManaBasePercent = 356 *0.85* 0.6;	-- 技能消耗的内力
	elseif dwSkillLevel <= 16 then
		skill.nCostManaBasePercent = 356 *0.85* 0.8;	-- 技能消耗的内力
	else
		skill.nCostManaBasePercent = 356*0.85;	-- 技能消耗的内力
	end
	----------------- 聚气相关 -------------------------------------------------
	...
	elseif dwSkillLevel < 19 then
		skill.nChannelInterval = (48 + (dwSkillLevel - 9) * 9)*0.9*1.25*1.15
	else
		skill.nChannelInterval = 155*0.9*1.25*1.15;     -- 通道技间隔时间   
	end
