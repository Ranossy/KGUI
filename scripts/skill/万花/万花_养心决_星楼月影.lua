---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_养心决_星楼月影.lua
-- 更新时间:	2013/6/3 17:34:19
-- 更新用户:	taoli
-- 脚本说明:	
----------------------------------------------------------------------<
------------------------------------------------
...
-- 武功套路  :  养心决
-- 技能名称  :  星楼月影
-- 技能效果  :  使自己在10秒内不受物理控制技能影响，并解除全部控制
------------------------------------------------
...
tSkillData = 
{
	{nDamageBase = 0, nDamageRand = 0, nCostMana = 286}, --level 1
};
...
function GetSkillLevelData(skill)
	...
	--skill.nCostMana      	= 476;					-- 技能消耗的内力
	--skill.nCostRage		= 0;					-- 技能消耗的怒气
	--skill.nCostStamina	= 0;					-- 技能消耗的体力
	--skill.nCostItemType	= 0;					-- 技能消耗的物品类型
	--skill.nCostItemIndex	= 0;					-- 技能消耗的物品索引ID
	skill.nCostManaBasePercent = 254;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
...
function Apply(dwCharacterID)
	...
	--[[
	if player.GetSkillLevel(5765) == 1 then
		player.AddBuff(dwCharacterID, player.nLevel, 6254, 1, 1)
		--player.AddBuff(dwCharacterID, player.nLevel, 6254, 1, 1)
		--player.AddBuff(dwCharacterID, player.nLevel, 6254, 1, 1)
	end
	--]]
	...
	--星楼增加1秒持续时间
	if player.GetSkillLevel(14634) == 1 then
		player.AddBuff(player.dwID, player.nLevel, 11808, 1, 5)
	else
		player.AddBuff(player.dwID, player.nLevel, 411, 1, 4)
	end

	ModityCDToUI(player, 100, 0, 0)
end
