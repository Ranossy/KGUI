---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_百花拂穴手_傍花随柳.lua
-- 更新时间:	2014/10/30 17:36:38
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
-- 文件名    :  万花_百花拂穴手_傍花随柳.lua
-- 创建人    :  南剑
-- 创建时间  :  2008-8-12
-- 用途(模块):  武功技能
-- 武功门派  :  万花
...
-- 武功套路  :  百花拂穴手
-- 技能名称  :  傍花随柳
-- 技能效果  :  对方若5秒内使用任何技能，将被定身6秒，并造成内力损失
------------------------------------------------
