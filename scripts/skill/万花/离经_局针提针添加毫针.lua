---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/离经_局针提针添加毫针.lua
-- 更新时间:	2015/9/13 20:55:31
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local nlev = player.GetSkillLevel(141)	--毫针技能等级
	if nlev ~= 0 and not target.GetBuff(126, nlev) then
		target.AddBuff(player.dwID, player.nLevel, 9724, nlev)
	end
end
