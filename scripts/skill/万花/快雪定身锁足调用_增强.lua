---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/快雪定身锁足调用_增强.lua
-- 更新时间:	2015/9/13 19:45:38
-- 更新用户:	mengxiangfei11
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	if dwSkillLevel < 10 then
		skill.nChannelInterval = 32 * 0.9;
	elseif dwSkillLevel < 29 then
		skill.nChannelInterval = (32 + (dwSkillLevel - 9) * 2) * 0.9
	else
		skill.nChannelInterval = 80 * 0.9;     -- 通道技间隔时间
	end
