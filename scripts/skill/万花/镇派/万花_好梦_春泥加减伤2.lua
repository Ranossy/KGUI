...
function GetSkillRecipeData(skill, SkillRecipeID, SkillRecipeLevel)
    ...
    local nRecipeLevel	= SkillRecipeLevel;
  	...
  	skill.AddAttribute(
  		...
  		tSkillRecipeData[1].nTherapyBase,							--属性值1
  		0																--属性值2
 		);
   	...
   	skill.AddAttribute(
  		...
  		tSkillRecipeData[1].nTherapyRand ,							--属性值1
  		0																--属性值2
 		);
     ...
     skill.nChannelInterval	= (skill.nChannelInterval + 64)*1.3;     
		--skill.SetBuffRecipe(1,50, 1);
    return
end
