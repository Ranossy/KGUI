---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/镇派/局针提针延长握针效果.lua
-- 更新时间:	2014/7/2 9:37:43
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/镇派/局针提针延长握针效果.lua", -- 属性值1
		0											-- 属性值2
	);
	...
	skill.AddSlowCheckDestOwnBuff(631, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);	-- 需求目标属于自己的Buff
...
function Apply(dwCharacterID, dwSkillSrcID)
	...
	local buff = target.GetBuffByOwner(631, nlev, player.dwID)

	if buff then
		if buff.nCustomValue < 3 then
			target.SetBuffLeftActiveCount(buff.nIndex, buff.nLeftActiveCount + 1)
