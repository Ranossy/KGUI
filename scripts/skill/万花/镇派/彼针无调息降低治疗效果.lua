---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/镇派/彼针无调息降低治疗效果.lua
-- 更新时间:	2015/9/13 22:00:39
-- 更新用户:	mengxiangfei11
-- 脚本说明:
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		"skill/万花/镇派/彼针无调息降低治疗效果.lua", -- 属性值1
		0											-- 属性值2
	);
	----------------- 技能施放Buff需求 ---------------------------------------------
...
function Apply(dwCharacterID)
	...
	if player.GetSkillLevel(140) ~= 0 and player.GetSkillLevel(14664) == 0 then
		local lv = player.GetSkillLevel(140)
		player.ForgetSkill(140)
		--player.LearnSkill(6621)
		player.LearnSkillLevel(14664, lv, dwCharacterID)
		RecipeCopy(140, lv, player, 14664)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 140, 14664, lv)
	end
end
...
function UnApply(dwCharacterID)
	...
	if player.GetSkillLevel(14664) ~= 0 and player.GetSkillLevel(140) == 0 then
		local lv = player.GetSkillLevel(14664)
		player.ForgetSkill(14664)
		--player.LearnSkill(2209)
		player.LearnSkillLevel(140, lv, dwCharacterID)
		RecipeCopy(14664, lv, player, 140)
		RemoteCallToClient(player.dwID, "OnActionBarSkillReplace", 14664, 140, lv)
	end
end
