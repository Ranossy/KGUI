...
function GetSkillLevelData(skill)
	...
	local dwSkillLevel = skill.dwLevel
			...
			skill.AddAttribute(
				ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,  --商阳
      ...
      skill.AddAttribute(
				ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,  --钟林
				ATTRIBUTE_TYPE.SET_TALENT_RECIPE,
				4054, 
				dwSkillLevel
			);
      ...
      skill.AddAttribute(
				ATTRIBUTE_EFFECT_MODE.EFFECT_TO_SELF_AND_ROLLBACK,  --兰催
				ATTRIBUTE_TYPE.SET_TALENT_RECIPE,
				4055, 
				dwSkillLevel
			);
