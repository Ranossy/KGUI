---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/镇派/万花_不会被打退.lua
-- 更新时间:	2017/4/19 11:48:07
-- 更新用户:	XIAXIANBO1
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{nActiveThreatCoefficient =  - 102},
	{nActiveThreatCoefficient =  - 205},
...
function GetSkillLevelData(skill)
 ...
 - 1024,
	...
	--0,
	--tSkillData[dwSkillLevel].nActiveThreatCoefficient
	--);
	----------------- 技能施放Buff需求 ---------------------------------------------
