---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_点穴截脉_少明指.lua
-- 更新时间:	2014/10/30 21:57:21
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
tSkillData =
{
	{ nDamageBase = 18, nDamageRand = 5, nCostMana = 229}, --level 1
	{ nDamageBase = 19, nDamageRand = 5, nCostMana = 286}, --level 2
	{ nDamageBase = 20, nDamageRand = 5, nCostMana = 344}, --level 3
	{ nDamageBase = 21, nDamageRand = 5, nCostMana = 378},
};
...
function GetSkillLevelData(skill)
	...
	--skill.SetNormalCoolDown(1, 180);					-- 改成瞬发了。
	...
	skill.nCostManaBasePercent = 457;	-- 技能消耗的内力
	----------------- 聚气相关 -------------------------------------------------
