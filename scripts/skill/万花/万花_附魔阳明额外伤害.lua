---------------------------------------------------------------------->
-- 脚本名称:	scripts/skill/万花/万花_沃土_阳明指额外25%伤害.lua
-- 更新时间:	2014/4/7 14:08:39
-- 更新用户:	mengxiangfei
-- 脚本说明:
----------------------------------------------------------------------<
------------------------------------------------
...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 0.7 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 0.7 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	--]]
	----------------- 技能施放Buff需求 ---------------------------------------------
	--skill.AddSlowCheckSelfBuff(7691, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL, 1, BUFF_COMPARE_FLAG.GREATER_EQUAL);		-- 需求自身Buff
	...
	--]]
	skill.nChannelInterval = (130 + 28) * (1+dwSkillLevel*0.1);     -- 通道技间隔时间
	--skill.nChannelInterval = 130; 				-- 通道技间隔时间
