...
function GetSkillLevelData(skill)
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageBase * 1.05 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	skill.AddAttribute(
		...
		tSkillData[dwSkillLevel].nDamageRand * 1.05 * (1 - tPit[dwSkillLevel].nReducePercent), -- 属性值1
		0																-- 属性值2
	);
	...
	--]]
	skill.nChannelInterval = (130*1.25 + 24) * 0.45;     -- 通道技间隔时间
	--skill.nChannelInterval = 130; 				-- 通道技间隔时间
